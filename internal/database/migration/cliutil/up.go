...
func Up(commandName string, factory RunnerFactory, outFactory OutputFactory, development bool) *cli.Command {
	...
	skipUpgradeValidationFlag := &cli.BoolFlag{
		...
		Usage: "Do not attempt to compare the previous instance version with the target instance version for upgrade compatibility. Please refer to https://khulnasoft.com/docs/admin/updates#update-policy for our instance upgrade compatibility policy.",
