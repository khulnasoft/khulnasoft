...
import (
	...
	connections "github.com/khulnasoft/khulnasoft/internal/database/connections/test"
...
See https://docs-legacy.khulnasoft.com/dev/background-information/bazel/faq#tests-fail-with-connection-refused`, cfg, err)
		}
