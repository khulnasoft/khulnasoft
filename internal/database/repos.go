...
import (
	...
	"github.com/khulnasoft/khulnasoft/internal/extsvc/pagure"
...
func (s *repoStore) listSQL(ctx context.Context, tr trace.Trace, opt ReposListOptions) (*sqlf.Query, error) {
	...
	// Since https://github.com/khulnasoft/khulnasoft/pull/35633 there is no need to do an anti-join
...
func parseDescriptionPattern(tr trace.Trace, p string) ([]*sqlf.Query, error) {
	...
	if len(exact) > 0 {
		...
		// Discussion: https://github.com/khulnasoft/khulnasoft/pull/39117#discussion_r925131158
