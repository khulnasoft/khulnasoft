...
import (
	...
	pb "github.com/khulnasoft/khulnasoft/internal/grpc/example/weather/v1"
	"github.com/khulnasoft/khulnasoft/internal/grpc/retry"
	"github.com/khulnasoft/khulnasoft/internal/grpc/streamio"
)
...
func main() {
	...
	// Demonstrate that all protobuf string fields must be utf-8 encoded.
	{
		...
		//
		// See https://github.com/khulnasoft/khulnasoft/issues/52181 for more context.
