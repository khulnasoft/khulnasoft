...
const sourcegraphPrefix = "github.com/khulnasoft/khulnasoft/"
...
func formatStackFrame(function string, file string, line int) string {
	treeAndFunc := strings.Split(function, "/")   // github.com/khulnasoft/khulnasoft/cmd/frontend/graphqlbackend.(*requestTracer).TraceQuery
	...
	tree := strings.Join(treeAndFunc[:len(treeAndFunc)-1], "/") + "/" + pckName // github.com/khulnasoft/khulnasoft/cmd/frontend/graphqlbackend
