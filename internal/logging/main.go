...
//
// Deprecated: All logging should use github.com/sourcegraph/log instead. See https://docs-legacy.khulnasoft.com/dev/how-to/add_logging
type Options struct {
...
// Init initializes log15's root logger based on Khulnasoft-wide logging configuration
// variables. See https://khulnasoft.com/docs/admin/observability/logs
//
// Deprecated: All logging should use github.com/sourcegraph/log instead. See https://docs-legacy.khulnasoft.com/dev/how-to/add_logging
