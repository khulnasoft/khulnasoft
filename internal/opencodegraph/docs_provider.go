...
var docsPatterns = []struct {
...
}{
	{
		...
		Title:          "Telemetry",
		URL:            "https://docs-legacy.khulnasoft.com/dev/background-information/telemetry#sourcegraph-web-app",
	},
	{
		Id:             "css",
		PathPattern:    regexp.MustCompile(`\.tsx?$`),
		...
		URL:            "https://docs-legacy.khulnasoft.com/dev/background-information/web/styling",
	},
	{
		Id:          "bazel",
		PathPattern: regexp.MustCompile(`(^|/)BUILD\.bazel$`),
		Title:       "Bazel at Khulnasoft",
		URL:         "https://docs-legacy.khulnasoft.com/dev/background-information/bazel",
	},
}
