...
// valid. cf. https://khulnasoft.com/docs/code_search/reference/language#commit-parameter
...
func validateRepoHasFile(nodes []Node) error {
	...
	if seenRepoHasFile && seenTypeSymbol {
		return errors.New("repohasfile is not compatible for type:symbol. Subscribe to https://github.com/khulnasoft/khulnasoft/issues/4610 for updates")
	}
	return nil
}
