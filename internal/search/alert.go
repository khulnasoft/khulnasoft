...
func AlertForInvalidRevision(revision string) *Alert {
	...
	return &Alert{
		...
		Description: fmt.Sprintf("We don't know how to interpret the revision (%s) you specified. Learn more about the revision syntax in our documentation: https://khulnasoft.com/docs/code-search/queries#repository-revisions.", revision),
	}
}
...
func AlertForUnownedResult() *Alert {
	return &Alert{
		...
		Description: "For some results, no ownership data was found, or no rule applied to the result. [Learn more about configuring code ownership](https://khulnasoft.com/docs/own).",
