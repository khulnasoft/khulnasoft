...
func TestUpdateCheckURL(t *testing.T) {
	tests := []struct {
		...
		{name: "default OK", env: "", want: "https://pings.khulnasoft.com/updates", errorLogsCount: 0},
		{name: "specified dotcom OK", env: "https://khulnasoft.com/", want: "https://khulnasoft.com/.api/updates", errorLogsCount: 0},
		{name: "http not OK", env: "http://khulnasoft.com/", want: "https://pings.khulnasoft.com/updates", errorLogsCount: 1},
		{name: "env OK", env: "https://fourfegraph.com/", want: "https://fourfegraph.com/.api/updates", errorLogsCount: 0},
		{name: "env no protocol not OK", env: "fourfegraph.com", want: "https://pings.khulnasoft.com/updates", errorLogsCount: 1},
		{name: "env garbage not OK", env: "garbage  foo", want: "https://pings.khulnasoft.com/updates", errorLogsCount: 1},
	}
