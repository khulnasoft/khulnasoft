...
func newStore[T workerutil.Record](observationCtx *observation.Context, handle basestore.TransactableHandle, options Options[T]) *store[T] {
	...
	if options.Name == "" {
		panic("no name supplied to github.com/khulnasoft/khulnasoft/internal/dbworker/store:newStore")
	}
...
// https://github.com/khulnasoft/khulnasoft/blob/main/doc/dev/background-information/workers.md#database-backed-stores
...
//
// See https://github.com/khulnasoft/khulnasoft/issues/32624.
