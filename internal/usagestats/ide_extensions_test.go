...
func TestIDEExtensionsUsageStatistics(t *testing.T) {
	...
	_, err := db.ExecContext(ctx, `
		...
		VALUES
			...
			(6, 'ViewBlob', '{}', 'https://sourcegraph.test:3443/github.com/khulnasoft/khulnasoft/-/blob/client/vscode/README.md?L8%3A1=', 2, '420657f0-d443-4d16-ac7d-003d8cdc19ac', 'WEB', $1::timestamp - interval '7 days', '{}', '3.33.3'),
			(7, 'ViewBlob', '{}', 'https://sourcegraph.test:3443/github.com/khulnasoft/khulnasoft/-/blob/client/vscode/README.md?L8%3A1=', 2, '420657f0-d443-4d16-ac7d-003d8cdc19ac', 'WEB', $1::timestamp - interval '10 days', '{}', '3.32.2'),
			(8, 'ViewBlob', '{}', 'https://sourcegraph.test:3443/github.com/khulnasoft/khulnasoft/-/blob/package.json', 2, '420657f0-d443-4d16-ac7d-003d8cdc19ac', 'WEB', $1::timestamp - interval '2 months', '{"editor": ""}', '3.32.2'),
			...
			(15, 'ViewBlob', '{}', 'https://sourcegraph.test:3443/github.com/khulnasoft/khulnasoft/-/blob/client/vscode/README.md?L8%3A1=', 2, '420657f0-d443-4d16-ac7d-003d8cdc19ac', 'WEB', $1::timestamp - interval '1 day', '{}', '3.35.0'),
			(16, 'VSCESearchSubmitted', '{}', '', 4, '420657f0-d443-6d16-ac7d-003d8cdcmf9y', 'BACKEND', $1::timestamp - interval '32 days', '{"editor": ""}', '3.37.1'),
			(17, 'ViewBlob', '{}', 'https://sourcegraph.test:3443/github.com/khulnasoft/khulnasoft/-/blob/client/vscode/README.md?L8%3A1=', 5, '420657f0-13d3-fgw3-ac7d-123d8cdm2sap', 'WEB', $1::timestamp - interval '1 day', '{}', '3.35.0'),
