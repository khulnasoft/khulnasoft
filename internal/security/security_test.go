...
func TestAddrValidation(t *testing.T) {
	var addrTests = []addrTest{
		...
		{"127.0.0.1:foo", false},
		{"khulnasoft.com", true},
		{"khulnasoft.com:443", true},
		{"khulnasoft.com:-baz", false},
		{"git123@khulnasoft.com", true},
		{"git123@127.0.0.1:80", true},
		{"git123@git456@khulnasoft.com", false},
		{"git-123@khulnasoft.com", false},
		{"git-123@khulnasoft.com:foo", false},
		{"git@khulnasoft.com", true},
		{"thissubdomaindoesnotexist.khulnasoft.com", false},
	}
