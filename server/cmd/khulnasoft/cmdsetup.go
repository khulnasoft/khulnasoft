...
var setupUsage = `
"setup" is used to populate a fresh KhulnaSoft instance with user(s) and account(s).
...
$ khulnasoft setup -name "My New Account" -email me@mydomain.org -populate
...
user by visting "/setup/" in your browser while the KhulnaSoft instance is running.
