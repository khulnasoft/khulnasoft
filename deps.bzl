...
def go_dependencies():
    ...
    go_repository(
        ...
        build_directives = [
            "gazelle:resolve go github.com/khulnasoft/khulnasoft/lib/errors @//lib/errors",
        ],
        build_file_proto_mode = "disable_global",
    ...
    go_repository(
        ...
        # This fixes the build for sourcegraph/scip which depends on khulnasoft/khulnasoft/lib but
        # gazelle doesn't know how to resolve those packages from within sourcegraph/scip.
        build_directives = [
            "gazelle:resolve go github.com/khulnasoft/khulnasoft/lib/errors @//lib/errors",
            "gazelle:resolve go github.com/khulnasoft/khulnasoft/lib/codeintel/lsif/protocol @//lib/codeintel/lsif/protocol",
            "gazelle:resolve go github.com/khulnasoft/khulnasoft/lib/codeintel/lsif/protocol/reader @//lib/codeintel/lsif/protocol/reader",
            "gazelle:resolve go github.com/khulnasoft/khulnasoft/lib/codeintel/lsif/protocol/writer @//lib/codeintel/lsif/protocol/writer",
        ],
        build_file_proto_mode = "disable_global",
    ...
    go_repository(
        ...
        build_directives = [
            "gazelle:resolve go github.com/khulnasoft/khulnasoft/lib/errors @//lib/errors",
            "gazelle:resolve go github.com/khulnasoft/khulnasoft/lib/background @//lib/background",
        ],
        build_file_proto_mode = "disable_global",
