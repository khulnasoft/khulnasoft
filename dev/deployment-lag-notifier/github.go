...
func getCommit(client *http.Client, sha string) (Commit, error) {
	...
	url := fmt.Sprintf("https://api.github.com/repos/khulnasoft/khulnasoft/commits/%v", sha)
...
// getCommitLog fetches the last numCommits commits of khulnasoft/khulnasoft@main from the Github API
func getCommitLog(client *http.Client, numCommits int) ([]Commit, error) {
	...
	url := "https://api.github.com/repos/khulnasoft/khulnasoft/commits"
