...
import (
	...
	"github.com/khulnasoft/khulnasoft/dev/managedservicesplatform/internal/imageupdater"
...
type EnvironmentResourcesSpec struct {
	...
	//  - REDIS_ENDPOINT
	//
	// Khulnasoft Redis libraries (i.e. internal/redispool) will automatically
