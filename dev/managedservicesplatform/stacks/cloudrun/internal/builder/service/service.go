...
import (
	...
	"github.com/khulnasoft/khulnasoft/dev/managedservicesplatform/internal/resource/cloudflare"
	"github.com/khulnasoft/khulnasoft/dev/managedservicesplatform/internal/resource/cloudflareorigincert"
	"github.com/khulnasoft/khulnasoft/dev/managedservicesplatform/internal/resource/loadbalancer"
	"github.com/khulnasoft/khulnasoft/dev/managedservicesplatform/internal/resource/managedcert"
...
func (b *serviceBuilder) Build(stack cdktf.TerraformStack, vars builder.Variables) (builder.Resource, error) {
	...
	} else if pointers.DerefZero(vars.Environment.Authentication.Khulnasoft) {
