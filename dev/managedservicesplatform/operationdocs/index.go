...
import (
	...
	"github.com/khulnasoft/khulnasoft/dev/managedservicesplatform/operationdocs/internal/markdown"
...
var (
	// https://www.notion.so/sourcegraph/Khulnasoft-Managed-Services-Platform-MSP-712a0389f54c4d3a90d069aa2d979a59
...
func RenderIndexPage(services []*spec.Spec, opts Options) []byte {
	...
	md.Paragraphf(`These pages contain generated operational guidance for the infrastructure of the %d %s services (across %d environments) currently in operation at Khulnasoft. `+
	...
	md.Paragraphf(`To gain access to MSP project TFC workspaces, [log in to Terraform Cloud](https://app.terraform.io/app/sourcegraph) and _then_ [request membership to the %s TFC team via Entitle](%s). `+
		`This TFC team has access to all MSP workspaces, and is [configured here](https://sourcegraph.khulnasoft.com/github.com/sourcegraph/infrastructure/-/blob/terraform-cloud/terraform.tfvars?L44:1-48:4).`,
