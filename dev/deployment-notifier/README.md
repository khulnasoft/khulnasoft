...
2. Compute the deployed applications and take note of the old commit new and Khulnasoft commit for each of them.
3. For each set of old and new commits, find all PRs that happened after the old Khulnasoft commit, up to the new Khulnasoft commit.
