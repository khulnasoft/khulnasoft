...
func IsKhulnasoft(r *Repository) bool {
	// If the container org doesn't contain Khulnasoft, we don't already
	// know it's not ours.
	...
	for _, ourImages := range images.KhulnasoftDockerImages {
