...
import (
	...
	"github.com/khulnasoft/khulnasoft/dev/ci/gitops"
...
var deployEphemeralCommand = cli.Command{
	...
	Flags: []cli.Flag{
		...
		&cli.StringFlag{
			Name:        "version",
			DefaultText: "deploys an ephemeral cloud Khulnasoft environment with the specified version. The version MUST exist and implies that no build will be created",
		},
	},
}
