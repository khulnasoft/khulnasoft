...
commands:
  frontend:
    ...
    install: go build -o .bin/frontend github.com/khulnasoft/khulnasoft/cmd/frontend
...
commands:
  frontend:
    cmd: .bin/frontend
    install: go build .bin/frontend github.com/khulnasoft/khulnasoft/cmd/frontend
    checkBinary: .bin/frontend
    env:
