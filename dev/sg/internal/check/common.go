...
func KhulnasoftDatabase(getConfig func() (*sgconf.Config, error)) CheckFunc {
	return func(ctx context.Context) error {
		// This check runs only in the `khulnasoft/khulnasoft` repository, so
...
func Caddy(_ context.Context) error {
	certPath, err := caddyKhulnasoftCertificatePath()
	if err != nil {
