...
import (
	...
	sgrun "github.com/khulnasoft/khulnasoft/dev/sg/internal/run"
...
//
// State is intended for use with the khulnasoft/khulnasoft repository
type State struct {
...
// GetState parses the git state of the root repository. Which is assumed to be khulnasoft/khulnasoft
