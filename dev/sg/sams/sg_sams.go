// Package sams exports 'sg sams' commands for the Khulnasoft Accounts Management System.
package sams
...
import (
	...
	"github.com/khulnasoft/khulnasoft/dev/sg/internal/secrets"
	"github.com/khulnasoft/khulnasoft/dev/sg/internal/std"
	"github.com/khulnasoft/khulnasoft/internal/httpcli"
	"github.com/khulnasoft/khulnasoft/lib/errors"

	"github.com/khulnasoft/khulnasoft/dev/sg/sams/samsflags"
)
...
func clientCredentialsFlags() []cli.Flag {
	return append(samsflags.ClientCredentials(),
		&cli.StringSliceFlag{
			...
			Usage:   "OAuth scopes ('$SERVICE::$PERM::$ACTION') to request from the Khulnasoft Accounts Management System (SAMS) server",
		},
	)
}

// Command is the 'sg sams' toolchain for the Khulnasoft Accounts Management System (SAMS).
var Command = &cli.Command{
	Name:     "sourcegraph-accounts",
	Aliases:  []string{"sams"},
	Category: category.Company,
	Usage:    "Development utilities for integrations against the Khulnasoft Accounts Management System (SAMS)",
	Description: `Learn more in https://sourcegraph.notion.site/Khulnasoft-Accounts-Management-System-SAMS-e86f1bc3dc3b4d979818e468bba189fd.
		...
		Subcommands: []*cli.Command{{
			...
			Flags: []cli.Flag{
				...
				&cli.StringFlag{
					...
					Usage: fmt.Sprintf("URL of the Khulnasoft Accounts Management System (SAMS) server - one of %q or %q",
			...
			Action: func(c *cli.Context) error {
				...
				if externalSecret := samsManagementSecretSource[samsServer]; externalSecret != nil {
					...
					if err != nil {
						std.Out.WriteAlertf("Failed to get secret - do you have Entitle access to the %q project? See https://sourcegraph.notion.site/Khulnasoft-Accounts-infrastructure-operations-b90a571da30443a8b1e7c31ade3594fb",
