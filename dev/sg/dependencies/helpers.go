...
func enableOnlyInKhulnasoftRepo() check.EnableFunc[CheckArgs] {
...
func checkKhulnasoftDatabase(ctx context.Context, out *std.Output, args CheckArgs) error {
	...
	return check.KhulnasoftDatabase(getConfig)(ctx)
}
