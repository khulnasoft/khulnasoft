...
// Khulnasoft Enterprise Portal service.
package enterprise
...
import (
	...
	subscriptionsv1 "github.com/khulnasoft/khulnasoft/lib/enterpriseportal/subscriptions/v1"
	subscriptionsv1connect "github.com/khulnasoft/khulnasoft/lib/enterpriseportal/subscriptions/v1/v1connect"
...
var Command = &cli.Command{
	...
	Usage:    "[EXPERIMENTAL] Manage Khulnasoft Enterprise subscriptions in Enterprise Portal",
	Description: `[EXPERIMENTAL] See https://www.notion.so/sourcegraph/Khulnasoft-Enterprise-Portal-EP-c6311818978547beb981bd2a593c6acf?pvs=4

Please reach out to #discuss-core-services for assistance if you have any questions!`,
	Subcommands: []*cli.Command{{
		Name:  "subscription",
		Usage: "Manage Khulnasoft Enterprise subscriptions in Enterprise Portal",
		Subcommands: []*cli.Command{{
			Name:      "list",
