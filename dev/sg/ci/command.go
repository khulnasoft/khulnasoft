...
var (
	...
	ciPipelineFlag = cli.StringFlag{
		...
		Usage:   "Select a custom Buildkite `pipeline` in the Khulnasoft org",
		Value:   "sourcegraph",
	}
)
...
var Command = &cli.Command{
	Name:        "ci",
	Usage:       "Interact with Khulnasoft's Buildkite continuous integration pipelines",
	Description: `Note that Khulnasoft's CI pipelines are under our enterprise license: https://github.com/khulnasoft/khulnasoft/blob/main/LICENSE.enterprise`,
	UsageText: `
