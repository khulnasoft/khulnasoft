...
var liveCommand = &cli.Command{
	...
	Usage:     "Reports which version of Khulnasoft is currently live in the given environment",
	UsageText: `
...
func constructLiveCmdLongHelp() string {
	...
	fmt.Fprintf(&out, "Prints the Khulnasoft version deployed to the given environment.")
	fmt.Fprintf(&out, "\n\n")
