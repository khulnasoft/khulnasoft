...
import (
	...
	"github.com/khulnasoft/khulnasoft/lib/cliutil/completions"
...
var (
	...
	startCommand = &cli.Command{
		...
		Usage:     "🌟 Starts the given commandset. Without a commandset it starts the default Khulnasoft dev environment",
		UsageText: `
# Run default environment, Khulnasoft enterprise:
sg start
...
func constructStartCmdLongHelp() string {
	...
	fmt.Fprintf(&out, `Use this to start your Khulnasoft environment!`)
