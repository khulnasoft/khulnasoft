...
PR_TITLE="security: Auto-update package lockfiles for Khulnasoft base images"
# PR_REVIEWER="sourcegraph/security"
PR_LABELS="SSDLC,security-auto-update,security-auto-update/images"
PR_BODY="Automatically generated PR to update package lockfiles for Khulnasoft base images.

Built from Buildkite run [#${BUILDKITE_BUILD_NUMBER}](https://buildkite.com/khulnasoft/khulnasoft/builds/${BUILDKITE_BUILD_NUMBER}).
## Test Plan
