...
// Khulnasoft application and writes it to stdout.
package main
...
import (
	...
	"github.com/khulnasoft/khulnasoft/dev/ci/internal/buildkite"
	"github.com/khulnasoft/khulnasoft/dev/ci/internal/ci"
	"github.com/khulnasoft/khulnasoft/dev/ci/internal/ci/changed"
	"github.com/khulnasoft/khulnasoft/dev/ci/runtype"
	"github.com/khulnasoft/khulnasoft/internal/hostname"
)
...
func renderPipelineDocs(logger log.Logger, w io.Writer) {
	...
	fmt.Fprintln(w, "\nFor a higher-level overview, please refer to the [continuous integration docs](https://docs-legacy.khulnasoft.com/dev/background-information/ci).")
