...
type TestReportOpts struct {
	...
	//
	// TODO: This is not finalized, see https://github.com/khulnasoft/khulnasoft/issues/31971
...
// to get exit codes from the scripts until https://github.com/khulnasoft/khulnasoft/issues/27264
// is fixed.
//
...
func SoftFail(exitCodes ...int) StepOpt {
	return func(step *Step) {
		...
		// https://github.com/khulnasoft/khulnasoft/issues/27264
