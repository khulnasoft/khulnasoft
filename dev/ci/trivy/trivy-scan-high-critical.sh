...
trivy_scan() {
  ...
  TRIVY_ARGS=(
    ...
    # (e.g. https://buildkite.com/khulnasoft/khulnasoft/builds/192926#0185a568-ee3e-494a-abbf-7b8f9c3f226f/118-173)
    "--timeout"
    "15m"
...
case "${exitCode:-"0"}" in
  ...
  "${VULNERABILITY_EXIT_CODE}")
    ...
    echo "<br />Trivy found issues. More information [here](https://handbook.khulnasoft.com/departments/product-engineering/engineering/cloud/security/trivy/#for-sourcegraph-engineers)." >> ./annotations/trivy-scan-high-critical.md
