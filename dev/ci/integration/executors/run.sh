...
export KHULNASOFT_LICENSE_GENERATION_KEY="${KHULNASOFT_LICENSE_GENERATION_KEY:-""}"
export TMP_DIR
export DATA
...
# Temporary workaround, see https://github.com/khulnasoft/khulnasoft/issues/44816
