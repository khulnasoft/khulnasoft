...
import (
	...
	"github.com/khulnasoft/khulnasoft/dev/ci/integration/executors/tester/config"
...
func initAndAuthenticate() (*gqltestutil.Client, error) {
	needsSiteInit, resp, err := gqltestutil.NeedsSiteInit(KhulnasoftEndpoint)
	...
	client, err := gqltestutil.NewClient(KhulnasoftEndpoint)
	if err != nil {
