...
docker exec $CONTAINER keycloak/bin/kcadm.sh update realms/$REALM -s displayNameHtml="<h3>Keycloak</h3><p style='font-size:12px;text-transform:none'><strong>Khulnasoft builtin usernames and passwords</strong><br/>$(cat "$MOTDFILE")root / q</p>"
