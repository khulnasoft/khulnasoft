...
import (
	...
	"github.com/khulnasoft/khulnasoft/internal/gqltestutil"
...
func testSearchClient(t *testing.T, client searchClient) {
	...
	t.Run("global text search", func(t *testing.T) {
		tests := []struct {
			...
			// Flakey test for exactMatchCount due to bug https://github.com/khulnasoft/khulnasoft/issues/29828
			// {
			...
			// Failing test: https://github.com/khulnasoft/khulnasoft/issues/48109
			// {
			//	name:  "fork:only",
			...
			// Ensure repo resolution is correct in global. https://github.com/khulnasoft/khulnasoft/issues/27044
			{
	...
	t.Run("And/Or queries", func(t *testing.T) {
		tests := []struct {
			...
			// https://buildkite.com/khulnasoft/khulnasoft/builds/161002
			// {
