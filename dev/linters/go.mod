module github.com/khulnasoft/khulnasoft/dev/linters

go 1.22

toolchain go1.23.3

replace github.com/khulnasoft/khulnasoft/lib => ../../lib
...
require (
	...
	github.com/khulnasoft/khulnasoft/lib v0.0.0-00010101000000-000000000000
