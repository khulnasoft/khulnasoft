...
var allowedToImport = []string{
	...
	"github.com/khulnasoft/khulnasoft/cmd/khulnasoft",
...
const dbconnPath = "github.com/khulnasoft/khulnasoft/internal/database/dbconn"

var cmdPkgRegex = regexp.MustCompile(`^github\.com/khulnasoft/khulnasoft/cmd/[\w-_]+$`)

func run(pass *analysis.Pass) (interface{}, error) {
	// for packages in the github.com/khulnasoft/khulnasoft module, we check whether they directly import
	...
	if strings.HasPrefix(pass.Pkg.Path(), "github.com/khulnasoft/khulnasoft") {
