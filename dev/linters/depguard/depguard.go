...
var Deny map[string]string = map[string]string{
	...
	"errors$":                             "Use github.com/khulnasoft/khulnasoft/lib/errors instead",
	"github.com/cockroachdb/errors$":      "Use github.com/khulnasoft/khulnasoft/lib/errors instead",
	"github.com/hashicorp/go-multierror$": "Use github.com/khulnasoft/khulnasoft/lib/errors instead",
	"github.com/aws/smithy-go/ptr":        "use github.com/khulnasoft/khulnasoft/lib/pointers instead",
	"k8s.io/utils/pointer":                "use github.com/khulnasoft/khulnasoft/lib/pointers instead",
	...
	"github.com/go-enry/go-enry$":         "Use github.com/khulnasoft/khulnasoft/lib/codeintel/languages instead. If some docs are not clear, please ask in #discuss-graph.",
	"github.com/go-enry/go-enry/v2$":      "Use github.com/khulnasoft/khulnasoft/lib/codeintel/languages instead. If some docs are not clear, please ask in #discuss-graph.",
	"github.com/go-enry/go-enry/v2/data$": "Use github.com/khulnasoft/khulnasoft/lib/codeintel/languages instead. If some needed API is missing, please ask in #discuss-graph.",
}
