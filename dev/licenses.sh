...
#
# Please refer to the handbook entry for more details: https://docs-legacy.khulnasoft.com/dev/background-information/ci#third-party-licenses
...
# run license check
echo "Running license_finder - if this fails, refer to our handbook: https://docs-legacy.khulnasoft.com/dev/background-information/ci#third-party-licenses"
