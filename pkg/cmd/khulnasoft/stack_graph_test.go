...
// Tests the output of 'khulnasoft stack graph'
...
func TestStackGraphCmd(t *testing.T) {
    ...
    Resource0 [label="urn:khulnasoft"];
}
`, dotOutput)
		})
...
`, dotOutput)
	...
	t.Run("graph with parent and child", func(t *testing.T) {
		...
		child := resource.URN("urn:khulnasoft:dev::pets::random:index/randomPet:RandomPet::child")
