		...
		Run: runCmdFunc(func(cmd *cobra.Command, args []string) error {
			...
			if all {
				...
				if cloudURL == "" {
					...
					// Default to the default cloud URL. This means a `khulnasoft logout` will delete the
					// credentials for khulnasoft.com if there's no "current" user set in the credentials file.
