...
func TestMoveLeafResource(t *testing.T) {
	...
	providerURN := resource.NewURN("sourceStack", "test", "", "khulnasoft:providers:a", "default_1_0_0")
	sourceResources := []*resource.State{
		{
			URN:    providerURN,
			Type:   "khulnasoft:providers:a::default_1_0_0",
			ID:     "provider_id",
			Custom: true,
		},
		{
  ...
  - urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::name
...
`
	...
	assert.Equal(t, urn.URN("urn:khulnasoft:destStack::test::khulnasoft:khulnasoft:Stack::test-destStack"),
		destSnapshot.Resources[0].URN)
	assert.Equal(t, urn.URN("urn:khulnasoft:destStack::test::khulnasoft:providers:a::default_1_0_0"),
		destSnapshot.Resources[1].URN)
	assert.Equal(t, urn.URN("urn:khulnasoft:destStack::test::d:e:f$a:b:c::name"),
		destSnapshot.Resources[2].URN)
	assert.Equal(t, "urn:khulnasoft:destStack::test::khulnasoft:providers:a::default_1_0_0::provider_id",
...
func TestChildrenAreBeingMoved(t *testing.T) {
	...
	assert.Contains(t, stdout.String(),
		"Planning to move the following resources from organization/test/sourceStack to organization/test/destStack:\n\n"+
			"  - urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::name\n"+
			"  - urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::name2")
	...
	assert.Equal(t, urn.URN("urn:khulnasoft:destStack::test::khulnasoft:khulnasoft:Stack::test-destStack"),
		destSnapshot.Resources[2].Parent)
	assert.Equal(t, urn.URN("urn:khulnasoft:destStack::test::d:e:f$a:b:c::name2"),
...
func TestMoveResourceWithDependencies(t *testing.T) {
  ...
  - urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::resToMove
  - urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::movedChildURN
  - urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::dependsOnMovedChildURN
...
The following resources remaining in organization/test/sourceStack have dependencies on resources moved to organization/test/destStack:
  ...
  - urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::deps has a dependency on urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::resToMove
  - urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::deletedWith is marked as deleted with urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::resToMove
  - urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::propDeps (key) has a property dependency on urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::resToMove
...
The following resources being moved to organization/test/destStack have dependencies on resources in organization/test/sourceStack:
  ...
  - urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::resToMove has a dependency on urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::remainingDep
...
`
	...
	assert.Equal(t, urn.URN("urn:khulnasoft:sourceStack::test::khulnasoft:providers:a::default_1_0_0"),
		sourceSnapshot.Resources[0].URN)
	assert.Equal(t, urn.URN("urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::remainingDep"),
		sourceSnapshot.Resources[1].URN)
	assert.Equal(t, urn.URN("urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::deps"),
	...
	assert.Equal(t, urn.URN("urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::deletedWith"),
		sourceSnapshot.Resources[3].URN)
	assert.Equal(t, urn.URN(""), sourceSnapshot.Resources[3].DeletedWith)
	assert.Equal(t, urn.URN("urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::propDeps"),
	...
	assert.Equal(t, urn.URN("urn:khulnasoft:destStack::test::khulnasoft:providers:a::default_1_0_0"),
		destSnapshot.Resources[1].URN)
	assert.Equal(t, urn.URN("urn:khulnasoft:destStack::test::d:e:f$a:b:c::resToMove"),
		destSnapshot.Resources[2].URN)
	assert.Equal(t, 0, len(destSnapshot.Resources[2].Dependencies))
	assert.Equal(t, urn.URN("urn:khulnasoft:destStack::test::d:e:f$a:b:c::movedChildURN"),
		destSnapshot.Resources[3].URN)
	assert.Equal(t, 0, len(destSnapshot.Resources[3].Dependencies))
	assert.Equal(t, urn.URN("urn:khulnasoft:destStack::test::d:e:f$a:b:c::dependsOnMovedChildURN"),
...
func TestMoveWithExistingProvider(t *testing.T) {
	...
	destResources := []*resource.State{
		{
			URN:    resource.NewURN("destStack", "test", "", "khulnasoft:providers:a", "default_1_0_0"),
			Type:   "khulnasoft:providers:a::default_1_0_0",
	...
	assert.ErrorContains(t, err, "provider urn:khulnasoft:destStack::test::khulnasoft:providers:a::default_1_0_0 "+
...
func TestMoveWithExistingResource(t *testing.T) {
	...
	otherProviderURN := resource.NewURN("destStack", "test", "", "khulnasoft:providers:a", "default_1_0_1")
	destResources := []*resource.State{
		{
			URN:    otherProviderURN,
			Type:   "khulnasoft:providers:a::default_1_0_1",
			ID:     "other_provider_id",
			Custom: true,
		},
		{
	...
	err = stateMoveCmd.Run(ctx, sourceStack, destStack, []string{string(sourceResources[1].URN)}, mp, mp)
	assert.ErrorContains(t, err, "resource urn:khulnasoft:destStack::test::d:e:f$a:b:c::name "+
		"already exists in destination stack")
}
	...
	sourceResources := []*resource.State{
		{
			...
			Type: "khulnasoft:khulnasoft:Stack",
		},
		{
			URN:    providerURN,
			Type:   "khulnasoft:providers:a::default_1_0_0",
...
func TestProviderIsReparented(t *testing.T) {
	...
	assert.Equal(t, 2, len(sourceSnapshot.Resources))
	assert.Equal(t, urn.URN("urn:khulnasoft:sourceStack::test::khulnasoft:khulnasoft:Stack::test-sourceStack"),
		sourceSnapshot.Resources[0].URN)
	assert.Equal(t, urn.URN("urn:khulnasoft:sourceStack::test::khulnasoft:providers:a::default_1_0_0"),
		sourceSnapshot.Resources[1].URN)
...
func TestMoveSecretOutsideOfProjectDir(t *testing.T) {
	...
	err = stateMoveCmd.Run(ctx, sourceStack, destStack, []string{string(sourceResources[2].URN)}, mp, mp)
	//nolint:lll
	assert.ErrorContains(t, err, "destination stack has no secret manager. To move resources either initialize the stack with a secret manager, or run the khulnasoft state move command from the destination project directory")
...
func TestMoveProviderWithSameInputs(t *testing.T) {
	...
	destProviderURN := resource.NewURN("destStack", "test", "", "khulnasoft:providers:a", "default_1_0_0")
	destResources := []*resource.State{
		{
			URN:    destProviderURN,
			Type:   "khulnasoft:providers:a::default_1_0_0",
...
`
	...
	assert.Equal(t, urn.URN("urn:khulnasoft:destStack::test::d:e:f$a:b:c::name"),
		destSnapshot.Resources[2].URN)
	assert.Equal(t, "urn:khulnasoft:destStack::test::khulnasoft:providers:a::default_1_0_0::another_provider_id",
		destSnapshot.Resources[2].Provider)
	assert.Equal(t, urn.URN("urn:khulnasoft:destStack::test::khulnasoft:khulnasoft:Stack::test-destStack"),
		destSnapshot.Resources[2].Parent)
}
...
// See https://github.com/khulnasoft/khulnasoft/pull/17208/files#diff-cbb48e4e8470d1946c5073f9d6ece05f454b340cc66ca4d9fbf7901e0a8b5c47L1330
//
...
func TestMoveLockedBackendRevertsDestination(t *testing.T) {
	...
	assert.Equal(t, urn.URN("urn:khulnasoft:sourceStack::test::khulnasoft:providers:a::default_1_0_0"),
		sourceSnapshot.Resources[1].URN)
	assert.Equal(t, urn.URN("urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::name"),
		sourceSnapshot.Resources[2].URN)
	assert.Equal(t, urn.URN("urn:khulnasoft:sourceStack::test::d:e:f$a:b:c::name2"),
		sourceSnapshot.Resources[3].URN)
}
