...
func TestSnapshotFrontendRoundTrip(t *testing.T) {
	...
	snapshot := &deploy.Snapshot{
		...
		Resources: []*resource.State{
			{
				URN:  resource.URN("urn:khulnasoft:dev::random::khulnasoft:khulnasoft:Stack::random-dev"),
			...
			{
				URN:    resource.URN("urn:khulnasoft:dev::random::khulnasoft:providers:random::default_4_13_2"),
			...
			{
				URN:    resource.URN("urn:khulnasoft:dev::random::random:index/randomPet:RandomPet::username-1"),
				...
				Parent:   resource.URN("urn:khulnasoft:dev::random::khulnasoft:khulnasoft:Stack::random-dev"),
				Provider: "urn:khulnasoft:dev::random::khulnasoft:providers:random::default_4_13_2::ed72fad1-9a82-49d7-b09f-1659b7a3c7db",
			},
		},
	}
