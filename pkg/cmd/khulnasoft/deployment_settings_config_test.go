...
func TestDSConfigureGit(t *testing.T) {
	...
	t.Run("using the GH app", func(t *testing.T) {
		...
		prompts := &promptHandlersMock{
			...
			PromptValueResponses: []promptAssertion[string, string]{
				...
				{"https://github.com/khulnasoft/test-repo.git", "https://github.com/khulnasoft/test-repo.git"},
			},
			PromptUserMultiResponses: []promptAssertion[[]string, []string]{
				{
					[]string{
		...
		assert.Equal(t, "khulnasoft/test-repo", d.Deployment.DeploymentSettings.GitHub.Repository)
	...
	t.Run("no authentication", func(t *testing.T) {
		...
		assert.Equal(t, "goproj", d.Deployment.DeploymentSettings.SourceContext.Git.RepoDir)
		assert.Equal(t, "master", d.Deployment.DeploymentSettings.SourceContext.Git.Branch)
		assert.Equal(t, "https://github.com/khulnasoft/test-repo.git", d.Deployment.DeploymentSettings.SourceContext.Git.RepoURL)
	...
	t.Run("using ssh", func(t *testing.T) {
		...
		assert.Equal(t, "goproj", d.Deployment.DeploymentSettings.SourceContext.Git.RepoDir)
		assert.Equal(t, "master", d.Deployment.DeploymentSettings.SourceContext.Git.Branch)
		assert.Equal(t, "https://github.com/khulnasoft/test-repo.git",
	...
	t.Run("non github", func(t *testing.T) {
		...
		prompts := &promptHandlersMock{
			...
			PromptValueResponses: []promptAssertion[string, string]{
				{"goproj", "goproj"},
				{"refs/heads/master", "master"},
				{"https://github.com/khulnasoft/test-repo.git", "https://example.com/khulnasoft/test-repo.git"},
			},
		}
		...
		assert.Equal(t, "goproj", d.Deployment.DeploymentSettings.SourceContext.Git.RepoDir)
		assert.Equal(t, "master", d.Deployment.DeploymentSettings.SourceContext.Git.Branch)
		assert.Equal(t, "https://example.com/khulnasoft/test-repo.git", d.Deployment.DeploymentSettings.SourceContext.Git.RepoURL)
		assert.Nil(t, d.Deployment.DeploymentSettings.SourceContext.Git.GitAuth)
