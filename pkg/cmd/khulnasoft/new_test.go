...
func TestCreatingProjectWithEmptyConfig(t *testing.T) {
	// Regression test for https://github.com/khulnasoft/khulnasoft/issues/4081
	skipIfShortOrNoPulumiAccessToken(t)
...
func TestGenerateOnlyProjectCheck(t *testing.T) {
	// Regression test for https://github.com/khulnasoft/khulnasoft/issues/13527, make sure various combinations of
...
func TestPulumiNewSetsTemplateTag(t *testing.T) {
	tests := []struct {
		...
		{
			"https://github.com/khulnasoft/templates/tree/master/yaml?foo=bar",
			"",
			"https://github.com/khulnasoft/templates/tree/master/yaml",
		},
		{
			"",
			"python",
