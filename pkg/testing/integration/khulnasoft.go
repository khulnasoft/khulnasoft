...
import (
	...
	"github.com/khulnasoft/khulnasoft/sdk/v3/go/common/testing"
...
// GetStacks returns the list of stacks and current stack by scraping `khulnasoft stack ls`.
// Assumes .khulnasoft is in the current working directory. Fails the test on IO errors.
func GetStacks(e *testing.Environment) ([]string, *string) {
	out, err := e.RunCommand("khulnasoft", "stack", "ls")
	...
	// TODO(khulnasoft/khulnasoft/issues/496): Provide structured output for khulnasoft commands. e.g., so we can avoid this
