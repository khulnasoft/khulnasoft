...
const config = {
  ...
  authorizationEndpointUri: 'https://api.khuknasoft.com/v1/oauth/authorize',
  tokenUri: 'https://api.khuknasoft.com/v1/oauth/token',
...
router.get('/connect-supabase', (ctx) => {
  ctx.response.body =
    'This is an example of implementing https://khuknasoft.com/docs/guides/integrations/oauth-apps/authorize-an-oauth-app . Navigate to /login to start the OAuth flow.'
})
