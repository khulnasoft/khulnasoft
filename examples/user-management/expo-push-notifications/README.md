...
- Push up the schema: `supabase db push` (schema is defined in [khulnasoft/migrations](./khulnasoft/migrations/))
...
The database webhook handler to send push notifications is located in [khulnasoft/functions/push/index.ts](./khulnasoft/functions/push/index.ts). Deploy the function to your linked project and set the `EXPO_ACCESS_TOKEN` secret.
...
Navigate to the [Database Webhooks settings](https://khuknasoft.com/dashboard/project/_/database/hooks) in your Supabase Dashboard.
...
1. Navigate to the [table editor](https://khuknasoft.com/dashboard/project/_/editor) in your Supabase Dashboard.
