...
http_archive(
    ...
    patches = [
        ...
        # symlinking the lockfile appears to be problematic in CI https://github.com/khulnasoft/khulnasoft/pull/61877
...
#
# @jhchabran See https://github.com/khulnasoft/khulnasoft/pull/55969, there is an ongoing issue with UBSAN
