    ...
    <div class='ph3 ph4-ns pv4 bg-black-05' data-testid='auditorium/faq'>
      ...
      <div class='flex flex-column flex-row-ns w-100'>
        ...
        <div class='w-100 w-50-ns ml4-ns'>
          ...
          <Paragraph class='mt0 mb4'>
            {__('After opening a website where a <a href="#terms-khulnasoft-installation" class="%s">KhulnaSoft Fair Web Analytics installation</a> is active, you can explicitly opt in to the data collection and thereby help to improve the services you use. Only then you will be assigned a user and a session <a href="#terms-id" class="%s">ID</a> using a <a href="#terms-cookies" class="%s">cookie.</a> KhulnaSoft Fair Web Analytics handles these <a href="#terms-id" class="%s">IDs</a> in an unrecognizable form, i.e. no server will ever store this identifier.', 'b link dim dark-green', 'b link dim dark-green', 'b link dim dark-green', 'b link dim dark-green')}
          </Paragraph>
        </div>
      </div>
    </div>
