                ...
                (props) => {
                  ...
                  return (
                    <Fragment>
                      <Wrapper>
                        <Illustration
                          src={urify(path.join(__dirname, 'khulnasoft-onboarding-1.svg'))}
                ...
                (props) => {
                  ...
                  return (
                    <Fragment>
                      <Wrapper>
                        <Illustration
                          src={urify(path.join(__dirname, 'khulnasoft-onboarding-2.svg'))}
                ...
                (props) => {
                  return (
                    <Fragment>
                      <Wrapper>
                        <Illustration
                          src={urify(path.join(__dirname, 'khulnasoft-onboarding-3.svg'))}
