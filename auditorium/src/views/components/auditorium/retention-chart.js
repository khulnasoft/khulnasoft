        ...
        {explainerActive
          ? (
            <Paragraph class='mw7 ma0 pv2'>
              {__('This panel displays your recurring visits of pages of the <a href="#terms-khulnasoft-installation" class="%s">KhulnaSoft Fair Web Analytics installation</a> during the last 4 weeks. For each of the previous weeks, the percentage is calculated from the value of the current week.', 'b link dim dark-green')}
            </Paragraph>
          )
          : null}
      </div>
