        ...
        {explainerActive
          ? (
            <Paragraph class='mw7 ma0 pv2'>
              {__('This panel displays the number of pages (bright green) and websites (dark green) you have visited where the <a href="#terms-khulnasoft-installation" class="%s">KhulnaSoft Fair Web Analytics installation</a> is active. To measure this, a cookie is used to assign you a user and a session <a href="#terms-id" class="%s">ID.</a>', 'b link dim dark-green', 'b link dim dark-green')}
            </Paragraph>
          )
          : null}
      </div>
            ...
            <div class='w-100 h-100 db bg-near-white br2'>
              <div class='h-100 w-100 dt pb4'>
                <div class='dtc v-mid tc'>
                  <img src={urify(path.join(__dirname, 'khulnasoft-empty-state.svg'))} alt={__('Empty state')} width='180' height='190' class='ma0' />
