...
const consentBanner = require('khulnasoft/consent-banner')
          ...
          return (
            <div class='mw6 center ph3 mt3 mb4'>
              ...
              <Paragraph class='ma0 mb4'>
                {__('<a class="%s" href="%s" target="_blank" rel="noopener">Read the Docs - Customizing the consent banner</a>', 'b link dim dark-green', 'https://docs.khulnasoft.com/running-khulnasoft/customizing-consent-banner/')}
              </Paragraph>
