  ...
  const renderBody = (props = {}) => (
    <div class='mw6 center ph3 mt3 mb4'>
      <Paragraph class='ma0 mb3'>
        {__('To use KhulnaSoft Fair Web Analytics with the account <em class="%s">%s</em> on your website, embed the following script on each page you want to appear in your statistics.', 'i tracked', model.account.name)}
      </Paragraph>
      <Paragraph class='ma0 mb3'>
