        ...
        {explainerActive
          ? (
            <Paragraph class='mw7 ma0 pv2'>
              {__('This panel displays several page lists that count the total number of your page views of the <a href="#terms-khulnasoft-installation" class="%s">KhulnaSoft Fair Web Analytics installation</a> per URL in different categories.', 'b link dim dark-green')}
            </Paragraph>
          )
          : null}
      </div>
      <div class='mt3'>
        ...
        >
          <Tables.Table
            ...
            explainer={(props) => {
              return (
                <Paragraph class='mw7 ma0 ph1 pv2 ws-normal'>
                  {__('A list of referrers that directed you to pages of the <a href="#terms-khulnasoft-installation" class="%s">KhulnaSoft Fair Web Analytics installation.</a> Popular referrers like, for example, Google or Twitter display their proper name, others their domain.', 'b link dim dark-green')}
                </Paragraph>
              )
            }}
            showAll={showAll === 2}
        ...
        >
          <Tables.Table
            ...
            explainer={(props) => (
              <Paragraph class='mw7 ma0 ph1 pv2 ws-normal'>
                {__('A list of pages of the <a href="#terms-khulnasoft-installation" class="%s">KhulnaSoft Fair Web Analytics installation</a> that you have opened first in all <a href="#terms-unique-session" class="%s">unique sessions.</a>', 'b link dim dark-green', 'b link dim dark-green')}
              </Paragraph>
            )}
            showAll={showAll === 3}
          ...
          <Tables.Table
            ...
            explainer={(props) => {
              return (
                <Paragraph class='mw7 ma0 ph1 pv2 ws-normal'>
                  {__('A list of pages of the <a href="#terms-khulnasoft-installation" class="%s">KhulnaSoft Fair Web Analytics installation</a> that you have opened last in all <a href="#terms-unique-session" class="%s">unique sessions.</a> For this to be counted you must have visited at least two pages.', 'b link dim dark-green', 'b link dim dark-green')}
                </Paragraph>
              )
            }}
            showAll={showAll === 3}
