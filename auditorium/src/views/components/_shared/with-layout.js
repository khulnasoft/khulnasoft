      ...
      <div class='w-100 bg-black-05'>
        <div class='mw8 center flex pb3 pt2 viewport-padding' id='headline'>
          <ForwardingAnchor pick={['locale']} href='/' class='dim link flex'>
            <img src={urify(path.join(__dirname, 'khulnasoft-icon-black.svg'))} alt='KhulnaSoft logo' width='37' height='40' class='ma0 mt1 mr3' />
            <h1 class='dib dark-gray f3 f2-ns normal ma0 margin-header'>{props.headline || __('KhulnaSoft Fair Web Analytics')}</h1>
          </ForwardingAnchor>
        </div>
      </div>
      ...
      <div class='mw8 center flex flex-wrap flex-column flex-row-ns justify-between f6 lh-title pb5 pb7-ns viewport-padding mid-gray'>
        <div class='w-100'>
          <Paragraph
            class='ma0 mb0'
          >
            {__('<a href="https://www.khulnasoft.com/" class="%s" target="_blank" rel="noreferrer noopener">KhulnaSoft Fair Web Analytics</a>', 'b link dim mid-gray')}
          </Paragraph>
        </div>
        <div class='w-100'>
          <Paragraph
            class='ma0 tl tr-ns'
          >
            {__('Found an issue, need help or want to add something?<br><a href="mailto:admin@khulnasoft.com" class="%s" target="_blank">Send an email</a> or file an <a href="https://github.com/khulnasoft/khulnasoft" class="%s" target="_blank" rel="noreferrer noopener">issue.</a>', 'b link dim mid-gray', 'b link dim mid-gray')}
          </Paragraph>
        </div>
      </div>
      {props.flash.length
          ...
          <div class='fixed bottom-0 bottom-2-ns w-100 ph4-ns'>
            {props.flash.map((message) => (
              <p
                ...
                role='alert'
              >
                <img src={urify(path.join(__dirname, 'khulnasoft-icon-black.svg'))} alt='KhulnaSoft logo' height='30' class='ma0 mr3' />
                <span
