    ...
    content = (
      <div class='w-100 w-90-ns mr3-ns'>
        <h3 class='f4 normal ma0 mb3'>
          {__('KhulnaSoft Fair Web Analytics requires cookies to function properly.')}
        </h3>
        <p class='ma0 mb2'>
          {__('KhulnaSoft Fair Web Analytics is a fair and open source analytics software. It is installed on the website that linked you here.')}
        </p>
        <p class='ma0'>
          {__('For KhulnaSoft Fair Web Analytics to work, your browser has to accept cookies. Please change your browsers settings and reload this page. Subsequently, you will be asked for consent to collect your usage data.')}
        </p>
      </div>
    )
    ...
    content = (
      <Fragment>
        <div class='w-100 w-60-ns mr3-ns' id='consent-banner' data-testid='index/consent-banner'>
          ...
          <p class='ma0 mb2'>
            {__('KhulnaSoft Fair Web Analytics is a fair and open source analytics software. Help the website that linked you here by allowing access to your usage data.')}
          </p>
