    ...
    <div class='ph3 ph4-ns pv4 bg-black-05' data-testid='index/faq'>
      <div class='flex flex-column flex-row-ns w-100'>
        ...
        <div class='w-100 w-50-ns ml4-ns'>
          ...
          <Paragraph class='mt0 mb1'>
            {__('After opening a website where an KhulnaSoft Fair Web Analytics installation is active, you can explicitly opt in to the data collection and thereby help to improve the services you use. Only then you will be assigned a user and a session ID using a cookie. KhulnaSoft Fair Web Analytics handles these IDs in an unrecognizable form. <a href="https://en.wikipedia.org/wiki/HTTP_cookie" class="%s" target="_blank" rel="noreferrer noopener">Learn more about cookies here.</a>', 'b link dim dark-green')}
          </Paragraph>
        </div>
      </div>
    </div>
