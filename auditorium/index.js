...
const vault = require('khulnasoft/vault')
...
window.auditoriumDispatchIntoStore = (...args) => store.dispatch(...args)
...
const App = () => {
  ...
  const handleRouteChange = (e) => {
    ...
    if (window.__khulnasoft__ && window.__khulnasoft__.pageview) {
      window.__khulnasoft__.pageview({ skipConsent: true })
    }
  }
