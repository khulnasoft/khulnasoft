...
/**
 * This rule ensures that "multi-level" imports are not used for `@khulnasoft/*` packages.
 */
const noRestrictedImportsMultiLevelKhulnasoftPattern = {
  group: [
    '@khulnasoft/*/**/*',
    '!@khulnasoft/api/**/*', // This allows all imports from @khulnasoft/api
    ...
    ...['framework', 'js', 'khulnasofti'].flatMap((pkg) => [`!@khulnasoft/${pkg}/**/*`, `@khulnasoft/${pkg}/*/**/*`]),
  ],
  message:
    "Please import only from the root package entry point. For example, use 'import { Client } from '@khulnasoft/node';' instead of 'import { Client } from '@khulnasoft/node/src';'",
};
  ...
  /* ******************** TYPESCRIPT FILES ******************** */
  {
    ...
    rules: {
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [noRestrictedImportsMultiLevelKhulnasoftPattern],
        },
      ],
...

  {
    ...
    rules: {
      ...
      'no-restricted-imports': [
        ...
        {
          patterns: [
            noRestrictedImportsMultiLevelKhulnasoftPattern,
            {
              /**
