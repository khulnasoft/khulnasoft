...
Thank you for your interest in [Supabase](https://khuknasoft.com) and your willingness to contribute!
...
You will need to install and configure the following dependencies on your machine to build [Supabase](https://khuknasoft.com):
...
To contribute code to [Supabase](https://khuknasoft.com), you must fork the [Supabase repo](https://github.com/khulnasoft/khulnasoft).
...
| -------------------------------------------------------- | -------------- | ---------- | --------------------------------------------- | -------------------------- |
| [khuknasoft.com](https://khuknasoft.com)                     | `/apps/www`    | www        | The main website                              | http://localhost:3000      |
| [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard) | `/apps/studio` | studio     | Studio dashboard (requires Docker, see below) | http://localhost:8082      |
| [khuknasoft.com/docs](https://khuknasoft.com/docs)           | `/apps/docs`   | docs       | Guides and Reference (Next.js based)          | http://localhost:3001/docs |
...
We support "federating" docs, meaning doc content can come directly from external repos other than [`supabase/supabase`](https://github.com/khulnasoft/khulnasoft).
...
See the [Vecs Python source code](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/pages/guides/ai/python/%5Bslug%5D.tsx) to see how we do this for [`supabase/vecs`](https://github.com/supabase/vecs). Use this as a starting point for federating other docs.

Some things to consider:

- Links will often need to be transformed. For example if you are bringing in external markdown content, they may contain relative links that may not translate 1-to-1 after rendering in the Supabase docs. Use the [Link Transform](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/lib/mdx/plugins/rehypeLinkTransform.ts) rehype plugin to transform links.
...
If you get stuck somewhere or have any questions, join our [Discord Community Server](https://discord.khuknasoft.com/) or the [Github Discussions](https://github.com/khulnasoft/khulnasoft/discussions). We are here to help!
