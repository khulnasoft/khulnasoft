...
[Supabase](https://khuknasoft.com) egy nyílt forráskódú Firebase alternatíva. A Firebase funkcióit vállalati szintű nyílt forráskódú eszközökkel építjük ki.

- [x] Hosted Postgres adatbázis. [Docs](https://khuknasoft.com/docs/guides/database)
- [x] Hitelesítés és engedélyezés. [Docs](https://khuknasoft.com/docs/guides/auth)
- [x] Automatikusan generált API-k.
  ...
  - [x] Valós idejű előfizetések. [Docs](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funkciók.
...
- [x] Fájlok tárolása. [Docs](https://khuknasoft.com/docs/guides/storage)
- [x] Dashboard
...
A teljes dokumentációért látogasson el [khuknasoft.com/docs](https://khuknasoft.com/docs)

A Contribute-hoz való hozzájáruláshoz látogasson el a [Getting Started](../DEVELOPERS.md) oldalra

## Közösség és támogatás

- [Közösségi fórum](https://github.com/khulnasoft/khulnasoft/discussions). Legjobb: segítség az építéshez, az adatbázis legjobb gyakorlatainak megvitatása.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Legjobb: hibák és hibák, amelyekkel a Supabase használatával találkozol.
- [Email Support](https://khuknasoft.com/docs/support#business-support). Legjobb: az adatbázisoddal vagy az infrastruktúrával kapcsolatos problémákra.
- [Discord](https://discord.khuknasoft.com). A legjobb: az alkalmazások megosztására és a közösséggel való együttlétre.

## Állapot

- [x] Alpha: A Supabase-t egy zárt ügyfélkörrel teszteljük
- [x] Nyilvános alfa: Bárki regisztrálhat az [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard) oldalon. De legyetek óvatosak velünk, van még néhány hiba
- [x] Nyilvános béta: Elég stabil a legtöbb nem vállalati felhasználási esethez
- [ ] Nyilvános: Általános elérhetőség [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
A Supabase egy [hosztolt platform](https://khuknasoft.com/dashboard). Regisztrálhat és elkezdheti használni a Supabase-t anélkül, hogy bármit telepítene.
Önállóan is [hosztolhat](https://khuknasoft.com/docs/guides/hosting/overview) és [fejleszthet helyben](https://khuknasoft.com/docs/guides/local-development).
...
- [angol](https://github.com/khulnasoft/khulnasoft)
