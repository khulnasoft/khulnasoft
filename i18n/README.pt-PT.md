...
[Supabase](https://khuknasoft.com) é uma alternativa open source ao Firebase. Estamos a construir as funcionalidades do Firebase usando ferramentas open source de nível empresarial.

- [x] Base de dados Postgres alojada. [Docs](https://khuknasoft.com/docs/guides/database)
- [x] Autenticação e autorização. [Docs](https://khuknasoft.com/docs/guides/auth)
- [x] APIs geradas automaticamente.
  ...
  - [x] Assinaturas em tempo real. [Docs](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funções.
  - [x] Funções de base de dados. [Docs](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Funções de Borda [Docs](https://khuknasoft.com/docs/guides/functions)
- [x] Armazenamento de Ficheiros. [Docs](https://khuknasoft.com/docs/guides/storage)
...
Para documentação completa, visite [khuknasoft.com/docs](https://khuknasoft.com/docs)

Para ver como contribuir, visite [Getting Started](../DEVELOPERS.md)

## Comunidade & Suporte

- [Fórum da Comunidade](https://github.com/khulnasoft/khulnasoft/discussions). Melhor para: ajuda com a construção, discussão sobre as melhores práticas de banco de dados.
- [Problemas no GitHub](https://github.com/khulnasoft/khulnasoft/issues). Melhor para: bugs e erros que encontra ao usar o Supabase.
- [Suporte por Email](https://khuknasoft.com/docs/support#business-support). Melhor para: problemas com a sua base de dados ou infra-estrutura.
- [Discord](https://discord.khuknasoft.com). Ideal para: partilhar as suas aplicações e conviver com a comunidade.

## Status

- [x] Alfa: Estamos a testar o Supabase com um conjunto fechado de clientes
- [x] Alfa Público: Qualquer pessoa pode inscrever-se em [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Mas vá com calma, ainda há alguns problemas
- [x] Beta Público: Estável o suficiente para a maioria dos casos de uso não empresarial
- [ ] Público: Disponibilidade geral [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase é uma [plataforma alojada](https://khuknasoft.com/dashboard). Pode registar-se e começar a usar o Supabase sem instalar nada.
Pode também [auto-hospedar](https://khuknasoft.com/docs/guides/hosting/overview) e [desenvolver localmente](https://khuknasoft.com/docs/guides/local-development).
...
- [Inglês](https://github.com/khulnasoft/khulnasoft)
