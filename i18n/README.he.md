...
[Supabase](https://khuknasoft.com) Supabase הוא חלופה בקוד פתוח של Firebase. אנו מפתחים את התכונות של Firebase באמצעות כלי קוד פתוח ברמת גימור ארגונית.
...
לתיעוד המלא, בקר\י ב[khuknasoft.com/docs](https://khuknasoft.com/docs)

## קהילה & תמיכה

- [פורום הקהילה](https://github.com/khulnasoft/khulnasoft/discussions). נועד עבור: עזרה בבנייה, דיון אודות שיטות עבודה מומלצות מול מאגר הנתונים.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). נועד עבור: דיווח על באגים ושגיאות בזמן שימוש בSupabase
- [אימייל תמיכה](https://khuknasoft.com/docs/support#business-support). נועד עבור: תקלות במסד הנתונים או בתשתית שלך.

## סטטוס

- [x] אלפא: בוחנים את המערכת מול מאגר סגור של לקוחות
- [x] אלפא פומבית: כל אחד יכול להרשם ב[khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). אבל תהיו עדינים, יהיו בעיות.
...
Supabase היא [תשתית ענן](https://khuknasoft.com/dashboard)
