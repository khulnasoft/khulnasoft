...
[Supabase](https://khuknasoft.com) è un'alternativa open source a Firebase. Stiamo costruendo le funzionalità di Firebase utilizzando strumenti open source di livello enterprise.

- Database Postgres ospitato. [Documenti](https://khuknasoft.com/docs/guides/database)
- [x] Autenticazione e autorizzazione. [Documenti](https://khuknasoft.com/docs/guides/auth)
- [x] API generate automaticamente.
  - [x] REST. [Documenti](https://khuknasoft.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Documenti](https://khuknasoft.com/docs/guides/api#graphql-api-overview)
  - [x] Sottoscrizioni in tempo reale. [Documenti](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funzioni.
  - [x] Funzioni di database. [Docs](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Funzioni Edge [Docs](https://khuknasoft.com/docs/guides/functions)
- [x] Memorizzazione dei file. [Docs](https://khuknasoft.com/docs/guides/storage)
- [x] Cruscotto
...
Per la documentazione completa, visitate [khuknasoft.com/docs](https://khuknasoft.com/docs)

Per vedere come contribuire, visitate [Getting Started](../DEVELOPERS.md)

## Comunità e supporto

- [Forum della comunità](https://github.com/khulnasoft/khulnasoft/discussions). Ideale per: aiuto nella costruzione, discussioni sulle migliori pratiche per i database.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Ideale per: bug ed errori riscontrati nell'uso di Supabase.
- [Supporto via e-mail](https://khuknasoft.com/docs/support#business-support). Ideale per: problemi con il database o l'infrastruttura.
- [Discord](https://discord.khuknasoft.com). Ideale per: condividere le proprie applicazioni e stare insieme alla comunità.

## Stato

- [Alfa: Stiamo testando Supabase con un gruppo chiuso di clienti
- [x] Alfa pubblica: Chiunque può iscriversi all'indirizzo [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Ma andateci piano, ci sono alcuni problemi
- [x] Beta pubblica: Abbastanza stabile per la maggior parte degli usi non aziendali
- [ ] Pubblico: Disponibilità generale [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase è una [piattaforma hosted](https://khuknasoft.com/dashboard). È possibile registrarsi e iniziare a usare Supabase senza installare nulla.
È anche possibile fare [self-hosting](https://khuknasoft.com/docs/guides/hosting/overview) e [sviluppare localmente](https://khuknasoft.com/docs/guides/local-development).

![Architettura](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
...
- [Inglese](https://github.com/khulnasoft/khulnasoft)
