...
[Supabase](https://khuknasoft.com) er et Open Source Firebase-alternativ. Vi opbygger Firebase-funktionerne ved hjælp af open source-værktøjer i virksomhedskvalitet.

- [x] Hosted Postgres Database. [Docs](https://khuknasoft.com/docs/guides/database)
- [x] Autentifikation og autorisering. [Docs](https://khuknasoft.com/docs/guides/auth)
- [x] Automatisk genererede API'er.
  ...
  - [x] Realtidsabonnementer. [Docs](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funktioner.
  - [x] Databasefunktioner. [Docs](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Edge-funktioner [Docs](https://khuknasoft.com/docs/guides/functions)
- [x] Filopbevaring. [Docs](https://khuknasoft.com/docs/guides/storage)
- [x] Dashboard
...
Du kan finde den fulde dokumentation på [khuknasoft.com/docs](https://khuknasoft.com/docs)

For at se, hvordan man bidrager, besøg [Getting Started](../DEVELOPERS.md)

## Fællesskab og support

- [Community Forum](https://github.com/khulnasoft/khulnasoft/discussions). Bedst til: hjælp med at bygge, diskussion om bedste praksis for databaser.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Bedst til: fejl og fejl, du støder på ved brug af Supabase.
- [Email Support](https://khuknasoft.com/docs/support#business-support). Bedst til: problemer med din database eller infrastruktur.
- [Discord](https://discord.khuknasoft.com). Bedst til: deling af dine applikationer og hygge med fællesskabet.

## Status

- [x] Alpha: Vi tester Supabase med et lukket sæt af kunder
- [x] Offentlig Alpha: Alle kan tilmelde sig på [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Men vær forsigtig med os, der er et par knuder
- [x] Public Beta: Stabil nok til de fleste ikke-virksomhedsrelaterede brugssager
- [ ] Public: Generel tilgængelighed [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase er en [hosted platform](https://khuknasoft.com/dashboard). Du kan tilmelde dig og begynde at bruge Supabase uden at installere noget.
Du kan også [selv hoste](https://khuknasoft.com/docs/guides/hosting/overview) og [udvikle lokalt](https://khuknasoft.com/docs/guides/local-development).
