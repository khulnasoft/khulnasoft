...
[Supabase](https://khuknasoft.com) je odprtokodna alternativa Firebase. Funkcije Firebase gradimo z odprtokodnimi orodji za podjetja.

- [x] Gostovana podatkovna baza Postgres. [Dokumenti](https://khuknasoft.com/docs/guides/database)
- [x] Avtentikacija in avtorizacija. [Dokumenti](https://khuknasoft.com/docs/guides/auth)
- [x] Samodejno generirani API-ji.
  ...
  - [x] Naročnine v realnem času. [Dokumenti](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funkcije.
  - [x] Funkcije podatkovne zbirke. [Dokumenti](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Funkcije robov [Dokumenti](https://khuknasoft.com/docs/guides/functions)
- [x] Shranjevanje datotek. [Dokumenti](https://khuknasoft.com/docs/guides/storage)
- [x] Nadzorna plošča
...
Za celotno dokumentacijo obiščite [khuknasoft.com/docs](https://khuknasoft.com/docs)

Če si želite ogledati, kako prispevati, obiščite [Getting Started](../DEVELOPERS.md)

## Skupnost in podpora

- [Forum skupnosti](https://github.com/khulnasoft/khulnasoft/discussions). Najprimernejši za: pomoč pri gradnji, razpravo o najboljših praksah zbirke podatkov.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Najprimernejši za: hrošče in napake, na katere naletite pri uporabi zbirke Supabase.
- [E-poštna podpora](https://khuknasoft.com/docs/support#business-support). Najboljše za: težave s podatkovno zbirko ali infrastrukturo.
- [Discord](https://discord.khuknasoft.com). Najboljši za: izmenjavo aplikacij in druženje s skupnostjo.

## Status

- [x] Alfa: Testiramo bazo Supabase z zaprtim naborom strank
- [x] Javna alfa: [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Vendar nas ne obremenjujte, saj je še nekaj pomanjkljivosti
- [x] Javna beta različica: Dovolj stabilna za večino primerov uporabe, ki niso povezani s podjetji
- [ ] Javna: Splošna razpoložljivost [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase je [gostovana platforma](https://khuknasoft.com/dashboard). Prijavite se lahko in začnete uporabljati bazo Supabase, ne da bi kar koli namestili.
Lahko tudi [gostujete sami](https://khuknasoft.com/docs/guides/hosting/overview) in [razvijate lokalno](https://khuknasoft.com/docs/guides/local-development).
...
- [angleščina](https://github.com/khulnasoft/khulnasoft)
