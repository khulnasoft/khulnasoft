...
[Supabase](https://khuknasoft.com) yra atvirojo kodo Firebase alternatyva. Kuriame "Firebase" funkcijas naudodami įmonių klasės atvirojo kodo įrankius.

- [x] Prieglobos Postgres duomenų bazė. [Dokumentai](https://khuknasoft.com/docs/guides/database)
- [x] Autentiškumo nustatymas ir autorizavimas. [Dokumentai](https://khuknasoft.com/docs/guides/auth)
- [x] Automatiškai generuojamos API.
  - [x] REST. [Dokumentai](https://khuknasoft.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumentai](https://khuknasoft.com/docs/guides/api#graphql-api-overview)
  - [x] Realaus laiko prenumeratos. [Dokumentai](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funkcijos.
  - [x] Duomenų bazės funkcijos. [Dokumentai](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Kraštų funkcijos [Docs](https://khuknasoft.com/docs/guides/functions)
- [x] Failų saugojimas. [Dokumentai](https://khuknasoft.com/docs/guides/storage)
...
Išsamios dokumentacijos rasite [khuknasoft.com/docs](https://khuknasoft.com/docs)

Norėdami sužinoti, kaip prisidėti, apsilankykite [Getting Started](../DEVELOPERS.md)

## Bendruomenė ir palaikymas

- [Bendrijos forumas](https://github.com/khulnasoft/khulnasoft/discussions). Geriausiai tinka: pagalbai kuriant, diskusijoms apie geriausią duomenų bazių praktiką.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Geriausia: klaidos ir klaidos, su kuriomis susiduriate naudodami "Supabase".
- [Pagalba el. paštu](https://khuknasoft.com/docs/support#business-support). Geriausiai tinka: problemoms, susijusioms su jūsų duomenų baze ar infrastruktūra, spręsti.
- [Discord](https://discord.khuknasoft.com). Geriausiai tinka: dalytis savo programomis ir bendrauti su bendruomene.

## Statusas

- [x] Alfa: Bandome "Supabase" su uždaru klientų rinkiniu
- [x] Viešoji Alfa versija: [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Tačiau neskubėkite su mumis, yra keletas trūkumų
- [x] Viešoji beta versija: Pakankamai stabili daugeliui ne įmonių naudojimo atvejų
- [ ] Vieša: Bendras prieinamumas [[statusas](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase yra [prieglobos platforma](https://khuknasoft.com/dashboard). Galite užsiregistruoti ir pradėti naudotis "Supabase" nieko neįdiegę.
Taip pat galite [savarankiškai talpinti](https://khuknasoft.com/docs/guides/hosting/overview) ir [kurti vietoje](https://khuknasoft.com/docs/guides/local-development).

![Architektūra](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
...
- [anglų kalba](https://github.com/khulnasoft/khulnasoft)
