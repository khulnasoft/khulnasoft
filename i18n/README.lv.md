...
[Supabase](https://khuknasoft.com) ir atvērtā koda Firebase alternatīva. Mēs veidojam Firebase funkcijas, izmantojot uzņēmumu klases atvērtā pirmkoda rīkus.

- [x] Hosted Postgres datubāze. [Dokumenti](https://khuknasoft.com/docs/guides/database)
- [x] Autentifikācija un autorizācija. [Dokumenti](https://khuknasoft.com/docs/guides/auth)
- [x] Automātiski ģenerēti API.
  - [x] REST. [Dokumenti](https://khuknasoft.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumenti](https://khuknasoft.com/docs/guides/api#graphql-api-overview)
  - [x] Reāllaika abonēšana. [Dokumenti](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funkcijas.
  - [x] Datubāzes funkcijas. [Dokumenti](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Edge funkcijas [Dokumenti](https://khuknasoft.com/docs/guides/functions)
- [x] Failu glabāšana. [Dokumenti](https://khuknasoft.com/docs/guides/storage)
- [x] Vadības panelis
...
Pilnu dokumentāciju skatīt [khuknasoft.com/docs](https://khuknasoft.com/docs)

Lai uzzinātu, kā veikt iemaksas, apmeklējiet [Getting Started](../DEVELOPERS.md)

## Kopiena un atbalsts

- [Kopienas forums](https://github.com/khulnasoft/khulnasoft/discussions). Vislabāk piemērots: palīdzībai veidošanā, diskusijām par datubāzes paraugpraksi.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Vislabākais: kļūdas un kļūdas, ar kurām jūs sastopaties, izmantojot Supabase.
- [E-pasta atbalsts](https://khuknasoft.com/docs/support#business-support). Vislabāk piemērots: problēmām ar jūsu datu bāzi vai infrastruktūru.
- [Discord](https://discord.khuknasoft.com). Vislabākais: lai dalītos ar savām lietojumprogrammām un komunicētu ar kopienu.

## Statuss

- [x] Alfa: Mēs testējam Supabase ar slēgtu klientu kopu
- [x] Publiskā alfa versija: [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Bet nesteidzieties, ir dažas nepilnības
- [x] Publiskā beta versija: Pietiekami stabila lielākajai daļai ar uzņēmumu nesaistītu lietošanas gadījumu
- [ ] Publisks: Vispārēja pieejamība [[statuss](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]]
...
Supabase ir [izvietota platforma](https://khuknasoft.com/dashboard). Jūs varat reģistrēties un sākt izmantot Supabase, neko neinstalējot.
Jūs varat arī [pašmāju resursus](https://khuknasoft.com/docs/guides/hosting/overview) un [izstrādāt lokāli](https://khuknasoft.com/docs/guides/local-development).

![Arhitektūra](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
...
- [angļu valodā](https://github.com/khulnasoft/khulnasoft)
