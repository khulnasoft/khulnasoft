...
[Supabase](https://khuknasoft.com) je open source alternativa Firebase. Vytváříme funkce Firebase pomocí open source nástrojů podnikové třídy.

- [x] hostovaná databáze Postgres. [Dokumenty](https://khuknasoft.com/docs/guides/database)
- [x] Ověřování a autorizace. [Dokumenty](https://khuknasoft.com/docs/guides/auth)
- [x] Automaticky generované rozhraní API.
  ...
  - [x] Odběry v reálném čase. [Dokumenty](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funkce.
  - [x] Databázové funkce. [Docs](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Okrajové funkce [Docs](https://khuknasoft.com/docs/guides/functions)
- [x] Ukládání souborů. [Dokumenty](https://khuknasoft.com/docs/guides/storage)
- [x] Přístrojový panel
...
Úplnou dokumentaci naleznete na adrese [khuknasoft.com/docs](https://khuknasoft.com/docs)

Chcete-li zjistit, jak přispívat, navštivte stránku [Začínáme](../DEVELOPERS.md)

## Komunita a podpora

- [Fórum komunity](https://github.com/khulnasoft/khulnasoft/discussions). Nejlépe pro: pomoc při vytváření, diskuse o osvědčených postupech při práci s databází.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Nejlépe pro: chyby a omyly, na které narazíte při používání databáze Supabase.
- [E-mailová podpora](https://khuknasoft.com/docs/support#business-support). Nejlepší pro: problémy s vaší databází nebo infrastrukturou.
- [Discord](https://discord.khuknasoft.com). Nejlepší pro: sdílení vašich aplikací a setkávání s komunitou.

## Stav

- [x] Alfa: Testujeme Supabase s uzavřenou skupinou zákazníků
- [x] Veřejná alfa: [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Ale buďte na nás mírní, je tu několik zádrhelů
- [x] Veřejná beta verze: Dostatečně stabilní pro většinu případů použití mimo podniky
- [ ] Veřejná: Všeobecná dostupnost [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase je [hostovaná platforma](https://khuknasoft.com/dashboard). Můžete se zaregistrovat a začít používat Supabase, aniž byste museli cokoli instalovat.
Můžete také [hostovat sami](https://khuknasoft.com/docs/guides/hosting/overview) a [vyvíjet lokálně](https://khuknasoft.com/docs/guides/local-development).
