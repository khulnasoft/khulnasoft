...
[Supabase](https://khuknasoft.com) är ett alternativ till Firebase med öppen källkod. Vi bygger upp funktionerna från Firebase med hjälp av öppen källkod-verktyg i företagsklass.

- [x] Hosted Postgres-databas. [Docs](https://khuknasoft.com/docs/guides/database)
- [x] Autentisering och auktorisering. [Docs](https://khuknasoft.com/docs/guides/auth)
- [x] Automatiskt genererade API:er.
  ...
  - [x] Prenumerationer i realtid. [Dokument](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funktioner.
  - [x] Databasfunktioner. [Dokument](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Edge-funktioner [Docs](https://khuknasoft.com/docs/guides/functions)
- [x] Lagring av filer. [Docs](https://khuknasoft.com/docs/guides/storage)
- [x] AI + Vektor/Inbäddningsverktyg. [Docs](https://khuknasoft.com/docs/guides/ai)
- [x] Kontrollpanel
...
Fullständig dokumentation finns på [khuknasoft.com/docs](https://khuknasoft.com/docs)

För att se hur man bidrar, besök [Getting Started](../DEVELOPERS.md)

## Gemenskap och stöd

- [Community Forum](https://github.com/khulnasoft/khulnasoft/discussions). Bäst för: hjälp med att bygga, diskussion om bästa praxis för databaser.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Bäst för: buggar och fel som du stöter på när du använder Supabase.
- [E-postsupport](https://khuknasoft.com/docs/support#business-support). Bäst för: problem med din databas eller infrastruktur.
- [Discord](https://discord.khuknasoft.com). Bäst för: att dela med dig av dina applikationer och umgås med gemenskapen.
...
Supabase är en [värdplattform](https://khuknasoft.com/dashboard). Du kan registrera dig och börja använda Supabase utan att installera något.
Du kan också [självhosta](https://khuknasoft.com/docs/guides/hosting/overview) och [utveckla lokalt](https://khuknasoft.com/docs/guides/local-development).
