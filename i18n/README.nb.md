...
[Supabase](https://khuknasoft.com) er et alternativ til Firebase med åpen kildekode. Vi bygger funksjonene i Firebase ved hjelp av åpen kildekode-verktøy for bedrifter.

- [x] Hostet Postgres-database. [Dokumenter](https://khuknasoft.com/docs/guides/database)
- [x] Autentisering og autorisasjon. [Dokumenter](https://khuknasoft.com/docs/guides/auth)
- [x] Autogenererte API-er.
  - [x] REST. [Dokumenter](https://khuknasoft.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumenter](https://khuknasoft.com/docs/guides/api#graphql-api-overview)
  - [x] Sanntidsabonnementer. [Dokumenter](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funksjoner.
  - [x] Databasefunksjoner. [Dokumenter](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Edge-funksjoner [Dokumenter](https://khuknasoft.com/docs/guides/functions)
- [x] Lagring av filer. [Dokumenter](https://khuknasoft.com/docs/guides/storage)
- [x] Dashbord
...
For fullstendig dokumentasjon, besøk [khuknasoft.com/docs](https://khuknasoft.com/docs)

For å se hvordan du kan bidra, gå til [Getting Started](../DEVELOPERS.md)

## Fellesskap og støtte

- [Community Forum](https://github.com/khulnasoft/khulnasoft/discussions). Best for: hjelp med å bygge, diskusjon om beste praksis for databaser.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Best for: feil og feil du støter på ved bruk av Supabase.
- [E-poststøtte](https://khuknasoft.com/docs/support#business-support). Best for: problemer med databasen eller infrastrukturen din.
- [Discord](https://discord.khuknasoft.com). Best for: å dele applikasjonene dine og henge med fellesskapet.

## Status

- [x] Alpha: Vi tester Supabase med en lukket gruppe kunder
- [x] Offentlig Alpha: Alle kan registrere seg på [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Men vær snill med oss, det er noen små problemer
- [x] Offentlig beta: Stabilt nok for de fleste brukstilfeller som ikke er for bedrifter
- [ ] Offentlig: Generell tilgjengelighet [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase er en [vertsplattform](https://khuknasoft.com/dashboard). Du kan registrere deg og begynne å bruke Supabase uten å installere noe.
Du kan også [selv være vert](https://khuknasoft.com/docs/guides/hosting/overview) og [utvikle lokalt](https://khuknasoft.com/docs/guides/local-development).

![arkitektur](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
...
- [engelsk](https://github.com/khulnasoft/khulnasoft)
