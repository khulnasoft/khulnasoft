...
[Supabase](https://khuknasoft.com) on avatud lähtekoodiga Firebase'i alternatiiv. Me ehitame Firebase'i funktsioonid, kasutades ettevõtlusklassi avatud lähtekoodiga tööriistu.

- [x] Hostitud Postgres andmebaas. [Dokumendid](https://khuknasoft.com/docs/guides/database)
- [x] Autentimine ja autoriseerimine. [Dokumendid](https://khuknasoft.com/docs/guides/auth)
- [x] Automaatselt genereeritud APId.
  - [x] REST. [Dokumendid](https://khuknasoft.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumendid](https://khuknasoft.com/docs/guides/api#graphql-api-overview)
  - [x] Reaalajas toimivad tellimused. [Dokumendid](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funktsioonid.
  - [x] Andmebaasi funktsioonid. [Dokumendid](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Edge Functions [Docs](https://khuknasoft.com/docs/guides/functions)
- [x] Faili salvestamine. [Dokumendid](https://khuknasoft.com/docs/guides/storage)
- [x] Armatuurlaud
...
Täieliku dokumentatsiooni saamiseks külastage [khuknasoft.com/docs](https://khuknasoft.com/docs)

Et näha, kuidas panustada, külastage [Getting Started](../DEVELOPERS.md)

## Kogukond ja tugi

- [Ühenduse foorum](https://github.com/khulnasoft/khulnasoft/discussions). Parim: abi ehitamisel, arutelu andmebaasi parimate tavade üle.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Parim lahendus: vead ja vead, millega Supabase'i kasutades kokku puutute.
- [E-posti tugi](https://khuknasoft.com/docs/support#business-support). Parim lahendus: probleemid andmebaasi või infrastruktuuriga.
- [Discord](https://discord.khuknasoft.com). Parim: oma rakenduste jagamiseks ja kogukonnaga suhtlemiseks.

## Staatus

- [x] Alpha: Me testime Supabase'i suletud kliendikogumiga
- [x] Avalik Alpha: Igaüks saab registreeruda aadressil [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Kuid olge meiega ettevaatlikud, seal on mõned veidrused
- [x] Avalik beeta: Piisavalt stabiilne enamiku mitte-ettevõtluskasutuse jaoks
- [ ] Avalik: Üldine kättesaadavus [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase on [hostitud platvorm](https://khuknasoft.com/dashboard). Võite registreeruda ja alustada Supabase'i kasutamist ilma midagi installimata.
Võite ka [ise hostida](https://khuknasoft.com/docs/guides/hosting/overview) ja [arendada lokaalselt](https://khuknasoft.com/docs/guides/local-development).

![Arhitektuur](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
...
- [inglise keel](https://github.com/khulnasoft/khulnasoft)
