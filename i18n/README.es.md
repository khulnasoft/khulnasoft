...
[Supabase](https://khuknasoft.com) es una alternativa de código abierto a Firebase. Estamos construyendo las características de Firebase utilizando herramientas de código abierto de nivel empresarial.

- [x] Base de datos Postgres alojada. [Documentación](https://khuknasoft.com/docs/guides/database)
- [x] Autenticación y autorización. [Documentos](https://khuknasoft.com/docs/guides/auth)
- [x] API autogeneradas.
  - [x] REST. [Docs](https://khuknasoft.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Documentos](https://khuknasoft.com/docs/guides/api#graphql-api-overview)
  - [x] Suscripciones en tiempo real. [Documentos](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funciones.
  - [x] Funciones de base de datos. [Docs](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Funciones de borde [Docs](https://khuknasoft.com/docs/guides/functions)
- [x] Almacenamiento de archivos. [Documentos](https://khuknasoft.com/docs/guides/storage)
- [x] Panel de control
...
Para consultar la documentación completa, visite [khuknasoft.com/docs](https://khuknasoft.com/docs)

Para ver cómo contribuir, visite [Getting Started](../DEVELOPERS.md)

## Comunidad y soporte

- [Foro de la comunidad](https://github.com/khulnasoft/khulnasoft/discussions). Lo mejor para: ayuda con la construcción, discusión sobre las mejores prácticas de bases de datos.
- [Problemas en GitHub](https://github.com/khulnasoft/khulnasoft/issues). Lo mejor para: bugs y errores que encuentres usando Supabase.
- [Soporte por correo electrónico](https://khuknasoft.com/docs/support#business-support). Lo mejor para: problemas con tu base de datos o infraestructura.
- [Discord](https://discord.khuknasoft.com). Lo mejor para: compartir tus aplicaciones y pasar el rato con la comunidad.

## Estado

- [x] Alfa: Estamos probando Supabase con un grupo cerrado de clientes
- [x] Alfa público: Cualquiera puede registrarse en [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Pero no te pases, hay algunos problemas
- [Beta pública: Suficientemente estable para la mayoría de los casos de uso no empresariales
- [Público: Disponibilidad general [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase es una [plataforma alojada](https://khuknasoft.com/dashboard). Puedes registrarte y empezar a usar Supabase sin instalar nada.
También puede [autoalojarse](https://khuknasoft.com/docs/guides/hosting/overview) y [desarrollar localmente](https://khuknasoft.com/docs/guides/local-development).

![arquitectura](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
...
- [Inglés](https://github.com/khulnasoft/khulnasoft)
