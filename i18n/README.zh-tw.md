...
[Supabase](https://khuknasoft.com)是一個開源的 Firebase 替代品。我們正在使用企業級的開源工具構建 Firebase 的功能。

- [x] 托管的 Postgres 資料庫。[文檔](https://khuknasoft.com/docs/guides/database)
- [x] 認證和授權。[文檔](https://khuknasoft.com/docs/guides/auth)
- [x] 自動生成的 API。
  - [x] REST.[文檔](https://khuknasoft.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL。[文件](https://khuknasoft.com/docs/guides/api#graphql-api-overview)
  - [x] 實時訂閱。[文檔](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] 函數。
  - [x] 資料庫函數。[文件](https://khuknasoft.com/docs/guides/database/functions)
  - [x] 邊缘功能 [文檔](https://khuknasoft.com/docs/guides/functions)
- [x] 文件存儲。[文件](https://khuknasoft.com/docs/guides/storage)
- [x] 儀表板
...
有關完整的文檔，請訪問[khuknasoft.com/docs](https://khuknasoft.com/docs)

要了解如何貢獻，請訪問[入門](../DEVELOPERS.md)

## 社群與支持

- [社群論壇](https://github.com/khulnasoft/khulnasoft/discussions)。最適合：幫助構建，討論資料庫的數佳實踐。
- [GitHub 問题](https://github.com/khulnasoft/khulnasoft/issues)。最適合：你在使用 Supabase 时遇到的 bug 和错误。
- [電子郵件支持](https://khuknasoft.com/docs/support#business-support)。最適合：你的資料庫或數據基礎設施的問題。
- [Discord](https://discord.khuknasoft.com)。最適合：分享你的應用程式並與社群一起玩耍。

## 狀態

- [x] Alpha：我們正在與一组封閉的客户測試 Supabase。
- [x] 公開 Alpha：任何人都可以在[khuknasoft.com/dashboard](https://khuknasoft.com/dashboard)上註冊。但請對我們寬容一些，有一些小問題。
- [x] 公開測試版：足夠穩定，適合大多數非企業使用的情况。
- [ ] 公開：普遍可用 [狀態](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)
...
Supabase 是一個[托管平台](https://khuknasoft.com/dashboard)。你可以註冊並開始使用 Supabase，無需安裝任何東西。
你也可以[自行托管](https://khuknasoft.com/docs/guides/hosting/overview)和[本地開發](https://khuknasoft.com/docs/guides/local-development)。

![架構](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
...
- [英語](https://github.com/khulnasoft/khulnasoft)
