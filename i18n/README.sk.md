...
[Supabase](https://khuknasoft.com) je open source alternatíva Firebase. Funkcie Firebase budujeme pomocou open source nástrojov podnikovej triedy.

- [x] hostovaná databáza Postgres. [Dokumenty](https://khuknasoft.com/docs/guides/database)
- [x] Autentifikácia a autorizácia. [Dokumenty](https://khuknasoft.com/docs/guides/auth)
- [x] Automaticky generované rozhrania API.
  - [x] REST. [Dokumenty](https://khuknasoft.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumenty](https://khuknasoft.com/docs/guides/api#graphql-api-overview)
  - [x] Odbery v reálnom čase. [Docs](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funkcie.
  - [x] Databázové funkcie. [Docs](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Okrajové funkcie [Docs](https://khuknasoft.com/docs/guides/functions)
- [x] Ukladanie súborov. [Dokumenty](https://khuknasoft.com/docs/guides/storage)
- [x] Prístrojový panel
...
Úplnú dokumentáciu nájdete na stránke [khuknasoft.com/docs](https://khuknasoft.com/docs)

Ak chcete zistiť, ako prispievať, navštívte stránku [Začíname](../DEVELOPERS.md)

## Komunita a podpora

- [Fórum komunity](https://github.com/khulnasoft/khulnasoft/discussions). Najlepšie pre: pomoc pri vytváraní, diskusie o osvedčených postupoch pri práci s databázou.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Najlepšie pre: chyby a omyly, na ktoré narazíte pri používaní databázy Supabase.
- [E-mailová podpora](https://khuknasoft.com/docs/support#business-support). Najlepšie pre: problémy s vašou databázou alebo infraštruktúrou.
- [Discord](https://discord.khuknasoft.com). Najlepšie na: zdieľanie vašich aplikácií a stretávanie sa s komunitou.

## Stav

- [x] Alfa: Testujeme Supabase s uzavretým súborom zákazníkov
- [x] Verejná alfa: [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Ale buďte na nás mierni, je tu niekoľko zádrheľov
- [x] Verejná beta verzia: Dostatočne stabilná pre väčšinu prípadov použitia, ktoré nie sú určené pre podniky
- [ ] Verejná: Všeobecná dostupnosť [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase je [hostovaná platforma](https://khuknasoft.com/dashboard). Môžete sa zaregistrovať a začať používať Supabase bez toho, aby ste čokoľvek inštalovali.
Môžete tiež [samostatne hosťovať](https://khuknasoft.com/docs/guides/hosting/overview) a [vyvíjať lokálne](https://khuknasoft.com/docs/guides/local-development).

![Architektúra](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
...
- [Angličtina](https://github.com/khulnasoft/khulnasoft)
