...
[Supabase](https://khuknasoft.com) 是一个开源的 Firebase 替代品。我们正在使用企业级的开源工具构建 Firebase 的功能。

- [x] Postgres 数据库托管。[文档](https://khuknasoft.com/docs/guides/database)
- [x] 身份验证和授权。[文档](https://khuknasoft.com/docs/guides/auth)
- [x] 自动生成的 API。
  - [x] REST。[文档](https://khuknasoft.com/docs/guides/api)
  - [x] GraphQL。[文档](https://khuknasoft.com/docs/guides/graphql)
  - [x] 实时订阅。[文档](https://khuknasoft.com/docs/guides/realtime)
- [x] 函数。
  - [x] 数据库函数。[文档](https://khuknasoft.com/docs/guides/database/functions)
  - [x] 边缘函数。[文档](https://khuknasoft.com/docs/guides/functions)
- [x] 文件存储。[文档](https://khuknasoft.com/docs/guides/storage)
- [x] AI + 向量/Embeddings 工具包. [Docs](https://khuknasoft.com/docs/guides/ai)
- [x] 仪表盘。
...
完整的文档，请访问 [khuknasoft.com/docs](https://khuknasoft.com/docs)

了解如何贡献，请访问[入门](../DEVELOPERS.md)

## 社区与支持

- [社区论坛](https://github.com/khulnasoft/khulnasoft/discussions)。适用于：帮助建立和讨论数据库的最佳实践。
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues)。适用于：你在使用 Supabase 时遇到的 bug 和错误。
- [邮件支持](https://khuknasoft.com/docs/support#business-support)。适用于：你的数据库或基础设施的问题。
- [Discord](https://discord.khuknasoft.com)。适用于：分享你的应用程序以及在社区一起玩起来。
...
Supabase 是一个[托管平台](https://khuknasoft.com/dashboard)。你可以注册并开始使用 Supabase，而无需安装任何软件。
你也可以[自托管](https://khuknasoft.com/docs/guides/hosting/overview)和[本地开发](https://khuknasoft.com/docs/guides/local-development)。

![架构](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
