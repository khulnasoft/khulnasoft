...
[Supabase](https://khuknasoft.com)は、オープンソースの Firebase 代替製品です。エンタープライズグレードのオープンソースツールを使って、Firebase の機能を構築しています。

- [x] ホスティングされた Postgres データベース [Docs](https://khuknasoft.com/docs/guides/database)
- [x] 認証・認可 [Docs](https://khuknasoft.com/docs/guides/auth)
- [x] API を自動生成
  - [x] REST [Docs](https://khuknasoft.com/docs/guides/api#rest-api-overview)
  - [x] リアルタイムサブスクリプション [Docs](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
  - [x] GraphQL (Beta) [Docs](https://khuknasoft.com/docs/guides/api#graphql-api-overview)
- [x] 関数
  - [x] データベース関数 [Docs](https://khuknasoft.com/docs/guides/database/functions)
...
詳しいドキュメントは[khuknasoft.com/docs](https://khuknasoft.com/docs)をご覧ください。

コントリビュート方法は[Getting Started](../DEVELOPERS.md)をご覧ください。

## コミュニティとサポート

- [コミュニティフォーラム](https://github.com/khulnasoft/khulnasoft/discussions) どんな時に使うか：構築の手助け、データベースのベストプラクティスに関する議論など
- [GitHub Issue](https://github.com/khulnasoft/khulnasoft/issues) どんな時に使うか: Supabase で起こったバグやエラーについて
- [Email サポート](https://khuknasoft.com/docs/support#business-support) どんな時に使うか: ユーザー自身のデータベースやインフラに何か問題が発生した場合
- [Discord](https://discord.khuknasoft.com) どんな時に使うか: アプリケーションの共有やコミュニティとの交流

## ステータス

- [x] Alpha: 限られたユーザーで Supabase をテストしています。
- [x] Public Alpha: 誰でも[khuknasoft.com/dashboard](https://khuknasoft.com/dashboard)から登録ができます。ただし、バグなどがある可能性がありますので、ご容赦ください。
...
Supabase は[ホスティングされたプラットフォーム](https://khuknasoft.com/dashboard)です。登録するだけで、何もインストールせずに使い始めることができます。
さらに、 [セルフホスティング](https://khuknasoft.com/docs/guides/hosting/overview) や [ローカル開発](https://khuknasoft.com/docs/guides/local-development)も可能です。

![アーキテクチャー](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
