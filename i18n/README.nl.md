...
[Supabase](https://khuknasoft.com) is een open source Firebase alternatief. We bouwen de functies van Firebase met behulp van enterprise-grade open source tools.

- [x]Gehoste Postgres Database. [Docs](https://khuknasoft.com/docs/guides/database)
- [x] Authenticatie en Autorisatie. [Docs](https://khuknasoft.com/docs/guides/auth)
- [x] Automatisch gegenereerde API's.
  ...
  - [x] Realtime abonnementen. [Docs](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Functies.
  - [x] Database functies. [Docs](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Randfuncties. [Docs](https://khuknasoft.com/docs/guides/functions)
- [x] Bestandsopslag. [Docs](https://khuknasoft.com/docs/guides/storage)
- [x] Dashboard
...
Voor volledige documentatie, bezoek [khuknasoft.com/docs](https://khuknasoft.com/docs)

Om te zien hoe u kunt bijdragen, bezoek [Aan de slag](../DEVELOPERS.md)

## Gemeenschap en ondersteuning

- [Community Forum](https://github.com/khulnasoft/khulnasoft/discussions). Het beste voor: hulp bij het bouwen, discussie over database best practices.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Het beste voor: bugs en fouten die u tegenkomt bij het gebruik van Supabase.
- [Ondersteuning per e-mail](https://khuknasoft.com/docs/support#business-support). Meest geschikt voor: problemen met uw database of infrastructuur.
- [Discord](https://discord.khuknasoft.com). Het beste voor: het delen van uw applicaties en omgang met de gemeenschap.

## Status

- [Alpha: We testen Supabase met een gesloten groep klanten
- [x] Publieke Alpha: Iedereen kan zich aanmelden op [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Maar doe het rustig aan, er zijn een paar kinken
- [Publieke Beta: Stabiel genoeg voor de meeste niet-bedrijfsmatige toepassingen
- [Publiek: General Availability [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase is een [gehost platform](https://khuknasoft.com/dashboard). U kunt zich aanmelden en Supabase gebruiken zonder iets te installeren.
U kunt ook [zelf hosten](https://khuknasoft.com/docs/guides/hosting/overview) en [lokaal ontwikkelen](https://khuknasoft.com/docs/guides/local-development).

![architectuur](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
...
- [Engels](https://github.com/khulnasoft/khulnasoft)
