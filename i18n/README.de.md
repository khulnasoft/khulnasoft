...
[Supabase](https://khuknasoft.com) ist eine Open-Source-Alternative zu Firebase. Wir bauen die Funktionen von Firebase mit Open-Source-Tools für Unternehmen auf.

- [x] Gehostete Postgres-Datenbank. [Docs](https://khuknasoft.com/docs/guides/database)
- [x] Authentifizierung und Autorisierung. [Docs](https://khuknasoft.com/docs/guides/auth)
- [x] Auto-generierte APIs.
  - [x] REST. [Docs](https://khuknasoft.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Docs](https://khuknasoft.com/docs/guides/api#graphql-api-overview)
  - [x] Echtzeit-Abonnements. [Docs](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funktionen.
  - [x] Datenbank-Funktionen. [Docs](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Edge-Funktionen [Docs](https://khuknasoft.com/docs/guides/functions)
- [x] Dateispeicher. [Docs](https://khuknasoft.com/docs/guides/storage)
- [x] Dashboard
...
Die vollständige Dokumentation finden Sie unter [khuknasoft.com/docs](https://khuknasoft.com/docs)

Wie Sie einen Beitrag leisten können, erfahren Sie unter [Erste Schritte](../DEVELOPERS.md)

## Gemeinschaft &amp; Unterstützung

- [Gemeinschaftsforum](https://github.com/khulnasoft/khulnasoft/discussions). Am besten geeignet für: Hilfe bei der Erstellung, Diskussion über bewährte Datenbankverfahren.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Am besten geeignet für: Bugs und Fehler, auf die Sie bei der Verwendung von Supabase stoßen.
- [E-Mail-Support](https://khuknasoft.com/docs/support#business-support). Am besten für: Probleme mit Ihrer Datenbank oder Infrastruktur.
- [Discord](https://discord.khuknasoft.com). Am besten geeignet für: Austausch von Anwendungen und Austausch mit der Community.

## Status

- [x] Alpha: Wir testen Supabase mit einer geschlossenen Gruppe von Kunden
- [x] Öffentliche Alpha: Jeder kann sich unter [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard) anmelden. Aber seien Sie nachsichtig mit uns, es gibt noch ein paar Macken
- [x] Öffentliche Beta: Stabil genug für die meisten nicht-unternehmerischen Anwendungsfälle
- [Öffentlich: Allgemeine Verfügbarkeit [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase ist eine [gehostete Plattform](https://khuknasoft.com/dashboard). Sie können sich anmelden und Supabase verwenden, ohne etwas zu installieren.
Sie können auch [selbst hosten](https://khuknasoft.com/docs/guides/hosting/overview) und [lokal entwickeln](https://khuknasoft.com/docs/guides/local-development).

![Architektur](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
...
- [Englisch](https://github.com/khulnasoft/khulnasoft)
