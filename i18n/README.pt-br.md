...
[Supabase](https://khuknasoft.com) é uma alternativa de código aberto ao Firebase. Estamos desenvolvendo os recursos do Firebase usando ferramentas de código aberto de nível empresarial.

- [x] Banco de dados Postgres hospedado. [Docs](https://khuknasoft.com/docs/guides/database)
...
- [x] Funções.
  - [x] Funções de banco de dados. [Docs](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Funções de borda [Docs](https://khuknasoft.com/docs/guides/functions)
- [x] Armazenamento de arquivos. [Docs](https://khuknasoft.com/docs/guides/storage)
- [x] AI + Vector/Toolkit de incorporações. [Docs](https://khuknasoft.com/docs/guides/ai)
- [x] Dashboard
...
Para obter a documentação completa, visite [khuknasoft.com/docs](https://khuknasoft.com/docs)

Para ver como contribuir, visite [Getting Started](../DEVELOPERS.md)

## Comunidade e suporte

- [Fórum da comunidade](https://github.com/khulnasoft/khulnasoft/discussions). Ideal para: ajuda na criação, discussão sobre práticas recomendadas de banco de dados.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Melhor para: bugs e erros que você encontra usando o Supabase.
- [Suporte por e-mail](https://khuknasoft.com/docs/support#business-support). Ideal para: problemas com seu banco de dados ou infraestrutura.
- [Discord](https://discord.khuknasoft.com). Ideal para: compartilhar seus aplicativos e interagir com a comunidade.
...
Supabase é uma [plataforma hospedada](https://khuknasoft.com/dashboard). Você pode se registrar e começar a usar o Supabase sem instalar nada.
Você também pode [auto-hospedar](https://khuknasoft.com/docs/guides/hosting/overview) e [desenvolver localmente](https://khuknasoft.com/docs/guides/local-development).

![Arquitetura](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
