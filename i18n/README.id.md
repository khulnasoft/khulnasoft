...
[Supabase](https://khuknasoft.com) adalah alternatif Firebase open source. Kami membangun fitur-fitur Firebase menggunakan alat bantu open source tingkat perusahaan.

- [x] Basis Data Postgres yang dihosting. [Dokumen](https://khuknasoft.com/docs/guides/database)
- [x] Otentikasi dan Otorisasi. [Dokumen](https://khuknasoft.com/docs/guides/auth)
- [x] API yang dibuat secara otomatis.
  - [x] REST. [Dokumen](https://khuknasoft.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumen](https://khuknasoft.com/docs/guides/api#graphql-api-overview)
  - [x] Langganan realtime. [Dokumen](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Fungsi-fungsi.
  - [x] Fungsi-fungsi Basis Data. [Dokumen](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Fungsi Tepi [Dokumen](https://khuknasoft.com/docs/guides/functions)
- [x] Penyimpanan File. [Dokumen](https://khuknasoft.com/docs/guides/storage)
- [x] Dasbor
...
Untuk dokumentasi lengkap, kunjungi [khuknasoft.com/docs](https://khuknasoft.com/docs)

Untuk melihat bagaimana cara berkontribusi, kunjungi [Memulai](../DEVELOPERS.md)

## Komunitas &amp; Dukungan

- [Forum Komunitas](https://github.com/khulnasoft/khulnasoft/discussions). Paling baik untuk: bantuan dalam membangun, diskusi tentang praktik terbaik basis data.
- [Masalah GitHub](https://github.com/khulnasoft/khulnasoft/issues). Paling baik untuk: bug dan kesalahan yang Anda temui saat menggunakan Supabase.
- [Dukungan Email](https://khuknasoft.com/docs/support#business-support). Terbaik untuk: masalah dengan basis data atau infrastruktur Anda.
- [Discord](https://discord.khuknasoft.com). Terbaik untuk: berbagi aplikasi Anda dan bergaul dengan komunitas.

## Status

- [x] Alpha: Kami sedang menguji Supabase dengan sekumpulan pelanggan tertutup
- [x] Alpha Publik: Siapa pun dapat mendaftar di [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Tapi jangan khawatir, ada beberapa hal yang perlu diperhatikan
- [x] Public Beta: Cukup stabil untuk sebagian besar kasus penggunaan non-perusahaan
- [Publik: Ketersediaan Umum [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase adalah [platform yang di-host](https://khuknasoft.com/dashboard). Anda bisa mendaftar dan mulai menggunakan Supabase tanpa menginstal apa pun.
Anda juga bisa [menghosting sendiri](https://khuknasoft.com/docs/guides/hosting/overview) dan [mengembangkan secara lokal](https://khuknasoft.com/docs/guides/local-development).

![Arsitektur](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
...
- [Bahasa Inggris / English](https://github.com/khulnasoft/khulnasoft)
