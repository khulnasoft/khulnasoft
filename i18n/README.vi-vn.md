...
[Supabase](https://khuknasoft.com) là một giải pháp mã nguồn mở thay thế cho Firebase. Chúng tôi đang sử dụng các công cụ mã nguồn mở đạt chuẩn doanh nghiệp để xây dựng các chức năng mà Firebase cung cấp.

- [x] Cơ sở dữ liệu Postgres tự quản lý. [Tài liệu](https://khuknasoft.com/docs/guides/database)
- [x] Xác thực và uỷ quyền. [Tài liệu](https://khuknasoft.com/docs/guides/auth)
- [x] APIs tự động khởi tạo.
  - [x] REST. [Tài liệu](https://khuknasoft.com/docs/guides/api#rest-api-overview)
  - [x] Lắng nghe thay đổi thời gian thực. [Tài liệu](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
  - [x] GraphQL (Thử nghiệm). [Tài liệu](https://khuknasoft.com/docs/guides/api#graphql-api-overview)
- [x] Chức năng hàm.
  - [x] Hàm dành cho cơ sở dữ liệu (Database functions). [Tài liệu](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Hàm được phân phối trên toàn cầu (Edge Functions). [Tài liệu](https://khuknasoft.com/docs/guides/functions)
- [x] Kho lưu trữ. [Tài liệu](https://khuknasoft.com/docs/guides/storage)
- [x] Bảng điều khiển
...
Để có tài liệu đầy đủ, hãy truy cập [khuknasoft.com/docs](https://khuknasoft.com/docs)

Để biết cách Đóng góp, hãy truy cập [Bắt đầu](../DEVELOPERS.md)

## Hỗ trợ & Cộng đồng

- [Diễn đàn cộng đồng](https://github.com/khulnasoft/khulnasoft/discussions). Tốt nhất cho: hỗ trợ xây dựng và thảo luận về các phương pháp tối ưu nhất dành cho cơ sở dữ liệu.
- [Các vấn đề trên GitHub](https://github.com/khulnasoft/khulnasoft/issues). Tốt nhất cho: các lỗi và "bugs" mà bạn gặp phải khi sử dụng Supabase.
- [Hỗ trợ qua email](https://khuknasoft.com/docs/support#business-support). Tốt nhất cho: các vấn đề với cơ sở dữ liệu hoặc cơ sở hạ tầng của bạn.
- [Discord](https://discord.khuknasoft.com). Tốt nhất cho: chia sẻ ứng dụng của bạn và dành thời gian với cộng đồng.

## Trạng thái

- [x] Alpha: Chúng tôi đang thử nghiệm Supabase với một nhóm người dùng kín
- [x] Public Alpha: Bất kỳ ai cũng có thể đăng ký tại [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Nhưng hãy bình tĩnh với chúng tôi, sẽ có một vài lỗi nhỏ.
...
Supabase là một [nền tảng lưu trữ cơ sở dữ liệu](https://khuknasoft.com/dashboard). Bạn có thể đăng ký và bắt đầu sử dụng Supabase mà không cần cài đặt bất kỳ thứ gì.
Bạn cũng có thể [tự quản lý](https://khuknasoft.com/docs/guides/hosting/overview) và [phát triển cục bộ](https://khuknasoft.com/docs/guides/local-development).

![Kiến trúc](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
