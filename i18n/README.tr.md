...
[Supabase](https://khuknasoft.com) açık kaynaklı bir Firebase alternatifidir. Kurumsal düzeyde açık kaynak araçları kullanarak Firebase'in özelliklerini geliştiriyoruz.

- [x] Barındırılan Postgres Veritabanı. [Dokümanlar](https://khuknasoft.com/docs/guides/database)
- [x] Kimlik Doğrulama ve Yetkilendirme. [Dokümanlar](https://khuknasoft.com/docs/guides/auth)
- [x] Otomatik oluşturulan API'ler.
  - [x] REST. [Dokümanlar](https://khuknasoft.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Docs](https://khuknasoft.com/docs/guides/api#graphql-api-overview)
  - [x] Gerçek zamanlı abonelikler. [Dokümanlar](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Fonksiyonlar.
  - [x] Veritabanı Fonksiyonları. [Dokümanlar](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Kenar İşlevleri [Dokümanlar](https://khuknasoft.com/docs/guides/functions)
- [x] Dosya Depolama. [Docs](https://khuknasoft.com/docs/guides/storage)
- [x] AI + Vektör / Gömme Araçları. [Dokümanlar](https://khuknasoft.com/docs/guides/ai)
- [x] Gösterge Tablosu
...
Belgelerin tamamı için [khuknasoft.com/docs](https://khuknasoft.com/docs) adresini ziyaret edin

Nasıl Katkıda bulunacağınızı görmek için [Başlarken](../DEVELOPERS.md) adresini ziyaret edin

## Topluluk ve Destek

- [Topluluk Forumu](https://github.com/khulnasoft/khulnasoft/discussions). Şunlar için en iyisi: oluşturma konusunda yardım, veritabanı en iyi uygulamaları hakkında tartışma.
- [GitHub Sorunları](https://github.com/khulnasoft/khulnasoft/issues). Supabase'i kullanırken karşılaştığınız hatalar ve hatalar için en iyisi.
- [E-posta Desteği](https://khuknasoft.com/docs/support#business-support). Veritabanınız veya altyapınızla ilgili sorunlar için en iyisi.
- [Discord](https://discord.khuknasoft.com). Uygulamalarınızı paylaşmak ve toplulukla takılmak için en iyisi.
...
Supabase [barındırılan bir platformdur](https://khuknasoft.com/dashboard). Supabase'e kaydolabilir ve hiçbir şey yüklemeden kullanmaya başlayabilirsiniz.
Ayrıca [self-host](https://khuknasoft.com/docs/guides/hosting/overview) ve [yerel olarak geliştirebilirsiniz](https://khuknasoft.com/docs/guides/local-development).

![Mimarlık](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
...
- [İngilizce](https://github.com/khulnasoft/khulnasoft)
