...
[Supabase](https://khuknasoft.com) és una alternativa de codi obert a Firebase. Estem construint les funcionalitats de Firebase usant eines de codi obert de nivell empresarial.
...
Per a veure la documentació completa, visita [khuknasoft.com/docs](https://khuknasoft.com/docs).

## Comunitat i suport

- [Fòrum de la comunitat](https://github.com/khulnasoft/khulnasoft/discussions). Millor per a: ajuda construint, discussions sobre les millors pràctiques de base de dades.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Millor per a: errors que et pots trobar utilitzant Supabase.
- [Suport per correu electrònic](https://khuknasoft.com/docs/support#business-*support). Millor per a: problemes amb la base de dades o infraestructura.
- [Discord](https://discord.khuknasoft.com). Millor per a: compartir les teves aplicacions i passar l’estona amb la comunitat.

## Estat

- [x] Alfa: Estem provant Supabase amb un cercle tancat de clients.
- [x] Alfa pública: Qualsevol pot registrar-se a [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Però sigues flexible amb nosaltres; encara poden existir obstacles.
...
Supabase és una [plataforma allotjada](https://khuknasoft.com/dashboard). Et pots registrar i començar a utilitzar Supabase sense instal·lar res. També podeu tenir una [_host_ pròpia](https://khuknasoft.com/docs/guides/hosting/overview) i [desenvolupar localment](https://khuknasoft.com/docs/guides/local-development).
...
| --------------------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`supabase-{lang}`** | [`JS`](https://github.com/khulnasoft/khulnasoft-js)  | [`C#`](https://github.com/khulnasoft/khulnasoft-csharp) \| [`Flutter`](https://github.com/khulnasoft/khulnasoft-Flutter) \| [`Python`](https://github.com/khulnasoft/khulnasoft-py) \| `Rust`                                          |
