...
[Supabase](https://khuknasoft.com) este o alternativă open source la Firebase. Construim caracteristicile Firebase folosind instrumente open source de nivel enterprise.

- [x] Baza de date Postgres găzduită. [Docs](https://khuknasoft.com/docs/guides/database)
- [x] Autentificare și autorizare. [Docs](https://khuknasoft.com/docs/guides/auth)
- [x] API-uri generate automat.
  ...
  - [x] Abonamente în timp real. [Docs](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funcții.
  - [x] Funcții de baze de date. [Docs](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Funcții de margine. [Docs](https://khuknasoft.com/docs/guides/functions)
- [x] Stocarea fișierelor. [Docs](https://khuknasoft.com/docs/guides/storage)
- [x] Tablou de bord
...
Pentru documentația completă, vizitați [khuknasoft.com/docs](https://khuknasoft.com/docs)

Pentru a vedea cum să contribui, vizitați [Getting Started](../DEVELOPERS.md)

## Comunitate și asistență

- [Community Forum](https://github.com/khulnasoft/khulnasoft/discussions). Cel mai bun pentru: ajutor la construcție, discuții despre cele mai bune practici în materie de baze de date.
- [Probleme GitHub](https://github.com/khulnasoft/khulnasoft/issues). Cel mai bun pentru: bug-uri și erori pe care le întâlniți folosind Supabase.
- [Email Support](https://khuknasoft.com/docs/support#business-support). Cel mai bun pentru: probleme cu baza de date sau cu infrastructura.
- [Discord](https://discord.khuknasoft.com). Cel mai bun pentru: împărtășirea aplicațiilor dvs. și petrecerea timpului cu comunitatea.

## Status

- [x] Alpha: Testăm Supabase cu un set închis de clienți
- [x] Public Alpha: Oricine se poate înscrie la [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Dar fiți blânzi cu noi, există câteva probleme
- [x] Public Beta: Suficient de stabilă pentru majoritatea cazurilor de utilizare non-întreprindere
- [ ] Public: Disponibilitate generală [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase este o [platformă găzduită](https://khuknasoft.com/dashboard). Vă puteți înscrie și puteți începe să utilizați Supabase fără a instala nimic.
Puteți, de asemenea, [auto-hosting](https://khuknasoft.com/docs/guides/hosting/overview) și [dezvolta local](https://khuknasoft.com/docs/guides/local-development).

![Arhitectură](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
