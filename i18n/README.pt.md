...
[Supabase](https://khuknasoft.com) é uma alternativa de código aberto ao Firebase. Estamos reproduzindo as funcionalidades do Firebase usando ferramentas de código aberto de nível empresarial.
...
Para ver a documentação completa, visite [khuknasoft.com/docs](https://khuknasoft.com/docs)

## Comunidade & Suporte

- [Fórum da comunidade](https://github.com/khulnasoft/khulnasoft/discussions). Indicado para: ajuda no desenvolvimento, discussão sobre as melhores práticas de base de dados.
- [Problemas do GitHub](https://github.com/khulnasoft/khulnasoft/issues). Indicado para: bugs e erros que tu encontrares ao usar o Supabase.
- [Suporte por e-mail](https://khuknasoft.com/docs/support#business-support). Indicado para: problemas com a tua base de dados ou infraestrutura.

## Status

- [x] Alpha: estamos a testar o Supabase com um grupo fechado de clientes
- [x] Alpha Público: Qualquer pessoa pode se inscrever em [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Mas vai com calma, ainda existem alguns problemas.
...
Supabase é uma [plataforma hospedada](https://khuknasoft.com/dashboard). Podes-te inscrever e começar a usar o Supabase sem instalar nada. Ainda estamos a criar a experiência de desenvolvimento local - esse é nosso foco atual, juntamente com a estabilidade da plataforma.
