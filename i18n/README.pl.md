...
[Supabase](https://khuknasoft.com) to alternatywa dla Firebase o otwartym kodzie źródłowym. Tworzymy funkcje Firebase przy użyciu narzędzi open source klasy korporacyjnej.

- [x] hostowana baza danych Postgres [x]. [Dokumenty](https://khuknasoft.com/docs/guides/database)
- [x] uwierzytelnianie i autoryzacja [x]. [Dokumenty](https://khuknasoft.com/docs/guides/auth)
- [x] Automatycznie generowane interfejsy API.
  ...
  - [x] Subskrypcje w czasie rzeczywistym. [Docs](https://khuknasoft.com/docs/guides/api#realtime-api-overview)
- [x] Funkcje.
  - [x] Funkcje bazy danych. [Docs](https://khuknasoft.com/docs/guides/database/functions)
  - [x] Funkcje brzegowe [Docs](https://khuknasoft.com/docs/guides/functions)
- przechowywanie plików [x]. [Docs](https://khuknasoft.com/docs/guides/storage)
- [Pulpit nawigacyjny
...
Pełna dokumentacja znajduje się na stronie [khuknasoft.com/docs](https://khuknasoft.com/docs)

Aby zobaczyć, jak wnieść swój wkład, odwiedź [Getting Started](../DEVELOPERS.md)

## Społeczność i wsparcie

- [Forum społeczności](https://github.com/khulnasoft/khulnasoft/discussions). Najlepsze do: pomocy w budowaniu, dyskusji o najlepszych praktykach dotyczących baz danych.
- [GitHub Issues](https://github.com/khulnasoft/khulnasoft/issues). Najlepszy do: błędów i błędów napotkanych podczas korzystania z Supabase.
- [Email Support](https://khuknasoft.com/docs/support#business-support). Najlepsze w przypadku: problemów z bazą danych lub infrastrukturą.
- [Discord](https://discord.khuknasoft.com). Najlepszy do: dzielenia się aplikacjami i spędzania czasu ze społecznością.

## Status

- [x] Alpha: Testujemy Supabase z zamkniętą grupą klientów
- [x] Publiczna wersja alfa: Każdy może zarejestrować się na stronie [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard). Ale spokojnie, jest kilka niedociągnięć
- [x] Publiczna beta: Wystarczająco stabilna dla większości przypadków użycia innych niż korporacyjne
- [] Public: Ogólna dostępność [[status](https://khuknasoft.com/docs/guides/getting-started/features#feature-status)]
...
Supabase jest [platformą hostowaną](https://khuknasoft.com/dashboard). Możesz zarejestrować się i zacząć korzystać z Supabase bez instalowania czegokolwiek.
Możesz także [self-host](https://khuknasoft.com/docs/guides/hosting/overview) i [rozwijać lokalnie](https://khuknasoft.com/docs/guides/local-development).

![Architektura](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/public/img/supabase-architecture.svg)
...
- [angielski](https://github.com/khulnasoft/khulnasoft)
