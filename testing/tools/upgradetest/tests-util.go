...
// Known bug versions
// versions 4.1.0 to v4.4.2 are affected by a known bug in MVU if initialized in these versions: https://github.com/khulnasoft/khulnasoft/pull/46969
...
func validateDBs(ctx context.Context, test *Test, version, migratorImage, networkName string, dbs []*testDB, postUpgrade bool) error {
	...
	if postUpgrade && ctx.Value(postReleaseKey{}) == "" {
		...
		// example schema check target: https://raw.githubusercontent.com/khulnasoft/khulnasoft/7648573357fef049e1a0bf11f400068ef83f2596/internal/database/schema.json
