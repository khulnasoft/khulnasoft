...
github.contributors.%:
	curl -sS https://api.github.com/repos/khulnasoft/$*/contributors \
...
github.contributors: \
	github.contributors.khulnasoft \
	github.contributors.khulnasoft-js \
	github.contributors.khulnasoft-py \
	github.contributors.khulnasoft-flutter \
	github.contributors.khulnasoft-dart

github.issues:
	curl -sS https://api.github.com/repos/khulnasoft/khulnasoft/issues \
...
.PHONY: github.repos
github.repos: \
	github.repos.khulnasoft \
	github.repos.realtime  \
	github.repos.postgres \
	github.repos.postgres-meta

github.repos.%:
	curl -sS https://api.github.com/repos/khulnasoft/$* \
