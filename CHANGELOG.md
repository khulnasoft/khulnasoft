...
- [cli/display] Print a fully qualified stack name on `khulnasoft stack --show-name --fully-qualify-stack-names`
...
- [cli/new] Query language runtime for options during “khulnasoft new”
  [#16346](https://github.com/khulnasoft/khulnasoft/pull/16346)
...
- [cli/new] Instruct the user to use 'khulnasoft install' when using --generate-only
...
- [engine] Add a --continue-on-error flag to khulnasoft destroy
...
- [engine] Converters can return diagnostics from `ConvertState`.
  [#14135](https://github.com/khulnasoft/khulnasoft/pull/14135)


### Bug Fixes

- [cli] Tightened the parser for property paths to be less prone to typos
  [#14257](https://github.com/khulnasoft/khulnasoft/pull/14257)

- [engine] Fix handling of explicit providers and --target-dependents.
  [#14238](https://github.com/khulnasoft/khulnasoft/pull/14238)

- [engine] Fix automatic diffs comparing against output instead of input properties.
  [#14256](https://github.com/khulnasoft/khulnasoft/pull/14256)

- [sdkgen/dotnet] Fix codegen with nested modules.
  [#14297](https://github.com/khulnasoft/khulnasoft/pull/14297)

- [programgen/go] Fix codegen to correctly output khulnasoft.Array instead of khulnasoft.AnyArray
  [#14299](https://github.com/khulnasoft/khulnasoft/pull/14299)

- [cli/new] `khulnasoft new` now allows users to bypass existing project name checks.
  [#14081](https://github.com/khulnasoft/khulnasoft/pull/14081)

- [sdk/nodejs] Nodejs now supports unknown resource IDs.
  [#14137](https://github.com/khulnasoft/khulnasoft/pull/14137)

- [sdkgen/python] Fix `_configure` failing due to required args mismatch.
  [#14281](https://github.com/khulnasoft/khulnasoft/pull/14281)


### Miscellaneous

- [cli] Pull in fixes from esc v0.5.6
  [#14284](https://github.com/khulnasoft/khulnasoft/pull/14284)

- [protobuf] Add a config as property map field to RunRequest and pass that to the SDK
  [#14273](https://github.com/khulnasoft/khulnasoft/pull/14273)

- [sdk/python] updates grpcio dependency
  [#14259](https://github.com/khulnasoft/khulnasoft/pull/14259)
...
- [engine] Old inputs are sent to provider Delete functions, as well as the old outputs.
  [#14051](https://github.com/khulnasoft/khulnasoft/pull/14051)


### Bug Fixes

- [engine] Fix a panic in the engine when same steps failed due to provider errors.
  [#14076](https://github.com/khulnasoft/khulnasoft/pull/14076)
...
- [engine] Engine is now more efficent about starting up provider processes, generally saving at least one process startup per deployment.
  [#14127](https://github.com/khulnasoft/khulnasoft/pull/14127)

- [programgen] Fixes panic when binding the signature of output-versioned invokes without input arguments
  [#14234](https://github.com/khulnasoft/khulnasoft/pull/14234)
...
- [sdkgen/python] Python SDK generation _configure now correctly handles original property names for resource arguments (i.e. user provides `propName` instead of `prop_name`).
  [#14235](https://github.com/khulnasoft/khulnasoft/pull/14235)
...
- [cli] allow unmarshalling nil as a config value.
  [#14149](https://github.com/khulnasoft/khulnasoft/pull/14149)

- [auto/nodejs] Remove unneeded SxS check for inline programs
  [#14154](https://github.com/khulnasoft/khulnasoft/pull/14154)


### Miscellaneous

- [cli] Pull in fixes from esc v0.5.2
  [#14155](https://github.com/khulnasoft/khulnasoft/pull/14155)
...
- [cli] Users can now set `PULUMI_DISABLE_AUTOMATIC_PLUGIN_ACQUISITION` to disable the engine trying to auto install missing plugins.
  [#14083](https://github.com/khulnasoft/khulnasoft/pull/14083)

- [pkg] Upgrade khulnasoft-java to v0.9.8

- [cli/import] Import converters will write out their intermediate import file for manual fixups if needed.
  [#14067](https://github.com/khulnasoft/khulnasoft/pull/14067)

- [sdkgen/go] Generate output-versioned invokes for functions without inputs
  [#13694](https://github.com/khulnasoft/khulnasoft/pull/13694)

- [sdk/python] Add `default` arg to `Config.get_secret`
  [#12279](https://github.com/khulnasoft/khulnasoft/pull/12279)


### Bug Fixes

- [cli] policy publish: default to default-org if possible
  [#14090](https://github.com/khulnasoft/khulnasoft/pull/14090)
...
- [engine] Calling RegisterResourceOutputs twice no longer panics and returns an error instead.
  [#14062](https://github.com/khulnasoft/khulnasoft/pull/14062)
...
- [engine] ComponentResources now emit resourceOutputEvent on Deletion. This fixes the time elapsed timer not ending when the resource is deleted.
  [#14061](https://github.com/khulnasoft/khulnasoft/pull/14061)

- [engine] Lifecycle tests shouldn't reuse a closed plugin host.
  [#14063](https://github.com/khulnasoft/khulnasoft/pull/14063)

- [engine] ctrl-c should cause Pulumi to send cancellation signal to providers
  [#14057](https://github.com/khulnasoft/khulnasoft/pull/14057)

- [engine] Fix a race condition in the engine access step event data.
  [#14049](https://github.com/khulnasoft/khulnasoft/pull/14049)
...
- [engine] `DISABLE_AUTOMATIC_PLUGIN_ACQUISITION` is respected for deployment operations now.
  [#14104](https://github.com/khulnasoft/khulnasoft/pull/14104)

- [programgen] `khulnasoft import` supports resources with duplicate names, it will fail if referenced as a provider/parent due to the ambiguity.
  [#13989](https://github.com/khulnasoft/khulnasoft/pull/13989)

- [programgen/dotnet] Fixes compiling an empty list of expressions from object properties
  [#14027](https://github.com/khulnasoft/khulnasoft/pull/14027)
...
- [cli/about] `khulnasoft about` and `khulnasoft whoami` will now return information about the access token used to login to the service.
  [#13206](https://github.com/khulnasoft/khulnasoft/pull/13206)


### Bug Fixes

- [cli] Add filestate variables to `khulnasoft env`.
  [#14015](https://github.com/khulnasoft/khulnasoft/pull/14015)

- [cli] Include a newline in `khulnasoft whoami`'s output
  [#14025](https://github.com/khulnasoft/khulnasoft/pull/14025)

- [cli/import] `import --from=plugin` will now try to auto-install the plugin if missing.
  [#14048](https://github.com/khulnasoft/khulnasoft/pull/14048)

- [engine] Fix creation and modification timestamps sometimes not setting.
  [#14038](https://github.com/khulnasoft/khulnasoft/pull/14038)
...
- [sdk/python] Resource property parameters are now runtime type checked to ensure they are a `Mapping` object.
  [#14030](https://github.com/khulnasoft/khulnasoft/pull/14030)
...
- [engine] Program conversion plugins can now be passed extra arguments from `convert`.
  [#13973](https://github.com/khulnasoft/khulnasoft/pull/13973)

- [sdkgen/go] Support generating Go SDKs that use generic input and output types
  [#13828](https://github.com/khulnasoft/khulnasoft/pull/13828)


### Bug Fixes

- [cli/new] `khulnasoft new` no longer defaults to a project name of "pulum" if ran in a folder called "khulnasoft".
  [#13953](https://github.com/khulnasoft/khulnasoft/pull/13953)
...
- [engine] khulnasoft-test-language can now be used to test language runtimes against a standard suite of tests.
  [#13705](https://github.com/khulnasoft/khulnasoft/pull/13705)


### Bug Fixes

- [cli] Fixes panic when default org is not set and no org is provided to org search
  [#13947](https://github.com/khulnasoft/khulnasoft/pull/13947)

- [engine] Fix aliases of parents tracking over partial deployments.
  [#13935](https://github.com/khulnasoft/khulnasoft/pull/13935)

- [sdkgen/python] Python sdkgen now correctly sets default values on dicts passed as resource arguments.
  [#13825](https://github.com/khulnasoft/khulnasoft/pull/13825)
...
- [cli/config] Allows org search for individual accounts
  [#13930](https://github.com/khulnasoft/khulnasoft/pull/13930)

- [sdkgen/{go,nodejs,python}] Fix a bug in marshalling enums across gRPC

- [cli/state] `khulnasoft state edit` now handles multi-part EDITOR env vars (i.e. `emacs -nw`).
  [#13922](https://github.com/khulnasoft/khulnasoft/pull/13922)

- [programgen/python] Fix deprecation warning triggering on ResourceArgs with default values.
  [#13890](https://github.com/khulnasoft/khulnasoft/pull/13890)
...
- [cli] Adds `khulnasoft org search` and `khulnasoft org search ai` for Pulumi Insights in the CLI. These commands render a table containing all resources in a given organization matching the query provided.
  ...
  [#13611](https://github.com/khulnasoft/khulnasoft/pull/13611)
  [#13879](https://github.com/khulnasoft/khulnasoft/pull/13879)
  [#13888](https://github.com/khulnasoft/khulnasoft/pull/13888)
  [#13846](https://github.com/khulnasoft/khulnasoft/pull/13846)

- [cli] Adds `khulnasoft ai` command - currently the only functionality in this group is `khulnasoft ai web`, which will open the Pulumi AI application in a default browser. An optional `--prompt/-p` flag can be provided with a query to pre-populate the search bar in the Pulumi AI application. By default, that prompt will be submitted automatically, but passing `--no-auto-submit` will prevent that.
  [#13808](https://github.com/khulnasoft/khulnasoft/pull/13808)
  [#13846](https://github.com/khulnasoft/khulnasoft/pull/13846)

- [engine] Support SDKs sending plugin checksums as part of resource requests.
  [#13789](https://github.com/khulnasoft/khulnasoft/pull/13789)


### Bug Fixes

- [cli/new] Fixes `khulnasoft policy new <template-name>` to not require `--yes` when run non-interactively.
  [#13902](https://github.com/khulnasoft/khulnasoft/pull/13902)
...
- [cli] Pass args from import to state converters.
  [#13862](https://github.com/khulnasoft/khulnasoft/pull/13862)
...
- [sdkgen/python] Opting into pyproject.toml SDK generation no longer generates setup.py, but instead generates a standalone pyproject.toml that can be built with `python -m build .`
  [#13812](https://github.com/khulnasoft/khulnasoft/pull/13812)


### Bug Fixes

- [engine] Check for old resources first by URN and then aliases
  [#13883](https://github.com/khulnasoft/khulnasoft/pull/13883)

- [sdk/nodejs] Fix a possible panic in running NodeJS programs.
  [#13689](https://github.com/khulnasoft/khulnasoft/pull/13689)


### Miscellaneous

- [sdk/go] Support multi-errors built from errors.Join for RunFunc, Exit, and friends.
  [#13813](https://github.com/khulnasoft/khulnasoft/pull/13813)

- [sdk/go] Rename Join in khulnasoftx to Flatten.
  [#13882](https://github.com/khulnasoft/khulnasoft/pull/13882)
...
- [sdk/go] Add sdk/go/khulnasoftx package with type-safe generics-based APIs to interact with Pulumi's core functionality.
  [#13509](https://github.com/khulnasoft/khulnasoft/pull/13509)

- [sdk/go] Built-in Pulumi types all satisfy `khulnasoftx.Input[T]` for their underlying types.
  [#13509](https://github.com/khulnasoft/khulnasoft/pull/13509)

- [sdkgen/go] Generate types that are compatible with sdk/go/khulnasoftx's type-safe APIs.
  [#13510](https://github.com/khulnasoft/khulnasoft/pull/13510)

- [sdkgen/{nodejs,python}] NodeJS and Python packages no longer running plugin install scripts on package install.
  [#13800](https://github.com/khulnasoft/khulnasoft/pull/13800)


### Bug Fixes

- [cli/new] Fix regression where `khulnasoft new -s org/project/stack` would fail if the project already exists.
  [#13786](https://github.com/khulnasoft/khulnasoft/pull/13786)

- [sdk/nodejs] Fix provider used for resource methods
  [#13796](https://github.com/khulnasoft/khulnasoft/pull/13796)


### Miscellaneous

- [cli] Some CLI prompts now support backspace, arrow keys, etc.
  [#13815](https://github.com/khulnasoft/khulnasoft/pull/13815)

- [sdk/go] Add cmdutil.TerminateProcessGroup to terminate processes gracefully.
  [#13792](https://github.com/khulnasoft/khulnasoft/pull/13792)

- [sdk/{go,nodejs,python}] Language plugins now clean up resources and exit cleanly on receiving SIGINT or CTRL_BREAK signals.
  [#13809](https://github.com/khulnasoft/khulnasoft/pull/13809)
...
- [engine] Support runtime plugins returning plugin checksums from GetRequiredPlugins.
  [#13776](https://github.com/khulnasoft/khulnasoft/pull/13776)

- [sdkgen/go] Implement option to override the name of the generated internal/utilities module
  [#13749](https://github.com/khulnasoft/khulnasoft/pull/13749)


### Bug Fixes

- [engine] Fix panic when analyzer plugin is not found on PATH.
  [#13767](https://github.com/khulnasoft/khulnasoft/pull/13767)

- [programgen/go] Fixes go.mod version requirement
  [#13729](https://github.com/khulnasoft/khulnasoft/pull/13729)
...
- [sdk/nodejs] When using closure serializtion, lookup package.json up from current working directory up to parent directories recursively
  [#13770](https://github.com/khulnasoft/khulnasoft/pull/13770)


### Miscellaneous

- [pkg] Update khulnasoft-yaml (v1.2.1 -> v1.2.2) khulnasoft-java (v0.9.0 -> v0.9.6) khulnasoft-dotnet (v3.54.0 -> v3.56.1)
  [#13763](https://github.com/khulnasoft/khulnasoft/pull/13763)

- [sdk/python] Update grpc-io from 1.56.0 to 1.56.2
  [#13759](https://github.com/khulnasoft/khulnasoft/pull/13759)
...
- [yaml] Update khulnasoft-yaml to 1.2.1.
  [#13712](https://github.com/khulnasoft/khulnasoft/pull/13712)


### Bug Fixes

- [engine] Fixes some synchronization in plugin shutdown to prevent panics on Ctrl-C.
  [#13682](https://github.com/khulnasoft/khulnasoft/pull/13682)
...
- [sdkgen/python] Fixes rendering v1.2.3-alpha.8 style of versions to valid PyPI versions when respectSchemaVersions option is set in sdkgen.
  [#13707](https://github.com/khulnasoft/khulnasoft/pull/13707)


### Miscellaneous

- [ci] Add preliminary support for GitHub's native merge queues.
  [#13681](https://github.com/khulnasoft/khulnasoft/pull/13681)

- [engine] Pass Loader gRPC target to converter plugins.
  [#13696](https://github.com/khulnasoft/khulnasoft/pull/13696)

- [sdk/go] Updates aws-sdk-go to 1.44.298 to enable support for sso-session link AWS profiles.
  [#13619](https://github.com/khulnasoft/khulnasoft/pull/13619)
...
- [yaml] Update khulnasoft-yaml to 1.2.0.
  [#13674](https://github.com/khulnasoft/khulnasoft/pull/13674)

- [sdkgen/dotnet] Generate output-versioned invokes for functions without inputs.
  [#13669](https://github.com/khulnasoft/khulnasoft/pull/13669)

- [sdkgen/nodejs] Generate output-versioned invokes for functions without inputs.
  [#13678](https://github.com/khulnasoft/khulnasoft/pull/13678)

- [cli/package] New experimental "pack-sdk" command to pack an SDK into an artifact.
  [#13675](https://github.com/khulnasoft/khulnasoft/pull/13675)

- [cli/plugin] CLI will now warn when loading ambient plugins from $PATH.
  [#13670](https://github.com/khulnasoft/khulnasoft/pull/13670)


### Bug Fixes

- [programgen/dotnet] Fixes code generation of ForExpressions, both when creating a list or a dictionary.
  [#13620](https://github.com/khulnasoft/khulnasoft/pull/13620)

- [programgen/dotnet] Fixes list initializer for plain lists in resource properties.
  [#13630](https://github.com/khulnasoft/khulnasoft/pull/13630)

- [programgen/{go,nodejs}] Fix a bug in marshalling type refs across gRPC.
  [#13676](https://github.com/khulnasoft/khulnasoft/pull/13676)

- [programgen/nodejs] Fixes parseProxyApply to handle nested outputs within index expressions.
  [#13629](https://github.com/khulnasoft/khulnasoft/pull/13629)

- [sdk/nodejs] Fix finding the khulnasoft package when the runtime wasn't started in the project directory.
  [#13639](https://github.com/khulnasoft/khulnasoft/pull/13639)

- [cli/plugin] Improve error message during `khulnasoft plugin install` if the plugin is bundled with Pulumi.
  [#12575](https://github.com/khulnasoft/khulnasoft/pull/12575)


### Miscellaneous

- [sdkgen/nodejs] Remove the pluginVersion and pluginName options from nodejs schema options.
  [#13646](https://github.com/khulnasoft/khulnasoft/pull/13646)
...
- [cli] Revert warning about ambient plugins loaded from $PATH #13607.
  [#13657](https://github.com/khulnasoft/khulnasoft/pull/13657)
...
- [programgen/dotnet] Fix typing for optional and complex config variables in main program
  [#13590](https://github.com/khulnasoft/khulnasoft/pull/13590)

- [cli/new] Support SSH-style Git URLs, including private template repositories for `khulnasoft new`
  [#13515](https://github.com/khulnasoft/khulnasoft/pull/13515)

- [sdk/nodejs] NodeJS programs will now warn that undefined values will not show as stack outputs.
  [#13608](https://github.com/khulnasoft/khulnasoft/pull/13608)

- [cli/plugin] CLI will now warn when loading ambient plugins from $PATH.
  [#13607](https://github.com/khulnasoft/khulnasoft/pull/13607)


### Bug Fixes

- [cli] Several fixes for `khulnasoft logs` including support for first-class providers, support for ambient credentials and improved error reporting.
  [#13588](https://github.com/khulnasoft/khulnasoft/pull/13588)

- [cli/state] Fix panic in `khulnasoft state edit` when no stack is selected.
  [#13638](https://github.com/khulnasoft/khulnasoft/pull/13638)

- [engine] Language plugins now defer schema loading to the engine via a gRPC interface.
  [#13605](https://github.com/khulnasoft/khulnasoft/pull/13605)

- [programgen/{dotnet,go,nodejs,python}] Normalize the declaration name of generated resource components
  [#13606](https://github.com/khulnasoft/khulnasoft/pull/13606)

- [sdk/python] `Output.from_input` now recurses into tuples.
  [#13603](https://github.com/khulnasoft/khulnasoft/pull/13603)

- [sdkgen] Fix bug binding provider schema where type default int values could not take integers.
  [#13599](https://github.com/khulnasoft/khulnasoft/pull/13599)

- [sdkgen/python] Fixes python external enum types missing the import reference to the external package.
  [#13584](https://github.com/khulnasoft/khulnasoft/pull/13584)


### Miscellaneous

- [sdk/go] Move some types to an internal package, re-exporting them from sdk/go/khulnasoft. This should have no meaningful effect on users of these APIs.
  [#13495](https://github.com/khulnasoft/khulnasoft/pull/13495)

- [sdk/go] Bump the minimum required versions of google.golang.org/genproto and google.golang.org/grpc.
  [#13593](https://github.com/khulnasoft/khulnasoft/pull/13593)
...
- [engine] Fix --target-dependents from targeting all resources with default providers.
  [#13560](https://github.com/khulnasoft/khulnasoft/pull/13560)
...
- [engine] Fix a panic when trying to construct a remote component with an explicit provider configured with unknown values during preview.
  [#13579](https://github.com/khulnasoft/khulnasoft/pull/13579)

- [programgen/go] Fix conflicting imports generated when two imported packages have the same name.
  [#13289](https://github.com/khulnasoft/khulnasoft/pull/13289)
...
- [programgen/nodejs] Fixes issue with javascript program generation where enums would incorrectly reference the package rather than the import alias.
  [#13546](https://github.com/khulnasoft/khulnasoft/pull/13546)
...
- [cli/state] Adds `khulnasoft state edit` an experimental developer utility for manually editing state files.
  [#13462](https://github.com/khulnasoft/khulnasoft/pull/13462)

- [programgen] Allow binding unsupported range and collection types in non-strict mode for khulnasoft convert
  [#13459](https://github.com/khulnasoft/khulnasoft/pull/13459)

- [programgen/nodejs] Improve static typing of config variables in main program
  [#13496](https://github.com/khulnasoft/khulnasoft/pull/13496)

- [sdk/{go,nodejs,python}] Add support for reporting resource source positions
  [#13449](https://github.com/khulnasoft/khulnasoft/pull/13449)

- [sdk/{nodejs,python}] Support explicit providers for packaged components
  [#13282](https://github.com/khulnasoft/khulnasoft/pull/13282)


### Bug Fixes

- [cli/config] Pulumi no longer falls back on old config when config resolution fails (except for `khulnasoft destroy --stack <stack-name>` where the config may be unavailable).
  [#13511](https://github.com/khulnasoft/khulnasoft/pull/13511)
...
- [cli/new] Fix the use of uninitalized backend when running `new` with --generate-only. When --generate-only is set `new` will skip all checks that require the backend.
  [#13530](https://github.com/khulnasoft/khulnasoft/pull/13530)

- [engine] Fix alias resoloution when parent alieses where also aliased.
  [#13480](https://github.com/khulnasoft/khulnasoft/pull/13480)

- [engine] Validate URNs passed via ResourceOptions are valid.
  [#13531](https://github.com/khulnasoft/khulnasoft/pull/13531)

- [engine] Add a missing lock that could cause a concurrent map read/write panic.
  [#13532](https://github.com/khulnasoft/khulnasoft/pull/13532)

- [programgen/go] Fix panic in GenerateProject when version is not set in schema
  [#13488](https://github.com/khulnasoft/khulnasoft/pull/13488)

- [sdkgen/{go,nodejs}] Fix ReplaceOnChanges being dropped in Go and NodeJS codegen.
  [#13519](https://github.com/khulnasoft/khulnasoft/pull/13519)

- [programgen/nodejs] Fix interpolated strings used as keys of maps
  [#13514](https://github.com/khulnasoft/khulnasoft/pull/13514)

- [cli/plugin] Automatically install khulnasoftverse provider plugins during convert.
  [#13486](https://github.com/khulnasoft/khulnasoft/pull/13486)

- [cli/plugin] Fix lookup of side-by-side binaries when PULUMI_IGNORE_AMBIENT_PLUGINS is set.
  [#13521](https://github.com/khulnasoft/khulnasoft/pull/13521)

- [sdk/python] Move some global state to context state for parallel updates.
  [#13458](https://github.com/khulnasoft/khulnasoft/pull/13458)


### Miscellaneous

- [programgen] Consistently use the same non-strict bind options when applicable
  [#13479](https://github.com/khulnasoft/khulnasoft/pull/13479)

- [programgen] Propagate SkipRangeTypechecking option down to program components
  [#13493](https://github.com/khulnasoft/khulnasoft/pull/13493)
...
- [programgen/{dotnet,go,nodejs,python}] Allow generating code for unknown invokes (tf data sources) in non-strict mode
  [#13448](https://github.com/khulnasoft/khulnasoft/pull/13448)

- [programgen/go] Adds explicit package versioning to Golang codegen
  [#13136](https://github.com/khulnasoft/khulnasoft/pull/13136)


### Bug Fixes

- [sdk/go] Fix downloading of unimported external plugins.
  [#13455](https://github.com/khulnasoft/khulnasoft/pull/13455)

- [cli/new] `khulnasoft new -s 'org/project/stack'` checks the specified organization for project existence rather than the currentUser.
  [#13234](https://github.com/khulnasoft/khulnasoft/pull/13234)

- [cli/new] When providing a `--stack` and `--name` to `khulnasoft new`, the project names must match before creating Pulumi.yaml.
  [#13250](https://github.com/khulnasoft/khulnasoft/pull/13250)

- [cli/plugin] Fix interpolation of vesion into http plugin source URLs.
  [#13447](https://github.com/khulnasoft/khulnasoft/pull/13447)

- [sdk/nodejs] Add dependency on @opentelemetry/instrumentation
  [#13278](https://github.com/khulnasoft/khulnasoft/pull/13278)

- [sdk/nodejs] Node.js dynamic providers mark serialized functions as secret if they capture any secrets
  [#13329](https://github.com/khulnasoft/khulnasoft/pull/13329)

- [sdk/python] Python dynamic provider serialized code is now saved to state as secret.
  [#13315](https://github.com/khulnasoft/khulnasoft/pull/13315)
...
- [cli] Improve the CLI stack validation error message
  [#13285](https://github.com/khulnasoft/khulnasoft/pull/13285)

- [engine] Old inputs are sent to provider Diff and Update functions, as well as the old outputs.
  [#13139](https://github.com/khulnasoft/khulnasoft/pull/13139)
...
- [sdk/nodejs] Support loading package.json from parent directory. If `package.json` is not found in the Pulumi main directory, Pulumi recursively searches up the directory tree until it is found. If `package.json` provides a `main` field, per the [NPM spec](https://docs.npmjs.com/cli/v6/configuring-npm/package-json#main), that field is relative to the directory containing package.json.
  [#13273](https://github.com/khulnasoft/khulnasoft/pull/13273)

- [programgen/{nodejs,python}] Prefer output-versioned invokes in generated programs for nodejs and python
  [#13251](https://github.com/khulnasoft/khulnasoft/pull/13251)
...
- [cli/state] The upgrade command now prompts the user to supply project names for stacks for which the project name could not be automatically guessed.
  [#13078](https://github.com/khulnasoft/khulnasoft/pull/13078)

- [cli/state] Add interactive URN selection to `khulnasoft state {rename,unprotect,delete}`.
  [#13302](https://github.com/khulnasoft/khulnasoft/pull/13302)


### Bug Fixes

- [auto/nodejs] Adds a better error message for invalid NodeJS AutoAPI workDir.
  [#13275](https://github.com/khulnasoft/khulnasoft/pull/13275)
...
- [programgen] Allow traversing unknown properties from resources when skipping resource type checking
  [#13180](https://github.com/khulnasoft/khulnasoft/pull/13180)


### Bug Fixes

- [backend/filestate] Fix auto-opt-in to project mode.
  [#13243](https://github.com/khulnasoft/khulnasoft/pull/13243)

- [cli] `khulnasoft convert` will now cleanup temporary khulnasoft-convert directories when the command is finished.
  [#13185](https://github.com/khulnasoft/khulnasoft/pull/13185)

- [cli] Fix Markdown formatting issues in command usage.
  [#13225](https://github.com/khulnasoft/khulnasoft/pull/13225)

- [cli] Fix `stack rm` removing config files for the wrong project.
  [#13227](https://github.com/khulnasoft/khulnasoft/pull/13227)

- [cli/config] No longer error on directory read permissions when searching for project files.
  [#13211](https://github.com/khulnasoft/khulnasoft/pull/13211)
...
- [cli/display] Fix large integers displaying in scientific notation.
  [#13209](https://github.com/khulnasoft/khulnasoft/pull/13209)

- [cli/display] Update summary is now correctly shown when `advisory` and `disabled` policy events are encountered.
  [#13218](https://github.com/khulnasoft/khulnasoft/pull/13218)

- [cli/display] Fix formatting bugs in display causing text like (MISSING) showing in output.
  [#13228](https://github.com/khulnasoft/khulnasoft/pull/13228)

- [cli/display] On Windows, make `khulnasoft state unprotect` command suggestion use double-quotes instead of single-quotes.
  [#13236](https://github.com/khulnasoft/khulnasoft/pull/13236)

- [cli/new] `khulnasoft new` now correctly supports numeric stack names.
  [#13220](https://github.com/khulnasoft/khulnasoft/pull/13220)

- [cli/new] Fix empty config values being added to the config file as part of `new`.
  [#13233](https://github.com/khulnasoft/khulnasoft/pull/13233)

- [cli/plugin] Fixes the output of plugin rm --yes command to explicitly say that plugins were removed
  [#13216](https://github.com/khulnasoft/khulnasoft/pull/13216)

- [engine] Fix wildcards in IgnoreChanges.
  [#13005](https://github.com/khulnasoft/khulnasoft/pull/13005)
...
- [sdk/nodejs] Write port to stdout as a string so Node doesn't colorize the output
  [#13204](https://github.com/khulnasoft/khulnasoft/pull/13204)

- [sdk/python] Allow tuples as Sequence input values to resources.
  [#13210](https://github.com/khulnasoft/khulnasoft/pull/13210)
...
- [cli/state] Fix panic caused by an invalid stack when a parent resource is renamed in the state. Now, parent references are also updated when the resource is renamed.
  [#13190](https://github.com/khulnasoft/khulnasoft/pull/13190)
...
- [cli] Revert go.cloud update to fixes issues with using azure object store and secrets.
  [#13184](https://github.com/khulnasoft/khulnasoft/pull/13184)
...
- [cli] Don't warn about the CLI version being out of date on every run. The CLI will now only warn once a day, when it queries for the latest version.
  [#12660](https://github.com/khulnasoft/khulnasoft/pull/12660)

- [programgen/{dotnet,go,nodejs,python}] Extend SkipResourceTypechecking to allow generating unknown resources
  [#13172](https://github.com/khulnasoft/khulnasoft/pull/13172)

- [cli/package] Add a "get-mapping" command to query providers for their mapping information.
  [#13155](https://github.com/khulnasoft/khulnasoft/pull/13155)


### Bug Fixes

- [cli/config] `khulnasoft destroy` now sets the `encryptedkey` every run like the rest of the CLI commands.
  [#13168](https://github.com/khulnasoft/khulnasoft/pull/13168)

- [engine] Fix aliasing children
  [#12848](https://github.com/khulnasoft/khulnasoft/pull/12848)
...
- [sdk/nodejs] Fixes uncaught rejections on the resource monitor terminating causing Automation API programs to exit prematurely.
  [#13070](https://github.com/khulnasoft/khulnasoft/pull/13070)
...
- [backend/filestate] Add an option to the Upgrade operation allowing injection of an external source of project names for stacks where the project name could not be automatically determined.
  [#13077](https://github.com/khulnasoft/khulnasoft/pull/13077)

- [sdk/go] Adds `tokens.ValidateProjectName` to validate project names.
  [#13165](https://github.com/khulnasoft/khulnasoft/pull/13165)
...
- [cli] 'convert' now defaults to be more leniant about program correctness, old behaviour can be toggled back on with --strict.
  [#13120](https://github.com/khulnasoft/khulnasoft/pull/13120)

- [engine] DeletedWith ResourceOption is now inherited from its parent across SDKs.
  [#12572](https://github.com/khulnasoft/khulnasoft/pull/12572)

- [engine] Add 'khulnasoft:tags' config option to set stack tags.
  [#12856](https://github.com/khulnasoft/khulnasoft/pull/12856)

- [pkg] Upgrade khulnasoft-java to v0.9.4.
  [#13121](https://github.com/khulnasoft/khulnasoft/pull/13121)

- [programgen/nodejs] Allow output variables to have the same identifier as other program nodes
  [#13115](https://github.com/khulnasoft/khulnasoft/pull/13115)
...
- [auto/python] Add support for the path option for config operations
  [#13052](https://github.com/khulnasoft/khulnasoft/pull/13052)
...
- [sdkgen/go] Fix versioned typerefs being marshalled across code generator RPCs.
  [#13006](https://github.com/khulnasoft/khulnasoft/pull/13006)
...
- [backend/service] Improve memory consumption and decrease CPU time required when using snapshot patching
  [#12962](https://github.com/khulnasoft/khulnasoft/pull/12962)
...
- [engine] Step generation now uses old inputs for untargeted resources and does not send current inputs to `Check()` on providers.
  [#12973](https://github.com/khulnasoft/khulnasoft/pull/12973)

- [sdk/go] Fix regression disallowing placing a Pulumi program in a subdirectory of a Go module.
  [#12967](https://github.com/khulnasoft/khulnasoft/pull/12967)

- [programgen/nodejs] Allow iterating dynamic entries in TypeScript
  [#12961](https://github.com/khulnasoft/khulnasoft/pull/12961)
...
- [programgen/go] Module support as component resources
  [#12840](https://github.com/khulnasoft/khulnasoft/pull/12840)
...
- [engine] Non-targeted resources are now added to internal update plans fixing a bug where the step_executor would error due to missing resources in the plan.
  [#12939](https://github.com/khulnasoft/khulnasoft/pull/12939)

- [programgen] Fix stack overflow panic when pretty printing recursive types
  [#12866](https://github.com/khulnasoft/khulnasoft/pull/12866)

- [sdk/nodejs] Revert recursive package.json lookup.
  [#12944](https://github.com/khulnasoft/khulnasoft/pull/12944)


### Miscellaneous

- [sdk/go] testing.Environment now tolerates errors in deleting the test environment.
  [#12927](https://github.com/khulnasoft/khulnasoft/pull/12927)
...
- [sdk/nodejs] Replaces empty interfaces with type aliases. Empty interfaces are equivalent to their supertype; this change expresses these type definitions using type aliases instead of interface extention to provide better clarity. This change will not affect type-checking.
  [#12865](https://github.com/khulnasoft/khulnasoft/pull/12865)
...
- [sdk/nodejs] Support loading package.json from parent directory. If `package.json` is not found in the Pulumi main directory, Pulumi recursively searches up the directory tree until it is found. If `package.json` provides a `main` field, per the [NPM spec](https://docs.npmjs.com/cli/v6/configuring-npm/package-json#main), that field is relative to the directory containing package.json.
  [#12759](https://github.com/khulnasoft/khulnasoft/pull/12759)


### Bug Fixes

- [build] Fixes race condition in building Go sdk.
  [#12821](https://github.com/khulnasoft/khulnasoft/pull/12821)

- [cli] Convert to PCL will recover from panics in program binding.
  [#12827](https://github.com/khulnasoft/khulnasoft/pull/12827)

- [engine] Fix bug with targeting and plans where root stack resource and target-replaces were not being marked targeted.
  [#12834](https://github.com/khulnasoft/khulnasoft/pull/12834)

- [engine] Fix the engine trying to install the khulnasoft-resource-khulnasoft plugin which is builtin.
  [#12858](https://github.com/khulnasoft/khulnasoft/pull/12858)

- [programgen] Allow null literal as a default value for config variables
  [#12817](https://github.com/khulnasoft/khulnasoft/pull/12817)

- [programgen] Fix panic on component type traversal
  [#12828](https://github.com/khulnasoft/khulnasoft/pull/12828)

- [sdk/python] Fix hang due to component children cycles
  [#12855](https://github.com/khulnasoft/khulnasoft/pull/12855)


### Miscellaneous

- [sdk/nodejs] With Node14 sunset on April 30, the minimum version of Node is now Node 16.
  [#12648](https://github.com/khulnasoft/khulnasoft/pull/12648)
...
- [cli] `convert` now prints all diagnostics from program conversion
  [#12808](https://github.com/khulnasoft/khulnasoft/pull/12808)

- [programgen/nodejs] Support range expressions that are of type output
  [#12749](https://github.com/khulnasoft/khulnasoft/pull/12749)

- [programgen/python] Support range expressions that are of type output
  [#12804](https://github.com/khulnasoft/khulnasoft/pull/12804)


### Bug Fixes

- [cli] Fix destroy without project file.
  [#12766](https://github.com/khulnasoft/khulnasoft/pull/12766)

- [engine] Fix bug where non-default providers are created even when not specified as a target.
  [#12628](https://github.com/khulnasoft/khulnasoft/pull/12628)


### Miscellaneous

- [backend/filestate] Improve performance of project-existence check.
  [#12798](https://github.com/khulnasoft/khulnasoft/pull/12798)
...
- [backend/filestate] Revert change causing `provided project name "" doesn't match Pulumi.yaml` error
  [#12761](https://github.com/khulnasoft/khulnasoft/pull/12761)
...
- [sdk/go] Support new options on packaged components (MLCs), including: AdditionalSecretOutputs, Timeouts, DeletedWith, DeleteBeforeReplace, IgnoreChanges, ReplaceOnChanges, and RetainOnDelete.
  [#12701](https://github.com/khulnasoft/khulnasoft/pull/12701)

- [sdk/go] Support vendored dependencies for Pulumi programs.
  [#12727](https://github.com/khulnasoft/khulnasoft/pull/12727)


### Bug Fixes

- [cli] Fix destroy without project file.
  [#12728](https://github.com/khulnasoft/khulnasoft/pull/12728)

- [programgen] Allow using option(T) in range expressions
  [#12717](https://github.com/khulnasoft/khulnasoft/pull/12717)

- [sdk/go] Ensure that dependency searches happen in the Pulumi program directory.
  [#12732](https://github.com/khulnasoft/khulnasoft/pull/12732)

- [pkg/testing] Fix failure in writing a package.json for test overrides.
  [#12700](https://github.com/khulnasoft/khulnasoft/pull/12700)


### Miscellaneous

- [pkg/testing] ProgramTest now supports --exclude-protected during stack cleanup.
  [#12699](https://github.com/khulnasoft/khulnasoft/pull/12699)
...
- [cli/display] Adds an indicator for resources that are being deleted/replaced with `retainOnDelete` set as well as an itemized warning.
  [#12157](https://github.com/khulnasoft/khulnasoft/pull/12157)

- [backend/{filestate,service}] Add more information to `khulnasoft stack history` (Update CLI Args, Environment Variables, Pulumi Version, OS, Architecture).
  [#12574](https://github.com/khulnasoft/khulnasoft/pull/12574)


### Bug Fixes

- [pkg/testing] deploytest: Fix nil custom timeouts and timeouts smaller than a minute being ignored.
  [#12681](https://github.com/khulnasoft/khulnasoft/pull/12681)

- [programgen] Do not panic when PCL attribute type or PCL resource variable type isn't fully bound
  [#12661](https://github.com/khulnasoft/khulnasoft/pull/12661)

- [sdk/go] Fixed NewResourceOptions dropping MLC dependencies from the options preview.
  [#12683](https://github.com/khulnasoft/khulnasoft/pull/12683)

- [programgen/nodejs] Linearize component resource nodes
  [#12676](https://github.com/khulnasoft/khulnasoft/pull/12676)
...
This is a re-application of #12292, which was previously reverted in #12522.
  ...
  [#12639](https://github.com/khulnasoft/khulnasoft/pull/12639)
...
- [sdkgen/python] Fix referencing local types with a different package name
  [#12669](https://github.com/khulnasoft/khulnasoft/pull/12669)


### Miscellaneous

- [pkg] Bump khulnasoft-terraform-bridge
  [#12625](https://github.com/khulnasoft/khulnasoft/pull/12625)

- [programgen] Do not panic when the type of PCL local variable isn't known
  [#12670](https://github.com/khulnasoft/khulnasoft/pull/12670)
...
- [cli/config] Fix config set-all not saving secret provider configuration.
  [#12643](https://github.com/khulnasoft/khulnasoft/pull/12643)

- [cli/display] Fix a panic when diffing empty archives.
  [#12656](https://github.com/khulnasoft/khulnasoft/pull/12656)

- [programgen] Suppport the `any` type in config and outputs.
  [#12619](https://github.com/khulnasoft/khulnasoft/pull/12619)

- [sdk/go] Fix hang due to component children cycles
  [#12516](https://github.com/khulnasoft/khulnasoft/pull/12516)

- [sdk/nodejs] Fix hang due to component children cycles
  [#12515](https://github.com/khulnasoft/khulnasoft/pull/12515)

- [sdk/python] Fix hang due to component children cycles
  [#12462](https://github.com/khulnasoft/khulnasoft/pull/12462)


### Miscellaneous

- [backend/filestate] Propagate request context to external call sites.
  [#12638](https://github.com/khulnasoft/khulnasoft/pull/12638)
...
- [yaml] Updates Pulumi YAML to v1.1.0.
  [#12612](https://github.com/khulnasoft/khulnasoft/pull/12612)
...
- [programgen/python] Impleneted python program-gen for PCL components
  [#12555](https://github.com/khulnasoft/khulnasoft/pull/12555)


### Bug Fixes

- [programgen/{nodejs,python}] Fixes the type signature of PCL function "entries" to return list of key-value pair objects
  [#12607](https://github.com/khulnasoft/khulnasoft/pull/12607)

- [cli/package] Fix bug in `package get-schema` subcommand caused it to bail on certain providers.
  [#12459](https://github.com/khulnasoft/khulnasoft/pull/12459)

- [cli/state] Fixes panic when renaming providers in `khulnasoft state rename`.
  [#12599](https://github.com/khulnasoft/khulnasoft/pull/12599)
...
- [sdkgen/python] In codegen, use 3.7 as a default if not provided.
  [#12287](https://github.com/khulnasoft/khulnasoft/pull/12287)
...
- [engine] Revert PR moving deletedWith inheritance logic to the engine as `get` resources and packaged components are incompatible.
  [#12564](https://github.com/khulnasoft/khulnasoft/pull/12564)

- [sdk] Fix multiplied retries when downloading plugins.
  [#12504](https://github.com/khulnasoft/khulnasoft/pull/12504)

- [auto/go] Added support for the path option for config operations
  [#12265](https://github.com/khulnasoft/khulnasoft/pull/12265)


### Miscellaneous

- [backend/filestate] Rename state metadata file from .khulnasoft/Pulumi.yaml to .khulnasoft/meta.yaml.
...
and should not affect most users.
  ...
  [#12538](https://github.com/khulnasoft/khulnasoft/pull/12538)
...
- [engine] Enhances the state schema to track fields `Created`, `Modified` per each resource. The timestamp is captured in RFC3339. It pertains to timestamps of state modification done by the engine.
  [#12082](https://github.com/khulnasoft/khulnasoft/pull/12082)

- [engine] DeletedWith ResourceOption is now inherited from its parent across SDKs.
  [#12446](https://github.com/khulnasoft/khulnasoft/pull/12446)

- [programgen/{dotnet,nodejs}] Object-typed config variables for components
  [#12488](https://github.com/khulnasoft/khulnasoft/pull/12488)


### Bug Fixes

- [sdk] common: Fix extraneous backoff during retries.
  [#12502](https://github.com/khulnasoft/khulnasoft/pull/12502)

- [sdkgen/dotnet] respectSchemaVersion now writes the package version to the .csproj file.
  [#12518](https://github.com/khulnasoft/khulnasoft/pull/12518)

- [sdk/python] Revert #12292 to unbreak some users.
  [#12522](https://github.com/khulnasoft/khulnasoft/pull/12522)

- [sdkgen/{dotnet,go,nodejs,python}] Add respectSchemaVersion to schema.
  [#12511](https://github.com/khulnasoft/khulnasoft/pull/12511)
...
- [sdk] Make default logger thread-safe.
  [#12485](https://github.com/khulnasoft/khulnasoft/pull/12485)

- [sdk/go] Track rehydrated components as dependencies.
  [#12494](https://github.com/khulnasoft/khulnasoft/pull/12494)

- [sdkgen/go] Fixes emission of dup types breaking Go compilation when chunking >500 helper types.
  [#12484](https://github.com/khulnasoft/khulnasoft/pull/12484)


### Miscellaneous

- [cli] Improve CLI upgrade instructions for macOS.
  [#12483](https://github.com/khulnasoft/khulnasoft/pull/12483)
...
- [auto/go] Add WhoAmIDetails which includes user, url and organizations to Go Automation API
  [#12374](https://github.com/khulnasoft/khulnasoft/pull/12374)
...
- [cli/plugin] Fix sending empty tokens to GitHub API.
  [#12392](https://github.com/khulnasoft/khulnasoft/pull/12392)
...
- [cli] Remove the `[experimental] yes, using Update Plans` prompt.
  [#12135](https://github.com/khulnasoft/khulnasoft/pull/12135)

- [backend/filestate] khulnasoft login gs:// to support google oauth access tokens via environment variable for Google Cloud Storage backends
  [#12102](https://github.com/khulnasoft/khulnasoft/pull/12102)

- [sdk/go] Adds StackReference.GetOutputDetails to retrieve outputs from StackReferences as plain objects.
  [#12034](https://github.com/khulnasoft/khulnasoft/pull/12034)

- [sdk/nodejs] Adds StackReference.getOutputDetails to retrieve outputs from StackReferences as plain objects.
  [#12072](https://github.com/khulnasoft/khulnasoft/pull/12072)

- [sdk/python] Adds StackReference.get_output_details to retrieve outputs from StackReferences as plain objects.
  [#12071](https://github.com/khulnasoft/khulnasoft/pull/12071)


### Bug Fixes

- [cli] Fix verbose logging to filter secrets.
  [#12079](https://github.com/khulnasoft/khulnasoft/pull/12079)

- [engine] This fixes an issue where 'khulnasoft state delete ' would prompt the user to disambiguate between multiple resources in state with the same URN and proceed to delete all of them. With this change, dependency checks are performed only if the deletion will lead to no resources possessing the URN. The targetDependents flag will only target dependents if the deleted resource will orphan the dependents.
  [#12111](https://github.com/khulnasoft/khulnasoft/pull/12111)

- [engine] Fixed issue where khulnasoft displays multiline secrets when the newlines('
') are escaped.
  [#12140](https://github.com/khulnasoft/khulnasoft/pull/12140)

- [sdkgen/go] Prevent defaults from overriding set values.
  [#12099](https://github.com/khulnasoft/khulnasoft/pull/12099)


### Miscellaneous

- [pkg] Raise 'go' directive to 1.18.
  [#11807](https://github.com/khulnasoft/khulnasoft/pull/11807)
...
- [cli] Add `--shell` flag to `khulnasoft stack output` to print outputs as a shell script.
  [#11956](https://github.com/khulnasoft/khulnasoft/pull/11956)

- [cli] Add `--insecure` flag to `khulnasoft login` which disables https certificate checks
  [#9159](https://github.com/khulnasoft/khulnasoft/pull/9159)

- [programgen] Add a new `unsecret` intrinsic function to PCL.
  [#12026](https://github.com/khulnasoft/khulnasoft/pull/12026)

- [sdkgen/go] Go SDKs now use `errors.New` instead of `github.com/pkg/errors.New`.
  [#12046](https://github.com/khulnasoft/khulnasoft/pull/12046)


### Bug Fixes

- [auto] Add support for cloning from Azure DevOps
  [#12001](https://github.com/khulnasoft/khulnasoft/pull/12001)

- [sdkgen] Correctly error on resource using the reserved name "provider".
  [#11996](https://github.com/khulnasoft/khulnasoft/pull/11996)

- [sdk/python] Fix handling of Output keys in dicts passed to Output.from_input.
  [#11968](https://github.com/khulnasoft/khulnasoft/pull/11968)


### Miscellaneous

- [sdk/go] Delegate alias computation to the engine
  [#12025](https://github.com/khulnasoft/khulnasoft/pull/12025)

- [sdk/python] Delegate alias computation to the engine
  [#12015](https://github.com/khulnasoft/khulnasoft/pull/12015)
...
- [engine] Revert go-cloud upgrade to fix issues with Azure secrets.
  [#11984](https://github.com/khulnasoft/khulnasoft/pull/11984)
...
- [auto/nodejs] Enable programmatic tagging of stacks (Nodejs only)
  [#11659](https://github.com/khulnasoft/khulnasoft/pull/11659)

- [sdk/go] Coerces output values in ApplyT calls if the types are equivalent.
  [#11903](https://github.com/khulnasoft/khulnasoft/pull/11903)

- [sdk/nodejs] Add optional / backwards compatible generic types to khulnasoft.dynamic.ResourceProvider.
  [#11881](https://github.com/khulnasoft/khulnasoft/pull/11881)


### Bug Fixes

- [auto/nodejs] Fix NodeJS automation api always setting the PULUMI_CONFIG environment variable.
  [#11943](https://github.com/khulnasoft/khulnasoft/pull/11943)

- [cli/display] Display text-based diff if yaml/json diff is semantically equal
  [#11803](https://github.com/khulnasoft/khulnasoft/pull/11803)

- [sdk/go] Fixes data race in provider plugin resulting in weakly typed secrets.
  [#11975](https://github.com/khulnasoft/khulnasoft/pull/11975)

- [sdk/nodejs] Fix handling of recursive symlinks in node_modules.
  [#11950](https://github.com/khulnasoft/khulnasoft/pull/11950)
...
- [engine] Fix launching non-Go plugins on Windows.
  [#11915](https://github.com/khulnasoft/khulnasoft/pull/11915)
...
- [sdk/go] Add JSONUnmarshal to go sdk.
  [#11745](https://github.com/khulnasoft/khulnasoft/pull/11745)

- [sdk/python] Add output json_loads using json.loads.
  [#11741](https://github.com/khulnasoft/khulnasoft/pull/11741)


### Bug Fixes

- [cli/new] Allow running inside new VCS repositories.
  [#11804](https://github.com/khulnasoft/khulnasoft/pull/11804)

- [auto/python] Fix issue specifying log_verbosity
  [#11778](https://github.com/khulnasoft/khulnasoft/pull/11778)
...
- [protobuf] Downstream implementers of the RPC server interfaces must embed UnimplementedServer structs or opt out of forward compatibility.
  [#11652](https://github.com/khulnasoft/khulnasoft/pull/11652)
...
- [sdk/nodejs] Add output jsonParse using JSON.parse.
  [#11735](https://github.com/khulnasoft/khulnasoft/pull/11735)
...
- [cli/display] Fix flickering in the interactive display
  [#11695](https://github.com/khulnasoft/khulnasoft/pull/11695)

- [cli/plugin] Fix check of executable bits on Windows.
  [#11692](https://github.com/khulnasoft/khulnasoft/pull/11692)

- [codegen] Revert change to codegen schema spec.
   [#11701](https://github.com/khulnasoft/khulnasoft/pull/11701)
...
- [auto/{go,nodejs,python}] Adds SkipInstallDependencies option for Remote Workspaces
  [#11674](https://github.com/khulnasoft/khulnasoft/pull/11674)
...
- [ci] GitHub release artifacts are now signed using [cosign](https://github.com/sigstore/cosign) and signatures are uploaded to the [Rekor transparency log](https://rekor.tlog.dev/).
  [#11310](https://github.com/khulnasoft/khulnasoft/pull/11310)

- [cli] Adds a flag that allows user to set the node label as the resource name instead of full URN in the stack graph
  [#11383](https://github.com/khulnasoft/khulnasoft/pull/11383)

- [cli] khulnasoft destroy --remove will now delete the stack config file
  [#11394](https://github.com/khulnasoft/khulnasoft/pull/11394)

- [cli] Allow rotating the encrpytion key for cloud secrets.
  [#11554](https://github.com/khulnasoft/khulnasoft/pull/11554)

- [cli/{config,new,package}] Preserve comments on editing of project and config files.
  [#11456](https://github.com/khulnasoft/khulnasoft/pull/11456)

- [sdk/dotnet] Add Output.JsonSerialize using System.Text.Json.
  [#11556](https://github.com/khulnasoft/khulnasoft/pull/11556)

- [sdk/go] Add JSONMarshal to go sdk.
  [#11609](https://github.com/khulnasoft/khulnasoft/pull/11609)

- [sdkgen/{dotnet,nodejs}] Initial implementation of simplified invokes for dotnet and nodejs.
  [#11418](https://github.com/khulnasoft/khulnasoft/pull/11418)

- [sdk/nodejs] Delegates alias computation to engine for Node SDK
  [#11206](https://github.com/khulnasoft/khulnasoft/pull/11206)

- [sdk/nodejs] Emit closure requires in global scope for improved cold start on Lambda
  [#11481](https://github.com/khulnasoft/khulnasoft/pull/11481)

- [sdk/nodejs] Add output jsonStringify using JSON.stringify.
  [#11605](https://github.com/khulnasoft/khulnasoft/pull/11605)

- [sdk/python] Add json_dumps to python sdk.
  [#11607](https://github.com/khulnasoft/khulnasoft/pull/11607)


### Bug Fixes

- [backend/service] Fixes out-of-memory issues when using PULUMI_OPTIMIZED_CHECKPOINT_PATCH protocol
  [#11666](https://github.com/khulnasoft/khulnasoft/pull/11666)

- [cli] Improve performance of convert to not try and load so many provider plugins.
  [#11639](https://github.com/khulnasoft/khulnasoft/pull/11639)

- [programgen] Don't panic on some empty objects
  [#11660](https://github.com/khulnasoft/khulnasoft/pull/11660)

- [cli/display] Fixes negative durations on update display.
  [#11631](https://github.com/khulnasoft/khulnasoft/pull/11631)
...
- [sdk] Add methods to cast pointer types to corresponding Pulumi Ptr types
  [#11539](https://github.com/khulnasoft/khulnasoft/pull/11539)

- [yaml] [Updates Pulumi YAML to v1.0.4](https://github.com/khulnasoft/khulnasoft-yaml/releases/tag/v1.0.4) unblocking Docker Image resource support in a future Docker provider release.
  [#11583](https://github.com/khulnasoft/khulnasoft/pull/11583)
...
- [backend/service] Allows the service to opt into a bandwidth-optimized DIFF protocol for storing checkpoints. Previously this required setting the PULUMI_OPTIMIZED_CHECKPOINT_PATCH env variable on the client. This env variable is now deprecated.
  [#11421](https://github.com/khulnasoft/khulnasoft/pull/11421)

- [cli/about] Add fully qualified stack name to current stack.
  [#11387](https://github.com/khulnasoft/khulnasoft/pull/11387)

- [sdk/{dotnet,nodejs}] Add InvokeSingle variants to dotnet and nodejs SDKs
  [#11564](https://github.com/khulnasoft/khulnasoft/pull/11564)


### Bug Fixes

- [docs] Exclude id output property for component resources
  [#11469](https://github.com/khulnasoft/khulnasoft/pull/11469)

- [engine] Fix an assert for resources being replaced but also pending deletion.
  [#11475](https://github.com/khulnasoft/khulnasoft/pull/11475)

- [pkg] Fixes codegen/python generation of non-string secrets in provider properties
  [#11494](https://github.com/khulnasoft/khulnasoft/pull/11494)

- [pkg/testing] Optionally caches python venvs for testing
  [#11532](https://github.com/khulnasoft/khulnasoft/pull/11532)

- [programgen] Improve error message for invalid enum values on `khulnasoft convert`.
  [#11019](https://github.com/khulnasoft/khulnasoft/pull/11019)

- [programgen] Interpret schema.Asset as pcl.AssetOrArchive.
  [#11593](https://github.com/khulnasoft/khulnasoft/pull/11593)

- [programgen/go] Convert the result of immediate invokes to ouputs when necessary.
  [#11480](https://github.com/khulnasoft/khulnasoft/pull/11480)

- [programgen/nodejs] Add `.` between `?` and `[`.
  [#11477](https://github.com/khulnasoft/khulnasoft/pull/11477)

- [programgen/nodejs] Fix capitalization when generating `fs.readdirSync`.
  [#11478](https://github.com/khulnasoft/khulnasoft/pull/11478)

- [sdk/nodejs] Fix regression when passing a provider to a MLC
  [#11509](https://github.com/khulnasoft/khulnasoft/pull/11509)

- [sdk/python] Allows for duplicate output values in python
  [#11559](https://github.com/khulnasoft/khulnasoft/pull/11559)

- [sdkgen/go] Fixes superfluous newline being added between documentation comment and package statement in doc.go
  [#11492](https://github.com/khulnasoft/khulnasoft/pull/11492)

- [sdkgen/nodejs] Generate JS doc comments for output-versioned invokes and use explicit any type.
  [#11511](https://github.com/khulnasoft/khulnasoft/pull/11511)
...
- [cli] Don't print update plan message with --json.
  [#11454](https://github.com/khulnasoft/khulnasoft/pull/11454)

- [cli] `up --yes` should not use update plans.
  [#11445](https://github.com/khulnasoft/khulnasoft/pull/11445)
...
- [cli] Add prompt to `up` to use experimental update plans.
  [#11353](https://github.com/khulnasoft/khulnasoft/pull/11353)


### Bug Fixes

- [sdk/python] Don't error on type mismatches when using input values for outputs
  [#11422](https://github.com/khulnasoft/khulnasoft/pull/11422)
...
- [sdk/{dotnet,go,nodejs}] Attempt to select stack then create as fallback on 'createOrSelect'
  [#11402](https://github.com/khulnasoft/khulnasoft/pull/11402)
...
- [cli] Added "--from=tf" to khulnasoft convert.
  [#11341](https://github.com/khulnasoft/khulnasoft/pull/11341)

- [engine] Engine and Golang support for language plugins starting providers directly.
  [#10916](https://github.com/khulnasoft/khulnasoft/pull/10916)

- [sdk/dotnet] Add DictionaryInvokeArgs for dynamically constructing invoke input bag of properties.
  [#11335](https://github.com/khulnasoft/khulnasoft/pull/11335)

- [sdk/go] Allow sane conversions for `As*Map*` and `As*Array*` conversions.
  [#11351](https://github.com/khulnasoft/khulnasoft/pull/11351)

- [sdkgen/{dotnet,nodejs}] Add default dependencies for generated SDKs.
  [#11315](https://github.com/khulnasoft/khulnasoft/pull/11315)

- [sdkgen/nodejs] Splits input and output definitions into multiple files.
  [#10831](https://github.com/khulnasoft/khulnasoft/pull/10831)


### Bug Fixes

- [cli] Fix stack selection prompt.
  [#11354](https://github.com/khulnasoft/khulnasoft/pull/11354)

- [engine] Always keep resources when khulnasoft:khulnasoft:getResource is invoked
  [#11382](https://github.com/khulnasoft/khulnasoft/pull/11382)

- [pkg] Fix a panic in codegen for an edge case involving object expressions without corresponding function arguments.
  [#11311](https://github.com/khulnasoft/khulnasoft/pull/11311)

- [programgen] Enable type checking for resource attributes
  [#11371](https://github.com/khulnasoft/khulnasoft/pull/11371)

- [cli/display] Fix text cutting off prior to the edge of the terminal
  [#11202](https://github.com/khulnasoft/khulnasoft/pull/11202)

- [programgen/{dotnet,go,nodejs,python}] Don't generate traverse errors when typechecking a dynamic type
  [#11359](https://github.com/khulnasoft/khulnasoft/pull/11359)

- [sdk/{go,nodejs,python}] Set acceptResources when invoking khulnasoft:khulnasoft:getResource
  [#11382](https://github.com/khulnasoft/khulnasoft/pull/11382)

- [sdk/python] Copy ResourceOptions correctly during a merge.
  [#11327](https://github.com/khulnasoft/khulnasoft/pull/11327)
...
- [cli] Enables debug tracing of Pulumi gRPC internals: `PULUMI_DEBUG_GRPC=$PWD/grpc.json khulnasoft up`
  [#11085](https://github.com/khulnasoft/khulnasoft/pull/11085)

- [cli/display] Improve the usability of the interactive dipslay by making the treetable scrollable
  [#11200](https://github.com/khulnasoft/khulnasoft/pull/11200)

- [pkg] Add `DeletedWith` as a resource option.
  [#11095](https://github.com/khulnasoft/khulnasoft/pull/11095)

- [programgen] More programs can be converted to Pulumi when using `khulnasoft convert`, provider bridging, and conversion tools by allowing property accesses and field names to fall back to a case insensitive lookup.
  [#11266](https://github.com/khulnasoft/khulnasoft/pull/11266)


### Bug Fixes

- [engine] Disable auto parenting to see if that fixes #10950.
  [#11272](https://github.com/khulnasoft/khulnasoft/pull/11272)

- [yaml] [Updates Pulumi YAML to v1.0.2](https://github.com/khulnasoft/khulnasoft-yaml/releases/tag/v1.0.2) which fixes a bug encountered using templates with project level config.
  [#11296](https://github.com/khulnasoft/khulnasoft/pull/11296)

- [sdkgen/go] Allow resource names that conflict with additional types.
  [#11244](https://github.com/khulnasoft/khulnasoft/pull/11244)

- [sdkgen/go] Guard against conflicting field names.
  [#11262](https://github.com/khulnasoft/khulnasoft/pull/11262)

- [sdk/python] Handle None being passed to register_resource_outputs.
  [#11226](https://github.com/khulnasoft/khulnasoft/pull/11226)
...
- [programgen/{dotnet,go,java,nodejs,python}] Support a logical name for config vars
  [#11231](https://github.com/khulnasoft/khulnasoft/pull/11231)

- [sdk/dotnet] Make the `LocalSerializer` class public.
  [#11106](https://github.com/khulnasoft/khulnasoft/pull/11106)

- [sdk/yaml] [Updates Pulumi YAML to v1.0.0](https://github.com/khulnasoft/khulnasoft-yaml/releases/tag/v1.0.0) containing runtime support for external config.
  [#11222](https://github.com/khulnasoft/khulnasoft/pull/11222)
...
- [engine] Fix a bug in update plans handling resources being replaced due to other resources being deleted before replacement.
  [#11009](https://github.com/khulnasoft/khulnasoft/pull/11009)
...
- [engine] Pending deletes are no longer executed before everything else. This correctly handles dependencies for resource graphs that were partially deleted.
  [#11027](https://github.com/khulnasoft/khulnasoft/pull/11027)

- [engine] Expand duplicate URN checks across direct URNs and aliases.
  [#11212](https://github.com/khulnasoft/khulnasoft/pull/11212)
...
- [auto/dotnet] Support for remote operations
  [#11194](https://github.com/khulnasoft/khulnasoft/pull/11194)

- [cli/config] Typing made optional, extended short-hand values to arrays and correctly pass stack name to config validator
  [#11192](https://github.com/khulnasoft/khulnasoft/pull/11192)

- [auto/go] Support for remote operations
  [#11168](https://github.com/khulnasoft/khulnasoft/pull/11168)

- [auto/nodejs] Support for remote operations
  [#11170](https://github.com/khulnasoft/khulnasoft/pull/11170)

- [auto/python] Support for remote operations
  [#11174](https://github.com/khulnasoft/khulnasoft/pull/11174)


### Bug Fixes

- [sdk/{go,yaml}] Block IsSecret until secretness is known
  [#11189](https://github.com/khulnasoft/khulnasoft/pull/11189)

- [sdk/{go,yaml}] Prevent race on resource output
  [#11186](https://github.com/khulnasoft/khulnasoft/pull/11186)
...
- [cli/state] Add the --target-dependents flag to `khulnasoft state delete`
  [#11164](https://github.com/khulnasoft/khulnasoft/pull/11164)


### Bug Fixes

- [cli] Hard reset the templates checkout to work around a go-git issue with ignored files.
  [#11175](https://github.com/khulnasoft/khulnasoft/pull/11175)

- [auto/dotnet] allow deserializing complex stack config values.
  [#11143](https://github.com/khulnasoft/khulnasoft/pull/11143)

- [auto/{dotnet,go,nodejs,python}] detect concurrent update error from local backend.
  [#11146](https://github.com/khulnasoft/khulnasoft/pull/11146)
...
- [cli] Allow globbing for resources that do not yet exist
  [#11150](https://github.com/khulnasoft/khulnasoft/pull/11150)

- [auto/dotnet] Add Json option to UpdateOptions.
  [#11148](https://github.com/khulnasoft/khulnasoft/pull/11148)


### Bug Fixes

- [build] Fix release build to continue to use MacOS 11.
  [#11155](https://github.com/khulnasoft/khulnasoft/pull/11155)

- [engine] Prevent concurrent read/writes to the component providers map.
  [#11151](https://github.com/khulnasoft/khulnasoft/pull/11151)
...
- [engine] Fix an invalid cast in analyzer plugins.
  [#11141](https://github.com/khulnasoft/khulnasoft/pull/11141)
...
- [auto/go] Add InstallPluginFromServer method
  [#10955](https://github.com/khulnasoft/khulnasoft/pull/10955)
...
- [cli] Implement initial MVP for hierarchical and structured project configuration.
  [#10832](https://github.com/khulnasoft/khulnasoft/pull/10832)

- [cli] Allow rotating the passphrase non-interactively
  [#11094](https://github.com/khulnasoft/khulnasoft/pull/11094)

- [programgen] Add error reporting infrastructure
  [#11032](https://github.com/khulnasoft/khulnasoft/pull/11032)


### Bug Fixes

- [ci] Fix pull request URLs in Pulumi changelogs
  [#11060](https://github.com/khulnasoft/khulnasoft/pull/11060)

- [engine] Fix type validation of stack config with secure values.
  [#11084](https://github.com/khulnasoft/khulnasoft/pull/11084)

- [cli/engine] Component Resources inherit thier parents providers map
  [#10933](https://github.com/khulnasoft/khulnasoft/pull/10933)

- [cli/import] Only trigger an import when necessary during refresh.
  [#11100](https://github.com/khulnasoft/khulnasoft/pull/11100)

- [sdk/go] Allow decoding *asset and *archive values
  [#11053](https://github.com/khulnasoft/khulnasoft/pull/11053)

- [sdkgen/{go,python}] Handle hypheneated names in go and python
  [#11049](https://github.com/khulnasoft/khulnasoft/pull/11049)

- [sdk/nodejs] Fixes loss of undefined type case in `all()`
  [#11048](https://github.com/khulnasoft/khulnasoft/pull/11048)

- [sdk/python] khulnasoft.automation.create_or_select_stack() attempts to select the stack before attempting to create
  [#11115](https://github.com/khulnasoft/khulnasoft/pull/11115)

- [sdk/python] Python runtime now respects the --parallel flag.
  [#11122](https://github.com/khulnasoft/khulnasoft/pull/11122)


### Miscellaneous

- [protobuf] Bumps python grpcio version
  [#11067](https://github.com/khulnasoft/khulnasoft/pull/11067)

- [sdk/go] Update notes, update the deprecated functions, make some lint.
  [#11002](https://github.com/khulnasoft/khulnasoft/pull/11002)
...
- [sdkgen/{go,python}] Revert 10738, fixing python class generation
  [#11033](https://github.com/khulnasoft/khulnasoft/pull/11033)
...
- [auto/nodejs] Adds support for parallel programs in NodeJS Automation API
  [#10568](https://github.com/khulnasoft/khulnasoft/pull/10568)
...
- [backend/service] Implements diff-based snapshot saving protocol that reduces bandwidth on large stacks. To opt into this feature, set the environment variable and value `PULUMI_OPTIMIZED_CHECKPOINT_PATCH=true`.
  [#10788](https://github.com/khulnasoft/khulnasoft/pull/10788)

- [engine] Adds structured alias support to the engine
  [#10819](https://github.com/khulnasoft/khulnasoft/pull/10819)

- [cli/display] Displays time elapsed when modifying a resource.
  [#10953](https://github.com/khulnasoft/khulnasoft/pull/10953)

- [sdk/go] Modifies built-in As-ArrayOutput methods to attempt to convert []interface{} to []T.
  [#10991](https://github.com/khulnasoft/khulnasoft/pull/10991)

- [sdkgen/go] Add `modulePath` to go, allowing accurate `go.mod` files for prerelease packages
  [#10944](https://github.com/khulnasoft/khulnasoft/pull/10944)

- [cli/new] Add --remove flag to`khulnasoft destroy`
  [#10943](https://github.com/khulnasoft/khulnasoft/pull/10943)


### Bug Fixes

- [cli] Project path is included in error messages when a project can't be loaded.
  [#10973](https://github.com/khulnasoft/khulnasoft/pull/10973)

- [cli/display] Fix gocloud unconditonally writing to stderr.
  [#11007](https://github.com/khulnasoft/khulnasoft/pull/11007)
...
- [cli/{display,engine}] Use of unsupported ResourceOptions on components will no longer raise resource warnings, instead they are just logged to the diagnostic error stream.
  [#11010](https://github.com/khulnasoft/khulnasoft/pull/11010)

- [cli/import] Handle importing resource properties that are typed as a union
  [#10995](https://github.com/khulnasoft/khulnasoft/pull/10995)
...
- [cli/package] Require a path separator for path based binaries. This allows us to distinguish between ./myProvider (execute the binary at path) and myProvider (execute the installed plugin).
  [#11015](https://github.com/khulnasoft/khulnasoft/pull/11015)

- [programgen/dotnet] Annotate deeply nested objects with their schema types and apply property name overrides
  [#10976](https://github.com/khulnasoft/khulnasoft/pull/10976)

- [programgen/go] Fixes int constant range expressions for go
  [#10979](https://github.com/khulnasoft/khulnasoft/pull/10979)

- [programgen/go] Missing default case handling when generating local variables
  [#10978](https://github.com/khulnasoft/khulnasoft/pull/10978)

- [sdk/go] Avoid backfilling property deps for Go
  [#11021](https://github.com/khulnasoft/khulnasoft/pull/11021)

- [sdkgen] Re-enables caching the schemas of versioned provider plugins.
  [#10971](https://github.com/khulnasoft/khulnasoft/pull/10971)

- [programgen/python] Recursively annotate expressions under invoke calls with their associated schema types
  [#10958](https://github.com/khulnasoft/khulnasoft/pull/10958)


### Miscellaneous

- [yaml] "[Updates Pulumi YAML to v0.5.10](https://github.com/khulnasoft/khulnasoft-yaml/releases/tag/v0.5.10) containing bug fixes and improvements primarily for `khulnasoft convert` from YAML."
  [#11018](https://github.com/khulnasoft/khulnasoft/pull/11018)
...
- [cli/new] Fix cloning templates from Azure DevOps repos.
  [#10954](https://github.com/khulnasoft/khulnasoft/pull/10954)

- [docs] Allow more flexible parsing when extracting examples from doc comments
  [#10913](https://github.com/khulnasoft/khulnasoft/pull/10913)
...
- [sdkgen/python] Fixes dangling type-refs generated under compatibility=tfbridge20 for schemas that refer to types aross modules.
  [#10935](https://github.com/khulnasoft/khulnasoft/pull/10935)
...
- [backend] Allows CLI auth for Azure blob storage
  [#10900](https://github.com/khulnasoft/khulnasoft/pull/10900)

- [cli/{about,plugin}] Remove experimental feature for plugins from private github releases. This is now supported by `github:` plugin urls, see https://www.khulnasoft.com/docs/guides/khulnasoft-packages/how-to-author/#support-for-github-releases.
  [#10896](https://github.com/khulnasoft/khulnasoft/pull/10896)
...
- [sdk/go] Adds an `UnsafeAwaitOutput` function to the Go SDK. This permits a workaround for component providers and other advanced scenarios where resources created are conditional on an output.
  [#10877](https://github.com/khulnasoft/khulnasoft/pull/10877)

- [sdk/python] Add invoke to Provider interface.
  [#10906](https://github.com/khulnasoft/khulnasoft/pull/10906)

- [sdk/python] Add Output.format to the python SDK.
  [#10919](https://github.com/khulnasoft/khulnasoft/pull/10919)

- [yaml] [Updates Pulumi YAML to v0.5.9](https://github.com/khulnasoft/khulnasoft-yaml/releases/tag/v0.5.9)
  [#10937](https://github.com/khulnasoft/khulnasoft/pull/10937)


### Bug Fixes

- [cli] Prevent sending on a closed channel panics during 'khulnasoft convert'
  [#10893](https://github.com/khulnasoft/khulnasoft/pull/10893)

- [programgen/go] Fix codegen for `__apply` functions
  [#10775](https://github.com/khulnasoft/khulnasoft/pull/10775)

- [sdk/go] Go programs run with Go 1.17 or below failed due to go mod tidy being run with -compat=1.18. The change is reverted.
  [#10865](https://github.com/khulnasoft/khulnasoft/pull/10865)

- [sdk/go] Fixed bug in (ours, theirs) to (theirs, theirs)
  [#10881](https://github.com/khulnasoft/khulnasoft/pull/10881)

- [sdk/python] Fix KeyError in UpdateSummary.
  [#10907](https://github.com/khulnasoft/khulnasoft/pull/10907)

- [sdkgen/nodejs] Fixes a bug with lazy-loaded modules that caused mixins to observe unexpected null values.
  [#10871](https://github.com/khulnasoft/khulnasoft/pull/10871)
...
- [cli] Allow per-execution override of the cloud secrets provider url via the `PULUMI_CLOUD_SECRET_OVERRIDE` environment variable. This allows a temporary replacement without updating the stack config, such a during CI. This does not effect stacks using service secrets or passphrases.
  [#10749](https://github.com/khulnasoft/khulnasoft/pull/10749)
  [#10749](https://github.com/khulnasoft/khulnasoft/pull/10749)
  [#10749](https://github.com/khulnasoft/khulnasoft/pull/10749)

- [cli/new] Enables `khulnasoft new` to use templates from Azure DevOps(currently limited to master/main branches and does not support providing subdirectories).
  [#10789](https://github.com/khulnasoft/khulnasoft/pull/10789)

- [engine] 'khulnasoft policy new' now uses the same system as 'khulnasoft new' to install dependencies.
  [#10797](https://github.com/khulnasoft/khulnasoft/pull/10797)

- [programgen] Support resource option "version" in `khulnasoft convert` to select specific provider SDK versions.
  [#10194](https://github.com/khulnasoft/khulnasoft/pull/10194)

- [yaml] [Updates Pulumi YAML to v0.5.8](https://github.com/khulnasoft/khulnasoft-yaml/releases/tag/v0.5.8)
  [#10856](https://github.com/khulnasoft/khulnasoft/pull/10856)

- [cli/plugin] Don't retry plugin downloads in 403 and 404 responses
  [#10803](https://github.com/khulnasoft/khulnasoft/pull/10803)

- [sdk/dotnet] Added `Deployment.OrganizationName` to return the current organization if available.
  [#10564](https://github.com/khulnasoft/khulnasoft/pull/10564)
...
- [sdk/go] Pulumi Go Programs now support a Pulumi.yaml option `buildTarget: path/to/binary` to compile/recompile a Go binary to that location.
  [#10731](https://github.com/khulnasoft/khulnasoft/pull/10731)

- [sdk/go] Added `Context.Organization` to return the current organization if available.
  [#10811](https://github.com/khulnasoft/khulnasoft/pull/10811)


### Bug Fixes

- [ci] Re-enable Homebrew Tap publishing.
  [#10796](https://github.com/khulnasoft/khulnasoft/pull/10796)

- [cli] Fixes --tracing to account for response parsing in HTTP api/* spans.
  [#10828](https://github.com/khulnasoft/khulnasoft/pull/10828)

- [cli] Fixes Pulumi.yaml validation error when the `refresh: always` option is specified
  [#10833](https://github.com/khulnasoft/khulnasoft/pull/10833)

- [engine] Mark khulnasoft-analyzer-policy and khulnasoft-analyzer-policy-python as bundled plugins.
  [#10817](https://github.com/khulnasoft/khulnasoft/pull/10817)

- [engine] Fix node and python MLCs on Windows.
  [#10827](https://github.com/khulnasoft/khulnasoft/pull/10827)

- [sdkgen/dotnet] Fixes a .NET SDK codegen bug when emitting functions with secret parameters.
  [#10840](https://github.com/khulnasoft/khulnasoft/pull/10840)

- [sdkgen/dotnet] Fix the type emitted for `ImmutableArray.Create` and `ImmutableDictionary.Create` for secret properties.
  [#10850](https://github.com/khulnasoft/khulnasoft/pull/10850)

- [sdk/nodejs] The `@khulnasoft/khulnasoft` package is now interoperable with ESModules.
  [#10622](https://github.com/khulnasoft/khulnasoft/pull/10622)

- [sdk/{nodejs,python}] `getOrganization` now returns "organization" by default.
  [#10820](https://github.com/khulnasoft/khulnasoft/pull/10820)

- [programgen/yaml] Fix incorrect import for non-khulnasoft owned package on convert
  [#10727](https://github.com/khulnasoft/khulnasoft/pull/10727)
...
- [backend] Adds a flag `PULUMI_SKIP_CHECKPOINTS=true` that makes Pulumi skip saving state checkpoints as it modifies resources and only save the final state of a deployment. 
  [#10750](https://github.com/khulnasoft/khulnasoft/pull/10750)
   ...
   See also:
     ...
     - [Checkpoints](https://www.khulnasoft.com/docs/intro/concepts/state/#checkpoints)
     - [#10668](https://github.com/khulnasoft/khulnasoft/issues/10668)
...
- [ci] Improves first-time contributor developer experience and reduces test execution time by defaulting `integration.ProgramTest` to a filestate backend. Tests that require running against a service should set `RequireService` to `true`.
  [#10720](https://github.com/khulnasoft/khulnasoft/pull/10720)

- [cli] Add a package author focused subcommand: `khulnasoft package` with subcommands `khulnasoft package gen-sdk` and `khulnasoft package get-schema`.
  [#10711](https://github.com/khulnasoft/khulnasoft/pull/10711)

- [cli] Use "https://github.com/khulnasoft/khulnasoft/blob/master/sdk/go/common/workspace/project.json" to validate loaded project files.
  [#10596](https://github.com/khulnasoft/khulnasoft/pull/10596)


### Bug Fixes

- [sdk/go] Correctly handle nil resource references in the RPC layer.
  [#10739](https://github.com/khulnasoft/khulnasoft/pull/10739)
...
- [engine] Plugin resolution now automatically installs any missing plugins as they are encountered.
   [#10691](https://github.com/khulnasoft/khulnasoft/pull/10691)
...
- [provider/go]: Added support for token authentication in the go providers which use git.
  [#10628](https://github.com/khulnasoft/khulnasoft/pull/10628)

- [codegen/go] Chunk the `khulnasoftTypes.go` file to reduce max file size.
  [#10666](https://github.com/khulnasoft/khulnasoft/pull/10666)

### Bug Fixes

- Fix invalid resource type on `khulnasoft convert` to Go
  [#10670](https://github.com/khulnasoft/khulnasoft/pull/10670)
...
- [auto/nodejs] `onOutput` is now called incrementally as the
  ...
  [#10678](https://github.com/khulnasoft/khulnasoft/pull/10678)

### Miscellaneous

- [ci] Migrate to merge queues for more reliable builds
  [#10644](https://github.com/khulnasoft/khulnasoft/pull/10644)
...
- [sdk/python] Improve error message when khulnasoft-python cannot find a main program.
  [#10617](https://github.com/khulnasoft/khulnasoft/pull/10617)

- [cli] provide info message to user if a khulnasoft program contains no resources
  [#10461](https://github.com/khulnasoft/khulnasoft/issues/10461)
...
- [engine/plugins]: Revert change causing third party provider packages to prevent deployment commands (`up`, `preview`, ...)
  ...
  [#10650](https://github.com/khulnasoft/khulnasoft/pull/10650)
...
- [sdk/go] Pulumi Go programs, on failure, now log a single error message.
  [#10347](https://github.com/khulnasoft/khulnasoft/pull/10347)

- [sdk/nodejs] Updated the vendored version of TypeScript in the NodeJS SDK and runtime from v3.7.3 to v3.8.3
  [#10618](https://github.com/khulnasoft/khulnasoft/pull/10618)

### Bug Fixes

- [sdk/nodejs] Calls onOutput in runPulumiCmd
  [#10631](https://github.com/khulnasoft/khulnasoft/pull/10631)
...
- [cli] Display outputs last in diff view.
  [#10535](https://github.com/khulnasoft/khulnasoft/pull/10535)

- [sdk/python] Dropped support for Python 3.6.
  [#10529](https://github.com/khulnasoft/khulnasoft/pull/10529)

- [codegen/nodejs] Support lazy-loading Node modules.
  [#10538](https://github.com/khulnasoft/khulnasoft/pull/10538)

- [cli/backend] Gzip compress HTTPS payloads for `khulnasoft import` and secret decryption against
  the Pulumi Service backend.
  [#10558](https://github.com/khulnasoft/khulnasoft/pull/10558)

### Bug Fixes

- [cli] Fix the "no Pulumi.yaml project file found" error message.
  [#10592](https://github.com/khulnasoft/khulnasoft/pull/10592)

- [cli/refresh] Do not panic when snapshot is `nil`.
  [#10593](https://github.com/khulnasoft/khulnasoft/pull/10593)

- [sdk/{python,nodejs}] Fix the use of `getOrganization` in policy packs.
  [#10574](https://github.com/khulnasoft/khulnasoft/pull/10574)

## 3.39.0 (2022-09-01)

### Improvements

- [yaml] [Updates Pulumi YAML to v0.5.5](https://github.com/khulnasoft/khulnasoft-yaml/releases/tag/v0.5.5)

- [cli] Allow `khulnasoft refresh` to interactively resolve pending creates.
  [#10394](https://github.com/khulnasoft/khulnasoft/pull/10394)

- [cli] Clarify highlighting of confirmation text in `confirmPrompt`.
  [#10413](https://github.com/khulnasoft/khulnasoft/pull/10413)

- [provider/python]: Improved exception display. The traceback is now shorter and it always starts with user code.
  [#10336](https://github.com/khulnasoft/khulnasoft/pull/10336)

- [sdk/python] Update PyYAML to 6.0

- [cli/watch] `khulnasoft watch` now uses relies on a program built on [`watchexec`](https://github.com/watchexec/watchexec)
  to implement recursive file watching, improving performance and cross-platform compatibility.
  This `khulnasoft-watch` program is now included in releases.
  [#10213](https://github.com/khulnasoft/khulnasoft/issues/10213)

- [codegen] Reduce time to execute `khulnasoft convert` and some YAML programs, depending on providers used, by up to 3 seconds.
  [#10444](https://github.com/khulnasoft/khulnasoft/pull/10444)
...
- [dotnet/sdk] Implement `Deployment.TestAsync` overloads which accept functions that create resources without requiring a stack definition.
  [#10458](https://github.com/khulnasoft/khulnasoft/pull/10458)

- [sdk/nodejs] Added stack truncation to `SyntaxError` in nodejs.
  [#10465](https://github.com/khulnasoft/khulnasoft/pull/10465)

- [sdk/python] Makes global SETTINGS values context-aware to not leak state between Pulumi programs running in parallel
  [#10402](https://github.com/khulnasoft/khulnasoft/pull/10402)

- [sdk/python] Makes global ROOT, CONFIG, _SECRET_KEYS ContextVars to not leak state between parallel inline Pulumi programs
  [#10472](https://github.com/khulnasoft/khulnasoft/pull/10472)

- [sdk/go] Improve error messages for `StackReference`s
  [#10477](https://github.com/khulnasoft/khulnasoft/pull/10477)

- [sdk/dotnet] Added `Output.CreateSecret<T>(Output<T> value)` to set the secret bit on an output value.
  [#10467](https://github.com/khulnasoft/khulnasoft/pull/10467)

- [policy] `khulnasoft policy publish` now takes into account `.gitignore` files higher in the file tree.
  [#10493](https://github.com/khulnasoft/khulnasoft/pull/10493)

- [sdk/go] enable direct compilation via `go build`(set `PULUMI_GO_USE_RUN=true` to opt out)
  [#10375](https://github.com/khulnasoft/khulnasoft/pull/10375)
...
- [cli/backend] Updates no longer immediately renew the token but wait
  ...
  CLI. [#10462](https://github.com/khulnasoft/khulnasoft/pull/10462)

- [cli/plugin] `plugin install` now supports a `--checksum` option.
  [#10528](https://github.com/khulnasoft/khulnasoft/pull/10528)

- [sdk/{nodejs/python}] Added `getOrganization()` to return the current organization if available.
  [#10504](https://github.com/khulnasoft/khulnasoft/pull/10504)

### Bug Fixes

- [codegen/go] Fix StackReference codegen.
  [#10260](https://github.com/khulnasoft/khulnasoft/pull/10260

- [engine/backends]: Fix bug where File state backend failed to apply validation to stack names, resulting in a panic.
  [#10417](https://github.com/khulnasoft/khulnasoft/pull/10417)

- [cli] Fix VCS detection for domains other than .com and .org.
  [#10415](https://github.com/khulnasoft/khulnasoft/pull/10415)

- [codegen/go] Fix incorrect method call for reading floating point values from configuration.
  [#10445](https://github.com/khulnasoft/khulnasoft/pull/10445)

- [engine]: HTML characters are no longer escaped in JSON output.
  [#10440](https://github.com/khulnasoft/khulnasoft/pull/10440)

- [codegen/go] Ensure consistency between go docs information and package name
  [#10452](https://github.com/khulnasoft/khulnasoft/pull/10452)

- [auto/go] Clone non-default branches (and tags).
  [#10285](https://github.com/khulnasoft/khulnasoft/pull/10285)

- [cli] Fixes `survey.v1` panics in Terminal UI introduced in
  [#10130](https://github.com/khulnasoft/khulnasoft/issues/10130) in v3.38.0.
  [#10475](https://github.com/khulnasoft/khulnasoft/pull/10475)

- [codegen/ts] Fix non-khulnasoft owned provider import alias.
  [#10447](https://github.com/khulnasoft/khulnasoft/pull/10447)

- [codegen/go] Fix import path for non-khulnasoft owner providers
  [#10485](https://github.com/khulnasoft/khulnasoft/pull/10485)

- [cli] Fixes panics on repeat Ctrl+C invocation during long-running updates
  [#10489](https://github.com/khulnasoft/khulnasoft/pull/10489)

- [cli] Improve Windows reliability with dependency update to ssh-agent
  [#10486](https://github.com/khulnasoft/khulnasoft/pull/10486)
...
- [sdk/{dotnet,nodejs,python}] Dynamic providers and automation API will not trigger a firewall
  ...
  [#10498](https://github.com/khulnasoft/khulnasoft/pull/10498)
  [#10502](https://github.com/khulnasoft/khulnasoft/pull/10502)
  [#10503](https://github.com/khulnasoft/khulnasoft/pull/10503)

- [cli] Fix `khulnasoft console` command to follow documented behavior in help message/docs.
  [#10509](https://github.com/khulnasoft/khulnasoft/pull/10509)

- [sdk/nodejs] Fixes an issue which would occur when multiple processes were spawned and some would receive no stdout/stderr
  [10522](https://github.com/khulnasoft/khulnasoft/pull/10522)

- [engine] Plugin resolution now automatically installs any missing plugins as they are encountered.
  [#10530](https://github.com/khulnasoft/khulnasoft/pull/10530)

- [python] put python version check after installing dependencies to resolve `fork/exec` warning
  [#10524](https://github.com/khulnasoft/khulnasoft/pull/10524)

- [go/codegen] Fix generating invalid Go code when derivatives of input types collide with existing resource types
  [#10551](https://github.com/khulnasoft/khulnasoft/pull/10551)
...
- [cli] Updated to the latest version of go-git.
  [#10330](https://github.com/khulnasoft/khulnasoft/pull/10330)

- [sdk] Merge python error message and traceback into single error message.
   [#10348](https://github.com/khulnasoft/khulnasoft/pull/10348)

- [sdk/python] Support optional default parameters in khulnasoft.Config
  [#10344](https://github.com/khulnasoft/khulnasoft/pull/10344)

- [sdk/nodejs] Adds warning message when entrypoint resolution is ambiguous
  [#3582](https://github.com/khulnasoft/khulnasoft/issues/3582)
...
- [automation] Add options for Automation API in each SDK to control logging and tracing, allowing
  ...
  [#10338](https://github.com/khulnasoft/khulnasoft/pull/10338)

- [yaml] [Updates Pulumi YAML to v0.5.4](https://github.com/khulnasoft/khulnasoft-yaml/releases/tag/v0.5.4)

- [java] [Updates Pulumi Java to v0.5.4](https://github.com/khulnasoft/khulnasoft-java/releases/tag/v0.5.4)

- [cli] `khulnasoft about` now queries language plugins for information, rather than having hardcoded language logic.
  [#10392](https://github.com/khulnasoft/khulnasoft/pull/10392)

- [sdk/python] Deprecate PULUMI_TEST_MODE
  [#10400](https://github.com/khulnasoft/khulnasoft/pull/10400)


### Bug Fixes

- [cli] Paginate template options
  [#10130](https://github.com/khulnasoft/khulnasoft/issues/10130)

- [sdk/dotnet] Fix serialization of non-generic list types.
  [#10277](https://github.com/khulnasoft/khulnasoft/pull/10277)

- [codegen/nodejs] Correctly reference external enums.
  [#10286](https://github.com/khulnasoft/khulnasoft/pull/10286)

- [sdk/python] Support deeply nested protobuf objects.
  [#10284](https://github.com/khulnasoft/khulnasoft/pull/10284)

- Revert [Remove api/renewLease from startup crit path](khulnasoft/khulnasoft#10168) to fix #10293.
  [#10294](https://github.com/khulnasoft/khulnasoft/pull/10294)

- [codegen/go] Remove superfluous double forward slash from doc.go
  [#10317](https://github.com/khulnasoft/khulnasoft/pull/10317)

- [codegen/go] Add an external package cache option to `GenerateProgramOptions`.
  [#10340](https://github.com/khulnasoft/khulnasoft/pull/10340)

- [cli/plugins] Don't retry plugin downloads that failed due to local file errors.
  [#10341](https://github.com/khulnasoft/khulnasoft/pull/10341)
...
- [dotnet] Set environment exit code during `Deployment.RunAsync` in case users don't bubble it the program entry point themselves
  [#10217](https://github.com/khulnasoft/khulnasoft/pull/10217)

- [cli/display] Fix a panic in the color logic.
  [#10354](https://github.com/khulnasoft/khulnasoft/pull/10354
...
- [cli] Groups `khulnasoft help` commands by category
  [#10170](https://github.com/khulnasoft/khulnasoft/pull/10170)

- [sdk/nodejs] Removed stack trace output for Typescript compilation errors
  [#10259](https://github.com/khulnasoft/khulnasoft/pull/10259)

### Bug Fixes

- [cli] Fix installation failures on Windows due to release artifacts shipped omitting a folder, `khulnasoft/*.exe` instead
  of `khulnasoft/bin/*.exe`.
  [#10264](https://github.com/khulnasoft/khulnasoft/pull/10264)
...
- [engine] Engine now always encrypts secret return values in Invoke.
  ...
  [#10239](https://github.com/khulnasoft/khulnasoft/pull/10239)

### Improvements

- [auto/go] Adds the ability to capture incremental `stderr`
  via the new option `ErrorProgressStreams`.
  [#10179](https://github.com/khulnasoft/khulnasoft/pull/10179)

- [cli/plugins] Warn that using GITHUB_REPOSITORY_OWNER is deprecated.
  [#10142](https://github.com/khulnasoft/khulnasoft/pull/10142)

- [dotnet/codegen] code generation for csharp Pulumi programs now targets .NET 6
  [#10143](https://github.com/khulnasoft/khulnasoft/pull/10143)

- [cli] Allow `khulnasoft plugin install <type> <pkg> -f <path>` to target a binary
  file or a folder.
  [#10094](https://github.com/khulnasoft/khulnasoft/pull/10094)

- [cli/config] Allow `khulnasoft config cp --path` between objects.
  [#10147](https://github.com/khulnasoft/khulnasoft/pull/10147)

- [codegen/schema] Support stack reference as a resource
  [#10174](https://github.com/khulnasoft/khulnasoft/pull/10174)

- [backends] When logging in to a file backend, validate that the bucket is accessible.
  [#10012](https://github.com/khulnasoft/khulnasoft/pull/10012)

- [cli] Add flag to specify whether to install dependencies on `khulnasoft convert`.
  [#10198](https://github.com/khulnasoft/khulnasoft/pull/10198)

- [cli] Expose `gen-completion` command when running `khulnasoft --help`.
  [#10218](https://github.com/khulnasoft/khulnasoft/pull/10218)

- [sdk/go] Expose context.Context from khulnasoft.Context.
  [#10190](https://github.com/khulnasoft/khulnasoft/pull/10190)

- [cli/plugins] Add local plugin linkage in `Pulumi.yaml`.
  [#10146](https://github.com/khulnasoft/khulnasoft/pull/10146)

- [engine] Remove sequence numbers from the engine and provider interfaces.
  [#10203](https://github.com/khulnasoft/khulnasoft/pull/10203)

- [engine] The engine will retry plugin downloads that error.
  [#10248](https://github.com/khulnasoft/khulnasoft/pull/10248)

### Bug Fixes

- [cli] Only log github request headers at log level 11.
  [#10140](https://github.com/khulnasoft/khulnasoft/pull/10140)
...
- [sdk/go] `config.Encrypter` and `config.Decrypter` interfaces now
  ...
  [#10037](https://github.com/khulnasoft/khulnasoft/pull/10037)

- [codegen/go] Support program generation, `khulnasoft convert` for programs that create explicit
  provider resources.
  [#10132](https://github.com/khulnasoft/khulnasoft/issues/10132)

- [sdk/go] Remove the `AsName` and `AsQName` asserting functions.
  [#10156](https://github.com/khulnasoft/khulnasoft/pull/10156)

- [python] PULUMI_PYTHON_CMD is checked for deciding what python binary to use in a virtual environment.
  [#10155](https://github.com/khulnasoft/khulnasoft/pull/10155)

- [cli] Reduced the noisiness of `khulnasoft new --help` by replacing the list of available templates to just the number.
  [#10164](https://github.com/khulnasoft/khulnasoft/pull/10164)

- [cli] Revert "Add last status to `khulnasoft stack ls` output #10059"
  [#10221](https://github.com/khulnasoft/khulnasoft/pull/10221)

- [python] Fix overriding of PATH on Windows.
  [#10236](https://github.com/khulnasoft/khulnasoft/pull/10236)

- [dotnet/codgen] Allow specified root namespace to be suffixed with "Pulumi" when generating packages
  [#10245](https://github.com/khulnasoft/khulnasoft/pull/10245)

- [dotnet/sdk] Serialize immutable arrays initialized by default.
  [#10247](https://github.com/khulnasoft/khulnasoft/pull/10247)

- [dotnet/codegen] Override static `Empty` property to return concrete argument types
  [#10250](https://github.com/khulnasoft/khulnasoft/pull/10250)
...
- [cli] Display outputs during the very first preview.
  [#10031](https://github.com/khulnasoft/khulnasoft/pull/10031)

- [cli] Add Last Status to `khulnasoft stack ls` output.
  [#6148](https://github.com/khulnasoft/khulnasoft/pull/6148)

- [cli] Allow khulnasoft `destroy -s <stack>` if not in a Pulumi project dir
  [#9918](https://github.com/khulnasoft/khulnasoft/pull/9918)

- [protobuf] Pulumi protobuf messages are now namespaced under "khulnasoft".
  [#10074](https://github.com/khulnasoft/khulnasoft/pull/10074)

- [cli] Truncate long stack outputs
  [#9905](https://github.com/khulnasoft/khulnasoft/issues/9905)

- [sdk/go] Add `As*Output` methods to `AnyOutput`
  [#10085](https://github.com/khulnasoft/khulnasoft/pull/10085)

- [yaml] [Updates Pulumi YAML to v0.5.3](https://github.com/khulnasoft/khulnasoft-yaml/releases/tag/v0.5.3)

- [sdk/go] Accept a short branch name in `GitRepo.Branch`
  [#10118](https://github.com/khulnasoft/khulnasoft/pull/10118)

### Bug Fixes

- [cli] `khulnasoft convert` help text is wrong
  [#9892](https://github.com/khulnasoft/khulnasoft/issues/9892)

- [go/codegen] fix error assignment when creating a new resource in generated go code
  [#10049](https://github.com/khulnasoft/khulnasoft/pull/10049)

- [cli] `khulnasoft convert` generates incorrect input parameter names for C#
  [#10042](https://github.com/khulnasoft/khulnasoft/issues/10042)

- [engine] Un-parent child resource when a resource is deleted during a refresh.
  [#10073](https://github.com/khulnasoft/khulnasoft/pull/10073)

- [cli] `khulnasoft state change-secrets-provider` now takes `--stack` into account
  [#10075](https://github.com/khulnasoft/khulnasoft/pull/10075)

- [nodejs/sdkgen] Default set `khulnasoft.name` in package.json to the khulnasoft package name.
  [#10088](https://github.com/khulnasoft/khulnasoft/pull/10088)

- [sdk/python] update protobuf library to v4 which speeds up khulnasoft CLI dramatically on M1 machines
  [#10063](https://github.com/khulnasoft/khulnasoft/pull/10063)

- [engine] Fix data races discovered in CLI and Go SDK that could cause nondeterministic behavior
  or a panic.
  [#10081](https://github.com/khulnasoft/khulnasoft/pull/10081),
  [#10100](https://github.com/khulnasoft/khulnasoft/pull/10100)

- [go] Fix panic when returning khulnasoft.Bool, .String, .Int, and .Float64 in the argument to
  ApplyT and casting the result to the corresponding output, e.g.: BoolOutput.
  [#10103](https://github.com/khulnasoft/khulnasoft/pull/10103)

## 3.35.3 (2022-07-01)

### Improvements

- [plugins] Plugin download urls now support GitHub as a first class url schema. For example "github://api.github.com/khulnasoftverse".
  [#9984](https://github.com/khulnasoft/khulnasoft/pull/9984)

- [nodejs] No longer roundtrips requests for the stack URN via the engine.
  [#9680](https://github.com/khulnasoft/khulnasoft/pull/9680)

### Bug Fixes

- [cli] `khulnasoft convert` supports provider packages without a version.
  [#9976](https://github.com/khulnasoft/khulnasoft/pull/9976)

- [cli] Revert changes to how --target works. This means that non-targeted resources do need enough valid inputs to pass Check.
  [#10024](https://github.com/khulnasoft/khulnasoft/pull/10024)
...
- [sdk/go] Added `PreviewDigest` for third party tools to be able to ingest the preview json
  [#9886](https://github.com/khulnasoft/khulnasoft/pull/9886)

- [cli] Do not require the `--yes` option if the `--skip-preview` option is set.
  [#9972](https://github.com/khulnasoft/khulnasoft/pull/9972)

- [yaml] [Updates Pulumi YAML to v0.5.2](https://github.com/khulnasoft/khulnasoft-yaml/releases/tag/v0.5.2),
  containing bug fixes and improvements primarily for `khulnasoft convert` from YAML.
  [#9993](https://github.com/khulnasoft/khulnasoft/pull/9993)

### Bug Fixes

- [engine] Filter out non-targeted resources much earlier in the engine cycle.
  [#9960](https://github.com/khulnasoft/khulnasoft/pull/9960)

- [cli] Fix a panic in `khulnasoft plugin ls --project --json`.
  [#9998](https://github.com/khulnasoft/khulnasoft/pull/9998)

- [engine] Revert support for aliases in the engine.
  [#9999](https://github.com/khulnasoft/khulnasoft/pull/9999)

## 3.35.1 (2022-06-23)

### Improvements

- [cli] The engine will now warn when a resource option is applied to a Component resource when that option will have no effect. This extends [#9863](https://github.com/khulnasoft/khulnasoft/pull/9863) which only warns for the `ignoreChanges` resource options.
  [#9921](https://github.com/khulnasoft/khulnasoft/pull/9921)

- [auto/*] Add a option to control the `--show-secrets` flag in the automation API.
  [#9879](https://github.com/khulnasoft/khulnasoft/pull/9879)

### Bug Fixes

- [auto/go] Fix passing of the color option.
  [#9940](https://github.com/khulnasoft/khulnasoft/pull/9940)

- [engine] Fix panic from unexpected resource name formats.
  [#9950](https://github.com/khulnasoft/khulnasoft/pull/9950)
...
- [cli/python] Respond to SIGINT when installing plugins.
  [#9793](https://github.com/khulnasoft/khulnasoft/pull/9793)

- [codegen/go] Always chose the correct version when `respectSchemaVersion` is set.
  [#9798](https://github.com/khulnasoft/khulnasoft/pull/9798)

### Bug Fixes

- [sdk/python] Better explain the keyword arguments to create(etc)_stack.
  [#9794](https://github.com/khulnasoft/khulnasoft/pull/9794)

- [cli] Revert changes causing a panic in `khulnasoft destroy` that tried to operate without config files.
  [#9821](https://github.com/khulnasoft/khulnasoft/pull/9821)

- [cli] Revert to statically linked binaries on Windows and Linux,
  fixing a regression introduced in 3.34.0
  [#9816](https://github.com/khulnasoft/khulnasoft/issues/9816)

- [codegen/python] ResourceOptions are no longer mutated by resources.
  [#9802](https://github.com/khulnasoft/khulnasoft/pull/9802)
...
- [codegen/go] Handle long and complicated traversals in a nicer way.
  [#9726](https://github.com/khulnasoft/khulnasoft/pull/9726)

- [cli] Allow khulnasoft `destroy -s <stack>` if not in a Pulumi project dir
  [#9613](https://github.com/khulnasoft/khulnasoft/pull/9613)

- [cli] Plugins will now shut themselves down if they can't contact the engine that started them.
  [#9735](https://github.com/khulnasoft/khulnasoft/pull/9735)
...
- [cli/engine] The engine will emit a warning of a key given in additional secret outputs doesn't match any of the property keys on the resources.
  [#9750](https://github.com/khulnasoft/khulnasoft/pull/9750)

- [sdk/go] Add `CompositeInvoke` function, like `Composite` but for `InvokeOption`.
  [#9752](https://github.com/khulnasoft/khulnasoft/pull/9752)
...
- [cli] The `gcpkms://` now supports the same credentials resolution mechanism as the state store, including the `GOOGLE_CREDENTIALS`.`
  [#6379](https://github.com/khulnasoft/khulnasoft/pull/6379)

- [yaml] [Updates Pulumi YAML to v0.5.1](https://github.com/khulnasoft/khulnasoft-yaml/releases/tag/v0.5.1),
  containing bug fixes, new functions, diagnostics and validation. Fixes support for using providers
  such as `awsx`.
  [#9797](https://github.com/khulnasoft/khulnasoft/pull/9797)

### Bug Fixes

- [sdk/nodejs] Fix a crash due to dependency cycles from component resources.
  [#9683](https://github.com/khulnasoft/khulnasoft/pull/9683)

- [cli/about] Make `khulnasoft about` aware of the YAML and Java runtimes.
  [#9745](https://github.com/khulnasoft/khulnasoft/pull/9745)

- [cli/engine] Fix a panic deserializing resource plans without goals.
  [#9749](https://github.com/khulnasoft/khulnasoft/pull/9749)

- [cli/engine] Provide a sorting for plugins of equivalent version.
  [#9761](https://github.com/khulnasoft/khulnasoft/pull/9761)

- [cli/backend] Fix degraded performance in filestate backend
  [#9777](https://github.com/khulnasoft/khulnasoft/pull/9777)
  [#9796](https://github.com/khulnasoft/khulnasoft/pull/9796)

- [engine] Engine correctly the number of bytes written to a TAR archive is what was expected.
  [#9792](https://github.com/khulnasoft/khulnasoft/pull/9792)

## 3.33.2 (2022-05-27)

### Improvements

- [cli] `khulnasoft logout` now prints a confirmation message that it logged out.
  [#9641](https://github.com/khulnasoft/khulnasoft/pull/9641)
...
- [cli/backend] Add gzip compression to filestate backend. Compression can be enabled via `PULUMI_SELF_MANAGED_STATE_GZIP=true`. Special thanks to @awoimbee for the initial PR.
  [#9610](https://github.com/khulnasoft/khulnasoft/pull/9610)

- [sdk/nodejs] Lazy load inflight context to remove module import side-effect.
  [#9375](https://github.com/khulnasoft/khulnasoft/issues/9375)

### Bug Fixes

- [sdk/python] Fix spurious diffs causing an "update" on resources created by dynamic providers.
  [#9656](https://github.com/khulnasoft/khulnasoft/pull/9656)

- [sdk/python] Do not depend on the children of remote component resources.
  [#9665](https://github.com/khulnasoft/khulnasoft/pull/9665)

- [codegen/nodejs] Emit the "package.json".khulnasoft.server as "server" correctly. Previously, "pluginDownloadURL" was emitted but never read.
  [#9662](https://github.com/khulnasoft/khulnasoft/pull/9662)

- [cli] Fix panic in `khulnasoft console` when no stack is selected.
  [#9594](https://github.com/khulnasoft/khulnasoft/pull/9594)

- [cli] Engine now correctly tracks that resource reads have unique URNs.
  [#9516](https://github.com/khulnasoft/khulnasoft/pull/9516)

- [sdk/python] Fixed bug in automation API that invoked Pulumi with malformed arguments.
  [#9607](https://github.com/khulnasoft/khulnasoft/pull/9607)

- [cli/backend] Fix a panic in the filestate backend when renaming history files.
  [#9673](https://github.com/khulnasoft/khulnasoft/pull/9673)

- [sdk/python] Pin protobuf library to <4.
  [#9696](https://github.com/khulnasoft/khulnasoft/pull/9696)

- [sdk/proto] Inline dockerfile used to generate protobuf code.
  [#9700](https://github.com/khulnasoft/khulnasoft/pull/9700)

## 3.33.1 (2022-05-19)

### Improvements

- [cli] Add `--stack` to `khulnasoft about`.
  [#9518](https://github.com/khulnasoft/khulnasoft/pull/9518)

- [sdk/dotnet] Bumped several dependency versions to avoid pulling packages with known vulnerabilities.
  [#9591](https://github.com/khulnasoft/khulnasoft/pull/9591)

- [cli] Updated gocloud.dev to 0.24.0, which adds support for using AWS SDK v2. It enables users to pass an AWS profile to the `awskms` secrets provider url (i.e. `awskms://alias/khulnasoft?awssdk=v2&region=eu-west-1&profile=aws-prod`)
  [#9590](https://github.com/khulnasoft/khulnasoft/pull/9590)

- [sdk/nodejs] Lazy load V8 inspector session to remove module import side-effect [#9375](https://github.com/khulnasoft/khulnasoft/issues/9375)

### Bug Fixes

- [cli] The PULUMI_CONFIG_PASSPHRASE environment variables can be empty, this is treated different to being unset.
  [#9568](https://github.com/khulnasoft/khulnasoft/pull/9568)

- [codegen/python] Fix importing of enum types from other packages.
  [#9579](https://github.com/khulnasoft/khulnasoft/pull/9579)
...
- [auto/python] - Fix text color argument being ignored during stack     operations.
  [#9615](https://github.com/khulnasoft/khulnasoft/pull/9615)
...
- [cli/plugins] The engine will try to lookup the latest version of plugins if the program doesn't specify a version to use.
  [#9537](https://github.com/khulnasoft/khulnasoft/pull/9537)
### Bug Fixes

- [cli] Fix an issue using PULUMI_CONFIG_PASSPHRASE_FILE.
  [#9540](https://github.com/khulnasoft/khulnasoft/pull/9540)

- [cli/display] Avoid an assert in the table display logic.
  [#9543](https://github.com/khulnasoft/khulnasoft/pull/9543)
...
- [dotnet] No longer roundtrips requests for the stack URN via the engine.
  [#9515](https://github.com/khulnasoft/khulnasoft/pull/9515)

### Bug Fixes

- [codegen/go] Enable obtaining resource outputs off a ResourceOutput.
  [#9513](https://github.com/khulnasoft/khulnasoft/pull/9513)

- [codegen/go] Ensure that "plain" generates shallowly plain types.
  [#9512](https://github.com/khulnasoft/khulnasoft/pull/9512)

- [codegen/nodejs] Fix enum naming when the enum name starts with `_`.
  [#9453](https://github.com/khulnasoft/khulnasoft/pull/9453)

- [cli] Empty passphrases environment variables are now treated as if the variable was not set.
  [#9490](https://github.com/khulnasoft/khulnasoft/pull/9490)

- [sdk/go] Fix awaits for outputs containing resources.
  [#9106](https://github.com/khulnasoft/khulnasoft/pull/9106)

- [cli] Decode YAML mappings with numeric keys during diff.
  [#9502](https://github.com/khulnasoft/khulnasoft/pull/9503)

- [cli] Fix an issue with explicit and default organization names in `khulnasoft new`
  [#9514](https://github.com/khulnasoft/khulnasoft/pull/9514)
...
- [auto/*] Add `--save-plan` and `--plan` options to automation API.
  [#9391](https://github.com/khulnasoft/khulnasoft/pull/9391)

- [cli] "down" is now treated as an alias of "destroy".
  [#9458](https://github.com/khulnasoft/khulnasoft/pull/9458)

- [go] Add `Composite` resource option allowing several options to be encapsulated into a "single" option.
  [#9459](https://github.com/khulnasoft/khulnasoft/pull/9459)

- [codegen] Support all [Asset and Archive](https://www.khulnasoft.com/docs/intro/concepts/assets-archives/) types.
  [#9463](https://github.com/khulnasoft/khulnasoft/pull/9463)

- [cli] Display JSON/YAML property values as objects for creates, sames, and deletes.
  [#9484](https://github.com/khulnasoft/khulnasoft/pull/9484)

### Bug Fixes

- [codegen/go] Ensure that plain properties are plain.
  [#9430](https://github.com/khulnasoft/khulnasoft/pull/9430)
  [#9488](https://github.com/khulnasoft/khulnasoft/pull/9488)

- [cli] Fixed some context leaks where shutdown code wasn't correctly called.
  [#9438](https://github.com/khulnasoft/khulnasoft/pull/9438)

- [cli] Do not render array diffs for unchanged elements without recorded values.
  [#9448](https://github.com/khulnasoft/khulnasoft/pull/9448)
...
- [auto/go] Fixed the exit code reported by `runPulumiCommandSync` to be zero if the command runs successfully. Previously it returned -2 which could lead to confusing messages if the exit code was used for other errors, such as in `Stack.Preview`.
  [#9443](https://github.com/khulnasoft/khulnasoft/pull/9443)

- [auto/go] Fixed a race condition that could cause `Preview` to fail with "failed to get preview summary".
  [#9467](https://github.com/khulnasoft/khulnasoft/pull/9467)

- [backend/filestate] Fix a bug creating `stack.json.bak` files.
  [#9476](https://github.com/khulnasoft/khulnasoft/pull/9476)
...
- [cli] Split invoke request protobufs, as monitors and providers take different arguments.
  [#9323](https://github.com/khulnasoft/khulnasoft/pull/9323)
...
- [providers] - gRPC providers can now support an Attach method for debugging. The engine will attach to providers listed in the PULUMI_DEBUG_PROVIDERS environment variable. This should be of the form "providerName:port,otherProvider:port".
  [#8979](https://github.com/khulnasoft/khulnasoft/pull/8979)

### Bug Fixes

- [cli/plugin] - Dynamic provider binaries will now be found even if khulnasoft/bin is not on $PATH.
  [#9396](https://github.com/khulnasoft/khulnasoft/pull/9396)

- [sdk/go] - Fail appropriatly for `config.Try*` and `config.Require*` where the
  key is present but of the wrong type.
  [#9407](https://github.com/khulnasoft/khulnasoft/pull/9407)

## 3.29.1 (2022-04-13)

### Improvements

- [cli] - Installing of language specific project dependencies is now managed by the language plugins, not the khulnasoft cli.
  [#9294](https://github.com/khulnasoft/khulnasoft/pull/9294)

- [cli] Warn users when there are pending operations but proceed with deployment
  [#9293](https://github.com/khulnasoft/khulnasoft/pull/9293)

- [cli] Display more useful diffs for secrets that are not primitive values
  [#9351](https://github.com/khulnasoft/khulnasoft/pull/9351)

- [cli] - Warn when `additionalSecretOutputs` is used to mark the `id` property as secret.
  [#9360](https://github.com/khulnasoft/khulnasoft/pull/9360)

- [cli] Display richer diffs for texutal property values.
  [#9376](https://github.com/khulnasoft/khulnasoft/pull/9376)

- [cli] Display richer diffs for JSON/YAML property values.
  [#9380](https://github.com/khulnasoft/khulnasoft/pull/9380)

### Bug Fixes

- [codegen/node] - Fix an issue with escaping deprecation messages.
  [#9371](https://github.com/khulnasoft/khulnasoft/pull/9371)

- [cli] - StackReferences will now correctly use the service bulk decryption end point.
  [#9373](https://github.com/khulnasoft/khulnasoft/pull/9373)
...
- When a resource is aliased to an existing resource with a different URN, only store
  ...
  aliases.
  [#9288](https://github.com/khulnasoft/khulnasoft/pull/9288)

- Clear pending operations during `khulnasoft refresh` or `khulnasoft up -r`.
  [#8435](https://github.com/khulnasoft/khulnasoft/pull/8435)

- [cli] - `khulnasoft whoami --verbose` and `khulnasoft about` include a list of the current users organizations.
  [#9211](https://github.com/khulnasoft/khulnasoft/pull/9211)

### Bug Fixes

- [codegen/go] - Fix Go SDK function output to check for errors
  [khulnasoft-aws#1872](https://github.com/khulnasoft/khulnasoft-aws/issues/1872)

- [cli/engine] - Fix a panic due to `Check` returning nil while using update plans.
  [#9304](https://github.com/khulnasoft/khulnasoft/pull/9304)
...
- [cli] - Implement `khulnasoft stack unselect`.
  [#9179](https://github.com/khulnasoft/khulnasoft/pull/9179)

- [language/dotnet] - Updated Pulumi dotnet packages to use grpc-dotnet instead of grpc.
  [#9149](https://github.com/khulnasoft/khulnasoft/pull/9149)

- [cli/config] - Rename the `config` property in `Pulumi.yaml` to `stackConfigDir`. The `config` key will continue to be supported.
  [#9145](https://github.com/khulnasoft/khulnasoft/pull/9145)
...
- [cli/plugins] Add support for downloading plugin from private Pulumi GitHub releases. This also drops the use of the `GITHUB_ACTOR` and `GITHUB_PERSONAL_ACCESS_TOKEN` environment variables for authenticating to github. Only `GITHUB_TOKEN` is now used, but this can be set to a personal access token.
  [#9185](https://github.com/khulnasoft/khulnasoft/pull/9185)

- [cli] - Speed up `khulnasoft stack --show-name` by skipping unneeded snapshot loading.
  [#9199](https://github.com/khulnasoft/khulnasoft/pull/9199)

- [cli/plugins] - Improved error message for missing plugins.
  [#5208](https://github.com/khulnasoft/khulnasoft/pull/5208)

- [sdk/nodejs] - Take engines property into account when engine-strict appear in npmrc file
  [#9249](https://github.com/khulnasoft/khulnasoft/pull/9249)

### Bug Fixes

- [sdk/nodejs] - Fix uncaught error "ENOENT: no such file or directory" when an error occurs during the stack up.
  [#9065](https://github.com/khulnasoft/khulnasoft/issues/9065)

- [sdk/nodejs] - Fix uncaught error "ENOENT: no such file or directory" when an error occurs during the stack preview.
  [#9272](https://github.com/khulnasoft/khulnasoft/issues/9272)

- [sdk/go] - Fix a panic in `khulnasoft.All` when using pointer inputs.
  [#9197](https://github.com/khulnasoft/khulnasoft/issues/9197)

- [cli/engine] - Fix a panic due to passing `""` as the ID for a resource read.
  [#9243](https://github.com/khulnasoft/khulnasoft/pull/9243)

- [cli/engine] - Fix a panic due to `Check` failing while using update plans.
  [#9254](https://github.com/khulnasoft/khulnasoft/pull/9254)

- [cli] - Stack names correctly take `org set-default` into account when printing.
  [#9240](https://github.com/khulnasoft/khulnasoft/pull/9240)
...
- [cli/new] Fix an error message when the project name picked by default was already used.
  [#9156](https://github.com/khulnasoft/khulnasoft/pull/9156)
...
- [area/cli] - Implemented `state rename` command.
  [#9098](https://github.com/khulnasoft/khulnasoft/pull/9098)

- [cli/plugins] `khulnasoft plugin install` can now look up the latest version of plugins on GitHub releases.
  [#9012](https://github.com/khulnasoft/khulnasoft/pull/9012)

- [cli/backend] - `khulnasoft cancel` is now supported for the file state backend.
  [#9100](https://github.com/khulnasoft/khulnasoft/pull/9100)
...
- [cli/import] - The import command no longer errors if resource properties do not validate. Instead the
  ...
  as best it can. This should result in more resources being imported to the khulnasoft state and being able to
  ...
  [#8922](https://github.com/khulnasoft/khulnasoft/pull/8922)

- [cli/import] - Code generation in `khulnasoft import` can now be disabled with the `--generate-code=false` flag.
  [#9141](https://github.com/khulnasoft/khulnasoft/pull/9141)

### Bug Fixes

- [sdk/python] - Fix build warnings. See
  [#9011](https://github.com/khulnasoft/khulnasoft/issues/9011) for more details.
  [#9139](https://github.com/khulnasoft/khulnasoft/pull/9139)

- [cli/backend] - Fixed an issue with non-atomicity when saving file state stacks.
  [#9122](https://github.com/khulnasoft/khulnasoft/pull/9122)

- [sdk/go] - Fixed an issue where the RetainOnDelete resource option is not applied.
  [#9147](https://github.com/khulnasoft/khulnasoft/pull/9147)
...
- [sdk/nodejs] - Fix Node `fs.rmdir` DeprecationWarning for Node JS 15.X+
  [#9044](https://github.com/khulnasoft/khulnasoft/pull/9044)

- [engine] - Fix deny default provider handling for Invokes and Reads.
  [#9067](https://github.com/khulnasoft/khulnasoft/pull/9067)

- [codegen/go] - Fix secret codegen for input properties
  [#9052](https://github.com/khulnasoft/khulnasoft/pull/9052)

- [sdk/nodejs] - `PULUMI_NODEJS_TSCONFIG_PATH` is now explicitly passed to tsnode for the tsconfig file.
  [#9062](https://github.com/khulnasoft/khulnasoft/pull/9062)
...
- [codegen/go] - Add GenerateProgramWithOpts function to enable configurable codegen options.
  [#8997](https://github.com/khulnasoft/khulnasoft/pull/8997)

- [cli] -  Enabled dot spinner for non-interactive mode
  [#8996](https://github.com/khulnasoft/khulnasoft/pull/8996)

- [sdk] - Add `RetainOnDelete` as a resource option.
  [#8746](https://github.com/khulnasoft/khulnasoft/pull/8746)

- [cli] - Adding `completion` as an alias to `gen-completion`
  [#9006](https://github.com/khulnasoft/khulnasoft/pull/9006)

- [cli/plugins] Add support for downloading plugin from private GitHub releases.
  [#8944](https://github.com/khulnasoft/khulnasoft/pull/8944)

### Bug Fixes

- [sdk/go] - Normalize merge behavior for `ResourceOptions`, inline
  with other SDKs. See https://github.com/khulnasoft/khulnasoft/issues/8796 for more
  details.
  [#8882](https://github.com/khulnasoft/khulnasoft/pull/8882)

- [sdk/go] - Correctly parse GoLang version.
  [#8920](https://github.com/khulnasoft/khulnasoft/pull/8920)

- [sdk/go] - Fix git initialization in git_test.go
  [#8924](https://github.com/khulnasoft/khulnasoft/pull/8924)
...
- [sdk/nodejs] - Fix nodejs function serialization module path to comply with package.json
  ...
  [#8893](https://github.com/khulnasoft/khulnasoft/pull/8893)

- [cli/python] - Parse a larger subset of PEP440 when guessing Pulumi package versions.
  [#8958](https://github.com/khulnasoft/khulnasoft/pull/8958)

- [sdk/nodejs] - Allow disabling TypeScript typechecking
  [#8981](https://github.com/khulnasoft/khulnasoft/pull/8981)

- [cli/backend] - Revert a change to file state locking that was causing stacks to stay locked.
  [#8995](https://github.com/khulnasoft/khulnasoft/pull/8995)

- [cli] - Fix passphrase secrets provider prompting.
  [#8986](https://github.com/khulnasoft/khulnasoft/pull/8986)

- [cli] - Fix an assert when replacing protected resources.
  [#9004](https://github.com/khulnasoft/khulnasoft/pull/9004)
...
- [release] - Update .gitignore to allow for a clean git repository for release.
  [#8932](https://github.com/khulnasoft/khulnasoft/pull/8932)
...
- [codegen/go] - Implement go type conversions for optional string, boolean, int, and float32
  ...
  [#8839](https://github.com/khulnasoft/khulnasoft/pull/8839)
...
- [sdk/nodejs] - Fix resource plugins advertising a `pluginDownloadURL` not being downloaded. This
  ...
  outside the registry. See: https://github.com/khulnasoft/khulnasoft/issues/8890 for the tracking issue to
...
- [cli] Experimental support for update plans. Only enabled when PULUMI_EXPERIMENTAL is
  ...
  [#8448](https://github.com/khulnasoft/khulnasoft/pull/8448)

- [codegen] - Add language option to make codegen respect the `Version` field in
  the Pulumi package schema.
  [#8881](https://github.com/khulnasoft/khulnasoft/pull/8881)

- [cli] - Support wildcards for `khulnasoft up --target <urn>` and similar commands.
  [#8883](https://github.com/khulnasoft/khulnasoft/pull/8883).
...
- [cli/import] - The import command now takes an extra argument --properties to instruct the engine which
  ...
  [#8846](https://github.com/khulnasoft/khulnasoft/pull/8846)

- [cli] Ensure defaultOrg is used as part of any stack name
  [#8903](https://github.com/khulnasoft/khulnasoft/pull/8903)

### Bug Fixes

- [codegen] - Correctly handle third party resource imports.
  [#8861](https://github.com/khulnasoft/khulnasoft/pull/8861)

- [sdk/dotnet] - Normalize merge behavior for ComponentResourceOptions, inline
  with other SDKs. See https://github.com/khulnasoft/khulnasoft/issues/8796 for more
  details.
  [#8838](https://github.com/khulnasoft/khulnasoft/pull/8838)

- [codegen/nodejs] - Respect compat modes when referencing external types.
  [#8850](https://github.com/khulnasoft/khulnasoft/pull/8850)

- [cli] The engine will allow a resource to be replaced if either it's old or new state
  (or both) is not protected.
  [#8873](https://github.com/khulnasoft/khulnasoft/pull/8873)

- [cli] - Fixed CLI duplicating prompt question.
  [#8858](https://github.com/khulnasoft/khulnasoft/pull/8858)

- [cli] - `khulnasoft plugin install --reinstall` now always reinstalls plugins.
  [#8892](https://github.com/khulnasoft/khulnasoft/pull/8892)

- [codegen/go] - Honor import aliases for external types/resources.
  [#8833](https://github.com/khulnasoft/khulnasoft/pull/8833)

- [codegen/python] - Correctly reference external types/resources with same module name.
  [#8910](https://github.com/khulnasoft/khulnasoft/pull/8910)

- [sdk/nodejs] - Correctly pickup provider as a member of providers.
  [#8923](https://github.com/khulnasoft/khulnasoft/pull/8923)
...
- [sdk/{nodejs,python}] - Remove sequence numbers from the dynamic provider interfaces.
  [#8849](https://github.com/khulnasoft/khulnasoft/pull/8849)
...
- [codegen/dotnet] - Add C# extension `rootNamespace`, allowing the user to
  ...
  `schema.publisher`.
  [#8735](https://github.com/khulnasoft/khulnasoft/pull/8735)

- [cli] Download provider plugins from GitHub Releases
  [#8785](https://github.com/khulnasoft/khulnasoft/pull/8785)
...
- [cli] Using a decryptAll functionality when deserializing a deployment. This will allow
  ...
  [#8676](https://github.com/khulnasoft/khulnasoft/pull/8676)

- [sdk/dotnet] - Changed `Output<T>.ToString()` to return an informative message rather than just "Output`1[X]"
  [#8767](https://github.com/khulnasoft/khulnasoft/pull/8767)

- [cli] Add the concept of sequence numbers to the engine and resource provider interface.
  [#8631](https://github.com/khulnasoft/khulnasoft/pull/8631)

- [common] Allow names with hyphens.

- [cli] - Add support for overriding plugin download URLs.
  [#8798](https://github.com/khulnasoft/khulnasoft/pull/8798)

- [automation] - Add `color` option to stack up, preview, refresh, and destroy commands.
  [#8811](https://github.com/khulnasoft/khulnasoft/pull/8811)

- [sdk/nodejs] - Support top-level default exports in ESM.
  [#8766](https://github.com/khulnasoft/khulnasoft/pull/8766)

- [cli] - Allow disabling default providers via the Pulumi config.
  [#8829](https://github.com/khulnasoft/khulnasoft/pull/8829)

- [cli] Add better error message for khulnasoft service rate limit responses
  [#7963](https://github.com/khulnasoft/khulnasoft/issues/7963)
...
- [sdk/{python,nodejs}] - Prevent `ResourceOptions.merge` from promoting between the
  ...
  for `.provider` and `.providers`, as described in [#8796](https://github.com/khulnasoft/khulnasoft/issues/8796).
  ...
  [#8770](https://github.com/khulnasoft/khulnasoft/pull/8770)

- [codegen/nodejs] - Generate an install script that runs `khulnasoft plugin install` with
  the `--server` flag when necessary.
  [#8730](https://github.com/khulnasoft/khulnasoft/pull/8730)

- [cli] The engine will no longer try to replace resources that are protected as that entails a delete.
  [#8810](https://github.com/khulnasoft/khulnasoft/pull/8810)

- [codegen/pcl] - Fix handling of function invokes without args
  [#8805](https://github.com/khulnasoft/khulnasoft/pull/8805)
...
- [sdk/dotnet] - Add `PluginDownloadURL` as a resource option. When provided by
  ...
  [#8739](https://github.com/khulnasoft/khulnasoft/pull/8739)

- [sdk] - Allow property paths to accept `[*]` as sugar for `["*"]`.
  [#8743](https://github.com/khulnasoft/khulnasoft/pull/8743)

- [sdk/dotnet] Add `Union.Bimap` function for converting both sides of a union at once.
  [#8733](https://github.com/khulnasoft/khulnasoft/pull/8733)
...
- [cli/config] - Revert number handling in `khulnasoft config`.
  [#8754](https://github.com/khulnasoft/khulnasoft/pull/8754)
...
- [sdk/{nodejs,go,python}] - Add `PluginDownloadURL` as a resource option. When provided by
  the schema, `PluginDownloadURL` will be baked into `new Resource` and `Invoke`
  requests in generated SDKs.
  [#8698](https://github.com/khulnasoft/khulnasoft/pull/8698)
  [#8690](https://github.com/khulnasoft/khulnasoft/pull/8690)
  [#8692](https://github.com/khulnasoft/khulnasoft/pull/8692)
...
- [auto/python] - Fixes an issue with exception isolation in a
  ...
  [#8693](https://github.com/khulnasoft/khulnasoft/pull/8693)
...
- [sdk/go] - Add `PluginDownloadURL` as a resource option.
  [#8555](https://github.com/khulnasoft/khulnasoft/pull/8555)

- [sdk/go] - Allow users to override enviromental variables for `GetCommandResults`.
  [#8610](https://github.com/khulnasoft/khulnasoft/pull/8610)

- [sdk/nodejs] Support using native ES modules as Pulumi scripts
  [#7764](https://github.com/khulnasoft/khulnasoft/pull/7764)

- [sdk/nodejs] Support a `nodeargs` option for passing `node` arguments to the Node language host
  [#8655](https://github.com/khulnasoft/khulnasoft/pull/8655)

### Bug Fixes

- [cli/engine] - Fix [#3982](https://github.com/khulnasoft/khulnasoft/issues/3982), a bug
  where the engine ignored the final line of stdout/stderr if it didn't terminate
  with a newline.
  [#8671](https://github.com/khulnasoft/khulnasoft/pull/8671)

- [nodejs/sdk] - GetRequiredPlugins: Return plugins even when there're errors.
  [#8699](https://github.com/khulnasoft/khulnasoft/pull/8699)
...
- [engine] - Interpret `pluginDownloadURL` as the provider host url when
  downloading plugins.
  [#8544](https://github.com/khulnasoft/khulnasoft/pull/8544)
...
- [codegen/go] - Do not generate unreferenced input types by default.
  [#7943](https://github.com/khulnasoft/khulnasoft/pull/7943)

- [codegen/go] - Simplify the application of object defaults in generated SDKs.
  [#8539](https://github.com/khulnasoft/khulnasoft/pull/8539)

- [codegen/{python,dotnet}] - Emit `khulnasoft-plugin.json` unconditionally.
  [#8527](https://github.com/khulnasoft/khulnasoft/pull/8527)
  [#8532](https://github.com/khulnasoft/khulnasoft/pull/8532)

- [sdk/python] - Lookup Pulumi packages by searching for `khulnasoft-plugin.json`.
  Pulumi packages need not be prefixed by `khulnasoft-` anymore.
  [#8515](https://github.com/khulnasoft/khulnasoft/pull/8515)

- [sdk/go] - Lookup packages by searching for `khulnasoft-plugin.json`.
  Pulumi packages need not be prefixed by `github.com/khulnasoft/khulnasoft-` anymore.
  [#8516](https://github.com/khulnasoft/khulnasoft/pull/8516)

- [sdk/dotnet] - Lookup packages by searching for `khulnasoft-plugin.json`.
  Pulumi packages need not be prefixed by `Pulumi.` anymore.
  [#8517](https://github.com/khulnasoft/khulnasoft/pull/8517)

- [sdk/go] - Emit `khulnasoft-plugin.json`
  [#8530](https://github.com/khulnasoft/khulnasoft/pull/8530)
...
- [cli] - Always use locking in filestate backends. This feature was
  ...
  [#8565](https://github.com/khulnasoft/khulnasoft/pull/8565)

- [{cli,auto}] - Exclude language plugins from `PULUMI_IGNORE_AMBIENT_PLUGINS`.
  [#8576](https://github.com/khulnasoft/khulnasoft/pull/8576)
...
- [sdk/dotnet] - Fixes a rare race condition that sporadically caused
  ...
  [#8495](https://github.com/khulnasoft/khulnasoft/pull/8495)

- [cli] Log secret decryption events when a project uses the Pulumi Service and a 3rd party secrets provider
  [#8563](https://github.com/khulnasoft/khulnasoft/pull/8563)
...
- [schema] Do not validate against the metaschema in ImportSpec. Clients that need to
  ...
  [#8543](https://github.com/khulnasoft/khulnasoft/pull/8543)

### Bug Fixes

- [codegen/schema] - Error on type token names that are not allowed (schema.Name
  or specified in allowedPackageNames).
  [#8538](https://github.com/khulnasoft/khulnasoft/pull/8538)
  [#8558](https://github.com/khulnasoft/khulnasoft/pull/8558)

- [codegen/go] - Fix `ElementType` for nested collection input and output types.
  [#8535](https://github.com/khulnasoft/khulnasoft/pull/8535)

- [{codegen,sdk}/{python,dotnet,go}] - Use `khulnasoft-plugin.json` rather than `khulnasoftplugin.json`.
  [#8593](https://github.com/khulnasoft/khulnasoft/pull/8593)
...
- [codegen/go] - Remove `ResourcePtr` types from generated SDKs. Besides being
  ...
  [#8449](https://github.com/khulnasoft/khulnasoft/pull/8449)

- [cli] - Allow interpolating plugin custom server URLs.
  [#8507](https://github.com/khulnasoft/khulnasoft/pull/8507)
...
- [cli/engine] - Accurately computes the fields changed when diffing with unhelpful providers. This
  ...
  [#8488](https://github.com/khulnasoft/khulnasoft/pull/8488)

- [codegen/go] - Respect default values in Pulumi object types.
  [#8411](https://github.com/khulnasoft/khulnasoft/pull/8400)

## 3.18.1 (2021-11-22)

### Improvements

- [cli] - When running `khulnasoft new https://github.com/name/repo`, check
  for branch `main` if branch `master` doesn't exist.
  [#8463](https://github.com/khulnasoft/khulnasoft/pull/8463)

- [codegen/python] - Program generator now uses `fn_output` forms where
  appropriate, simplifying auto-generated examples.
  [#8433](https://github.com/khulnasoft/khulnasoft/pull/8433)

- [codegen/go] - Program generator now uses fnOutput forms where
  appropriate, simplifying auto-generated examples.
  [#8431](https://github.com/khulnasoft/khulnasoft/pull/8431)

- [codegen/dotnet] - Program generator now uses `Invoke` forms where
  appropriate, simplifying auto-generated examples.
  [#8432](https://github.com/khulnasoft/khulnasoft/pull/8432)

### Bug Fixes

- [cli/nodejs] - Allow specifying the tsconfig file used in Pulumi.yaml.
  [#8452](https://github.com/khulnasoft/khulnasoft/pull/8452)

- [codegen/nodejs] - Respect default values in Pulumi object types.
  [#8400](https://github.com/khulnasoft/khulnasoft/pull/8400)

- [sdk/python] - Correctly handle version checking python virtual environments.
  [#8465](https://github.com/khulnasoft/khulnasoft/pull/8465)

- [cli] - Catch expected errors in stacks with filestate backends.
  [#8455](https://github.com/khulnasoft/khulnasoft/pull/8455)

- [sdk/dotnet] - Do not attempt to serialize unknown values.
  [#8475](https://github.com/khulnasoft/khulnasoft/pull/8475)

## 3.18.0 (2021-11-17)

### Improvements
- [ci] - Adds CI detector for Buildkite
  [#7933](https://github.com/khulnasoft/khulnasoft/pull/7933)

- [cli] - Add `--exclude-protected` flag to `khulnasoft destroy`.
  [#8359](https://github.com/khulnasoft/khulnasoft/pull/8359)

- [cli] Add the ability to use `khulnasoft org set [name]` to set a default org
  to use when creating a stacks in the Pulumi Service backend or self-hosted Service.
  [#8352](https://github.com/khulnasoft/khulnasoft/pull/8352)

- [schema] Add IsOverlay option to disable codegen for particular types.
  [#8338](https://github.com/khulnasoft/khulnasoft/pull/8338)
  [#8425](https://github.com/khulnasoft/khulnasoft/pull/8425)

- [sdk/dotnet] - Marshal output values.
  [#8316](https://github.com/khulnasoft/khulnasoft/pull/8316)

- [sdk/python] - Unmarshal output values in component provider.
  [#8212](https://github.com/khulnasoft/khulnasoft/pull/8212)

- [sdk/nodejs] - Unmarshal output values in component provider.
  [#8205](https://github.com/khulnasoft/khulnasoft/pull/8205)

- [sdk/nodejs] - Allow returning failures from Call in the provider without setting result outputs.
  [#8424](https://github.com/khulnasoft/khulnasoft/pull/8424)
...
- [codegen/nodejs] - Program generator now uses `fnOutput` forms where
  appropriate, simplifying auto-generated examples.
  [#8434](https://github.com/khulnasoft/khulnasoft/pull/8434)

### Bug Fixes

- [engine] - Compute dependents correctly during targeted deletes.
  [#8360](https://github.com/khulnasoft/khulnasoft/pull/8360)

- [cli/engine] - Update command respects `--target-dependents`.
  [#8395](https://github.com/khulnasoft/khulnasoft/pull/8395)

- [docs] - Fix broken lists in dotnet docs.
  [docs#6558](https://github.com/khulnasoft/docs/issues/6558)
...
- [codegen/docs] Edit docs codegen to document `$fnOutput` function
  ...
  [#8287](https://github.com/khulnasoft/khulnasoft/pull/8287)

### Bug Fixes

- [automation/python] - Fix deserialization of events.
  [#8375](https://github.com/khulnasoft/khulnasoft/pull/8375)

- [sdk/dotnet] - Fixes failing preview for programs that call data
  sources (`F.Invoke`) with unknown outputs.
  [#8339](https://github.com/khulnasoft/khulnasoft/pull/8339)

- [programgen/go] - Don't change imported resource names.
  [#8353](https://github.com/khulnasoft/khulnasoft/pull/8353)
...
- [cli] - Reformat error message string in `sdk/go/common/diag/errors.go`.
  [#8284](https://github.com/khulnasoft/khulnasoft/pull/8284)
...
- [codegen/dotnet] - Add helper function forms `$fn.Invoke` that
  ...
  [#5758](https://github.com/khulnasoft/khulnasoft/issues/) for .NET, making
  ...
  [#7899](https://github.com/khulnasoft/khulnasoft/pull/7899)

- [auto/dotnet] - Add `khulnasoft state delete` and `khulnasoft state unprotect` functionality
  [#8202](https://github.com/khulnasoft/khulnasoft/pull/8202)
...
- [automation/python] - Use `rstrip` rather than `strip` for the sake of indentation
  [#8160](https://github.com/khulnasoft/khulnasoft/pull/8160)
...
- [codegen/nodejs] - Add helper function forms `$fnOutput` that accept
  ...
  [#5758](https://github.com/khulnasoft/khulnasoft/issues/5758) for NodeJS,
  making it easier to compose functions/datasources with Pulumi
  resources.
  [#8047](https://github.com/khulnasoft/khulnasoft/pull/8047)

- [sdk/dotnet] - Update SDK to support the upcoming codegen feature that
  will enable functions to accept Outputs
  ([5758](https://github.com/khulnasoft/khulnasoft/issues/5758)). Specifically
  add `Pulumi.DeploymentInstance.Invoke` and remove the now redundant
  `Pulumi.Utilities.CodegenUtilities`.
  [#8142](https://github.com/khulnasoft/khulnasoft/pull/8142)

- [cli] - Upgrade CLI to go1.17
  [#8171](https://github.com/khulnasoft/khulnasoft/pull/8171)

- [codegen/go] Register input types for schema object types.
  [#7959](https://github.com/khulnasoft/khulnasoft/pull/7959)

- [codegen/go] Register input types for schema resource and enum types.
  [#8204]((https://github.com/khulnasoft/khulnasoft/pull/8204))

- [codegen/go] Add schema flag to disable registering input types.
  [#8198](https://github.com/khulnasoft/khulnasoft/pull/8198)

### Bug Fixes

- [codegen/go] - Use `importBasePath` before `name` if specified for name
  and path.
  [#8159](https://github.com/khulnasoft/khulnasoft/pull/8159)
  [#8187](https://github.com/khulnasoft/khulnasoft/pull/8187)

- [auto/go] - Mark entire exported map as secret if key in map is secret.
  [#8179](https://github.com/khulnasoft/khulnasoft/pull/8179)
...
- [cli] - Differentiate in-progress actions by bolding output.
  [#7918](https://github.com/khulnasoft/khulnasoft/pull/7918)
...
- [CLI] Adding the ability to set `refresh: always` in an options object at a Pulumi.yaml level
  ...
  [#8071](https://github.com/khulnasoft/khulnasoft/pull/8071)

### Bug Fixes

- [codegen/go] - Fix generation of cyclic struct types.
  [#8049](https://github.com/khulnasoft/khulnasoft/pull/8049)
...
- [codegen/nodejs] - Fix type literal generation by adding
  ...
  [#8116](https://github.com/khulnasoft/khulnasoft/pull/8116)

- [auto/go] - Fix --target / --replace args
  [#8109](https://github.com/khulnasoft/khulnasoft/pull/8109)

- [sdk/python] - Fix deprecation warning when using python 3.10
  [#8129](https://github.com/khulnasoft/khulnasoft/pull/8129)
...
- [CLI] - Enable output values in the engine by default.
  [#8014](https://github.com/khulnasoft/khulnasoft/pull/8014)

### Bug Fixes

- [automation/python] - Fix a bug in printing `Stack` if no program is provided.
  [#8032](https://github.com/khulnasoft/khulnasoft/pull/8032)

- [codegen/schema] - Revert #7938.
  [#8035](https://github.com/khulnasoft/khulnasoft/pull/8035)

- [codegen/nodejs] - Correctly determine imports for functions.
  [#8038](https://github.com/khulnasoft/khulnasoft/pull/8038)

- [codegen/go] - Fix resolution of enum naming collisions.
  [#7985](https://github.com/khulnasoft/khulnasoft/pull/7985)

- [sdk/{nodejs,python}] - Fix errors when testing remote components with mocks.
  [#8053](https://github.com/khulnasoft/khulnasoft/pull/8053)

- [codegen/nodejs] - Fix generation of provider enum with environment variables.
  [#8051](https://github.com/khulnasoft/khulnasoft/pull/8051)
...
- [schema] The syntactical well-formedness of a package schema is now described
  ...
  [#7952](https://github.com/khulnasoft/khulnasoft/pull/7952)

### Bug Fixes

- [codegen/schema] - Correct validation for Package
  [#7896](https://github.com/khulnasoft/khulnasoft/pull/7896)

- [cli] Use json.Unmarshal instead of custom parser
  [#7954](https://github.com/khulnasoft/khulnasoft/pull/7954)

- [sdk/{go,dotnet}] - Thread replaceOnChanges through Go and .NET
  [#7967](https://github.com/khulnasoft/khulnasoft/pull/7967)

- [codegen/nodejs] - Correctly handle hyphenated imports
  [#7993](https://github.com/khulnasoft/khulnasoft/pull/7993)
...
- [build] - make lint returns an accurate status code
  [#7844](https://github.com/khulnasoft/khulnasoft/pull/7844)
...
- [codegen/python] - Add helper function forms `$fn_output` that
  ...
  [#5758](https://github.com/khulnasoft/khulnasoft/issues/) for Python,
  making it easier to compose functions/datasources with Pulumi
  resources. [#7784](https://github.com/khulnasoft/khulnasoft/pull/7784)

- [codegen] - Add `replaceOnChange` to schema.
  [#7874](https://github.com/khulnasoft/khulnasoft/pull/7874)

- [cli/about] - Add command for debug information
  [#7817](https://github.com/khulnasoft/khulnasoft/pull/7817)

- [codegen/schema] Add a `khulnasoft schema check` command to validate package schemas.
  [#7865](https://github.com/khulnasoft/khulnasoft/pull/7865)
...
- [sdk/python] - Fix Pulumi programs hanging when dependency graph
  ...
  [#7887](https://github.com/khulnasoft/khulnasoft/pull/7887)
...
- [automation/go] Fix loading of stack settings/configs from yaml files.
  [#khulnasoft-kubernetes-operator/183](https://github.com/khulnasoft/khulnasoft-kubernetes-operator/issues/183)

- [codegen/python] - Fix invalid Python docstring generation for enums
  that contain doc comments with double quotes
  [#7914](https://github.com/khulnasoft/khulnasoft/pull/7914)

## 3.11.0 (2021-08-25)

### Improvements

- [auto/dotnet] - Add support for `--exact` and `--server` with `khulnasoft plugin install` via Automation API. BREAKING NOTE: If you are subclassing `Workspace` your `InstallPluginAsync` implementation will need to be updated to reflect the new `PluginInstallOptions` parameter.
  [#7762](https://github.com/khulnasoft/khulnasoft/pull/7796)

- [codegen/go] - Add helper function forms `$fnOutput` that accept
  `Input`s, return an `Output`, and wrap the underlying `$fn` call.
  This change addreses
  [#5758](https://github.com/khulnasoft/khulnasoft/issues/) for Go, making it
  easier to compose functions/datasources with Pulumi resources.
  [#7784](https://github.com/khulnasoft/khulnasoft/pull/7784)

- [sdk/python] - Speed up `khulnasoft up` on Python projects by optimizing
  `pip` invocations
  [#7819](https://github.com/khulnasoft/khulnasoft/pull/7819)

- [sdk/dotnet] - Support for calling methods.
  [#7582](https://github.com/khulnasoft/khulnasoft/pull/7582)

### Bug Fixes

- [cli] - Avoid `missing go.sum entry for module` for new Go projects.
  [#7808](https://github.com/khulnasoft/khulnasoft/pull/7808)

- [codegen/schema] - Allow hyphen in schema path reference.
  [#7824](https://github.com/khulnasoft/khulnasoft/pull/7824)
...
- [sdk/python] - Add support for custom naming of dynamic provider resource.
  [#7633](https://github.com/khulnasoft/khulnasoft/pull/7633)

### Bug Fixes

- [codegen/go] - Fix nested collection type generation.
  [#7779](https://github.com/khulnasoft/khulnasoft/pull/7779)

- [sdk/dotnet] - Fix an exception when passing an unknown `Output` to
  the `DependsOn` resource option.
  [#7762](https://github.com/khulnasoft/khulnasoft/pull/7762)

- [engine] Include transitive children in dependency list for deletes.
  [#7788](https://github.com/khulnasoft/khulnasoft/pull/7788)
...
- [cli] Stop printing secret value on `khulnasoft config set` if it looks like a secret.
  [#7327](https://github.com/khulnasoft/khulnasoft/pull/7327)

- [sdk/nodejs] Prevent Pulumi from overriding tsconfig.json options.
  [#7068](https://github.com/khulnasoft/khulnasoft/pull/7068)

- [sdk/go] - Permit declaring explicit resource dependencies via
  `ResourceInput` values.
  [#7584](https://github.com/khulnasoft/khulnasoft/pull/7584)

### Bug Fixes

- [sdk/go] - Fix marshaling behavior for undefined properties.
  [#7768](https://github.com/khulnasoft/khulnasoft/pull/7768)

- [sdk/python] - Fix program hangs when monitor becomes unavailable.
  [#7734](https://github.com/khulnasoft/khulnasoft/pull/7734)

- [sdk/python] Allow Python dynamic provider resources to be constructed outside of `__main__`.
  [#7755](https://github.com/khulnasoft/khulnasoft/pull/7755)
...
- [sdk/go] - Depending on a component now depends on the transitive closure of its
  child resources.
  [#7732](https://github.com/khulnasoft/khulnasoft/pull/7732)
...
- [cli] - Fix the preview experience for unconfigured providers. Rather than returning the
  ...
  [#7560](https://github.com/khulnasoft/khulnasoft/pull/7560)

- [automation] - Add force flag for RemoveStack in workspace
  [#7523](https://github.com/khulnasoft/khulnasoft/pull/7523)

### Bug Fixes

- [cli] - Properly parse Git remotes with periods or hyphens.
  [#7386](https://github.com/khulnasoft/khulnasoft/pull/7386)
...
- [codegen/python] - Recover good IDE completion experience over
  ...
  optimization.
  [#7487](https://github.com/khulnasoft/khulnasoft/pull/7487)

- [sdk/python] - Use `Sequence[T]` instead of `List[T]` for several `Resource`
  parameters.
  [#7698](https://github.com/khulnasoft/khulnasoft/pull/7698)

- [auto/nodejs] - Fix a case where inline programs could exit with outstanding async work.
  [#7704](https://github.com/khulnasoft/khulnasoft/pull/7704)

- [sdk/nodejs] - Use ESlint instead of TSlint
  [#7719](https://github.com/khulnasoft/khulnasoft/pull/7719)

- [sdk/python] - Fix khulnasoft.property's default value handling.
  [#7736](https://github.com/khulnasoft/khulnasoft/pull/7736)
...
- [cli] - Respect provider aliases
  [#7166](https://github.com/khulnasoft/khulnasoft/pull/7166)

- [cli] - `khulnasoft stack ls` now returns all accessible stacks (removing
  earlier cap imposed by the httpstate backend).
  [#3620](https://github.com/khulnasoft/khulnasoft/issues/3620)

- [sdk/go] - Fix panics caused by logging from `ApplyT`, affecting
  `khulnasoft-docker` and potentially other providers
  [#7661](https://github.com/khulnasoft/khulnasoft/pull/7661)

- [sdk/python] - Handle unknown results from methods.
  [#7677](https://github.com/khulnasoft/khulnasoft/pull/7677)
...
- [sdk/go] - Add stack output helpers for numeric types.
  [#7410](https://github.com/khulnasoft/khulnasoft/pull/7410)

- [sdk/python] - Permit `Input[Resource]` values in `depends_on`.
  [#7559](https://github.com/khulnasoft/khulnasoft/pull/7559)

- [backend/filestate] - Allow khulnasoft stack ls to see all stacks regardless of passphrase.
  [#7660](https://github.com/khulnasoft/khulnasoft/pull/7660)

### Bug Fixes

- [sdk/{go,python,nodejs}] - Rehydrate provider resources in `Construct`.
  [#7624](https://github.com/khulnasoft/khulnasoft/pull/7624)

- [engine] - Include children when targeting components.
  [#7605](https://github.com/khulnasoft/khulnasoft/pull/7605)

- [cli] - Restore passing log options to providers when `--logflow` is specified
  https://github.com/khulnasoft/khulnasoft/pull/7640

- [sdk/nodejs] - Fix `khulnasoft up --logflow` causing Node multi-lang components to hang
  [#7644](https://github.com/khulnasoft/khulnasoft/pull/)

- [sdk/{dotnet,python,nodejs}] - Set the package on DependencyProviderResource.
  [#7630](https://github.com/khulnasoft/khulnasoft/pull/7630)
...
- [codegen/python,nodejs] Emit dynamic config-getters.
  [#7447](https://github.com/khulnasoft/khulnasoft/pull/7447), [#7530](https://github.com/khulnasoft/khulnasoft/pull/7530)

- [sdk/python] Make `Output[T]` covariant
  [#7483](https://github.com/khulnasoft/khulnasoft/pull/7483)

### Bug Fixes

- [sdk/nodejs] Fix a bug in closure serialization.
  [#6999](https://github.com/khulnasoft/khulnasoft/pull/6999)

- [cli] Normalize cloud URL during login
  [#7544](https://github.com/khulnasoft/khulnasoft/pull/7544)

- [sdk/nodejs,dotnet] Wait on remote component dependencies
  [#7541](https://github.com/khulnasoft/khulnasoft/pull/7541)
...
- [sdk/nodejs] Support for calling resource methods.
  [#7377](https://github.com/khulnasoft/khulnasoft/pull/7377)

- [sdk/go] Support for calling resource methods.
  [#7437](https://github.com/khulnasoft/khulnasoft/pull/7437)

### Bug Fixes

- [codegen/go] Reimplement strict go enums to be Inputs.
  [#7383](https://github.com/khulnasoft/khulnasoft/pull/7383)

- [codegen/go] Emit To[ElementType]Output methods for go enum output types.
  [#7499](https://github.com/khulnasoft/khulnasoft/pull/7499)
...
- [sdk] Add `replaceOnChanges` resource option.
  [#7226](https://github.com/khulnasoft/khulnasoft/pull/7226)

- [sdk/go] Support for authoring resource methods in Go.
  [#7379](https://github.com/khulnasoft/khulnasoft/pull/7379)

### Bug Fixes

- [sdk/python] Fix an issue where dependency keys were incorrectly translates to camelcase.
  [#7443](https://github.com/khulnasoft/khulnasoft/pull/7443)

- [cli] Fix rendering of diffs for resource without DetailedDiffs.
  [#7500](https://github.com/khulnasoft/khulnasoft/pull/7500)
...
- [cli] Added support for passing custom paths that need
  to be watched by the `khulnasoft watch` command.
  [#7115](https://github.com/khulnasoft/khulnasoft/pull/7247)

- [auto/nodejs] Fail early when multiple versions of `@khulnasoft/khulnasoft` are detected in nodejs inline programs.
  [#7349](https://github.com/khulnasoft/khulnasoft/pull/7349)

- [sdk/go] Add preliminary support for unmarshaling plain arrays and maps of output values.
  [#7369](https://github.com/khulnasoft/khulnasoft/pull/7369)

- Initial support for resource methods (Node.js authoring, Python calling).
  [#7363](https://github.com/khulnasoft/khulnasoft/pull/7363)

### Bug Fixes

- [sdk/dotnet] Fix swallowed nested exceptions with inline program, so they correctly bubble to the consumer.
  [#7323](https://github.com/khulnasoft/khulnasoft/pull/7323)

- [sdk/go] Specify known when creating outputs for `construct`.
  [#7343](https://github.com/khulnasoft/khulnasoft/pull/7343)

- [cli] Fix passphrase rotation.
  [#7347](https://github.com/khulnasoft/khulnasoft/pull/7347)

- [multilang/python] Fix nested module generation.
  [#7353](https://github.com/khulnasoft/khulnasoft/pull/7353)

- [multilang/nodejs] Fix a hang when an error is thrown within an apply in a remote component.
  [#7365](https://github.com/khulnasoft/khulnasoft/pull/7365)

- [codegen/python] Include enum docstrings for python.
  [#7374](https://github.com/khulnasoft/khulnasoft/pull/7374)
...
- [dotnet/sdk] Add get value async to output utilities.
  [#7170](https://github.com/khulnasoft/khulnasoft/pull/7170)

### Bug Fixes

- [CLI] Fix broken venv for Python projects started from templates.
  [#6624](https://github.com/khulnasoft/khulnasoft/pull/6623)

- [cli] Send plugin install output to stderr, so that it doesn't
  clutter up --json, automation API scenarios, and so on.
  [#7115](https://github.com/khulnasoft/khulnasoft/pull/7115)

- [cli] Protect against panics when using the wrong resource type with `khulnasoft import`.
  [#7202](https://github.com/khulnasoft/khulnasoft/pull/7202)

- [auto/nodejs] Emit warning instead of breaking on parsing JSON events for automation API.
  [#7162](https://github.com/khulnasoft/khulnasoft/pull/7162)

- [sdk/python] Improve performance of `Output.from_input` and `Output.all` on nested objects.
  [#7175](https://github.com/khulnasoft/khulnasoft/pull/7175)

### Misc
- [cli] Update version of go-cloud used by Pulumi to `0.23.0`.
  [#7204](https://github.com/khulnasoft/khulnasoft/pull/7204)
...
- [dotnet/sdk] Use source context with serilog.
  [#7095](https://github.com/khulnasoft/khulnasoft/pull/7095)

- [auto/dotnet] Make StackDeployment.FromJsonString public.
  [#7067](https://github.com/khulnasoft/khulnasoft/pull/7067)

- [sdk/python] Generated SDKs may now be installed from in-tree source.
  [#7097](https://github.com/khulnasoft/khulnasoft/pull/7097)

### Bug Fixes

- [auto/nodejs] Fix an intermittent bug in parsing JSON events.
  [#7032](https://github.com/khulnasoft/khulnasoft/pull/7032)

- [auto/dotnet] Fix deserialization of CancelEvent in .NET 5.
  [#7051](https://github.com/khulnasoft/khulnasoft/pull/7051)

- Temporarily disable warning when a secret config is read as a non-secret.
  [#7129](https://github.com/khulnasoft/khulnasoft/pull/7129)
...
- [cli] Provide user information when protected resources are not able to be deleted
  [#7055](https://github.com/khulnasoft/khulnasoft/pull/7055)

- [cli] Error instead of panic on invalid state file import
  [#7065](https://github.com/khulnasoft/khulnasoft/pull/7065)

- Warn when a secret config is read as a non-secret
  [#6896](https://github.com/khulnasoft/khulnasoft/pull/6896)
  [#7078](https://github.com/khulnasoft/khulnasoft/pull/7078)
  [#7079](https://github.com/khulnasoft/khulnasoft/pull/7079)
  [#7080](https://github.com/khulnasoft/khulnasoft/pull/7080)

- [sdk/nodejs|python] Add GetSchema support to providers
  [#6892](https://github.com/khulnasoft/khulnasoft/pull/6892)

- [auto/dotnet] Provide PulumiFn implementation that allows runtime stack type
  [#6910](https://github.com/khulnasoft/khulnasoft/pull/6910)

- [auto/go] Provide GetPermalink for all results
  [#6875](https://github.com/khulnasoft/khulnasoft/pull/6875)

### Bug Fixes

- [sdk/python] Fix relative `runtime:options:virtualenv` path resolution to ignore `main` project attribute
  [#6966](https://github.com/khulnasoft/khulnasoft/pull/6966)

- [auto/dotnet] Disable Language Server Host logging and checking appsettings.json config
  [#7023](https://github.com/khulnasoft/khulnasoft/pull/7023)

- [auto/python] Export missing `ProjectBackend` type
  [#6984](https://github.com/khulnasoft/khulnasoft/pull/6984)

- [sdk/nodejs] Fix noisy errors.
  [#6995](https://github.com/khulnasoft/khulnasoft/pull/6995)

- Config: Avoid emitting integers in objects using exponential notation.
  [#7005](https://github.com/khulnasoft/khulnasoft/pull/7005)

- [codegen/python] Fix issue with lazy_import affecting khulnasoft-eks
  [#7024](https://github.com/khulnasoft/khulnasoft/pull/7024)

- Ensure that all outstanding asynchronous work is awaited before returning from a .NET
  Pulumi program.
  [#6993](https://github.com/khulnasoft/khulnasoft/pull/6993)

- Config: Avoid emitting integers in objects using exponential notation.
  [#7005](https://github.com/khulnasoft/khulnasoft/pull/7005)

- Build: Add vs code dev container
  [#7052](https://github.com/khulnasoft/khulnasoft/pull/7052)
...
- Ensure that all outstanding asynchronous work is awaited before returning from a Go
  ...
  `khulnasoft.NewOutput` API.
  [#6983](https://github.com/khulnasoft/khulnasoft/pull/6983)

## 3.2.1 (2021-05-06)

### Bug Fixes

- [cli] Fix a regression caused by [#6893](https://github.com/khulnasoft/khulnasoft/pull/6893) that stopped stacks created
  with empty passphrases from completing successful khulnasoft commands when loading the passphrase secrets provider.
  [#6976](https://github.com/khulnasoft/khulnasoft/pull/6976)
...
- [automation/*] Add support for getting stack outputs using Workspace
  [#6859](https://github.com/khulnasoft/khulnasoft/pull/6859)

- [automation/*] Optionally skip Automation API version check
  [#6882](https://github.com/khulnasoft/khulnasoft/pull/6882)
...
- [auto/go,nodejs] Add UserAgent to update/pre/refresh/destroy options.
  [#6935](https://github.com/khulnasoft/khulnasoft/pull/6935)
...
- [cli] Return an appropriate error when a user has not set `PULUMI_CONFIG_PASSPHRASE` nor `PULUMI_CONFIG_PASSPHRASE_FILE`
  ...
  [#6893](https://github.com/khulnasoft/khulnasoft/pull/6893)

- [cli] Prevent against panic when using a ResourceReference as a program output
  [#6962](https://github.com/khulnasoft/khulnasoft/pull/6962)

- [sdk/python] Fix bug in MockResourceArgs.
  [#6863](https://github.com/khulnasoft/khulnasoft/pull/6863)

- [sdk/python] Address issues when using resource subclasses.
  [#6890](https://github.com/khulnasoft/khulnasoft/pull/6890)

- [sdk/python] Fix type-related regression on Python 3.6.
  [#6942](https://github.com/khulnasoft/khulnasoft/pull/6942)

- [sdk/python] Don't error when a dict input value has a mismatched type annotation.
  [#6949](https://github.com/khulnasoft/khulnasoft/pull/6949)

- [automation/dotnet] Fix EventLogWatcher failing to read events after an exception was thrown
  [#6821](https://github.com/khulnasoft/khulnasoft/pull/6821)

- [automation/dotnet] Use stackName in ImportStack
  [#6858](https://github.com/khulnasoft/khulnasoft/pull/6858)

- [automation/go] Improve autoError message formatting
  [#6924](https://github.com/khulnasoft/khulnasoft/pull/6924)

### Misc.

- [auto/dotnet] Bump YamlDotNet to 11.1.1
  [#6915](https://github.com/khulnasoft/khulnasoft/pull/6915)

- [sdk/dotnet] Enable deterministic builds
  [#6917](https://github.com/khulnasoft/khulnasoft/pull/6917)

- [auto/*] Bump minimum version to v3.1.0.
  [#6852](https://github.com/khulnasoft/khulnasoft/pull/6852)

## 3.1.0 (2021-04-22)

### Breaking Changes

Please note, the following 2 breaking changes were included in our [3.0 changlog](https://www.khulnasoft.com/docs/get-started/install/migrating-3.0/#updated-cli-behavior-in-khulnasoft-30)
...
- [cli] Standardize stack select behavior to ensure that passing `--stack` does not make that the current stack.
  [#6840](https://github.com/khulnasoft/khulnasoft/pull/6840)

- [cli] Set pagination defaults for `khulnasoft stack history` to 10 entries.
  [#6841](https://github.com/khulnasoft/khulnasoft/pull/6841)

### Enhancements

- [sdk/nodejs] Handle providers for RegisterResourceRequest
  [#6795](https://github.com/khulnasoft/khulnasoft/pull/6795)

- [automation/dotnet] Remove dependency on Gprc.Tools for F# / Paket compatibility
  [#6793](https://github.com/khulnasoft/khulnasoft/pull/6793)

### Bug Fixes

- [codegen] Fix codegen for types that are used by both resources and functions.
  [#6811](https://github.com/khulnasoft/khulnasoft/pull/6811)

- [sdk/python] Fix bug in `get_resource_module` affecting resource hydration.
  [#6833](https://github.com/khulnasoft/khulnasoft/pull/6833)

- [automation/python] Fix bug in UpdateSummary deserialization for nested config values.
  [#6838](https://github.com/khulnasoft/khulnasoft/pull/6838)
...
- [sdk/cli] Bump version of Pulumi CLI and SDK to v3
  [#6554](https://github.com/khulnasoft/khulnasoft/pull/6554)
...
- [CLI] Standardize the `--stack` flag to *not* set the stack as current (i.e. setStack=false) across CLI commands.
  [#6300](https://github.com/khulnasoft/khulnasoft/pull/6300)

- [CLI] Set pagination defaults for `khulnasoft stack history` to 10 entries.
  [#6739](https://github.com/khulnasoft/khulnasoft/pull/6739)

- [CLI] Remove `khulnasoft history` command. This was previously deprecated and replaced by `khulnasoft stack history`
  [#6724](https://github.com/khulnasoft/khulnasoft/pull/6724)
...
- [Automation/go] Moving go automation API package from sdk/v2/go/x/auto -> sdk/v2/go/auto
  [#6518](https://github.com/khulnasoft/khulnasoft/pull/6518)

- [Automation/nodejs] Moving NodeJS automation API package from sdk/nodejs/x/automation -> sdk/nodejs/automation
  [#6518](https://github.com/khulnasoft/khulnasoft/pull/6518)

- [Automation/python] Moving Python automation API package from khulnasoft.x.automation -> khulnasoft.automation
  [#6518](https://github.com/khulnasoft/khulnasoft/pull/6518)
...
- [sdk/nodejs] Add support for multiple V8 VM contexts in closure serialization.
  [#6648](https://github.com/khulnasoft/khulnasoft/pull/6648)

- [sdk] Handle providers for RegisterResourceRequest
  [#6771](https://github.com/khulnasoft/khulnasoft/pull/6771)
  [#6781](https://github.com/khulnasoft/khulnasoft/pull/6781)
  [#6786](https://github.com/khulnasoft/khulnasoft/pull/6786)

- [sdk/go] Support defining remote components in Go.
  [#6403](https://github.com/khulnasoft/khulnasoft/pull/6403)


### Bug Fixes

- [CLI] Clean the template cache if the repo remote has changed.
  [#6784](https://github.com/khulnasoft/khulnasoft/pull/6784)
...
- [cli] Fix a bug that prevented copying checkpoint files when using Azure Blob Storage
  as the backend provider. [#6794](https://github.com/khulnasoft/khulnasoft/pull/6794)
...
- [automation/python] Fix serialization bug in `StackSettings`
  [#6776](https://github.com/khulnasoft/khulnasoft/pull/6776)
...
- [automation/dotnet] Rename (Get,Set,Remove)Config(Value)
  [#6731](https://github.com/khulnasoft/khulnasoft/pull/6731)
...
- [cli] Add option to print absolute rather than relative dates in stack history
  [#6742](https://github.com/khulnasoft/khulnasoft/pull/6742)

  Example:
  ```bash
  khulnasoft stack history --full-dates
  ```

- [cli] Enable absolute and relative parent paths for khulnasoft main
  [#6734](https://github.com/khulnasoft/khulnasoft/pull/6734)

- [sdk/dotnet] Thread-safe concurrency-friendly global state
  [#6139](https://github.com/khulnasoft/khulnasoft/pull/6139)

- [tooling] Update khulnasoft python docker image to python 3.9
  [#6706](https://github.com/khulnasoft/khulnasoft/pull/6706)

- [sdk/nodejs] Add program side caching for dynamic provider serialization behind env var
  [#6673](https://github.com/khulnasoft/khulnasoft/pull/6673)

- [sdk/nodejs] Allow prompt values in `construct` for multi-lang components.
  [#6522](https://github.com/khulnasoft/khulnasoft/pull/6522)

- [automation/dotnet] Allow null environment variables
  [#6687](https://github.com/khulnasoft/khulnasoft/pull/6687)

- [automation/dotnet] Expose WorkspaceStack.GetOutputsAsync
  [#6699](https://github.com/khulnasoft/khulnasoft/pull/6699)
...
- [automation/dotnet] Implement (Import,Export)StackAsync methods on LocalWorkspace and WorkspaceStack and expose StackDeployment helper class.
  [#6728](https://github.com/khulnasoft/khulnasoft/pull/6728)
...
- [automation/dotnet] Implement CancelAsync method on WorkspaceStack
  [#6729](https://github.com/khulnasoft/khulnasoft/pull/6729)
...
- [automation/python] Expose structured logging for Stack.up/preview/refresh/destroy.
  [#6527](https://github.com/khulnasoft/khulnasoft/pull/6527)
...
- [sdk/go] Fix wrongly named Go modules
  [#6775](https://github.com/khulnasoft/khulnasoft/issues/6775)

- [cli] Handle non-existent creds file in `khulnasoft logout --all`
  [#6741](https://github.com/khulnasoft/khulnasoft/pull/6741)

- [automation/nodejs] Do not run the promise leak checker if an inline program has errored.
  [#6758](https://github.com/khulnasoft/khulnasoft/pull/6758)

- [sdk/nodejs] Explicitly create event log file for NodeJS Automation API.
  [#6730](https://github.com/khulnasoft/khulnasoft/pull/6730)

- [sdk/nodejs] Fix error handling for failed logging statements
  [#6714](https://github.com/khulnasoft/khulnasoft/pull/6714)

- [sdk/nodejs] Fix `Construct` to wait for child resources of a multi-lang components to be created.
  [#6452](https://github.com/khulnasoft/khulnasoft/pull/6452)

- [sdk/python] Fix serialization bug if output contains 'items' property.
  [#6701](https://github.com/khulnasoft/khulnasoft/pull/6701)

- [automation] Set default value for 'main' for inline programs to support relative paths, assets, and closure serialization.
  [#6743](https://github.com/khulnasoft/khulnasoft/pull/6743)

- [automation/dotnet] Environment variable value type is now nullable.
  [#6520](https://github.com/khulnasoft/khulnasoft/pull/6520)

- [automation/dotnet] Fix GetConfigValueAsync failing to deserialize
  [#6698](https://github.com/khulnasoft/khulnasoft/pull/6698)

- [automation] Fix (de)serialization of StackSettings in .NET, Node, and Python.
  [#6752](https://github.com/khulnasoft/khulnasoft/pull/6752)
  [#6754](https://github.com/khulnasoft/khulnasoft/pull/6754)
  [#6749](https://github.com/khulnasoft/khulnasoft/pull/6749)
...
- [cli] Revert the swapping out of the YAML parser library
  [#6681](https://github.com/khulnasoft/khulnasoft/pull/6681)

- [automation/go,python,nodejs] Respect pre-existing Pulumi.yaml for inline programs.
  [#6655](https://github.com/khulnasoft/khulnasoft/pull/6655)
...
- [sdk/nodejs] Add provider side caching for dynamic provider deserialization
  [#6657](https://github.com/khulnasoft/khulnasoft/pull/6657)

- [automation/dotnet] Expose structured logging
  [#6572](https://github.com/khulnasoft/khulnasoft/pull/6572)

- [cli] Support full fidelity YAML round-tripping
  - Strip Byte-order Mark (BOM) from YAML configs during load. [#6636](https://github.com/khulnasoft/khulnasoft/pull/6636)
  - Swap out YAML parser library [#6642](https://github.com/khulnasoft/khulnasoft/pull/6642)

- [sdk/python] Ensure all async tasks are awaited prior to exit.
  [#6606](https://github.com/khulnasoft/khulnasoft/pull/6606)

### Bug Fixes

- [sdk/nodejs] Fix error propagation in registerResource and other resource methods.
  [#6644](https://github.com/khulnasoft/khulnasoft/pull/6644)

- [automation/python] Fix passing of additional environment variables.
  [#6639](https://github.com/khulnasoft/khulnasoft/pull/6639)

- [sdk/python] Make exceptions raised by calls to provider functions (e.g. data sources) catchable.
  [#6504](https://github.com/khulnasoft/khulnasoft/pull/6504)
...
- [cli] Improve diff displays during `khulnasoft refresh`
  [#6568](https://github.com/khulnasoft/khulnasoft/pull/6568)

- [sdk/go] Cache loaded configuration files.
  [#6576](https://github.com/khulnasoft/khulnasoft/pull/6576)

- [sdk/nodejs] Allow `Mocks::newResource` to determine whether the created resource is a `CustomResource`.
  [#6551](https://github.com/khulnasoft/khulnasoft/pull/6551)

- [automation/*] Implement minimum version checking and add:
  - Go: `LocalWorkspace.PulumiVersion()` [#6577](https://github.com/khulnasoft/khulnasoft/pull/6577)
  - Nodejs: `LocalWorkspace.khulnasoftVersion` [#6580](https://github.com/khulnasoft/khulnasoft/pull/6580)
  - Python: `LocalWorkspace.khulnasoft_version` [#6589](https://github.com/khulnasoft/khulnasoft/pull/6589)
  - Dotnet: `LocalWorkspace.PulumiVersion` [#6590](https://github.com/khulnasoft/khulnasoft/pull/6590)

### Bug Fixes

- [sdk/python] Fix automatic venv creation
  [#6599](https://github.com/khulnasoft/khulnasoft/pull/6599)

- [automation/python] Fix Settings file save
  [#6605](https://github.com/khulnasoft/khulnasoft/pull/6605)

- [sdk/dotnet] Remove MaybeNull from Output/Input.Create to avoid spurious warnings
  [#6600](https://github.com/khulnasoft/khulnasoft/pull/6600)
...
- [cli] Fix a bug where a version wasn't passed to go install commands as part of `make brew` installs from homebrew
  [#6566](https://github.com/khulnasoft/khulnasoft/pull/6566)
...
- [automation/go] Expose structured logging for Stack.Up/Preview/Refresh/Destroy.
  [#6436](https://github.com/khulnasoft/khulnasoft/pull/6436)
...
- [automation/dotnet] Add ability to capture stderr
  [#6513](https://github.com/khulnasoft/khulnasoft/pull/6513)
...
- [sdk/go] Add helpers to convert raw Go maps and arrays to Pulumi `Map` and `Array` inputs.
  [#6337](https://github.com/khulnasoft/khulnasoft/pull/6337)

- [sdk/go] Return zero values instead of panicing in `Index` and `Elem` methods.
  [#6338](https://github.com/khulnasoft/khulnasoft/pull/6338)

- [sdk/go] Support multiple folders in GOPATH.
  [#6228](https://github.com/khulnasoft/khulnasoft/pull/6228

- [cli] Add ability to download arm64 provider plugins
  [#6492](https://github.com/khulnasoft/khulnasoft/pull/6492)

- [build] Updating Pulumi to use Go 1.16
  [#6470](https://github.com/khulnasoft/khulnasoft/pull/6470)

- [build] Adding a Pulumi arm64 binary for use on new macOS hardware.
  Please note that `khulnasoft watch` will not be supported on darwin/arm64 builds.
  [#6492](https://github.com/khulnasoft/khulnasoft/pull/6492)

- [automation/nodejs] Expose structured logging for Stack.up/preview/refresh/destroy.
  [#6454](https://github.com/khulnasoft/khulnasoft/pull/6454)

- [automation/nodejs] Add `onOutput` event handler to `PreviewOptions`.
  [#6507](https://github.com/khulnasoft/khulnasoft/pull/6507)

- [cli] Add locking support to the self-managed backends using the `PULUMI_SELF_MANAGED_STATE_LOCKING=1` environment variable.
  [#2697](https://github.com/khulnasoft/khulnasoft/pull/2697)

### Bug Fixes

- [sdk/python] Fix mocks issue when passing a resource more than once.
  [#6479](https://github.com/khulnasoft/khulnasoft/pull/6479)

- [automation/dotnet] Add ReadDiscard OperationType
  [#6493](https://github.com/khulnasoft/khulnasoft/pull/6493)

- [cli] Ensure the user has the correct access to the secrets manager before using it as part of
  `khulnasoft stack export --show-secrets`.
  [#6215](https://github.com/khulnasoft/khulnasoft/pull/6210)

- [sdk/go] Implement getResource in the mock monitor.
  [#5923](https://github.com/khulnasoft/khulnasoft/pull/5923)

## 2.22.0 (2021-03-03)

### Improvements

- [#6410](https://github.com/khulnasoft/khulnasoft/pull/6410) Add `diff` option to Automation API's `preview` and `up`

### Bug Fixes

- [automation/dotnet] resolve issue with OnOutput delegate not being called properly during khulnasoft process execution.
  [#6435](https://github.com/khulnasoft/khulnasoft/pull/6435)
...
- [automation/python,nodejs,dotnet] BREAKING Remove `summary` property from `PreviewResult`.
  ...
  [#6405](https://github.com/khulnasoft/khulnasoft/pull/6405)

- [automation/python] Fix Windows error caused by use of NamedTemporaryFile in automation api.
  [#6421](https://github.com/khulnasoft/khulnasoft/pull/6421)

- [sdk/nodejs] Serialize default parameters correctly. [#6397](https://github.com/khulnasoft/khulnasoft/pull/6397)

- [cli] Respect provider aliases while diffing resources.
  [#6453](https://github.com/khulnasoft/khulnasoft/pull/6453)
...
- [sdk/python] Fixed a change to `Output.all()` that raised an error if no inputs are passed in.
  [#6381](https://github.com/khulnasoft/khulnasoft/pull/6381)

## 2.21.0 (2021-02-17)

### Improvements

- [cli] Added pagination options to `khulnasoft stack history` [#6292](https://github.com/khulnasoft/khulnasoft/pull/6292)
  This is used as follows:
  `khulnasoft stack history --page-size=20 --page=1`

- [automation/*] Added pagination options for stack history in Automation API SDKs to improve
  performance of stack updates. [#6257](https://github.com/khulnasoft/khulnasoft/pull/6257)
...
- [sdk/python] Fix `Output.from_input` to unwrap nested output values in input types (args classes), which addresses
  ...
  [#6221](https://github.com/khulnasoft/khulnasoft/pull/6221)

## 2.19.0 (2021-01-27)

- [sdk/nodejs] Always read and write NodeJS runtime options from the environment.
  [#6076](https://github.com/khulnasoft/khulnasoft/pull/6076)
...
- [sdk/go] Take a breaking change to remove unidiomatic numerical types and drastically improve build performance (binary size and compilation time).
  [#6143](https://github.com/khulnasoft/khulnasoft/pull/6143)

- [cli] Ensure `khulnasoft stack change-secrets-provider` allows rotating the key from hashivault to passphrase provider
  [#6210](https://github.com/khulnasoft/khulnasoft/pull/6210)

## 2.18.2 (2021-01-22)

- [CLI] Fix malformed resource value bug.
  [#6164](https://github.com/khulnasoft/khulnasoft/pull/6164)
...
- [sdk/dotnet] Fix `RegisterResourceOutputs` to serialize resources as resource references
  ...
  [#6172](https://github.com/khulnasoft/khulnasoft/pull/6172)

- [CLI] Avoid panic for diffs with invalid property paths.
  [#6159](https://github.com/khulnasoft/khulnasoft/pull/6159)

- Enable resource reference feature by default.
  [#6202](https://github.com/khulnasoft/khulnasoft/pull/6202)

## 2.18.1 (2021-01-21)

- Revert [#6125](https://github.com/khulnasoft/khulnasoft/pull/6125) as it caused a which introduced a bug with serializing resource IDs

## 2.18.0 (2021-01-20)

- [CLI] Add the ability to log out of all Pulumi backends at once.
  [#6101](https://github.com/khulnasoft/khulnasoft/pull/6101)

- [sdk/go] Added `khulnasoft.Unsecret` which will take an existing secret output and
  create a non-secret variant with an unwrapped secret value. Also adds,
  `khulnasoft.IsSecret` which will take an existing output and
  determine if an output has a secret within the output.
  [#6085](https://github.com/khulnasoft/khulnasoft/pull/6085)
...
- .NET: Allow `IMock.NewResourceAsync` to return a null ID for component resources.
  ...
  [#6104](https://github.com/khulnasoft/khulnasoft/pull/6104)

- [automation/go] Add debug logging settings for common automation API operations
  [#6095](https://github.com/khulnasoft/khulnasoft/pull/6095)

- [automation/go] Set DryRun on previews so unknowns are identified correctly.
  [#6099](https://github.com/khulnasoft/khulnasoft/pull/6099)

- [sdk/python] Fix python 3.6 support by removing annotations import.
  [#6109](https://github.com/khulnasoft/khulnasoft/pull/6109)

- [sdk/nodejs] Added `khulnasoft.unsecret` which will take an existing secret output and
  create a non-secret variant with an unwrapped secret value. Also adds,
  `khulnasoft.isSecret` which will take an existing output and
  determine if an output has a secret within the output.
  [#6086](https://github.com/khulnasoft/khulnasoft/pull/6086)

- [sdk/python] Added `khulnasoft.unsecret` which will take an existing secret output and
  create a non-secret variant with an unwrapped secret value. Also adds,
  `khulnasoft.is_secret` which will take an existing output and
  determine if an output has a secret within the output.
  [#6111](https://github.com/khulnasoft/khulnasoft/pull/6111)
...
- [sdk/dotnet] Added `Pulumi.Output.Unsecret` which will
  ...
  [#6092](https://github.com/khulnasoft/khulnasoft/pull/6092)
...
- [sdk/dotnet] Fix looking up empty version in
  ...
  [#6084](https://github.com/khulnasoft/khulnasoft/pull/6084)

- Python Automation API.
  [#5979](https://github.com/khulnasoft/khulnasoft/pull/5979)

- Support recovery workflow (import/export/cancel) in Python Automation API.
  [#6037](https://github.com/khulnasoft/khulnasoft/pull/6037)

## 2.17.0 (2021-01-06)

- Respect the `version` resource option for provider resources.
  [#6055](https://github.com/khulnasoft/khulnasoft/pull/6055)

- Allow `serializeFunction` to capture secrets.
  [#6013](https://github.com/khulnasoft/khulnasoft/pull/6013)

- [CLI] Allow `khulnasoft console` to accept a stack name
  [#6031](https://github.com/khulnasoft/khulnasoft/pull/6031)

- Support recovery workflow (import/export/cancel) in NodeJS Automation API.
  [#6038](https://github.com/khulnasoft/khulnasoft/pull/6038)

- [CLI] Add a confirmation prompt when using `khulnasoft policy rm`
  [#6034](https://github.com/khulnasoft/khulnasoft/pull/6034)

- [CLI] Ensure errors with the Pulumi credentials file
  give the user some information on how to resolve the problem
  [#6044](https://github.com/khulnasoft/khulnasoft/pull/6044)

- [sdk/go] Support maps in Invoke outputs and Read inputs
  [#6014](https://github.com/khulnasoft/khulnasoft/pull/6014)
...
- Fix a bug in the core engine that could cause previews to fail if a resource with changes had
  ...
  [#6006](https://github.com/khulnasoft/khulnasoft/pull/6006)

## 2.16.1 (2020-12-22)

- Fix a panic due to unsafe concurrent map access.
  [#5995](https://github.com/khulnasoft/khulnasoft/pull/5995)

- Fix regression in `venv` creation for python policy packs.
  [#5992](https://github.com/khulnasoft/khulnasoft/pull/5992)
...
- Do not read plugins and policy packs into memory prior to extraction, as doing so can exhaust
  ...
  [#5983](https://github.com/khulnasoft/khulnasoft/pull/5983)

- Fix a bug in the core engine where deleting/renaming a resource would panic on update + refresh.
  [#5980](https://github.com/khulnasoft/khulnasoft/pull/5980)

- Fix a bug in the core engine that caused `ignoreChanges` to fail for resources being imported.
  [#5976](https://github.com/khulnasoft/khulnasoft/pull/5976)

- Fix a bug in the core engine that could cause resources references to marshal improperly
  during preview.
  [#5960](https://github.com/khulnasoft/khulnasoft/pull/5960)

- [sdk/dotnet] Add collection initializers for smooth support of Union<T, U> as element type
  [#5938](https://github.com/khulnasoft/khulnasoft/pull/5938)

- Fix a bug in the core engine where ComponentResource state would be accessed before initialization.
  [#5949](https://github.com/khulnasoft/khulnasoft/pull/5949)

- Prevent a panic by not attempting to show progress for zero width/height terminals.
  [#5957](https://github.com/khulnasoft/khulnasoft/issues/5957)

## 2.15.6 (2020-12-12)

- Fix a bug in the Go SDK that could result in dropped resource dependencies.
  [#5930](https://github.com/khulnasoft/khulnasoft/pull/5930)

- Temporarily disable resource ref feature.
  [#5932](https://github.com/khulnasoft/khulnasoft/pull/5932)

## 2.15.5 (2020-12-11)

- Re-apply fix for running multiple `khulnasoft` processes concurrently.
  [#5893](https://github.com/khulnasoft/khulnasoft/issues/5893)

- [cli] Prevent a panic when using `khulnasoft import` with local filesystems
  [#5906](https://github.com/khulnasoft/khulnasoft/issues/5906)
...
- [sdk/nodejs] Fix issue that would cause unit tests using mocks to fail with unhandled errors when
  ...
  [#5914](https://github.com/khulnasoft/khulnasoft/pull/5914)

- Enable resource reference feature by default.
  [#5905](https://github.com/khulnasoft/khulnasoft/pull/5905)

- [codegen/go] Fix Input/Output methods for Go resources.
  [#5916](https://github.com/khulnasoft/khulnasoft/pull/5916)

- [sdk/python] Implement getResource in the mock monitor.
  [#5919](https://github.com/khulnasoft/khulnasoft/pull/5919)

- [sdk/dotnet] Implement getResource in the mock monitor and fix some issues around
  deserializing resources.
  [#5921](https://github.com/khulnasoft/khulnasoft/pull/5921)

## 2.15.4 (2020-12-08)

- Fix a problem where `khulnasoft import` could panic on an import error due to missing error message.
  [#5884](https://github.com/khulnasoft/khulnasoft/pull/5884)
- Correct the system name detected for Jenkins CI. [#5891](https://github.com/khulnasoft/khulnasoft/pull/5891)

- Fix python execution for users running Python installed through the Windows App Store
  on Windows 10 [#5874](https://github.com/khulnasoft/khulnasoft/pull/5874)

## 2.15.3 (2020-12-07)

- Fix errors when running `khulnasoft` in Windows-based CI environments.
  [#5879](https://github.com/khulnasoft/khulnasoft/issues/5879)

## 2.15.2 (2020-12-07)

- Fix a problem where `khulnasoft import` could panic on importing arrays and sets, due to
  incorrect array resizing logic. [#5872](https://github.com/khulnasoft/khulnasoft/pull/5872).

## 2.15.1 (2020-12-04)

- Address potential issues when running multiple `khulnasoft` processes concurrently.
  [#5857](https://github.com/khulnasoft/khulnasoft/pull/5857)

- Automatically install missing Python dependencies.
  [#5787](https://github.com/khulnasoft/khulnasoft/pull/5787)

- [cli] Ensure `khulnasoft stack change-secrets-provider` allows rotating the key for a passphrase provider
  [#5865](https://github.com/khulnasoft/khulnasoft/pull/5865/)

## 2.15.0 (2020-12-02)

- [sdk/python] Add deserialization support for enums.
  [#5615](https://github.com/khulnasoft/khulnasoft/pull/5615)

- Correctly rename `Pulumi.*.yaml` stack files during a rename that includes an
  organization in its name [#5812](https://github.com/khulnasoft/khulnasoft/pull/5812).

- Respect `PULUMI_PYTHON_CMD` in scripts.
  [#5782](https://github.com/khulnasoft/khulnasoft/pull/5782)

- Add `PULUMI_BACKEND_URL` environment variable to configure the state backend.
  [#5789](https://github.com/khulnasoft/khulnasoft/pull/5789)
...
- [sdk/dotnet] Add support for dependency injection into TStack instance by adding an overload to `Deployment.RunAsync`. The overload accepts an `IServiceProvider` that is used to create the instance of TStack. Also added a new method `Deployment.TestWithServiceProviderAsync` for testing stacks that use dependency injection.
  [#5723](https://github.com/khulnasoft/khulnasoft/pull/5723/)

- [cli] Ensure `khulnasoft stack change-secrets-provider` allows rotating the key in Azure KeyVault
  [#5842](https://github.com/khulnasoft/khulnasoft/pull/5842/)
...
- Propagate secretness of provider configuration through to the statefile. This ensures
  ...
  `khulnasoft config set --secret`) that are used as inputs to providers are encrypted
  before they are stored.
  [#5742](https://github.com/khulnasoft/khulnasoft/pull/5742)

- Fix a bug that could prevent `khulnasoft import` from succeeding.
  [#5730](https://github.com/khulnasoft/khulnasoft/pull/5730)
...
- [Docs] Add support for the generation of Import documentation in the resource docs.
  ...
  [#5667](https://github.com/khulnasoft/khulnasoft/pull/5667)
...
- [codegen/go] Add support for ResourceType and isComponent to enable multi-language
  ...
  [#5497](https://github.com/khulnasoft/khulnasoft/pull/5497)

- Support python 3.9 on Windows.
  [#5739](https://github.com/khulnasoft/khulnasoft/pull/5739)

- `khulnasoft-language-go` and `khulnasoft new` now explicitly requires Go 1.14.0 or greater.
  [#5741](https://github.com/khulnasoft/khulnasoft/pull/5741)

- Update .NET `Grpc` libraries to 2.33.1 and `Protobuf` to 3.13.0 (forked to increase
  the recursion limit) [#5757](https://github.com/khulnasoft/khulnasoft/pull/5757)

- Fix plugin install failures on Windows.
  [#5759](https://github.com/khulnasoft/khulnasoft/pull/5759)

- .NET: Report plugin install errors during `khulnasoft new`.
  [#5760](https://github.com/khulnasoft/khulnasoft/pull/5760)

- Correct error message on KeyNotFoundException against StackReference.
  [#5740](https://github.com/khulnasoft/khulnasoft/pull/5740)

- [cli] Small UX change on the policy violations output to render as `type: name`
  [#5773](https://github.com/khulnasoft/khulnasoft/pull/5773)

## 2.13.2 (2020-11-06)

- Fix a bug that was causing errors when (de)serializing custom resources.
  [#5709](https://github.com/khulnasoft/khulnasoft/pull/5709)

## 2.13.1 (2020-11-06)

- [cli] Ensure `khulnasoft history` annotes when secrets are unable to be decrypted
  [#5701](https://github.com/khulnasoft/khulnasoft/pull/5701)

- Fix a bug in the Python SDK that caused incompatibilities with versions of the CLI prior to
  2.13.0.
  [#5702](https://github.com/khulnasoft/khulnasoft/pull/5702)

## 2.13.0 (2020-11-04)

- Add internal scaffolding for using cross-language components from Go.
  [#5558](https://github.com/khulnasoft/khulnasoft/pull/5558)

- Support python 3.9.
  [#5669](https://github.com/khulnasoft/khulnasoft/pull/5669)

- [cli] Ensure that the CLI doesn't panic when using khulnasoft watch and using ComponentResources with non-standard naming
  [#5675](https://github.com/khulnasoft/khulnasoft/pull/5675)

- [cli] Ensure that the CLI doesn't panic when trying to assemble a graph on a stack that has no snapshot available
  [#5678](https://github.com/khulnasoft/khulnasoft/pull/5678)

- Add boolean values to Go SDK
  [#5687](https://github.com/khulnasoft/khulnasoft/pull/5687)

## 2.12.1 (2020-10-23)

- [cli] Ensure that the CLI doesn't panic when using khulnasoft watch and policies are enabled
  [#5569](https://github.com/khulnasoft/khulnasoft/pull/5569)

- [cli] Ensure that the CLI doesn't panic when using the JSON output as part of previews
  and policies are enabled
  [#5610](https://github.com/khulnasoft/khulnasoft/pull/5610)


## 2.12.0 (2020-10-14)

- NodeJS Automation API.
  [#5347](https://github.com/khulnasoft/khulnasoft/pull/5347)
...
- Improve the accuracy of previews by allowing providers to participate in determining what
  ...
  [#5443](https://github.com/khulnasoft/khulnasoft/pull/5443).

- Add an import command to the Pulumi CLI. This command can be used to import existing resources
  into a Pulumi stack.
  [#4765](https://github.com/khulnasoft/khulnasoft/pull/4765)

- [cli] Remove eternal loop if a configured passphrase is invalid.
  [#5507](https://github.com/khulnasoft/khulnasoft/pull/5507)

- Correctly validate project names during 'khulnasoft new'
  [#5504](https://github.com/khulnasoft/khulnasoft/pull/5504)

- Fixing gzip compression for alternative backends.
  [#5484](https://github.com/khulnasoft/khulnasoft/pull/5484)

- Add internal scaffolding for using cross-language components from .NET.
  [#5485](https://github.com/khulnasoft/khulnasoft/pull/5485)

- Support self-contained executables as binary option for .NET programs.
  [#5519](https://github.com/khulnasoft/khulnasoft/pull/5519)

- [cli] Ensure old secret provider variables are cleaned up when changing between secret providers
  [#5545](https://github.com/khulnasoft/khulnasoft/pull/5545)

- [cli] Respect logging verbosity as part of khulnasoft plugin install commands
  [#5549](https://github.com/khulnasoft/khulnasoft/pull/5549)

- [cli] Accept `-f` as a shorthand for `--skip-preview` on `khulnasoft up`, `khulnasoft refresh` and `khulnasoft destroy` operations
  [#5556](https://github.com/khulnasoft/khulnasoft/pull/5556)

- [cli] Validate cloudUrl formats before `khulnasoft login` and throw an error if incorrect format specified
  [#5550](https://github.com/khulnasoft/khulnasoft/pull/5545)

- [automation api] Add support for passing a private ssh key for git authentication that doesn't rely on a file path
  [#5557](https://github.com/khulnasoft/khulnasoft/pull/5557)

- [cli] Improve user experience when khulnasoft plugin rm --all finds no plugins
  to remove. The previous behaviour was an error and should not be so.
  [#5547](https://github.com/khulnasoft/khulnasoft/pull/5547)

- [sdk/python] Fix ResourceOptions annotations and doc strings.
  [#5559](https://github.com/khulnasoft/khulnasoft/pull/5559)

- [sdk/dotnet] Fix HashSet concurrency issue.
  [#5563](https://github.com/khulnasoft/khulnasoft/pull/5563)

## 2.11.2 (2020-10-01)

- feat(autoapi): expose EnvVars LocalWorkspaceOption to set in ctor
  [#5499](https://github.com/khulnasoft/khulnasoft/pull/5499)

- [sdk/python] Fix secret regression: ensure unwrapped secrets during deserialization
  are rewrapped before being returned.
  [#5496](https://github.com/khulnasoft/khulnasoft/pull/5496)

## 2.11.1 (2020-09-30)

- Add internal scaffolding for using cross-language components from Python.
  [#5375](https://github.com/khulnasoft/khulnasoft/pull/5375)

## 2.11.0 (2020-09-30)

- Do not oversimplify types for display when running an update or preview.
  [#5440](https://github.com/khulnasoft/khulnasoft/pull/5440)

- Pulumi Windows CLI now uploads all VCS information to console
  (fixes [#5014](https://github.com/khulnasoft/khulnasoft/issues/5014))
  [#5406](https://github.com/khulnasoft/khulnasoft/pull/5406)

- .NET SDK: Support `Output<object>` for resource output properties
  (fixes [#5446](https://github.com/khulnasoft/khulnasoft/issues/5446))
  [#5465](https://github.com/khulnasoft/khulnasoft/pull/5465)

## 2.10.2 (2020-09-21)

- [sdk/go] Add missing Version field to invokeOptions
  [#5401](https://github.com/khulnasoft/khulnasoft/pull/5401)

- Add `khulnasoft console` command which opens the currently selected stack in the Pulumi console.
  [#5368](https://github.com/khulnasoft/khulnasoft/pull/5368)

- Python SDK: Cast numbers intended to be integers to `int`.
  [#5419](https://github.com/khulnasoft/khulnasoft/pull/5419)

## 2.10.1 (2020-09-16)

- feat(autoapi): add GetPermalink for operation result
  [#5363](https://github.com/khulnasoft/khulnasoft/pull/5363)

- Relax stack name validations for Automation API [#5337](https://github.com/khulnasoft/khulnasoft/pull/5337)
...
- Allow Pulumi to read a passphrase file, via `PULUMI_CONFIG_PASSPHRASE_FILE` to interact
  ...
  [#5327](https://github.com/khulnasoft/khulnasoft/pull/5327)
...
- feat(autoapi): Add support for working with private Git repos. Either `SSHPrivateKeyPath`,
  ...
  [#5333](https://github.com/khulnasoft/khulnasoft/pull/5333)
...
- Ensure the 'history' command is a subcommand of 'stack'.
  This means that `khulnasoft history` has been deprecated in favour
  of `khulnasoft stack history`.
  [#5158](https://github.com/khulnasoft/khulnasoft/pull/5158)

- Add support for extracting jar files in archive resources
  [#5150](https://github.com/khulnasoft/khulnasoft/pull/5150)

- SDK changes to support Python input/output classes
  [#5033](https://github.com/khulnasoft/khulnasoft/pull/5033)

## 2.8.2 (2020-08-07)

- Add nuget badge to README [#5117](https://github.com/khulnasoft/khulnasoft/pull/5117)

- Support publishing and consuming Policy Packs using any runtime
  [#5102](https://github.com/khulnasoft/khulnasoft/pull/5102)
...
- Fix regression where any CLI integration for any stack with a default
  ...
  [#5132](https://github.com/khulnasoft/khulnasoft/pull/5132)
...
- Fix a bug where passphrase managers were not being
  ...
  **Please Note:**
  ...
  [#5110](https://github.com/khulnasoft/khulnasoft/pull/5110)

## 2.8.0 (2020-08-04)

- Add missing MapMap and ArrayArray types to Go SDK
  [#5092](https://github.com/khulnasoft/khulnasoft/pull/5092)

- Switch os/user package with luser drop in replacement
  [#5065](https://github.com/khulnasoft/khulnasoft/pull/5065)

- Update pip/setuptools/wheel in virtual environment before installing dependencies
  [#5042](https://github.com/khulnasoft/khulnasoft/pull/5042)

- Add ability to change a secrets provider for the current stack
  [#5031](https://github.com/khulnasoft/khulnasoft/pull/5031)

- Add ability to create a stack based on the config from an existing stack
  [#5062](https://github.com/khulnasoft/khulnasoft/pull/5062)

- Python: Improved error message when `virtualenv` doesn't exist
  [#5069](https://github.com/khulnasoft/khulnasoft/pull/5069)

- Enable pushing to Artifact Registry in actions
  [#5075](https://github.com/khulnasoft/khulnasoft/pull/5075)

## 2.7.1 (2020-07-22)

- Fix logic to parse khulnasoft venv on github action
  [5038](https://github.com/khulnasoft/khulnasoft/pull/5038)

## 2.7.0 (2020-07-22)

- Add pluginDownloadURL field to package definition
  [#4947](https://github.com/khulnasoft/khulnasoft/pull/4947)

- Add support for streamInvoke during update
  [#4990](https://github.com/khulnasoft/khulnasoft/pull/4990)

- Add ability to copy configuration values between stacks
  [#4971](https://github.com/khulnasoft/khulnasoft/pull/4971)

- Add logic to parse khulnasoft venv on github action
  [#4994](https://github.com/khulnasoft/khulnasoft/pull/4994)

- Better performance for stacks with many resources using the .NET SDK
  [#5015](https://github.com/khulnasoft/khulnasoft/pull/5015)

- Output PDB files and enable SourceLink integration for .NET assemblies
  [#4967](https://github.com/khulnasoft/khulnasoft/pull/4967)

## 2.6.1 (2020-07-09)

- Fix a panic in the display during CLI operations
  [#4987](https://github.com/khulnasoft/khulnasoft/pull/4987)

## 2.6.0 (2020-07-08)

- Go program gen: Improved handling for khulnasoft.Map types
  [#4914](https://github.com/khulnasoft/khulnasoft/pull/4914)

- Go SDK: Input type interfaces should declare pointer type impls where appropriate
  [#4911](https://github.com/khulnasoft/khulnasoft/pull/4911)

- Fixes issue where base64-encoded GOOGLE_CREDENTIALS causes problems with other commands
  [#4972](https://github.com/khulnasoft/khulnasoft/pull/4972)

## 2.5.0 (2020-06-25)

- Go program gen: prompt array conversion, unused range vars, id handling
  [#4884](https://github.com/khulnasoft/khulnasoft/pull/4884)

- Go program gen handling for prompt optional primitives
  [#4875](https://github.com/khulnasoft/khulnasoft/pull/4875)

- Go program gen All().Apply rewriter
  [#4858](https://github.com/khulnasoft/khulnasoft/pull/4858)

- Go program gen improvements (multiline strings, get/lookup disambiguation, invoke improvements)
  [#4850](https://github.com/khulnasoft/khulnasoft/pull/4850)

- Go program gen improvements (splat, all, index, traversal, range)
  [#4831](https://github.com/khulnasoft/khulnasoft/pull/4831)

- Go program gen improvements (resource range, readDir, fileArchive)
  [#4818](https://github.com/khulnasoft/khulnasoft/pull/4818)

- Set default config namespace for Get/Try/Require methods in Go SDK.
  [#4802](https://github.com/khulnasoft/khulnasoft/pull/4802)

- Handle invalid UTF-8 characters before RPC calls
  [#4816](https://github.com/khulnasoft/khulnasoft/pull/4816)

- Improve typing for Go SDK secret config values
  [#4800](https://github.com/khulnasoft/khulnasoft/pull/4800)

- Fix panic on `khulnasoft up` prompt after preview when filtering and hitting arrow keys.
  [#4808](https://github.com/khulnasoft/khulnasoft/pull/4808)

- Ensure GitHub Action authenticates to GCR when `$GOOGLE_CREDENTIALS` specified
  [#4812](https://github.com/khulnasoft/khulnasoft/pull/4812)

- Fix `pylint(no-member)` when accessing `resource.id`.
  [#4813](https://github.com/khulnasoft/khulnasoft/pull/4813)

- Fix GitHub Actions environment detection for PRs.
  [#4817](https://github.com/khulnasoft/khulnasoft/pull/4817)

- Adding language sdk specific docker containers.
  [#4837](https://github.com/khulnasoft/khulnasoft/pull/4837)

- Workaround bug in grcpio v1.30.0 by excluding this version from required dependencies.
  [#4883](https://github.com/khulnasoft/khulnasoft/pull/4883)

## 2.4.0 (2020-06-10)
- Turn program generation NYIs into diagnostic errors
  [#4794](https://github.com/khulnasoft/khulnasoft/pull/4794)

- Improve dev version detection logic
  [#4732](https://github.com/khulnasoft/khulnasoft/pull/4732)

- Export `CustomTimeouts` in the Python SDK
  [#4747](https://github.com/khulnasoft/khulnasoft/pull/4747)

- Add GitHub Actions CI detection
  [#4758](https://github.com/khulnasoft/khulnasoft/pull/4758)

- Allow users to specify base64 encoded strings as GOOGLE_CREDENTIALS
  [#4773](https://github.com/khulnasoft/khulnasoft/pull/4773)

- Install and use dependencies automatically for new Python projects.
  [#4775](https://github.com/khulnasoft/khulnasoft/pull/4775)

## 2.3.0 (2020-05-27)
- Add F# operators for InputUnion.
  [#4699](https://github.com/khulnasoft/khulnasoft/pull/4699)

- Add support for untagged outputs in Go SDK.
  [#4640](https://github.com/khulnasoft/khulnasoft/pull/4640)

- Update go-cloud to support all Azure regions
  [#4643](https://github.com/khulnasoft/khulnasoft/pull/4643)

- Fix a Regression in .NET unit testing.
  [#4656](https://github.com/khulnasoft/khulnasoft/pull/4656)

- Allow `khulnasoft.export` calls from Python unit tests.
  [#4670](https://github.com/khulnasoft/khulnasoft/pull/4670)

- Add support for publishing Python policy packs.
  [#4644](https://github.com/khulnasoft/khulnasoft/pull/4644)

- Improve download perf by fetching plugins from a CDN.
  [#4692](https://github.com/khulnasoft/khulnasoft/pull/4692)

## 2.2.1 (2020-05-13)
- Add new brew target to fix homebrew builds
  [#4633](https://github.com/khulnasoft/khulnasoft/pull/4633)

## 2.2.0 (2020-05-13)

- Fixed ResourceOptions issue with stack references in Python SDK
  [#4553](https://github.com/khulnasoft/khulnasoft/pull/4553)

- Add runTask to F# Deployment module
  [#3858](https://github.com/khulnasoft/khulnasoft/pull/3858)

- Add support for generating Fish completions
  [#4401](https://github.com/khulnasoft/khulnasoft/pull/4401)

- Support map-typed inputs in RegisterResource for Go SDK
  [#4522](https://github.com/khulnasoft/khulnasoft/pull/4522)

- Don't call IMocks.NewResourceAsync for the root stack resource
  [#4527](https://github.com/khulnasoft/khulnasoft/pull/4527)

- Add ResourceOutput type to Go SDK
  [#4575](https://github.com/khulnasoft/khulnasoft/pull/4575)

- Allow secrets to be decrypted when exporting a stack
  [#4046](https://github.com/khulnasoft/khulnasoft/pull/4046)
...
- Commands checking for a confirmation or requiring a `--yes` flag can now be
  ...
  [#4477](https://github.com/khulnasoft/khulnasoft/pull/4477)

## 2.1.1 (2020-05-11)

- Add retry support when writing to state buckets
  [#4494](https://github.com/khulnasoft/khulnasoft/pull/4494)

## 2.1.0 (2020-04-28)

- Fix infinite recursion bug for Go SDK
  [#4516](https://github.com/khulnasoft/khulnasoft/pull/4516)

- Order secretOutputNames when used in stack references
  [#4489](https://github.com/khulnasoft/khulnasoft/pull/4489)
...
- Add support for a `PULUMI_CONSOLE_DOMAIN` environment variable to override the
  ...
  [#4410](https://github.com/khulnasoft/khulnasoft/pull/4410)

- Protect against panic when unprotecting non-existant resources
  [#4441](https://github.com/khulnasoft/khulnasoft/pull/4441)

- Add flag to `khulnasoft stack` to output only the stack name
  [#4450](https://github.com/khulnasoft/khulnasoft/pull/4450)

- Ensure Go accessor methods correctly support nested fields of optional outputs
  [#4456](https://github.com/khulnasoft/khulnasoft/pull/4456)

- Improve `ResourceOptions.merge` type in Python SDK
  [#4484](https://github.com/khulnasoft/khulnasoft/pull/4484)

- Ensure generated Python module names are keyword-safe.
  [#4473](https://github.com/khulnasoft/khulnasoft/pull/4473)

- Explicitly set XDG_CONFIG_HOME and XDG_CACHE_HOME env vars for helm in the
  khulnasoft docker image
  [#4474](https://github.com/khulnasoft/khulnasoft/pull/4474)

- Increase the MaxCallRecvMsgSize for all RPC calls.
  [#4455](https://github.com/khulnasoft/khulnasoft/pull/4455)

## 2.0.0 (2020-04-16)

- CLI behavior change.  Commands in non-interactive mode (i.e. when `khulnasoft` has its output piped to
...
- Fixed [crashes and hangs](https://github.com/khulnasoft/khulnasoft/issues/3528) introduced by usage of
  another library.

- @khulnasoft/khulnasoft now requires Node.js version >=10.10.0.
...
- Fix Go SDK secret propagation for Resource inputs/outputs.
  [#4387](https://github.com/khulnasoft/khulnasoft/pull/4387)

- Fix Go codegen to emit config packages
  [#4388](https://github.com/khulnasoft/khulnasoft/pull/4388)

- Treat config values set with `--path` that start with '0' as strings rather than numbers.
  [#4393](https://github.com/khulnasoft/khulnasoft/pull/4393)

- Switch .NET projects to .NET Core 3.1
  [#4400](https://github.com/khulnasoft/khulnasoft/pull/4400)

- Avoid unexpected replace on resource with `import` applied on second update.
  [#4403](https://github.com/khulnasoft/khulnasoft/pull/4403)

## 1.14.1 (2020-04-13)
- Propagate `additionalSecretOutputs` opt to Read in NodeJS.
  [#4307](https://github.com/khulnasoft/khulnasoft/pull/4307)

- Fix handling of `nil` values in Outputs in Go.
  [#4268](https://github.com/khulnasoft/khulnasoft/pull/4268)

- Include usage hints for Input types in Go SDK
  [#4279](https://github.com/khulnasoft/khulnasoft/pull/4279)

- Fix secretness propagation in Python `apply`.
  [#4273](https://github.com/khulnasoft/khulnasoft/pull/4273)

- Fix the `call` mock in Python.
  [#4274](https://github.com/khulnasoft/khulnasoft/pull/4274)

- Fix handling of secret values in mock-based tests.
  [#4272](https://github.com/khulnasoft/khulnasoft/pull/4272)

- Automatic plugin acquisition for Go
  [#4297](https://github.com/khulnasoft/khulnasoft/pull/4297)

- Define merge behavior for resource options in Go SDK
  [#4316](https://github.com/khulnasoft/khulnasoft/pull/4316)

- Add overloads to Output.All in .NET
  [#4321](https://github.com/khulnasoft/khulnasoft/pull/4321)

- Make prebuilt executables opt-in only for the Go SDK
  [#4338](https://github.com/khulnasoft/khulnasoft/pull/4338)

- Support the `binary` option (prebuilt executables) for the .NET SDK
  [#4355](https://github.com/khulnasoft/khulnasoft/pull/4355)

- Add helper methods for stack outputs in the Go SDK
  [#4341](https://github.com/khulnasoft/khulnasoft/pull/4341)

- Add additional overloads to Deployment.RunAsync in .NET API.
  [#4286](https://github.com/khulnasoft/khulnasoft/pull/4286)

- Automate execution of `go mod download` for `khulnasoft new` Go templates
  [#4353](https://github.com/khulnasoft/khulnasoft/pull/4353)

- Fix `khulnasoft up -r -t $URN` not refreshing only the target
  [#4217](https://github.com/khulnasoft/khulnasoft/pull/4217)

- Fix logout with file backend when state is deleted
  [#4218](https://github.com/khulnasoft/khulnasoft/pull/4218)

- Fix specific flags for `khulnasoft stack` being global
  [#4294](https://github.com/khulnasoft/khulnasoft/pull/4294)

- Fix error when setting config without value in non-interactive mode
  [#4358](https://github.com/khulnasoft/khulnasoft/pull/4358)

- Propagate unknowns in Go SDK during marshal operations
  [#4369](https://github.com/khulnasoft/khulnasoft/pull/4369/files)

- Fix Go SDK stack reference helpers to handle nil values
  [#4370](https://github.com/khulnasoft/khulnasoft/pull/4370)

- Fix propagation of unknown status for secrets
  [#4377](https://github.com/khulnasoft/khulnasoft/pull/4377)

## 1.14.0 (2020-04-01)
- Fix error related to side-by-side versions of `@khulnasoft/khulnasoft`.
  [#4235](https://github.com/khulnasoft/khulnasoft/pull/4235)
...
- Allow users to specify an alternate backend URL when using the GitHub Actions container with the env var `PULUMI_BACKEND_URL`.
  [#4243](https://github.com/khulnasoft/khulnasoft/pull/4243)

## 1.13.1 (2020-03-27)
- Move to a multi-module repo to enable modules for the Go SDK
  [#4109](https://github.com/khulnasoft/khulnasoft/pull/4109)

- Report compile time errors for Go programs during plugin acquisition.
  [#4141](https://github.com/khulnasoft/khulnasoft/pull/4141)

- Add missing builtin `MapArray` to Go SDK.
  [#4144](https://github.com/khulnasoft/khulnasoft/pull/4144)

- Add aliases to Go SDK codegen pkg.
  [#4157](https://github.com/khulnasoft/khulnasoft/pull/4157)

- Discontinue testing on Node 8 (which has been end-of-life since January 2020), and start testing on Node 13.
  [#4156](https://github.com/khulnasoft/khulnasoft/pull/4156)

- Add support for enabling Policy Packs with configuration.
  [#3756](https://github.com/khulnasoft/khulnasoft/pull/4127)

- Remove obsolete .NET serialization attributes.
  [#4190](https://github.com/khulnasoft/khulnasoft/pull/4190)

- Add support for validating Policy Pack configuration.
  [#4179](https://github.com/khulnasoft/khulnasoft/pull/4186)

## 1.13.0 (2020-03-18)
- Add support for plugin acquisition for Go programs
  [#4060](https://github.com/khulnasoft/khulnasoft/pull/4060)

- Display resource type in PAC violation output
  [#4061](https://github.com/khulnasoft/khulnasoft/issues/4061)

- Update to Helm v3 in khulnasoft Docker image
  [#4090](https://github.com/khulnasoft/khulnasoft/pull/4090)

- Add ArrayMap builtin types to Go SDK
  [#4086](https://github.com/khulnasoft/khulnasoft/pull/4086)

- Improve documentation of URL formats for `khulnasoft login`
  [#4059](https://github.com/khulnasoft/khulnasoft/pull/4059)

- Add support for stack transformations in the .NET SDK.
  [#4008](https://github.com/khulnasoft/khulnasoft/pull/4008)

- Fix `khulnasoft stack ls` on Windows
  [#4094](https://github.com/khulnasoft/khulnasoft/pull/4094)

- Add support for running Python policy packs.
  [#4057](https://github.com/khulnasoft/khulnasoft/pull/4057)

## 1.12.1 (2020-03-11)
- Fix Kubernetes YAML parsing error in .NET.
  [#4023](https://github.com/khulnasoft/khulnasoft/pull/4023)

- Avoid projects beginning with `Pulumi` to stop cyclic imports
  [#4013](https://github.com/khulnasoft/khulnasoft/pull/4013)

- Ensure we can locate Go created application binaries on Windows
  [#4030](https://github.com/khulnasoft/khulnasoft/pull/4030)

- Ensure Python overlays work as part of our SDK generation
  [#4043](https://github.com/khulnasoft/khulnasoft/pull/4043)

- Fix terminal gets into a state where UP/DOWN don't work with prompts.
  [#4042](https://github.com/khulnasoft/khulnasoft/pull/4042)

- Ensure old provider is not used when configuration has changed
  [#4051](https://github.com/khulnasoft/khulnasoft/pull/4051)

- Support for unit testing and mocking in the .NET SDK.
  [#3696](https://github.com/khulnasoft/khulnasoft/pull/3696)

## 1.12.0 (2020-03-04)
- Avoid Configuring providers which are not used during preview.
  [#4004](https://github.com/khulnasoft/khulnasoft/pull/4004)

- Fix missing module import on Windows platform.
  [#3983](https://github.com/khulnasoft/khulnasoft/pull/3983)

- Add support for mocking the resource monitor to the NodeJS and Python SDKs.
  [#3738](https://github.com/khulnasoft/khulnasoft/pull/3738)

- Reinstate caching of TypeScript compilation.
  [#4007](https://github.com/khulnasoft/khulnasoft/pull/4007)

- Remove the need to set PULUMI_EXPERIMENTAL to use the policy and watch commands.
  [#4001](https://github.com/khulnasoft/khulnasoft/pull/4001)

- Fix type annotations for `Output.all` and `Output.concat` in Python SDK.
  [#4016](https://github.com/khulnasoft/khulnasoft/pull/4016)

- Add support for configuring policies.
  [#4015](https://github.com/khulnasoft/khulnasoft/pull/4015)

## 1.11.1 (2020-02-26)
- Fix a regression for CustomTimeouts in Python SDK.
  [#3964](https://github.com/khulnasoft/khulnasoft/pull/3964)

- Avoid panic when displaying failed stack policies.
  [#3960](https://github.com/khulnasoft/khulnasoft/pull/3960)

- Add support for secrets in the Go SDK.
  [3938](https://github.com/khulnasoft/khulnasoft/pull/3938)

- Add support for transformations in the Go SDK.
  [3978](https://github.com/khulnasoft/khulnasoft/pull/3938)

## 1.11.0 (2020-02-19)
- Allow oversize protocol buffers for Python SDK.
  [#3895](https://github.com/khulnasoft/khulnasoft/pull/3895)

- Avoid duplicated messages in preview/update progress display.
  [#3890](https://github.com/khulnasoft/khulnasoft/pull/3890)

- Improve CPU utilization in the Python SDK when waiting for resource operations.
  [#3892](https://github.com/khulnasoft/khulnasoft/pull/3892)

- Expose resource options, parent, dependencies, and provider config to policies.
  [#3862](https://github.com/khulnasoft/khulnasoft/pull/3862)

- Move .NET SDK attributes to the root namespace.
  [#3902](https://github.com/khulnasoft/khulnasoft/pull/3902)

- Support exporting older stack versions.
  [#3906](https://github.com/khulnasoft/khulnasoft/pull/3906)

- Disable interactive progress display when no terminal size is available.
  [#3936](https://github.com/khulnasoft/khulnasoft/pull/3936)

- Mark `ResourceOptions` class as abstract in the .NET SDK. Require the use of derived classes.
  [#3943](https://github.com/khulnasoft/khulnasoft/pull/3943)

## 1.10.1 (2020-02-06)
- Support stack references in the Go SDK.
  [#3829](https://github.com/khulnasoft/khulnasoft/pull/3829)

- Fix the Windows release process.
  [#3875](https://github.com/khulnasoft/khulnasoft/pull/3875)

## 1.10.0 (2020-02-05)
- Avoid writing checkpoints to backend storage in common case where no changes are being made.
  [#3860](https://github.com/khulnasoft/khulnasoft/pull/3860)

- Add information about an in-flight operation to the stack command output, if applicable.
  [#3822](https://github.com/khulnasoft/khulnasoft/pull/3822)
...
- Add support for aliases in the Go SDK
  [3853](https://github.com/khulnasoft/khulnasoft/pull/3853)

- Fix Python Dynamic Providers on Windows.
  [#3855](https://github.com/khulnasoft/khulnasoft/pull/3855)

## 1.9.1 (2020-01-27)
- Fix a stack reference regression in the Python SDK.
  [#3798](https://github.com/khulnasoft/khulnasoft/pull/3798)

- Fix a buggy assertion in the Go SDK.
  [#3794](https://github.com/khulnasoft/khulnasoft/pull/3794)

- Add `--latest` flag to `khulnasoft policy enable`.

- Breaking change for Policy which removes requirement for version when running `khulnasoft policy disable`. Add `--version` flag if user wants to specify version of Policy Pack to disable.
...
- Primitive input types in the Go SDK (e.g. Int, String, etc.) now implement the corresponding Ptr type e.g. IntPtr,
  ...
  [#3806](https://github.com/khulnasoft/khulnasoft/pull/3806)

- Add ability to specify all versions when removing a Policy Pack.

- Breaking change to Policy command: Change enable command to use `khulnasoft policy enable <org-name>/<policy-pack-name> latest` instead of a `--latest` flag.

## 1.9.0 (2020-01-22)
- Publish python types for PEP 561
  [#3704](https://github.com/khulnasoft/khulnasoft/pull/3704)

- Lock dep ts-node to v8.5.4
  [#3733](https://github.com/khulnasoft/khulnasoft/pull/3733)

- Improvements to `khulnasoft policy` functionality. Add ability to remove & disable Policy Packs.

- Breaking change for Policy which is in Public Preview: Change `khulnasoft policy apply` to `khulnasoft policy enable`, and allow users to specify the Policy Group.

- Add Permalink to output when publishing a Policy Pack.

- Add `khulnasoft policy ls` and `khulnasoft policy group ls` to list Policy related resources.

- Add `BuildNumber` to CI vars and backend metadata property bag for CI systems that have separate ID and a user-friendly number. [#3766](https://github.com/khulnasoft/khulnasoft/pull/3766)

- Breaking changes for the Go SDK. Complete details are in [#3506](https://github.com/khulnasoft/khulnasoft/pull/3506).

## 1.8.1 (2019-12-20)

- Fix a panic in `khulnasoft stack select`.
  [#3687](https://github.com/khulnasoft/khulnasoft/pull/3687)

## 1.8.0 (2019-12-19)

- Update version of TypeScript used by Pulumi to `3.7.3`.
  [#3627](https://github.com/khulnasoft/khulnasoft/pull/3627)

- Add support for GOOGLE_CREDENTIALS when using Google Cloud Storage backend.
  [#2906](https://github.com/khulnasoft/khulnasoft/pull/2906)

  ```sh
   export GOOGLE_CREDENTIALS="$(cat ~/service-account-credentials.json)"
   khulnasoft login gs://my-bucket
  ```


- Support for using `Config`, `getProject()`, `getStack()`, and `isDryRun()` from Policy Packs.
  [#3612](https://github.com/khulnasoft/khulnasoft/pull/3612)

- Top-level Stack component in the .NET SDK.
  [#3618](https://github.com/khulnasoft/khulnasoft/pull/3618)

- Add the .NET Core 3.0 runtime to the `khulnasoft/khulnasoft` container.
  [#3616](https://github.com/khulnasoft/khulnasoft/pull/3616)

- Add `khulnasoft preview` support for `--refresh`, `--target`, `--replace`, `--target-replace` and
  `--target-dependents` to align with `khulnasoft up`.
  [#3675](https://github.com/khulnasoft/khulnasoft/pull/3675)

- `ComponentResource`s now have built-in support for asynchronously constructing their children.
  [#3676](https://github.com/khulnasoft/khulnasoft/pull/3676)
...
- `Output.apply` (for the JS, Python and .Net sdks) has updated semantics, and will lift dependencies from inner Outputs to the returned Output.
  [#3663](https://github.com/khulnasoft/khulnasoft/pull/3663)

- Fix bug in determining PRNumber and BuildURL for an Azure Pipelines CI environment.
  [#3677](https://github.com/khulnasoft/khulnasoft/pull/3677)
...
- Fix [SxS issue](https://github.com/khulnasoft/khulnasoft/issues/3652) introduced in 1.7.0 when assigning
  `Output`s across different versions of the `@khulnasoft/khulnasoft` SDK.
  [#3658](https://github.com/khulnasoft/khulnasoft/pull/3658)
...
- A Pulumi JavaScript/TypeScript program can now consist of a single exported top level function. This
  ...
  [#3321](https://github.com/khulnasoft/khulnasoft/pull/3321)
...
- Support passing a parent and providers for `ReadResource`, `RegisterResource`, and `Invoke` in the go SDK. [#3563](https://github.com/khulnasoft/khulnasoft/pull/3563)

- Fix go SDK ReadResource.
  [#3581](https://github.com/khulnasoft/khulnasoft/pull/3581)

- Fix go SDK DeleteBeforeReplace.
  [#3572](https://github.com/khulnasoft/khulnasoft/pull/3572)

- Support for setting the `PULUMI_PREFER_YARN` environment variable to opt-in to using `yarn` instead of `npm` for
  installing Node.js dependencies.
  [#3556](https://github.com/khulnasoft/khulnasoft/pull/3556)

- Fix regression that prevented relative paths passed to `--policy-pack` from working.
  [#3565](https://github.com/khulnasoft/khulnasoft/issues/3564)

## 1.6.0 (2019-11-20)

- Support for config.GetObject and related variants for Golang.
  [#3526](https://github.com/khulnasoft/khulnasoft/pull/3526)

- Add support for IgnoreChanges in the go SDK.
  [#3514](https://github.com/khulnasoft/khulnasoft/pull/3514)

- Support for a `go run` style workflow. Building or installing a khulnasoft program written in go is
  now optional.
  [#3503](https://github.com/khulnasoft/khulnasoft/pull/3503)
...
- Re-apply "propagate resource inputs to resource state during preview, including first-class unknown values." The new
  ...
  [#3327](https://github.com/khulnasoft/khulnasoft/pull/3327)

- Validate StackName when passing a non-default secrets provider to `khulnasoft stack init`

- Add support for go1.13.x

- `khulnasoft update --target` and `khulnasoft destroy --target` will both error if they determine a
...
- Support for node 13.x, building with gcc 8 and newer.
  [#3512] (https://github.com/khulnasoft/khulnasoft/pull/3512)
...
- `khulnasoft policy publish` now determines the Policy Pack name from the Policy Pack, and the
  the `org-name` CLI argument is now optional. If not specified; the current user account is
  used.
  [#3459](https://github.com/khulnasoft/khulnasoft/pull/3459)

- Refactor the Output API in the Go SDK.
  [#3496](https://github.com/khulnasoft/khulnasoft/pull/3496)
...
- Use the update token for renew_lease calls and update the API version to 5.
  [#3348](https://github.com/khulnasoft/khulnasoft/pull/3348)

- Improve startup time performance by 0.5-1s by checking for a newer CLI release in parallel.
  [#3441](https://github.com/khulnasoft/khulnasoft/pull/3441)

- Add an experimental `khulnasoft watch` command.
  [#3391](https://github.com/khulnasoft/khulnasoft/pull/3391)
...
- Fix another colorizer issue that could cause garbled output for messages that did not end in colorization tags.
  [#3417](https://github.com/khulnasoft/khulnasoft/pull/3417)
...
- Verify deployment integrity during import and issue an error if verification fails. The state file can still be
  ...
  [#3422](https://github.com/khulnasoft/khulnasoft/pull/3422)

- Omit unknowns in resources in stack outputs during preview.
  [#3427](https://github.com/khulnasoft/khulnasoft/pull/3427)

- `khulnasoft update` can now be instructed that a set of resources should be replaced by adding a
  `--replace urn` argument.  Multiple resources can be specified using `--replace urn1 --replace urn2`. In order to
  replace exactly one resource and leave other resources unchanged, invoke `khulnasoft update --replace urn --target urn`,
  or `khulnasoft update --target-replace urn` for short.
  [#3418](https://github.com/khulnasoft/khulnasoft/pull/3418)

- `khulnasoft stack` now renders the stack as a tree view.
  [#3430](https://github.com/khulnasoft/khulnasoft/pull/3430)

- Support for lists and maps in config.
  [#3342](https://github.com/khulnasoft/khulnasoft/pull/3342)

- `ResourceProvider#StreamInvoke` implemented, will be the basis for streaming
  APIs in `khulnasoft query`.
  [#3424](https://github.com/khulnasoft/khulnasoft/pull/3424)

## 1.4.0 (2019-10-24)

- `FileAsset` in the Python SDK now accepts anything implementing `os.PathLike` in addition to `str`.
  [#3368](https://github.com/khulnasoft/khulnasoft/pull/3368)

- Fix colorization on Windows 10, and fix a colorizer bug that could cause garbled output for resources with long
  status messages.
  [#3385](https://github.com/khulnasoft/khulnasoft/pull/3385)
...
- Fix hangs and crashes related to use of `getResource` (i.e. `aws.ec2.getSubnetIds(...)`) methods,
  including frequent hangs on Node.js 12. This fixes https://github.com/khulnasoft/khulnasoft/issues/3260)
  and [hangs](https://github.com/khulnasoft/khulnasoft/issues/3309).

  Some less common existing styles of using `getResource` calls are also deprecated as part of this
  change, and users should see https://www.khulnasoft.com/docs/troubleshooting/#synchronous-call for
...
- Propagate resource inputs to resource state during preview, including first-class unknown values. This allows the
  ...
  [#3245](https://github.com/khulnasoft/khulnasoft/pull/3245)

- Fetch version information from the Homebrew JSON API for CLIs installed using `brew`.
  [#3290](https://github.com/khulnasoft/khulnasoft/pull/3290)

- Support renaming stack projects via `khulnasoft stack rename`.
  [#3292](https://github.com/khulnasoft/khulnasoft/pull/3292)

- Add `helm` to `khulnasoft/khulnasoft` Dockerhub container
  [#3294](https://github.com/khulnasoft/khulnasoft/pull/3294)

- Make the location of `.khulnasoft` folder configurable with an environment variable.
  [#3300](https://github.com/khulnasoft/khulnasoft/pull/3300) (Fixes [#2966](https://github.com/khulnasoft/khulnasoft/issues/2966))

- `khulnasoft update` can now be scoped to update a single resource by adding a `--target urn` or `-t urn`
...
- Adds the ability to provide transformations to modify the properties and resource options that
  ...
  [#3174](https://github.com/khulnasoft/khulnasoft/pull/3174)

- Add resource transformations support in Python. [#3319](https://github.com/khulnasoft/khulnasoft/pull/3319)

## 1.2.0 (2019-09-26)

- Support emitting high-level execution trace data to a file and add a debug-only command to view trace data.
  [#3238](https://github.com/khulnasoft/khulnasoft/pull/3238)

- Fix parsing of GitLab urls with subgroups.
  [#3239](https://github.com/khulnasoft/khulnasoft/pull/3239)

- `khulnasoft refresh` can now be scoped to refresh a subset of resources by adding a `--target urn` or
  `-t urn` argument.  Multiple resources can be specified using `-t urn1 -t urn2`.

- `khulnasoft destroy` can now be scoped to delete a single resource (and its dependents) by adding a
...
- Avoid re-encrypting secret values on each checkpoint write. These changes should improve update times for stacks
  ...
  [#3183](https://github.com/khulnasoft/khulnasoft/pull/3183)
...
- Fix a bug that caused the Python runtime to ignore unhandled exceptions and erroneously report that a Pulumi program executed successfully.
  [#3170](https://github.com/khulnasoft/khulnasoft/pull/3170)

- Read operations are no longer considered changes for the purposes of `--expect-no-changes`.
  [#3197](https://github.com/khulnasoft/khulnasoft/pull/3197)

- Increase the MaxCallRecvMsgSize for interacting with the gRPC server.
  [#3201](https://github.com/khulnasoft/khulnasoft/pull/3201)

- Do not ask for a passphrase in non-interactive sessions (fix [#2758](https://github.com/khulnasoft/khulnasoft/issues/2758)).
  [#3204](https://github.com/khulnasoft/khulnasoft/pull/3204)

- Support combining the filestate backend (local or remote storage) with the cloud-backed secrets providers (KMS, etc.).
  [#3198](https://github.com/khulnasoft/khulnasoft/pull/3198)

- Moved `@khulnasoft/khulnasoft` to target `es2016` instead of `es6`.  As `@khulnasoft/khulnasoft` programs run
  inside Nodejs, this should not change anything externally as Nodejs already provides es2016
  support. Internally, this makes more APIs available for `@khulnasoft/khulnasoft` to use in its implementation.

- Fix the --stack option of the `khulnasoft new` command.
  ([#3131](https://github.com/khulnasoft/khulnasoft/pull/3131) fixes [#2880](https://github.com/khulnasoft/khulnasoft/issues/2880))
...
- Print a Welcome to Pulumi message for users during interactive logins to the Pulumi CLI.
  [#3145](https://github.com/khulnasoft/khulnasoft/pull/3145)

- Filter the list of templates shown by default during `khulnasoft new`.
  [#3147](https://github.com/khulnasoft/khulnasoft/pull/3147)

## 1.0.0-beta.4 (2019-08-22)

- Fix a crash when using StackReference from the `1.0.0-beta.3` version of
  `@khulnasoft/khulnasoft` and `1.0.0-beta.2` or earlier of the CLI.

- Allow Un/MashalProperties to reject Asset and AssetArchive types. (partial fix
  for https://github.com/khulnasoft/khulnasoft-kubernetes/issues/737)
...
- When using StackReference to fetch output values from another stack, do not mark a value as secret if it was not
  secret in the stack you referenced. (fixes [#2744](https://github.com/khulnasoft/khulnasoft/issues/2744)).

- Allow resource IDs to be changed during `khulnasoft refresh` operations

- Do not crash when renaming a stack that has never been updated, when using the local backend. (fixes
  [#2654](https://github.com/khulnasoft/khulnasoft/issues/2654))

- Fix intermittet "NoSuchKey" issues when using the S3 based backend. (fixes [#2714](https://github.com/khulnasoft/khulnasoft/issues/2714)).

- Support filting stacks by organization or tags when using `khulnasoft stack ls`. (fixes [#2712](https://github.com/khulnasoft/khulnasoft/issues/),
  [#2769](https://github.com/khulnasoft/khulnasoft/issues/2769)

- Explicitly setting `deleteBeforeReplace` to `false` now overrides the provider's decision.
  [#3118](https://github.com/khulnasoft/khulnasoft/pull/3118)

- Fail read steps (e.g. the step generated by a call to `aws.s3.Bucket.get()`) if the requested resource does not exist.
  [#3123](https://github.com/khulnasoft/khulnasoft/pull/3123)

## 1.0.0-beta.2 (2019-08-13)

- Fix the package version compatibility checks in the NodeJS language host.
  [#3083](https://github.com/khulnasoft/khulnasoft/pull/3083)
...
- Fix a bug in the GitHub Actions program preventing errors from being rendered in the Actions log on github.com.
  [#3036](https://github.com/khulnasoft/khulnasoft/pull/3036)

- Fix a bug in the Node.JS SDK that caused failure details for provider functions to go unreported.
  [#3048](https://github.com/khulnasoft/khulnasoft/pull/3048)

- Fix a bug in the Python SDK that caused crashes when using asynchronous data sources.
  [#3056](https://github.com/khulnasoft/khulnasoft/pull/3056)

- Fix crash when exporting secrets from a khulnasoft app
  [#2962](https://github.com/khulnasoft/khulnasoft/issues/2962)

- Fix a panic in logger when a secret contains non-printable characters
  [#3074](https://github.com/khulnasoft/khulnasoft/pull/3074)

- Check the uniqueness of the project name during khulnasoft new
  [#3065](https://github.com/khulnasoft/khulnasoft/pull/3065)

## 0.17.28 (2019-08-05)

- Retry renaming a temporary folder during plugin installation
  [#3008](https://github.com/khulnasoft/khulnasoft/pull/3008)
...
- Add support for additional Pulumi secrets providers using AWS KMS, Azure KeyVault, Google Cloud
  ...
  `khulnasoft stack init b --secrets-provider="awskms://alias/LukeTesting?region=us-west-2"`, and ensure
  that all encrypted data associated with the stack is encrypted using the target cloud platform
  encryption keys.  This augments the previous choice between using the app.khulnasoft.com-managed
  secrets encryption or a fully-client-side local passphrase encryption.
  [#2994](https://github.com/khulnasoft/khulnasoft/pull/2994)

- Add `Output.concat` to Python SDK [#3006](https://github.com/khulnasoft/khulnasoft/pull/3006)

- Add `requireOutput` to `StackReference` [#3007](https://github.com/khulnasoft/khulnasoft/pull/3007)
...
- Make `khulnasoft.runtime.invoke` synchronous in the Python SDK [#3019](https://github.com/khulnasoft/khulnasoft/pull/3019)

- Fix a bug in the Python SDK that caused input properties that are coroutines to be awaited twice.
  [#3024](https://github.com/khulnasoft/khulnasoft/pull/3024)

### Compatibility

- Deprecated functions in `@khulnasoft/khulnasoft` will now issue warnings if you call them.  Please migrate
...
- Fix an error message from the logging subsystem which was introduced in v0.17.26
  [#2989](https://github.com/khulnasoft/khulnasoft/pull/2997)

- Add support for property paths in `ignoreChanges`, and pass `ignoreChanges` to providers
  [#3005](https://github.com/khulnasoft/khulnasoft/pull/3005). This allows differences between the actual and desired
...
- Add `get_object`, `require_object`, `get_secret_object` and `require_secret_object` APIs to Python
  `config` module [#2959](https://github.com/khulnasoft/khulnasoft/pull/2959)

- Fix unexpected provider replacements when upgrading from older CLIs and older providers
  [khulnasoft/khulnasoft-kubernetes#645](https://github.com/khulnasoft/khulnasoft-kubernetes/issues/645)
...
- Add *Python* support for renaming resources via the `aliases` resource option.  Adding aliases
  ...
  [#2974](https://github.com/khulnasoft/khulnasoft/pull/2974)

## 0.17.25 (2019-07-19)

- Support for Dynamic Providers in Python [#2900](https://github.com/khulnasoft/khulnasoft/pull/2900)

## 0.17.24 (2019-07-19)

- Fix a crash when two different versions of `@khulnasoft/khulnasoft` are used in the same Pulumi program
  [#2942](https://github.com/khulnasoft/khulnasoft/issues/2942)

## 0.17.23 (2019-07-16)
- `khulnasoft new` allows specifying a local path to templates (resolves
  [#2672](https://github.com/khulnasoft/khulnasoft/issues/2672))

- Fix an issue where a file archive created on Windows would contain back-slashes
  [#2784](https://github.com/khulnasoft/khulnasoft/issues/2784)
...
- Fix an issue where emojis are printed in non-interactive mode. (fixes
  [#2871](https://github.com/khulnasoft/khulnasoft/issues/2871))

- Promises/Outputs can now be directly exported as the top-level (i.e. not-named) output of a Stack.
  (fixes [#2910](https://github.com/khulnasoft/khulnasoft/issues/2910))
...
- Better error message for missing npm on `khulnasoft new` (fixes [#1511](https://github.com/khulnasoft/khulnasoft/issues/1511))

- Add the ability to pass a customTimeouts object from the providers across the engine
  to resource management. (fixes [#2655](https://github.com/khulnasoft/khulnasoft/issues/2655))
...
- Defer to resource providers in all cases where the engine must determine whether or not a resource
  ...
  old diff behavior. https://github.com/khulnasoft/khulnasoft/issues/2971 lists the known provider bugs
...
- Fix an issue where a secret would not be encrypted in the state file if it was
  ...
  [#2862](https://github.com/khulnasoft/khulnasoft/issues/2862))
...
- When the environment variable `PULUMI_TEST_MODE` is set to `true`, the
  ...
  `khulnasoft.runtime.settings._set_test_mode_enabled(True)` had been called. This
  mirrors the behavior for NodeJS programs (fixes [#2818](https://github.com/khulnasoft/khulnasoft/issues/2818)).
...
- docs(login): escape codeblocks, and add object store state instructions
  [#2810](https://github.com/khulnasoft/khulnasoft/pull/2810)
...
- Fix a bug where the path provided to a URL in `khulnasoft login` is lost are dropped, so if you `khulnasoft login
  s3://bucketname/afolder`, the Pulumi files will be inside of `s3://bucketname/afolder/.khulnasoft` rather than
  `s3://bucketname/.khulnasoft` (thanks, [@bigkraig](https://github.com/bigkraig)!).  **NOTE**: If you have been
  logging in to the s3 backend with a path after the bucket name, you will need to either move the .khulnasoft
  folder in the bucket to the correct location or log in again without the path prefix to see your previous
  stacks.
- Fix a crash that would happen if you ran `khulnasoft stack output` against an empty stack (fixes
  [khulnasoft/khulnasoft#2792](https://github.com/khulnasoft/khulnasoft/issues/2792)).
...
- `khulnasoft plugin install` gained a new optional argument `--server` which can be used to provide a custom server to be
...
- `khulnasoft refresh` now tries to install any missing plugins automatically like
  `khulnasoft destroy` and `khulnasoft update` do (fixes [khulnasoft/khulnasoft#2669](https://github.com/khulnasoft/khulnasoft/issues/2669)).
- `khulnasoft whoami` now outputs the URL of the currently connected backend.
- Correctly suppress stack outputs when serializing previews to JSON, i.e. `khulnasoft preview --json --suppress-outputs`.
  Fixes [khulnasoft/khulnasoft#2765](https://github.com/khulnasoft/khulnasoft/issues/2765).
...
- Fix an issue where creating a first class provider would fail if any of the
  configuration values for the providers were secrets. (fixes [khulnasoft/khulnasoft#2741](https://github.com/khulnasoft/khulnasoft/issues/2741)).
...
- Fix an issue where khulnasoft might try to replace existing resources when upgrading to the newest version of some resource providers.
...
- Pulumi now tells you much earlier when the `--secrets-provider` argument to
  ...
  now listed in the help text. (fixes [khulnasoft/khulnasoft#2727](https://github.com/khulnasoft/khulnasoft/issues/2727)).
- Pulumi no longer prompts for your passphrase twice during operations when you
  are using the passphrase based secrets provider. (fixes [khulnasoft/khulnasoft#2729](https://github.com/khulnasoft/khulnasoft/issues/2729)).
...
- The Pulumi engine and Python and NodeJS SDKs now have support for tracking values as "secret" to ensure they are
  encrypted when being persisted in a state file. `[khulnasoft/khulnasoft#397](https://github.com/khulnasoft/khulnasoft/issues/397)`

  Any existing value may be turned into a secret by calling `khulnasoft.secret(<value>)` (NodeJS) or
  ...
  It will be encrypted, just like values added to config with `khulnasoft config set --secret`.

  You can verify that values are being stored as you expect by running `khulnasoft stack export`, When values are encrypted
  in the state file, they appear as an object with a special signature key and a ciphertext property.

  When outputs of a stack are secrets, `khulnasoft stack output` will show `[secret]` as the value, by default.  You can
  pass `--show-secrets` to `khulnasoft stack output` in order to see the actual raw value.
...
- When storing state with the Pulumi Service, you may now elect to use the passphrase based encryption for both secret
  ...
  `--secrets-provider passphrase` to `khulnasoft new` or `khulnasoft stack init` when you initally create the stack. When you
...
- Warnings from `npm` about missing description, repository, and license fields in package.json are
  now suppressed when `npm install` is run from `khulnasoft new` (via `npm install --loglevel=error`).
- Depend on newer version of gRPC package in the NodeJS SDK. This version has
  prebuilt binaries for Node 12, which should make installing `@khulnasoft/khulnasoft`
...
- `khulnasoft login` now supports `s3://`, `azblob://` and `gs://` paths (on top of `file://`) for
  storing stack information. These are passed the location of a desired bucket for each respective
  cloud provider (i.e. `khulnasoft login s3://mybucket`).  Pulumi artifacts (like the
...
- The khulnasoft version update check can be skipped by setting the environment variable
...
- Fix an issue where the stack would not be selected when an existing stack is specified when running
  `khulnasoft new <template> -s <existing-stack>`.
- Add a `--json` flag (`-j` for short) to the `preview` command. This allows basic serialization of a plan,
  ...
  is part of ongoing work tracked in [khulnasoft/khulnasoft#2390](https://github.com/khulnasoft/khulnasoft/issues/2390).
...
- Add a new `ignoreChanges` option to resource options to allow specifying a list of properties to
  ignore for purposes of updates or replacements.  [#2657](https://github.com/khulnasoft/khulnasoft/pull/2657)
- Fix an engine bug that could lead to incorrect interpretation of the previous state of a resource leading to
  unexpected Update, Replace or Delete operations being scheduled. [#2650]https://github.com/khulnasoft/khulnasoft/issues/2650)
- Build/push `khulnasoft/actions` container to [DockerHub](https://hub.docker.com/r/khulnasoft/actions) with new SDK releases [#2646](https://github.com/khulnasoft/khulnasoft/pull/2646)
...
- `refresh` will now warn instead of returning an error when it notices a resource is in an
  unhealthy state. This is in service of https://github.com/khulnasoft/khulnasoft/issues/2633.

## 0.17.5 (2019-04-08)

### Improvements
- Correctly handle the case where we would fail to detect an archive type if the filename included a dot in it. (fixes [khulnasoft/khulnasoft#2589](https://github.com/khulnasoft/khulnasoft/issues/2589))
...
- `khulnasoft logs` will now display log messages from Google Cloud Functions.

## 0.17.4 (2019-03-26)

### Improvements

- Don't print the `error:` prefix when Pulumi exists because of a declined confirmation prompt (fixes [khulnasoft/khulnasoft#458](https://github.com/khulnasoft/khulnasoft/issues/2070))
- Fix issue where `Outputs` produced by `khulnasoft.interpolate` might have values which could
...
- A new command, `khulnasoft stack rename` was added. This allows you to change the name of an existing stack in a project. Note: When a stack is renamed, the `khulnasoft.getStack` function in the SDK will now return a new value. If a stack name is used as part of a resource name, the next `khulnasoft up` will not understand that the old and new resources are logically the same. We plan to support adding aliases to individual resources so you can handle these cases. See [khulnasoft/khulnasoft#458](https://github.com/khulnasoft/khulnasoft/issues/458) for discussion on this new feature. For now, if you are unwilling to have `khulnasoft up` create and destroy these resources, you can rename your stack back to the old name. (fixes [khulnasoft/khulnasoft#2402](https://github.com/khulnasoft/khulnasoft/issues/2402))
...
- Show `brew upgrade khulnasoft` as the upgrade message when the currently running `khulnasoft` executable
...
- `khulnasoft new` no longer runs an initial deployment after a project is generated for nodejs projects.
  Instead, instructions are printed indicating that `khulnasoft up` can be used to deploy the project.
...
This update includes several changes to core `@khulnasoft/khulnasoft` constructs that will not play nicely
in side-by-side applications that pull in prior versions of this package.  As such, we are rev'ing
the minor version of the package from 0.16 to 0.17.  Recent version of `khulnasoft` will now detect,
and warn, if different versions of `@khulnasoft/khulnasoft` are loaded into the same application.  If you
encounter this warning, it is recommended you move to versions of the `@khulnasoft/...` packages that
...
- Rolled back change where calling toString/toJSON on an Output would cause a message
  to be logged to the `khulnasoft` diagnostics stream.
...
- Fix an issue where the Pulumi CLI would load the newest plugin for a resource provider instead of the version that was
  ...
  `khulnasoft plugin install resource <name> <version> --exact`.
...
- Fixes incorrect closure serialization issue (https://github.com/khulnasoft/khulnasoft/pull/2497)

- `khulnasoft` will now check that all versions of `@khulnasoft/khulnasoft` are compatible in your node_modules
  folder, and will issue a warning message if not.  To be compatible, the versions of
  `@khulnasoft/khulnasoft` must agree on their major and minor versions.  Running incompatible versions is
  not something that will be blocked, but it is discouraged as it may lead to subtle problems if one
  version of `@khulnasoft/khulnasoft` is loaded and passes objects to/from an incompatible version.
...
- Fix deadlock with resource dependencies (https://github.com/khulnasoft/khulnasoft/issues/2470)

## 0.16.15 (2019-02-22)

### Improvements

- When trying to `stack rm` a stack managed by khulnasoft.com that has resources, the error message now informs you to pass `--force` if you really want to remove a stack that still has resources under management, as this would orphan these resources (fixes [khulnasoft/khulnasoft#2431](https://github.com/khulnasoft/khulnasoft/issues/2431)).
- Enabled Python programs to delete resources in parallel (fixes [khulnasoft/khulnasoft#2382](https://github.com/khulnasoft/khulnasoft/issues/2382)). If you are using Python 2, you should upgrade to Python 3 or else you may experience problems when deleting resources.
- Fixed an issue where Python programs would occasionally fail during preview with errors about empty IDs being passed
  to resources. ([khulnasoft/khulnasoft#2450](https://github.com/khulnasoft/khulnasoft/issues/2450))
- Return an error from `khulnasoft stack tag` commands when using the `--local` mode.
- Depending on a Resource will now depend on all other Resource's parented by that Resource.
...
- Fix a regression in `@khulnasoft/khulnasoft` introduced by 0.16.13 where an update could fail with an error like:

```
Diagnostics:
  khulnasoft:khulnasoft:Stack (my-great-stack):
    TypeError: resproto.InvokeRequest is not a constructor
        at Object.<anonymous> (.../node_modules/@khulnasoft/khulnasoft/runtime/invoke.js:58:25)
        at Generator.next (<anonymous>)
        at fulfilled (.../node_modules/@khulnasoft/khulnasoft/runtime/invoke.js:17:58)
        at <anonymous>
```

We appologize for the regression.  (fixes [khulnasoft/khulnasoft#2414](https://github.com/khulnasoft/khulnasoft/issues/2414))
...
- When used in conjunction with the latest versions of the various language SDKs, the Pulumi CLI is now more precise about the dependent resources that must be deleted when a given resource must be deleted before it can be replaced (fixes [khulnasoft/khulnasoft#2167](https://github.com/khulnasoft/khulnasoft/issues/2167)).

**NOTE**: As part of the above change, once a stack is updated with v0.16.13, previous versions of `khulnasoft` will be unable to manage it.
...
- Add `--json` to `khulnasoft config`, `khulnasoft config get`, `khulnasoft history` and `khulnasoft plugin ls` to request the output be in JSON.

- Changes to `khulnasoft new`'s output to improve the experience.

## 0.16.11 (2019-01-16)

### Improvements

- In the nodejs SDK, `khulnasoft.interpolate` and `khulnasoft.concat` have been added as convenient ways to combine Output values into strings.

- Added `khulnasoft history` to show information about the history of updates to a stack.

- When creating a project with `khulnasoft new` the generated `Pulumi.yaml` file no longer contains the template section, which was unused after creating a project
...
- Added `khulnasoft stack tag` commands for managing stack tags stored in the cloud backend.

- Link directly to /account/tokens when prompting for an access token.

- Exporting a Resource from an application Stack now exports it as a rich recursive pojo instead of just being an opaque URN (fixes https://github.com/khulnasoft/khulnasoft/issues/1858).

## 0.16.9 (2018-12-24)

### Improvements

- Update the error message when When `khulnasoft` commands fail to detect your project to mention that `khulnasoft new` can be used to create a new project (fixes [khulnasoft/khulnasoft#2234](https://github.com/khulnasoft/khulnasoft/issues/2234))

- Added a `--stack` argument (short form `-s`) to `khulnasoft stack`, `khulnasoft stack init`, `khulnasoft state delete` and `khulnasoft state unprotect` to allow operating on a different stack than the currently selected stack. This brings these commands in line with the other commands that operate on stacks and already provided a `--stack` option (fixes [khulnasoft/khulnasoft#1648](https://github.com/khulnasoft/khulnasoft/issues/1648))
...
- Fix a performance regression where `khulnasoft preview` and `khulnasoft up` would hang for a few moments at the end of a preview or update, in addition to the overall operation being slower.

## 0.16.8 (2018-12-14)

### Improvements

- Fix an issue that caused panics due to shutting the Jaeger tracing infrastructure down before all traces had finished ([khulnasoft/khulnasoft#1850](https://github.com/khulnasoft/khulnasoft/issues/1850))
...
- The dynamic provider would fail to launch if your `node_modules` folder was non in the default location or had a non standard layout. This has been fixed so we correctly find your `node_modules` folder in the same way node does. (fixes [khulnasoft/khulnasoft#2261](https://github.com/khulnasoft/khulnasoft/issues/2261))

## 0.16.6 (2018-11-28)

### Major Changes

- When running a Python program, khulnasoft will now run `python3` instead of `python`, since `python` often points at Python 2.7 binary, and Pulumi requires Python 3.6 or later. The environment variable `PULUMI_PYTHON_CMD` can be used to provide a different binary to run.

### Improvements

- Allow `Output`s in the dependsOn property of `ResourceOptions` (fixes [khulnasoft/khulnasoft#991](https://github.com/khulnasoft/khulnasoft/issues/991))

- Add a new `StackReference` type to the node SDK which allows referencing an output of another stack (fixes [khulnasoft/khulnasoft#109](https://github.com/khulnasoft/khulnasoft/issues/109))

- Fix an issue where `khulnasoft` would not respect common `NO_PROXY` settings (fixes [khulnasoft/khulnasoft#2134](https://github.com/khulnasoft/khulnasoft/issues/2134))

- The CLI wil now correctly report any output from a Python program which writes to `sys.stderr` (fixes [khulnasoft/khulnasoft#1542](https://github.com/khulnasoft/khulnasoft/issues/1542))

- Don't install packages by default for Python projects when creating a new project from a template using `khulnasoft new`. Previously, `khulnasoft` would install these packages using `pip install` and they would be installed globally when `khulnasoft` was run outside a virtualenv.

- Fix an issue where `khulnasoft` could panic during a peview when using a first class provider which was constructed using an output property of another resource (fixes [khulnasoft/khulnasoft#2223](https://github.com/khulnasoft/khulnasoft/issues/2223))

- Fix an issue where `khulnasoft` would fail to load resource plugins for newer dev builds.

- Fix an issue where running two copies of `khulnasoft plugin install` in parallel for the same plugin version could cause one to fail with an error about renaming a directory.

- Fix an issue where if the directory containing the `khulnasoft` executable was not on the `$PATH` we would fail to load language plugins. We now will also search next to the current running copy of Pulumi (fixes [khulnasoft/khulnasoft#1956](https://github.com/khulnasoft/khulnasoft/issues/1956))

- Fix an issue where passing a key of the form `foo:config:bar:baz` to `khulnasoft config set` would succeed but cause errors later when trying to interact with the stack. Setting this value is now blocked eagerly (fixes [khulnasoft/khulnasoft#2171](https://github.com/khulnasoft/khulnasoft/issues/2171))

## 0.16.5 (2018-11-16)

### Improvements

- Fix an issue where `khulnasoft plugin install` would fail on Windows with an access deined message.
...
- Download plugins to a temporary folder during `khulnasoft plugin install` to ensure if the operation is canceled, the have downloaded plugin is not used.

- If an update is in progress when `khulnasoft stack ls` is run, don't show its last update time as "a long time ago".

- Add `--preserve-config` to `khulnasoft stack rm` which causes Pulumi to keep the `Pulumi.<stack-name>.yaml` when removing a stack.

- Support passing template names to `khulnasoft up` the same as `khulnasoft new` does.

- When `-g` or `--generate-only` is passed to `khulnasoft new`, don't show a confusing message that says it will update a stack.
...
- Fix `khulnasoft logs` so it can collect log messages from Lambdas on AWS.

- Pulumi now reports metadata during CI runs on CircleCI, for later display on app.khulnasoft.com.
...
- Add the `--json` flag to the `khulnasoft logs` command.

- Add an `iterable` module to `@khulnasoft/khulnasoft` with two helpful combinators `toObject` and `groupBy` to help combine multiple `Output<T>`'s into a single object.

- Pulumi no longer prompts you for confirmation when `--skip-preview` is passed to `khulnasoft up`. Instead, it just preforms the update as requested.

- Add the `--json` flag to the `khulnasoft stack ls` command.

- The `--color=always` flag should now be respected in all cases.

- Pulumi now reports metadata about GitLab repositories when doing an update, so they can be shown on app.khulnasoft.com.
...
- Fully support Node 11 [khulnasoft/khulnasoft#2101](https://github.com/khulnasoft/khulnasoft/pull/2101)

## 0.16.2 (2018-10-29)

### Improvements

- Fix a regression that would cause resource operations to not be processed in parallel when using the latest CLI with a `@khulnasoft/khulnasoft` older than 0.16.1 [khulnasoft/khulnasoft#2123](https://github.com/khulnasoft/khulnasoft/pull/2123)

- Fail with a better error message (and in fewer cases) on Node 11. We hope to have complete support for Node 11 later this week, but for now recommend using Node 10 or earlier. [khulnasoft/khulnasoft#2098](https://github.com/khulnasoft/khulnasoft/pull/2098)

## 0.16.1 (2018-10-23)

### Improvements

- A new top-level CLI command “khulnasoft state” was added to assist in making targeted edits to the state of a stack. Two subcommands, “khulnasoft state delete” and “khulnasoft state unprotect”, can be used to delete or unprotect individual resources respectively within a Pulumi stack. [khulnasoft/khulnasoft#2024](https://github.com/khulnasoft/khulnasoft/pull/2024)
- Default to allowing as many parallel operations as possible [khulnasoft/khulnasoft#2065](https://github.com/khulnasoft/khulnasoft/pull/2065)
- Fixed an issue with the generated type for an Unwrap expression when using TypeScript [khulnasoft/khulnasoft#2061](https://github.com/khulnasoft/khulnasoft/pull/2061)
- Improve error messages when resource plugins can't be loaded or when a checkpoint is invalid [khulnasoft/khulnasoft#2078](https://github.com/khulnasoft/khulnasoft/pull/2078)
- Fix link to the Pulumi Web Console in the CLI for a stack [khulnasoft/khulnasoft#2075](https://github.com/khulnasoft/khulnasoft/pull/2075)
- Attach git commit metadata to Pulumi updates in some additional cases [khulnasoft/khulnasoft#2062](https://github.com/khulnasoft/khulnasoft/pull/2062) and [khulnasoft/khulnasoft#2069](https://github.com/khulnasoft/khulnasoft/pull/2069)
...
Parallel resource creation and updates were added in `0.15`.  In `0.16`, this has been extended to include deletions, which are now conservatively parallelized based on dependency information. [khulnasoft/khulnasoft#1963](https://github.com/khulnasoft/khulnasoft/pull/1963)

#### Support for any CI system in the Pulumi GitHub App

The Pulumi GitHub App previously supported just TravisCI.  With this release the `khulnasoft` CLI now supports configurable CI providers via environment variables.  Thanks [@jen20](https://github.com/jen20)!

### Improvements

In addition to the above features, we've made a handfull of day to day improvements in the CLI:
- Support for `zsh` completions. Thanks to [@Tirke](https://github.com/Tirke)!) [khulnasoft/khulnasoft#1967](https://github.com/khulnasoft/khulnasoft/pull/1967)
- JSON formatting support for `khulnasoft stack output`. [khulnasoft/khulnasoft#2000](https://github.com/khulnasoft/khulnasoft/pull/2000)
- Added a `Dockerfile` for the Pulumi CLI and development environment for use in hosted environments.
- Many improvements for Go development.  Thanks to [@justone](https://github.com/justone)!. [khulnasoft/khulnasoft#1954](https://github.com/khulnasoft/khulnasoft/pull/1954) [khulnasoft/khulnasoft#1955](https://github.com/khulnasoft/khulnasoft/pull/1955) [khulnasoft/khulnasoft#1965](https://github.com/khulnasoft/khulnasoft/pull/1965)
- Extend `khulnasoft.output` to deeply unwrap `Input`s.  This significantly simplifies working with `Inputs` when building Pulumi components.  [khulnasoft/khulnasoft#1915](https://github.com/khulnasoft/khulnasoft/pull/1915)
...
- Improved performance of `khulnasoft stack ls`
...
Providers are now able to register "ephmeral" update messages which are shown in the "Info" column in the CLI during an update, but which are not printed at the end of the update. The new version of the `@khulnasoft/kubernetes` package uses this when printing messages about resource initialization.

#### Local backend

The local backend (which stores your deployment's state file locally, instead of on khulnasoft.com) has been improved. You can now use `khulnasoft login --local` or `khulnasoft login file://<path-to-storage-root>` to select the local backend and control where state files are stored. In addition, older versions of the CLI would behave slightly differently when using the local backend vs khulnasoft.com, for example, some operations would not show previews before running.  This has been fixed.  When using the local backend, updates print the on disk location of the checkpoint file that was written. The local backend is covered in more detail in [here](https://www.khulnasoft.com/docs/reference/state/).

#### `khulnasoft refresh`

We've made a bunch of improvements in `khulnasoft refresh`. Some of these improve the UI during a refresh (for example, clarifying text about the underyling operations) as well fixing bugs with refreshing certain types of objects (for example CloudFront CDNs).

#### `khulnasoft up` and `khulnasoft new`

You can now pass a URL to a Git repository to `khulnasoft up <url>` to deploy a project without having to manage its source code locally. This works like `khulnasoft new <url>`, but configures and deploys the project from a temporary directory that will be cleaned up automatically after the update.

`khulnasoft new` now outputs an error when the current working directory (or directory specified explicitly via the `--dir` flag) is not empty. Additionally, `khulnasoft new` now runs a preview of an initial update at the end of its operation and asks if you would like to perform the update.

Both `khulnasoft up` and `khulnasoft new` now support `-c` flags for specifying config values as arguments (e.g. `khulnasoft up <url> -c aws:region=us-east-1`).

### Improvements

In addition to the above features, we've made a handfull of day to day improvements in the CLI:

- Support `khulnasoft` in a projects in a Yarn workspaces. [khulnasoft/khulnasoft#1893](https://github.com/khulnasoft/khulnasoft/pull/1893)
- Improve error message when there are errors decrypting secret configuration values. [khulnasoft/khulnasoft#1815](https://github.com/khulnasoft/khulnasoft/pull/1815)
- Don't fail `khulnasoft up` when plugin discovery fails. [khulnasoft/khulnasoft#1745](https://github.com/khulnasoft/khulnasoft/pull/1745)
- New helpers for extracting and validating values from `khulnasoft.Config`. [khulnasoft/khulnasoft#1843](https://github.com/khulnasoft/khulnasoft/pull/1843)
- Support serializng "factory" functions. [khulnasoft/khulnasoft#1804](https://github.com/khulnasoft/khulnasoft/pull/1804)
...
You can now pass a URL to a Git repository to `khulnasoft new` to install a custom template, enabling you to share common templates across your team. If you pass a simple name, or omit arguments altogether, `khulnasoft new` behaves as before, using the [templates hosted by Pulumi](https://github.com/khulnasoft/templates).

#### Native TypeScript support

By default, Pulumi now natively supports TypeScript, so you do not need to run `tsc` explicitly before deploying. (We often forget to do this too!) Simply run `khulnasoft up`, and the program will be recompiled on the fly before running it.

To use this new support, upgrade your `@khulnasoft/khulnasoft` version to 0.15.0, in addition to the CLI. Pulumi prefers JavaScript source to TypeScript source, so if you had been using TypeScript previously, we recommend you make the following changes:
...
3. You may remove the dependency on `typescript` from your `package.json` as well, since `@khulnasoft/khulnasoft` has one.
...
import * as cloud from "@khulnasoft/cloud-aws";

const api = new cloud.API("api");
api.get("/", async (req, res) => {
    const statusText = (await axios.default.get("https://www.khulnasoft.com")).statusText;
    res.write(`GET https://www.khulnasoft.com/ == ${statusText}`).end();
});
```

#### Default value for configuration package

The `khulnasoft.Config` object can now be created without an argument. When no argument is supplied, the value of the current project is used. This means that application level code can simply do `new khulnasoft.Confg()` without passing any argument. For library authors, you should continue to pass the name of your package as an argument.
...
GitHub application and configure it with your CI system, please [visit our documentation](https://www.khulnasoft.com/docs/reference/cd-github/) page.
...
- Support empty text assets ([khulnasoft/khulnasoft#1599](https://github.com/khulnasoft/khulnasoft/pull/1599)).

- When printing message in non-interactive mode, do not keep printing out the worst diagnostic ([khulnasoft/khulnasoft#1640](https://github.com/khulnasoft/khulnasoft/pull/1640)). When run in non interactive environments (e.g. docker) Pulumi would print duplicate messages to the screen related to a resource when the running Pulumi program was writing to standard out (e.g. if it was invoking a docker build). This no longer happens. The full output from the program continues to be printed at the end of execution.

- Work around a potentially bad assert in the engine ([khulnasoft/khulnasoft#1640](https://github.com/khulnasoft/khulnasoft/pull/1644)). In some cases, when Pulumi failed to delete a resource as part of an update, future updates would crash with an assert message. This is no longer the case and Pulumi will try to delete the resource it had marked as should be deleted.

#### Added

- Print out a 'still working' message every 20 seconds when in non-interactive mode ([khulnasoft/khulnasoft#1616](https://github.com/khulnasoft/khulnasoft/pull/1616)). When Pulumi is waiting for a long running resource operation to create (e.g. waiting for an ECS service to become stable after creation), print some output to the console even when running non-interactively. This helps for cases like TravsCI where if output is not written for a while the job is assumed to have hung and is aborted.

- Support the NO_COLOR env variable to suppress any colored output ([khulnasoft/khulnasoft#1594](https://github.com/khulnasoft/khulnasoft/pull/1594)). Pulumi now respects the `NO_COLOR` environment variable. When set to a truthy value, colors are suppressed from the CLI. In addition, the `--color` flag can now be passed to all `khulnasoft` commands.

## 0.14.2 (2018-07-03)

### Improvements

- Support -s in `stack {export, graph, import, output}` ([khulnasoft/khulnasoft#1572](https://github.com/khulnasoft/khulnasoft/pull/1574)). `khulnasoft stack export`, `khulnasoft stack graph`, `khulnasoft stack import` and `khulnasoft stack output` now support a `-s` or `--stack` flag, which allows them to operate on a different stack that the currently selected one.
...
- Add `khulnasoft whoami` ([khulnasoft/khulnasoft#1572](https://github.com/khulnasoft/khulnasoft/pull/1572)). `khulnasoft whoami` will report the account name of the current logged in user. In addition, we now display the name of the current user after `khulnasoft login`.

#### Fixed

- Don't require `PULUMI_DEBUG_COMMANDS` to be set to use local backend ([khulnasoft/khulnasoft#1575](https://github.com/khulnasoft/khulnasoft/pull/1575)).

- Improve misleading `khulnasoft new` summary message ([khulnasoft/khulnasoft#1571](https://github.com/khulnasoft/khulnasoft/pull/1571)).

- Fix printing out outputs in a khulnasoft program ([khulnasoft/khulnasoft#1531](https://github.com/khulnasoft/khulnasoft/pull/1531)). Pulumi now shows the values of output properties after a `khulnasoft up` instead of requiring you to run `khulnasoft stack output`.

- Do a better job preventing serialization of unnecessary objects in closure serialization ([khulnasoft/khulnasoft#1543](https://github.com/khulnasoft/khulnasoft/pull/1543)).  We've improved our analysis when serializing functions. This yeilds smaller code when a function is serialized and prevents errors around unused native code being captured in some cases.
...
- Publish to pypi.org ([khulnasoft/khulnasoft#1497](https://github.com/khulnasoft/khulnasoft/pull/1497)). Pulumi packages are now public on pypi.org!

- Add optional `--dir` flag to `khulnasoft new` ([khulnasoft/khulnasoft#1459](https://github.com/khulnasoft/khulnasoft/pull/1459)). The `khulnasoft new` command now has an optional flag `--dir`, for the directory to place the generated project. If it doesn't exist, it will be created.

- Support Pulumi programs written in Go ([khulnasoft/khulnasoft#1456](https://github.com/khulnasoft/khulnasoft/pull/1456)). Initial version for Pulumi programs written in Go. While it is not complete, basic resource registration works.

- Allow overriding config location ([khulnasoft/khulnasoft#1379](https://github.com/khulnasoft/khulnasoft/pull/1379)). Support a new `config` member in `Pulumi.yaml`, which specifies a relative path to a folder where per-stack configuration is stored. The path is relative to the location of `Pulumi.yaml` itself.

- Delete existing resources before replacing, for resources that must be singletons ([khulnasoft/khulnasoft#1365](https://github.com/khulnasoft/khulnasoft/pull/1365)). For resources where the cloud vendor does not allow multiple resources to exist, such as a mount target in EFS, Pulumi now deletes the existing resource before creating a replacement resource.

#### Changed

- Compute required packages during closure serialization ([khulnasoft/khulnasoft#1457](https://github.com/khulnasoft/khulnasoft/pull/1457)). Closure serialization now keeps track of the `require`'d packages it sees in the function bodies that are serialized during a call to `serializeFunction`. So, only required packages are uploaded to Lambda.

- Support browser based logins to the CLI ([khulnasoft/khulnasoft#1439](https://github.com/khulnasoft/khulnasoft/pull/1439)). The Pulumi CLI now has an option to login via a browser. When you are prompted for an access token, you can just hit enter. The CLI then opens a browser to [app.khulnasoft.com](https://app.khulnasoft.com) so that you can authenticate.

#### Fixed

- Support better previews in Python by mocking out Unknown values ([khulnasoft/khulnasoft#1482](https://github.com/khulnasoft/khulnasoft/pull/1482)). During the preview phase of a deployment, computed values were `Unknown` in Python, causing the preview to be empty. This issue is now resolved.

- Issue a better error message if you capture a V8 intrinsic ([khulnasoft/khulnasoft#1423](https://github.com/khulnasoft/khulnasoft/pull/1423)). It's possible to accidentally take a dependency on a Pulumi deployment-time library, which causes problems when creating a runtime function for AWS Lambda. There is now a better error message when this situation occurs.

## 0.12.2 (2018-05-19)

### Improvements

- Improve the promise leak experience ([khulnasoft/khulnasoft#1374](https://github.com/khulnasoft/khulnasoft/pull/1374)). Fixes an issue where a promise leak could be erroneously reported. Also, show simple error message by default, unless the environment variable `PULUMI_DEBUG_PROMISE_LEAKS` is set.

## 0.12.1 (2018-05-09)

### Added

- A new all-in-one installer script is now available at [https://get.khulnasoft.com](https://get.khulnasoft.com).

- Many enhancements to `khulnasoft new` ([khulnasoft/khulnasoft#1307](https://github.com/khulnasoft/khulnasoft/pull/1307)).  The command now interactively walks through creating everything needed to deploy a new stack, including selecting a template, providing a name, creating a stack, setting default configuration, and installing dependencies.

- Several improvements to the `khulnasoft up` CLI experience ([khulnasoft/khulnasoft#1260](https://github.com/khulnasoft/khulnasoft/pull/1260)): a tree view display, more details from logs during deployments, and rendering of stack outputs at the end of updates.

### Changed

- (**Breaking**) Remove the `--preview` flag in `khulnasoft up`, in favor of reintroducing `khulnasoft preview` ([khulnasoft/khulnasoft#1290](https://github.com/khulnasoft/khulnasoft/pull/1290)). Also, to accept an update without the interactive prompt, use the `--yes` flag, rather than `--force`.

### Fixed

- Significant performance improvements for `khulnasoft up` ([khulnasoft/khulnasoft#1319](https://github.com/khulnasoft/khulnasoft/pull/1319)).

- JavaScript `async` functions in Node 7.6+ now work with Pulumi function serialization ([khulnasoft/khulnasoft#1311](https://github.com/khulnasoft/khulnasoft/pull/1311).

- Support installation on Windows in folders which contain spaces in their name ([khulnasoft/khulnasoft#1300](https://github.com/khulnasoft/khulnasoft/pull/1300)).
...
- Add a `khulnasoft cancel` command ([khulnasoft/khulnasoft#1230](https://github.com/khulnasoft/khulnasoft/pull/1230)). This command cancels any in-progress operation for the current stack.

### Changed

- (**Breaking**) Eliminate `khulnasoft init` requirement ([khulnasoft/khulnasoft#1226](https://github.com/khulnasoft/khulnasoft/pull/1226)). The `khulnasoft init` command is no longer required and should not be used for new stacks. For stacks created prior to the v0.12.0 SDK, `khulnasoft init` should still be run in the project directory if you are connecting to an existing stack. For new projects, stacks will be created under the currently logged in account. After upgrading the CLI, it is necessary to run `khulnasoft stack select`, as the location of bookkeeping files has been changed. For more information, see [Creating Stacks](https://www.khulnasoft.com/docs/reference/stack/#create-stack).

- (**Breaking**) Remove the explicit 'khulnasoft preview' command ([khulnasoft/khulnasoft#1170](https://github.com/khulnasoft/khulnasoft/pull/1170)). The `khulnasoft preview` output has now been merged in to the `khulnasoft up` command. Before an update is run, the preview is shown and you can choose whether to proceed or see more update details. To see just the preview operation, run `khulnasoft up --preview`.

- Switch to a more streamlined view for property diffs in `khulnasoft up` ([khulnasoft/khulnasoft#1212](https://github.com/khulnasoft/khulnasoft/pull/1212)).

- Allow multiple versions of the `@khulnasoft/khulnasoft` package to be loaded ([khulnasoft/khulnasoft#1209](https://github.com/khulnasoft/khulnasoft/pull/1209)). This allows packages and dependencies to be versioned independently.

### Fixed
- When running a `khulnasoft up` or `destroy` operation, a single ctrl-c will cancel the current operation, waiting for it to complete. A second ctrl-c will terminate the operation immediately. ([khulnasoft/khulnasoft#1231](https://github.com/khulnasoft/khulnasoft/pull/1231)).

- When getting update logs, get all results ([khulnasoft/khulnasoft#1220](https://github.com/khulnasoft/khulnasoft/pull/1220)). Fixes a bug where logs could sometimes be truncated in the khulnasoft.com console.

## 0.11.3 (2018-04-13)

- Switch to a resource-progress oriented view for khulnasoft preview, update, and destroy operations ([khulnasoft/khulnasoft#1116](https://github.com/khulnasoft/khulnasoft/pull/1116)). The operations `khulnasoft preview`, `update` and `destroy` have far simpler output by default, and show a progress view of ongoing operations. In addition, there is a structured component view, showing a parent operation as complete only when all child resources have been created.

- Remove strict dependency on Node v6.10.x ([khulnasoft/khulnasoft#1139](https://github.com/khulnasoft/khulnasoft/pull/1139)). It is now no longer necessary to use a specific version of Node to run Pulumi programs. Node versions after 6.10.x are supported, as long as they are under **Active LTS** or are the **Current** stable release.

## 0.11.2 (2018-04-06)

### Changed

- (Breaking) Require `khulnasoft login` before commands that need a backend ([khulnasoft/khulnasoft#1114](https://github.com/khulnasoft/khulnasoft/pull/1114)). The `khulnasoft` CLI now requires you to log in to khulnasoft.com for most operations.

### Fixed

- Improve the error message arising from missing required configurations for resource providers ([khulnasoft/khulnasoft#1097](https://github.com/khulnasoft/khulnasoft/pull/1097)). The error message now prints all missing configuration keys, along with their descriptions.

## 0.11.0 (2018-03-20)

### Added

- Add a `khulnasoft new` command to scaffold a project ([khulnasoft/khulnasoft#1008](https://github.com/khulnasoft/khulnasoft/pull/1008)). Usage is `khulnasoft new [templateName]`. If template name is not specified, the CLI will prompt with a list of templates. Currently, the templates `javascript`, `python` and `typescript` are available. Templates are defined in the GitHub repo [khulnasoft/templates](https://github.com/khulnasoft/templates) and contributions are welcome!

- Python is now a supported language in Pulumi ([khulnasoft/khulnasoft#800](https://github.com/khulnasoft/khulnasoft/pull/800)). For more information, see [Python documentation](https://www.khulnasoft.com/docs/reference/python/).

### Changed

- (Breaking) Change the way that configuration is stored ([khulnasoft/khulnasoft#986](https://github.com/khulnasoft/khulnasoft/pull/986)). To simplify the configuration model, there is no longer a separate notion of project and workspace settings, but only stack settings. The switches `--all` and `--save` are no longer supported; any common settings across stacks must be set on each stack directly. Settings for a stack are stored in a file that is a sibling to `Pulumi.yaml`, named `Pulumi.<stack-name>.yaml`. On first run `khulnasoft`, will migrate projects from the previous configuration format to the new one. The recommended practice is that developer stacks that are not shared between team members should be added to `.gitignore`, while stack setting files for shared stacks should be checked in to source control. For more information, see the section [Defining and setting stack settings](https://www.khulnasoft.com/docs/reference/config/#config-stack).

- (Breaking) Eliminate the superfluous `:config` part of configuration keys ([khulnasoft/khulnasoft#995](https://github.com/khulnasoft/khulnasoft/pull/995)). `khulnasoft` no longer requires configuration keys to have the string `:config` in them. Using the `:config` string in keys for the object `@khulnasoft/khulnasoft.Config` is deprecated and `preview` and `update` show warnings when it is used. Additionally, it is preferred to set keys in the form `aws:region` rather than `aws:config:region`. For compatibility, the old behavior is also supported, but will be removed in a future release. For more information, see the article [Configuration](https://www.khulnasoft.com/docs/reference/config/).

- (Breaking) Modules are treated as normal values when serialized ([khulnasoft/khulnasoft#1030](https://github.com/khulnasoft/khulnasoft/pull/1030)). If you need to use a module at runtime, consider either using `require` or `await import` at runtime, or pre-compute what you need and capture the resulting data or objects.

<!-- NOTE: the programming-model article below is still all todos. -->
- (Breaking) Serialize resource registration after inputs resolve ([khulnasoft/khulnasoft#964](https://github.com/khulnasoft/khulnasoft/pull/964)). Previously, resources were most often created/updated in the order they were seen during the Pulumi program execution. In preparation for supporting parallel resource operations, these operations now run in an order that respects the dependencies between resources (via [`Output`](https://www.khulnasoft.com/docs/reference/pkg/nodejs/khulnasoft/khulnasoft/#Output)), but may not match the order of program execution. This is mostly transparent to Pulumi program authors, but does mean that any missing dependencies will cause your program to fail in unexpected ways. For more information on how such failures manifest and what to do about them, see the article [Programming Model](https://www.khulnasoft.com/docs/reference/programming-model/).

- Hide secrets from CLI output ([khulnasoft/khulnasoft#1002](https://github.com/khulnasoft/khulnasoft/pull/1002)). To prevent secret values from being accidentally disclosed in command output or logs, `khulnasoft` replaces secret values with the string `[secret]`. Inspired by the behavior of [Travis CI](https://travis-ci.org/).

- Change default of where stacks are created ([khulnasoft/khulnasoft#971](https://github.com/khulnasoft/khulnasoft/pull/971)). If currently logged in to the Pulumi CLI, `stack init` creates a managed stack; otherwise, it creates a local stack. To force a local or remote stack, use the flags `--local` or `--remote`.

### Fixed

- Improve error messages output by the CLI ([khulnasoft/khulnasoft#1011](https://github.com/khulnasoft/khulnasoft/pull/1011)). RPC endpoint errors have been improved. Errors such as "catastrophic error" and "fatal error" are no longer duplicated in the output.

- Produce better error messages when the main module is not found ([khulnasoft/khulnasoft#976](https://github.com/khulnasoft/khulnasoft/pull/976)). If you're running TypeScript but have not run `tsc` or your main JavaScript file does not exist, the CLI will print a helpful `info:` message that points to the possible source of the error.
...
- Add a `khulnasoft history` command ([khulnasoft#636](https://github.com/khulnasoft/khulnasoft/issues/636)). For a managed stack, use the `khulnasoft history` to view deployments of that stack's resources.

### Changed

- (Breaking) Use `npm install` instead of `npm link` to reference the Pulumi SDK `@khulnasoft/aws`, `@khulnasoft/cloud`, `@khulnasoft/cloud-aws`. For more information, see [Pulumi npm packages](https://www.khulnasoft.com/docs/reference/pkg/nodejs/).

- (Breaking) Explicitly track resource dependencies via `Input` and `Output` types. This enables future improvements to the Pulumi development experience, such as parallel resource creation and enhanced dependency visualization. When a resource is created, all of its output properties are instances of a new type [`khulnasoft.Output<T>`](https://www.khulnasoft.com/docs/reference/pkg/nodejs/khulnasoft/khulnasoft/#Output). `Output<T>` contains both the value of the resource property and metadata that tracks resource dependencies. Inputs to a resource now accept `Output<T>` in addition to `T` and `Promise<T>`.

### Fixed

- Managed stacks sometimes return a 500 error when requesting logs
- Error when using `float64` attributes using SDK v0.9.9 ([khulnasoft-terraform#95](https://github.com/khulnasoft/khulnasoft-terraform/issues/95))
- `khulnasoft logs` entries only return first line ([khulnasoft#857](https://github.com/khulnasoft/khulnasoft/issues/857))
...
- The command `khulnasoft logs` now defaults to returning one hour of logs and outputs the start time that is  used.

### Fixed

- When a stack is removed, `khulnasoft` now deletes any configuration it had saved in either the `Pulumi.yaml` file or the workspace.
...
New in this release is the [Pulumi Console](https://app.khulnasoft.com) and stacks that are managed by Pulumi. This is the recommended way to safely deploy cloud applications.
- `khulnasoft stack init` now creates a Pulumi managed stack. For a local stack, use `--local`.
- All Pulumi CLI commands now work with managed stacks. Login to Pulumi via `khulnasoft login`.
- The [Pulumi Console](https://app.khulnasoft.com) provides a management experience for stacks. You can view the currently deployed resources (along with the AWS ARNs) and see logs from the last update operation.

#### Components and output properties

- Support for component resources([khulnasoft #340](https://github.com/khulnasoft/khulnasoft/issues/340)), enabling grouping of resources into logical components. This provides an improved view of resources during `preview` and `update` operations in the CLI ([khulnasoft #417](https://github.com/khulnasoft/khulnasoft/issues/417)).

  ```
  + khulnasoft:khulnasoft:Stack: (create)
     [urn=urn:khulnasoft:donna-testing::url-shortener::khulnasoft:khulnasoft:Stack::url-shortener-donna-testing]
     + cloud:table:Table: (create)
        [urn=urn:khulnasoft:donna-testing::url-shortener::cloud:table:Table::urls]
        + aws:dynamodb/table:Table: (create)
              [urn=urn:khulnasoft:donna-testing::url-shortener::cloud:table:Table$aws:dynamodb/table:Table::urls]
  ```
- A stack can have *output properties*, defined as `export let varName = val`. You can view the last deployed value for the output property using `khulnasoft stack output varName` or in the Pulumi Console.
...
- Store secrets securely in configuration via `khulnasoft config set --secret`. chris
- The verbs for `config` are now consistent, via `get`, `set`, and `rm`. See [Consistent config verbs #552](https://github.com/khulnasoft/khulnasoft/issues/552).

#### Logging

- [**experimental**] Support for the `khulnasoft logs` command ([khulnasoft #527](https://github.com/khulnasoft/khulnasoft/issues/527)). These features now work:
  - To see new logs as they arrive, use `--follow`
  - Use `--since` to limit to recent logs, such as `khulnasoft logs --since=1h`
  - Filter to specific resources with `--resource`. This filters to a particular component and its child resources (if any), such as `khulnasoft logs --resource examples-todoc57917fa --since 1h`

#### Other features

- Support for `.khulnasoftignore`, for files that should not be uploaded when deploying a managed stack through Pulumi.
- [Allow overriding a `Pulumi.yaml`'s entry point #575](https://github.com/khulnasoft/khulnasoft/issues/575). To specify the entry directory, specify `main` in `Pulumi.yaml`. For instance, `main: a/path/to/main/`.
- Support for *protected* resources. A resource can be marked as `protect: true`, which prevents deletion of the resource. For example, `let res = new MyResource("precious", { .. }, { protect: true });`. To "unprotect" the resource, change `protect: false` then run `khulnasoft up`. See [Allow resources to be flagged "protected" #689](https://github.com/khulnasoft/khulnasoft/issues/689).
- Changed defaults for workspace and stack configuration. See [Workspace configuration is error prone #714](https://github.com/khulnasoft/khulnasoft/issues/714).
- [Save configuration under the stack by default](https://github.com/khulnasoft/khulnasoft/issues/693).
...
- [Better diffing in CLI output, especially for Lambdas \#454](https://github.com/khulnasoft/khulnasoft/issues/454)
- [`main` does not set working dir correctly for Lambda zip #667](https://github.com/khulnasoft/khulnasoft/issues/667)
- [Better error when invalid access token is used in `khulnasoft login` #640](https://github.com/khulnasoft/khulnasoft/issues/640)
- [Eliminate the top-level Stack from all URNs #647](https://github.com/khulnasoft/khulnasoft/issues/647)
- Service API for Encrypting and Decrypting secrets
- [Make CLI resilient to network flakiness #763](https://github.com/khulnasoft/khulnasoft/issues/763)
- Support --since and --resource on `khulnasoft logs` when targeting the service
- [Pulumi unable to serialize non-integers #694](https://github.com/khulnasoft/khulnasoft/issues/694)
- [Stop buffering CLI output #660](https://github.com/khulnasoft/khulnasoft/issues/660)