...
- Added support for Google as an LLM provider for Cody, with the following models available through Cody Gateway: Gemini Pro (`gemini-pro-latest`), Gemini 1.5 Flash (`gemini-1.5-flash-latest`), and Gemini 1.5 Pro (`gemini-1.5-pro-latest`). [#63053](https://github.com/khulnasoft/khulnasoft/pull/63053)
- Added syntax highlighting for the Magik programming language. [#62919](https://github.com/khulnasoft/khulnasoft/pull/62919)
- Added syntax highlighting for the Hack programming language. [#62770](https://github.com/khulnasoft/khulnasoft/pull/62770)
- Batch Changes: The new (optional) field "version" of batch specs determines how the spec is processed. This allows us to introduce new features while maintaining backward compatability. [#63613](https://github.com/khulnasoft/khulnasoft/pull/63613)
- Batch Changes: A new version `2` is introduced. Batch specs specifying `version: 2` will use keyword search as the default pattern type to determine repos/workspaces. Batch specs with `version: 1` or without version field keep using pattern type "standard". [#63613](https://github.com/khulnasoft/khulnasoft/pull/63613)
- Batch Changes: GitHub apps can now be added as a credential for authentication and interacting with changesets. [#31533](https://github.com/khulnasoft/khulnasoft/issues/31533)
...
- Fix a bug that caused Bedrock Provisioned Throughput model names to fail [#62695](https://github.com/khulnasoft/khulnasoft/pull/62695) ~~[#62642](https://github.com/khulnasoft/khulnasoft/pull/62642)~~
- Fixed an issue where usernames were too eagerly suffixed with a random ID to prevent duplicates which could cause issues with Bitbucket Server permissions syncing where exact username matches are required. [#62747](https://github.com/khulnasoft/khulnasoft/pull/62747)
- Fixed an issue where code graph configuration policies would miscategorize lightweight tags as branches. [#62671](https://github.com/khulnasoft/khulnasoft/pull/62671)
- Fixed a bug in batch changes scheduling that could cause excessive CPU usage. [#62597](https://github.com/khulnasoft/khulnasoft/pull/62597)
- Cody ignore: update version constraint error message [#62654](https://github.com/khulnasoft/khulnasoft/pull/62654)

## 5.4.0

### Added

- Added rate and latency instrumentation for git / package repository syncing operations. These are visible in the gitserver dashboards (VCS "Clone/Fetch/IsCloneable" Metrics). [#61708](https://github.com/khulnasoft/khulnasoft/pull/61708)
- Added syntax highlighting for the [Pkl](https://pkl-lang.org/) configuration language. [#61478](https://github.com/khulnasoft/khulnasoft/pull/61478)
- New `rev:at.time()` search filter that allows you to search a branch at a point in time. [#61513](https://github.com/khulnasoft/khulnasoft/pull/61513)
- "cody.contextFilters" field to the site config. Admins can set include and exclude rules to define which repositories Cody can use as context in its requests to third-party LLMs. [#61101](https://github.com/khulnasoft/khulnasoft/pull/61101), [#61641](https://github.com/khulnasoft/khulnasoft/pull/61641)
- Added whether "cody.contextFilters" field is configured in the site config to pings. [#62080](https://github.com/khulnasoft/khulnasoft/pull/62080)
- Added exhaustive logging for all gRPC requests sent to gitserver. This feature is off by default, and can be enabled by setting the `SRC_GITSERVER_EXHAUSTIVE_LOGGING_ENABLED` environment variable to `true`. [#61270](https://github.com/khulnasoft/khulnasoft/pull/61270)
- Added an `internal` option for the `repositoryQuery` field for GitHub Enterprise code host connections. This will mirror all internal repositories on the code host. [#61924](https://github.com/khulnasoft/khulnasoft/pull/61924)

### Changed

- Improved syntax highlighting for Dart. [#58480](https://github.com/khulnasoft/khulnasoft/pull/58480)
- The default noop Event type in the honey package has been replaced with a new type that aggregates fields in memory for testing and logging purposes. [#61854](https://github.com/khulnasoft/khulnasoft/pull/61854)
- Improved the performance of Language Stats Insights by 50-70% by increasing the concurrent requests from the frontend to the gitserver from 1 to 4. You can override the concurrency with the `GET_INVENTORY_GIT_SERVER_CONCURRENCY` environment variable. [#62011](https://github.com/khulnasoft/khulnasoft/pull/62011)
- Raised the backend timeout for Language Stats Insights from 3 minutes to 5 minutes. You can override this with the `GET_INVENTORY_TIMEOUT` environment variable. [#62011](https://github.com/khulnasoft/khulnasoft/pull/62011)
- Code insights drilldown behavior has been changed from a diff search to a point-in-time search with the new `rev:at.time()`. [#61953](https://github.com/khulnasoft/khulnasoft/pull/61953)
- The `FirstEverCommit` gitserver client method has been changed to use a new bespoke gRPC endpoint instead of the legacy `exec` endpoint. [#62173](https://github.com/khulnasoft/khulnasoft/pull/62173)
- The `GetBehindAhead` gitserver client method has been changed to use a new bespoke gRPC endpoint instead of the legacy `exec` endpoint. [#62217](https://github.com/khulnasoft/khulnasoft/pull/62217)
- All uses of the `DiffSymbols` gitserver client method have been replaced with the new `ChangedFiles` method. As such, the `DiffSymbos` method has been removed [#62355](https://github.com/khulnasoft/khulnasoft/pull/62355)

### Fixed

- Updated the Docker-in-Docker image to 26.0.0 to resolve several vulnerabilities. [#61735](https://github.com/khulnasoft/khulnasoft/pull/61735)
- The GetCommit() RPC in the gitserver service now uses the correct protobuf type that allows for non-utf8 byte sequences in commit messages, author names, and author emails. [#61940](https://github.com/khulnasoft/khulnasoft/pull/61940)
- The ArchiveReader() RPC in the gitserver service now uses the correct protobuf type that allows for non-utf8 byte sequences in file paths. [#61970](https://github.com/khulnasoft/khulnasoft/pull/61970)
...
- Indexed-search now supports draining a replica of indexes to support zero-downtime reduction in cluster size. [#62005](https://github.com/khulnasoft/khulnasoft/pull/62005)

### Fixed

- Rust binaries are now built in release mode to avoid unnecessary debug checks. [#61740](https://github.com/khulnasoft/khulnasoft/pull/61740)
- Fixed how scip-ctags reports errors to avoid failing search indexing on non-fatal errors. [#61712](https://github.com/khulnasoft/khulnasoft/pull/61712)
- Fixed a bug in Enterprise Cody context for queries containing only stopwords. [#61848](https://github.com/khulnasoft/khulnasoft/pull/61848), [#62026](https://github.com/khulnasoft/khulnasoft/pull/62026)
- Fixed the instance dropdown on the zoekt grafana dashboard. [#61836](https://github.com/khulnasoft/khulnasoft/pull/61836)

## 5.3.11625

### Changed

- Notices configured in the site config now allow for specifying a style or color. [#61338](https://github.com/khulnasoft/khulnasoft/pull/61338)
- Reduce spamming error logs when canceling symbols indexing or canceling a syntax highlighting request. [#61880](https://github.com/khulnasoft/khulnasoft/pull/61880), [#61719](https://github.com/khulnasoft/khulnasoft/pull/61719), [#61732](https://github.com/khulnasoft/khulnasoft/pull/61732)

### Fixed

- Fixed a bug where the `src batch preview` command could fail due to an incorrect file-not-found error. [#61984](https://github.com/khulnasoft/khulnasoft/pull/61984)
- Fixed a bug where the Roles page in the Site Admin view was inaccessible. [#61738](https://github.com/khulnasoft/khulnasoft/pull/61738)
- Fixed a panic in Cody Attribution in sourcegraph-frontend when reporting an error. [#60439](https://github.com/khulnasoft/khulnasoft/issues/60439)

## 5.3.9104

### Added

- GitHub app installations can now be refreshed from the Batch Changes Site Admin page. [#60125](https://github.com/khulnasoft/khulnasoft/pull/60125)
- The SAML auth provider configuration now supports a `usernameAttributeNames` field that can be used to specify a list of SAML attribute that should be used as the username. [#60603](https://github.com/khulnasoft/khulnasoft/pull/60603)
- Added the GraphQL query `User.evaluateFeatureFlag` to show if a feature flag is enabled or disabled for a user. [#60828](https://github.com/khulnasoft/khulnasoft/pull/60828)
...
- GitHub apps installation records will only be deleted from the database if the GitHub App has been uninstalled or if the GitHub app has been deleted. [#60460](https://github.com/khulnasoft/khulnasoft/pull/60460)
- The Anthropic provider for Cody has been updated to use the messages API which includes support for Claude 3 models. This is applicable to both BYOK and Cody Gateway users. The messages API does not support model identifiers which only set a major model version such as: `claude-2`, `claude-instant-v1` and `claude-instant-1`. Default values have been updated to `claude-2.0` and `claude-instant-1.2`, any legacy models identifiers in the site config will be set to the corresponding default previously mentioned. [#60953](https://github.com/khulnasoft/khulnasoft/pull/60953) [#61324](https://github.com/khulnasoft/khulnasoft/pull/61324)
- The AWS Bedrock provider for Cody has been updated to use Anthropic's Messages API, bringing support for Claude 3 models. [#61347](https://github.com/khulnasoft/khulnasoft/pull/61347)
- Improved the ranking of branches for repositories with a lot of branches. Branches in the branch selector are now always sorted by recency, with HEAD at the top. [#60323](https://github.com/khulnasoft/khulnasoft/pull/60323)
- Notices configured in the site config now allow for specifying a style or color. [#61338](https://github.com/khulnasoft/khulnasoft/pull/61338)

### Fixed

- Code Monitors now properly ignores monitors associated with soft-deleted users, which previously would have led to an error on the overview page. [#60405](https://github.com/khulnasoft/khulnasoft/pull/60405)
...
- Selecting "View blame prior to this change" on a file that was moved will now correctly navigate to the old file location at the specified commit. [#61577](https://github.com/khulnasoft/khulnasoft/pull/61577)
- Git blame performance on large files with a large number of commits has been drastically improved. [#61577](https://github.com/khulnasoft/khulnasoft/pull/61577)
- Code Insights now properly ignores search API alerts, which previously would have led to a code insight error. [#61431](https://github.com/khulnasoft/khulnasoft/pull/61431)
...
- Changed the Azure OpenAI Cody provider to use the stable 2023-05-15 api version, due to the retirement of previous preview api versions. [61005](https://github.com/khulnasoft/khulnasoft/pull/61005)

### Fixed

- Fixed an issue in our build process that broke tooltips and validation in the settings editors. [#60808](https://github.com/khulnasoft/khulnasoft/pull/60808)

- Fixes a bug where the reference panel would not show any definitions or references for Protocol Buffers (and other languages where the name contained a space). [#60987](https://github.com/khulnasoft/khulnasoft/pull/60987)

- Fixed a bug where permission syncs could be scheduled for repositories or users even when a sync is already scheduled or in progress, leading to significant delays in the permissions sync system as a whole. [#61024](https://github.com/khulnasoft/khulnasoft/pull/61024)

- Fixed a bug in gitserver where it was possible to use expired Github App authorization tokens when syncing a large repository. Now, gitserver will use the latest tokens for each step of the syncing process (and refresh them if necessary). [#61179](https://github.com/khulnasoft/khulnasoft/pull/61179/)
...
- The search bar now supports keyword search by default, which ANDs terms together instead of searching literally as before. The behavior can be disabled through a toggle on the search results page. [#58815](https://github.com/khulnasoft/khulnasoft/issues/58815)
- The `has.topic` filter now supports filtering by Gitlab topics. [#57649](https://github.com/khulnasoft/khulnasoft/pull/57649)
- Batch Changes now allows changesets to be exported in CSV and JSON format. [#56721](https://github.com/khulnasoft/khulnasoft/pull/56721)
- Supports custom ChatCompletion models in Cody clients for dotcom users. [#58158](https://github.com/khulnasoft/khulnasoft/pull/58158)
- Topics synced from GitHub and GitLab are now displayed for repository matches in the search results and on the repository tree page. [#58927](https://github.com/khulnasoft/khulnasoft/pull/58927)
- Added a new column "Repository metadata JSON" to the CSV export of repository search results, which includes the JSON encoded object of metadata key-value pairs. [#59334](https://github.com/khulnasoft/khulnasoft/pull/59334)
- Expiry to access tokens. Users can now select a maximum timespan for which a token is valid. Tokens will automatically lose access after this period. Default timeframes and an override to disable access tokens without expiration can be configured in the `auth.accessTokens` section of the site configuration. [#59565](https://github.com/khulnasoft/khulnasoft/pull/59565)
- Gerrit code host connections now support an 'exclude' field that prevents repos in this list from being synced. [#59739](https://github.com/khulnasoft/khulnasoft/pull/59739)
- Limit the number of active access tokens for a user. By default users are able to have 25 active access tokens. This limit can be configured using the `maxTokensPerUser` setting in the `auth.accessTokens` section of the site configuration. [#59731](https://github.com/khulnasoft/khulnasoft/pull/59731)
- Add experimental support for .cody/ignore when retrieving remote context. To enable it, set `experimentalFeatures.codyContextIgnore: true` in the site configuration. [#59836](https://github.com/khulnasoft/khulnasoft/pull/59836), [#59907](https://github.com/khulnasoft/khulnasoft/pull/59907)
- Site admin, link to the Cody Analytics service. [#60371](https://github.com/khulnasoft/khulnasoft/pull/60371)
- Added a reimagined filter panel to the search result page, facilitating a workflow centered around iterative refinement.
- Search results were treated to a design refresh, improving information density of results. [#59834](https://github.com/khulnasoft/khulnasoft/pull/59834)
- Added a preview pane to file search results so you can view the full file without navigating away from the search results. [#58311](https://github.com/khulnasoft/khulnasoft/pull/58311)
...
- Clicking on a search result now opens the blob view at the same commit as the search result. Before, blob views were opened at the tip of the default branch, which sometimes caused inconsistencies in line numbers if the index was out of date. [#58381](https://github.com/khulnasoft/khulnasoft/pull/58381)
- The `exclude` configuration for code host configuration has been updated to allow chaining multiple conditions together and filtering GitHub repositories based on their size or number of GitHub stars. [#58377](https://github.com/khulnasoft/khulnasoft/pull/58377) and [#58405](https://github.com/khulnasoft/khulnasoft/pull/58405)
...
- Site configuration edit history no longer breaks when the user that made the edit is deleted. [#57656](https://github.com/khulnasoft/khulnasoft/pull/57656)
- Drilling down into an insights query no longer mangles `content:` fields in your query. [#57679](https://github.com/khulnasoft/khulnasoft/pull/57679)
- The blame column now shows correct blame information when a hunk starts in a folded code section. [#58042](https://github.com/khulnasoft/khulnasoft/pull/58042)
- Fixed a bug where typing in the GraphQL editor in the Site Admin API console could cause the cursor to jump to the start of the editor. [#57862](https://github.com/khulnasoft/khulnasoft/pull/57862)
- The blame column no longer ignores whitespace-only changes by default. [#58134](https://github.com/khulnasoft/khulnasoft/pull/58134)
- Long lines now wrap correctly in the diff view. [#58138](https://github.com/khulnasoft/khulnasoft/pull/58138)
- Fixed an issue in the search input where pressing Enter after selecting a suggestion would sometimes insert another suggestions instead of submitting the query. [#58186](https://github.com/khulnasoft/khulnasoft/pull/58186)
- Fixed an issue where having sub-repo permissions enabled could cause repositories with a large number of files in directories to become unviewable. [#59420](https://github.com/khulnasoft/khulnasoft/pull/59420)
- On the search context, code monitoring, code insights, saved searches or notebook pages, when selecting a repository or file suggestion in the query input with Enter the suggestion is now properly appended to the query instead of navigating away to the corresponding repository or file page. [#59941](https://github.com/khulnasoft/khulnasoft/pull/59941)
- Perforce email matching for user permissions is now case insensitive, matching Perforce behavior. [#60252](https://github.com/khulnasoft/khulnasoft/pull/60252)
- A bug with syncing GitHub App installations that caused installations to be truncated after the first 30 orgs. [#60383](https://github.com/khulnasoft/khulnasoft/pull/60383)
...
- The notepad UI, notebook creation feature. [#58217](https://github.com/khulnasoft/khulnasoft/pull/58217)
- The experimental `indexRepositoryName` option for the rust packages code host connection has been removed. [#59176](https://github.com/khulnasoft/khulnasoft/pull/59176)
- The column "Repository metadata" in the CSV export of repository search results is now deprecated and will be removed in a future release. Use "Repository metadata JSON" instead [#59334](https://github.com/khulnasoft/khulnasoft/pull/59334)
- Remote embeddings as context source for Cody has been removed. [#59493](https://github.com/khulnasoft/khulnasoft/pull/59493)

## 5.2.7

### Fixed

- The reference panel correctly shows definition and reference information instead of a "Could not find token" error for MATLAB. [#59636](https://github.com/khulnasoft/khulnasoft/pull/59636)
- The auto-index configuration page correctly shows any auto-inference errors instead of a nil pointer exception. [#59756](https://github.com/khulnasoft/khulnasoft/pull/59756)

## 5.2.6

### Added

- Implement adding automatic retry support for idempotent gRPC methods [#59404](https://github.com/khulnasoft/khulnasoft/pull/59404)

### Fixed

- Fix executors auth header `installSrc` [#59391](https://github.com/khulnasoft/khulnasoft/pull/59391)
- Avoid constantly rerunning failed embeddings jobs. [#58980](https://github.com/khulnasoft/khulnasoft/pull/58980)

## 5.2.5

### Added

- Added Cody providers data to pings. [#58848](https://github.com/khulnasoft/khulnasoft/pull/58848)
- Added the ability to proxy authentication requests when using the Azure OpenAI Cody provider. [#58862](https://github.com/khulnasoft/khulnasoft/pull/58862)

### Fixed

- Fixed an issue where updating a generic git code host would cause it to become unrestricted if permissions user mapping is enabled. [#58772](https://github.com/khulnasoft/khulnasoft/pull/58772)
- Fail embeddings jobs immediately if the rate limit is exceeded. [#58869](https://github.com/khulnasoft/khulnasoft/pull/58869)

### Changed

- Improved the admin page for search indexing. [#58866](https://github.com/khulnasoft/khulnasoft/pull/58866)

## 5.2.4

### Added

- Added the ability to use Workload Identity, Managed Identity and Environmental credentials when using the Azure OpenAI completions and embeddings providers [#58289](https://github.com/khulnasoft/khulnasoft/pull/58289)
- Added support for cloning via SSH from Azure DevOps. [#58655](https://github.com/khulnasoft/khulnasoft/pull/58655)
...
- Fixed performance issue with embeddings job scheduling. (#58651)[https://github.com/khulnasoft/khulnasoft/pull/58651]
...
- Defining file filters for embeddings jobs no longer causes all files to be skipped if `MaxFileSizeBytes` isn't defined. [#58262](https://github.com/khulnasoft/khulnasoft/pull/58262)

## 5.2.2

### Added

- Added a new authorization configuration options to GitLab code host connections: "markInternalReposAsPublic". Setting "markInternalReposAsPublic" to true is useful for organizations that have a large amount of internal repositories that everyone on the instance should be able to access, removing the need to have permissions to access these repositories. Additionally, when configuring a GitLab auth provider, you can specify "syncInternalRepoPermissions": false, which will remove the need to sync permissions for these internal repositories. [#57858](https://github.com/khulnasoft/khulnasoft/pull/57858)
- Experimental support for OpenAI powered autocomplete has been added. [#57872](https://github.com/khulnasoft/khulnasoft/pull/57872)

### Fixed

- Updated the endpoint used by the AWS Bedrock Claude provider. [#58028](https://github.com/khulnasoft/khulnasoft/pull/58028)
...
- Fixed a user's Permissions page being inaccessible if the user has had no permission syncs with an external account connected. [#57372](https://github.com/khulnasoft/khulnasoft/pull/57372)
- Fixed a bug where site admins could not view a user's permissions if they didn't have access to all of the repositories the user has. Admins still won't be able to see repositories they don't have access to, but they will now be able to view the rest of the user's repository permissions. [#57375](https://github.com/khulnasoft/khulnasoft/pull/57375)
- Fixed a bug where gitserver statistics would not be properly decoded / reported when using REST (i.e. `experimentalFeatures.enableGRPC = false` in site configuration). [#57318](https://github.com/khulnasoft/khulnasoft/pull/57318)
- Updated the `curl` and `libcurl` dependencies to `8.4.0-r0` to fix [CVE-2023-38545](https://curl.se/docs/CVE-2023-38545.html). [#57533](https://github.com/khulnasoft/khulnasoft/pull/57533)
- Fixed a bug where commit signing failed when creating a changeset if `batchChanges.enforceFork` is set to true. [#57520](https://github.com/khulnasoft/khulnasoft/pull/57520)
...
- Language detection for code highlighting now uses `go-enry` for all files by default, which fixes highlighting for MATLAB files. [#56559](https://github.com/khulnasoft/khulnasoft/pull/56559)
...
- Added experimental autocomplete support for Azure OpenAI [#56063](https://github.com/khulnasoft/khulnasoft/pull/56063)

### Changed

- Improved stability of gRPC connections [#56314](https://github.com/khulnasoft/khulnasoft/pull/56314), [#56302](https://github.com/khulnasoft/khulnasoft/pull/56302), [#56298](https://github.com/khulnasoft/khulnasoft/pull/56298), [#56217](https://github.com/khulnasoft/khulnasoft/pull/56217)

## 5.1.7

### Changed

- Pressing `Mod-f` will always select the input value in the file view search [#55546](https://github.com/khulnasoft/khulnasoft/pull/55546)
- Caddy has been updated to version 2.7.3 resolving a number of vulnerabilities. [#55606](https://github.com/khulnasoft/khulnasoft/pull/55606)
...
- New Prometheus metrics have been added to track the response / request sizes of gRPC calls. [#55381](https://github.com/khulnasoft/khulnasoft/pull/55381)
- A new embeddings site configuration setting `excludeChunkOnError` allows embedding jobs to complete job execution despite chunks of code or text that fail. When enabled the chunks are skipped after failed retries but the index can continue being populated. When disabled the entire job fails and the index is not saved. This setting is enabled by default. Embedding job statistics now capture `code_chunks_excluded` and `text_chunks_excluded` for successfully completed jobs. Total excluded chunks and file names for excluded chunks are logged as warnings. [#55180](https://github.com/khulnasoft/khulnasoft/pull/55180)
- Experimental support for Azure OpenAI for the completions and embeddings provider has been added. [#55178](https://github.com/khulnasoft/khulnasoft/pull/55178)
- Added a feature flag for alternate GitLab project visibility resolution. This may solve some weird cases with not being able to see GitLab internal projects. [#54426](https://github.com/khulnasoft/khulnasoft/pull/54426)
...
- It is now possible to add annotations to pods spawned by jobs created by the Kubernetes executor. [#55361](https://github.com/khulnasoft/khulnasoft/pull/55361)

### Changed

- Updated all packages in container images to latest versions
- Updated Docker-in-Docker image from 23.0.1 to 23.0.6
- The gRPC implementation for the Symbol service's `LocalCodeIntel` endpoint has been changed to stream its results. [#55242](https://github.com/khulnasoft/khulnasoft/pull/55242)
- When using OpenAI or Azure OpenAI for Cody completions, code completions will be disabled - chat will continue to work. This is because we currently don't support code completions with OpenAI. [#55624](https://github.com/khulnasoft/khulnasoft/pull/55624)

### Fixed

- Fixed a bug where user account requests could not be approved even though the license would permit user creation otherwise. [#55482](https://github.com/khulnasoft/khulnasoft/pull/55482)
- Fixed a bug where the background scheduler for embedding jobs based on policies would not schedule jobs for private repositories. [#55698](https://github.com/khulnasoft/khulnasoft/pull/55698)
- Fixed a source of inconsistency in precise code navigation, affecting implementations and prototypes especially. [#54410](https://github.com/khulnasoft/khulnasoft/pull/54410)
...
- Fixed an embeddings job scheduler bug where if we cannot resolve one of the repositories or its default branch then all repositories submitted will not have their respective embeddings job enqueued. Embeddings job scheduler will now continue to schedule jobs for subsequent repositories in the submitted repositories set. [#54701](https://github.com/khulnasoft/khulnasoft/pull/54701)
- Creation of GitHub Apps will now respect system certificate authorities when specifying certificates for the tls.external site configuration. [#55084](https://github.com/khulnasoft/khulnasoft/pull/55084)
- Passing multi-line Coursier credentials in JVM packages configuration should now work correctly. [#55113](https://github.com/khulnasoft/khulnasoft/pull/55113)
- SCIP indexes are now ingested in a streaming fashion, eliminating out-of-memory errors in most cases, even when uploading very large indexes (1GB+ uncompressed). [#53828](https://github.com/khulnasoft/khulnasoft/pull/53828)
- Moved the license checks to worker service. We make sure to run only 1 instance of license checks this way. [54854](https://github.com/khulnasoft/khulnasoft/pull/54854)
- Updated base images to resolve issues in curl, OpenSSL, and OpenSSL. [55310](https://github.com/khulnasoft/khulnasoft/pull/55310)
- The default message size limit for gRPC clients has been raised from 4MB to 90MB. [#55209](https://github.com/khulnasoft/khulnasoft/pull/55209)
- The message printing feature for the custom gRPC internal error interceptor now supports logging all internal error types, instead of just non-utf 8 errors. [#55130](https://github.com/khulnasoft/khulnasoft/pull/55130)
- Fixed an issue where GitHub Apps could not be set up using Firefox. [#55305](https://github.com/khulnasoft/khulnasoft/pull/55305)
- Fixed nil panic on certain GraphQL fields when listing users. [#55322](https://github.com/khulnasoft/khulnasoft/pull/55322)

### Changed

- The "Files" tab of the fuzzy finder now allows you to navigate directly to a line number by appending `:NUMBER`. For example, the fuzzy query `main.ts:100` opens line 100 in the file `main.ts`. [#55064](https://github.com/khulnasoft/khulnasoft/pull/55064)
- The gRPC implementation for the Symbol service's `LocalCodeIntel` endpoint has been changed to stream its results. [#55242](https://github.com/khulnasoft/khulnasoft/pull/55242)
- GitLab auth providers now support an `ssoURL` option that facilitates scenarios where a GitLab group requires SAML/SSO. [#54957](https://github.com/khulnasoft/khulnasoft/pull/54957)
...
- A bug where we would temporarily use much more memory than needed during embeddings fetching. [#54972](https://github.com/khulnasoft/khulnasoft/pull/54972)
...
- Fixes a crash when uploading indexes with malformed source ranges (this was a bug in scip-go). [#54304](https://github.com/khulnasoft/khulnasoft/pull/54304)
- Fixed validation of Bitbucket Cloud configuration in site-admin create/update form. [#54494](https://github.com/khulnasoft/khulnasoft/pull/54494)
- Fixed race condition with grpc `server.send` message. [#54500](https://github.com/khulnasoft/khulnasoft/pull/54500)
- Fixed a configuration initialization issue that broke the outbound request in the site admin page. [#54745](https://github.com/khulnasoft/khulnasoft/pull/54745)
- Fixed Postgres DSN construction edge-case. [#54858](https://github.com/khulnasoft/khulnasoft/pull/54858)

## 5.1.1

### Fixed

- Fixed the default behaviour when the explicit permissions API is enabled. Repositories are no longer marked as unrestricted by default. [#54419](https://github.com/khulnasoft/khulnasoft/pull/54419)
...
- Executors natively support Kubernetes environments. [#49236](https://github.com/khulnasoft/khulnasoft/pull/49236)
- Documentation for GitHub fine-grained access tokens. [#50274](https://github.com/khulnasoft/khulnasoft/pull/50274)
- Code Insight dashboards retain size and order of the cards. [#50301](https://github.com/khulnasoft/khulnasoft/pull/50301)
...
- Added the ability to block auto-indexing scheduling and inference via the `codeintel_autoindexing_exceptions` Postgres table. [#51578](https://github.com/khulnasoft/khulnasoft/pull/51578)
- When an admin has configured rollout windows for Batch Changes changesets, the configuration details are now visible to all users on the Batch Changes settings page. [#50479](https://github.com/khulnasoft/khulnasoft/pull/50479)
- Added support for regular expressions in`exclude` repositories for GitLab code host connections. [#51862](https://github.com/khulnasoft/khulnasoft/pull/51862)
- Branches created by Batch Changes will now be automatically deleted on the code host upon merging or closing a changeset if the new `batchChanges.autoDeleteBranch` site setting is enabled. [#52055](https://github.com/khulnasoft/khulnasoft/pull/52055)
- Repository metadata now generally available for everyone [#50567](https://github.com/khulnasoft/khulnasoft/pull/50567), [#50607](https://github.com/khulnasoft/khulnasoft/pull/50607), [#50857](https://github.com/khulnasoft/khulnasoft/pull/50857), [#50908](https://github.com/khulnasoft/khulnasoft/pull/50908), [#972](https://github.com/sourcegraph/src-cli/pull/972), [#51031](https://github.com/khulnasoft/khulnasoft/pull/51031), [#977](https://github.com/sourcegraph/src-cli/pull/977), [#50821](https://github.com/khulnasoft/khulnasoft/pull/50821), [#51258](https://github.com/khulnasoft/khulnasoft/pull/51258), [#52078](https://github.com/khulnasoft/khulnasoft/pull/52078), [#51985](https://github.com/khulnasoft/khulnasoft/pull/51985), [#52150](https://github.com/khulnasoft/khulnasoft/pull/52150), [#52249](https://github.com/khulnasoft/khulnasoft/pull/52249), [#51982](https://github.com/khulnasoft/khulnasoft/pull/51982), [#51248](https://github.com/khulnasoft/khulnasoft/pull/51248), [#51921](https://github.com/khulnasoft/khulnasoft/pull/51921), [#52301](https://github.com/khulnasoft/khulnasoft/pull/52301)
- Batch Changes for Gerrit Code Hosts [#52647](https://github.com/khulnasoft/khulnasoft/pull/52647).
- Batch Changes now supports per-batch-change control for pushing to a fork of the upstream repository when the property `changesetTemplate.fork` is specified in the batch spec. [#51572](https://github.com/khulnasoft/khulnasoft/pull/51572)
- Executors can now be configured to process multiple queues. [#52016](https://github.com/khulnasoft/khulnasoft/pull/52016)
- Added `isCodyEnabled` as a new GraphQL field to `Site`. [#52941](https://github.com/khulnasoft/khulnasoft/pull/52941)
- Enabled improved search ranking by default. This feature can be disabled through the `search-ranking` feature flag.[#53031](https://github.com/khulnasoft/khulnasoft/pull/53031)
- Added token callback route for Cody in VS Code and VS Code insiders. [#53313](https://github.com/khulnasoft/khulnasoft/pull/53313)
- Latest repository clone/sync output is surfaced in the "Mirroring and cloning" page (`{REPO}/-/settings/mirror`). Added primarily to enable easier debugging of issues with Perforce depots, it can also be useful for other code hosts. [#51598](https://github.com/khulnasoft/khulnasoft/pull/51598)
- New `file:has.contributor(...)` predicate for filtering files based on contributors. [#53206](https://github.com/khulnasoft/khulnasoft/pull/53206)
- Added multi-repo scope selector for Cody on the web supporting unified context generation API which uses combination of embeddings search and keyword search as fallback for context generation. [53046](https://github.com/khulnasoft/khulnasoft/pull/53046)
- Batch Changes can now sign commits for changesets published on GitHub code hosts via GitHub Apps. [#52333](https://github.com/khulnasoft/khulnasoft/pull/52333)
...
- GitHub `repositoryQuery` searches now respect date ranges and use API requests more efficiently. #[49969](https://github.com/khulnasoft/khulnasoft/pull/49969)
- Fixed an issue where search based references were not displayed in the references panel. [#50157](https://github.com/khulnasoft/khulnasoft/pull/50157)
- Symbol suggestions only insert `type:symbol` filters when necessary. [#50183](https://github.com/khulnasoft/khulnasoft/pull/50183)
- Removed an incorrect beta label on the Search Context creation page [#51188](https://github.com/khulnasoft/khulnasoft/pull/51188)
- Multi-version upgrades to version `5.0.2` in a fully airgapped environment will not work without the command `--skip-drift-check`. [#51164](https://github.com/khulnasoft/khulnasoft/pull/51164)
- Could not set "permissions.syncOldestUsers" or "permissions.syncOldestRepos" to zero. [#51255](https://github.com/khulnasoft/khulnasoft/pull/51255)
- GitLab code host connections will disable repo-centric repository permission syncs when the authentication provider is set as "oauth". This prevents repo-centric permission sync from getting incorrect data. [#51452](https://github.com/khulnasoft/khulnasoft/pull/51452)
- Code intelligence background jobs did not correctly use an internal context, causing SCIP data to sometimes be prematurely deleted. [#51591](https://github.com/khulnasoft/khulnasoft/pull/51591)
- Slow request logs now have the correct trace and span IDs attached if a trace is present on the request. [#51826](https://github.com/khulnasoft/khulnasoft/pull/51826)
- The braindot menu on the blob view no longer fetches data eagerly to prevent performance issues for larger monorepo users. [#53039](https://github.com/khulnasoft/khulnasoft/pull/53039)
- Fixed an issue where commenting out redacted site-config secrets would re-add the secrets. [#53152](https://github.com/khulnasoft/khulnasoft/pull/53152)
- Fixed an issue where SCIP packages would sometimes not be written to the database, breaking cross-repository jump to definition. [#53763](https://github.com/khulnasoft/khulnasoft/pull/53763)
- Fixed an issue when adding a new user external account was not scheduling a new permission sync for the user. [#54144](https://github.com/khulnasoft/khulnasoft/pull/54144)
- Adding a new user account now correctly schedules a permission sync for the user. [#54258](https://github.com/khulnasoft/khulnasoft/pull/54258)
- Users/repos without an existing sync job in the permission_sync_jobs table are now scheduled properly. [#54278](https://github.com/khulnasoft/khulnasoft/pull/54278)

### Removed

- User tags are removed in favor of the newer feature flags functionality. [#49318](https://github.com/khulnasoft/khulnasoft/pull/49318)
- Previously deprecated site config `experimentalFeatures.bitbucketServerFastPerm` has been removed. [#50707](https://github.com/khulnasoft/khulnasoft/pull/50707)
- Unused site-config field `api.rateLimit` has been removed. [#51087](https://github.com/khulnasoft/khulnasoft/pull/51087)
- Legacy (table-based) blob viewer. [#50915](https://github.com/khulnasoft/khulnasoft/pull/50915)

## 5.0.6

### Fixed

- SAML assertions to get user display name are now compared case insensitively and we do not always return an error. [#52992](https://github.com/khulnasoft/khulnasoft/pull/52992)
- Fixed an issue where `type:diff` search would not work when sub-repo permissions are enabled. [#53210](https://github.com/khulnasoft/khulnasoft/pull/53210)

## 5.0.5

### Added

- Organization members can now administer batch changes created by other members in their organization's namespace if the setting `orgs.allMembersBatchChangesAdmin` is enabled for that organization. [#50724](https://github.com/khulnasoft/khulnasoft/pull/50724)
- Allow instance public access mode based on `auth.public` site config and `allow-anonymous-usage` license tag [#52440](https://github.com/khulnasoft/khulnasoft/pull/52440)
- The endpoint configuration field for completions is now supported by the OpenAI provider [#52530](https://github.com/khulnasoft/khulnasoft/pull/52530)

### Fixed

- MAU calculation in product analytics and pings use the same condition and UTC at all times. [#52306](https://github.com/khulnasoft/khulnasoft/pull/52306) [#52579](https://github.com/khulnasoft/khulnasoft/pull/52579) [#52581](https://github.com/khulnasoft/khulnasoft/pull/52581)
- Bitbucket native integration: fix code-intel popovers on the pull request pages. [#52609](https://github.com/khulnasoft/khulnasoft/pull/52609)
- `id` column of `user_repo_permissions` table was switched to `bigint` to avoid `int` overflow. [#52299](https://github.com/khulnasoft/khulnasoft/pull/52299)
- In some circumstances filenames containing `..` either could not be read or would return a diff when viewed. We now always correctly read those files. [#52605](https://github.com/khulnasoft/khulnasoft/pull/52605)
...
- Git blame lookups of repositories synced through `src serve-git` or code hosts using a custom `repositoryPathPattern` will now use the correct URL when streaming git blame is enabled. [#51525](https://github.com/khulnasoft/khulnasoft/pull/51525)
- Code Insights scoped to a static list of repository names would fail to resolve repositories with permissions enabled, resulting in insights that would not process. [#51657](https://github.com/khulnasoft/khulnasoft/pull/51657)
- Batches: Resolved an issue with GitHub webhooks where CI check updates fail due to the removal of a field from the GitHub webhook payload. [#52035](https://github.com/khulnasoft/khulnasoft/pull/52035)

## 5.0.3

### Added

- Cody aggregated pings. [#50835](https://github.com/khulnasoft/khulnasoft/pull/50835)

### Fixed

- Bitbucket Server adding an error log if there is no account match for the user. #[51030](https://github.com/khulnasoft/khulnasoft/pull/51030)
- Editing search context with special characters such as `/` resulted in http 404 error. [#51196](https://github.com/khulnasoft/khulnasoft/pull/51196)
- Significantly improved performance and reduced memory usage of the embeeddings service. [#50953](https://github.com/khulnasoft/khulnasoft/pull/50953), [#51372](https://github.com/khulnasoft/khulnasoft/pull/51372)
- Fixed an issue where a Code Insights query with structural search type received 0 search results for the latest commit of any matching repo. [#51076](https://github.com/khulnasoft/khulnasoft/pull/51076)

## 5.0.2

### Added

- An experimental site config setting to restrict cody to users by the cody-experimental feature flag [#50668](https://github.com/khulnasoft/khulnasoft/pull/50668)
...
- For Cody, explicitly detect some cases where context is needed to avoid failed responses. [#50541](https://github.com/khulnasoft/khulnasoft/pull/50541)
- Code Insights that are run over zero repositories will finish processing and show `"No data to display"`. #[50561](https://github.com/khulnasoft/khulnasoft/pull/50561)
- DNS timeouts on calls to host.docker.internal from every html page load for docker-compose air-gapped instances. No more DNS lookups in jscontext.go anymore. #[50638](https://github.com/khulnasoft/khulnasoft/pull/50638)
- Improved the speed of the embedding index by significantly decreasing the calls to Gitserver. [#50410](https://github.com/khulnasoft/khulnasoft/pull/50410)
...
- Added a modal to show warnings and errors when exporting search results. [#50348](https://github.com/khulnasoft/khulnasoft/pull/50348)
...
- Fixed an issue where Slack code monitoring notifications failed when the message was too long. [#50083](https://github.com/khulnasoft/khulnasoft/pull/50083)
...
- Granting pending permissions to users when experimentalFeatures.unifiedPermissions is turned ON [#50059](https://github.com/khulnasoft/khulnasoft/pull/50059)
- The unified permissions out of band migration reported as unfinished if there were users with no permissions [#50147](https://github.com/khulnasoft/khulnasoft/pull/50147)
- Filenames with special characters are correctly handled in Cody's embedding service [#50023](https://github.com/khulnasoft/khulnasoft/pull/50023)
- Structural search correctly cleans up when done preventing a goroutine leak [#50034](https://github.com/khulnasoft/khulnasoft/pull/50034)
- Fetch search based definitions in the reference panel if no precise definitions were found [#50179](https://github.com/khulnasoft/khulnasoft/pull/50179)
...
- Experimental GraphQL query, `permissionsSyncJobs` is substituted with new non-experimental query which provides full information about permissions sync jobs stored in the database. [#47933](https://github.com/khulnasoft/khulnasoft/pull/47933)
- Renders `readme.txt` files in the repository page. [#47944](https://github.com/khulnasoft/khulnasoft/pull/47944)
- Renders GitHub pull request references in all places where a commit message is referenced. [#48183](https://github.com/khulnasoft/khulnasoft/pull/48183)
- CodeMirror blob view (default) uses selection-driven code navigation. [#48066](https://github.com/khulnasoft/khulnasoft/pull/48066)
- Older Code Insights data points will now be automatically archived as configured by the site configuration setting `insights.maximumSampleSize`, set to 30 by default. All points can be exported. This behaviour can be disabled using the experimental setting `insightsDataRetention`. [#48259](https://github.com/khulnasoft/khulnasoft/pull/48259)
- The admin debug GraphQL endpoint for Code Insights will now include the series metadata in the response. [#49473](https://github.com/khulnasoft/khulnasoft/pull/49473)
...
- The ordering of code host sync error messages in the notifications menu will now be persistent. Previously the order was not guaranteed on a refresh of the status messages, which would make the code host sync error messages jump positions, giving a false sense of change to the site admins. [#48722](https://github.com/khulnasoft/khulnasoft/pull/48722)
- Fixed Detect & Track Code Insights running over all repositories when during creation a search was used to specify the repositories for the insight. [#49633](https://github.com/khulnasoft/khulnasoft/pull/49633)

### Removed

- The LSIF upload endpoint is no longer supported and has been replaced by a diagnostic error page. src-cli v4.5+ will translate all local LSIF files to SCIP prior to upload. [#47547](https://github.com/khulnasoft/khulnasoft/pull/47547)
- The experimental setting `authz.syncJobsRecordsLimit` has been removed. [#47933](https://github.com/khulnasoft/khulnasoft/pull/47933)
- Storing permissions sync jobs statuses in Redis has been removed as now all permissions sync related data is stored in a database. [#47933](https://github.com/khulnasoft/khulnasoft/pull/47933)
- The key `shared_steps` has been removed from auto-indexing configuration descriptions. If you have a custom JSON auto-indexing configuration set for a repository that defines this key, you should inline the content into each index job's `steps` array. [#48770](https://github.com/khulnasoft/khulnasoft/pull/48770)

## 4.5.1

### Changed

- Updated git to version 2.39.2 to address [reported security vulnerabilities](https://github.blog/2023-02-14-git-security-vulnerabilities-announced-3/) [#47892](https://github.com/khulnasoft/khulnasoft/pull/47892/files)
- Updated curl to 7.88.1 to address [reported security vulnerabilities](https://curl.se/docs/CVE-2022-42915.html) [#48144](https://github.com/khulnasoft/khulnasoft/pull/48144)
...
- Batch Changes: Log outputs from execution steps are now paginated in the web interface. [#46335](https://github.com/khulnasoft/khulnasoft/pull/46335)
...
- Resolved issue which would prevent Batch Changes from being able to update changesets on forks of repositories on Bitbucket Server created prior to version 4.2. [#47397](https://github.com/khulnasoft/khulnasoft/pull/47397)
- Fixed a bug where changesets created on forks of repositories in a personal user's namespace on GitHub could not be updated after creation. [#47397](https://github.com/khulnasoft/khulnasoft/pull/47397)
- Fixed a bug where saving default Sort & Limit filters in Code Insights did not persist [#46653](https://github.com/khulnasoft/khulnasoft/pull/46653)
...
- Fixed a bug where removing an auth provider would render a user's Account Security page inaccessible if they still had an external account associated with the removed auth provider. [#47092](https://github.com/khulnasoft/khulnasoft/pull/47092)
- Fixed a bug where the `repo:has.description()` parameter now correctly shows description of a repository synced from a Bitbucket server code host connection, while previously it used to show the repository name instead [#46752](https://github.com/khulnasoft/khulnasoft/pull/46752)
- Fixed a bug where permissions syncs consumed more rate limit tokens than required. This should lead to speed-ups in permission syncs, as well as other possible cases where a process runs in repo-updater. [#47374](https://github.com/khulnasoft/khulnasoft/pull/47374)
- Fixes UI bug where folders with single child were appearing as child folders themselves. [#46628](https://github.com/khulnasoft/khulnasoft/pull/46628)
- Performance issue with the Outbound requests page. [#47544](https://github.com/khulnasoft/khulnasoft/pull/47544)
...
- Connection checks for code host connections have been changed to talk to code host APIs directly via HTTP instead of doing DNS lookup and TCP dial. That makes them more resistant in environments where proxies are used. [#46918](https://github.com/khulnasoft/khulnasoft/pull/46918)
- The search query input overflow behavior on search home page has been fixed. [#46922](https://github.com/khulnasoft/khulnasoft/pull/46922)
...
- Monitoring: Indexed-Search's dashboard now has new graphs for search request durations and "in-flight" search request workloads [#45966](https://github.com/khulnasoft/khulnasoft/pull/45966)
- The GraphQL API now supports listing single-file commit history across renames (with `GitCommit.ancestors(follow: true, path: "<some-path>")`). [#45882](https://github.com/khulnasoft/khulnasoft/pull/45882)
- Added support for receiving Bitbucket Cloud webhook `push` events. [#45960](https://github.com/khulnasoft/khulnasoft/pull/45960)
- Added a way to test code host connection from the `Manage code hosts` page. [#45972](https://github.com/khulnasoft/khulnasoft/pull/45972)
- Updates to the site configuration from the site admin panel will now also record the user id of the author in the database in the `critical_and_site_config.author_user_id` column. [#46150](https://github.com/khulnasoft/khulnasoft/pull/46150)
...
- Added a `Corrupted` status filter on the Admin repositories page, allowing Administrators to filter the list of repositories to only those that have been detected as corrupt. [#46415](https://github.com/khulnasoft/khulnasoft/pull/46415)
- Added “Background job dashboard” admin feature [#44901](https://github.com/khulnasoft/khulnasoft/pull/44901)

### Changed

- Code Insights no longer uses a custom index of commits to compress historical backfill and instead queries the repository log directly. This allows the compression algorithm to span any arbitrary time frame, and should improve the reliability of the compression in general. [#45644](https://github.com/khulnasoft/khulnasoft/pull/45644)
...
- Renders GitHub pull request references in git blame view. [#46409](https://github.com/khulnasoft/khulnasoft/pull/46409)

### Fixed

- Made search results export use the same results list as the search results page. [#45702](https://github.com/khulnasoft/khulnasoft/pull/45702)
- Code insights with more than 1 year of history will correctly show 12 data points instead of 11. [#45644](https://github.com/khulnasoft/khulnasoft/pull/45644)
- Hourly code insights will now behave correctly and will no longer truncate to midnight UTC on the calendar date the insight was created. [#45644](https://github.com/khulnasoft/khulnasoft/pull/45644)
- Code Insights: fixed an issue where filtering by a search context that included multiple repositories would exclude data. [#45574](https://github.com/khulnasoft/khulnasoft/pull/45574)
- Ignore null JSON objects returned from GitHub API when listing public repositories. [#45969](https://github.com/khulnasoft/khulnasoft/pull/45969)
- Fixed issue where emails that have never been verified before would be unable to receive resent verification emails. [#46185](https://github.com/khulnasoft/khulnasoft/pull/46185)
- Resolved issue preventing LSIF uploads larger than 2GiB (gzipped) from uploading successfully. [#46209](https://github.com/khulnasoft/khulnasoft/pull/46209)
...
- Fix issue in Gitlab OAuth in which user group membership is set too wide - adds `min_access_level=10` to `/groups` request. [#46480](https://github.com/khulnasoft/khulnasoft/pull/46480)
...
- User and organization auto-defined search contexts have been permanently removed along with the `autoDefinedSearchContexts` GraphQL query. The only auto-defined context now is the `global` context. [#46083](https://github.com/khulnasoft/khulnasoft/pull/46083)
- The settings `experimentalFeatures.showSearchContext`, `experimentalFeatures.showSearchNotebook`, and `experimentalFeatures.codeMonitoring` have been removed and these features are now permanently enabled when available. [#46086](https://github.com/khulnasoft/khulnasoft/pull/46086)
- The legacy panels on the homepage (recent searches, etc) which were turned off by default but could still be re-enabled by setting `experimentalFeatures.showEnterpriseHomePanels` to true, are permanently removed now. [#45705](https://github.com/khulnasoft/khulnasoft/pull/45705)
- The `site { monitoringStatistics { alerts } }` GraphQL query has been deprecated and will no longer return any data. The query will be removed entirely in a future release. [#46299](https://github.com/khulnasoft/khulnasoft/pull/46299)
- The Monaco version of the search query input and the corresponding feature flag (`experimentalFeatures.editor`) have been permanently removed. [#46249](https://github.com/khulnasoft/khulnasoft/pull/46249)
...
- Batch Change: When one or more changesets are selected, we now display all bulk operations but disable the ones that aren't applicable to the changesets. [#44617](https://github.com/khulnasoft/khulnasoft/pull/44617)
- Gitserver's repository purge worker now runs on a regular interval instead of just on weekends, configurable by the `repoPurgeWorker` site configuration. [#44753](https://github.com/khulnasoft/khulnasoft/pull/44753)
- Editing the presentation metadata (title, line color, line label) or the default filters of a scoped Code Insight will no longer trigger insight recalculation. [#44769](https://github.com/khulnasoft/khulnasoft/pull/44769), [#44797](https://github.com/khulnasoft/khulnasoft/pull/44797)
...
- Saving a new view of a scoped Code Insight will no longer trigger insight recalculation. [#44679](https://github.com/khulnasoft/khulnasoft/pull/44679)
...
- GitHub fine-grained Personal Access Tokens can now clone repositories correctly, but are not yet officially supported. [#45137](https://github.com/khulnasoft/khulnasoft/pull/45137)
- Detect-and-track Code Insights will now return data for repositories without sub-repo permissions even when sub-repo permissions are enabled on the instance. [#45631](https://github.com/khulnasoft/khulnasoft/pull/45361)

### Removed

- Removed legacy GraphQL field `dirtyMetadata` on an insight series. `insightViewDebug` can be used as an alternative. [#44416](https://github.com/khulnasoft/khulnasoft/pull/44416)
- Removed `search.index.enabled` site configuration setting. Search indexing is now always enabled.
- Removed the experimental feature setting `showSearchContextManagement`. The search context management page is now available to all users with access to search contexts. [#45230](https://github.com/khulnasoft/khulnasoft/pull/45230)
- Removed the experimental feature setting `showComputeComponent`. Any notebooks that made use of the compute component will no longer render the block. The block will be deleted from the databse the next time a notebook that uses it is saved. [#45360](https://github.com/khulnasoft/khulnasoft/pull/45360)
...
- Batch changes run server-side now support secrets. [#27926](https://github.com/khulnasoft/khulnasoft/issues/27926)
- OIDC success/fail login attempts are now a part of the audit log. [#44467](https://github.com/khulnasoft/khulnasoft/pull/44467)
- A new experimental GraphQL query, `permissionsSyncJobs`, that lists the states of recently completed permissions sync jobs and the state of each provider. The TTL of entries retrained can be configured with `authz.syncJobsRecordsTTL`. [#44387](https://github.com/khulnasoft/khulnasoft/pull/44387), [#44258](https://github.com/khulnasoft/khulnasoft/pull/44258)
- The search input has a new search history button and allows cycling through recent searches via up/down arrow keys. [#44544](https://github.com/khulnasoft/khulnasoft/pull/44544)
- Repositories can now be ordered by size on the repo admin page. [#44360](https://github.com/khulnasoft/khulnasoft/pull/44360)
- The search bar contains a new Smart Search toggle. If a search returns no results, Smart Search attempts alternative queries based on a fixed set of rules, and shows their results (if there are any). Smart Search is enabled by default. It can be disabled by default with `"search.defaultMode": "precise"` in settings. [#44385](https://github.com/khulnasoft/khulnasoft/pull/44395)
- Repositories in the site-admin area can now be filtered, so that only indexed repositories are displayed [#45288](https://github.com/khulnasoft/khulnasoft/pull/45288)

### Changed

- Updated minimum required version of `git` to 2.38.1 in `gitserver` and `server` Docker image. This addresses: https://github.blog/2022-04-12-git-security-vulnerability-announced/ and https://lore.kernel.org/git/d1d460f6-e70f-b17f-73a5-e56d604dd9d5@github.com/. [#43615](https://github.com/khulnasoft/khulnasoft/pull/43615)
- When a `content:` filter is used in a query, only file contents will be searched (previously any of file contents, paths, or repos were searched). However, as before, if `type:` is also set, the `content:` filter will search for results of the specified `type:`. [#43442](https://github.com/khulnasoft/khulnasoft/pull/43442)
- Updated [p4-fusion](https://github.com/salesforce/p4-fusion) from `1.11` to `1.12`.

### Fixed

- Fixed a bug where path matches on files in the root directory of a repository were not highlighted. [#43275](https://github.com/khulnasoft/khulnasoft/pull/43275)
- Fixed a bug where a search query wouldn't be validated after the query type has changed. [#43849](https://github.com/khulnasoft/khulnasoft/pull/43849)
- Fixed an issue with insights where a single erroring insight would block access to all insights. This is a breaking change for users of the insights GraphQL api as the `InsightViewConnection.nodes` list may now contain `null`. [#44491](https://github.com/khulnasoft/khulnasoft/pull/44491)
- Fixed a bug where Open in Editor didn't work well with `"repositoryPathPattern" = "{nameWithOwner}"` [#43839](https://github.com/khulnasoft/khulnasoft/pull/44475)

### Removed

- Remove the older `log.gitserver.accessLogs` site config setting. The setting is succeeded by `log.auditLog.gitserverAccess`. [#43174](https://github.com/khulnasoft/khulnasoft/pull/43174)
- Remove `LOG_ALL_GRAPHQL_REQUESTS` env var. The setting is succeeded by `log.auditLog.graphQL`. [#43181](https://github.com/khulnasoft/khulnasoft/pull/43181)
- Removed support for setting `SRC_ENDPOINTS_CONSISTENT_HASH`. This was an environment variable to support the transition to a new consistent hashing scheme introduced in 3.31.0. [#43528](https://github.com/khulnasoft/khulnasoft/pull/43528)
...
- Fixed a bug that caused the Phabricator native extension to not load the right CSS assets. [#43868](https://github.com/khulnasoft/khulnasoft/pull/43868)
- Fixed a bug that prevented search result exports to load. [#43344](https://github.com/khulnasoft/khulnasoft/pull/43344)

## 4.1.2

### Fixed

- Fix code navigation on OSS when CodeIntel is unavailable. [#43458](https://github.com/khulnasoft/khulnasoft/pull/43458)

### Removed

- Removed the onboarding checklist for new users that showed up in the top navigation bar, on user profiles, and in the site-admin overview page. After changes to the underlying user statistics system, the checklist caused severe performance issues for customers with large and heavily-used instances. [#43591](https://github.com/khulnasoft/khulnasoft/pull/43591)

## 4.1.1

### Fixed

- Fixed a bug with normalizing the `published` draft value for `changeset_specs`. [#43390](https://github.com/khulnasoft/khulnasoft/pull/43390)

## 4.1.0

### Added

- Outdated executors now show a warning from the admin page. [#40916](https://github.com/khulnasoft/khulnasoft/pull/40916)
- Added support for better Slack link previews for private instances. Link previews are currently feature-flagged, and site admins can turn them on by creating the `enable-link-previews` feature flag on the `/site-admin/feature-flags` page. [#41843](https://github.com/khulnasoft/khulnasoft/pull/41843)
- Added a new button in the repository settings, under "Mirroring", to delete a repository from disk and reclone it. [#42177](https://github.com/khulnasoft/khulnasoft/pull/42177)
- Batch changes run on the server can now be created within organisations. [#36536](https://github.com/khulnasoft/khulnasoft/issues/36536)
- GraphQL request logs are now compliant with the audit logging format. The old GraphQl logging based on `LOG_ALL_GRAPHQL_REQUESTS` env var is now deprecated and scheduled for removal. [#42550](https://github.com/khulnasoft/khulnasoft/pull/42550)
- Mounting files now works when running batch changes server side. [#31792](https://github.com/khulnasoft/khulnasoft/issues/31792)
- Added mini dashboard of total batch change metrics to the top of the batch changes list page. [#42046](https://github.com/khulnasoft/khulnasoft/pull/42046)
- Added repository sync counters to the code host details page. [#43039](https://github.com/khulnasoft/khulnasoft/pull/43039)

### Changed

- Git server access logs are now compliant with the audit logging format. Breaking change: The 'actor' field is now nested under 'audit' field. [#41865](https://github.com/khulnasoft/khulnasoft/pull/41865)
- All Perforce rules are now stored together in one column and evaluated on a "last rule takes precedence" basis. [#41785](https://github.com/khulnasoft/khulnasoft/pull/41785)
- Security events are now a part of the audit log. [#42653](https://github.com/khulnasoft/khulnasoft/pull/42653)
- "GC AUTO" is now the default garbage collection job. We disable sg maintenance, which had previously replace "GC AUTO", after repeated reports about repo corruption. [#42856](https://github.com/khulnasoft/khulnasoft/pull/42856)
- Security events (audit log) can now optionally omit the internal actor actions (internal traffic). [#42946](https://github.com/khulnasoft/khulnasoft/pull/42946)
- To use the optional `customGitFetch` feature, the `ENABLE_CUSTOM_GIT_FETCH` env var must be set on `gitserver`. [#42704](https://github.com/khulnasoft/khulnasoft/pull/42704)

### Fixed

- WIP changesets in Gitlab >= 14.0 are now prefixed with `Draft:` instead of `WIP:` to accomodate for the [breaking change in Gitlab 14.0](https://docs.gitlab.com/ee/update/removals.html#wip-merge-requests-renamed-draft-merge-requests). [#42024](https://github.com/khulnasoft/khulnasoft/pull/42024)
- When updating the site configuration, the provided Last ID is now used to prevent race conditions when simultaneous config updates occur. [#42691](https://github.com/khulnasoft/khulnasoft/pull/42691)
- When multiple auth providers of the same external service type is set up, there are now separate entries in the user's Account Security settings. [#42865](https://github.com/khulnasoft/khulnasoft/pull/42865)
- Fixed a bug with GitHub code hosts that did not label archived repos correctly when using the "public" repositoryQuery keyword. [#41461](https://github.com/khulnasoft/khulnasoft/pull/41461)
- Fixed a bug that would display the blank batch spec that a batch change is initialized with in the batch specs executions tab. [#42914](https://github.com/khulnasoft/khulnasoft/pull/42914)
- Fixed a bug that would cause menu dropdowns to not open appropriately. [#42779](https://github.com/khulnasoft/khulnasoft/pull/42779)
...
- Fixed a panic that can be caused by some tracing configurations. [#42027](https://github.com/khulnasoft/khulnasoft/pull/42027)
- Fixed broken code navigation for Javascript. [#42055](https://github.com/khulnasoft/khulnasoft/pull/42055)
- Fixed issue with empty code navigation popovers. [#41958](https://github.com/khulnasoft/khulnasoft/pull/41958)
...
- **IMPORTANT:** `repo:contains(file:foo content:bar)` has been renamed to `repo:contains.file(path:foo content:bar)`. `repo:contains.file(foo)` has been renamed to `repo:contains.path(foo)`. `repo:contains()` **is no longer a valid predicate. Saved searches using** `repo:contains()` **will need to be updated to use the new syntax.** [#40389](https://github.com/khulnasoft/khulnasoft/pull/40389)

### Fixed

- Fixed support for bare repositories using the src-cli and other codehost type. This requires the latest version of src-cli. [#40863](https://github.com/khulnasoft/khulnasoft/pull/40863)
- The recommended [src-cli](https://github.com/sourcegraph/src-cli) version is now reported consistently. [#39468](https://github.com/khulnasoft/khulnasoft/issues/39468)
- A performance issue affecting structural search causing results to not stream. It is much faster now. [#40872](https://github.com/khulnasoft/khulnasoft/pull/40872)
- An issue where the saved search input box reports an invalid pattern type for `standard`, which is now valid. [#41068](https://github.com/khulnasoft/khulnasoft/pull/41068)
- Git will now respect system certificate authorities when specifying `certificates` for the `tls.external` site configuration. [#38128](https://github.com/khulnasoft/khulnasoft/issues/38128)
- Fixed a bug where setting `"observability.tracing": {}` would disable tracing, when the intended behaviour is to default to tracing with `"sampling": "selective"` enabled by default. [#41242](https://github.com/khulnasoft/khulnasoft/pull/41242)
- The performance, stability, and latency of search predicates like `repo:has.file()`, `repo:has.content()`, and `file:has.content()` have been dramatically improved. [#418](https://github.com/sourcegraph/zoekt/pull/418), [#40239](https://github.com/khulnasoft/khulnasoft/pull/40239), [#38988](https://github.com/khulnasoft/khulnasoft/pull/38988), [#39501](https://github.com/khulnasoft/khulnasoft/pull/39501)
- A search query issue where quoted patterns inside parenthesized expressions would be interpreted incorrectly. [#41455](https://github.com/khulnasoft/khulnasoft/pull/41455)

### Removed

- `CACHE_DIR` has been removed from the `sourcegraph-frontend` deployment. This required ephemeral storage which will no longer be needed. This variable (and corresponding filesystem mount) has been unused for many releases. [#38934](https://github.com/khulnasoft/khulnasoft/issues/38934)
- Quick links will no longer be shown on the homepage or search sidebar. The `quicklink` setting is now marked as deprecated. [#40750](https://github.com/khulnasoft/khulnasoft/pull/40750)
- Quick links will no longer be shown on the homepage or search sidebar if the "Simple UI" toggle is enabled and will be removed entirely in a future release. The `quicklink` setting is now marked as deprecated. [#40750](https://github.com/khulnasoft/khulnasoft/pull/40750)
...
- The single-container `sourcegraph/server` deployment no longer bundles a Jaeger instance. [#41244](https://github.com/khulnasoft/khulnasoft/pull/41244)
...
- Fixed an issue causing context cancel error dumps when updating a code host config manually. [#40857](https://github.com/khulnasoft/khulnasoft/pull/41265)
- Fixed non-critical errors stopping the repo-syncing process for Bitbucket projectKeys. [#40897](https://github.com/khulnasoft/khulnasoft/pull/40582)
- Fixed an issue marking accounts as expired when the supplied Account ID list has no entries. [#40860](https://github.com/khulnasoft/khulnasoft/pull/40860)

## 3.43.1

### Fixed

- Fixed an infinite render loop on the batch changes detail page, causing the page to become unusable. [#40857](https://github.com/khulnasoft/khulnasoft/pull/40857)
- Unable to pick the correct GitLab OAuth for user authentication and repository permissions syncing when the instance configures more than one GitLab OAuth authentication providers. [#40897](https://github.com/khulnasoft/khulnasoft/pull/40897)
...
- Fix issue during code insight creation where selecting `"Run your insight over all your repositories"` reset the currently selected distance between data points. [#39261](https://github.com/khulnasoft/khulnasoft/pull/39261)
- Fix issue where symbols in the side panel did not have file level permission filtering applied correctly. [#39592](https://github.com/khulnasoft/khulnasoft/pull/39592)

### Removed

- The experimental dependencies search feature has been removed, including the `repo:deps(...)` search predicate and the site configuration options `codeIntelLockfileIndexing.enabled` and `experimentalFeatures.dependenciesSearch`. [#39742](https://github.com/khulnasoft/khulnasoft/pull/39742)

## 3.42.2

### Fixed

- Fix issue with capture group insights to fail immediately if they contain invalid queries. [#39842](https://github.com/khulnasoft/khulnasoft/pull/39842)
- Fix issue during conversion of just in time code insights to start backfilling data from the current time instead of the date the insight was created. [#39923](https://github.com/khulnasoft/khulnasoft/pull/39923)

## 3.42.1

### Fixed

- Reverted git version to avoid an issue with commit-graph that could cause repository corruptions [#39537](https://github.com/khulnasoft/khulnasoft/pull/39537)
- Fixed an issue with symbols where they were not respecting sub-repository permissions [#39592](https://github.com/khulnasoft/khulnasoft/pull/39592)

## 3.42.0

### Added

- Reattached changesets now display an action and factor into the stats when previewing batch changes. [#36359](https://github.com/khulnasoft/khulnasoft/issues/36359)
- New site configuration option `"permissions.syncUsersMaxConcurrency"` to control the maximum number of user-centric permissions syncing jobs could be spawned concurrently. [#37918](https://github.com/khulnasoft/khulnasoft/issues/37918)
- Added experimental support for exporting traces to an OpenTelemetry collector with `"observability.tracing": { "type": "opentelemetry" }` [#37984](https://github.com/khulnasoft/khulnasoft/pull/37984)
- Code Insights over some repos now get 12 historic data points in addition to a current daily value and future points that align with the defined interval. [#37756](https://github.com/khulnasoft/khulnasoft/pull/37756)
...
- A toggle to enable/disable a beta simplified UI has been added to the user menu. This new UI is still actively in development and any changes visible with the toggle enabled may not be stable are subject to change. [#38763](https://github.com/khulnasoft/khulnasoft/pull/38763)
- Search query inputs are now backed by the CodeMirror library instead of Monaco. Monaco can be re-enabled by setting `experimentalFeatures.editor` to `"monaco"`. [38584](https://github.com/khulnasoft/khulnasoft/pull/38584)
- Better search-based code navigation for Python using tree-sitter [#38459](https://github.com/khulnasoft/khulnasoft/pull/38459)
...
- Search: Pasting a query with line breaks into the main search query input will now replace them with spaces instead of removing them. [#37674](https://github.com/khulnasoft/khulnasoft/pull/37674)
...
- Fix an issue where updating the title or body of a Bitbucket Cloud pull request opened by a batch change could fail when the pull request was not on a fork of the target repository. [#37585](https://github.com/khulnasoft/khulnasoft/issues/37585)
- A bug where some complex `repo:` regexes only returned a subset of repository results. [#37925](https://github.com/khulnasoft/khulnasoft/pull/37925)
- Fix a bug when selecting all the changesets on the Preview Batch Change Page only selected the recently loaded changesets. [#38041](https://github.com/khulnasoft/khulnasoft/pull/38041)
- Fix a bug with bad code insights chart data points links. [#38102](https://github.com/khulnasoft/khulnasoft/pull/38102)
- Code Insights: the commit indexer no longer errors when fetching commits from empty repositories and marks them as successfully indexed. [#39081](https://github.com/khulnasoft/khulnasoft/pull/38091)
- The file view does not jump to the first selected line anymore when selecting multiple lines and the first selected line was out of view. [#38175](https://github.com/khulnasoft/khulnasoft/pull/38175)
- Fixed an issue where multiple activations of the back button are required to navigate back to a previously selected line in a file [#38193](https://github.com/khulnasoft/khulnasoft/pull/38193)
- Support timestamps with numeric timezone format from Gitlab's Webhook payload [#38250](https://github.com/khulnasoft/khulnasoft/pull/38250)
- Fix regression in 3.41 where search-based Code Insights could have their queries wrongly parsed into regex patterns when containing quotes or parentheses. [#38400](https://github.com/khulnasoft/khulnasoft/pull/38400)
- Fixed regression of mismatched `From` address when render emails. [#38589](https://github.com/khulnasoft/khulnasoft/pull/38589)
- Fixed a bug with GitHub code hosts using `"repositoryQuery":{"public"}` where it wasn't respecting exclude archived. [#38839](https://github.com/khulnasoft/khulnasoft/pull/38839)
- Fixed a bug with GitHub code hosts using `repositoryQuery` with custom queries, where it could potentially stall out searching for repos. [#38839](https://github.com/khulnasoft/khulnasoft/pull/38839)
- Fixed an issue in Code Insights were duplicate points were sometimes being returned when displaying series data. [#38903](https://github.com/khulnasoft/khulnasoft/pull/38903)
- Fix issue with Bitbucket Projects repository permissions sync regarding granting pending permissions. [#39013](https://github.com/khulnasoft/khulnasoft/pull/39013)
- Fix issue with Bitbucket Projects repository permissions sync when BindID is username. [#39035](https://github.com/khulnasoft/khulnasoft/pull/39035)
- Improve keyboard navigation for batch changes server-side execution flow. [#38601](https://github.com/khulnasoft/khulnasoft/pull/38601)
- Fixed a bug with the WorkspacePreview panel glitching when it's resized. [#36470](https://github.com/khulnasoft/khulnasoft/issues/36470)
- Handle special characters in search query when creating a batch change from search. [#38772](https://github.com/khulnasoft/khulnasoft/pull/38772)
- Fixed bug when parsing numeric timezone offset in Gitlab webhook payload. [#38250](https://github.com/khulnasoft/khulnasoft/pull/38250)
- Fixed setting unrestricted status on a repository when using the explicit permissions API. If the repository had never had explicit permissions before, previously this call would fail. [#39141](https://github.com/khulnasoft/khulnasoft/pull/39141)

### Removed

- The direct DataDog trace export integration has been removed. ([#37654](https://github.com/khulnasoft/khulnasoft/pull/37654))
- Removed the deprecated git exec forwarder. [#38092](https://github.com/khulnasoft/khulnasoft/pull/38092)
- Browser and IDE extensions banners. [#38715](https://github.com/khulnasoft/khulnasoft/pull/38715)

## 3.41.1

### Fixed

- Fix issue with Bitbucket Projects repository permissions sync when wrong repo IDs were used [#38637](https://github.com/khulnasoft/khulnasoft/pull/38637)
- Fix perforce permissions interpretation for rules where there is a wildcard in the depot name [#37648](https://github.com/khulnasoft/khulnasoft/pull/37648)

### Added

- Allow directory read access for sub repo permissions [#38487](https://github.com/khulnasoft/khulnasoft/pull/38487)

### Changed

- p4-fusion version is upgraded to 1.10 [#38272](https://github.com/khulnasoft/khulnasoft/pull/38272)
...
- Batch Changes: The credentials of the last applying user will now be used to sync changesets when available. If unavailable, then the previous behaviour of using a site or code host configuration credential is retained. [#33413](https://github.com/khulnasoft/khulnasoft/issues/33413)
- Gitserver: we disable automatic git-gc for invocations of git-fetch to avoid corruption of repositories by competing git-gc processes. [#36274](https://github.com/khulnasoft/khulnasoft/pull/36274)
- Commit and diff search: The hard limit of 50 repositories has been removed, and long-running searches will continue running until the timeout is hit. [#36486](https://github.com/khulnasoft/khulnasoft/pull/36486)
...
- The internal git command forwarder has been deprecated and will be removed in 3.42 [#37320](https://github.com/khulnasoft/khulnasoft/pull/37320)
...
- Fix issue with OAuth login using a Github code host by reverting gologin dependency update [#36685](https://github.com/khulnasoft/khulnasoft/pull/36685)
- Fix issue with single-container docker image where codeinsights-db was being incorrectly created [#36678](https://github.com/khulnasoft/khulnasoft/pull/36678)

## 3.40.1

### Fixed

- Support expiring OAuth tokens for GitLab which became the default in version 15.0. [#36003](https://github.com/khulnasoft/khulnasoft/pull/36003)
- Fix external service resolver erroring when webhooks not supported. [#35932](https://github.com/khulnasoft/khulnasoft/pull/35932)
...
- Code Insights: You can share code insights through a shareable link. [#34965](https://github.com/khulnasoft/khulnasoft/pull/34965)
- Search: `path:` is now a valid filter. It is an alias for the existing `file:` filter. [#34947](https://github.com/khulnasoft/khulnasoft/pull/34947)
...
- A new token creation callback feature that sends a token back to a trusted program automatically after the user has signed in [#35339](https://github.com/khulnasoft/khulnasoft/pull/35339)
- The Grafana dashboard now has a global container resource usage view to help site-admin quickly identify potential scaling issues. [#34808](https://github.com/khulnasoft/khulnasoft/pull/34808)

### Changed

- Sourcegraph's docker images are now based on Alpine Linux 3.14. [#34508](https://github.com/khulnasoft/khulnasoft/pull/34508)
...
- Unverified primary emails no longer breaks the Emails-page for users and Users-page for Site Admin. [#34312](https://github.com/khulnasoft/khulnasoft/pull/34312)
- Button to download raw file in blob page is now working correctly. [#34558](https://github.com/khulnasoft/khulnasoft/pull/34558)
- Searches containing `or` expressions are now optimized to evaluate natively on the backends that support it ([#34382](https://github.com/khulnasoft/khulnasoft/pull/34382)), and both commit and diff search have been updated to run optimized `and`, `or`, and `not` queries. [#34595](https://github.com/khulnasoft/khulnasoft/pull/34595)
- Carets in textareas in Firefox are now visible. [#34888](https://github.com/khulnasoft/khulnasoft/pull/34888)
- Changesets to GitHub code hosts could fail with a confusing, non actionable error message. [#35048](https://github.com/khulnasoft/khulnasoft/pull/35048)
- An issue causing search expressions to not work in conjunction with `type:symbol`. [#35126](https://github.com/khulnasoft/khulnasoft/pull/35126)
- A non-descriptive error message that would be returned when using `on.repository` if it is not a valid repository path [#35023](https://github.com/khulnasoft/khulnasoft/pull/35023)
- Reduced database load when viewing or previewing a batch change. [#35501](https://github.com/khulnasoft/khulnasoft/pull/35501)
- Fixed a bug where Capture Group Code Insights generated just in time only returned data for the latest repository in the list. [#35624](https://github.com/khulnasoft/khulnasoft/pull/35624)

### Removed

- The experimental API Docs feature released on our Cloud instance since 3.30.0 has been removed from the product entirely. This product functionality is being superseded by [doctree](https://github.com/sourcegraph/doctree). [#34798](https://github.com/khulnasoft/khulnasoft/pull/34798)
...
- Fixed an issue with notebooks that caused the cursor to behave erratically in markdown blocks. [#34227](https://github.com/khulnasoft/khulnasoft/pull/34227)
...
- Notebooks are now enabled by default. [#33706](https://github.com/khulnasoft/khulnasoft/pull/33706)
- The Code Insights GraphQL API now accepts Search Contexts as a filter and will extract the expressions embedded the `repo` and `-repo` search query fields from the contexts to apply them as filters on the insight. [#33866](https://github.com/khulnasoft/khulnasoft/pull/33866)
...
- Code Insights: Replaced native window confirmation dialog with branded modal. [#33637](https://github.com/khulnasoft/khulnasoft/pull/33637)
- Code Insights: Series data is now sorted by semantic version then alphabetically.
- Code Insights: Added locked insights overlays for frozen insights while in limited access mode. Restricted insight editing save change button for frozen insights. [#33062](https://github.com/khulnasoft/khulnasoft/pull/33062)
- Code Insights: A global dashboard will now be automatically created while in limited access mode to provide consistent visibility for unlocked insights. This dashboard cannot be deleted or modified while in limited access mode. [#32992](https://github.com/khulnasoft/khulnasoft/pull/32992)
- Update "getting started checklist for visitors" to a new design [TODO:]
- Update "getting started/quick start checklist for visitors" to a new design [#32882](https://github.com/khulnasoft/khulnasoft/pull/32882)
- Code Insights: Capture group values are now restricted to 100 characters. [#32828](https://github.com/khulnasoft/khulnasoft/pull/32828)
- Repositories for which gitserver's janitor job "sg maintenance" fails will eventually be re-cloned if "DisableAutoGitUpdates" is set to false (default) in site configuration. [#33432](https://github.com/khulnasoft/khulnasoft/pull/33432)
- The Code Insights database is now based on Postgres 12, removing the dependency on TimescaleDB. [#32697](https://github.com/khulnasoft/khulnasoft/pull/32697)
...
- Fail to log extension activation event will no longer block extension from activating [#33300][https://github.com/khulnasoft/khulnasoft/pull/33300]
- Fixed out-ouf-memory events for gitserver's janitor job "sg maintenance". [#33353](https://github.com/khulnasoft/khulnasoft/issues/33353)
- Setting the publication state for changesets when previewing a batch spec now works correctly if all changesets are selected and there is more than one page of changesets. [#33619](https://github.com/khulnasoft/khulnasoft/issues/33619)
...
- An issue introduced in 3.38 that caused alerts to not be delivered [#33398](https://github.com/khulnasoft/khulnasoft/pull/33398)
...
- Timestamps in the history panel can now be formatted as absolute timestamps by using user setting `history.preferAbsoluteTimestamps` [#31837](https://github.com/khulnasoft/khulnasoft/pull/31837)
...
- Searching for the pattern `//` with regular expression search is now interpreted literally and will search for `//`. Previously, the `//` pattern was interpreted as our regular expression syntax `/<regexp>/` which would in turn be intrpreted as the empty string. Since searching for an empty string offers little practically utility, we now instead interpret `//` to search for its literal meaning in regular expression search. [#31520](https://github.com/khulnasoft/khulnasoft/pull/31520)
- Timestamps in the webapp will now display local time on hover instead of UTC time [#31672](https://github.com/khulnasoft/khulnasoft/pull/31672)
- Updated Postgres version from 12.6 to 12.7 [#31933](https://github.com/khulnasoft/khulnasoft/pull/31933)
- Code Insights will now periodically clean up data series that are not in use. There is a 1 hour grace period where the series can be reattached to a view, after which all of the time series data and metadata will be deleted. [#32094](https://github.com/khulnasoft/khulnasoft/pull/32094)
- Code Insights critical telemetry total count now only includes insights that are not frozen (limited by trial mode restrictions). [#32529](https://github.com/khulnasoft/khulnasoft/pull/32529)
...
- Viewing or previewing a batch change is now more resilient when transient network or server errors occur. [#29859](https://github.com/khulnasoft/khulnasoft/issues/29859)
- Search: `select:file` and `select:file.directory` now properly deduplicates results. [#32469](https://github.com/khulnasoft/khulnasoft/pull/32469)
- Security: Patch container images against CVE 2022-0778 [#32679](https://github.com/khulnasoft/khulnasoft/issues/32679)
- When closing a batch change, draft changesets that will be closed are now also shown. [#32481](https://github.com/khulnasoft/khulnasoft/pull/32481)

### Removed

- The deprecated GraphQL field `SearchResults.resultCount` has been removed in favor of its replacement, `matchCount`. [#31573](https://github.com/khulnasoft/khulnasoft/pull/31573)
- The deprecated site-config field `UseJaeger` has been removed. Use `"observability.tracing": { "sampling": "all" }` instead [#31294](https://github.com/khulnasoft/khulnasoft/pull/31294/commits/6793220d6cf1200535a2610d79d2dd9e18c67dca)
...
- Links generated by editor endpoint will render image preview correctly. [#30767](https://github.com/khulnasoft/khulnasoft/pull/30767)
- Fixed a race condition in the precise code intel upload expirer process that prematurely expired new uploads. [#30546](https://github.com/khulnasoft/khulnasoft/pull/30546)
- Pushing changesets from Batch Changes to code hosts with self-signed TLS certificates has been fixed. [#31010](https://github.com/khulnasoft/khulnasoft/issues/31010)
- Fixed LSIF uploads not being expired according to retention policies when the repository contained tags and branches with the same name but pointing to different commits. [#31108](https://github.com/khulnasoft/khulnasoft/pull/31108)
- Service discovery for the symbols service can transition from no endpoints to endpoints. Previously we always returned an error after the first empty state. [#31225](https://github.com/khulnasoft/khulnasoft/pull/31225)
- Fixed performance issue in LSIF upload processing, reducing the latency between uploading an LSIF index and accessing precise code intel in the UI. ([#30978](https://github.com/khulnasoft/khulnasoft/pull/30978), [#31143](https://github.com/khulnasoft/khulnasoft/pull/31143))
- Fixed symbols not appearing when no files changed between commits. [#31295](https://github.com/khulnasoft/khulnasoft/pull/31295)
- Fixed symbols not appearing when too many files changed between commits. [#31110](https://github.com/khulnasoft/khulnasoft/pull/31110)
- Fixed runaway disk usage in the `symbols` service. [#30647](https://github.com/khulnasoft/khulnasoft/pull/30647)

### Removed

- Removed `experimentalFeature.showCodeMonitoringTestEmailButton`. Test emails can still be sent by editing the code monitor and expanding the "Send email notification" section. [#29953](https://github.com/khulnasoft/khulnasoft/pull/29953)

## 3.36.3

### Fixed

- Fix Code Monitor permissions. For more detail see our [security advisory](https://github.com/khulnasoft/khulnasoft/security/advisories/GHSA-xqv2-x6f2-w3pf) [#30547](https://github.com/khulnasoft/khulnasoft/pull/30547)
...
- Fix broken 'src lsif upload' inside executor due to basic auth removal. [#30023](https://github.com/khulnasoft/khulnasoft/pull/30023)
...
- Search notebooks are now fully persistable. You can create notebooks through the WYSIWYG editor and share them via a unique URL. We support two visibility modes: private (only the creator can view the notebook) and public (everyone can view the notebook). This feature is _beta_ and may change in the following releases. [#27384](https://github.com/khulnasoft/khulnasoft/issues/27384)
- Code Insights that are run over all repositories now have data points with links that lead to the search page. [#29587](https://github.com/khulnasoft/khulnasoft/pull/29587)
- Code Insights creation UI query field now supports different syntax highlight modes based on `patterntype` filter. [#29733](https://github.com/khulnasoft/khulnasoft/pull/29733)
- Code Insights creation UI query field now has live-preview button that leads to the search page with predefined query value. [#29698](https://github.com/khulnasoft/khulnasoft/pull/29698)
- Code Insights creation UI detect and track patterns can now search across all repositories. [#29906](https://github.com/khulnasoft/khulnasoft/pull/29906)
- Pings now contain aggregated CTA metrics. [#29966](https://github.com/khulnasoft/khulnasoft/pull/29966)
- Pings now contain aggregated CTA metrics. [#29966](https://github.com/khulnasoft/khulnasoft/pull/29966) and [#31389](https://github.com/khulnasoft/khulnasoft/pull/31389)

### Changed

- Sourcegraph's API (streaming search, GraphQL, etc.) may now be used from any domain when using an access token for authentication, or with no authentication in the case of Sourcegraph.com. [#28775](https://github.com/khulnasoft/khulnasoft/pull/28775)
...
- Search results within the same file are now ordered by relevance instead of line number. To order by line number, update the setting `experimentalFeatures.clientSearchResultRanking: "by-line-number"`. [#29046](https://github.com/khulnasoft/khulnasoft/pull/29046)
- Bumped the symbols processing timeout from 20 minutes to 2 hours and made it configurable. [#29891](https://github.com/khulnasoft/khulnasoft/pull/29891)
...
- Skipped migrations caused existing Code Insights to not appear. [#29395](https://github.com/khulnasoft/khulnasoft/pull/29395)
- Enterprise-only out-of-band migrations failed to execute due to missing enterprise configuration flag. [#29426](https://github.com/khulnasoft/khulnasoft/pull/29426)
...
- Minio service upgraded to RELEASE.2021-12-10T23-03-39Z. [#29188](https://github.com/khulnasoft/khulnasoft/pull/29188)
- Code insights creation UI form query field now supports suggestions and syntax highlighting. [#28130](https://github.com/khulnasoft/khulnasoft/pull/28130)
- Using `select:repo` in search queries will now stream results incrementally, greatly improving speed and reducing time-to-first-result. [#28920](https://github.com/khulnasoft/khulnasoft/pull/28920)
- The fuzzy file finder is now enabled by default and can be activated with the shortcut `Cmd+K` on macOS and `Ctrl+K` on Linux/Windows. Change the user setting `experimentalFeatures.fuzzyFinder` to `false` to disable this feature. [#29010](https://github.com/khulnasoft/khulnasoft/pull/29010)
- Search-based code intelligence and the symbol sidebar are much faster now that the symbols service incrementally processes files that changed. [#27932](https://github.com/khulnasoft/khulnasoft/pull/27932)

### Fixed

- Moving a changeset from draft state into published state was broken on GitLab code hosts. [#28239](https://github.com/khulnasoft/khulnasoft/pull/28239)
- The shortcuts for toggling the History Panel and Line Wrap were not working on Mac. [#28574](https://github.com/khulnasoft/khulnasoft/pull/28574)
- Suppresses docker-on-mac warning for Kubernetes, Docker Compose, and Pure Docker deployments. [#28405](https://github.com/khulnasoft/khulnasoft/pull/28821)
- Fixed an issue where certain regexp syntax for repository searches caused the entire search, including non-repository searches, to fail with a parse error (issue affects only version 3.34). [#28826](https://github.com/khulnasoft/khulnasoft/pull/28826)
- Modifying changesets on Bitbucket Server could previously fail if the local copy in Batch Changes was out of date. That has been fixed by retrying the operations in case of a 409 response. [#29100](https://github.com/khulnasoft/khulnasoft/pull/29100)
...
- A bug introduced in 3.34 and 3.34.1 that resulted in certain repositories being missed in search results. [#28624](https://github.com/khulnasoft/khulnasoft/pull/28624)

## 3.34.1

### Fixed

- Fixed Redis alerting for docker-compose deployments [#28099](https://github.com/khulnasoft/khulnasoft/issues/28099)
...
- Batch Changes now requests the `workflow` scope on GitHub personal access tokens to allow batch changes to write to the `.github` directory in repositories. If you have already configured a GitHub PAT for use with Batch Changes, we suggest adding the scope to the others already granted. [#26606](https://github.com/khulnasoft/khulnasoft/issues/26606)
- Sourcegraph's Prometheus and Alertmanager dependency has been upgraded to v2.31.1 and v0.23.0 respectively. [#27336](https://github.com/khulnasoft/khulnasoft/pull/27336)
- The search UI's repositories count as well as the GraphQL API's `search().repositories` and `search().repositoriesCount` have changed semantics from the set of searchable repositories to the set of repositories with matches. In a future release, we'll introduce separate fields for the set of searchable repositories backed by a [scalable implementation](https://github.com/khulnasoft/khulnasoft/issues/27274). [#26995](https://github.com/khulnasoft/khulnasoft/issues/26995)
...
- An issue that causes the server to panic when performing a structural search via the GQL API for a query that also
  ...
  . [#26630](https://github.com/khulnasoft/khulnasoft/pull/26630)
...
- Fixed: backported saved search and code monitor notification fixes from 3.34.0 [#28019](https://github.com/khulnasoft/khulnasoft/pull/28019)
...
- More rules have been added to the search query validation so that user get faster feedback on issues with their query. [#24747](https://github.com/khulnasoft/khulnasoft/pull/24747)
...
- For short search queries containing no filters but the name of a supported programming language we are now suggesting to run the query with a language filter. [#25792](https://github.com/khulnasoft/khulnasoft/pull/25792)
- The API scope used by GitLab OAuth can now optionally be configured in the provider. [#26152](https://github.com/khulnasoft/khulnasoft/pull/26152)
- Added Apex language support for syntax highlighting and search-based code intelligence. [#25268](https://github.com/khulnasoft/khulnasoft/pull/25268)
...
- A search regression in 3.32.0 which caused instances with search indexing _disabled_ (very rare) via `"search.index.enabled": false,` in their site config to crash with a panic. [#25321](https://github.com/khulnasoft/khulnasoft/pull/25321)
- An issue where the default `search.index.enabled` value on single-container Docker instances would incorrectly be computed as `false` in some situations. [#25321](https://github.com/khulnasoft/khulnasoft/pull/25321)
- StatefulSet service discovery in Kubernetes correctly constructs pod hostnames in the case where the ServiceName is different from the StatefulSet name. [#25146](https://github.com/khulnasoft/khulnasoft/pull/25146)
- An issue where clicking on a link in the 'Revisions' search sidebar section would result in an invalid query if the query didn't already contain a 'repo:' filter. [#25076](https://github.com/khulnasoft/khulnasoft/pull/25076)
- An issue where links to jump to Bitbucket Cloud wouldn't render in the UI. [#25533](https://github.com/khulnasoft/khulnasoft/pull/25533)
- Fixed some code insights pings being aggregated on `anonymous_user_id` instead of `user_id`. [#25926](https://github.com/khulnasoft/khulnasoft/pull/25926)
- Code insights running over all repositories using a commit search (`type:commit` or `type:diff`) would fail to deserialize and produce no results. [#25928](https://github.com/khulnasoft/khulnasoft/pull/25928)
- Fixed an issue where code insights queries could produce a panic on queued records that did not include a `record_time` [#25929](https://github.com/khulnasoft/khulnasoft/pull/25929)
- Fixed an issue where Batch Change changeset diffs would sometimes render incorrectly when previewed from the UI if they contained deleted empty lines. [#25866](https://github.com/khulnasoft/khulnasoft/pull/25866)
- An issue where `repo:contains.commit.after()` would fail on some malformed git repositories. [#25974](https://github.com/khulnasoft/khulnasoft/issues/25974)
- Fixed primary email bug where users with no primary email set would break the email setting page when trying to add a new email. [#25008](https://github.com/khulnasoft/khulnasoft/pull/25008)
- An issue where keywords like `and`, `or`, `not` would not be highlighted properly in the search bar due to the presence of quotes. [#26135](https://github.com/khulnasoft/khulnasoft/pull/26135)
- An issue where frequent search indexing operations led to incoming search queries timing out. When these timeouts happened in quick succession, `zoekt-webserver` processes would shut themselves down via their `watchdog` routine. This should now only happen when a given `zoekt-webserver` is under-provisioned on CPUs. [#25872](https://github.com/khulnasoft/khulnasoft/issues/25872)
- Since 3.28.0, Batch Changes webhooks would not update changesets opened in private repositories. This has been fixed. [#26380](https://github.com/khulnasoft/khulnasoft/issues/26380)
- Reconciling batch changes could stall when updating the state of a changeset that already existed. This has been fixed. [#26386](https://github.com/khulnasoft/khulnasoft/issues/26386)
...
- Fixed a number of issues where repository permissions sync may fail for instances with very large numbers of repositories. [#24852](https://github.com/khulnasoft/khulnasoft/pull/24852), [#24972](https://github.com/khulnasoft/khulnasoft/pull/24972)
- Fixed excessive re-rendering of the whole web application on every keypress in the search query input. [#24844](https://github.com/khulnasoft/khulnasoft/pull/24844)
- Code Insights line chart now supports different timelines for each data series (lines). [#25005](https://github.com/khulnasoft/khulnasoft/pull/25005)
- Postgres exporter now exposes pg_stat_activity account to show the number of active DB connections. [#25086](https://github.com/khulnasoft/khulnasoft/pull/25086)

### Removed

- The `PRECISE_CODE_INTEL_DATA_TTL` environment variable is no longer read by the worker service. Instead, global and repository-specific data retention policies configurable in the UI by site-admins will control the length of time LSIF uploads are considered _fresh_. [#24793](https://github.com/khulnasoft/khulnasoft/pull/24793)
- The `repo.cloned` column was removed as it was deprecated in 3.26. [#25066](https://github.com/khulnasoft/khulnasoft/pull/25066)

## 3.31.2

### Fixed

- Fixed multiple CVEs for [libssl](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-3711) and [Python3](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-29921). [#24700](https://github.com/khulnasoft/khulnasoft/pull/24700) [#24620](https://github.com/khulnasoft/khulnasoft/pull/24620) [#24695](https://github.com/khulnasoft/khulnasoft/pull/24695)

## 3.31.1

### Added

- The required authentication scopes required to enable caching behaviour for GitHub repository permissions can now be requested via `allowGroupsPermissionsSync` in GitHub `auth.providers`. [#24328](https://github.com/khulnasoft/khulnasoft/pull/24328)

### Changed

- Caching behaviour for GitHub repository permissions enabled via the `authorization.groupsCacheTTL` field in the code host config can now leverage additional caching of team and organization permissions for repository permissions syncing (on top of the caching for user permissions syncing introduced in 3.31). [#24328](https://github.com/khulnasoft/khulnasoft/pull/24328)

## 3.31.0

### Added

- Backend Code Insights GraphQL queries now support arguments `includeRepoRegex` and `excludeRepoRegex` to filter on repository names. [#23256](https://github.com/khulnasoft/khulnasoft/pull/23256)
- Code Insights background queries now process in a priority order backwards through time. This will allow insights to populate concurrently. [#23101](https://github.com/khulnasoft/khulnasoft/pull/23101)
- Operator documentation has been added to the Search Reference sidebar section. [#23116](https://github.com/khulnasoft/khulnasoft/pull/23116)
- Syntax highlighting support for the [Cue](https://cuelang.org) language.
- Reintroduced a revised version of the Search Types sidebar section. [#23170](https://github.com/khulnasoft/khulnasoft/pull/23170)
- Improved usability where filters followed by a space in the search query will warn users that the filter value is empty. [#23646](https://github.com/khulnasoft/khulnasoft/pull/23646)
- Perforce: [`git p4`'s `--use-client-spec` option](https://git-scm.com/docs/git-p4#Documentation/git-p4.txt---use-client-spec) can now be enabled by configuring the `p4.client` field. [#23833](https://github.com/khulnasoft/khulnasoft/pull/23833), [#23845](https://github.com/khulnasoft/khulnasoft/pull/23845)
...
- Code Insights will now always backfill from the time the data series was created. [#23430](https://github.com/khulnasoft/khulnasoft/pull/23430)
- Code Insights queries will now extract repository name out of the GraphQL response instead of going to the database. [#23388](https://github.com/khulnasoft/khulnasoft/pull/23388)
- Code Insights backend has moved from the `repo-updater` service to the `worker` service. [#23050](https://github.com/khulnasoft/khulnasoft/pull/23050)
- Code Insights feature flag `DISABLE_CODE_INSIGHTS` environment variable has moved from the `repo-updater` service to the `worker` service. Any users of this flag will need to update their `worker` service configuration to continue using it. [#23050](https://github.com/khulnasoft/khulnasoft/pull/23050)
- Updated Docker-Compose Caddy Image to v2.0.0-alpine. [#468](https://github.com/sourcegraph/deploy-sourcegraph-docker/pull/468)
- Code Insights historical samples will record using the timestamp of the commit that was searched. [#23520](https://github.com/khulnasoft/khulnasoft/pull/23520)
- Authorization checks are now handled using role based permissions instead of manually altering SQL statements. [23398](https://github.com/khulnasoft/khulnasoft/pull/23398)
...
- Code Insights historical samples will record using the most recent commit to the start of the frame instead of the middle of the frame. [#23573](https://github.com/khulnasoft/khulnasoft/pull/23573)
- The copy icon displayed next to files and repositories will now copy the file or repository path. Previously, this action copied the URL to clipboard. [#23390](https://github.com/khulnasoft/khulnasoft/pull/23390)
- Sourcegraph's Prometheus dependency has been upgraded to v2.28.1. [23663](https://github.com/khulnasoft/khulnasoft/pull/23663)
- Sourcegraph's Alertmanager dependency has been upgraded to v0.22.2. [23663](https://github.com/khulnasoft/khulnasoft/pull/23714)
...
- Code Insights will attempt to sync insight definitions from settings to the database once every 10 minutes. [23805](https://github.com/khulnasoft/khulnasoft/pull/23805)
- Code Insights exposes information about queries that are flagged `dirty` through the `insights` GraphQL query. [#23857](https://github.com/khulnasoft/khulnasoft/pull/23857/)
- Code Insights GraphQL query `insights` will now fetch 12 months of data instead of 6 if a specific time range is not provided. [#23786](https://github.com/khulnasoft/khulnasoft/pull/23786)
- Code Insights will now generate 12 months of historical data during a backfill instead of 6. [#23860](https://github.com/khulnasoft/khulnasoft/pull/23860)
...
- The search reference will now show matching entries when using the filter input. [#23224](https://github.com/khulnasoft/khulnasoft/pull/23224)
...
- All commit search results for `and`-expressions are now highlighted. [#23336](https://github.com/khulnasoft/khulnasoft/pull/23336)
- Email notifiers in `observability.alerts` now correctly respect the `email.smtp.noVerifyTLS` site configuration field. [#23636](https://github.com/khulnasoft/khulnasoft/issues/23636)
- Alertmanager (Prometheus) now respects `SMTPServerConfig.noVerifyTLS` field. [#23636](https://github.com/khulnasoft/khulnasoft/issues/23636)
- Clicking on symbols in the left search pane now renders hover tooltips for indexed repositories. [#23664](https://github.com/khulnasoft/khulnasoft/pull/23664)
- Fixed a result streaming throttling issue that was causing significantly increased latency for some searches. [#23736](https://github.com/khulnasoft/khulnasoft/pull/23736)
- GitCredentials passwords stored in AWS CodeCommit configuration is now redacted. [#23832](https://github.com/khulnasoft/khulnasoft/pull/23832)
- Patched a vulnerability in `apk-tools`. [#23917](https://github.com/khulnasoft/khulnasoft/pull/23917)
- Line content was being duplicated in unindexed search payloads, causing memory instability for some dense search queries. [#23918](https://github.com/khulnasoft/khulnasoft/pull/23918)
- Updating draft merge requests on GitLab from batch changes no longer removes the draft status. [#23944](https://github.com/khulnasoft/khulnasoft/issues/23944)
- Report highlight matches instead of line matches in search results. [#21443](https://github.com/khulnasoft/khulnasoft/issues/21443)
...
- The old batch repository syncer was removed and can no longer be activated by setting `ENABLE_STREAMING_REPOS_SYNCER=false`. [#22949](https://github.com/khulnasoft/khulnasoft/pull/22949)
- Email notifications for saved searches are now deprecated in favor of Code Monitoring. Email notifications can no longer be enabled for saved searches. Saved searches that already have notifications enabled will continue to work, but there is now a button users can click to migrate to code monitors. Notifications for saved searches will be removed entirely in the future. [#23275](https://github.com/khulnasoft/khulnasoft/pull/23275)
- The `sg_service` Postgres role and `sg_repo_access_policy` policy on the `repo` table have been removed due to performance concerns. [#23622](https://github.com/khulnasoft/khulnasoft/pull/23622)
- Deprecated site configuration field `email.smtp.disableTLS` has been removed. [#23639](https://github.com/khulnasoft/khulnasoft/pull/23639)
...
- The experimental `codeInsightsAllRepos` feature flag has been removed. [#23850](https://github.com/khulnasoft/khulnasoft/pull/23850)

## 3.30.4

### Added

- Add a new environment variable `SRC_HTTP_CLI_EXTERNAL_TIMEOUT` to control the timeout for all external HTTP requests. [#23620](https://github.com/khulnasoft/khulnasoft/pull/23620)
...
- Codeintel-db database images have been reverted back to debian due to corruption caused by glibc and alpine. [23324](https://github.com/khulnasoft/khulnasoft/pull/23324)
...
- Postgres database images have been reverted back to debian due to corruption caused by glibc and alpine. [23302](https://github.com/khulnasoft/khulnasoft/pull/23302)
...
- An issue where the UI would occasionally display `lsifStore.Ranges: ERROR: relation \"lsif_documentation_mappings\" does not exist (SQLSTATE 42P01)` [#23115](https://github.com/khulnasoft/khulnasoft/pull/23115)
- Fixed a vulnerability in our Postgres Alpine image related to libgcrypt [#23174](https://github.com/khulnasoft/khulnasoft/pull/23174)
- When syncing in streaming mode, repo-updater will now ensure a repo's transaction is committed before notifying gitserver to update that repo. [#23169](https://github.com/khulnasoft/khulnasoft/pull/23169)
- When encountering spurious errors during streaming syncing (like temporary 500s from codehosts), repo-updater will no longer delete all associated repos that weren't seen. Deletion will happen only if there were no errors or if the error was one of "Unauthorized", "Forbidden" or "Account Suspended". [#23171](https://github.com/khulnasoft/khulnasoft/pull/23171)
- External HTTP requests are now automatically retried when appropriate. [#23131](https://github.com/khulnasoft/khulnasoft/pull/23131)
...
- Added support for `select:file.directory` in search queries, which returns unique directory paths for results that satisfy the query. [#22449](https://github.com/khulnasoft/khulnasoft/pull/22449)
- An `sg_service` Postgres role has been introduced, as well as an `sg_repo_access_policy` policy on the `repo` table that restricts access to that role. The role that owns the `repo` table will continue to get unrestricted access. [#22303](https://github.com/khulnasoft/khulnasoft/pull/22303)
- Every service that connects to the database (i.e. Postgres) now has a "Database connections" monitoring section in its Grafana dashboard. [#22570](https://github.com/khulnasoft/khulnasoft/pull/22570)
- A new bulk operation to close many changesets at once has been added to Batch Changes. [#22547](https://github.com/khulnasoft/khulnasoft/pull/22547)
- Backend Code Insights will aggregate viewable repositories based on the authenticated user. [#22471](https://github.com/khulnasoft/khulnasoft/pull/22471)
...
- Backend Code Insights only fills historical data frames that have changed to reduce the number of searches required. [#22298](https://github.com/khulnasoft/khulnasoft/pull/22298)
- Backend Code Insights displays data points for a fixed 6 months period in 2 week intervals, and will carry observations forward that are missing. [#22298](https://github.com/khulnasoft/khulnasoft/pull/22298)
- Backend Code Insights now aggregate over 26 weeks instead of 6 months. [#22527](https://github.com/khulnasoft/khulnasoft/pull/22527)
- Search queries now disallow specifying `rev:` without `repo:`. Note that to search across potentially multiple revisions, a query like `repo:.* rev:<revision>` remains valid. [#22705](https://github.com/khulnasoft/khulnasoft/pull/22705)
- The extensions status bar on diff pages has been redesigned and now shows information for both the base and head commits. [#22123](https://github.com/khulnasoft/khulnasoft/pull/22123/files)
- The `applyBatchChange` and `createBatchChange` mutations now accept an optional `publicationStates` argument to set the publication state of specific changesets within the batch change. [#22485](https://github.com/khulnasoft/khulnasoft/pull/22485) and [#22854](https://github.com/khulnasoft/khulnasoft/pull/22854)
- Search queries now return up to 80 suggested filters. Previously we returned up to 24. [#22863](https://github.com/khulnasoft/khulnasoft/pull/22863)
- GitHub code host connections can now include `repositoryQuery` entries that match more than 1000 repositories from the GitHub search API without requiring the previously documented work-around of splitting the query up with `created:` qualifiers, which is now done automatically. [#2562](https://github.com/khulnasoft/khulnasoft/issues/2562)
...
- An issue where using `select:repo` in conjunction with `and` patterns did not yield expected repo results. [#22743](https://github.com/khulnasoft/khulnasoft/pull/22743)
- The `isLocked` and `isDisabled` fields of GitHub repositories are now fetched correctly from the GraphQL API of GitHub Enterprise instances. Users that rely on the `repos` config in GitHub code host connections should update so that locked and disabled repositories defined in that list are actually skipped. [#22788](https://github.com/khulnasoft/khulnasoft/pull/22788)
- Homepage no longer fails to load if there are invalid entries in user's search history. [#22857](https://github.com/khulnasoft/khulnasoft/pull/22857)
- An issue where regexp query highlighting in the search bar would render incorrectly on Firefox. [#23043](https://github.com/khulnasoft/khulnasoft/pull/23043)
- Code intelligence uploads and indexes are restricted to only site-admins. It was read-only for any user. [#22890](https://github.com/khulnasoft/khulnasoft/pull/22890)
- Daily usage statistics are restricted to only site-admins. It was read-only for any user. [#23026](https://github.com/khulnasoft/khulnasoft/pull/23026)
...
- The experimental paginated search feature (the `stable:` keyword) has been removed, to be replaced with streaming search. [#22428](https://github.com/khulnasoft/khulnasoft/pull/22428)
- The experimental extensions view page has been removed. [#22565](https://github.com/khulnasoft/khulnasoft/pull/22565)
- A search query diagnostic that previously warned the user when quotes are interpreted literally has been removed. The literal meaning has been Sourcegraph's default search behavior for some time now. [#22892](https://github.com/khulnasoft/khulnasoft/pull/22892)
...
- Code Insights queries can now run concurrently up to a limit set by the `insights.query.worker.concurrency` site config. [#21219](https://github.com/khulnasoft/khulnasoft/pull/21219)
- Code Insights workers now support a rate limit for query execution and historical data frame analysis using the `insights.query.worker.rateLimit` and `insights.historical.worker.rateLimit` site configurations. [#21533](https://github.com/khulnasoft/khulnasoft/pull/21533)
- The GraphQL `Site` `SettingsSubject` type now has an `allowSiteSettingsEdits` field to allow clients to determine whether the instance uses the `GLOBAL_SETTINGS_FILE` environment variable. [#21827](https://github.com/khulnasoft/khulnasoft/pull/21827)
- The Code Insights creation UI now remembers previously filled-in field values when returning to the form after having navigated away. [#21744](https://github.com/khulnasoft/khulnasoft/pull/21744)
...
- Pings include aggregated usage for the Code Insights creation UI, organization visible insight count per insight type, and insight step size in days. [#21671](https://github.com/khulnasoft/khulnasoft/pull/21671)
...
- Stricter validation of structural search queries. The `type:` parameter is not supported for structural searches and returns an appropriate alert. [#21487](https://github.com/khulnasoft/khulnasoft/pull/21487)
- Batch changeset specs that are not attached to changesets will no longer prematurely expire before the batch specs that they are associated with. [#21678](https://github.com/khulnasoft/khulnasoft/pull/21678)
- The Y-axis of Code Insights line charts no longer start at a negative value. [#22018](https://github.com/khulnasoft/khulnasoft/pull/22018)
- Correctly handle field aliases in the query (like `r:` versus `repo:`) when used with `contains` predicates. [#22105](https://github.com/khulnasoft/khulnasoft/pull/22105)
- Running a code insight over a timeframe when the repository didn't yet exist doesn't break the entire insight anymore. [#21288](https://github.com/khulnasoft/khulnasoft/pull/21288)

### Removed

- The deprecated GraphQL `icon` field on CommitSearchResult and Repository was removed. [#21310](https://github.com/khulnasoft/khulnasoft/pull/21310)
- The undocumented `index` filter was removed from search type-ahead suggestions. [#18806](https://github.com/khulnasoft/khulnasoft/issues/18806)
- Code host connection tokens aren't used for creating changesets anymore when the user is site admin and no credential has been specified. [#16814](https://github.com/khulnasoft/khulnasoft/issues/16814)

## 3.28.0

### Added

- Added `select:commit.diff.added` and `select:commit.diff.removed` for `type:diff` search queries. These selectors return commit diffs only if a pattern matches in `added` (respespectively, `removed`) lines. [#20328](https://github.com/khulnasoft/khulnasoft/pull/20328)
- Additional language autocompletions for the `lang:` filter in the search bar. [#20535](https://github.com/khulnasoft/khulnasoft/pull/20535)
- Steps in batch specs can now have an `if:` attribute to enable conditional execution of different steps. [#20701](https://github.com/khulnasoft/khulnasoft/pull/20701)
- Extensions can now log messages through `sourcegraph.app.log` to aid debugging user issues. [#20474](https://github.com/khulnasoft/khulnasoft/pull/20474)
- Bulk comments on many changesets are now available in Batch Changes. [#20361](https://github.com/khulnasoft/khulnasoft/pull/20361)
- Batch specs are now viewable when previewing changesets. [#19534](https://github.com/khulnasoft/khulnasoft/issues/19534)
- Added a new UI for creating code insights. [#20212](https://github.com/khulnasoft/khulnasoft/issues/20212)
...
- Repository permissions can now be enabled for site admins via the `authz.enforceForSiteAdmins` setting. [#20674](https://github.com/khulnasoft/khulnasoft/pull/20674)
- Site admins can no longer view user added code host configuration. [#20851](https://github.com/khulnasoft/khulnasoft/pull/20851)
- Site admins cannot add access tokens for any user by default. [#20988](https://github.com/khulnasoft/khulnasoft/pull/20988)
...
- The extension registry main page has a new visual design that better conveys the most useful information about extensions, and individual extension pages have better information architecture. [#20822](https://github.com/khulnasoft/khulnasoft/pull/20822)

### Fixed

- Search returned inconsistent result counts when a `count:` limit was not specified.
- Indexed search failed when the `master` branch needed indexing but was not the default. [#20260](https://github.com/khulnasoft/khulnasoft/pull/20260)
- `repo:contains(...)` built-in did not respect parameters that affect repo filtering (e.g., `repogroup`, `fork`). It now respects these. [#20339](https://github.com/khulnasoft/khulnasoft/pull/20339)
- An issue where duplicate results would render for certain `or`-expressions. [#20480](https://github.com/khulnasoft/khulnasoft/pull/20480)
- Issue where the search query bar suggests that some `lang` values are not valid. [#20534](https://github.com/khulnasoft/khulnasoft/pull/20534)
- Pull request event webhooks received from GitHub with unexpected actions no longer cause panics. [#20571](https://github.com/khulnasoft/khulnasoft/pull/20571)
- Repository search patterns like `^repo/(prefix-suffix|prefix)$` now correctly match both `repo/prefix-suffix` and `repo/prefix`. [#20389](https://github.com/khulnasoft/khulnasoft/issues/20389)
...
- Minor query syntax highlighting bug for `repo:contains` predicate. [#21038](https://github.com/khulnasoft/khulnasoft/pull/21038)
- An issue causing diff and commit results with file filters to return invalid results. [#21039](https://github.com/khulnasoft/khulnasoft/pull/21039)
...
- An issue causing diff views to display without syntax highlighting [#21160](https://github.com/khulnasoft/khulnasoft/pull/21160)

### Removed

- The deprecated `SetRepositoryEnabled` mutation was removed. [#21044](https://github.com/khulnasoft/khulnasoft/pull/21044)

## 3.27.5

### Fixed

- Fix scp style VCS url parsing. [#20799](https://github.com/khulnasoft/khulnasoft/pull/20799)

## 3.27.4

### Fixed

- Fixed an issue related to Gitolite repos with `@` being prepended with a `?`. [#20297](https://github.com/khulnasoft/khulnasoft/pull/20297)
- Add missing return from handler when DisableAutoGitUpdates is true. [#20451](https://github.com/khulnasoft/khulnasoft/pull/20451)

## 3.27.3

### Fixed

- Pushing batch changes to Bitbucket Server code hosts over SSH was broken in 3.27.0, and has been fixed. [#20324](https://github.com/khulnasoft/khulnasoft/issues/20324)
...
- Indexed search failed when the `master` branch needed indexing but was not the default. [#20260](https://github.com/khulnasoft/khulnasoft/pull/20260)
- Fixed a regression that caused "other" code hosts urls to not be built correctly which prevents code to be cloned / updated in 3.27.0. This change will provoke some cloning errors on repositories that are already sync'ed, until the next code host sync. [#20258](https://github.com/khulnasoft/khulnasoft/pull/20258)

## 3.27.0

### Added

- `count:` now supports "all" as value. Queries with `count:all` will return up to 999999 results. [#19756](https://github.com/khulnasoft/khulnasoft/pull/19756)
- Credentials for Batch Changes are now validated when adding them. [#19602](https://github.com/khulnasoft/khulnasoft/pull/19602)
- Batch Changes now ignore repositories that contain a `.batchignore` file. [#19877](https://github.com/khulnasoft/khulnasoft/pull/19877) and [src-cli#509](https://github.com/sourcegraph/src-cli/pull/509)
...
- A regression caused by search onboarding tour logic to never focus input in the search bar on the homepage. Input now focuses on the homepage if the search tour isn't in effect. [#19678](https://github.com/khulnasoft/khulnasoft/pull/19678)
- New changes of a Perforce depot will now be reflected in `master` branch after the initial clone. [#19718](https://github.com/khulnasoft/khulnasoft/pull/19718)
- Gitolite and Other type code host connection configuration can be correctly displayed. [#19976](https://github.com/khulnasoft/khulnasoft/pull/19976)
- Fixed a regression that caused user and code host limits to be ignored. [#20089](https://github.com/khulnasoft/khulnasoft/pull/20089)
- A regression where incorrect query highlighting happens for certain quoted values. [#20110](https://github.com/khulnasoft/khulnasoft/pull/20110)
- We now respect the `disableAutoGitUpdates` setting when cloning or fetching repos on demand and during cleanup tasks that may re-clone old repos. [#20194](https://github.com/khulnasoft/khulnasoft/pull/20194)

## 3.26.3

### Fixed

- Setting `gitMaxCodehostRequestsPerSecond` to `0` now actually blocks all Git operations happening on the gitserver. [#19716](https://github.com/khulnasoft/khulnasoft/pull/19716)

## 3.26.2

### Fixed

- Our indexed search logic now correctly handles de-duplication of search results across multiple replicas. [#19743](https://github.com/khulnasoft/khulnasoft/pull/19743)
...
- Commit search returning duplicate commits. [#19460](https://github.com/khulnasoft/khulnasoft/pull/19460)
- Clicking the Code Monitoring tab tries to take users to a non-existent repo. [#19525](https://github.com/khulnasoft/khulnasoft/pull/19525)
- Diff and commit search not highlighting search terms correctly for some files. [#19543](https://github.com/khulnasoft/khulnasoft/pull/19543), [#19639](https://github.com/khulnasoft/khulnasoft/pull/19639)
- File actions weren't appearing on large window sizes in Firefox and Safari. [#19380](https://github.com/khulnasoft/khulnasoft/pull/19380)
...
- Opsgenie API keys can now be added via an environment variable. [#18662](https://github.com/khulnasoft/khulnasoft/pull/18662)
- It's now possible to control where code insights are displayed through the boolean settings `insights.displayLocation.homepage`, `insights.displayLocation.insightsPage` and `insights.displayLocation.directory`. [#18979](https://github.com/khulnasoft/khulnasoft/pull/18979)
- Users can now create changesets in batch changes on repositories that are cloned using SSH. [#16888](https://github.com/khulnasoft/khulnasoft/issues/16888)
- Syntax highlighting for Elixir, Elm, REG, Julia, Move, Nix, Puppet, VimL, Coq. [#19282](https://github.com/khulnasoft/khulnasoft/pull/19282)
...
- Pings now contain added, aggregated campaigns usage data: aggregate counts of unique monthly users and Weekly campaign and changesets counts for campaign cohorts created in the last 12 months. [#18604](https://github.com/khulnasoft/khulnasoft/pull/18604)

### Fixed

- Auto complete suggestions for repositories and files containing spaces will now be automatically escaped when accepting the suggestion. [#18635](https://github.com/khulnasoft/khulnasoft/issues/18635)
- An issue causing repository results containing spaces to not be clickable in some cases. [#18668](https://github.com/khulnasoft/khulnasoft/pull/18668)
- Closing a batch change now correctly closes the entailed changesets, when requested by the user. [#18957](https://github.com/khulnasoft/khulnasoft/pull/18957)
- TypesScript highlighting bug. [#15930](https://github.com/khulnasoft/khulnasoft/issues/15930)
- The number of shards is now reported accurately in Site Admin > Repository Status > Settings > Indexing. [#19265](https://github.com/khulnasoft/khulnasoft/pull/19265)
...
- A security vulnerability with in the authentication workflow has been fixed. [#18686](https://github.com/khulnasoft/khulnasoft/pull/18686)
...
- New site config option `"log": { "sentry": { "backendDSN": "<REDACTED>" } }` to use a separate Sentry project for backend errors. [#17363](https://github.com/khulnasoft/khulnasoft/pull/17363)
- Structural search now supports searching indexed branches other than default. [#17726](https://github.com/khulnasoft/khulnasoft/pull/17726)
- Structural search now supports searching unindexed revisions. [#17967](https://github.com/khulnasoft/khulnasoft/pull/17967)
- New site config option `"allowSignup"` for SAML authentication to determine if automatically create new users is allowed. [#17989](https://github.com/khulnasoft/khulnasoft/pull/17989)
...
- Fixes an issue that prevented the hard deletion of a user if they had saved searches. [#17461](https://github.com/khulnasoft/khulnasoft/pull/17461)
- Fixes an issue that caused some missing results for `type:commit` when a pattern was used instead of the `message` field. [#17490](https://github.com/khulnasoft/khulnasoft/pull/17490#issuecomment-764004758)
- Fixes an issue where cAdvisor-based alerts would not fire correctly for services with multiple replicas. [#17600](https://github.com/khulnasoft/khulnasoft/pull/17600)
- Significantly improved performance of structural search on monorepo deployments [#17846](https://github.com/khulnasoft/khulnasoft/pull/17846)
...
- Fixes an issue where counts on search filters were inaccurate. [#18158](https://github.com/khulnasoft/khulnasoft/pull/18158)
...
- Removed the `search.migrateParser` setting. As of 3.20 and onward, a new parser processes search queries by default. Previously, `search.migrateParser` was available to enable the legacy parser. Enabling/disabling this setting now no longer has any effect. [#17344](https://github.com/khulnasoft/khulnasoft/pull/17344)

## 3.24.1

### Fixed

- Fixes an issue that SAML is not able to proceed with the error `Expected Enveloped and C14N transforms`. [#13032](https://github.com/khulnasoft/khulnasoft/issues/13032)
...
- Specifying a ref that doesn't exist would show an alert, but still return results [#15576](https://github.com/khulnasoft/khulnasoft/issues/15576)
- Fixed search highlighting the wrong line. [#10468](https://github.com/khulnasoft/khulnasoft/issues/10468)
- Fixed an issue where searches of the form `foo type:file` returned results of type `path` too. [#17076](https://github.com/khulnasoft/khulnasoft/issues/17076)
- Fixed queries like `(type:commit or type:diff)` so that if the query matches both the commit message and the diff, both are returned as results. [#16899](https://github.com/khulnasoft/khulnasoft/issues/16899)
- Fixed container monitoring and provisioning dashboard panels not displaying metrics in certain deployment types and environments. If you continue to have issues with these panels not displaying any metrics after upgrading, please [open an issue](https://github.com/khulnasoft/khulnasoft/issues/new).
- Fixed a nonexistent field in site configuration being marked as "required" when configuring PagerDuty alert notifications. [#17277](https://github.com/khulnasoft/khulnasoft/pull/17277)
- Fixed cases of incorrect highlighting for symbol definitions in the definitions panel. [#17258](https://github.com/khulnasoft/khulnasoft/pull/17258)
- Fixed a Cross-Site Scripting vulnerability where quick links created on the homepage were not sanitized and allowed arbitrary JavaScript execution. [#17099](https://github.com/khulnasoft/khulnasoft/pull/17099)

### Removed

- Interactive mode has now been removed. [#16868](https://github.com/khulnasoft/khulnasoft/pull/16868).
...
- Syntax highlighting on files with mixed extension case (e.g. `.CPP` vs `.cpp`) now works as expected. [#11327](https://github.com/khulnasoft/khulnasoft/issues/11327)
- After applying a campaign, some GitLab MRs might have had outdated state shown in the UI until the next sync with the code host. [#16100](https://github.com/khulnasoft/khulnasoft/pull/16100)
- The web app no longer sends stale text document content to extensions. [#14965](https://github.com/khulnasoft/khulnasoft/issues/14965)
- The blob viewer now supports multiple decorations per line as intended. [#15063](https://github.com/khulnasoft/khulnasoft/issues/15063)
- Repositories with plus signs in their name can now be navigated to as expected. [#15079](https://github.com/khulnasoft/khulnasoft/issues/15079)
...
- Reduced memory and CPU required for updating the code intelligence commit graph [#16517](https://github.com/khulnasoft/khulnasoft/pull/16517)
...
- Improved contrast / visibility in comment syntax highlighting. [#14546](https://github.com/khulnasoft/khulnasoft/issues/14546)
- Campaigns are no longer in beta. [#14900](https://github.com/khulnasoft/khulnasoft/pull/14900)
- Campaigns now have a fancy new icon. [#14740](https://github.com/khulnasoft/khulnasoft/pull/14740)
- Search queries with an unbalanced closing paren `)` are now invalid, since this likely indicates an error. Previously, patterns with dangling `)` were valid in some cases. Note that patterns with dangling `)` can still be searched, but should be quoted via `content:"foo)"`. [#15042](https://github.com/khulnasoft/khulnasoft/pull/15042)
- Extension providers can now return AsyncIterables, enabling dynamic provider results without dependencies. [#15042](https://github.com/khulnasoft/khulnasoft/issues/15061)
- Deprecated the `"email.smtp": { "disableTLS" }` site config option, this field has been replaced by `"email.smtp": { "noVerifyTLS" }`. [#15682](https://github.com/khulnasoft/khulnasoft/pull/15682)

### Fixed

- The `file:` added to the search field when navigating to a tree or file view will now behave correctly when the file path contains spaces. [#12296](https://github.com/khulnasoft/khulnasoft/issues/12296)
- OAuth login now respects site configuration `experimentalFeatures: { "tls.external": {...} }` for custom certificates and skipping TLS verify. [#14144](https://github.com/khulnasoft/khulnasoft/issues/14144)
- If the `HEAD` file in a cloned repo is absent or truncated, background cleanup activities will use a best-effort default to remedy the situation. [#14962](https://github.com/khulnasoft/khulnasoft/pull/14962)
- Search input will always show suggestions. Previously we only showed suggestions for letters and some special characters. [#14982](https://github.com/khulnasoft/khulnasoft/pull/14982)
- Fixed an issue where `not` keywords were not recognized inside expression groups, and treated incorrectly as patterns. [#15139](https://github.com/khulnasoft/khulnasoft/pull/15139)
- Fixed an issue where hover pop-ups would not show on the first character of a valid hover range in search queries. [#15410](https://github.com/khulnasoft/khulnasoft/pull/15410)
- Fixed an issue where submodules configured with a relative URL resulted in non-functional hyperlinks in the file tree UI. [#15286](https://github.com/khulnasoft/khulnasoft/issues/15286)
- Pushing commits to public GitLab repositories with campaigns now works, since we use the configured token even if the repository is public. [#15536](https://github.com/khulnasoft/khulnasoft/pull/15536)
- `.kts` is now highlighted properly as Kotlin code, fixed various other issues in Kotlin syntax highlighting.
- Fixed an issue where the value of `content:` was treated literally when the regular expression toggle is active. [#15639](https://github.com/khulnasoft/khulnasoft/pull/15639)
- Fixed an issue where non-site admins were prohibited from updating some of their other personal metadata when `auth.enableUsernameChanges` was `false`. [#15663](https://github.com/khulnasoft/khulnasoft/issues/15663)
- Fixed the `url` fields of repositories and trees in GraphQL returning URLs that were not %-encoded (e.g. when the repository name contained spaces). [#15667](https://github.com/khulnasoft/khulnasoft/issues/15667)
- Fixed "Find references" showing errors in the references panel in place of the syntax-highlighted code for repositories with spaces in their name. [#15618](https://github.com/khulnasoft/khulnasoft/issues/15618)
- Fixed an issue where specifying the `repohasfile` filter did not return results as expected unless `repo` was specified. [#15894](https://github.com/khulnasoft/khulnasoft/pull/15894)
- Fixed an issue causing user input in the search query field to be erased in some cases. [#15921](https://github.com/khulnasoft/khulnasoft/issues/15921).
...
- Fix externalURLs alert logic [#14980](https://github.com/khulnasoft/khulnasoft/pull/14980)
...
- Fix alerting for native integration condition [#14775](https://github.com/khulnasoft/khulnasoft/pull/14775)
- Fix query with large repo count hanging [#14944](https://github.com/khulnasoft/khulnasoft/pull/14944)
- Fix server upgrade where codeintel database does not exist [#14953](https://github.com/khulnasoft/khulnasoft/pull/14953)
- CVE-2019-18218 in postgres docker image [#14954](https://github.com/khulnasoft/khulnasoft/pull/14954)
- Fix an issue where .git/HEAD in invalid [#14962](https://github.com/khulnasoft/khulnasoft/pull/14962)
- Repository syncing will not happen more frequently than the repoListUpdateInterval config value [#14901](https://github.com/khulnasoft/khulnasoft/pull/14901) [#14983](https://github.com/khulnasoft/khulnasoft/pull/14983)
...
- Git clone URLs now validate their format correctly. [#14313](https://github.com/khulnasoft/khulnasoft/pull/14313)
- Usernames set in Slack `observability.alerts` now apply correctly. [#14079](https://github.com/khulnasoft/khulnasoft/pull/14079)
- Path segments in breadcrumbs get truncated correctly again on small screen sizes instead of inflating the header bar. [#14097](https://github.com/khulnasoft/khulnasoft/pull/14097)
...
- gomod: rollback go-diff to v0.5.3 (v0.6.0 causes panic in certain cases) [#13973](https://github.com/khulnasoft/khulnasoft/pull/13973).
- Fixed an issue causing the scoped query in the search field to be erased when viewing files. [#13954](https://github.com/khulnasoft/khulnasoft/pull/13954).
...
- Sourcegraph now watches its [configuration files](https://docs.sourcegraph.com/admin/config/advanced_config_file) (when using external files) and automatically applies the changes to Sourcegraph's configuration when they change. For example, this allows Sourcegraph to detect when a Kubernetes ConfigMap changes. [#13646](https://github.com/khulnasoft/khulnasoft/pull/13646)
...
- Diff and commit searches are limited to 10,000 repositories (if `before:` or `after:` filters are used), or 50 repositories (if no time filters are used). You can configure this limit in the site configuration property `search.limits`. [#13386](https://github.com/khulnasoft/khulnasoft/pull/13386)
- The site configuration `maxReposToSearch` has been deprecated in favor of the property `maxRepos` on `search.limits`. [#13439](https://github.com/khulnasoft/khulnasoft/pull/13439)
- Search queries are now processed by a new parser that will always be enabled going forward. There should be no material difference in behavior. In case of adverse effects, the previous parser can be reenabled by setting `"search.migrateParser": false` in settings. [#13435](https://github.com/khulnasoft/khulnasoft/pull/13435)
- It is now possible to search for file content that excludes a term using the `NOT` operator. [#12412](https://github.com/khulnasoft/khulnasoft/pull/12412)
- `NOT` is available as an alternative syntax of `-` on supported keywords `repo`, `file`, `content`, `lang`, and `repohasfile`. [#12412](https://github.com/khulnasoft/khulnasoft/pull/12412)
- Negated content search is now also supported for unindexed repositories. Previously it was only supported for indexed repositories [#13359](https://github.com/khulnasoft/khulnasoft/pull/13359).
- The experimental feature flag `andOrQuery` is deprecated. [#13435](https://github.com/khulnasoft/khulnasoft/pull/13435)
- After a user's password changes, they will be signed out on all devices and must sign in again. [#13647](https://github.com/khulnasoft/khulnasoft/pull/13647)
- `rev:` is available as alternative syntax of `@` for searching revisions instead of the default branch [#13133](https://github.com/khulnasoft/khulnasoft/pull/13133)
- Campaign URLs have changed to use the campaign name instead of an opaque ID. The old URLs no longer work. [#13368](https://github.com/khulnasoft/khulnasoft/pull/13368)
- A new `external_service_repos` join table was added. The migration required to make this change may take a few minutes.

### Fixed

- User satisfaction/NPS surveys will now correctly provide a range from 0–10, rather than 0–9. [#13163](https://github.com/khulnasoft/khulnasoft/pull/13163)
- Fixed a bug where we returned repositories with invalid revisions in the search results. Now, if a user specifies an invalid revision, we show an alert. [#13271](https://github.com/khulnasoft/khulnasoft/pull/13271)
- Previously it wasn't possible to search for certain patterns containing `:` because they would not be considered valid filters. We made these checks less strict. [#10920](https://github.com/khulnasoft/khulnasoft/pull/10920)
- When a user signs out of their account, all of their sessions will be invalidated, not just the session where they signed out. [#13647](https://github.com/khulnasoft/khulnasoft/pull/13647)
- URL information will no longer be leaked by the HTTP referer header. This prevents the user's password reset code from being leaked. [#13804](https://github.com/khulnasoft/khulnasoft/pull/13804)
- GitLab OAuth2 user authentication now respects `tls.external` site setting. [#13814](https://github.com/khulnasoft/khulnasoft/pull/13814)
...
- search: always limit commit and diff to less than 10,000 repos [a97f81b0f7](https://github.com/khulnasoft/khulnasoft/commit/a97f81b0f79535253bd7eae6c30d5c91d48da5ca)
- search: configurable limits on commit/diff search [1c22d8ce1](https://github.com/khulnasoft/khulnasoft/commit/1c22d8ce13c149b3fa3a7a26f8cb96adc89fc556)
- search: add site configuration for maxTimeout [d8d61b43c0f](https://github.com/khulnasoft/khulnasoft/commit/d8d61b43c0f0d229d46236f2f128ca0f93455172)

## 3.19.1

### Fixed

- migrations: revert migration causing deadlocks in some deployments [#13194](https://github.com/khulnasoft/khulnasoft/pull/13194)

## 3.19.0

### Added

- Emails can be now be sent to SMTP servers with self-signed certificates, using `email.smtp.disableTLS`. [#12243](https://github.com/khulnasoft/khulnasoft/pull/12243)
...
- Password reset emails will now be automatically sent to users created by a site admin if email sending is configured and password reset is enabled. Previously, site admins needed to manually send the user this password reset link. [#12803](https://github.com/khulnasoft/khulnasoft/pull/12803)
- Syntax highlighting for `and` and `or` search operators. [#12694](https://github.com/khulnasoft/khulnasoft/pull/12694)
- It is now possible to search for file content that excludes a term using the `NOT` operator. Negating pattern syntax requires setting `"search.migrateParser": true` in settings and is currently only supported for literal and regexp queries on indexed repositories. [#12412](https://github.com/khulnasoft/khulnasoft/pull/12412)
- `NOT` is available as an alternative syntax of `-` on supported keywords `repo`, `file`, `content`, `lang`, and `repohasfile`. `NOT` requires setting `"search.migrateParser": true` option in settings. [#12520](https://github.com/khulnasoft/khulnasoft/pull/12520)
...
- The site admin repository needs-index page is significantly faster. Previously on large instances it would usually timeout. Now it should load within a second. [#12513](https://github.com/khulnasoft/khulnasoft/pull/12513)
- User password reset page now respects the value of site config `auth.minPasswordLength`. [#12971](https://github.com/khulnasoft/khulnasoft/pull/12971)
- Fixed an issue where duplicate search results would show for queries with `or`-expressions. [#12531](https://github.com/khulnasoft/khulnasoft/pull/12531)
- Faster indexed search queries over a large number of repositories. Searching 100k+ repositories is now ~400ms faster and uses much less memory. [#12546](https://github.com/khulnasoft/khulnasoft/pull/12546)
...
- Removed `CloneInProgress` option from GraphQL Repositories API. [#12560](https://github.com/khulnasoft/khulnasoft/pull/12560)
...
- The "Add repositories" page (/site-admin/external-services/new) now displays a dismissible notification explaining how and why we access code host data. [#11789](https://github.com/khulnasoft/khulnasoft/pull/11789).
...
- Specific alerts can now be silenced using `observability.silenceAlerts`. [#12087](https://github.com/khulnasoft/khulnasoft/pull/12087)
- Revisions listed in `experimentalFeatures.versionContext` will be indexed for faster searching. This is the first support towards indexing non-default branches. [#6728](https://github.com/khulnasoft/khulnasoft/issues/6728)
...
- Some monitoring alerts now have more useful descriptions. [#11542](https://github.com/khulnasoft/khulnasoft/pull/11542)
- Searching `fork:true` or `archived:true` has the same behaviour as searching `fork:yes` or `archived:yes` respectively. Previously it incorrectly had the same behaviour as `fork:only` and `archived:only` respectively. [#11740](https://github.com/khulnasoft/khulnasoft/pull/11740)
- Configuration for `observability.alerts` has changed and notifications are now provided by Prometheus Alertmanager. [#11832](https://github.com/khulnasoft/khulnasoft/pull/11832)
...
- An issue where repositories would not clone and index in some edge cases where the clones were deleted or not successful on gitserver. [#11602](https://github.com/khulnasoft/khulnasoft/pull/11602)
- An issue where repositories previously deleted on gitserver would not immediately reclone on system startup. [#11684](https://github.com/khulnasoft/khulnasoft/issues/11684)
...
- Removed "Cloning" tab in site-admin Repository Status page. [#12043](https://github.com/khulnasoft/khulnasoft/pull/12043)
- The `blacklist` configuration option for Gitolite that was deprecated in 3.17 has been removed in 3.19. Use `exclude.pattern` instead. [#12345](https://github.com/khulnasoft/khulnasoft/pull/12345)

## 3.17.3

### Fixed

- git: Command retrying made a copy that was never used [#11807](https://github.com/khulnasoft/khulnasoft/pull/11807)
- frontend: Allow opt out of EnsureRevision when making a comparison query [#11811](https://github.com/khulnasoft/khulnasoft/pull/11811)
- Fix Phabricator icon class [#11825](https://github.com/khulnasoft/khulnasoft/pull/11825)
...
- Dynamic repo search filters on branches which contain special characters are correctly escaped now. [#10810](https://github.com/khulnasoft/khulnasoft/pull/10810)
- Forks and archived repositories at a specific commit are searched without the need to specify "fork:yes" or "archived:yes" in the query. [#10864](https://github.com/khulnasoft/khulnasoft/pull/10864)
- The git history for binary files is now correctly shown. [#11034](https://github.com/khulnasoft/khulnasoft/pull/11034)
- Links to AWS Code Commit repositories have been fixed after the URL schema has been changed. [#11019](https://github.com/khulnasoft/khulnasoft/pull/11019)
- A link to view all repositories will now always appear on the Explore page. [#11113](https://github.com/khulnasoft/khulnasoft/pull/11113)
...
- Automatic syncing of Campaign webhooks for Bitbucket Server. [#10962](https://github.com/khulnasoft/khulnasoft/pull/10962)
...
- Search: fix indexed search match count [#7fc96](https://github.com/khulnasoft/khulnasoft/commit/7fc96d319f49f55da46a7649ccf261aa7e8327c3)
- Sort detected languages properly [#e7750](https://github.com/khulnasoft/khulnasoft/commit/e77507d060a40355e7b86fb093d21a7149ea03ac)
...
- Autocompletion for `repogroup` filters in search queries. [#10141](https://github.com/khulnasoft/khulnasoft/pull/10286)
...
- New permissions page in both user and repository settings when background permissions syncing is enabled (`"permissions.backgroundSync": {"enabled": true}`). [#10473](https://github.com/khulnasoft/khulnasoft/pull/10473) [#10655](https://github.com/khulnasoft/khulnasoft/pull/10655)
...
- The deprecated feature discussions has been removed. [#9649](https://github.com/khulnasoft/khulnasoft/issues/9649)
...
- observability (monitoring): **More metrics monitored and alerted on, more legible dashboards**
  ...
  - Symbols: failing `symbols` -> `frontend-internal` requests are now monitored. [#9732](https://github.com/khulnasoft/khulnasoft/issues/9732)
...
- Multiple backwards-incompatible changes in the parts of the GraphQL API related to Campaigns [#9106](https://github.com/khulnasoft/khulnasoft/issues/9106):
  - `CampaignPlan.status` has been removed, since we don't need it anymore after moving execution of campaigns to src CLI in [#8008](https://github.com/khulnasoft/khulnasoft/pull/8008).
...
- Removed the scoped search field on tree pages. When browsing code, the global search query will now get scoped to the current tree or file. [#9225](https://github.com/khulnasoft/khulnasoft/pull/9225)
- Instances without a license key that exceed the published user limit will now display a notice to all users.

### Fixed

- `.*` in the filter pattern were ignored and led to missing search results. [#9152](https://github.com/khulnasoft/khulnasoft/pull/9152)
- The Phabricator integration no longer makes duplicate requests to Phabricator's API on diff views. [#8849](https://github.com/khulnasoft/khulnasoft/issues/8849)
- Changesets on repositories that aren't available on the instance anymore are now hidden instead of failing. [#9656](https://github.com/khulnasoft/khulnasoft/pull/9656)
- observability (monitoring):
  - **Dashboard and alerting bug fixes**
    - Syntect Server dashboard: "Worker timeouts" can no longer appear to go negative. [#9523](https://github.com/khulnasoft/khulnasoft/issues/9523)
    - Symbols dashboard: "Store fetch queue size" can no longer appear to go negative. [#9731](https://github.com/khulnasoft/khulnasoft/issues/9731)
    - Syntect Server dashboard: "Worker timeouts" no longer incorrectly shows multiple values. [#9524](https://github.com/khulnasoft/khulnasoft/issues/9524)
    ...
    - Fixed an issue where NaN could leak into the `alert_count` metric. [#9832](https://github.com/khulnasoft/khulnasoft/issues/9832)
    - Gitserver: "resolve_revision_duration_slow" alert is no longer flaky / non-deterministic. [#9751](https://github.com/khulnasoft/khulnasoft/issues/9751)
    - Git Server dashboard: there is now a panel to show concurrent command executions to match the defined alerts. [#9354](https://github.com/khulnasoft/khulnasoft/issues/9354)
    - Git Server dashboard: adjusted the critical disk space alert to 15% so it can now fire. [#9351](https://github.com/khulnasoft/khulnasoft/issues/9351)
  - **Dashboard visiblity and legibility improvements**
    - all: "frontend internal errors" are now broken down just by route, which makes reading the graph easier. [#9668](https://github.com/khulnasoft/khulnasoft/issues/9668)
    - Frontend dashboard: panels no longer show misleading duplicate labels. [#9660](https://github.com/khulnasoft/khulnasoft/issues/9660)
    - Syntect Server dashboard: panels are no longer compacted, for improved visibility. [#9525](https://github.com/khulnasoft/khulnasoft/issues/9525)
    - Frontend dashboard: panels are no longer compacted, for improved visibility. [#9356](https://github.com/khulnasoft/khulnasoft/issues/9356)
    - Searcher dashboard: "Search errors on unindexed repositories" is now broken down by code instead of instance for improved readability. [#9670](https://github.com/khulnasoft/khulnasoft/issues/9670)
    - Symbols dashboard: metrics are now aggregated instead of per-instance, for improved visibility. [#9730](https://github.com/khulnasoft/khulnasoft/issues/9730)
    - Firing alerts are now correctly sorted at the top of dashboards by default. [#9766](https://github.com/khulnasoft/khulnasoft/issues/9766)
    - Panels at the bottom of the home dashboard no longer appear clipped / cut off. [#9768](https://github.com/khulnasoft/khulnasoft/issues/9768)
    - Git Server dashboard: disk usage now shown in percentages to match the alerts that can fire. [#9352](https://github.com/khulnasoft/khulnasoft/issues/9352)
    - Git Server dashboard: the 'echo command duration test' panel now properly displays units in seconds. [#7628](https://github.com/khulnasoft/khulnasoft/issues/7628)
    - Dashboard panels showing firing alerts no longer over-count firing alerts due to the number of service replicas. [#9353](https://github.com/khulnasoft/khulnasoft/issues/9353)

### Removed

- The experimental feature discussions is marked as deprecated. GraphQL and configuration fields related to it will be removed in 3.16. [#9649](https://github.com/khulnasoft/khulnasoft/issues/9649)
...
- phabricator: Duplicate requests to phabricator API from sourcegraph extensions. [#8849](https://github.com/khulnasoft/khulnasoft/issues/8849)

## 3.14.2

### Fixed

- campaigns: Ignore changesets where repo does not exist anymore. [#9656](https://github.com/khulnasoft/khulnasoft/pull/9656)
...
- Indexed search exports more prometheus metrics and debug logs to aid debugging performance issues. [#9111](https://github.com/khulnasoft/khulnasoft/issues/9111)
...
- GitHub labels associated with campaigns are now displayed. [#8115](https://github.com/khulnasoft/khulnasoft/pull/8115)
...
- The syntax highlighter (syntect-server) no longer fails when run in environments without IPv6 support. [#8463](https://github.com/khulnasoft/khulnasoft/pull/8463)
- After adding/removing a gitserver replica the admin interface will correctly report that repositories that need to move replicas as cloning. [#7970](https://github.com/khulnasoft/khulnasoft/issues/7970)
- Show download button for images. [#7924](https://github.com/khulnasoft/khulnasoft/issues/7924)
- gitserver backoffs trying to re-clone repositories if they fail to clone. In the case of large monorepos that failed this lead to gitserver constantly cloning them and using many resources. [#7804](https://github.com/khulnasoft/khulnasoft/issues/7804)
- It is now possible to escape spaces using `\` in the search queries when using regexp. [#7604](https://github.com/khulnasoft/khulnasoft/issues/7604)
- Clicking filter chips containing whitespace is now correctly quoted in the web UI. [#6498](https://github.com/khulnasoft/khulnasoft/issues/6498)
- **Monitoring:** Fixed an issue with the **Frontend** -> **Search responses by status** panel which caused search response types to not be aggregated as expected. [#7627](https://github.com/khulnasoft/khulnasoft/issues/7627)
- **Monitoring:** Fixed an issue with the **Replacer**, **Repo Updater**, and **Searcher** dashboards would incorrectly report on a metric from the unrelated query-runner service. [#7531](https://github.com/khulnasoft/khulnasoft/issues/7531)
...
- Spread out periodic git reclones. Previously we would reclone all git repositories every 45 days. We now add in a jitter of 12 days to spread out the load for larger installations. [#8259](https://github.com/khulnasoft/khulnasoft/issues/8259)
- Fixed an issue with missing commit information in graphql search results. [#8343](https://github.com/khulnasoft/khulnasoft/pull/8343)

### Removed

- All repository fields related to `enabled` and `disabled` have been removed from the GraphQL API. These fields have been deprecated since 3.4. [#3971](https://github.com/khulnasoft/khulnasoft/pull/3971)
...
- Extension API showInputBox and other Window methods now work on search results pages [#8519](https://github.com/khulnasoft/khulnasoft/issues/8519)
- Extension error notification styling is clearer [#8521](https://github.com/khulnasoft/khulnasoft/issues/8521)
...
- New optional `apiURL` configuration option for Bitbucket Cloud code host connection [#8082](https://github.com/khulnasoft/khulnasoft/pull/8082)

## 3.12.3

### Fixed

- Fixed an issue in `sourcegraph/*` Docker images where data folders were either not created or had incorrect permissions—preventing the use of Docker volumes. [#7991](https://github.com/khulnasoft/khulnasoft/pull/7991)
...
- A regression in 3.12.0 which caused find-leaked-credentials campaigns to not return any results for private repositories. [#7914](https://github.com/khulnasoft/khulnasoft/issues/7914)
- A regression in 3.12.0 which removed the horizontal bar between search result matches.
- Manual campaigns were wrongly displayed as being in draft mode. [#8009](https://github.com/khulnasoft/khulnasoft/issues/8009)
- Manual campaigns could be published and create the wrong changesets on code hosts, even though the campaign was never in draft mode (see line above). [#8012](https://github.com/khulnasoft/khulnasoft/pull/8012)
- A regression in 3.12.0 which caused manual campaigns to not properly update the UI after adding a changeset. [#8023](https://github.com/khulnasoft/khulnasoft/pull/8023)
- Minor improvements to manual campaign form fields. [#8033](https://github.com/khulnasoft/khulnasoft/pull/8033)

## 3.12.1

### Fixed

- The ephemeral `/site-config.json` escape-hatch config file has moved to `$HOME/site-config.json`, to support non-root container environments. [#7873](https://github.com/khulnasoft/khulnasoft/issues/7873)
- Fixed an issue where repository permissions would sometimes not be cached, due to improper Redis nil value handling. [#7912](https://github.com/khulnasoft/khulnasoft/issues/7912)
...
- The experimental search pagination API no longer times out when large repositories are encountered. [#6384](https://github.com/khulnasoft/khulnasoft/issues/6384)
- We resolve relative symbolic links from the directory of the symlink, rather than the root of the repository. [#6034](https://github.com/khulnasoft/khulnasoft/issues/6034)
- Show errors on repository settings page when repo-updater is down. [#3593](https://github.com/khulnasoft/khulnasoft/issues/3593)
- Remove benign warning that verifying config took more than 10s when updating or saving an external service. [#7176](https://github.com/khulnasoft/khulnasoft/issues/7176)
- repohasfile search filter works again (regressed in 3.10). [#7380](https://github.com/khulnasoft/khulnasoft/issues/7380)
- Structural search can now run on very large repositories containing any number of files. [#7133](https://github.com/khulnasoft/khulnasoft/issues/7133)

### Removed

- The deprecated GraphQL mutation `setAllRepositoriesEnabled` has been removed. [#7478](https://github.com/khulnasoft/khulnasoft/pull/7478)
- The deprecated GraphQL mutation `deleteRepository` has been removed. [#7483](https://github.com/khulnasoft/khulnasoft/pull/7483)
...
- The version updating logic has been fixed for `sourcegraph/server`. Users running `sourcegraph/server:3.11.1` will need to manually modify their `docker run` command to use `sourcegraph/server:3.11.4` or higher. [#7442](https://github.com/khulnasoft/khulnasoft/issues/7442)

## 3.11.1

### Fixed

- The syncing process for newly created campaign changesets has been fixed again after they have erroneously been marked as deleted in the database. [#7522](https://github.com/khulnasoft/khulnasoft/pull/7522)
- The syncing process for newly created changesets (in campaigns) has been fixed again after they have erroneously been marked as deleted in the database. [#7522](https://github.com/khulnasoft/khulnasoft/pull/7522)
...
- High-level health metrics and dashboards have been added to Sourcegraph's monitoring (found under the **Site admin** -> **Monitoring** area). [#7216](https://github.com/khulnasoft/khulnasoft/pull/7216)
...
- Diff and commit searches that make use of `before:` and `after:` filters to narrow their search area are now no longer subject to the 50-repository limit. This allows for creating saved searches on more than 50 repositories as before. [#7215](https://github.com/khulnasoft/khulnasoft/issues/7215)

### Fixed

- Changes to external service configurations are reflected much faster. [#6058](https://github.com/khulnasoft/khulnasoft/issues/6058)
- Deleting an external service will not show warnings for the non-existent service. [#5617](https://github.com/khulnasoft/khulnasoft/issues/5617)
- Suggested search filter chips are quoted if necessary. [#6498](https://github.com/khulnasoft/khulnasoft/issues/6498)
- Remove potential panic in gitserver if heavily loaded. [#6710](https://github.com/khulnasoft/khulnasoft/issues/6710)
- Multiple fixes to make the preview and creation of campaigns more robust and a smoother user experience. [#6682](https://github.com/khulnasoft/khulnasoft/pull/6682) [#6625](https://github.com/khulnasoft/khulnasoft/issues/6625) [#6658](https://github.com/khulnasoft/khulnasoft/issues/6658) [#7088](https://github.com/khulnasoft/khulnasoft/issues/7088) [#6766](https://github.com/khulnasoft/khulnasoft/issues/6766) [#6717](https://github.com/khulnasoft/khulnasoft/issues/6717) [#6659](https://github.com/khulnasoft/khulnasoft/issues/6659)
- Repositories referenced in campaigns that are removed in an external service configuration change won't lead to problems with the syncing process anymore. [#7015](https://github.com/khulnasoft/khulnasoft/pull/7015)
- The Searcher dashboard (and the `src_graphql_search_response` Prometheus metric) now properly account for search alerts instead of them being incorrectly added to the `timeout` category. [#7214](https://github.com/khulnasoft/khulnasoft/issues/7214)
- In the experimental search pagination API, the `cloning`, `missing`, and other repository fields now return a well-defined set of results. [#6000](https://github.com/khulnasoft/khulnasoft/issues/6000)
...
- An issue where diff/commit searches that would run over more than 50 repositories would incorrectly display a timeout error instead of the correct error suggesting users scope their query to less repositories. [#7090](https://github.com/khulnasoft/khulnasoft/issues/7090)

## 3.10.3

### Fixed

- A critical regression in 3.10.2 which caused diff, commit, and repository searches to timeout. [#7090](https://github.com/khulnasoft/khulnasoft/issues/7090)
- A critical regression in 3.10.2 which caused "No results" to appear frequently on pages with search results. [#7095](https://github.com/khulnasoft/khulnasoft/pull/7095)
- An issue where the built-in Grafana Searcher dashboard would show duplicate success/error metrics. [#7078](https://github.com/khulnasoft/khulnasoft/pull/7078)

## 3.10.2

### Added

- Site admins can now use the built-in Grafana Searcher dashboard to observe how many search requests are successful, or resulting in errors or timeouts. [#6756](https://github.com/khulnasoft/khulnasoft/issues/6756)

### Fixed

- When searches timeout, a consistent UI with clear actions like a button to increase the timeout is now returned. [#6754](https://github.com/khulnasoft/khulnasoft/issues/6754)
- To reduce the chance of search timeouts in some cases, the default indexed search timeout has been raised from 1.5s to 3s. [#6754](https://github.com/khulnasoft/khulnasoft/issues/6754)
- We now correctly inform users of the limitations of diff/commit search. If a diff/commit search would run over more than 50 repositories, users will be shown an error suggesting they scope their search to less repositories using the `repo:` filter. Global diff/commit search support is being tracked in [#6826](https://github.com/khulnasoft/khulnasoft/issues/6826). [#5519](https://github.com/khulnasoft/khulnasoft/issues/5519)

## 3.10.1

### Added

- Syntax highlighting for Starlark (Bazel) files. [#6827](https://github.com/khulnasoft/khulnasoft/issues/6827)

### Fixed

- The experimental search pagination API no longer times out when large repositories are encountered. [#6384](https://github.com/khulnasoft/khulnasoft/issues/6384) [#6383](https://github.com/khulnasoft/khulnasoft/issues/6383)
- In single-container deployments, the builtin `postgres_exporter` now correctly respects externally configured databases. This previously caused PostgreSQL metrics to not show up in Grafana when an external DB was in use. [#6735](https://github.com/khulnasoft/khulnasoft/issues/6735)

## 3.10.0

### Added

- Indexed Search supports horizontally scaling. Instances with large number of repositories can update the `replica` field of the `indexed-search` StatefulSet. See [configure indexed-search replica count](https://github.com/sourcegraph/deploy-sourcegraph/blob/master/docs/configure.md#configure-indexed-search-replica-count). [#5725](https://github.com/khulnasoft/khulnasoft/issues/5725)
- Bitbucket Cloud external service supports `exclude` config option. [#6035](https://github.com/khulnasoft/khulnasoft/issues/6035)
...
- Support hyphens in Bitbucket Cloud team names. [#6154](https://github.com/khulnasoft/khulnasoft/issues/6154)
- Server will run `redis-check-aof --fix` on startup to fix corrupted AOF files. [#651](https://github.com/khulnasoft/khulnasoft/issues/651)
- Authorization provider configuration errors in external services will be shown as site alerts. [#6061](https://github.com/khulnasoft/khulnasoft/issues/6061)
...
- The experimental search pagination API no longer omits a single repository worth of results at the end of the result set. [#6286](https://github.com/khulnasoft/khulnasoft/issues/6286)
- The experimental search pagination API no longer produces search cursors that can get "stuck". [#6287](https://github.com/khulnasoft/khulnasoft/issues/6287)
- In literal search mode, searching for quoted strings now works as expected. [#6255](https://github.com/khulnasoft/khulnasoft/issues/6255)
- In literal search mode, quoted field values now work as expected. [#6271](https://github.com/khulnasoft/khulnasoft/pull/6271)
- `type:path` search queries now correctly work in indexed search again. [#6220](https://github.com/khulnasoft/khulnasoft/issues/6220)
...
- URI-decode the username, password, and pathname when constructing Postgres connection paramers in lsif-server [#6174](https://github.com/khulnasoft/khulnasoft/pull/6174). Fixes a crashing lsif-server process for users with passwords containing special characters.

## 3.9.1

### Changed

- Reverted [#6094](https://github.com/khulnasoft/khulnasoft/pull/6094) because it introduced a minor security hole involving only Grafana.
  [#6075](https://github.com/khulnasoft/khulnasoft/issues/6075) will be fixed with a different approach.
...
- Allow single trailing hyphen in usernames and org names [#5680](https://github.com/khulnasoft/khulnasoft/pull/5680)
- Indexed search won't spam the logs on startup if the frontend API is not yet available. [zoekt#30](https://github.com/sourcegraph/zoekt/pull/30), [#5866](https://github.com/khulnasoft/khulnasoft/pull/5866)
- Search query fields are now case insensitive. For example `repoHasFile:` will now be recognized, not just `repohasfile:`. [#5168](https://github.com/khulnasoft/khulnasoft/issues/5168)
- Search queries are now interpreted literally by default, rather than as regular expressions. [#5899](https://github.com/khulnasoft/khulnasoft/pull/5899)
...
- Disk cleanup in gitserver is now done in terms of percentages to fix [#5059](https://github.com/khulnasoft/khulnasoft/issues/5059).
- Search results now correctly show highlighting of matches with runes like 'İ' that lowercase to runes with a different number of bytes in UTF-8 [#4791](https://github.com/khulnasoft/khulnasoft/issues/4791).
- Fixed an issue where search would sometimes crash with a panic due to a nil pointer. [#5246](https://github.com/khulnasoft/khulnasoft/issues/5246)
...
- Fixed Phabricator external services so they won't stop the syncing process for repositories when Phabricator doesn't return clone URLs. [#5101](https://github.com/khulnasoft/khulnasoft/pull/5101)
...
- Commit searches now correctly highlight unicode characters, for example 加. [#4512](https://github.com/khulnasoft/khulnasoft/issues/4512)
- Symbol searches now show the number of symbol matches rather than the number of file matches found. [#4578](https://github.com/khulnasoft/khulnasoft/issues/4578)
- Symbol searches with truncated results now show a `+` on the results page to signal that some results have been omitted. [#4579](https://github.com/khulnasoft/khulnasoft/issues/4579)
...
- Syntax highlighting requests that fail are now logged and traced. A new Prometheus metric `src_syntax_highlighting_requests` allows monitoring and alerting. [#4877](https://github.com/khulnasoft/khulnasoft/issues/4877).
- Sourcegraph's SAML authentication now supports RSA PKCS#1 v1.5. [#4869](https://github.com/khulnasoft/khulnasoft/pull/4869)

### Fixed

- Increased nginx proxy buffer size to fix issue where login failed when SAML AuthnRequest was too large. [#4849](https://github.com/khulnasoft/khulnasoft/pull/4849)
- A regression in 3.3.8 where `"corsOrigin": "*"` was improperly forbidden. [#4424](https://github.com/khulnasoft/khulnasoft/issues/4424)
...
- Prevent data inconsistency on cached archives due to restarts. [#4366](https://github.com/khulnasoft/khulnasoft/pull/4366)
- On the /extensions page, the UI is now less ambiguous when an extension has not been activated. [#4446](https://github.com/khulnasoft/khulnasoft/issues/4446)

## 3.4.5

### Fixed

- Fixed an issue where syntax highlighting taking too long would result in errors or wait long amounts of time without properly falling back to plaintext rendering after a few seconds. [#4267](https://github.com/khulnasoft/khulnasoft/issues/4267) [#4268](https://github.com/khulnasoft/khulnasoft/issues/4268) (this fix was intended to be in 3.4.3, but was in fact left out by accident)
- Fixed an issue with `sourcegraph/server` Docker deployments where syntax highlighting could produce `server closed idle connection` errors. [#4269](https://github.com/khulnasoft/khulnasoft/issues/4269) (this fix was intended to be in 3.4.3, but was in fact left out by accident)
- Fix `repository.language` GraphQL field (previously returned empty for most repositories).
...
- Fixed an out of bounds error in the GraphQL repository query. [#4426](https://github.com/khulnasoft/khulnasoft/issues/4426)
...
- Fixed incorrect wording in site-admin onboarding. [#4127](https://github.com/khulnasoft/khulnasoft/issues/4127)
...
- Fixed an issue where repo-updater was slower in performing its work which could sometimes cause other performance issues. https://github.com/khulnasoft/khulnasoft/pull/3633
...
- Fixed https://github.com/khulnasoft/khulnasoft/issues/3336.
...
- The default for `experimentalFeatures.canonicalURLRedirect` in site config was changed back to `disabled` (to avoid [#807](https://github.com/khulnasoft/khulnasoft/issues/807)).
...
- Fixed an issue that prevented users without email addresses from signing in (https://github.com/khulnasoft/khulnasoft/issues/426).
