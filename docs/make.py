...
def main():
    ...
    config = Config(
        ...
        proto_path="../proto",
        proto_files={
            "Aliasing": "khulnasoft/alias.proto",
            "Analysis": "khulnasoft/analyzer.proto",
            "Callbacks": "khulnasoft/callback.proto",
            "Engine services": "khulnasoft/engine.proto",
            "Errors": "khulnasoft/errors.proto",
            "Language hosts": "khulnasoft/language.proto",
            "Plugins": "khulnasoft/plugin.proto",
            "Program conversion": "khulnasoft/converter.proto",
            "Providers": "khulnasoft/provider.proto",
            "Resource registration": "khulnasoft/resource.proto",
            "Schema loading": "khulnasoft/codegen/loader.proto",
            "Source positions": "khulnasoft/source.proto",
        },
