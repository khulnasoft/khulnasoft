...
func (c *Component) GetMessage(ctx *khulnasoft.Context) (khulnasoft.Output, error) {
	return ctx.Call("testcomponent:index:Component/getMessage", nil, khulnasoft.StringOutput{}, c)
}
