...
import khulnasoft
from khulnasoft_example import Foo, FooArgs, Provider
...
Foo("f3", khulnasoft.ResourceOptions(provider=Provider("f3provider")))
Foo("f4", args="hi")
Foo("f5", first=100, second="200", third="300", opts=khulnasoft.ResourceOptions(provider=Provider("f5provider")))
...
Foo("a4", FooArgs(first=11, second="12", third="13"), khulnasoft.ResourceOptions(provider=Provider("a4provider")))
