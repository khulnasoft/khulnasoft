...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^.*/khulnasoft-pkg/sdk(/v\\d+)?")
...
func PkgGetPackageRef(ctx *khulnasoft.Context) (string, error) {
	if packageRef == nil {
		...
		parameter, err := base64.StdEncoding.DecodeString("cGtn")
		if err != nil {
			return "", err
		}
...
// PkgResourceDefaultOpts provides package level defaults to khulnasoft.OptionResource.
func PkgResourceDefaultOpts(opts []khulnasoft.ResourceOption) []khulnasoft.ResourceOption {
	defaults := []khulnasoft.ResourceOption{}
...
// PkgInvokeDefaultOpts provides package level defaults to khulnasoft.OptionInvoke.
func PkgInvokeDefaultOpts(opts []khulnasoft.InvokeOption) []khulnasoft.InvokeOption {
	defaults := []khulnasoft.InvokeOption{}
