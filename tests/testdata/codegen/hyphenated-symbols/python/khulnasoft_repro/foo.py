...
class Foo(khulnasoft.CustomResource):
    ...
    @property
    @khulnasoft.getter(name="conditionSets")
    def condition_sets(self) -> khulnasoft.Output[Optional[Sequence[Sequence[Sequence['outputs.Bar']]]]]:
        return khulnasoft.get(self, "condition_sets")
