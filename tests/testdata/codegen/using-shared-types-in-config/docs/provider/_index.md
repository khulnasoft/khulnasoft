...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">khulnasoft:providers:credentials</span><span class="p"></span>
...
<h4 id="hashkind">
Hash<wbr>Kind<khulnasoft-choosable type="language" values="python,go" class="inline">, Hash<wbr>Kind<wbr>Args</khulnasoft-choosable>
</h4>
