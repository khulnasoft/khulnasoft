...
class ComponentArgs:
    def __init__(__self__, *,
                 local_enum: Optional[khulnasoft.Input['local.MyEnum']] = None,
                 remote_enum: Optional[khulnasoft.Input['khulnasoft_google_native.accesscontextmanager.v1.DevicePolicyAllowedDeviceManagementLevelsItem']] = None):
        """
        The set of arguments for constructing a Component resource.
        """
        if local_enum is not None:
            khulnasoft.set(__self__, "local_enum", local_enum)
        if remote_enum is not None:
            khulnasoft.set(__self__, "remote_enum", remote_enum)

    @property
    @khulnasoft.getter(name="localEnum")
    def local_enum(self) -> Optional[khulnasoft.Input['local.MyEnum']]:
        return khulnasoft.get(self, "local_enum")

    @local_enum.setter
    def local_enum(self, value: Optional[khulnasoft.Input['local.MyEnum']]):
        khulnasoft.set(self, "local_enum", value)

    @property
    @khulnasoft.getter(name="remoteEnum")
    def remote_enum(self) -> Optional[khulnasoft.Input['khulnasoft_google_native.accesscontextmanager.v1.DevicePolicyAllowedDeviceManagementLevelsItem']]:
        return khulnasoft.get(self, "remote_enum")

    @remote_enum.setter
    def remote_enum(self, value: Optional[khulnasoft.Input['khulnasoft_google_native.accesscontextmanager.v1.DevicePolicyAllowedDeviceManagementLevelsItem']]):
        khulnasoft.set(self, "remote_enum", value)
...
class Component(khulnasoft.CustomResource):
    ...
    @property
    @khulnasoft.getter(name="localEnum")
    def local_enum(self) -> khulnasoft.Output[Optional['local.MyEnum']]:
        return khulnasoft.get(self, "local_enum")

    @property
    @khulnasoft.getter(name="remoteEnum")
    def remote_enum(self) -> khulnasoft.Output[Optional['khulnasoft_google_native.accesscontextmanager.v1.DevicePolicyAllowedDeviceManagementLevelsItem']]:
        return khulnasoft.get(self, "remote_enum")
