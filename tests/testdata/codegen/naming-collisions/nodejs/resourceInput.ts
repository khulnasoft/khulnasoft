...
export class ResourceInput extends khulnasoft.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: khulnasoft.Input<khulnasoft.ID>, opts?: khulnasoft.CustomResourceOptions): ResourceInput {
        return new ResourceInput(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __khulnasoftType = 'example::ResourceInput';
    ...
    public static isInstance(obj: any): obj is ResourceInput {
        ...
        return obj['__khulnasoftType'] === ResourceInput.__khulnasoftType;
    }

    public /*out*/ readonly bar!: khulnasoft.Output<string | undefined>;
     ...
     */
    constructor(name: string, args?: ResourceInputArgs, opts?: khulnasoft.CustomResourceOptions) {
        ...
        super(ResourceInput.__khulnasoftType, name, resourceInputs, opts);
    }
}
