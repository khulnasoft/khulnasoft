...
export class MainComponent extends khulnasoft.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: khulnasoft.Input<khulnasoft.ID>, opts?: khulnasoft.CustomResourceOptions): MainComponent {
        return new MainComponent(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __khulnasoftType = 'example::MainComponent';
    ...
    public static isInstance(obj: any): obj is MainComponent {
        ...
        return obj['__khulnasoftType'] === MainComponent.__khulnasoftType;
    }
     ...
     */
    constructor(name: string, args?: MainComponentArgs, opts?: khulnasoft.CustomResourceOptions) {
        ...
        super(MainComponent.__khulnasoftType, name, resourceInputs, opts);
    }
}
