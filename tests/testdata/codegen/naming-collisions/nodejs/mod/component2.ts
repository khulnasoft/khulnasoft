...
export class Component2 extends khulnasoft.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: khulnasoft.Input<khulnasoft.ID>, opts?: khulnasoft.CustomResourceOptions): Component2 {
        return new Component2(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __khulnasoftType = 'example:mod:Component2';
    ...
    public static isInstance(obj: any): obj is Component2 {
        ...
        return obj['__khulnasoftType'] === Component2.__khulnasoftType;
    }
     ...
     */
    constructor(name: string, args?: Component2Args, opts?: khulnasoft.CustomResourceOptions) {
        ...
        super(Component2.__khulnasoftType, name, resourceInputs, opts);
    }
}
