...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">ModuleResource</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ModuleResourceArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/khulnasoft/khulnasoft/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewModuleResource</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/khulnasoft/sdk/v3/go/khulnasoft?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ModuleResourceArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/khulnasoft/khulnasoft/sdk/v3/go/khulnasoft?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ModuleResource</span>, error)</span></code></pre></div>
</div></khulnasoft-choosable>
</div>
...
example, err := foobar.NewModuleResource(ctx, "moduleResourceResource", &foobar.ModuleResourceArgs{
	PlainRequiredBool:   false,
	RequiredString:      khulnasoft.String("string"),
	RequiredNumber:      khulnasoft.Float64(0),
	RequiredEnum:        foobar.EnumThingFour,
	RequiredBool:        khulnasoft.Bool(false),
	PlainRequiredString: "string",
	PlainRequiredNumber: 0,
	PlainRequiredConst:  "string",
	OptionalString:      khulnasoft.String("string"),
	PlainOptionalString: "string",
	PlainOptionalNumber: 0,
	PlainOptionalConst:  "string",
	PlainOptionalBool:   false,
	OptionalBool:        khulnasoft.Bool(false),
	OptionalNumber:      khulnasoft.Float64(0),
	OptionalEnum:        foobar.EnumThingFour,
	OptionalConst:       khulnasoft.String("string"),
})
```
...
<h4 id="enumthing">
Enum<wbr>Thing<khulnasoft-choosable type="language" values="python,go" class="inline">, Enum<wbr>Thing<wbr>Args</khulnasoft-choosable>
</h4>
