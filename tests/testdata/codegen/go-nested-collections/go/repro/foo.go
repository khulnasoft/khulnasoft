...
type Foo struct {
	...
	PrivateEndpoint khulnasoft.StringMapMapMapOutput `khulnasoft:"privateEndpoint"`
}
...
func (o FooOutput) PrivateEndpoint() khulnasoft.StringMapMapMapOutput {
	return o.ApplyT(func(v *Foo) khulnasoft.StringMapMapMapOutput { return v.PrivateEndpoint }).(khulnasoft.StringMapMapMapOutput)
}
