...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">khulnasoft:providers:std</span><span class="p"></span>
