...
export class Person extends khulnasoft.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: khulnasoft.Input<khulnasoft.ID>, opts?: khulnasoft.CustomResourceOptions): Person {
        return new Person(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __khulnasoftType = 'example::Person';
    ...
    public static isInstance(obj: any): obj is Person {
        ...
        return obj['__khulnasoftType'] === Person.__khulnasoftType;
    }

    public readonly name!: khulnasoft.Output<string | undefined>;
    public readonly pets!: khulnasoft.Output<outputs.Pet[] | undefined>;
     ...
     */
    constructor(name: string, args?: PersonArgs, opts?: khulnasoft.CustomResourceOptions) {
        ...
        super(Person.__khulnasoftType, name, resourceInputs, opts);
    }
}
...
export interface PersonArgs {
    ...
    pets?: khulnasoft.Input<khulnasoft.Input<inputs.PetArgs>[]>;
}
