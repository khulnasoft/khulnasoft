...
export class Resource extends khulnasoft.CustomResource {
    ...
    /** @internal */
    public static readonly __khulnasoftType = 'example::Resource';
    ...
    public readonly bar!: khulnasoft.Output<string | undefined>;
    public /*out*/ readonly baz!: khulnasoft.Output<string | undefined>;
    ...
    constructor(name: string, args?: ResourceArgs, opts?: khulnasoft.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            resourceInputs["bar"] = args?.bar ? khulnasoft.secret(args.bar) : undefined;
