...
class Resource(khulnasoft.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["bar"] = None if bar is None else khulnasoft.Output.secret(bar)
            __props__.__dict__["baz"] = None
        secret_opts = khulnasoft.ResourceOptions(additional_secret_outputs=["bar", "baz"])
    ...
    @property
    @khulnasoft.getter
    def bar(self) -> khulnasoft.Output[Optional[str]]:
        return khulnasoft.get(self, "bar")

    @property
    @khulnasoft.getter
    def baz(self) -> khulnasoft.Output[Optional[str]]:
