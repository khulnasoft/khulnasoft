...
class BarResource(khulnasoft.ComponentResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BarResourceArgs, khulnasoft.ResourceOptions, *args, **kwargs)
