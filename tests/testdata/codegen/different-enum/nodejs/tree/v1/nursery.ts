...
export class Nursery extends khulnasoft.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: khulnasoft.Input<khulnasoft.ID>, opts?: khulnasoft.CustomResourceOptions): Nursery {
        return new Nursery(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __khulnasoftType = 'plant:tree/v1:Nursery';
    ...
    public static isInstance(obj: any): obj is Nursery {
        ...
        return obj['__khulnasoftType'] === Nursery.__khulnasoftType;
    }
     ...
     */
    constructor(name: string, args: NurseryArgs, opts?: khulnasoft.CustomResourceOptions) {
        ...
        super(Nursery.__khulnasoftType, name, resourceInputs, opts);
    }
}
...
export interface NurseryArgs {
     ...
     */
    sizes?: khulnasoft.Input<{[key: string]: khulnasoft.Input<enums.tree.v1.TreeSize>}>;
    /**
     * The varieties available
     */
    varieties: khulnasoft.Input<khulnasoft.Input<enums.tree.v1.RubberTreeVariety>[]>;
}
