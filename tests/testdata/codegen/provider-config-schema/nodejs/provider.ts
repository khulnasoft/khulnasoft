...
export class Provider extends khulnasoft.ProviderResource {
    /** @internal */
    public static readonly __khulnasoftType = 'configstation';
    ...
    constructor(name: string, args?: ProviderArgs, opts?: khulnasoft.ResourceOptions) {
        ...
        opts = opts || {};
        {
            ...
            resourceInputs["secretSandwiches"] = khulnasoft.output(args?.secretSandwiches ? khulnasoft.secret(args.secretSandwiches) : undefined).apply(JSON.stringify);
        }
...
export interface ProviderArgs {
     ...
     */
    favoriteColor?: khulnasoft.Input<string | enums.Color>;
    /**
     * Super duper secret sandwiches.
     */
    secretSandwiches?: khulnasoft.Input<khulnasoft.Input<inputs.config.SandwichArgs>[]>;
}
