...
class BasicResourceV2(khulnasoft.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BasicResourceV2Args, khulnasoft.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = khulnasoft.ResourceOptions(aliases=[khulnasoft.Alias(type_="example:index:BasicResource")])
    ...
    def get(resource_name: str,
            ...
            opts: Optional[khulnasoft.ResourceOptions] = None) -> 'BasicResourceV2':
        """
