...
class Cat(khulnasoft.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        secret_opts = khulnasoft.ResourceOptions(additional_secret_outputs=["name"])
        opts = khulnasoft.ResourceOptions.merge(opts, secret_opts)
        replace_on_changes = khulnasoft.ResourceOptions(replace_on_changes=["foes.*.associated.color", "foes.*.color", "friends[*].associated.color", "friends[*].color", "name", "toy.color"])
    ...
    @property
    @khulnasoft.getter
    def foes(self) -> khulnasoft.Output[Optional[Mapping[str, 'outputs.Toy']]]:
        return khulnasoft.get(self, "foes")

    @property
    @khulnasoft.getter
    def friends(self) -> khulnasoft.Output[Optional[Sequence['outputs.Toy']]]:
        return khulnasoft.get(self, "friends")
    ...
    @property
    @khulnasoft.getter
    def other(self) -> khulnasoft.Output[Optional['God']]:
        return khulnasoft.get(self, "other")

    @property
    @khulnasoft.getter
    def toy(self) -> khulnasoft.Output[Optional['outputs.Toy']]:
        return khulnasoft.get(self, "toy")
