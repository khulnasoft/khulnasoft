...
class God(khulnasoft.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GodArgs, khulnasoft.ResourceOptions, *args, **kwargs)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[khulnasoft.ResourceOptions] = None) -> 'God':
        """
    ...
    @property
    @khulnasoft.getter
    def backwards(self) -> khulnasoft.Output[Optional['Dog']]:
        return khulnasoft.get(self, "backwards")
