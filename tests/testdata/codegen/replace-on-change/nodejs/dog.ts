...
export class Dog extends khulnasoft.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: khulnasoft.Input<khulnasoft.ID>, opts?: khulnasoft.CustomResourceOptions): Dog {
        return new Dog(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __khulnasoftType = 'example::Dog';
    ...
    public static isInstance(obj: any): obj is Dog {
        ...
        return obj['__khulnasoftType'] === Dog.__khulnasoftType;
    }

    public /*out*/ readonly bone!: khulnasoft.Output<string | undefined>;
     ...
     */
    constructor(name: string, args?: DogArgs, opts?: khulnasoft.CustomResourceOptions) {
        ...
        super(Dog.__khulnasoftType, name, resourceInputs, opts);
    }
}
