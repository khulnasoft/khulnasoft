...
export class NoRecursive extends khulnasoft.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: khulnasoft.Input<khulnasoft.ID>, opts?: khulnasoft.CustomResourceOptions): NoRecursive {
        return new NoRecursive(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __khulnasoftType = 'example::NoRecursive';
    ...
    public static isInstance(obj: any): obj is NoRecursive {
        ...
        return obj['__khulnasoftType'] === NoRecursive.__khulnasoftType;
    }

    public /*out*/ readonly rec!: khulnasoft.Output<outputs.Rec | undefined>;
    public /*out*/ readonly replaceMe!: khulnasoft.Output<string | undefined>;
     ...
     */
    constructor(name: string, args?: NoRecursiveArgs, opts?: khulnasoft.CustomResourceOptions) {
        ...
        super(NoRecursive.__khulnasoftType, name, resourceInputs, opts);
    }
}
