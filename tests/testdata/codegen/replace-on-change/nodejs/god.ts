...
export class God extends khulnasoft.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: khulnasoft.Input<khulnasoft.ID>, opts?: khulnasoft.CustomResourceOptions): God {
        return new God(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __khulnasoftType = 'example::God';
    ...
    public static isInstance(obj: any): obj is God {
        ...
        return obj['__khulnasoftType'] === God.__khulnasoftType;
    }

    public /*out*/ readonly backwards!: khulnasoft.Output<Dog | undefined>;
     ...
     */
    constructor(name: string, args?: GodArgs, opts?: khulnasoft.CustomResourceOptions) {
        ...
        super(God.__khulnasoftType, name, resourceInputs, opts);
    }
}
