...
class ExampleServerArgs:
    def __init__(__self__, *,
                 properties_collection: Optional[khulnasoft.Input[Sequence[khulnasoft.Input[Union['ServerPropertiesForReplicaArgs', 'ServerPropertiesForRestoreArgs']]]]] = None):
        """
        The set of arguments for constructing a ExampleServer resource.
        """
        if properties_collection is not None:
            khulnasoft.set(__self__, "properties_collection", properties_collection)

    @property
    @khulnasoft.getter(name="propertiesCollection")
    def properties_collection(self) -> Optional[khulnasoft.Input[Sequence[khulnasoft.Input[Union['ServerPropertiesForReplicaArgs', 'ServerPropertiesForRestoreArgs']]]]]:
        return khulnasoft.get(self, "properties_collection")

    @properties_collection.setter
    def properties_collection(self, value: Optional[khulnasoft.Input[Sequence[khulnasoft.Input[Union['ServerPropertiesForReplicaArgs', 'ServerPropertiesForRestoreArgs']]]]]):
        khulnasoft.set(self, "properties_collection", value)
...
class ExampleServer(khulnasoft.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties_collection: Optional[khulnasoft.Input[Sequence[khulnasoft.Input[Union[khulnasoft.InputType['ServerPropertiesForReplicaArgs'], khulnasoft.InputType['ServerPropertiesForRestoreArgs']]]]]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["properties_collection"] = properties_collection
