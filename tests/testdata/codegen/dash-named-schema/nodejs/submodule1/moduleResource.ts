...
export class ModuleResource extends khulnasoft.CustomResource {
    ...
    /** @internal */
    public static readonly __khulnasoftType = 'foo-bar:submodule1:ModuleResource';
    ...
    public readonly thing!: khulnasoft.Output<outputs.TopLevel | undefined>;
...
export interface ModuleResourceArgs {
    thing?: khulnasoft.Input<inputs.TopLevelArgs>;
}
