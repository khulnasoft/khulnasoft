...
class FOOEncryptedBarClass(khulnasoft.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FOOEncryptedBarClassArgs, khulnasoft.ResourceOptions, *args, **kwargs)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[khulnasoft.ResourceOptions] = None) -> 'FOOEncryptedBarClass':
        """
