...
class ComponentArgs:
    def __init__(__self__, *,
                 ...
                 baz_map: Optional[Mapping[str, khulnasoft.Input['FooArgs']]] = None,
                 d: Optional[int] = None,
                 f: Optional[str] = None,
        ...
        if baz_map is not None:
            khulnasoft.set(__self__, "baz_map", baz_map)
        if d is not None:
    ...
    @property
    @khulnasoft.getter(name="bazMap")
    def baz_map(self) -> Optional[Mapping[str, khulnasoft.Input['FooArgs']]]:
        return khulnasoft.get(self, "baz_map")

    @baz_map.setter
    def baz_map(self, value: Optional[Mapping[str, khulnasoft.Input['FooArgs']]]):
        khulnasoft.set(self, "baz_map", value)
...
class Component(khulnasoft.ComponentResource):
    ...
    def __init__(__self__,
                 ...
                 baz_map: Optional[Mapping[str, khulnasoft.Input[Union['FooArgs', 'FooArgsDict']]]] = None,
                 c: Optional[int] = None,
                 d: Optional[int] = None,
                 e: Optional[str] = None,
                 f: Optional[str] = None,
