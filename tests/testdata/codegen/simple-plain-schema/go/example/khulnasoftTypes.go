...
func (i FooArgs) ToOutput(ctx context.Context) khulnasoftx.Output[Foo] {
...
func (i *fooPtrType) ToOutput(ctx context.Context) khulnasoftx.Output[*Foo] {
	return khulnasoftx.Output[*Foo]{
...
func (i FooArray) ToOutput(ctx context.Context) khulnasoftx.Output[[]Foo] {
	return khulnasoftx.Output[[]Foo]{
...
func (i FooMap) ToOutput(ctx context.Context) khulnasoftx.Output[map[string]Foo] {
	return khulnasoftx.Output[map[string]Foo]{
...
func (o FooPtrOutput) ToOutput(ctx context.Context) khulnasoftx.Output[*Foo] {
	return khulnasoftx.Output[*Foo]{
		OutputState: o.OutputState,
	}
}
...
func (o FooArrayOutput) ToOutput(ctx context.Context) khulnasoftx.Output[[]Foo] {
	return khulnasoftx.Output[[]Foo]{
		OutputState: o.OutputState,
	}
}
...
func (o FooMapOutput) ToOutput(ctx context.Context) khulnasoftx.Output[map[string]Foo] {
	return khulnasoftx.Output[map[string]Foo]{
		OutputState: o.OutputState,
	}
}
