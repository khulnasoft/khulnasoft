...
type OutputOnlyObjectTypeOutput struct{ *khulnasoft.OutputState }
...
func (o OutputOnlyObjectTypeOutput) Foo() khulnasoft.StringPtrOutput {
	return o.ApplyT(func(v OutputOnlyObjectType) *string { return v.Foo }).(khulnasoft.StringPtrOutput)
}

type OutputOnlyObjectTypePtrOutput struct{ *khulnasoft.OutputState }
...
func (o OutputOnlyObjectTypePtrOutput) Foo() khulnasoft.StringPtrOutput {
...
type OutputOnlyObjectTypeArrayOutput struct{ *khulnasoft.OutputState }
...
func (o OutputOnlyObjectTypeArrayOutput) Index(i khulnasoft.IntInput) OutputOnlyObjectTypeOutput {
	return khulnasoft.All(o, i).ApplyT(func(vs []interface{}) OutputOnlyObjectType {
...
func init() {
	...
	khulnasoft.RegisterOutputType(OutputOnlyObjectTypeOutput{})
	khulnasoft.RegisterOutputType(OutputOnlyObjectTypePtrOutput{})
	khulnasoft.RegisterOutputType(OutputOnlyObjectTypeArrayOutput{})
