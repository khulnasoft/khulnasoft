...
def func_with_all_optional_inputs(a: Optional[Union['HelmReleaseSettings', 'HelmReleaseSettingsDict']] = None,
    ...
    __ret__ = khulnasoft.runtime.invoke('mypkg::funcWithAllOptionalInputs', __args__, opts=opts, typ=FuncWithAllOptionalInputsResult).value
...
def func_with_all_optional_inputs_output(a: Optional[khulnasoft.Input[Optional[Union['HelmReleaseSettings', 'HelmReleaseSettingsDict']]]] = None,
    ...
    __args__['b'] = b
    opts = khulnasoft.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = khulnasoft.runtime.invoke_output('mypkg::funcWithAllOptionalInputs', __args__, opts=opts, typ=FuncWithAllOptionalInputsResult)
