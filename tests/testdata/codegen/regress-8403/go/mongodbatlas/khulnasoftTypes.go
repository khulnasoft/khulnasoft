...
func (i GetCustomDbRolesResultArgs) ToGetCustomDbRolesResultOutputWithContext(ctx context.Context) GetCustomDbRolesResultOutput {
	return khulnasoft.ToOutputWithContext(ctx, i).(GetCustomDbRolesResultOutput)
}
...
func (i GetCustomDbRolesResultArgs) ToGetCustomDbRolesResultPtrOutputWithContext(ctx context.Context) GetCustomDbRolesResultPtrOutput {
	return khulnasoft.ToOutputWithContext(ctx, i).(GetCustomDbRolesResultOutput).ToGetCustomDbRolesResultPtrOutputWithContext(ctx)
}
...
func (i *getCustomDbRolesResultPtrType) ToGetCustomDbRolesResultPtrOutputWithContext(ctx context.Context) GetCustomDbRolesResultPtrOutput {
	return khulnasoft.ToOutputWithContext(ctx, i).(GetCustomDbRolesResultPtrOutput)
}

type GetCustomDbRolesResultOutput struct{ *khulnasoft.OutputState }
...
type GetCustomDbRolesResultPtrOutput struct{ *khulnasoft.OutputState }
...
func init() {
	khulnasoft.RegisterInputType(reflect.TypeOf((*GetCustomDbRolesResultInput)(nil)).Elem(), GetCustomDbRolesResultArgs{})
	khulnasoft.RegisterInputType(reflect.TypeOf((*GetCustomDbRolesResultPtrInput)(nil)).Elem(), GetCustomDbRolesResultArgs{})
	khulnasoft.RegisterOutputType(GetCustomDbRolesResultOutput{})
	khulnasoft.RegisterOutputType(GetCustomDbRolesResultPtrOutput{})
}
