 ...
 */
export function getClientConfig(opts?: khulnasoft.InvokeOptions): Promise<GetClientConfigResult> {
    opts = khulnasoft.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return khulnasoft.runtime.invoke("mypkg::getClientConfig", {
    }, opts);
}
 ...
 * Failing example taken from azure-native. Original doc: Use this function to access the current configuration of the native Azure provider.
 */
export function getClientConfigOutput(opts?: khulnasoft.InvokeOptions): khulnasoft.Output<GetClientConfigResult> {
    opts = khulnasoft.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return khulnasoft.runtime.invokeOutput("mypkg::getClientConfig", {
    }, opts);
}
