...
def get_bastion_shareable_link(bastion_host_name: Optional[str] = None,
                               ...
                               opts: Optional[khulnasoft.InvokeOptions] = None) -> AwaitableGetBastionShareableLinkResult:
    """
    Response for all the Bastion Shareable Link endpoints.
    ...
    __ret__ = khulnasoft.runtime.invoke('mypkg::getBastionShareableLink', __args__, opts=opts, typ=GetBastionShareableLinkResult).value

    return AwaitableGetBastionShareableLinkResult(
        next_link=khulnasoft.get(__ret__, 'next_link'))
def get_bastion_shareable_link_output(bastion_host_name: Optional[khulnasoft.Input[str]] = None,
                                      resource_group_name: Optional[khulnasoft.Input[str]] = None,
                                      vms: Optional[khulnasoft.Input[Optional[Sequence[Union['BastionShareableLink', 'BastionShareableLinkDict']]]]] = None,
                                      opts: Optional[khulnasoft.InvokeOptions] = None) -> khulnasoft.Output[GetBastionShareableLinkResult]:
    """
    Response for all the Bastion Shareable Link endpoints.
    API Version: 2020-11-01.
    ...
    __args__['vms'] = vms
    opts = khulnasoft.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = khulnasoft.runtime.invoke_output('mypkg::getBastionShareableLink', __args__, opts=opts, typ=GetBastionShareableLinkResult)
