...
def get_integration_runtime_object_metadatum(factory_name: Optional[str] = None,
                                             ...
                                             opts: Optional[khulnasoft.InvokeOptions] = None) -> AwaitableGetIntegrationRuntimeObjectMetadatumResult:
    """
    ...
    __ret__ = khulnasoft.runtime.invoke('mypkg::getIntegrationRuntimeObjectMetadatum', __args__, opts=opts, typ=GetIntegrationRuntimeObjectMetadatumResult).value
...
def get_integration_runtime_object_metadatum_output(factory_name: Optional[khulnasoft.Input[str]] = None,
                                                    integration_runtime_name: Optional[khulnasoft.Input[str]] = None,
                                                    metadata_path: Optional[khulnasoft.Input[Optional[str]]] = None,
                                                    resource_group_name: Optional[khulnasoft.Input[str]] = None,
                                                    opts: Optional[khulnasoft.InvokeOptions] = None) -> khulnasoft.Output[GetIntegrationRuntimeObjectMetadatumResult]:
    """
    Another failing example. A list of SSIS object metadata.
    API Version: 2018-06-01.
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = khulnasoft.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = khulnasoft.runtime.invoke_output('mypkg::getIntegrationRuntimeObjectMetadatum', __args__, opts=opts, typ=GetIntegrationRuntimeObjectMetadatumResult)
