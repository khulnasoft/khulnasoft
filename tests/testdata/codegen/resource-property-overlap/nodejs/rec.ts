...
export class Rec extends khulnasoft.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: khulnasoft.Input<khulnasoft.ID>, opts?: khulnasoft.CustomResourceOptions): Rec {
        return new Rec(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __khulnasoftType = 'example::Rec';
    ...
    public static isInstance(obj: any): obj is Rec {
        ...
        return obj['__khulnasoftType'] === Rec.__khulnasoftType;
    }

    public /*out*/ readonly rec!: khulnasoft.Output<Rec | undefined>;
     ...
     */
    constructor(name: string, args?: RecArgs, opts?: khulnasoft.CustomResourceOptions) {
        ...
        super(Rec.__khulnasoftType, name, resourceInputs, opts);
    }
}
