...
func (i ContainerArgs) ToOutput(ctx context.Context) khulnasoftx.Output[Container] {
...
func (i *containerPtrType) ToOutput(ctx context.Context) khulnasoftx.Output[*Container] {
	return khulnasoftx.Output[*Container]{
...
func (o ContainerPtrOutput) ToOutput(ctx context.Context) khulnasoftx.Output[*Container] {
	return khulnasoftx.Output[*Container]{
		OutputState: o.OutputState,
	}
}
