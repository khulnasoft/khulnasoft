...
type ConfigArgs struct {
	Foo khulnasoftx.Input[*string] `khulnasoft:"foo"`
}
...
func (i *ConfigArgs) ToOutput(ctx context.Context) khulnasoftx.Output[*ConfigArgs] {
...
func (o ConfigOutput) Foo() khulnasoftx.Output[*string] {
	return khulnasoftx.Apply[Config](o, func(v Config) *string { return v.Foo })
}
