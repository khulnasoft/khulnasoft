 ...
 * ```
 */
export class SqlResourceSqlContainer extends khulnasoft.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: khulnasoft.Input<khulnasoft.ID>, opts?: khulnasoft.CustomResourceOptions): SqlResourceSqlContainer {
        return new SqlResourceSqlContainer(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __khulnasoftType = 'azure-native:documentdb:SqlResourceSqlContainer';
    ...
    public static isInstance(obj: any): obj is SqlResourceSqlContainer {
        ...
        return obj['__khulnasoftType'] === SqlResourceSqlContainer.__khulnasoftType;
    }

    public /*out*/ readonly resource!: khulnasoft.Output<outputs.documentdb.SqlContainerGetPropertiesResponseResource | undefined>;
     ...
     */
    constructor(name: string, args?: SqlResourceSqlContainerArgs, opts?: khulnasoft.CustomResourceOptions) {
        ...
        super(SqlResourceSqlContainer.__khulnasoftType, name, resourceInputs, opts);
    }
}
