...
export interface HelmReleaseSettingsArgs {
     ...
     * The backend storage driver for Helm. Values are: configmap, secret, memory, sql.
     */
    driver?: khulnasoft.Input<string>;
    /**
     * The path to the helm plugins directory.
     */
    pluginsPath?: khulnasoft.Input<string>;
    /**
     * to test required args
     */
    requiredArg: khulnasoft.Input<string>;
}
/**
...
export interface KubeClientSettingsArgs {
     ...
     */
    burst?: khulnasoft.Input<number>;
    /**
     * Maximum queries per second (QPS) to the API server from this client. Default value is 5.
     */
    qps?: khulnasoft.Input<number>;
    recTest?: khulnasoft.Input<inputs.KubeClientSettingsArgs>;
}
/**
...
export function kubeClientSettingsArgsProvideDefaults(val: KubeClientSettingsArgs): KubeClientSettingsArgs {
    return {
        ...
        recTest: (val.recTest ? khulnasoft.output(val.recTest).apply(inputs.kubeClientSettingsArgsProvideDefaults) : undefined),
    };
}
...
export interface LayeredTypeArgs {
     ...
     */
    answer?: khulnasoft.Input<number>;
    other: khulnasoft.Input<inputs.HelmReleaseSettingsArgs>;
    /**
     ...
     */
    question?: khulnasoft.Input<string>;
    recursive?: khulnasoft.Input<inputs.LayeredTypeArgs>;
    /**
     * To ask and answer
     */
    thinker: khulnasoft.Input<string>;
}
/**
...
export function layeredTypeArgsProvideDefaults(val: LayeredTypeArgs): LayeredTypeArgs {
    return {
        ...
        other: khulnasoft.output(val.other).apply(inputs.helmReleaseSettingsArgsProvideDefaults),
        ...
        recursive: (val.recursive ? khulnasoft.output(val.recursive).apply(inputs.layeredTypeArgsProvideDefaults) : undefined),
...
export interface TypArgs {
    mod1?: khulnasoft.Input<inputs.mod1.TypArgs>;
    mod2?: khulnasoft.Input<inputs.mod2.TypArgs>;
    val?: khulnasoft.Input<string>;
}
/**
...
export function typArgsProvideDefaults(val: TypArgs): TypArgs {
    return {
        ...val,
        mod1: (val.mod1 ? khulnasoft.output(val.mod1).apply(inputs.mod1.typArgsProvideDefaults) : undefined),
        mod2: (val.mod2 ? khulnasoft.output(val.mod2).apply(inputs.mod2.typArgsProvideDefaults) : undefined),
