...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">Foo</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">FooArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/khulnasoft/khulnasoft/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
Burst: khulnasoft.Int(0),
Qps: khulnasoft.Float64(0),
RecTest: khulnasoft.Any(kubeClientSettings),
},
Argument: "string",
KubeClientSettings: khulnasoft.Any(kubeClientSettings),
Settings: &example.LayeredTypeArgs{
Other: &example.HelmReleaseSettingsArgs{
RequiredArg: khulnasoft.String("string"),
Driver: khulnasoft.String("string"),
PluginsPath: khulnasoft.String("string"),
},
Thinker: khulnasoft.String("string"),
Answer: khulnasoft.Float64(0),
PlainOther: interface{}{
RequiredArg: khulnasoft.String("string"),
Driver: khulnasoft.String("string"),
PluginsPath: khulnasoft.String("string"),
},
Question: khulnasoft.String("string"),
Recursive: khulnasoft.Any(layeredType),
},
})
```
...
Helm<wbr>Release<wbr>Settings<khulnasoft-choosable type="language" values="python,go" class="inline">, Helm<wbr>Release<wbr>Settings<wbr>Args</khulnasoft-choosable>
</h4>
...
<h4 id="layeredtype">
Layered<wbr>Type<khulnasoft-choosable type="language" values="python,go" class="inline">, Layered<wbr>Type<wbr>Args</khulnasoft-choosable>
</h4>
