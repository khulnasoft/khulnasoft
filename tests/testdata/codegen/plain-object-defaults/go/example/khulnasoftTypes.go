...
func (val *HelmReleaseSettingsArgs) Defaults() *HelmReleaseSettingsArgs {
	...
	if tmp.Driver == nil {
		if d := internal.GetEnvOrDefault("secret", nil, "PULUMI_K8S_HELM_DRIVER"); d != nil {
			tmp.Driver = khulnasoft.StringPtr(d.(string))
		}
	}
	if tmp.PluginsPath == nil {
		if d := internal.GetEnvOrDefault(nil, nil, "PULUMI_K8S_HELM_PLUGINS_PATH"); d != nil {
			tmp.PluginsPath = khulnasoft.StringPtr(d.(string))
		}
	}
	return &tmp
}
...
func (val *KubeClientSettingsArgs) Defaults() *KubeClientSettingsArgs {
	...
	if tmp.Burst == nil {
		if d := internal.GetEnvOrDefault(nil, internal.ParseEnvInt, "PULUMI_K8S_CLIENT_BURST"); d != nil {
			tmp.Burst = khulnasoft.IntPtr(d.(int))
		}
	}
	if tmp.Qps == nil {
		if d := internal.GetEnvOrDefault(nil, internal.ParseEnvFloat, "PULUMI_K8S_CLIENT_QPS"); d != nil {
			tmp.Qps = khulnasoft.Float64Ptr(d.(float64))
		}
	}
...
func (val *LayeredTypeArgs) Defaults() *LayeredTypeArgs {
	...
	tmp := *val
	if tmp.Answer == nil {
		tmp.Answer = khulnasoft.Float64Ptr(42.0)
	}
	...
	if tmp.Question == nil {
		if d := internal.GetEnvOrDefault("<unknown>", nil, "PULUMI_THE_QUESTION"); d != nil {
			tmp.Question = khulnasoft.StringPtr(d.(string))
		}
	}

	if tmp.Thinker == nil {
		tmp.Thinker = khulnasoft.String("not a good interaction")
	}
	return &tmp
}
...
func (val *TypArgs) Defaults() *TypArgs {
	...
	if tmp.Val == nil {
		tmp.Val = khulnasoft.StringPtr("mod main")
	}
	return &tmp
}
