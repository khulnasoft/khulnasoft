...
if not MYPY:
    class MyTypeDict(TypedDict):
        my_prop: str
        external_prop: NotRequired['khulnasoft_kubernetes.core.v1.PodArgs']
...
if not MYPY:
    class MyTypeArgsDict(TypedDict):
        ...
        external_prop: NotRequired[khulnasoft.Input['khulnasoft_kubernetes.core.v1.PodArgs']]
        my_other_prop: NotRequired[khulnasoft.Input[float]]
elif False:
