...
```
# lsif-index-tester
go install github.com/khulnasoft/khulnasoft/lib/codeintel/tools/lsif-index-tester

# lsif-semantic-diff
go install github.com/khulnasoft/khulnasoft/lib/codeintel/tools/lsif-semantic-diff

# lsif-validate
go install github.com/khulnasoft/khulnasoft/lib/codeintel/tools/lsif-validate

# lsif-visualize
go install github.com/khulnasoft/khulnasoft/lib/codeintel/tools/lsif-visualize
```
