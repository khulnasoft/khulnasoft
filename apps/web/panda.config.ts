...
import { GLOBAL_CSS, khulnasoftPandaPreset } from '@khulnasoft/khulnasofti';

const STYLED_SYSTEM_PATH_BASE = './node_modules/@khulnasoft/khulnasofti/';
...
export default defineConfig({
   ...
   * Most things should likely go in the `KhulnasoftPandaPreset`, but if there is something
  ...
  importMap: '@khulnasoft/khulnasofti',
