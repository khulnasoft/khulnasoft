    ...
    h(
      ...
      lines.map((line, index) => {
        ...
        if (
          ...
          line?.some(
            token => token.content === 'khulnasoft' && token.color === 'var(--shiki-token-text)'
          ) // works fine for Python and JS
        ) {
          isKhulnasoftImport = true // TODO: Actually use, probably to dim the line
        }
