...
import { colors, Checkbox, Tooltip } from '@khulnasoft/design-system';
import { ProductUseCasesEnum } from '@khulnasoft/shared';
...
const tooltipLabel = {
  [ProductUseCasesEnum.IN_APP]:
    'Utilize Khulnasoft’s pre-built customizable in-app component. Or opt for the headless library to create your own in-app notification center',
