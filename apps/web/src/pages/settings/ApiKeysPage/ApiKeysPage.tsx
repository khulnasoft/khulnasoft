import { IconOutlineVisibility, IconOutlineVisibilityOff, IconRefresh, IconSize, Input } from '@khulnasoft/design-system';
import { Flex } from '@khulnasoft/khulnasofti/jsx';
    ...
    <SettingsPageContainer title="API keys">
      <Flex direction={'column'} gap={'200'} maxW="37.5rem">
        <Input
          ...
          label="Secret Key"
          description="The secret key to interact with the Khulnasoft API"
          rightSection={
