...
import { colors, Text, ReactLogo, AngularLogo, JavaScriptLogo, VueLogo, IframeLogo } from '@khulnasoft/design-system';
import { UTM_CAMPAIGN_QUERY_PARAM } from '@khulnasoft/shared';

import { FrameworkEnum } from '../../quick-start/consts';

const KhulnasoftInAppFrameworksHolder = styled.div`
  display: flex;
...
const frameworks = [
  ...
  { icon: AngularLogo, name: 'Angular', frameworkEnum: FrameworkEnum.ANGULAR },
  {
    icon: JavaScriptLogo,
    name: 'Web Component',
    href: `https://docs.khulnasoft.com/notification-center/client/web-component${UTM_CAMPAIGN_QUERY_PARAM}`,
  },
  {
    icon: JavaScriptLogo,
    name: 'Headless',
    href: `https://docs.khulnasoft.com/notification-center/client/headless/get-started${UTM_CAMPAIGN_QUERY_PARAM}`,
  },
  { icon: VueLogo, name: 'Vue', frameworkEnum: FrameworkEnum.VUE },
  { icon: IframeLogo, name: 'iFrame', frameworkEnum: FrameworkEnum.JS },
];

export const KhulnasoftInAppFrameworks = ({ onFrameworkClick }: { onFrameworkClick: (framework: FrameworkEnum) => void }) => {
  return (
    <KhulnasoftInAppFrameworksHolder data-test-id="khulnasoft-in-app-frameworks">
    ...
    </KhulnasoftInAppFrameworksHolder>
  );
};
