...
import { Popover, Switch, Text, Button, useColorScheme } from '@khulnasoft/design-system';
...
const PopoverContent = () => {
  ...
  return (
    <Group spacing={8}>
      <Text>Upgrade your billing plan to remove Khulnasoft branding</Text>
      <Button
        size="xs"
        variant="light"
        onClick={() => {
...
export const KhulnasoftInAppRemoveBranding = ({ control }: { control: any }) => {
  ...
  return (
    <Controller
      ...
      render={({ field }) => (
        <SwitchWrapper>
          <SwitchLabel>Remove "Powered by Khulnasoft" branding</SwitchLabel>
          <Popover
            ...
            target={
              <Switch
                ...
                data-test-id="remove-khulnasoft-branding"
                checked={field.value}
