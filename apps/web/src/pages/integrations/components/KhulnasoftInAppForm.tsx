...
import type { IResponseError, ICredentialsDto } from '@khulnasoft/shared';
import { UTM_CAMPAIGN_QUERY_PARAM } from '@khulnasoft/shared';
import { Switch, Button, colors, CircleArrowRight } from '@khulnasoft/design-system';
...
export const KhulnasoftInAppForm = ({
  provider,
  showModal,
}: {
