...
import { ChannelTypeEnum, IConfigCredentials } from '@khulnasoft/shared';

import { colors, shadows, Text, Tooltip } from '@khulnasoft/design-system';
import { useIntegrationLimit } from '../../../hooks';
import type { IIntegratedProvider } from '../types';
import { CardStatusBar } from './CardStatusBar';
import { LimitBar } from './LimitBar';

export function KhulnasoftIntegrationCard({
  provider,
...
function TooltipLabel({
  ...
  const label = isLimitReached
    ...
    : // eslint-disable-next-line max-len
      `The predefined free Khulnasoft provider allows sending ${limit} ${unit} per month. Configure a different ${channel} provider to send more.`;
