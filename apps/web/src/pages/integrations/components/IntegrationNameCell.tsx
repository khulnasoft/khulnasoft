...
import { colors, IExtendedCellProps, Popover, Text, Star } from '@khulnasoft/design-system';
    ...
    <CellHolder data-test-id="integration-name-cell">
      ...
      <DetailsHolder>
        <NameHolder>
          ...
          {original.name?.toLowerCase().includes('khulnasoft') && original.channelType !== ChannelTypeEnum.IN_APP && (
