...
import { FeatureFlagsKeysEnum, WorkflowCreationSourceEnum } from '@khulnasoft/shared';
      ...
      <Group spacing={8}>
        <Group spacing={4}>
          <When truthy={original.bridge}>
            <Tooltip label="Workflow is handled by Khulnasoft Framework" position="top">
              <div>
    ...
    >
      ...
      <TemplateListTableWrapper>
        ...
        <When truthy={shouldShowEmptyState && isV2Enabled}>
          ...
          >
            To create a workflow in this environment, you need to create a workflow using the @khulnasoft/framework and sync
