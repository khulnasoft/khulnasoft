...
import { ChannelTypeEnum, KHULNASOFT_SMS_EMAIL_PROVIDERS } from '@khulnasoft/shared';
import { Button, colors, Tooltip } from '@khulnasoft/design-system';
...
export const ListProviders = ({
  ...
  const containsKhulnasoftProvider = useMemo(
    () =>
      KHULNASOFT_SMS_EMAIL_PROVIDERS.some(
  ...
  const hasKhulnasoftProvider = providersForTheCurrentEnvironment.length === 1 && containsKhulnasoftProvider;
  ...
  return (
    <ListProvidersContainer>
      ...
      <When truthy={hasKhulnasoftProvider}>
