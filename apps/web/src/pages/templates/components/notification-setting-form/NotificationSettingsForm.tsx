...
import type { IResponseError, INotificationTrigger } from '@khulnasoft/shared';

import { Input, Select, Switch, Tooltip, Check, Copy, When } from '@khulnasoft/design-system';
