...
import { colors, MadeByKhulnasoft } from '@khulnasoft/design-system';
...
export const KhulnasoftButtonHolder = styled.div`
  position: absolute;
  bottom: 4px;
  right: 4px;
  z-index: 10000;
...
export const MadeByKhulnasoftStyled = styled(MadeByKhulnasoft)`
  color: ${colors.B60};
`;
