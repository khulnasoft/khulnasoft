...
import { Button, colors, shadows, Close } from '@khulnasoft/design-system';
import { faFile } from '@fortawesome/free-regular-svg-icons';

import { INotificationTemplateStep, WorkflowCreationSourceEnum } from '@khulnasoft/shared';

import {
  CanvasHolder,
  GroupName,
  MadeByKhulnasoftStyled,
  ModalBodyHolder,
  KhulnasoftButtonHolder,
  TemplateDetails,
  TemplateHeader,
  TemplateItem,
  TemplateName,
      ...
      <ModalBodyHolder data-test-id="templates-store-modal">
        ...
        <TemplatesDetailsHolder>
          ...
          <CanvasHolder>
            ...
            <KhulnasoftButtonHolder>
              <MadeByKhulnasoftStyled width={104} height={20} />
              <Button
