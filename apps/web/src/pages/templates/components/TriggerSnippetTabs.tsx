...
import { INotificationTrigger, INotificationTriggerVariable, TemplateVariableTypeEnum } from '@khulnasoft/shared';

import { colors, Tabs } from '@khulnasoft/design-system';
