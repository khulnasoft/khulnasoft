...
export const MultiChannelUseCaseConst: OnboardingUseCase = {
  ...
  useCaseLink: 'https://docs.khulnasoft.com/channels-and-providers/introduction?utm_campaign=inapp-usecase-multichannel',
  steps: [
    {
      ...
      Description() {
        return (
          <StepDescription>
            <StepText>
              Khulnasoft has set up trial email and SMS providers for you. To expand your options, add more providers in the
            </StepText>
            <GetStartedLink
    ...
    },
    {
      ...
      Description() {
        return (
          <StepDescription>
            <StepText>Khulnasoft has prepared workflow templates. </StepText>
