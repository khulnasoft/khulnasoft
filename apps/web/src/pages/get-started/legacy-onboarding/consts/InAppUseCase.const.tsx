  ...
  steps: [
      ...
      Description() {
        ...
        return (
          <StepDescription>
            ...
            <StepText>
              {' instance, and select a framework to set up credentials in the Khulnasoft’s Integration store.'}
            </StepText>
          </StepDescription>
        );
      },
    },
    {
      ...
      Description() {
        return (
          <StepDescription>
            <StepText>Khulnasoft pre-built a workflow for testing. </StepText>
