...
import { IconCellTower, IconCloudQueue, IconCode, IconHealthAndSafety } from '@khulnasoft/design-system';
    ...
    <Flex className={className} direction="row" alignItems="center" gap="300">
      <div>
        ...
        <Text variant="secondary" className={cx(css({ marginTop: '50' }), mainText)}>
          With Khulnasoft, you write notification workflows in your codebase locally right in your IDE and preview and edit
        ...
        <Flex gap="150" className={css({ marginTop: '150' })}>
          ...
          <div>
            ...
            <Text variant="secondary" className={columnText}>
              Sync local workflows with Khulnasoft Cloud and ease collaboration using the web editor.
            </Text>
          </div>
        </Flex>
      </div>
