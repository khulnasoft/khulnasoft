import { IconLaptopMac, IconOutlineCloudUpload, IconGroup } from '@khulnasoft/khulnasofti/icons';
...
export const onboardingTabs = [
  {
    ...
    description: 'Build and test your first workflow in Khulnasoft Studio',
