...
import { IconCode } from '@khulnasoft/khulnasofti/icons';
    ...
    steps: [
      {
        ...
        content: () => {
          return (
            <>
              <TextElement>
                Khulnasoft works as part of your CI/CD flow, so first, make sure that your application is pushed to a remote
      ...
      },
      {
        ...
        content: () => {
          return (
            <>
              <TextElement>
                Khulnasoft can be synced and updated automatically, on each push to your GitHub repository.
                <br />
      ...
      },
      {
        ...
        content: () => {
          return (
            <>
              <TextElement>
                Publish your application to Vercel following their onboarding instructions, so that the Khulnasoft bridge can
    ...
    steps: [
      {
        ...
        content: () => {
          return (
            <>
              <TextElement>
                Khulnasoft works as part of your existing CI/CD flow, so first, make sure that your application is pushed to a
      ...
      },
      {
        ...
        content: () => {
          return (
            <>
              <TextElement>
                Publish your application to Netlify following their onboarding instructions, so that the Khulnasoft bridge can
      ...
      },
      {
        ...
        content: () => {
          return (
            <>
              <TextElement>
                Publish your application on your hosting provider, so that the Khulnasoft bridge can be accessed from the
                internet.
              </TextElement>
            </>
          );
        ...
        content: () => {
          ...
          return (
            <TextElement>
              ...
              <CodeSnippet
                command={`npx khulnasoft@latest sync --bridge-url <YOUR_DEPLOYED_URL> --secret-key=${
