...
export const faqUrl = `https://docs.khulnasoft.co/notification-center/introduction${UTM_CAMPAIGN_QUERY_PARAM}`;
export const notificationCenterDocsUrl = `https://docs.khulnasoft.co/notification-center/introduction${UTM_CAMPAIGN_QUERY_PARAM}`;
