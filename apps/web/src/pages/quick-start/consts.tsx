...
import { ChannelTypeEnum, UTM_CAMPAIGN_QUERY_PARAM } from '@khulnasoft/shared';
import { Bell, Chat, Mail, Mobile, Sms } from '@khulnasoft/design-system';
...
export const faqUrl = `https://docs.khulnasoft.com/notification-center/introduction${UTM_CAMPAIGN_QUERY_PARAM}`;
export const notificationCenterDocsUrl = `https://docs.khulnasoft.com/notification-center/introduction${UTM_CAMPAIGN_QUERY_PARAM}`;
export const discordInviteUrl = 'https://discord.gg/khulnasoft';
...
const installReactNotificationCenter = 'npm install @khulnasoft/notification-center';
const installReactInbox = 'npm install @khulnasoft/react';
const installAngularNotificationCenter = 'npm install @khulnasoft/notification-center-angular';
const installVueNotificationCenter = 'npm install @khulnasoft/notification-center-vue';
...
import {
  ...
  NotificationBell,
} from '@khulnasoft/notification-center';

export const Header = () => {
  return (
    <KhulnasoftProvider subscriberId={'${onBoardingSubscriberId}'} applicationIdentifier={'${APPLICATION_IDENTIFIER}'}>
...
import { NotificationCenterModule } from '@khulnasoft/notification-center-angular';
...
const vuePluginSnippet = `import NotificationCenterPlugin from '@khulnasoft/notification-center-vue';
import '@khulnasoft/notification-center-vue/dist/style.css';
...
const embedScript = `<script>
  ...
  })(window, document, '${WIDGET_EMBED_PATH}', 'khulnasoft', 'script');

  khulnasoft.init('${APPLICATION_IDENTIFIER}', '#notification-bell', {
    subscriberId: "${onBoardingSubscriberId}",
  });
</script>`;
...
export const quickStartChannels: IQuickStartChannelConfiguration[] = [
  {
    ...
    description: '🎉  Try our gift: 300 emails Use Khulnasoft provider for free or change the provider to yours',
