...
const helloWorld = workflow('hello-world', async ({ step, payload }) => {
    ...
    },
    {
      ...
      controlSchema: z.object({
        subject: z.string().default('Welcome to Khulnasoft'),
        title: z.string().default('Welcome to Khulnasoft, {{payload.name}}'),
        text: z.string()
          .default(
...
/**
 * Khulnasoft Framework exposes a khulnasoft endpoint that can be used to serve the workflow definitions.
