...
import { DiscoverStepOutput, DiscoverWorkflowOutput } from '@khulnasoft/framework/internal';
    ...
    setTimeout(() => {
      if (terminalRef.current) {
        terminalRef.current.write(
          '\nWelcome to the Khulnasoft Playground! Feel free to edit the code above and see the results in the editor on the right side\n\n'
        );
      }
    }, 1000);
  }, !isBridgeAppLoading);
