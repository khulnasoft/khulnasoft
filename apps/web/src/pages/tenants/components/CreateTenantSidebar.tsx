...
import type { IResponseError, ICreateTenantDto, ITenantEntity } from '@khulnasoft/shared';
import { slugify } from '@khulnasoft/shared';
import { Button, colors, Sidebar, Text, Title, Tooltip } from '@khulnasoft/design-system';
