...
import type { IResponseError, ITenantEntity, IUpdateTenantDto } from '@khulnasoft/shared';
import { Button, colors, NameInput, Sidebar, Text } from '@khulnasoft/design-system';
