...
export const guidePreview: Record<string, IGuide> = {
  trigger: {
    ...
    docsUrl: `https://docs.khulnasoft.co/api-reference/events/trigger-event${UTM_CAMPAIGN_QUERY_PARAM}`,
    sequence: {
  ...
  digest: {
    ...
    docsUrl: `https://docs.khulnasoft.co/workflow/digest${UTM_CAMPAIGN_QUERY_PARAM}`,
    sequence: {
      1: { open: false, opacity: HINT_HIDDEN_OPACITY },
  ...
  email: {
    ...
    docsUrl: `https://docs.khulnasoft.co/integrations/providers/introduction${UTM_CAMPAIGN_QUERY_PARAM}`,
    sequence: {
      1: { open: false, opacity: HINT_HIDDEN_OPACITY },
      2: { open: false, opacity: HINT_HIDDEN_OPACITY },
