...
import { BoltOutlinedGradient, Button, colors, Playground, shadows, Text, Title } from '@khulnasoft/design-system';
import styled from '@emotion/styled';
import { createStyles, Group, Popover, Stack, useMantineColorScheme } from '@mantine/core';
import type { INotificationTemplate, IResponseError } from '@khulnasoft/shared';
import {
  ActorTypeEnum,
