...
const items: BoxItem[] = [
  {
    ...
    description: 'Learn how to use KhulnaSoft run AI-generated code to analyze yourdata.',
  ...
  },
  {
    ...
    description: 'Create interactive charts by running Python code in KHULNASOFT.',
