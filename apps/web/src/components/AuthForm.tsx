  ...
  return (
    <div className="mx-auto flex flex-1 w-full justify-center items-center flex-col pt-4">
      <h1 className="text-4xl font-bold mt-8 mb-4">
        {view === 'sign_in' && 'Sign in to KHULNASOFT'}
        {view === 'sign_up' && 'Create new KhulnaSoft account'}
      ...
      <div className="flex flex-1 flex-col pt-4">
          ...
          view === 'update_password') && (
            <div className="flex items-center justify-start gap-2">
              ...
              <Link
                ...
                href={`/auth/sign-in?${redirectTo ? `redirect_to=${redirectTo}` : ''
                  }`}
              >
        ...
        {view === 'sign_in' && (
          <div className="flex items-center justify-start gap-2">
            ...
            <Link
              href={`/auth/sign-up?${redirectTo ? `redirect_to=${redirectTo}` : ''
                }`}
            >
