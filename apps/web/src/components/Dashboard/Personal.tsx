...
import { KHULNASOFTUser } from '@/utils/useUser'
    ...
    <div className="flex flex-col w-full">
      <div className="flex flex-col h-full">
        ...
        <div className="flex w-full items-center space-x-2 pb-4">
          ...
          />
          <Button variant="outline" onClick={updateUserEmail}>
            Save changes
          </Button>
        </div>
        ...
        <span className="text-sm text-neutral-300 pb-4">
          This is your personal access token. It is used in CLI (e.g. for
        ...
        {user.app_metadata.provider === 'email' && (
          <>
            <h1 className="font-bold pb-4 text-xl">Reset password</h1>
