...
const DEFAULT_DOMAIN = 'khulnasoft.com'
    ...
    <div className="flex flex-col w-full">
      <div className="flex flex-col h-full">
        ...
        <span className="text-sm text-neutral-300 pb-4">
          Set API URL so the dashboard can connect to your KhulnaSoft Cluster and
        ...
        {domain !== DEFAULT_DOMAIN && (
          ...
          >
            <h4 className="font-medium pb-2">
              Setting custom API URL in the KhulnaSoft SDK & CLI
            </h4>
            <div className="text-sm text-gray-400">
              In your environment variables, set the <code>KHULNASOFT_DOMAIN</code>{' '}
