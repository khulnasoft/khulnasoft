...
import { css, cva } from '@khulnasoft/khulnasofti/css';
import { IconArrowDropDown, IconMoreHoriz, IconSettings } from '@khulnasoft/khulnasofti/icons';
import { Center, Flex, HStack, Stack } from '@khulnasoft/khulnasofti/jsx';
  ...
  return (
    ...
    >
      ...
      <Center gap="0.25rem" alignSelf="stretch" mt="auto">
        <img
          src={`/static/images/khulnasoft-gray.svg`}
          className={css({
            h: '0.75rem',
            w: '0.75rem',
            borderRadius: 'circle',
        ...
        />
        <Text variant="secondary">Powered by Khulnasoft</Text>
      </Center>
    </Flex>
  );
}
