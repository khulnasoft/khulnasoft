...
import { Button, colors, Text, Calendar, Close } from '@khulnasoft/design-system';
        ...
        <Group spacing={24} align="center">
          <Button
            onClick={() => {
              ...
              window.open('https://notify.khulnasoft.com/meetings/khulnasoft/notifications-45min?utm_campaign=in-app');
            }}
            variant="outline"
          >
            <Group spacing={8}>
