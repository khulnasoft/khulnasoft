...
import { Tabs, Tooltip } from '@khulnasoft/design-system';
import { IconInfoOutline, IconOutlineWarning } from '@khulnasoft/khulnasofti/icons';
import { css } from '@khulnasoft/khulnasofti/css';
import { Flex, Grid, GridItem, styled } from '@khulnasoft/khulnasofti/jsx';
