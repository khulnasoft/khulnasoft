...
import { colors, Tooltip, useColorScheme } from '@khulnasoft/design-system';
import { Button, Text } from '@khulnasoft/khulnasofti';
import { css } from '@khulnasoft/khulnasofti/css';
import { IconOutlineCloudUpload } from '@khulnasoft/khulnasofti/icons';
