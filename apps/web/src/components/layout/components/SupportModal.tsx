import { errorMessage, Modal, successMessage } from '@khulnasoft/design-system';
import { css } from '@khulnasoft/khulnasofti/css';
import { Button, Title, Textarea } from '@khulnasoft/khulnasofti';
import { HStack, Box } from '@khulnasoft/khulnasofti/jsx';
...
export const SupportModal: FC<SupportModalProps> = ({ isOpen, toggleOpen }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      errorMessage('Something went wrong. Please reach out to us at support@khulnasoft.co');
    }
  };
          ...
          <HStack justify={'space-between'}>
            <div>
              <HStack gap="50" className={css({ color: 'typography.text.secondary' })}>
                ...
                <a href="mailto:support@khulnasoft.co">support@khulnasoft.co</a>
              </HStack>
            </div>
