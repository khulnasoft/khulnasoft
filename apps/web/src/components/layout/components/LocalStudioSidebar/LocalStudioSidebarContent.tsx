import { IconAdd } from '@khulnasoft/khulnasofti/icons';
...
import { WithLoadingSkeleton } from '@khulnasoft/khulnasofti';
import type { DiscoverWorkflowOutput } from '@khulnasoft/framework/internal';
