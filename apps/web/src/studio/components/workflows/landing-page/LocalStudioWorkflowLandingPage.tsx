  ...
  if (status === 'disconnected') {
    return (
      <WorkflowPlaceholderPage title={'Studio Disconnected'} docsButtonLabel="See our troubleshooting guide">
        Local environment disconnected from Khulnasoft Bridge URL.
        <br />
        This usually happens when your Bridge app is not running or <code>npx khulnasoft dev</code> is not running.
