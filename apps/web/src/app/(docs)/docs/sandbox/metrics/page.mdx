...
pip install khulnasoft-code-interpreter==1.2.0b0
#
# or use Core: https://github.com/khulnasoft/khulnasoft
# pip install khulnasoft==1.2.0b0
```
</CodeGroup>
...
<CodeGroup isTerminalCommand>
```bash
khulnasoft sandbox metrics <sandbox_id>  # $HighlightLine
