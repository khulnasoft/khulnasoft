...
<CodeGroup>
```js
import { Sandbox } from '@khulnasoft/code-interpeter'
...
<CodeGroup>
```bash {{ language: 'js' }}
http://3000-i62mff4ahtrdfdkyn2esc-b0b684e9.khulnasoft.com
```
...
<CodeGroup>
```bash {{ language: 'js' }}
Server started at: https://3000-ip3nfrvajtqu5ktoxugc7-b0b684e9.khulnasoft.com
