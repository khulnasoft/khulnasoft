...
You can use KhulnaSoft Sandbox to run AI-generated code to analyze data. Here's how the AI data analysis workflow usually looks like:
...
## Example: Analyze CSV file with KhulnaSoft and Claude 3.5 Sonnet
This short example will show you how to use KhulnaSoft Sandbox to run AI-generated code to analyze CSV data.
...
Install the KhulnaSoft SDK and Claude SDK to your project by running the following command in your terminal.

<CodeGroup isTerminalCommand>
```bash {{ language: 'js' }}
npm i @khulnasoft/code-interpreter @anthropic-ai/sdk dotenv
```
```bash {{ language: 'python' }}
pip install khulnasoft-code-interpreter anthropic python-dotenv
```
</CodeGroup>

### 2. Set your API keys
1. Get your KHULNASOFT API key from [KhulnaSoft Dashboard](/dashboard?tab=keys).
