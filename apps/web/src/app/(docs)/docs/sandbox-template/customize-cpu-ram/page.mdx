...
You can customize the CPU and RAM of your sandbox template via KhulnaSoft CLI.
...
```bash
khulnasoft template build -c "/root/.jupyter/start-up.sh" --cpu-count 2 --memory-mb 2048
```
</CodeGroup>
