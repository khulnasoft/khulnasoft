...
import imgModel from '@/images/ai-app-khulnasoft-sandbox-model.png'
import { Check } from 'lucide-react'

import { features } from './features'

# Overview
**The KHULNASOFT's sandboxes are isolated cloud environments made specifcially for AI code interpreting or code execution.**

The KhulnaSoft sandboxes are an ideal fit as a playground for AI assistants like coding copilots, code interpreters, AI data analysts, AI browser assistants, and other AI-powered apps.
...
<Image
  ...
  alt="Separate KhulnaSoft Sandbox for each instance of your AI app"
  unoptimized
/>

KhulnaSoft Sandboxes are made exactly to solve these challenges. The sandbox is like an isolated runtime or playground for the LLM. **We give you our SDK to spawn and control these sandboxes.**
...
To start and control the sandbox, use the [KhulnaSoft SDK](/docs/getting-started/installation) for Python or JavaScript.
...
<Note>
Make sure you have the `KHULNASOFT_API_KEY` environment variable set with your [API key](/docs/getting-started/api-key).
</Note>
