      ...
      {user ? (
        <div className="flex flex-col space-y-4">
          <SecretBlock
            ...
            tip={
              <span>
                Set as <code>KHULNASOFT_API_KEY</code> environment variable to avoid passing it
                every time.
              </span>
            }
          />
          <SecretBlock
            ...
            description={
              <div className="flex flex-col">
                ...
                <span>
                  Acess token is not needed when logging in CLI via <code>khulnasoft auth login</code>.
                </span>
              </div>
            }
            secret={accessToken}
            ...
            tip={
              <Note>
                <div className="flex flex-col">
                  <span>To authenticate without the browser, you can set <code>KHULNASOFT_ACCESS_TOKEN</code> as an environment variable.</span>
