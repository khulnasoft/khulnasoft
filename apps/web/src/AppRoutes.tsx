...
import { khulnasoftOnboardedCookie } from './utils/cookies';
  ...
  return (
    <Routes>
      ...
      <Route path={ROUTES.STUDIO} element={<StudioPageLayout />}>
        <Route
          path=""
          element={<Navigate to={khulnasoftOnboardedCookie.get() ? ROUTES.STUDIO_FLOWS : ROUTES.STUDIO_ONBOARDING} replace />}
        />
