...
export const khulnasoftRedirectURLCookie = createCookieHandler('nv_redirect_url');

/*
 * TODO: Store the onboarding step in the cookie and resume the flow from that step on page reload.
 * For now we just store 1.
 */
export const khulnasoftOnboardedCookie = createCookieHandler('nv_onboarding_step');
...
export function setKhulnasoftOnboardingStepCookie() {
  return khulnasoftOnboardedCookie.set('1', {
