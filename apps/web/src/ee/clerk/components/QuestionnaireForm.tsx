...
import { Button, inputStyles, Select } from '@khulnasoft/design-system';
import { FeatureFlagsKeysEnum, JobTitleEnum, jobTitleToLabelMapper, UpdateExternalOrganizationDto } from '@khulnasoft/shared';
