...
export function FileEditEditor({
  ...
  useEffect(() => {
    ...
    monacoRef.current.editor.setTheme(colorScheme === 'dark' ? 'khulnasoft-dark' : 'khulnasoft');
  }, [colorScheme]);
    ...
    <div>
      ...
      <Editor
        ...
        onMount={(editor, monaco) => {
          const themeName = colorScheme === 'dark' ? 'khulnasoft-dark' : 'khulnasoft';
          monaco.editor.defineTheme('khulnasoft-dark', {
            base: 'vs-dark',
            inherit: true,
            rules: [],
            colors: {
          ...
          monaco.editor.defineTheme('khulnasoft', {
            base: 'vs',
            inherit: true,
            rules: [],
            colors: {
