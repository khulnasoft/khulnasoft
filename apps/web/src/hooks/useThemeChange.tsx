...
import { IconOutlineDarkMode, IconOutlineLightMode, IconOutlineTonality, IconType } from '@khulnasoft/khulnasofti/icons';
import { ColorSchemePreferenceEnum, THEME_TITLE_LOOKUP, useLocalThemePreference } from '@khulnasoft/design-system';
