import { FeatureFlagsKeysEnum, getContextPath, KhulnasoftComponentEnum } from '@khulnasoft/shared';
...
const blueprintApiUrlByEnv =
  ENV === 'production' || ENV === 'prod' ? 'https://api.khulnasoft.co' : 'https://api.khulnasoft-staging.co';
...
export const APP_ID = window._env_.REACT_APP_KHULNASOFT_APP_ID || process.env.REACT_APP_KHULNASOFT_APP_ID;
...
export const IS_KHULNASOFT_PROD_STAGING = !IS_SELF_HOSTED && !API_ROOT.includes('localhost');

export const REACT_APP_VERSION = process.env.KHULNASOFT_VERSION;

export const INTERCOM_APP_ID = window._env_.REACT_APP_INTERCOM_APP_ID || process.env.REACT_APP_INTERCOM_APP_ID || '';

export const CONTEXT_PATH = getContextPath(KhulnasoftComponentEnum.WEB);
...
export const MAIL_SERVER_DOMAIN =
  window._env_.REACT_APP_MAIL_SERVER_DOMAIN || process.env.REACT_APP_MAIL_SERVER_DOMAIN || 'dev.inbound-mail.khulnasoft.co';
...
export const IS_EU_ENV = (ENV === 'production' || ENV === 'prod') && API_ROOT.includes('eu.api.khulnasoft.co');
...
export const BRIDGE_SYNC_SAMPLE_ENDPOINT = 'https://deploy-preview-8--onboarding-sandbox.netlify.app/api/khulnasoft';
/**
...
export const BRIDGE_ENDPOINTS_LEGACY_VERSIONS = [
  'https://onboarding-sandbox.netlify.app/api/khulnasoft',
  'https://deploy-preview-1--onboarding-sandbox.netlify.app/api/khulnasoft',
  'https://deploy-preview-4--onboarding-sandbox.netlify.app/api/khulnasoft',
  'https://deploy-preview-6--onboarding-sandbox.netlify.app/api/khulnasoft',
];
