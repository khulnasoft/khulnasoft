...
async function testPreviewMode(emailEditorModal: NodeEmailEditorPageModal, workflowEditorPage: WorkflowEditorPage) {
  ...
  expect(previewContentUpdated).toContain(TEST_TEXT_KHULNASOFT);
...
const JSON_PARAM = `{
  "firstName": "Khulnasoft",
  "customVariable": "notCustomVariable"
}`;
const TEST_TEXT_KHULNASOFT = 'This text is written from a test Khulnasoft';
...
const NODE_CODE_IMPORT_SAMPLE = "import { Khulnasoft } from '@khulnasoft/node'";
