...
const Examples: Example[] = [
  ...
  },
  {
    ...
    repo_url:
      'https://github.com/khulnasoft/khulnasoft/tree/master/examples/user-management/flutter-user-management',
    vercel_deploy_url: '',
    demo_url: '',
  },
  {
  ...
  },
  {
    ...
    repo_url:
      'https://github.com/khulnasoft/khulnasoft/tree/master/examples/slack-clone/nextjs-slack-clone',
    vercel_deploy_url: '',
    demo_url: '',
  },
  {
  ...
  },
  {
    ...
    repo_url:
      'https://github.com/khulnasoft/khulnasoft/tree/master/examples/todo-list/sveltejs-todo-list',
    vercel_deploy_url: '',
    demo_url: '',
  },
  {
  ...
  },
  {
    ...
    repo_url: 'https://khuknasoft.com/docs/guides/functions/examples/send-emails',
  },
  {
    type: 'example',
    tags: ['OpenAI'],
    ...
    repo_url: 'https://khuknasoft.com/docs/guides/ai/examples/openai',
  },
  // {
  //   type: 'example',
  //   tags: ['Supabase'],
  ...
  //   repo_url: 'https://khuknasoft.com/docs/guides/functions/auth',
  // },
  {
    type: 'example',
    tags: ['Stripe'],
    ...
    repo_url: 'https://khuknasoft.com/docs/guides/functions/examples/stripe-webhooks',
  },
  {
    type: 'example',
    tags: ['Postgres'],
    ...
    repo_url: 'https://khuknasoft.com/docs/guides/functions/connect-to-postgres',
  },
  {
    type: 'example',
    tags: ['Huggingface'],
  ...
  },
  {
    ...
    repo_url:
      'https://github.com/khulnasoft/khulnasoft/tree/master/examples/edge-functions/khulnasoft/functions/file-upload-storage',
  },
]
