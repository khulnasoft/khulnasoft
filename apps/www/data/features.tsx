...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/database/overview',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/ai',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/api#rest-api-overview',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/graphql/api',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/platform/backups',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/platform/custom-domains',
    slug: 'custom-domains',
  },
  {
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/platform/network-restrictions',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/platform/ssl-enforcement',
...
3. Automatic migrations: Runs new migrations when changes are pushed to the ./khulnasoft/migrations directory.
4. Data seeding: Preview branches can be seeded with sample data using ./khulnasoft/seed.sql.
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/platform/branching',
    slug: 'branching',
  },
  {
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/deployment/terraform',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/platform/read-replicas',
    slug: 'read-replicas',
  },
  {
    title: 'Fly Postgres',
...
`,
    ...
    products: [PRODUCT_SHORTNAMES.DATABASE],
    heroImage: '',
    docsUrl: 'https://khuknasoft.com/docs/guides/platform/fly-postgres',
    slug: 'fly-postgres',
  },
  {
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/database/webhooks',
...
`,
    ...
    heroImage: 'https://khuknasoft.com/docs/img/guides/database/vault-hello-compressed.mp4',
    docsUrl: 'https://khuknasoft.com/docs/guides/database/vault',
    slug: 'vault',
  },
  {
    title: 'Supavisor',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/blog/supavisor-postgres-connection-pooler',
    slug: 'supavisor',
  },
  // Realtime
  {
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/realtime/postgres-changes',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/realtime/broadcast',
...
`,
    ...
    products: [PRODUCT_SHORTNAMES.REALTIME],
    heroImage: 'https://www.youtube-nocookie.com/embed/BelYEMJ2N00',
    docsUrl: 'https://khuknasoft.com/docs/guides/realtime/presence',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/auth/passwords',
    slug: 'email-login',
  },
  {
    title: 'Social login',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/auth/social-login',
    slug: 'social-login',
  },
  {
    title: 'Phone logins',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/auth/phone-login',
    slug: 'phone-logins',
  },
  {
...
`,
    ...
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '',
    docsUrl: 'https://khuknasoft.com/docs/guides/auth/auth-email-passwordless',
...
`,
    ...
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '',
    docsUrl: 'https://khuknasoft.com/docs/guides/auth/auth-mfa',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/auth/row-level-security',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/auth/auth-captcha',
...
`,
    ...
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '',
    docsUrl: 'https://khuknasoft.com/docs/guides/auth/server-side',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/storage',
    slug: 'file-storage',
  },
  {
...
`,
    ...
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: '',
    docsUrl: 'https://khuknasoft.com/docs/guides/storage/cdn',
    slug: 'cdn',
  },
  {
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/storage/cdn/smart-cdn',
    slug: 'smart-cdn',
  },
  {
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/storage/image-transformations',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/storage/uploads/resumable-uploads',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/storage/s3/compatibility',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/functions',
...
`,
    ...
    products: [PRODUCT_SHORTNAMES.FUNCTIONS],
    heroImage: '',
    docsUrl: 'https://khuknasoft.com/docs/guides/functions/regional-invocation',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/blog/edge-functions-node-npm',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/ai/examples/huggingface-image-captioning',
...
`,
    ...
    docsUrl:
      'https://khuknasoft.com/docs/guides/local-development?queryGroups=package-manager&package-manager=pnpm',
    slug: 'cli',
  },
  {
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/project-management/api',
    slug: 'management-api',
  },
  {
...
`,
    ...
    docsUrl:
      'https://khuknasoft.com/docs/guides/database/postgres/custom-claims-and-role-based-access-control-rbac',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/blog/supabase-reports-and-metrics',
...
`,
    ...
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://khuknasoft.com/docs/guides/security/compliance',
...
`,
    ...
    docsUrl:
      'https://khuknasoft.com/blog/studio-introducing-assistant#introducing-the-supabase-assistant',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/monitoring-troubleshooting/logs',
    slug: 'logs-analytics',
  },
  {
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/blog/supabase-studio-3-0#schema-visualizer',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/blog/security-and-performance-advisor',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/database/postgres/roles',
    slug: 'postgres-roles',
  },
  {
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/blog/supabase-studio-2.0#foreign-key-selector',
...
`,
    ...
    docsUrl: 'https://khuknasoft.com/blog/log-drains',
    slug: 'log-drains',
  },
]
