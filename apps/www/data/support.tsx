      ...
      links: [
        {
          ...
          link: 'https://github.com/khulnasoft/khulnasoft/issues',
          target: '_blank',
      ...
      links: [
        {
          ...
          link: 'https://github.com/khulnasoft/khulnasoft/discussions',
          target: '_blank',
        ...
        {
          label: 'Join Discord',
          link: 'https://discord.khuknasoft.com/',
          target: '_blank',
    ...
    links: [
      {
        ...
        link: 'https://forms.khuknasoft.com/enterprise',
        target: '_blank',
        type: 'default',
      },
      {
        label: 'Open Ticket',
        link: 'https://khuknasoft.com/dashboard/support/new',
        target: '_blank',
        icon: <ArrowUpRight />,
