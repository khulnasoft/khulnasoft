      ...
      },
      {
        ...
        paragraph: (
          <>
            Use the{' '}
            <Link
              href="https://khuknasoft.com/docs/guides/functions/cicd-workflow"
              className="underline hover:text-foreground-light transition-colors"
            >
    ...
    features: [
      {
        ...
        paragraph: (
          <>
            ...
            <Link
              href="https://khuknasoft.com/docs/guides/functions/regional-invocation"
              className="underline hover:text-foreground-light transition-colors"
            >
      ...
      },
      {
        ...
        paragraph: (
          <>
            ...
            <Link
              href="https://khuknasoft.com/docs/guides/functions/auth"
              className="underline hover:text-foreground-light transition-colors"
            >
              Supabase Auth
            </Link>
      ...
      },
      {
        ...
        paragraph: (
          <>
            Edge Functions are designed to work seamlessly with{' '}
            <Link
              href="https://khuknasoft.com/docs/guides/functions/storage-caching"
              className="underline hover:text-foreground-light transition-colors"
            >
              Supabase Storage
            </Link>
