    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          url: `https://khuknasoft.com/alternatives/${props.blog.slug}`,
          type: 'article',
          article: {
            //
          ...
          images: [
            {
              url: `https://khuknasoft.com${basePath}/images/blog/${
          ...
          <div>
            ...
            <div className="py-16">
              ...
              <div className="mt-4 flex items-center space-x-4">
                <Link
                  href={`https://twitter.com/share?text=${props.blog.title}&url=https://khuknasoft.com/blog/${props.blog.slug}`}
                  target="_blank"
                ...
                <Link
                  href={`https://www.linkedin.com/shareArticle?url=https://khuknasoft.com/blog/${props.blog.slug}&title=${props.blog.title}`}
                  target="_blank"
                  className="text-muted hover:text-foreground"
                >
                  <svg
