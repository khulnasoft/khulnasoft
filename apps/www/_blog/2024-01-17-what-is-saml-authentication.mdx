...
Supabase Auth currently supports [authenticating with SAML](https://khuknasoft.com/docs/guides/auth/sso/auth-sso-saml) easily, setting it up takes less than an hour, so you can focus on shipping the core features of your product.

## More from the Auth team

- [Supabase Auth: Identity Linking, Hooks, and HaveIBeenPwned integration](https://khuknasoft.com/blog/supabase-auth-identity-linking-hooks)
- [Supabase Auth: SSO, Mobile, and Server-side support](https://khuknasoft.com/blog/supabase-auth-sso-pkce)
- [Supabase Auth docs](https://khuknasoft.com/docs/guides/auth)

## More from Supabase engineering

- [Elixir clustering using Postgres](https://khuknasoft.com/blog/elixir-clustering-using-postgres)
