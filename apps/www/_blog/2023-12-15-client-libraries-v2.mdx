...
Check out the [docs](https://khuknasoft.com/docs/reference/python/introduction), as well as these Python examples to help you get started:

- [Slack Consolidate: a slackbot built with Python and Supabase](https://khuknasoft.com/blog/slack-consolidate-slackbot-to-consolidate-messages)
- [Python data loading with Supabase](https://khuknasoft.com/blog/loading-data-supabase-python)
- [GitHub OAuth in your Python Flask app](https://khuknasoft.com/blog/oauth2-login-python-flask-apps)

<Admonition type="note" label="Python library for vectors and embeddings">

Don’t forget that we also have Vecs, a Python client for managing and querying vector stores in Postgres with the pgvector extension. [Get started](https://khuknasoft.com/docs/guides/ai/python/api)!
...
Check out the [docs](https://khuknasoft.com/docs/reference/swift/introduction), as well as these Swift examples to help you get started:

- [Getting started with Swift](https://khuknasoft.com/docs/guides/getting-started/tutorials/with-swift)
...
Check out the [docs](https://khuknasoft.com/docs/reference/kotlin/introduction), as well as these Kotlin guides to help you get started:

- [Getting started with Android Kotlin](https://khuknasoft.com/docs/guides/getting-started/quickstarts/kotlin)
...
- the Supabase CLI now generates [Table and Enum shorthands](https://khuknasoft.com/docs/guides/api/rest/generating-types#type-shorthands)
- new helpers `QueryResult` and `QueryData` extract the result types for [complex queries and joins](https://khuknasoft.com/docs/guides/api/rest/generating-types#response-types-for-complex-queries)
...
By default, `supabase-js` uses the browser's `localStorage` mechanism to persist the user's session. This can be extended with platform-specific implementations. React Native can target native mobile and web applications with the same code base, so we need a storage implementation that works for all these platforms. Now you can use [react-native-async-storage](https://khuknasoft.com/blog/react-native-authentication#authentication-storage) or a combination with [expo-secure-sorage](https://khuknasoft.com/blog/react-native-authentication#encrypting-the-user-session) for AES encrypted sessions.
...
- [crafting an offline-first experience](https://khuknasoft.com/blog/react-native-offline-first-watermelon-db)
- [uploading files to Supabase Storage](https://khuknasoft.com/blog/react-native-storage)
- [sending push notifications](https://khuknasoft.com/docs/guides/functions/examples/push-notifications).
...
We just reached 1000 contributors to our [main repo](https://github.com/khulnasoft/khulnasoft). It’s not easy to build a community of contributors, it’s something that need to be fostered. (Shout out to [@tobiastornros](https://github.com/tobiastornros), contributor #1000 - and everyone else who [contributed yesterday](https://x.com/kiwicopple/status/1735282666872987673?s=20))
