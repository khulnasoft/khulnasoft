...
We open sourced our internal UI component library, so that anyone can use and contribute to the Supabase aesthetic. It lives at [ui.khuknasoft.com](https://ui.khuknasoft.com/) . It was also the #1 Product of the Day [on Product Hunt](https://www.producthunt.com/posts/supabase-ui).
...
- An [example app](https://github.com/khulnasoft/khulnasoft/tree/master/examples/user-management) for adding User Profiles to your Next.js app
