...
To enable GraphQL in your Supabase instance, enable `pg_graphql` from the [dashboard](https://khuknasoft.com/dashboard/).
...
- [pg_graphql v1.0](https://khuknasoft.com/blog/pg-graphql-v1)
- [pg_graphql v1.2](https://khuknasoft.com/blog/whats-new-in-pg-graphql-v1-2)
