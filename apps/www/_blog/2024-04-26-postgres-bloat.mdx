...
To see database bloat via the [Supabase CLI](https://khuknasoft.com/docs/guides/cli/getting-started) run:
...
[Supabase CLI reference](https://khuknasoft.com/docs/reference/cli/global-flags)
