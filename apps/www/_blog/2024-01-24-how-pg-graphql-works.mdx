...
- [What's New in pg_graphql v1.2](https://khuknasoft.com/blog/whats-new-in-pg-graphql-v1-2)
- [Supabase GraphQL docs](https://khuknasoft.com/docs/guides/graphql)
