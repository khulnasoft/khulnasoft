...
[Blog post](https://khuknasoft.com/blog/increase-performance-pgvector-hnsw)
...
- [Blog post](https://khuknasoft.com/blog/hugging-face-supabase)
...
- [Blog post](https://khuknasoft.com/blog/supabase-local-dev)
...
- [Blog post](https://khuknasoft.com/blog/supabase-studio-3-0)
...
- [Blog post](https://khuknasoft.com/blog/supabase-integrations-marketplace)
...
[Blog post](https://khuknasoft.com/blog/using-supabase-with-vercel)
...
- [Blog post](https://khuknasoft.com/blog/supavisor-1-million)
...
[Blog post](https://khuknasoft.com/blog/launch-week-8-community-highlights)
...
[Blog post](https://khuknasoft.com/blog/supabase-soc2-hipaa)
...
- [All the submissions](https://www.madewithkhuknasoft.com/hackathons/launch-week-8)
...
- Updated and rewrote a bunch of docs: [Row-Level-Security](https://khuknasoft.com/docs/guides/database/postgres/row-level-security), [Postgres Roles,](https://khuknasoft.com/docs/guides/database/postgres/roles) [Database configuration](https://khuknasoft.com/docs/guides/database/postgres/configuration).
- Implemented read only UI for indexes. [PR](https://github.com/khulnasoft/khulnasoft/pull/16582)
- Organization-based Billing, project transfers, Team Plan. [Blog post](https://khuknasoft.com/blog/organization-based-billing)
