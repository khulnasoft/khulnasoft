...
During [Launch Week 5](https://khuknasoft.com/launch-week), we shipped a lot of features, which was exciting, but what is more exciting is reviewing all the awesome hackathon submissions you all created for [Launch Week 5 Hackathon!](https://khuknasoft.com/blog/launch-week-5-hackathon)

It is always tough to pick the winner, but this time around it was extra hard because of the amount of incredible projects: there were 46 submitted projects, making this our most popular hackathon yet. You will be able to view all of the submissions of this hackathon on [madewithkhuknasoft.com](https://www.madewithkhuknasoft.com/).
...
As promised in the [hackathon announcement article](https://khuknasoft.com/blog/launch-week-5-hackathon), each members of the winners will receive a limited edition golden Supabase cap!
...
- [**supabase-js v2 Release Candidate**](https://khuknasoft.com/blog/supabase-js-v2)
- [**Supabase Realtime Guide**](https://khuknasoft.com/docs/guides/realtime)
