...
You can seed your Preview branch in the same way that you [seed your local development environment](/docs/guides/cli/seeding-your-database). Just add `./khulnasoft/seed.sql` in your repo and the seed script will run when the Preview Branch is created.
