...
Since [Logflare joined Supabase](https://khuknasoft.com/blog/supabase-acquires-logflare) over a year ago it’s been quietly handling over 1 billion log events every day. These events come from various tools in the Supabase infrastructure - the API gateway, Postgres databases, Storage, Edge Functions, Auth, and Realtime.
...
📢 Check out the [new self-hosting docs](https://khuknasoft.com/docs/reference/self-hosting-analytics/introduction) to get Logflare up and running as your analytics server.
...
Contact us at growth@khuknasoft.com to get in early on that waitlist.
