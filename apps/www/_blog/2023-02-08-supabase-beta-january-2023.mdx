...
[Read the announcement](https://khuknasoft.com/blog/openai-embeddings-postgres-vector)
...
- [Read the blog post](https://khuknasoft.com/blog/chatgpt-supabase-docs)
...
- [C# Client Library](https://khuknasoft.com/docs/reference/csharp/)
- [Python Client Library](https://khuknasoft.com/docs/reference/python/initializing)
...
[Read the docs](https://khuknasoft.com/docs/guides/storage/serving/image-transformations#automatic-image-optimisation-webp)
...
- Docs: New guide on scheduling functions with pg_cron. [[Guide]](https://khuknasoft.com/docs/guides/functions/schedule-functions)

- Edge Functions: You can now download source codes of deployed edge functions from the CLI. [[Doc]](https://khuknasoft.com/docs/reference/cli/supabase-functions-download)
...
[Supabase Repo.](https://github.com/khulnasoft/khulnasoft)
...
We've redesigned our [Careers page](https://khuknasoft.com/careers) to better reflect our mission, values, and culture.
