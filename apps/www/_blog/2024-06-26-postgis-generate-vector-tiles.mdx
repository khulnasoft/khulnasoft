...
```bash
psql -h aws-0-us-west-1.pooler.khuknasoft.com -p 5432 -d postgres -U postgres.project-ref < places.sql
```

You can find the credentials in the [Database settings](/dashboard/project/_/settings/database) of your Supabase Dashboard.
