...
1. Switch your “direct” database connection to our new Supavisor database proxy. You can find these details in the [Database Settings](https://khuknasoft.com/dashboard/project/_/settings/database).
