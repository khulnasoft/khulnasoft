...
In Launch Week 7, [we added Supabase AI to the Studio](https://khuknasoft.com/blog/supabase-studio-2.0). Through our ⌘K menu, you could ask Supabase AI to do all sorts of common tasks — create tables, views, and indexes, write database functions, write RLS policies, and more.
...
With Supabase AI, you won't even need the whole weekend to scale to millions. Head over to the [SQL Editor](https://khuknasoft.com/dashboard/project/_/sql) and give it a try!
...
As migrations get run against your project from the CLI, you can see information in the Studio about when the migration was run, by who and what changes were made. [See the documentation](https://khuknasoft.com/docs/guides/cli/local-development#database-migrations) to get started with migrations.

<Img src="/images/blog/launch-week-8/day-3/migrations.png" alt="Migrations UI" />

## Wrappers UI

During Launch Week 6, we [announced](https://khuknasoft.com/blog/postgres-foreign-data-wrappers-rust) Supabase Wrappers — a framework for building foreign data wrappers with Postgres. Wrappers allow your Supabase project to act as a one-stop hub for your data.
...
- [Supabase Local Dev: migrations, branching, and observability](https://khuknasoft.com/blog/supabase-local-dev)
