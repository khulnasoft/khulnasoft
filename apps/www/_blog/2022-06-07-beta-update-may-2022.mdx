...
Now you can deploy functions with optional JWT verification. This makes it easier to trigger Edge Functions with webhooks. Use the -no-verify-jwt flag when deploying your functions via the CLI to enable this mode. You can test this out with our [Edge Functions Telegram Bot example](https://github.com/khulnasoft/khulnasoft/tree/master/examples/edge-functions/khulnasoft/functions/telegram-bot).

[![graphql](/images/blog/2022-may/stripe-webhook.jpg)](https://github.com/khulnasoft/khulnasoft/tree/master/examples/edge-functions/khulnasoft/functions/telegram-bot)

## Metrics for everybody

We are making another enterprise feature available for all of our users. Our Prometheus-compatible metrics endpoint gives you granular insights on the health and status of your projects, allowing for real-time monitoring, debugging, and alerting for all. [Read the docs](https://khuknasoft.com/docs/guides/platform/metrics).

[![realtime](/images/blog/2022-may/prometheus.png)](https://khuknasoft.com/docs/guides/platform/metrics)

## Improved Policy Editor

The Policy editor now includes a “Target roles” field. We now have a strong recommendation to use this over the auth.role() = 'authenticated' technique. In one customer’s database, this reduced a query from 46 seconds to 7 milliseconds. Sometimes even we get it wrong - luckily you can trust that Postgres has it right. [Check it out](https://khuknasoft.com/dashboard/project/_/auth/policies).

[![enterprise](/images/blog/2022-may/policy.jpg)](https://khuknasoft.com/dashboard/project/_/auth/policies)
...
- Join the **[team](https://about.khuknasoft.com/careers)**
