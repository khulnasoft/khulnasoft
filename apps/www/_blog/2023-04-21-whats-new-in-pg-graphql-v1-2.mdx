...
It's been 4 months since the [1.0.0 release of pg_graphql](https://khuknasoft.com/blog/pg-graphql-v1).
...
📢 These features are only available on projects with Postgres version `15.1.0.63` or higher. For help with upgrading, please review the [migrating and upgrading projects guide](https://khuknasoft.com/docs/guides/platform/migrating-and-upgrading-projects).
...
- [Introducing pg_graphql: A GraphQL extension for PostgreSQL](https://khuknasoft.com/blog/pg-graphql)
- [GraphQL is now available in Supabase](https://khuknasoft.com/blog/graphql-now-available)
