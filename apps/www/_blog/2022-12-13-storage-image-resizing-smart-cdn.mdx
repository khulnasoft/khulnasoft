...
🆕 What is new in Storage: [Supabase Storage v3: Resumable Uploads with support for 50GB files](https://khuknasoft.com/blog/storage-v3-resumable-uploads)
...
- **More Transformations**: quality, rotate, blur? Cast your vote on [this GitHub Discussion](https://github.com/khulnasoft/khulnasoft/discussions/10918).
- **Integrations**: Native integration with [next/image](https://nextjs.org/docs/api-reference/next/image) and [Edge Functions](https://khuknasoft.com/edge-functions) for advanced transformations.

## Getting started

[Upgrade to Pro](https://khuknasoft.com/pricing) to get started with Image Resizing today.

- Check out the Docs for [Image Resizing](https://khuknasoft.com/docs/guides/storage/serving/image-transformations).
- Check out the Docs for the [Storage CDN](https://khuknasoft.com/docs/guides/storage/cdn/fundamentals).
- Get Started today with the [JavaScript](https://khuknasoft.com/docs/reference/javascript/storage-from-download) and [Dart](https://khuknasoft.com/docs/reference/dart/storage-from-list) client libraries.
...
- [Community Day](https://khuknasoft.com/blog/launch-week-6-community-day)
