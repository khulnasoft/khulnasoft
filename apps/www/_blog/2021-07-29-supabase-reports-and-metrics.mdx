...
Any other metrics you want to see in your projects? Reach out on our [Discord channel](https://discord.khuknasoft.com/) and give Supabase a try by [creating a project](https://khuknasoft.com/dashboard/).
