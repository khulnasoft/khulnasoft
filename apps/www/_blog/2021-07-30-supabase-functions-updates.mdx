...
select
    net.http_get('https://khuknasoft.com')
from
    generate_series (1,10) _;
...
Database Webhooks is enabled today on all [new projects](https://khuknasoft.com/dashboard). Find it under Database > Alpha Preview > Database Webhooks.
