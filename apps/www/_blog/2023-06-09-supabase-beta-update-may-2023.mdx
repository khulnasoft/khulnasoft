...
We're also absolutely stoked to let you know that we've hit a massive milestone: [50k GitHub Stars](https://github.com/khulnasoft/khulnasoft)! 🌟. Much love to everyone who helped us get there!
...
[Supabase Vector](https://khuknasoft.com/vector)
...
[Learn how to use Vault.](https://khuknasoft.com/docs/guides/database/vault)
...
[Updated docs](https://khuknasoft.com/docs/guides/auth/auth-helpers/nextjs)
...
- [Auth] You can now use Turnstile as a Captcha provider. [Doc](https://khuknasoft.com/docs/guides/auth/auth-captcha#sign-up-for-captcha)

- [Auth] How to send a password reauthentication nonce. [Doc](https://khuknasoft.com/docs/reference/javascript/auth-resend)

- [Dashboard] Supabase Wrappers UI that supports pulling data in from Firebase, Stripe, S3, and Clickhouse. [Create a Wrapper](https://khuknasoft.com/dashboard/project/_/database/wrappers)

- [Edge Functions] Support for deploying all Edge Functions via CLI. [Doc](https://khuknasoft.com/docs/guides/functions/quickstart#deploy-all-functions)

- [Edge Functions] Custom domains and vanity domains support for Edge Functions. [PR](https://github.com/khulnasoft/khulnasoft-js/pull/778)

- [Storage] Image Transformation is now out of Beta. [Doc](https://khuknasoft.com/docs/guides/storage/serving/image-transformations)
...
- [Supabase Vecs: a vector client for Postgres](https://khuknasoft.com/blog/vecs)

- [ChatGPT plugins now support Postgres & Supabase](https://khuknasoft.com/blog/chatgpt-plugins-support-postgres)

- [Building ChatGPT Plugins with Supabase Edge Runtime](https://khuknasoft.com/blog/building-chatgpt-plugins-template)
...
[Read the blog post with all the winners](https://khuknasoft.com/blog/flutter-hackathon-winners)
...
- We worked with Cloudflare on a new integration that makes it super easy to connect your Supabase database from Cloudflare Workers. [Doc](https://khuknasoft.com/partners/integrations/cloudflare-workers)
...
- Our friends from 1Password announced Passage and wrote an integration guide. [Doc](https://khuknasoft.com/partners/integrations/passageidentity)
