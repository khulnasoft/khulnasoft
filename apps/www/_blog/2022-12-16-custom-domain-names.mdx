...
Get your custom domain in the [Dashboard](https://khuknasoft.com/dashboard/project/_/settings/general)
...
Instructions for setting up Vanity Subdomains are now available in our [docs](https://khuknasoft.com/docs/guides/platform/custom-domains#vanity-subdomains).
