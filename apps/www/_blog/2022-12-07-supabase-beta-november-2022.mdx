...
[Get your ticket](https://khuknasoft.com/launch-week)
...
[Read the docs](https://khuknasoft.com/docs/guides/auth/auth-helpers/remix)
...
Plus, we published three new functions examples: [Generate OG Images](https://github.com/khulnasoft/khulnasoft/tree/master/examples/edge-functions/khulnasoft/functions/opengraph), [Build API servers using Oak](https://github.com/khulnasoft/khulnasoft/tree/master/examples/edge-functions/khulnasoft/functions/oak-server), and [Generate Screenshots using Puppeteer](https://github.com/khulnasoft/khulnasoft/tree/master/examples/edge-functions/khulnasoft/functions/puppeteer).
...
- Now you can do redirects from your functions. [PR](https://github.com/khulnasoft/khulnasoft/issues/10325)
...
[Check the full list](https://khuknasoft.com/blog/the-supabase-content-storm)
...
Discover other great projects: [Made with Supabase](https://www.madewithkhuknasoft.com/).
...
- Flutter Authentication and Authorization with RLS. [Tutorial](https://khuknasoft.com/blog/flutter-authentication-and-authorization-with-rls)
