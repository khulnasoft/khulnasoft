...
[wasm.khuknasoft.com](https://wasm.khuknasoft.com)
...
2. Tell them to go to [wasm.khuknasoft.com](https://wasm.khuknasoft.com/)
...
5. On your own machine, open a terminal and run
   `psql postgres://postgres:my_password@proxy.wasm.khuknasoft.com:<PORT>`
