...
Supabase Integrations allows Partners to extend the Supabase platform with useful tooling. Today we're adding [OAuth2.0 Applications](https://khuknasoft.com/docs/guides/platform/oauth-apps/publish-an-oauth-app). For Supabase users, this makes it even easier to connect their favorite tools to their Supabase projects. Within minutes you can:

- Add your favorite [Low Code](https://khuknasoft.com/partners/integrations#low-code) tools on top of your Supabase database.
- Integrate your favorite [DevTools](https://khuknasoft.com/partners/integrations#devtools): including secrets managers and database management tools.
- Add [caching](https://khuknasoft.com/partners/integrations#caching%20/%20offline-first) to your Supabase database.
- Not a fan of the Supabase admin dashboard? Try [one of these](https://khuknasoft.com/partners/integrations#data%20platform).
- Try out a different [SMS and email provider](https://khuknasoft.com/partners/integrations#messaging).
...
We've released full instructions in our [Build with Supabase](https://khuknasoft.com/docs/guides/platform/oauth-apps/build-a-supabase-integration) documentation so that you can build your own Supabase OAuth application for your users. Simply visit your [Organization settings](https://khuknasoft.com/dashboard/org/_/apps) and click “Add application” to get started:
...
The Integrations marketplace is open to everyone. After your submission is complete, you can share the integration with your own users - simply create a button to launch your new app. We've provided some [brand assets](https://khuknasoft.com/brand-assets) so that developers can quickly identify the integration on your site.

## Building custom integrations

You don't actually need to build an OAuth Application to build an integration with Supabase. If you're building something for yourself or your team, the [Management API](https://khuknasoft.com/docs/reference/api/introduction) is the way to go.
