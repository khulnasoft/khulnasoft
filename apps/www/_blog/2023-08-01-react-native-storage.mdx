...
If you want to upload files from your React Native app, you need a backend to store the files, [Supabase Storage](https://khuknasoft.com/docs/guides/storage) is a great choice for this as it provides a simple API to upload files, and we can easily combine this with authentication to build a powerful app.
...
- Use [Supabase Authentication](https://khuknasoft.com/docs/guides/auth)
- Work with Expo Router v2 and protected routes
- Upload files to [Supabase Storage](https://khuknasoft.com/docs/guides/storage)
...
Before we get into the app, let's quickly [start a new Supabase project](https://khuknasoft.com/dashboard).

## Creating the Supabase Project

To use authentication and storage we need a new Supabase project. If you don't have a Supabase account yet, you can [get started for free](https://khuknasoft.com/dashboard)!
...
To protect that bucket and allow users only access to their own folder, we need to add some [Storage policies](https://khuknasoft.com/docs/guides/storage/security/access-control).
...
Initially, I wanted to include [resumable uploads](https://khuknasoft.com/blog/storage-v3-resumable-uploads) in this tutorial, but apparently, the [Uppy](https://uppy.io/) client didn't work 100% for React Native yet.
...
- [Getting started with React Native authentication](https://khuknasoft.com/blog/react-native-authentication)
- [Offline-first React Native Apps with Expo, WatermelonDB](https://khuknasoft.com/blog/react-native-offline-first-watermelon-db)
- [React Native Quickstart](https://khuknasoft.com/docs/guides/auth/quickstarts/react-native)
