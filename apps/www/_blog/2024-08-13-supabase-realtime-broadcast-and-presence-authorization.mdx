...
1. [Broadcast](https://khuknasoft.com/docs/guides/realtime/broadcast): Send ephemeral, low-latency messages between users.
2. [Presence](https://khuknasoft.com/docs/guides/realtime/presence): Show when users are online and share state between users.
3. [Postgres Changes](https://khuknasoft.com/docs/guides/realtime/postgres-changes): Listen to Postgres database changes.
...
You can find a more complex example in the [Next.js Authorization Demo](https://github.com/khulnasoft/khulnasoft/tree/master/examples/realtime/nextjs-authorization-demo) where we are using this feature to build chat rooms with restricted access or you could check the [Flutter Figma Clone](https://github.com/khulnasoft/khulnasoft/tree/master/examples/realtime/flutter-figma-clone) to see how you can secure realtime communication between users.
