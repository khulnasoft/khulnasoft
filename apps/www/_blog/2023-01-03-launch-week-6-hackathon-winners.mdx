...
We ended 2022 shipping tons of features in [Launch Week 6](https://khuknasoft.com/launch-week), but the fun hasn’t ended yet, because we get to announce the winners of our [Hackathon No.6](https://khuknasoft.com/blog/launch-week-6-hackathon)!

As usual, we enjoyed looking at all the awesome projects, and this time we got to share the excitement with the folks from Deno, who judged the [Best Edge Functions Project](https://deno.com/blog/edge-functions-supabase-launch-week-6-hackathon#Winners). You can view all the submissions on [madewithkhuknasoft.com](https://www.madewithkhuknasoft.com/).
...
As promised in the [hackathon announcement article](https://khuknasoft.com/blog/launch-week-6-hackathon) the winners of the Best overall project will be granted the extremely limited edition Supabase Darkmode Keyboard!
...
- [**supabase-js v2**](https://khuknasoft.com/blog/supabase-js-v2)
- [**Supabase Storage Guide**](https://khuknasoft.com/docs/guides/storage)
- [**Flutter Quick Start Guide**](https://khuknasoft.com/docs/guides/with-flutter)
