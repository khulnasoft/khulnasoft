...
[Read the blog post](https://khuknasoft.com/blog/supabase-is-now-compatible-with-nextjs-14).
...
[See the full benchmarks](https://khuknasoft.com/blog/pgvector-vs-pinecone)
...
Managing Storage buckets with CLI works best if there are less than 100k objects in your bucket and each of them is smaller than 20MB. Reference docs are [here](https://khuknasoft.com/docs/reference/cli/supabase-storage-ls).
...
- Better error surfacing in SQL Editor. [[PR]](https://github.com/khulnasoft/khulnasoft/pull/18327)
- Break out auth rate limit fields into a separate page. [[PR]](https://github.com/khulnasoft/khulnasoft/pull/18265)
- Enumerated types management. [[PR]](https://github.com/khulnasoft/khulnasoft/pull/17953)
- New API side panel. [[PR]](https://github.com/khulnasoft/khulnasoft/pull/17880)
- Audit logs for organizations available on Team Plan.

[Check them out](https://khuknasoft.com/dashboard/).
...
[Check out the doc](https://khuknasoft.com/docs/guides/platform/multi-factor-authentication)

## Quick product announcements

- [Auth] LinkedIn OIDC provider. [[PR]](https://github.com/khulnasoft/khulnasoft/pull/18225)
...
- [Dashboard] Scopes for OAuth apps. [[PR]](https://github.com/khulnasoft/khulnasoft/pull/17976)
...
- Offline-first React Native Apps with Expo, WatermelonDB, and Supabase. [Blog post](https://khuknasoft.com/blog/react-native-offline-first-watermelon-db)
