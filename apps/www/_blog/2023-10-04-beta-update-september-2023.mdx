...
We’ve come a long way since our first update email in April 2020. We’ve gone from 6 hosted databases on our platform to over 650,000 (and that doesn’t even include [database branches](https://khuknasoft.com/blog/supabase-local-dev). As always we’ve had another hectic month of shipping fast, and community involvement in our [open source repos](https://github.com/khulnasoft/khulnasoft), meaning we can iterate on Supabase faster than ever. Here’s a small sample of some of the things we shipped during September…
...
[Broadcast docs](https://khuknasoft.com/docs/guides/realtime/broadcast#send-messages-using-rest-calls)
...
[Read the Airtable Wrapper docs](https://khuknasoft.com/docs/guides/database/extensions/wrappers/airtable)
[Learn about Wrappers](https://khuknasoft.com/blog/postgres-foreign-data-wrappers-rust)
...
[Try them out](https://khuknasoft.com/dashboard/project/_)
...
[Read the HNSW docs](https://khuknasoft.com/docs/guides/ai/python/api#create-an-index)
...
- [Edge Functions] You can manage the secrets for your project's Edge Functions via the dashboard. [[Try it now](https://khuknasoft.com/dashboard/project/_/settings/functions)]
...
- 🧠 [Quivr](https://khuknasoft.com/customers/quivr): an open source second brain that went viral and became one of the most popular Generative AI projects, launching 5000 databases on Supabase.
- 💬 [Chatbase](https://khuknasoft.com/customers/chatbase): an AI chatbot builder that scaled to $1M in 5 months, making it one of the most successful single-founder AI products in the industry.
