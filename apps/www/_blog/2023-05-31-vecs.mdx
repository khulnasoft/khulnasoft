...
[celebrity look-alike demo](https://github.com/khulnasoft/khulnasoft/blob/be1f4ea85e10cc8134e389dcdbe6a092b08612f1/examples/ai/face_similarity.ipynb),
...
For more deployment options, including enterprise scalable architecture, check out the [engineering for scale guide](https://khuknasoft.com/docs/guides/ai/engineering-for-scale#simple-workloads).
...
- Supabase Vector Toolkit: [khuknasoft.com/docs/guides/ai](/docs/guides/ai)
