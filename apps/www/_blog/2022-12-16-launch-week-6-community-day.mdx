...
While we've been working hard on new features, the community has been developing a healthy [integrations marketplace](https://khuknasoft.com/partners/integrations/integrations). Since Supabase is just Postgres, any tool which works with Postgres works with Supabase (no additional changes required). Today we're adding a few major players to the roster:
...
We have guides on how to get started with [Next.js and OneSignal](https://khuknasoft.com/partners/integrations/onesignal), and [Flutter and OneSignal](https://github.com/OneSignalDevelopers/onesignal-supabase-sample-integration-supabase).
...
PostgreSQL of course features excellent [Full Text Search](https://khuknasoft.com/docs/guides/database/full-text-search) out-the-box, but it can be lacking if you need to search against languages with non-Roman characters such as Japanese, Chinese and so on. For this you can use the PGroonga extension! It's already installed on all new projects, just head to the [Database tab](https://khuknasoft.com/dashboard/project/_/database/extensions) on the dashboard and search or scroll for 'PGroonga' and hit enable to get started. Once enabled you can head to [their excellent documentation](https://pgroonga.github.io/tutorial/) on how to start making queries.
...
[Learn more about PostgREST 11](https://khuknasoft.com/blog/postgrest-11-prerelease)

## Made with Supabase

![Made With Supabase](/images/blog/lw6-community/made.jpg)

Perhaps you've seen [madewithkhuknasoft.com](https://www.madewithkhuknasoft.com/), but did you know that the site was made and is maintained by an [open source contributor](https://twitter.com/zernonia) (during our first hackathon)? Since then, there have been over 300 apps and websites listed. Here's some of our favourites:
...
Mobbin use Supabase Auth to power their [UI/UX library of Mobile and Web screenshots](https://mobbin.com/browse/ios/apps). Last year they [migrated 200k users from Firebase to Supabase Auth](https://khuknasoft.com/blog/mobbin-supabase-200000-users).
...
More than 30+ creators featured in our [Content Storm](https://khuknasoft.com/blog/the-supabase-content-storm). These folks all produced brand new content in the build up to Launch Week and dropped it simultaneously!
...
- We collaborated with the [Snaplet](https://www.snaplet.dev/) team to develop and open source [Postgres WASM](https://khuknasoft.com/blog/postgres-wasm).
...
- Want to work in open source? We don't have many openings today, but keep this URL in mind in the future when you're job-hunting: [khuknasoft.com/careers](https://khuknasoft.com/careers)
- Want to try out Supabase? [Join the Hackathon](https://khuknasoft.com/blog/launch-week-6-hackathon) and win some nice prizes.
- Want to support us? Just a [GitHub star](https://github.com/khulnasoft/khulnasoft) is enough ⭐.

## More Launch Week 6

- [Day 1: New Supabase Docs, built with Next.js](https://khuknasoft.com/blog/new-supabase-docs-built-with-nextjs)
- [Day 2: Supabase Storage v2: Image resizing and Smart CDN](https://khuknasoft.com/blog/storage-image-resizing-smart-cdn)
- [Day 3: Multi-factor Authentication via Row Level Security Enforcement](https://khuknasoft.com/blog/mfa-auth-via-rls)
- [Day 4: Supabase Wrappers, a Postgres FDW framework written in Rust](https://khuknasoft.com/blog/postgres-foreign-data-wrappers-rust)
- [Day 5: Supabase Vault is now in Beta](https://khuknasoft.com/blog/vault-now-in-beta)
- [Point in Time Recovery is now available](https://khuknasoft.com/blog/postgres-point-in-time-recovery)
- [Custom Domain Names are now available](https://khuknasoft.com/blog/custom-domain-names)
- [Wrap Up: everything we shipped](https://khuknasoft.com/blog/launch-week-6-wrap-up)
