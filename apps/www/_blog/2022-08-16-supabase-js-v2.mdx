...
[Check the updated docs](https://khuknasoft.com/docs/reference/javascript) and [migration guide](https://khuknasoft.com/docs/reference/javascript/v1/upgrade-guide).

</div>

Today we're publishing a release candidate for [supabase-js v2](https://github.com/khulnasoft/khulnasoft-js), which focuses on “quality-of-life” improvements for developers.

Try it out by running `npm i @supabase/supabase-js@rc`

Nearly 2 years ago we [released supabase-js v1](https://khuknasoft.com/blog/improved-dx).
Since then it has been used in over [17K repositories](https://github.com/khulnasoft/khulnasoft-js/network/dependents?package_id=UGFja2FnZS04MjM3OTUyMDU%3D) and has grown
...
[type generators](https://khuknasoft.com/docs/reference/cli/usage#supabase-gen-types) to the CLI.
...
This improvement inspired by a Supabase community member. Thanks [@vejja](https://github.com/khulnasoft/functions-js/pull/23)!
...
This is a "preparatory" release for our upcoming [multiplayer](https://khuknasoft.com/blog/supabase-realtime-with-multiplayer-features) features.
...
- [`functions-js`](https://github.com/khulnasoft/functions-js/graphs/contributors) (4)
...
- [`supabase-js`](https://github.com/khulnasoft/khulnasoft-js/graphs/contributors) (39)
...
[Migration guide](https://khuknasoft.com/docs/reference/javascript/v1/upgrade-guide)
...
- [v2 Documentation](https://khuknasoft.com/docs/reference/javascript)
- [Migration guide](https://khuknasoft.com/docs/reference/javascript/v1/upgrade-guide)
- [Next.js quickstart guide](/docs/guides/with-nextjs)
- [Examples](https://github.com/khulnasoft/khulnasoft/tree/master/examples)
