...
We can either run these queries on demand or, for better query performance, we can run them in the background (using something like [pg_cron](https://khuknasoft.com/docs/guides/database/extensions/pgcron)), and materialize the data into a local table.
...
- Supabase Launch Week: [khuknasoft.com/launch-week](https://khuknasoft.com/launch-week)
