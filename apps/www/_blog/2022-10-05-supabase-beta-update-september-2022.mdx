...
[Read the blog post](https://khuknasoft.com/blog/postgres-wasm) <br/>
...
[Review the Security Notice](https://github.com/khulnasoft/khulnasoft/discussions/9314).
...
- A new [guide](https://khuknasoft.com/docs/guides/auth/auth-captcha) to add captcha to your sign-in, sign-up, and password reset forms
...
- Added [docs](https://khuknasoft.com/docs/guides/storage/cdn/fundamentals) for how caching works in Supabase
