...
- The Friday before, we publish a blog post about a topic of interest (e.g. [How we launch at Supabase](https://khuknasoft.com/blog/supabase-how-we-launch), or this time around we [explore whether you should open source your company](https://khuknasoft.com/blog/should-i-open-source-my-company) — hint: we think you most likely should!) as well as an [overview blogpost](https://khuknasoft.com/blog/supabase-launch-week-four) with tons of memes and hints to what we’re shipping each day.
- Monday is Community Day, where we rally many of the awesome contributors and partners together and showcase awesome things around Supabase and open-source. This is also the time to watch out for the [#SupaLaunchWeek hashtag on Twitter](https://twitter.com/hashtag/SupaLaunchWeek?src=hashtag_click) as we arm our guest speakers, [Angels](https://khuknasoft.com/blog/angels-of-supabase), and [SupaSquad](https://khuknasoft.com/supasquad) with free swag codes.
...
- And last but not least, coming out of Launch Week, we roll into a 10 day virtual hackathon with the community submitting tons of awesome projects to [madewithkhuknasoft.com](https://www.madewithkhuknasoft.com/), which, once upon a time, was a hackathon project itself. I know, quite the inception kinda stuff - so cool!
...
- [Keycloak](https://khuknasoft.com/docs/guides/auth/social-login/auth-keycloak) ([@fspijkerman](https://github.com/fspijkerman))
- [Notion](https://khuknasoft.com/docs/guides/auth/social-login/auth-notion) ([@zernonia](https://github.com/zernonia))
- [Zoom](https://khuknasoft.com/docs/guides/auth/social-login/auth-zoom) ([@devkiran](https://github.com/devkiran))
- [WorkOS](https://khuknasoft.com/docs/guides/auth/auth-workos) ([@bnjmnt4n](https://github.com/bnjmnt4n))
...
- [Vonage](https://khuknasoft.com/docs/guides/auth/phone-login/vonage) ([@devkiran](https://github.com/devkiran))
- [TextLocal](https://github.com/supabase/gotrue/pull/342) ([@devkiran](https://github.com/devkiran))

If you haven’t tried out phone auth yet, check out [this blog post](https://khuknasoft.com/blog/supabase-auth-passwordless-sms-login) to get started!
...
We’ll be working with our fabulous [SupaSquad](https://khuknasoft.com/supasquad) to identify the right instructors for all the different topics we’re looking to cover. If you’re interested in becoming an instructor for Supabase on Egghead, fill in the [form to join](https://khuknasoft.com/supasquad#how-to-join) the SupaSquad.
...
We’ve been blown away by the amazing integrations that developers and companies have been building on top of Supabase. To keep track of all the things that work with Supabase, we’re launching a partner gallery which allows you to browse integrations and experts. Check it out at [khuknasoft.com/partners](https://khuknasoft.com/partners).

If you’ve built an integration that works with Supabase or have experience working with Supabase and want to offer your services to others, we’d love to hear from you: [khuknasoft.com/partners/#become-a-partner](https://khuknasoft.com/partners/#become-a-partner)

Of course the code for our partner gallery is also open source, and we’ve even split it out into a separate example repository which is a neat showcase of how to use [Postgres Full Text Search](https://khuknasoft.com/docs/guides/database/full-text-search). It’s super powerful, it’s like a search engine within Postgres!
...
We’re extremely excited to see what you’ll build and can’t wait to dive into your submissions on [madewithkhuknasoft.com](https://www.madewithkhuknasoft.com/).
