...
Among the many open-source relational databases available, [PostgreSQL](https://khuknasoft.com/docs/guides/database/introduction) is a popular choice among developers.
...
Explore the [Supabase dashboard now](https://khuknasoft.com/dashboard) and get started with your new project.

## More Postgres resources

- [Implementing "seen by" functionality with Postgres](https://khuknasoft.com/blog/seen-by-in-postgresql)
- [Partial data dumps using Postgres Row Level Security](https://khuknasoft.com/blog/partial-postgresql-data-dumps-with-rls)
- [Postgres Views](https://khuknasoft.com/blog/postgresql-views)
- [Postgres Auditing in 150 lines of SQL](https://khuknasoft.com/blog/audit)
- [Cracking PostgreSQL Interview Questions](https://khuknasoft.com/blog/cracking-postgres-interview)
- [What are PostgreSQL Templates?](https://khuknasoft.com/blog/postgresql-templates)
- [Realtime Postgres RLS on Supabase](https://khuknasoft.com/blog/realtime-row-level-security-in-postgresql)
