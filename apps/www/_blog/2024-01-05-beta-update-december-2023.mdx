...
Happy New Year! We concluded 2023 with [Launch Week X](https://khuknasoft.com/launch-week). Here's a rundown of all the fantastic goodies we shipped... now, let the building commence!
...
- [Blog post](https://khuknasoft.com/blog/studio-introducing-assistant)
...
- [Blog post](https://khuknasoft.com/blog/edge-functions-node-npm)
...
- [Blog post](https://khuknasoft.com/blog/supabase-branching)
...
- [Blog post](https://khuknasoft.com/blog/supabase-auth-identity-linking-hooks)
...
- [Blog post](https://khuknasoft.com/blog/introducing-read-replicas)
...
[Full list of winners](https://khuknasoft.com/blog/launch-week-x-hackathon-winners) | [All the submissions](https://www.madewithkhuknasoft.com/hackathons/launch-week-x)

## Moarrr LWX

As if all that wasn't enough, we shipped even more cool stuff:

- [Fly Postgres, managed by Supabase](https://khuknasoft.com/blog/postgres-on-fly-by-supabase)
- [Supabase Libraries V2: Python, Swift, Kotlin, Flutter, and Typescript](https://khuknasoft.com/blog/client-libraries-v2)
- [Supavisor 1.0: a scalable connection pooler for Postgres](https://khuknasoft.com/blog/supavisor-postgres-connection-pooler)
- [Postgres Language Server: implementing the Parser](https://khuknasoft.com/blog/postgres-language-server-implementing-parser)
- [Supabase Grafana](https://github.com/khulnasoft/khulnasoft-grafana)
- [Supabase Wrappers v0.2: Query Pushdown & Remote Subqueries](https://khuknasoft.com/blog/supabase-wrappers-v02)
- [PostgREST 12](https://khuknasoft.com/blog/postgrest-12)
- [pg_graphql: Postgres functions now supported](https://khuknasoft.com/blog/pg-graphql-postgres-functions)
- [The Supabase Album](https://www.youtube.com/watch?v=r1POD-IdG-I)
- [How design works at Supabase](https://khuknasoft.com/blog/how-design-works-at-supabase)
- [Master thread with all our traditional Twitter Spaces](https://twitter.com/supabase/status/1734190040413061583)
- [Top 10 Launches of LWX (plus cool things from the community](https://khuknasoft.com/blog/launch-week-x-best-launches)
...
- [Support Engineers across all timezones](https://khuknasoft.com/careers#positions)
