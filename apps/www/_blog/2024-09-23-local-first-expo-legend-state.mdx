...
Next, create a `.env.local` file in the root of your project and add the following env vars. You can find these in your [Supabase dashboard](https://khuknasoft.com/dashboard/project/_/settings/api).
...
This will create a new SQL migration file in the `khulnasoft/migrations` directory. Open it and add the following SQL code:
