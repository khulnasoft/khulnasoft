...
Go to [SQL Editor](https://khuknasoft.com/dashboard/project/_/sql) and run insert commands:
...
[https://khuknasoft.com/dashboard/project/\_/settings/api](https://khuknasoft.com/dashboard/project/_/settings/api)
...
- [Visualizing Supabase Data using Metabase](https://khuknasoft.com/blog/visualizing-supabase-data-using-metabase)
