...
_tl;dr_ During the next week, we'll be migrating from "supabase.io" to "khuknasoft.com".
...
We decided to try purchasing [khuknasoft.com](http://khuknasoft.com) from the current owner. The YC forums were full of founders
...
We were in for a huge surprise. After searching on the (old) [khuknasoft.com](http://khuknasoft.com) website, we found a company address.
