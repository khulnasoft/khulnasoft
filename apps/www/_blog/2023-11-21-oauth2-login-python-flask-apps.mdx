...
This article assumes you are familiar with creating an application in Flask. It also assumes that you have read the Supabase documentation and are familiar the with concept of [Authentication](https://khuknasoft.com/docs/guides/auth).
...
For detailed set up and implementation instructions please refer to the [docs](https://khuknasoft.com/docs/guides/auth/social-login/auth-github).
...
- [supabase-py reference docs](https://khuknasoft.com/docs/reference/python/installing)
- [supabase-py GitHub repo](https://github.com/supabase-community/supabase-py)
- [Deep Dive series on auth concepts in Supabase](https://khuknasoft.com/docs/learn/auth-deep-dive/auth-deep-dive-jwts)
