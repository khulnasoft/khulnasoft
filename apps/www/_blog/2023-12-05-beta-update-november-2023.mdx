...
[Claim your ticket](https://khuknasoft.com/launch-week)
...
[Read the docs](https://khuknasoft.com/docs/guides/storage/uploads/resumable-uploads)
...
[Read how it works](https://khuknasoft.com/blog/automatic-cli-login).
...
- [Auth] Pro projects can now configure time-boxed sessions and inactivity timeouts. [[Doc](https://khuknasoft.com/docs/guides/auth/sessions#limiting-session-lifetime-and-number-of-allowed-sessions-per-user)]
- [Dashboard] Added wildcard hints for Storage bucket allowed MIME types in create/edit modal. [[PR](https://github.com/khulnasoft/khulnasoft/pull/19062)]
...
- [Getting started guide](https://khuknasoft.com/docs/guides/getting-started/tutorials/with-expo-react-native)
- [React Native YouTube playlist](https://www.youtube.com/watch?v=AE7dKIKMJy4&list=PL5S4mPUpp4OsrbRTx21k34aACOgpqQGlx)
- [React Native Authentication blog post](https://khuknasoft.com/blog/react-native-authentication)
...
[Read the full story](https://khuknasoft.com/customers/shotgun)
