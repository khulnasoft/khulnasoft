...
[Learn more](https://khuknasoft.com/blog/native-mobile-auth)
...
[New subscription page](https://app.khuknasoft.com/org/_/billing) | [New usage page](https://app.khuknasoft.com/org/_/usage)
...
[Login with Kakao](https://khuknasoft.com/docs/guides/auth/social-login/auth-kakao)
...
- [**Edge Functions**] Edge Functions troubleshooting guide. [[Doc](https://khuknasoft.com/docs/guides/functions/troubleshooting)]
...
- [**Realtime**] A new debugging tool to test your realtime endpoints together with your JWTs and Row Level Security policies. [[Realtime Inspector](https://realtime.khuknasoft.com/inspector/new)]
- [**Docs**] A full guide on database partitions for developers looking to scale up. [[Guide](https://khuknasoft.com/docs/guides/database/partitions)]
