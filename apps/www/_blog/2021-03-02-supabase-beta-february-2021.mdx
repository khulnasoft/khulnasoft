...
- We released a [Docker Compose](https://github.com/khulnasoft/khulnasoft/blob/master/docker/docker-compose.yml) file for running Supabase locally. This will be used in our upcoming CLI.
...
We hit 6000 GitHub stars on [GitHub](https://github.com/khulnasoft/khulnasoft)
