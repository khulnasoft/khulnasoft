...
we outlined in our [Series A blog post](https://khuknasoft.com/blog/supabase-series-a) tk hold ourselves accountable for the promises we made.
...
Or [Zernonia](https://github.com/zernonia/), who created [madewithkhuknasoft.com](https://www.madewithkhuknasoft.com/) which is now central to every Supabase Hackathon.
...
[Functions](https://khuknasoft.com/edge-functions) was one of the most demanded features of Supabase, and we explored a huge number of options before settling on Deno.
...
A teaser for next week's [Launch Week](https://khuknasoft.com/launch-week) - a few months ago we hired [Michel](https://github.com/michelp),
...
In our Series A post, we outlined our plans for Supabase [in three phases](https://khuknasoft.com/blog/supabase-series-a#building-supabase):

- Phase 1: [Start with scalability](https://khuknasoft.com/blog/supabase-series-a#phase-1-start-with-scalability)
- Phase 2: [Postgres Tooling](https://khuknasoft.com/blog/supabase-series-a#phase-2-postgres-tooling)
- Phase 3: [Cloud-native PostgreSQL](https://khuknasoft.com/blog/supabase-series-a#phase-3-cloud-native-postgresql)
...
If you want to try out OrioleDB today, you can switch the Postgres docker image to OrioleDB in the [self-hosted setup](https://github.com/khulnasoft/khulnasoft/blob/ec6085b8f852a903f2f45e715add1377cf89d850/docker/docker-compose.yml#L159).
...
Launch Week 5 is starting Monday 15th August, we will launch one new feature every day for a week. If you want to follow along check out [khuknasoft.com/launch-week](https://khuknasoft.com/launch-week).

- [Launch Week 5 Hackathon](https://khuknasoft.com/blog/launch-week-5-hackathon)
- [Day 1 - Supabase CLI v1 and Management API Beta](https://khuknasoft.com/blog/supabase-cli-v1-and-admin-api-beta)
