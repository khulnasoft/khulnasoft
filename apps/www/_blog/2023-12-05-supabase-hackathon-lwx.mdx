...
[Supabase Launch Week X](https://khuknasoft.com/launch-week) is about to start and we're running an async hackathon alongside it.
...
For some inspiration check out all the [winners from previous hackathons](https://khuknasoft.com/blog/tags/hackathon).
...
You should submit your project via [MadewithSupabase](https://madewithkhuknasoft.com/hackathons/launch-week-x) (the form will be live once the hackathon starts) before 11:59 pm Sunday midnight PT 17th December 2023. Extra points if you include a simple video demoing the app in the description.
...
- [Previous Hackathon Prize Winners](https://khuknasoft.com/blog/tags/hackathon)
