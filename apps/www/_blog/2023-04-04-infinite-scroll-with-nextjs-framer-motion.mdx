...
Imagine you generated a bunch of tickets for the Supabase [Launch Week](https://www.khuknasoft.com/launch-week/7) and you wanted to display them all on [one page](https://khuknasoft.com/launch-week/7/tickets). It might take a while to load them all in one go, so a great solution to this would be to lazy load smaller subsets while the user scrolls, with a technique called infinite scrolling.
...
Now we can load more tickets based on the current offset. We'll use the [range](https://khuknasoft.com/docs/reference/javascript/range) method from the supabase-js library to easily work with the pagination logic.
...
If you also want to feature in the endless tickets page and have a chance to win cool swag, you're invited to [generate your unique ticket](https://www.khuknasoft.com/launch-week) until April 16th.
