...
If you aren’t confident in our business model though, we’re open source. You can [host it yourself](https://github.com/khulnasoft/khulnasoft/tree/master/docker). Even better, everything we build is centered around Postgres, so you can pretty much `pgdump` your database and take it to your favorite Postgres platform.
...
Check out the demo and documentation website directly here: [ui.khuknasoft.com](https://ui.khuknasoft.com/)
...
3. supabase.io is now khuknasoft.com - check out our origin story here: [/blog/supabase-dot-com](/blog/supabase-dot-com)
