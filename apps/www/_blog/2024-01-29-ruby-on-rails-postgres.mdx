...
There's also a [Heroku to Supabase migration tool](https://migrate.khuknasoft.com/) available to migrate in just a few clicks.
...
When your project is up and running, navigate to the [database settings](https://khuknasoft.com/dashboard/project/_/settings/database) to find the URI connection string.
...
```bash Terminal
export DATABASE_URL=postgres://postgres.xxxx:password@xxxx.pooler.khuknasoft.com:5432/postgres
```
