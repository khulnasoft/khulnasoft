...
[Quickstart](https://khuknasoft.com/docs/guides/getting-started/quickstarts/kotlin)

[Tutorial](https://khuknasoft.com/docs/guides/getting-started/tutorials/with-kotlin)
...
[Read the benchmark](https://khuknasoft.com/blog/pgvector-performance)

## Quick product announcements

- [Auth] There is a new OAuth provider in time: Login with Figma. [Docs](https://khuknasoft.com/docs/guides/auth/social-login/auth-figma)
...
- [Postgres Tooling] PostgREST 11.1 is now live. [Blog post](https://khuknasoft.com/blog/postgrest-11-1-release)
...
- React Native file upload with Supabase Storage. [Tutorial](https://khuknasoft.com/blog/react-native-storage) | [Video](https://www.youtube.com/watch?v=am6w5zEDk_g)
