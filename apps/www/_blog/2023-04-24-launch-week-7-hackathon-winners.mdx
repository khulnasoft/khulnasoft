...
[Launch Week 7](https://khuknasoft.com/launch-week) passed by, but we still have our favorite part left, celebrating the winners of the hackathon! We added an AI theme to our hackathon, and the results were exceptional. The quality of the apps was out of this world.
...
As promised in the [hackathon announcement article](https://khuknasoft.com/blog/launch-week-7-hackathon) the winners of the Best overall project will be granted the extremely limited edition Supabase Launch Week 7 Keyboard!
...
- **[Quick Start Guides](https://khuknasoft.com/docs/guides/getting-started)**
