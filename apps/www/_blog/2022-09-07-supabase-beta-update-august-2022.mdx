...
[Blog Post](https://khuknasoft.com/blog/supabase-cli-v1-and-admin-api-beta)
...
[Blog Post](https://khuknasoft.com/blog/supabase-soc2)

[Security at Supabase](https://khuknasoft.com/security)
...
[Blog Post](https://khuknasoft.com/blog/supabase-realtime-multiplayer-general-availability)
...
We wrapped Launch Week 5 with contributors, partners, and friends and the traditional One More Thing... that was actually SIX more things: [Supabase Vault](https://khuknasoft.com/blog/supabase-vault), Auth UI, Dashboard permissions, [JSON schema validation](https://khuknasoft.com/blog/pg-jsonschema-a-postgres-extension-for-json-validation), pg_graphql v0.4.0, MFA early-access.

[Community Day Blog Post](https://khuknasoft.com/blog/launch-week-5-community-day)

[Community Day Video Announcement](https://www.youtube.com/watch?v=s9UePQjLT0U)

[One More Thing Blog Post](https://khuknasoft.com/blog/launch-week-5-one-more-thing)
...
[Full list of winners](https://khuknasoft.com/blog/launch-week-5-hackathon-winners)

[Check all the submissions in Made with Supabase](https://www.madewithkhuknasoft.com/launch-week-5)
...
- [Firebase Auth Migration](https://khuknasoft.com/docs/guides/migrations/firebase-auth)
- [Firestore Data Migration](https://khuknasoft.com/docs/guides/migrations/firestore-data)
- [Firebase Storage Migration](https://khuknasoft.com/docs/guides/migrations/firebase-storage)
- [Migrate from Heroku to Supabase](https://khuknasoft.com/docs/guides/migrations/heroku)
...
- A new guide showing how to combine Supabase and Directus. [Guide](https://khuknasoft.com/partners/integrations/directus)
