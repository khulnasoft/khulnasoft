...
[Launch Week](https://khuknasoft.com/launch-week) is about to start and we're running a hackathon in parallel for the entire duration.

There's a $1500 GitHub sponsorship and [gold Supabase caps](https://supabase.store/products/gold-supacap) to be won!

[Supabase-js v2.0](https://github.com/khulnasoft/khulnasoft-js/releases) and [Flutter SDK v1.0](https://khuknasoft.com/blog/supabase-flutter-sdk-1-developer-preview) will both be announced during Launch Week, they are both available already and using them in your project will gain extra credit!
...
You should submit your project using [this form](https://www.madewithkhuknasoft.com/launch-week-5).
...
- [Day 1 - supabase-js v2 Release Candidate](https://khuknasoft.com/blog/supabase-js-v2)
