...
We are excited to announce that [Edge Functions](https://khuknasoft.com/docs/guides/functions) now natively supports npm modules and Node built-in APIs. You can directly import millions of popular, commonly used npm modules into your Edge Functions.
...
We created a demo to show how to migrate a Node app that uses Express, Node Postgres, and Drizzle. For more information on using npm modules and Node built-ins within your Edge Functions, see the [Managing dependencies guide](https://khuknasoft.com/docs/guides/functions/import-maps).
...
```bash cURL
# https://khuknasoft.com/docs/guides/functions/deploy#invoking-remote-functions
...
```js JavaScript
// https://khuknasoft.com/docs/reference/javascript/installing
import { createClient } from '@supabase/supabase-js'

// Create a single supabase client for interacting with your database
const supabase = createClient('https://xyzcompany.supabase.co', 'public-anon-key')

// https://khuknasoft.com/docs/reference/javascript/functions-invoke
...
ℹ️ Check out the [Regional Invocation guide](https://khuknasoft.com/docs/guides/functions/regional-invocation) for more details.

</div>

### Better Metrics

We've added more metrics in the Edge Functions section of the [Supabase Dashboard](https://khuknasoft.com/dashboard/project/_/functions): it now shows CPU time and memory used. We've also broken down invocations by HTTP status codes.

These changes help you spot any issues with your Edge Functions and act on them.

<div className="bg-gray-300 rounded-lg px-6 py-2 bold">

ℹ️ See the [logging and metrics guide](https://khuknasoft.com/docs/guides/functions/debugging) for Edge Functions to learn more.
...
NPM support was one of the most requested features for Edge Functions. If you couldn't use Edge Functions previously because of the lack of support, we hope this update will entice you to [try it again](https://khuknasoft.com/dashboard/project/_/functions). If you run into any issues, we are just [one support request away](https://supabase.help).
