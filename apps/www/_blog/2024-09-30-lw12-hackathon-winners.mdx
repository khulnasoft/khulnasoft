...
The [Launch Week 12](https://khuknasoft.com/launch-week) brought us a whole new set of Supabase features to build with. And to showcase what developers can build with Supabase, we announced the [Launch Week 12 hackathon](https://khuknasoft.com/blog/supabase-lw12-hackathon) a while back, and it’s finally time to announce the winners!
