...
The Wasm FDW feature is available today on the Supabase platform. We have 2 new built-in Wasm FDWs: [Snowflake](https://khuknasoft.com/docs/guides/database/extensions/wrappers/snowflake) and [Paddle](https://khuknasoft.com/docs/guides/database/extensions/wrappers/paddle).

To get started, follow below steps:

1. Create a new Supabase project: [database.new](http://database.new)
2. Navigate to the [Database -> Wrappers](https://khuknasoft.com/dashboard/project/_/database/wrappers) section and enable Wrappers.
...
Inside the [SQL editor](https://khuknasoft.com/dashboard/project/_/sql/new), enable the Wasm Wrapper feature:
