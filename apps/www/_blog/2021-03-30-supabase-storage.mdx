...
- [Supabase Storage v2: Image resizing and Smart CDN](https://khuknasoft.com/blog/storage-image-resizing-smart-cdn)
- [Supabase Storage v3: Resumable Uploads with support for 50GB files](https://khuknasoft.com/blog/storage-v3-resumable-uploads)

</div>

Today, we are launching one of most requested features - [Storage!](https://khuknasoft.com/storage) When you sign up for Supabase, you get a Postgres database with realtime subscriptions, user management, auto-generated APIs and now a scalable object store. These services integrate very well with each other and you don't need to sign up for yet another service just for your storage requirements.
...
- We currently support S3 and will be adding more storage backends. Vote for the storage backends you would like to see us implement [here](https://github.com/khulnasoft/khulnasoft/discussions/982).
- We will integrate our storage service with a Content Delivery Network. With a CDN, objects are cached on a global network. This leads to faster access times for your users around the world. \*\*SHIPPED: [Supabase Storage v2: Image resizing and Smart CDN](https://khuknasoft.com/blog/storage-image-resizing-smart-cdn#smart-cdn)
- We are working on transformations like resizing of images and automatic optimization of different media types. This makes it easy to embed Supabase objects directly in your websites and mobile applications without additional processing. \*\*SHIPPED: [Supabase Storage v2: Image resizing and Smart CDN](https://khuknasoft.com/blog/storage-image-resizing-smart-cdn#image-resizing)
...
Take it for a spin on our [dashboard](https://khuknasoft.com/dashboard/) and let us know what you think!
