...
You may already know him as the maintainer of [madewithkhuknasoft.com](https://www.madewithkhuknasoft.com/).
...
Just a reminder, we also support [Twilio](https://khuknasoft.com/docs/guides/auth/phone-login/twilio) and [MessageBird](https://khuknasoft.com/docs/guides/auth/phone-login/messagebird).

On a final note, we are hiring for an [Auth Engineer](https://about.khuknasoft.com/careers/auth-engineers).

## Query logs with SQL

Supabase logs are more powerful with the [newly added SQL querying](https://github.com/khulnasoft/khulnasoft/pull/4734).

We added [timestamp filtering](https://github.com/khulnasoft/khulnasoft/pull/4904), and you’ll notice our usage charts have [more time spans available](https://github.com/khulnasoft/khulnasoft/pull/4732).
...
You'll learn how to listen to _any_ database change, then send those changes [in a payload](https://khuknasoft.com/blog/supabase-functions-updates#hook-payload) via HTTP request.
...
And, as part of our continued commitment to Support, we are hiring [Support Engineers](https://about.khuknasoft.com/careers/support-and-qa).
...
Jason Lengstorf caught up with our very own [Jon Meyers](https://jonmeyers.io/) on his awesome show, [Learn with Jason](https://www.youtube.com/watch?v=8vqY1KT4TLU), to talk about building an app [with Supabase and Next.js](https://khuknasoft.com/docs/guides/with-nextjs).
...
Of course, we can’t tell you what will happen (perhaps because we don’t know ourselves yet), but you can always speculate in the community [Discord server](https://discord.khuknasoft.com/), or even [tweet us your predictions](https://twitter.com/supabase).
