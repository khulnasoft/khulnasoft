...
We previously [discussed](https://khuknasoft.com/blog/supabase-soc2) the process the SOC2 Type 1. To recap,
...
We used the same auditor to streamline the process. Many of the controls required for HIPAA compliance could be mapped to the testing they had already done for SOC2. Additional evidence for encryption, audit logs, business continuity and disaster recovery exercises was unnecessary since the auditor already had access to it. And some of the HIPAA checks such as Facility Access Controls were not applicable to us since [we are a remote company](https://khuknasoft.com/blog/why-supabase-remote).
...
If you want to start developing healthcare apps on Supabase, reach out to our team [here](https://forms.khuknasoft.com/hipaa2) to sign our BAA. We are excited to see what you build!
