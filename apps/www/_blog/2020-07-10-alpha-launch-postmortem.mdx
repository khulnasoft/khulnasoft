...
GitHub stars rocketed for our two main repos, [supabase](https://github.com/khulnasoft/khulnasoft) and [realtime](https://github.com/supabase/realtime).
