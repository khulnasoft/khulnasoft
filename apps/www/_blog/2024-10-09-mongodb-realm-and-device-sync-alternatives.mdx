...
- **Guide**: [Legend-State Guide](https://khuknasoft.com/blog/local-first-expo-legend-state)
...
With Legend-State, developers can integrate [**real-time data sync**](https://khuknasoft.com/realtime) while maintaining performance and consistency during network outages—something previously handled by MongoDB Realm.
...
- **Guide**: [WatermelonDB for React Native](https://khuknasoft.com/blog/react-native-offline-first-watermelon-db)
...
- **Partner Gallery**: [Supabase & PowerSync](https://khuknasoft.com/partners/integrations/powersync)
...
- **Partner Gallery**: [Replicache & Supabase](https://khuknasoft.com/partners/integrations/replicache)
...
- **Partner Gallery**: [ElectricSQL & Supabase](https://khuknasoft.com/partners/integrations/electricsql)
