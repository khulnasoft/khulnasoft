...
The [Supabase GA week](https://khuknasoft.com/ga-week) brought us so many cool updates, but the fun isn’t over yet, because we are now announcing the winners of the [Supabase Open Source Hackathon 2024](https://khuknasoft.com/blog/supabase-oss-hackathon)!

We have enjoyed trying out every single submission we have received! You can find all of the submissions on [madewithkhuknasoft.com](https://www.madewithkhuknasoft.com/).
...
- [AI & Vectors Guide](https://khuknasoft.com/docs/guides/ai)
