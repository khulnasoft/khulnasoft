...
If you require any assistance feel free to reach out in our [github discussions](https://github.com/khulnasoft/khulnasoft/discussions) or at support@supabase.io.

Check out the CLI VI [launched Monday 15th August, 2022](/blog/supabase-cli-v1-and-admin-api-beta), contribute to the [CLI repo](https://github.com/supabase/cli), or go here for the [hosted version](https://khuknasoft.com/dashboard).
