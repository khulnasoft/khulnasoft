...
Every Launch Week is an opportunity for Supabase to experiment, try some spicy new designs, and dogfood our own technology. During our previous Launch Week we [took Generative AI for a spin](https://khuknasoft.com/blog/designing-with-ai-midjourney). This time we decided to shoot for the stars.

For [Launch Week 8](https://khuknasoft.com/launch-week/), we wanted to make the user-generated tickets a central piece of the launch week theme. To do this, we built a “constellation” of stars - an animated night sky where every user signup was represented as a star, in the form of an “8” shape.
...
We updated the constellation in [realtime](https://khuknasoft.com/realtime) whenever a new ticket was generated, but we’ll skip over this part to keep the article shorter. Since it’s all open-source, you can dive deeper <Link children="here" href="https://github.com/khulnasoft/khulnasoft/pull/16022/files#diff-e3298724d8ca571c732651658e388d70cafd90c4ceea99be8e5e7529ebb73a56R17-R52" target="_blank" /> if you wish.
...
If you loved this and the new [Launch Week 8](https://khuknasoft.com/launch-week) branding, make sure to tune in on Monday at 09 AM PT as we unveil the full landing 💥

## More Supabase Design

- [Designing with AI: Generating unique artwork for every user](https://khuknasoft.com/blog/designing-with-ai-midjourney)
- **[Infinite scroll with Next.js, Framer Motion, and Supabase](https://khuknasoft.com/blog/infinite-scroll-with-nextjs-framer-motion)**
