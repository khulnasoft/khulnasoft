...
We've released [Supabase Studio](https://github.com/khulnasoft/khulnasoft/tree/master/studio). The same Dashboard that you're using on our Platform is now available for Local Development and Self-Hosting.
