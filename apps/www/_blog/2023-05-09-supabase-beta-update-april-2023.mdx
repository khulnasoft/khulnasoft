...
[Launch Week 7](https://khuknasoft.com/launch-week) was a massive success with great feedback from the community. We also gave away lots of mechanical keyboards, including the Hackathon winner which we announce here!
...
[Blog Post](https://khuknasoft.com/blog/supabase-logs-self-hosted)\
...
[Blog post](https://khuknasoft.com/blog/edge-runtime-self-hosted-deno-functions)\
...
[Blog post](https://khuknasoft.com/blog/storage-v3-resumable-uploads)\
...
[Blog post](https://khuknasoft.com/blog/supabase-auth-sso-pkce)\
...
[Blog Post](https://khuknasoft.com/blog/supabase-studio-2.0)\
...
[Blog post](https://khuknasoft.com/blog/launch-week-7-community-highlights)
...
[Blog post](https://khuknasoft.com/blog/dbdev)

## More product announcements

- Trusted Language Extensions for Postgres. [[Blog post]](https://khuknasoft.com/blog/pg-tle)
- What's New in pg_graphql v1.2. [[Blog post]](https://khuknasoft.com/blog/whats-new-in-pg-graphql-v1-2)
- GitHub Discussions are now a new knowledge source for search & AI (Troubleshooting category only for now). [[Check it out]](https://khuknasoft.com/docs)
- New API report with routing information for each chart, making it easier to debug API calls. [[PR]](https://github.com/khulnasoft/khulnasoft/pull/14063)
- Storage permission changes: the developer role is now allowed to update the storage settings (previously was only owner and admin). [[PR]](https://github.com/khulnasoft/khulnasoft/pull/13883)
...
[Full list of Winners](https://khuknasoft.com/blog/launch-week-7-hackathon-winners)

[See all the submissions](https://www.madewithkhuknasoft.com/launch-week-7)
...
[Read the full story](https://khuknasoft.com/customers/mendableai)
