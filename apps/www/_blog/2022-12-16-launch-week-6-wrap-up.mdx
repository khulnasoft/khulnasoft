...
- Check out [the new docs](https://khuknasoft.com/docs)
...
- Read the [announcement](https://khuknasoft.com/blog/storage-image-resizing-smart-cdn)
- Watch the [recap on YouTube](https://www.youtube.com/watch?v=NpEl20iuOtg)
- Browse the docs for [Image Transformations](https://khuknasoft.com/docs/guides/storage/serving/image-transformations)
- Browse the docs for our [Smart CDN](https://khuknasoft.com/docs/guides/storage/cdn/smart-cdn)
...
- [Star us on GitHub](https://github.com/khulnasoft/khulnasoft)
- [Join the Discord](https://discord.khuknasoft.com)
- [Read the docs](https://khuknasoft.com/docs)
