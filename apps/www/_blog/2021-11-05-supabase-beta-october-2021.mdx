...
[Slack](https://khuknasoft.com/docs/guides/auth/social-login/auth-slack),
[Spotify](https://khuknasoft.com/docs/guides/auth/social-login/auth-spotify), and
[MessageBird](https://khuknasoft.com/docs/guides/auth/phone-login/messagebird) phone logins.
...
[Docs](https://khuknasoft.com/docs/reference/javascript/initializing#api-schemas).
...
Learn about PostgreSQL Functions. [Docs](https://khuknasoft.com/docs/guides/database/functions).
...
Learn about all the exciting features of Auth within Supabase. [Docs](https://khuknasoft.com/docs/guides/auth).
...
Learn more about the power of PostgREST for RESTful APIs. [Docs](https://khuknasoft.com/docs/guides/database/api#restful-api).
...
- Redwood Quickstart: [https://khuknasoft.com/docs/guides/with-redwoodjs](https://khuknasoft.com/docs/guides/with-redwoodjs)
- Expanded Self-hosting: [https://khuknasoft.com/docs/guides/hosting/overview](https://khuknasoft.com/docs/guides/hosting/overview)
- Expanded Auth Reference docs with [serverside functions](https://khuknasoft.com/docs/reference/javascript/auth-api-deleteuser).
- "Before you launch" checklist: [https://khuknasoft.com/docs/going-into-prod](https://khuknasoft.com/docs/going-into-prod)
...
- Made With Supabase (now on Nuxt 3) - Zernonia [site](https://www.madewithkhuknasoft.com/)
...
We hit 20K stars!! 21,268 to be exact: [github.com/khulnasoft/khulnasoft](http://github.com/khulnasoft/khulnasoft)
...
We had Launch Week [numero uno](https://khuknasoft.com/blog/launch-week) in March, and the sequel "[Launch Week II: the SQL](https://khuknasoft.com/blog/supabase-launch-week-sql)" in July.

Now we're going even bigger with the third installment: `Launch Week III: The Trilogy`. Join us on 29th November on our [Discord](https://discord.khuknasoft.com).
