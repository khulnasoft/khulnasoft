...
By default, [`supabase-js`](https://khuknasoft.com/docs/reference/javascript/introduction) uses `localStorage` to store the user's session. This works well for client-side apps, but will fail when you try to use [`supabase-js`](https://khuknasoft.com/docs/reference/javascript/introduction) in a Server Component, as there is no concept of 'localStorage' on the server.
...
That is a lot of very confusing code! So we decided to [create a package called `@supabase/ssr`](https://khuknasoft.com/docs/guides/auth/server-side/overview) that does all of this for you. Then we took it one step further and created a [Next.js and Supabase Starter Template](https://khuknasoft.com/docs/guides/getting-started/quickstarts/nextjs), so you can just focus on building your awesome app! 🚀
...
- [Next.js Quickstart](https://khuknasoft.com/docs/guides/getting-started/quickstarts/nextjs)
- [Build a User Management App with Next.js](https://khuknasoft.com/docs/guides/getting-started/tutorials/with-nextjs)
- [Server-Side Auth Overview](https://khuknasoft.com/docs/guides/auth/server-side/overview)
- [Fetching and caching Supabase data in Next.js 13 Server Components](https://khuknasoft.com/blog/fetching-and-caching-supabase-data-in-next-js-server-components)
