...
Supabase Vault is now available on every Supabase project. [Check it out](https://khuknasoft.com/dashboard/project/_/settings/vault/secrets)
...
To learn how to use Supabase Vault, check out the [docs](https://khuknasoft.com/docs/guides/database/vault). Supabase Vault is now available on all [Supabase projects](https://khuknasoft.com/dashboard/project/_/settings/vault/secrets) (some projects will have to enable via request).
