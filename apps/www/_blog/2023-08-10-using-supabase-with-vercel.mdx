...
You can now [link multiple](https://app.khuknasoft.com/org/_/integrations) Vercel projects to a single Supabase project:
...
For now, Branching in Supabase is limited to development partners. We'll be rolling it out to everyone over the coming months. If you're interested in testing the new features, [sign up for early access](https://forms.khuknasoft.com/branching-request).
