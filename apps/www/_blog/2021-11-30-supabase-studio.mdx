...
Today we're releasing [Supabase Studio](https://github.com/khulnasoft/khulnasoft/tree/master/studio).
The same Dashboard that you're using on our Platform is now available for [Local Development](https://khuknasoft.com/docs/guides/local-development)
and [Self-Hosting](https://khuknasoft.com/docs/guides/hosting/overview).
...
We've been planning to make the Dashboard public for a long time now, starting with [Supabase UI](https://ui.khuknasoft.com/),
[`supabase/grid`](https://github.com/supabase/grid), and a standalone [PR](https://github.com/khulnasoft/khulnasoft/pull/2281) for Supabase Studio.
...
For the past week, the dashboard you've been using on the Platform has been deployed from our [main repository](https://github.com/khulnasoft/khulnasoft/tree/master/studio).
...
- [Supabase UI](https://ui.khuknasoft.com/) - Our own component library.
- [MobX](https://www.mobxjs.com/) - A state management library.
- A host of other [useful libraries](https://github.com/khulnasoft/khulnasoft/blob/master/studio/package.json), including [Radix UI](https://www.radix-ui.com), [Lottiefiles](https://lottiefiles.com/), [react-grid-layout](https://github.com/react-grid-layout/react-grid-layout), and [zxcvbn](https://github.com/dropbox/zxcvbn).
...
Check out the full instructions in our [Studio Readme](https://github.com/khulnasoft/khulnasoft/tree/master/studio).
