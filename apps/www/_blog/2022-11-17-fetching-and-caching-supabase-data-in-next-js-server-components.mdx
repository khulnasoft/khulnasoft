...
Before we jump into fetching data, we need some data to fetch. Let’s [create a new Supabase project](https://khuknasoft.com/dashboard).

Once your instance is up and running, head over to the [SQL Editor](https://khuknasoft.com/dashboard/project/_/sql), paste in the following snippet and click `RUN`.
...
> The values for these can be found in [your project’s API settings](https://khuknasoft.com/dashboard/project/_/settings/api).
...
> For automatically adding types to the Supabase client, check out [how to generate types](https://khuknasoft.com/docs/reference/javascript/typescript-support).
...
> Again, check out [how to generate types](https://khuknasoft.com/docs/reference/javascript/typescript-support) to add proper typing for Post.

But now we have loading spinners! Yuck!

# Realtime

Realtime allows us to subscribe to changes in Supabase — inserted, updated or deleted posts — and update our UI dynamically. In order to receive realtime events, we need to [enable replication](https://khuknasoft.com/dashboard/project/_/database/publications) on the posts table.
...
- [Next.js Quickstart](https://khuknasoft.com/docs/guides/with-nextjs)
