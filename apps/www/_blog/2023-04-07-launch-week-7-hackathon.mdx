...
With Easter just around the corner, [Launch Week](https://khuknasoft.com/launch-week) is about to start and, as usual, we're running an async hackathon alongside it. This time it’s AI-themed!
...
For some inspiration check out the [Next.js OpenAI Doc Search template](https://github.com/supabase-community/nextjs-openai-doc-search?og=v2) released yesterday and [storing embeddings on Supabase article](https://khuknasoft.com/blog/openai-embeddings-postgres-vector).

Additionally, you can see all the [winners from previous hackathons](https://khuknasoft.com/blog/tags/hackathon).
...
You should submit your project using [this form](https://www.madewithkhuknasoft.com/launch-week-7) before 11:59 pm Sunday midnight PT 16th April 2023. Extra points if you include a simple video demoing the app in the description.
...
- [Storing OpenAI embeddings in Postgres with pgvector article](https://khuknasoft.com/blog/openai-embeddings-postgres-vector)
- [pgvector guide](https://khuknasoft.com/docs/guides/database/extensions/pgvector)
...
Don't forget to check out the new features being announced as part of [Launch Week](https://khuknasoft.com/launch-week).

- [Previous Hackathon Prize Winners](https://khuknasoft.com/blog/launch-week-6-hackathon-winners)
