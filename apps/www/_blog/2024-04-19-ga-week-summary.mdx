...
[Read more.](https://khuknasoft.com/blog/supabase-bootstrap)
...
[Read more.](https://khuknasoft.com/blog/branching-publicly-available)
...
[Read more.](https://khuknasoft.com/blog/supabase-swift)
...
[Read more.](https://khuknasoft.com/blog/security-performance-advisor)
...
[Read more.](https://khuknasoft.com/blog/ai-inference-now-available-in-supabase-edge-functions)
...
[Read more.](https://khuknasoft.com/blog/s3-compatible-storage)
...
[Read more.](https://khuknasoft.com/blog/anonymous-sign-ins)
...
[Read more.](https://khuknasoft.com/blog/supabase-acquires-oriole)
...
[Check out the journey so far.](https://khuknasoft.com/ga)
...
In the previous Launch Week we started working on [Fly Postgres, a managed offering from Supabase](https://khuknasoft.com/blog/postgres-on-fly-by-supabase). We've received a lot of feedback from early testers, and we're working hard to make the service available and as resilient for production workloads.
...
The 10-day hackathon is still going! If you want a chance to win a set of Apple AirPods along with extremely limited edition Supabase swag check out [all the details here](https://khuknasoft.com/blog/supabase-oss-hackathon).
