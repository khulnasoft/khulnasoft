...
In the case of Pebblely, Alfred and SK built their prototype in just two days, utilizing Supabase for the [database](https://khuknasoft.com/database), API, [realtime](https://khuknasoft.com/realtime) functionality, and [authentication](https://khuknasoft.com/auth). They successfully launched the prototype in January 2023.
...
> To learn more about how Supabase Auth can help you build and scale secure AI apps with ease, [reach out to us](https://forms.khuknasoft.com/enterprise).
