...
[Authentication](https://khuknasoft.com/auth), built using [GoTrue](https://github.com/supabase/gotrue), instantly solved their users' login issues.
...
[Sign up](https://khuknasoft.com/dashboard/) for Supabase's Free Plan and set up a scalable backend in less than 2 minutes.
