...
Their database infrastructure bill went from $7k to a bit over $2k and Shotgun was able to turn off most of their Fivetran spend by taking advantage of the [publications features](https://khuknasoft.com/docs/guides/database/replication) available in Supabase.
...
> To learn more about how Supabase can help you manage and scale your database, **[reach out to us](https://forms.khuknasoft.com/enterprise)**.
