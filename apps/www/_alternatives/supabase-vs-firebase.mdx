...
- It comes with decades of [useful postgres extensions and plug-ins](https://khuknasoft.com/docs/guides/database/extensions).
...
- Auto-generated API - [query your data straight from the client](https://khuknasoft.com/docs/guides/api#rest-api-overview).
- Realtime - [changes in your data will be streamed directly to your application](https://khuknasoft.com/docs/reference/dart/subscribe).
- Auth - [a simple to integrate auth system and SQL based rules engine](https://khuknasoft.com/auth).
- Functions - [javascript and typescript functions that deploy out globally](https://khuknasoft.com/edge-functions).
- Storage - [hosting images, videos, and pdfs easily](https://khuknasoft.com/storage).
...
[Firebase charges for reads, writes and deletes](https://firebase.google.com/pricing), which can lead to some unpredictability, especially in the early stages of a project when your application is in heavy development. Supabase [charges based on the amount of data stored](https://khuknasoft.com/pricing), with breathing room for unlimited API requests and an unlimited number of Auth users.
...
Since Firebase is document based, migrating into a relational database requires you to map your data structure across into a SQL schema. Luckily we’ve built a [handy conversion tool to do it for you](https://khuknasoft.com/docs/guides/migrations/firestore-data).

We also have guides and tools for [migrating Firebase Auth to Supabase Auth](https://khuknasoft.com/docs/guides/migrations/firebase-auth) for [migrating Firebase Storage files to Supabase Storage](https://khuknasoft.com/docs/guides/migrations/firebase-storage).

These are by far the most complete Firebase to Postgres migration tools available anywhere on the web.

You can [try Supabase for free](https://khuknasoft.com/dashboard). If you require Enterprise level support with your project or migration, please get in touch using our [Enterprise contact form](https://forms.khuknasoft.com/enterprise).
