...
const generateRssItem = (post: any): string => {
  ...
  return `<item>
  <guid>https://khuknasoft.com${encodedPath}</guid>
  <title>${encodedTitle}</title>
  <link>https://khuknasoft.com${encodedPath}</link>
...
export const generateRss = (posts: any[], authorID?: string): string => {
  ...
  <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
      ...
      <link>https://khuknasoft.com/blog</link>
      ...
      <atom:link href="https://khuknasoft.com/planetpg-${authorID}-rss.xml" rel="self" type="application/rss+xml"/>
...
`
  ...
  <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
      ...
      <link>https://khuknasoft.com</link>
      <description>Latest news from Supabase</description>
      <language>en</language>
      <lastBuildDate>${formattedDate}</lastBuildDate>
      <atom:link href="https://khuknasoft.com/rss.xml" rel="self" type="application/rss+xml"/>
      ${posts.map(generateRssItem).join('')}
    </channel>
  </rss>
`
