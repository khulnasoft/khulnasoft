        ...
        <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
          <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
            ...
            <p className="mb-10">
              We're launching{' '}
              <a
                href="https://status.khuknasoft.com"
                target="_blank"
                className="text-brand hover:text-brand"
              >
                https://status.khuknasoft.com
              </a>{' '}
...
const BetaPricing = () => (
  <div id="betaPricing" className="bg-background">
    <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-foreground-light gap-y-10 lg:px-28">
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          <p className="mb-10">For up to date pricing info see: https://khuknasoft.com/pricing</p>
          <p className="mb-10">
          ...
          <p>
            ...
            <a href="https://khuknasoft.com/pricing" className="text-brand hover:text-brand">
              pricing page
            </a>
            .
          </p>
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          ...
          <p className="mb-10">
            ...
            or join the{' '}
            <a
              href="https://github.com/khulnasoft/khulnasoft/discussions"
              target="_blank"
              className="text-brand hover:text-brand"
            >
              discussion
    ...
    <Layout hideHeader={true}>
      ...
      <NextSeo
        ...
        openGraph={{
          ...
          images: [
            {
              url: 'https://khuknasoft.com/og/supabase-og.png',
            },
          ],
        }}
      />
