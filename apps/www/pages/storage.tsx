    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: meta_title,
          description: meta_description,
          url: `https://khuknasoft.com/storage`,
          images: [
            {
              url: `https://khuknasoft.com${basePath}/images/product/storage/storage-og.jpg`,
            },
          ],
        }}
      />
            ...
            footer={
              <>
                ...
                <ExampleCard
                  ...
                  repo_url={
                    'https://github.com/khulnasoft/khulnasoft/tree/master/examples/user-management/nextjs-user-management'
                  }
                  vercel_deploy_url={
