    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: pageData.metaTitle,
          description: pageData.metaDescription,
          url: `https://khuknasoft.com/partners`,
          images: [
            {
              url: `https://khuknasoft.com${router.basePath}/images/og/integrations.png`, // TODO
            },
          ],
        }}
      />
        ...
        <SectionContainer>
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-4">
            <div className="col-span-1 lg:col-span-2">
              ...
              <TextLink
                url="https://khuknasoft.com/docs/guides/platform/marketplace"
                label="View docs"
              />
            </div>
          ...
          <SectionContainer className="flex flex-col gap-8">
            <div className="flex flex-col lg:flex-row gap-8 xl:gap-10 justify-between">
              <div className="w-full lg:w-1/2 gap-2 flex flex-col items-start">
                ...
                <TextLink
                  url="https://khuknasoft.com/docs/guides/platform/oauth-apps/publish-an-oauth-app"
                  label="Learn more"
                />
              </div>
          ...
          <div className="flex flex-col text-center gap-4 py-8 items-center justify-center">
            ...
            <div className="w-full mt-4 flex items-center justify-center text-center gap-4">
              <Button asChild size="medium">
                <Link href="https://forms.khuknasoft.com/partner" tabIndex={-1}>
                  Become a Partner
                </Link>
              </Button>
            </div>
