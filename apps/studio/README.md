...
A dashboard for managing your self-hosted Supabase project, and used on our [hosted platform](https://khuknasoft.com/dashboard). Built with:
...
Follow the [self-hosting guide](https://khuknasoft.com/docs/guides/hosting/docker) to get started.
