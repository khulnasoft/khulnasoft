      ...
      <Alert_Shadcn_ variant="warning">
        ...
        <div className="mt-3 flex items-center space-x-2">
          <Button asChild type="default">
            <Link href="https://khuknasoft.com/docs/guides/platform/exhaust-ram">Learn more</Link>
          </Button>
  ...
  if (severity === 'critical') {
    return (
      <Alert_Shadcn_ variant="destructive">
        ...
        <div className="mt-3 flex items-center space-x-2">
          <Button asChild type="default">
            <Link href="https://khuknasoft.com/docs/guides/platform/exhaust-cpu">Learn more</Link>
          </Button>
