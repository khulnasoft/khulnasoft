        ...
        links: [
          {
            ...
            url: 'https://khuknasoft.com/docs/guides/platform/compute-add-ons#disk-throughput-and-iops',
          },
          {
            name: 'Interpreting Disk IO budget',
            url: 'https://khuknasoft.com/docs/guides/platform/compute-add-ons#bursting-and-disk-io-budget',
          },
          {
            name: 'Metrics',
            url: 'https://khuknasoft.com/docs/guides/platform/metrics',
