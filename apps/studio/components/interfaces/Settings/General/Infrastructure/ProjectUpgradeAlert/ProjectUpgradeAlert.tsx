              ...
              <div className="space-y-4">
                ...
                {isDiskSizeUpdated && (
                  <Markdown
                    ...
                    [right-sized](https://khuknasoft.com/docs/guides/platform/upgrading#disk-sizing) with the upgrade.`}
                  />
                )}
                    ...
                    <AlertDescription_Shadcn_ className="flex flex-col gap-3">
                      ...
                      <div>
                        <Button size="tiny" type="default" asChild>
                          <Link
                            href="https://khuknasoft.com/docs/guides/platform/migrating-and-upgrading-projects#caveats"
                            target="_blank"
                            rel="noreferrer"
                          >
                            View docs
