...
export const lintInfoMap: LintInfo[] = [
  {
    ...
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0001_unindexed_foreign_keys',
  },
  {
    ...
    linkText: 'View table',
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0002_auth_users_exposed',
  },
  {
    ...
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0003_auth_rls_initplan',
  },
  {
    name: 'no_primary_key',
    ...
    linkText: 'View table',
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0004_no_primary_key',
  },
  {
    name: 'unused_index',
    title: 'Unused Index',
    ...
    linkText: 'View index',
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0005_unused_index',
  },
  {
    ...
    linkText: 'View policies',
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0006_multiple_permissive_policies',
  },
  {
    ...
    linkText: 'View policies',
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0007_policy_exists_rls_disabled',
  },
  {
    ...
    linkText: 'View table',
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0008_rls_enabled_no_policy',
  },
  {
    ...
    linkText: 'View index',
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0009_duplicate_index',
  },
  {
    ...
    link: () =>
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0010_security_definer_view',
    linkText: 'View docs',
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0010_security_definer_view',
  },
  {
    ...
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0011_function_search_path_mutable',
  },
  {
    ...
    linkText: 'View policies',
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0013_rls_disabled_in_public',
  },
  {
    ...
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0014_extension_in_public',
  },
  {
    ...
    docsLink: 'https://khuknasoft.com/docs/guides/platform/going-into-prod#security',
  },
  {
  ...
  },
  {
    ...
    linkText: 'View policies',
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?queryGroups=lint&lint=0015_rls_references_user_metadata',
  },
  {
    ...
    icon: <Eye className="text-foreground-muted" size={15} strokeWidth={1.5} />,
    link: () =>
      `https://khuknasoft.com/docs/guides/database/database-advisors?lint=0016_materialized_view_in_api`,
    linkText: 'View docs',
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-advisors?lint=0016_materialized_view_in_api',
  },
  {
    ...
    link: () =>
      `https://khuknasoft.com/docs/guides/database/database-linter?lint=0017_foreign_table_in_api`,
    linkText: 'View docs',
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-linter?lint=0017_foreign_table_in_api',
  },
  {
    ...
    icon: <Table2 className="text-foreground-muted" size={15} strokeWidth={1.5} />,
    link: () =>
      `https://khuknasoft.com/docs/guides/database/database-advisors?lint=0018_unsupported_reg_types&queryGroups=lint`,
    linkText: 'View docs',
    docsLink:
      'https://khuknasoft.com/docs/guides/database/database-advisors?lint=0018_unsupported_reg_types&queryGroups=lint',
  },
