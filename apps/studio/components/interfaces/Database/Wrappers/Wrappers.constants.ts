...
export const WRAPPERS: WrapperMeta[] = [
  {
    ...
    label: 'Stripe',
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions/wrappers/stripe',
    server: {
      options: [
        {
          name: 'api_key_id',
  ...
  },
  {
    ...
    label: 'Firebase',
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions/wrappers/firebase',
    server: {
      options: [
        {
          name: 'project_id',
  ...
  },
  {
    ...
    extensionName: 'S3Fdw',
    label: 'S3',
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions/wrappers/s3',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    label: 'ClickHouse',
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions/wrappers/clickhouse',
    server: {
      options: [
        {
          name: 'conn_string_id',
  ...
  },
  {
    ...
    label: 'BigQuery',
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions/wrappers/bigquery',
    server: {
      options: [
        {
          name: 'sa_key_id',
  ...
  },
  {
    ...
    label: 'Airtable',
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions/wrappers/airtable',
    server: {
      options: [
        {
          name: 'api_key_id',
  ...
  },
  {
    ...
    label: 'Logflare',
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions/wrappers/logflare',
    server: {
      options: [
        {
          name: 'api_key_id',
  ...
  },
  {
    ...
    label: 'Auth0',
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions/wrappers/auth0',
  ...
  },
  {
    ...
    label: 'Cognito',
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions/wrappers/cognito',
    minimumExtensionVersion: '0.3.0',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions/wrappers/mssql',
    minimumExtensionVersion: '0.3.0',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    label: 'Redis',
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions/wrappers/redis',
    minimumExtensionVersion: '0.3.0',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    label: 'Paddle',
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions/wrappers/paddle',
  ...
  },
  {
    ...
    label: 'Snowflake',
    docsUrl: 'https://khuknasoft.com/docs/guides/database/extensions/wrappers/snowflake',
    minimumExtensionVersion: '0.4.0',
    server: {
      options: [
        {
