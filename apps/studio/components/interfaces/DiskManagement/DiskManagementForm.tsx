                ...
                {!isReadOnlyMode && usedPercentage >= 90 && isWithinCooldownWindow && (
                  ...
                  >
                    <DocsButton
                      abbrev={false}
                      className="mt-2"
                      href="https://khuknasoft.com/docs/guides/platform/database-size#read-only-mode"
                    />
                  </Admonition>
                )}
                {isReadOnlyMode && (
                  ...
                  >
                    <DocsButton
                      abbrev={false}
                      className="mt-2"
                      href="https://khuknasoft.com/docs/guides/platform/database-size#disabling-read-only-mode"
                    />
                  </Admonition>
                )}
              </div>
