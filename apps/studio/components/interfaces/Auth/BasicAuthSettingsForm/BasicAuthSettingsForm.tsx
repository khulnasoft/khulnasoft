                  ...
                  <Toggle
                    ...
                    descriptionText={
                      <Markdown
                        ...
                        content="Enable [manual linking APIs](https://khuknasoft.com/docs/guides/auth/auth-identity-linking#manual-linking-beta) for your project."
                      />
                    }
                    disabled={!canUpdateConfig}
                  />
                  <Toggle
                    ...
                    descriptionText={
                      <Markdown
                        extLinks
                        className="[&>p>a]:text-foreground-light [&>p>a]:transition-all [&>p>a]:hover:text-foreground [&>p>a]:hover:decoration-brand"
                        content="Enable [anonymous sign-ins](https://khuknasoft.com/docs/guides/auth/auth-anonymous) for your project."
                      />
                    }
                    disabled={!canUpdateConfig}
                  />
