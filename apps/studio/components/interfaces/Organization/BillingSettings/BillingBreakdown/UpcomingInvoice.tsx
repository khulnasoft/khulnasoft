...
const feeTooltipData: TooltipData[] = [
  {
    ...
    linkRef:
      'https://khuknasoft.com/docs/guides/platform/org-based-billing#billing-for-compute-compute-hours',
  },
]
                ...
                <tr className="border-b">
                  <td className="py-2 text-sm max-w-[200px]">
                    ...
                    <InvoiceTooltip
                      ...
                      linkRef="https://khuknasoft.com/docs/guides/platform/org-based-billing#compute-credits"
                    />
                  </td>
