          ...
          <AlertDescription_Shadcn_>
            ...
            <div className="flex items-center gap-x-2 mt-3">
              ...
              <Button asChild type="default" icon={<ExternalLink />}>
                <a href="https://khuknasoft.com/docs/guides/platform/spend-cap">About spend cap</a>
              </Button>
            </div>
          </AlertDescription_Shadcn_>
        </Alert_Shadcn_>
        ...
        <Alert_Shadcn_ variant="warning">
          ...
          <AlertDescription_Shadcn_>
            ...
            <div className="flex items-center gap-x-2 mt-3">
              ...
              <Button asChild type="default" icon={<ExternalLink />}>
                <a href="https://khuknasoft.com/docs/guides/platform/billing-faq#fair-use-policy">
