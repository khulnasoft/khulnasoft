        ...
        header={
          <div className="flex items-center justify-between">
            ...
            <Button asChild type="default" icon={<ExternalLink strokeWidth={1.5} />}>
              <Link href="https://khuknasoft.com/pricing" target="_blank" rel="noreferrer">
                Pricing
              </Link>
            </Button>
          </div>
                ...
                description={
                  <div>
                    ...
                    <div className="space-x-3 mt-2">
                      <Button asChild type="default" icon={<ExternalLink strokeWidth={1.5} />}>
                        <Link
                          href="https://khuknasoft.com/docs/guides/platform/org-based-billing"
                          target="_blank"
                          rel="noreferrer"
                        >
                          How billing works
                      ...
                      {subscription?.plan?.id === 'free' && (
                        <Button asChild type="default" icon={<ExternalLink strokeWidth={1.5} />}>
                          <Link
                            href="https://khuknasoft.com/docs/guides/platform/project-transfer"
                            target="_blank"
                            rel="noreferrer"
                          >
                            Project transfers
