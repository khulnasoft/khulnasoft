    ...
    attributes: [
      subscription?.plan.id === 'free'
        ? {
            ...
            links: [
              {
                name: 'Documentation',
                url: 'https://khuknasoft.com/docs/guides/platform/database-size',
              },
            ],
            chartDescription: 'The data refreshes every 24 hours.',
        ...
        : {
            ...
            links: [
              {
                name: 'Documentation',
                url: 'https://khuknasoft.com/docs/guides/platform/org-based-billing#disk-size',
              },
              {
                name: 'Disk Management',
                url: 'https://khuknasoft.com/docs/guides/platform/database-size#disk-management',
              },
            ],
            chartDescription: '',
          },
      {
        ...
        links: [
          {
            name: 'Storage',
            url: 'https://khuknasoft.com/docs/guides/storage',
          },
        ],
      },
    ],
    ...
    attributes: [
      {
        ...
        links: [
          {
            name: 'Auth',
            url: 'https://khuknasoft.com/docs/guides/auth',
          },
        ],
      },
      {
        ...
        links: [
          {
            ...
            url: 'https://khuknasoft.com/docs/guides/auth/sso/auth-sso-saml',
          },
        ],
      },
      {
        ...
        links: [
          {
            name: 'Documentation',
            url: 'https://khuknasoft.com/docs/guides/storage/image-transformations',
          },
        ],
      },
      {
        ...
        links: [
          {
            name: 'Edge Functions',
            url: 'https://khuknasoft.com/docs/guides/functions',
          },
        ],
      },
      {
        ...
        links: [
          {
            ...
            url: 'https://khuknasoft.com/docs/guides/realtime/quotas',
          },
        ],
      },
      {
