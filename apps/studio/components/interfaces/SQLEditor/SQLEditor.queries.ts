...
`.trim(),
  },
  {
    ...
    sql: `
--
-- For use with https://github.com/khulnasoft/khulnasoft/tree/master/examples/slack-clone/nextjs-slack-clone
...
--
-- For use with:
-- https://github.com/khulnasoft/khulnasoft/tree/master/examples/todo-list/sveltejs-todo-list or
