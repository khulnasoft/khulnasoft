        ...
        <>
          ...
          <div className="doc-section">
            <article className="code-column text-foreground">
              ...
              <p>
                <a
                  href="https://khuknasoft.com/docs/reference/javascript/select"
                  target="_blank"
                  rel="noreferrer"
                >
                  Learn more
          ...
          <div className="doc-section">
            <article className="code-column text-foreground">
              ...
              <p>
                <a
                  href="https://khuknasoft.com/docs/reference/javascript/using-filters"
                  target="_blank"
                  rel="noreferrer"
                >
                  Learn more
        ...
        <>
          ...
          <div className="doc-section">
            <article className="code-column text-foreground">
              ...
              <p>
                <a
                  href="https://khuknasoft.com/docs/reference/javascript/insert"
                  target="_blank"
                  rel="noreferrer"
                >
                  Learn more
        ...
        <>
          ...
          <div className="doc-section">
            <article className="code-column text-foreground">
              ...
              <p>
                <a
                  href="https://khuknasoft.com/docs/reference/javascript/update"
                  target="_blank"
                  rel="noreferrer"
                >
                  Learn more
        ...
        <>
          ...
          <div className="doc-section">
            <article className="code-column text-foreground">
              ...
              <p>
                <a
                  href="https://khuknasoft.com/docs/reference/javascript/delete"
                  target="_blank"
                  rel="noreferrer"
                >
                  Learn more
          ...
          <>
            ...
            <div className="doc-section">
              <article className="code-column text-foreground">
                ...
                <p>
                  <a
                    href="https://khuknasoft.com/docs/reference/javascript/subscribe"
                    target="_blank"
                    rel="noreferrer"
                  >
                    Learn more
