  ...
  return (
    <>
      <h2 className="doc-heading flex items-center justify-between">
        ...
        <DocsButton href="https://khuknasoft.com/docs/guides/database/api/generating-types" />
      </h2>
      <div className="doc-section">
        <article className="code-column text-foreground">
          ...
          <p>
            ...
            <Link href="https://khuknasoft.com/docs/guides/database/api/generating-types">
              Supabase CLI
            </Link>
