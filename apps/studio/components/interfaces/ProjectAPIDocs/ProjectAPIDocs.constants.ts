...
-d '{
  ...
  oauthLogin: {
    ...
    description: `
Users can log in with Third Party OAuth like Google, Facebook, GitHub, and more. You must first enable each of these in the Auth Providers settings [here](https://khuknasoft.com).

View all the available [Third Party OAuth providers](https://khuknasoft.com).
...
- Install the Supabase [CLI](https://khuknasoft.com/docs/guides/cli).
- [Login to the CLI](https://khuknasoft.com/docs/reference/cli/usage#supabase-login) using the command: \`supabase login\`..
- [Initialize Supabase](https://khuknasoft.com/docs/guides/getting-started/local-development#getting-started) inside your project using the command: \`supabase init\`..
- [Link to your Remote Project](https://khuknasoft.com/docs/reference/cli/usage#supabase-link) using the command \`supabase link --project-ref [ref]\`..
- Setup your environment: Follow the steps [here](https://khuknasoft.com/docs/guides/functions/quickstart#setting-up-your-environment).
`,
    js: undefined,
    bash: undefined,
  },
...
You can generate types from your database either through the [Supabase CLI](https://khuknasoft.com/docs/guides/database/api/generating-types), or by downloading the types file via the button on the right and importing it in your application within \`src/index.ts\`.
`,
    js: undefined,
    bash: undefined,
  },
...
- [Broadcast](https://khuknasoft.com/docs/guides/realtime/broadcast): Send ephemeral messages from client to clients with low latency.
- [Presence](https://khuknasoft.com/docs/guides/realtime/presence): Track and synchronize shared state between clients.
- [Postgres Changes](https://khuknasoft.com/docs/guides/realtime/postgres-changes): Listen to Postgres database changes and send them to authorized clients.
`,
    js: undefined,
    bash: undefined,
  },
...
- By default, listening to database changes is disabled for new projects due to database performance and security concerns. You can turn it on by managing Realtime's [replication](https://khuknasoft.com/docs/guides/api#realtime-api-overview).
...
export const DOCS_RESOURCE_CONTENT: {
  ...
  rpcSingle: {
    ...
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/rpc',
    code: ({
      rpcName,
      rpcParams,
      endpoint,
...
if (error) console.error(error)
  ...
  readRows: {
    ...
    title: `Read rows`,
    category: 'entities',
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/select',
...
let { data: ${resourceId}, error } = await supabase
  ...
  filtering: {
    ...
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/using-filters',
    code: ({
      resourceId,
      endpoint,
      apikey,
...
`,
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/insert',
    code: ({
      resourceId,
      endpoint,
      apikey,
...
`,
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/update',
    code: ({
      resourceId,
      endpoint,
      apikey,
...
`,
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/delete',
    code: ({
      resourceId,
      endpoint,
      apikey,
...
`,
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/subscribe',
...
const channels = supabase.channel('custom-filter-channel')
  ...
  uploadFile: {
    ...
    category: 'storage',
    title: 'Upload a file',
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/storage-from-upload',
    description: `
...
`,
  ...
  deleteFiles: {
    ...
    category: 'storage',
    title: 'Delete files',
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/storage-from-remove',
    description: `
...
const { data, error } = await supabase
  ...
  listFiles: {
    ...
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/storage-from-list',
    description: `
...
const { data, error } = await supabase
  ...
  downloadFile: {
    ...
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/storage-from-download',
    description: `
...
const { data, error } = await supabase
  ...
  createSignedURL: {
    ...
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/storage-from-createsignedurl',
    description: `
...
const { data, error } = await supabase
  ...
  retrievePublicURL: {
    ...
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/storage-from-getpublicurl',
    description: `
A simple convenience function to get the URL for an asset in a public bucket. If you do not want to use this function, you can construct the public URL by concatenating the bucket URL with the path to the asset.

This function does not verify if the bucket is public. If a public URL is created for a bucket which is not public, you will not be able to download the asset.

The bucket needs to be set to public, either via \`updateBucket()\` or by going to Storage on khuknasoft.com/dashboard, clicking the overflow menu on a bucket and choosing "Make public"
...
const { data } = supabase
  ...
  invokeEdgeFunction: {
    ...
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/functions-invoke',
    description: `
