export const CLIENT_LIBRARIES = [
  {
    ...
    docsUrl: 'https://khuknasoft.com/docs/reference/javascript/installing',
    gitUrl: 'https://github.com/khulnasoft/khulnasoft-js',
  },
  {
    language: 'Flutter',
    officialSupport: true,
    releaseState: undefined,
    docsUrl: 'https://khuknasoft.com/docs/reference/dart/installing',
    gitUrl: 'https://github.com/khulnasoft/khulnasoft-flutter',
  },
  {
    language: 'Python',
    officialSupport: true,
    releaseState: 'Alpha',
    docsUrl: 'https://khuknasoft.com/docs/reference/python/initializing',
    gitUrl: 'https://github.com/khulnasoft/khulnasoft-py',
  },
  {
    language: 'C#',
    officialSupport: false,
    releaseState: undefined,
    docsUrl: 'https://khuknasoft.com/docs/reference/csharp/installing',
  ...
  },
  {
    ...
    officialSupport: true,
    releaseState: undefined,
    docsUrl: 'https://khuknasoft.com/docs/reference/swift/initializing',
    gitUrl: 'https://github.com/khulnasoft/khulnasoft-swift',
  },
  {
    language: 'Kotlin',
    officialSupport: false,
    releaseState: undefined,
    docsUrl: 'https://khuknasoft.com/docs/reference/kotlin/installing',
...
export const EXAMPLE_PROJECTS = [
  ...
  },
  {
    ...
    url: 'https://github.com/khulnasoft/khulnasoft/tree/master/examples/slack-clone/nextjs-slack-clone',
    type: 'app',
  },
  {
    framework: 'nextjs',
  ...
  },
  {
    ...
    url: 'https://github.com/khulnasoft/khulnasoft/tree/master/examples/todo-list/nextjs-todo-list',
    type: 'app',
  },
  {
    framework: 'Svelte',
    ...
    url: 'https://github.com/khulnasoft/khulnasoft/tree/master/examples/todo-list/sveltejs-todo-list',
    type: 'app',
  },
  {
    framework: 'Flutter',
  ...
  },
  {
    ...
    url: 'https://github.com/khulnasoft/khulnasoft-swift/tree/main/Examples/UserManagement',
    type: 'mobile',
  },
  {
    framework: 'Swift',
    ...
    url: 'https://github.com/khulnasoft/khulnasoft-swift/tree/main/Examples/SlackClone',
    type: 'mobile',
  },
  {
    framework: 'Flutter',
    ...
    url: 'https://github.com/khulnasoft/khulnasoft/tree/master/examples/auth/flutter-mfa',
  },
  {
    framework: 'NuxtJS',
