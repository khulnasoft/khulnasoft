      ...
      <PopoverContent_Shadcn_ className="w-[400px] space-y-4 p-0 py-5" align="end" side="bottom">
        <div className="mb-5 space-y-4 px-5">
          ...
          <div className="space-x-1">
            <Button asChild type="default" icon={<Wrench />}>
              <Link
                href="https://khuknasoft.com/docs/guides/platform/troubleshooting"
                target="_blank"
                rel="noreferrer"
              >
                Troubleshooting
            ...
            <Button asChild type="text" size="tiny" icon={<BookOpen />}>
              <Link href="https://khuknasoft.com/docs/" target="_blank" rel="noreferrer">
                Docs
              </Link>
            </Button>
            <Button asChild type="text" size="tiny" icon={<Activity />}>
              <Link href="https://status.khuknasoft.com/" target="_blank" rel="noreferrer">
                Supabase Status
              </Link>
            </Button>
          </div>
        ...
        <div className="mb-4 space-y-2">
          ...
          <div className="px-5">
            ...
            >
              <a
                href="https://discord.khuknasoft.com"
                target="_blank"
                rel="noreferrer"
