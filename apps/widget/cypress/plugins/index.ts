...
import { DalService, EnvironmentEntity } from '@khulnasoft/dal';
import { EnvironmentService, NotificationsService, NotificationTemplateService, UserSession } from '@khulnasoft/testing';
...
module.exports = (on, config) => {
  ...
  on('task', {
    ...
    async dropDatabase() {
      ...
      await dal.connect('mongodb://127.0.0.1:27017/khulnasoft-test');
      await dal.destroy();
