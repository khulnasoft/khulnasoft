...
import { InputEnd, Slider, Tooltip } from 'design-system';
      ...
      <T
        ...
        values={{
          announcement: (children) => (
            <ExternalLink
              openInNewTab
              href="https://khulnasoft.com/blog/scale-to-zero-optimize-gpu-and-cpu-workloads"
              className="underline"
            >
              {children}
            </ExternalLink>
          ...
          feedback: (children) => (
            <ExternalLink openInNewTab href="https://community.khulnasoft.com" className="underline">
              {children}
            </ExternalLink>
          ),
        }}
