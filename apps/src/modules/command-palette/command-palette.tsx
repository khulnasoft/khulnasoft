...
function useRegisterExternalNavigationCommands() {
  ...
  useRegisterCommand({
    label: 'Go to Khulnasoft website',
    description: 'Open www.khulnasoft.com',
    keywords: ['website', 'khulnasoft'],
    execute: () => void window.open('http://www.khulnasoft.com'),
  });

  useRegisterCommand({
    label: "View Khulnasoft's pricing",
    description: 'Open khulnasoft.com/pricing',
    keywords: ['pricing', 'cost', 'money'],
    execute: () => void window.open('http://khulnasoft.com/pricing'),
  });

  useRegisterCommand({
    label: 'View all one-click applications',
    description: 'Open khulnasoft.com/deploy',
    keywords: ['deploy', 'example', 'one-click'],
    execute: () => void window.open('http://khulnasoft.com/deploy'),
  });

  useRegisterCommand({
    label: 'View Khulnasoft tutorials',
    description: 'Open khulnasoft.com/tutorials',
    keywords: ['tutorials', 'help'],
    execute: () => void window.open('http://khulnasoft.com/tutorials'),
  });

  useRegisterCommand({
    label: "View Khulnasoft's changelog",
    description: 'Open khulnasoft.com/changelog',
    keywords: ['changelog'],
    execute: () => void window.open('http://khulnasoft.com/changelog'),
  });

  useRegisterCommand({
    label: "View Khulnasoft's blog",
    description: 'Open khulnasoft.com/blog',
    keywords: ['blog'],
    execute: () => void window.open('http://khulnasoft.com/blog'),
  });

  useRegisterCommand({
    label: 'Go to Khulnasoft documentation',
    description: 'Open khulnasoft.com/docs',
    keywords: ['documentation', 'docs', 'help'],
    execute: () => void window.open('http://khulnasoft.com/docs'),
  });

  useRegisterCommand({
    label: 'Go to Khulnasoft API documentation',
    description: 'Open developer.khulnasoft.com',
    keywords: ['documentation', 'docs', 'help', 'api'],
    execute: () => void window.open('http://developer.khulnasoft.com'),
  });

  useRegisterCommand({
    label: 'Go to the Khulnasoft community platform',
    description: 'Open community.khulnasoft.com',
    keywords: ['community', 'discourse', 'help'],
    execute: () => void window.open('http://community.khulnasoft.com'),
  });

  useRegisterCommand({
    label: 'Open a feature request or give feedback',
    description: 'Open feedback.khulnasoft.com',
    keywords: ['feedback', 'canny', 'feature', 'idea', 'improvement'],
    execute: () => void window.open('http://feedback.khulnasoft.com'),
  });

  useRegisterCommand({
    label: "Open the platform's status page",
    description: 'Open status.khulnasoft.com',
    keywords: ['status', 'instatus', 'platform', 'outage', 'uptime'],
    execute: () => void window.open('http://status.khulnasoft.com'),
  });
}
...
function useRegisterAccountCommands() {
  ...
  useRegisterCommand({
    ...
    description: 'Create a new Khulnasoft organization',
  ...
  useRegisterCommand({
    label: 'Log out',
    description: 'Sign out from the Khulnasoft control panel',
...
function useRegisterMiscCommands() {
  ...
  useRegisterCommand((register) => {
    if (organization?.plan !== 'hobby') {
      register({
        label: 'Contact Khulnasoft support',
    ...
    register({
      ...
      description: 'View the source code of the Khulnasoft control panel on GitHub',
      keywords: ['code', 'khulnasoft'],
      execute: () => void window.open('https://github.com/khulnasoft/khulnasoft'),
    });
  });
}
