...
import { Badge, Radio, TabButton, TabButtons } from 'design-system';
...
export function InstanceSelector({
  ...
  const khulnasoftRegions = instances[0]?.regionCategory === 'khulnasoft';
  const hasKhulnasoftAI = useFeatureFlag('khulnasoft-ai');
  ...
  return (
    <div className={clsx('col gap-3', className)}>
      ...
      <div className={clsx('my-4', !khulnasoftRegions && 'font-medium')}>
      ...
      {hasKhulnasoftAI && <InstanceAssistant />}
    </div>
  );
}
