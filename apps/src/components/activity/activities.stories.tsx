...
const khulnasoft: ActivityActor = {
  type: 'system_user',
  name: '',
  metadata: {},
};
...
export const domainCreated = createStory({
  actor: user,
  verb: 'created',
  object: create.activityObject({ type: 'domain', name: 'www.khulnasoft.com' }),
});

export const domainDeleted = createStory({
  actor: user,
  verb: 'deleted',
  object: create.activityObject({ type: 'domain', name: 'www.khulnasoft.com', deleted: true }),
});
