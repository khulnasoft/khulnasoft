...
export interface paths {
    ...
    "/v1/billing/has_unpaid_invoices": {
         ...
         *     Khulnasoft doesn't guarantee backwards compatible breaking change and reserve the right to completely drop it without notice.
...
export interface components {
    schemas: {
        ...
        /**
         * - AUTOASSIGNED: Domain like <appName>-<orgName>.khulnasoft.app
        ...
        GitSource: {
            /** @description A url to a git repository (contains the provider as well) .e.g: github.com/khulnasoft/test. */
            repository?: string;
        ...
        Archive: {
            ...
            /**
             * Format: date-time
             * @description This field is automatically set by Khulnasoft when the
        ...
        DatacenterListItem: {
            ...
            /** e.g. "par" */
            region_id?: string;
            /** e.g. "all-par1.infra.prod.khulnasoft.com" */
            domain?: string;
