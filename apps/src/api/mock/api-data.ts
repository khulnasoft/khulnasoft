...
export class ApiData {
  ...
  public serviceVariables: Api.ServiceVariables = {
    ...
    system_env: [
      'KHULNASOFT_REGION',
      'KHULNASOFT_SERVICE_PRIVATE_DOMAIN',
      'KHULNASOFT_REGIONAL_DEPLOYMENT_ID',
      'KHULNASOFT_SERVICE_NAME',
      'KHULNASOFT_PRIVILEGED',
      'KHULNASOFT_INSTANCE_ID',
      'KHULNASOFT_APP_NAME',
      'KHULNASOFT_ORGANIZATION_NAME',
      'KHULNASOFT_INSTANCE_MEMORY_MB',
      'KHULNASOFT_REPLICA_INDEX',
      'KHULNASOFT_DC',
      'KHULNASOFT_ORGANIZATION_ID',
      'KHULNASOFT_SERVICE_ID',
      'KHULNASOFT_INSTANCE_TYPE',
      'KHULNASOFT_GIT_BRANCH',
      'KHULNASOFT_HYPERVISOR_ID',
      'PORT',
      'KHULNASOFT_APP_ID',
      'KHULNASOFT_GIT_REPOSITORY',
      'KHULNASOFT_PUBLIC_DOMAIN',
      'KHULNASOFT_PORT_8000_PROTOCOL',
    ],
    user_env: [],
  };
