import { ExecutionDetailsRepository, IntegrationRepository, MessageRepository } from '@khulnasoft/dal';
import { ChannelTypeEnum, ExecutionDetailsSourceEnum, ExecutionDetailsStatusEnum } from '@khulnasoft/shared';
import { IEmailEventBody } from '@khulnasoft/stateless';
