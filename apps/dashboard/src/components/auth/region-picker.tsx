...
export function RegionPicker() {
  ...
  function handleRegionChange(value: RegionType) {
    switch (value) {
      case REGION_MAP.US:
        window.location.href = 'https://dashboard-v2.khulnasoft.co';
        break;
      case REGION_MAP.EU:
        window.location.href = 'https://eu.dashboard-v2.khulnasoft.co';
        break;
    }
  }
      ...
      <div className="text-xs font-medium leading-none text-neutral-400">
        ...
        <TooltipProvider delayDuration={100}>
          <Tooltip>
            ...
            <TooltipContent>
              Khulnasoft offers data residency in Europe (Germany) and the United States. Data residency cannot be modified
              after sign-up.
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
