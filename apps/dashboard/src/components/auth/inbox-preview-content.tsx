import { Inbox, InboxContent, InboxProps } from '@khulnasoft/react';
...
export function InboxPreviewContent({
  ...
  const configuration: InboxProps = {
    ...
    backendUrl: API_HOSTNAME ?? 'https://api.khulnasoft.co',
    socketUrl: WEBSOCKET_HOSTNAME ?? 'https://ws.khulnasoft.co',
    localization: {
