    ...
    <div className="flex w-full flex-col items-center justify-center gap-8">
      <div className="flex w-full flex-col items-start gap-1">
        ...
        <div className="flex flex-col gap-1">
          <h2 className="text-lg font-medium text-[#232529]">How do you plan to use Khulnasoft?</h2>
          <p className="text-xs text-[#717784]">
            You can route notifications across channels intelligently with Khulnasoft's powerful workflows, among the channels
            below.
          </p>
        </div>
      </div>
