    ...
    <div className="inline-flex h-full w-full max-w-[476px] flex-col items-center justify-center gap-[50px] p-5">
      <div className="flex flex-col items-start justify-start gap-4">
        <div className="inline-flex items-center justify-start gap-3">
          <img src="/images/khulnasoft-logo-dark.svg" className="w-24" alt="logo" />
        </div>
      ...
      <div className="hidden md:flex md:flex-col md:items-start md:justify-start md:gap-8 md:self-stretch">
        ...
        <AuthFeatureRow
          ...
          description="Khulnasoft API-first approach, means that you can use just what you need, when you need it."
        />
        <AuthFeatureRow
          icon={<ShieldZap className="h-6 w-6" />}
          title="Observable and scalable with built-in security"
          description="Khulnasoft handles any volume, any channel, and any team for mission-critical notifications."
        />
      </div>
