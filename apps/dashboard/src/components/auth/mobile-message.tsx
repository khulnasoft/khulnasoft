      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm font-medium text-gray-950">
            We see you signed up from your mobile—nice move! But to complete the Khulnasoft setup, you'll need to switch over
            to your laptop and fire up your favorite IDE.
          </p>
          <p className="text-sm text-gray-500">
            Integrating Khulnasoft into your stack means writing some actual code, setting up workflows, configuring Inbox ,
