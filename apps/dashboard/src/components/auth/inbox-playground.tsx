...
import { FeatureFlagsKeysEnum, IEnvironment, StepTypeEnum, WorkflowCreationSourceEnum } from '@khulnasoft/shared';
      ...
      steps: [
        {
          ...
          controlValues: {
            ...
            body: '{{payload.body}}',
            avatar: window.location.origin + '/images/khulnasoft.svg',
            primaryAction: {
