...
function KhulnasoftBrandingSwitch({ value, onChange }: { value: boolean | undefined; onChange: (value: boolean) => void }) {
            ...
            <div className="flex flex-col gap-2 p-1">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-muted-foreground text-xs">
                  Remove Khulnasoft branding from your inbox by upgrading to our paid plans.
                </p>
              </div>
            ...
            return (
              <FormItem className="flex items-center justify-between gap-2">
                <FormLabel
                  className="text-xs"
                  htmlFor="active"
                  tooltip='Hide "Powered by Khulnasoft" branding from your <Inbox />'
                >
                  Remove "Powered by Khulnasoft" branding
                </FormLabel>
                <FormControl>
                  <KhulnasoftBrandingSwitch value={field.value} onChange={field.onChange} />
                </FormControl>
              </FormItem>
            );
          }}
