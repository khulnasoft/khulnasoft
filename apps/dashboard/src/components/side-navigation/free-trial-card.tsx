...
import { GetSubscriptionDto } from '@khulnasoft/shared';
...
const CardContent = ({
  ...
  <>
      ...
      <Tooltip>
        ...
        <TooltipContent variant="light" size="lg" side="right" className="w-48">
          ...
          <span className="text-foreground-600 text-xs">
            After the trial ends, continue to enjoy khulnasoft's free tier with unlimited workflows and up to 30k
            events/month.
          </span>
        </TooltipContent>
      </Tooltip>
    ...
    <span className="text-foreground-600 text-xs">
      Enjoy unlimited access to Khulnasoft for free for the next {pluralizedDays}.
    </span>
