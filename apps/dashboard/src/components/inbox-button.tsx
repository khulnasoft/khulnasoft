...
import { Bell as BellV3, InboxContent as InboxContentV3, Inbox as InboxV3, useKhulnasoft as useKhulnasoftV3 } from '@khulnasoft/react';
import { Bell as BellV2, InboxContent as InboxContentV2, Inbox as InboxV2, useKhulnasoft as useKhulnasoftV2 } from '@khulnasoft/react-v2';
...
const InboxInner = () => {
  ...
  const khulnasoft = isInboxV3Enabled ? useKhulnasoftV3() : useKhulnasoftV2();
  useEffect(() => {
    ...
    const cleanup = khulnasoft.on('notifications.notification_received', () => {
      setJingle(true);
