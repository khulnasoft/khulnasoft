...
import { ChannelTypeEnum, WorkflowPreferences, WorkflowResponseDto } from '@khulnasoft/shared';
...
export const ChannelPreferencesForm = (props: ConfigureWorkflowFormProps) => {
  ...
  const isDashboardWorkflow = useMemo(() => workflow.origin === WorkflowOriginEnum.KHULNASOFT_CLOUD, [workflow.origin]);
