...
import { StepContentIssue, StepIntegrationIssue, StepResponseDto } from '@khulnasoft/shared';
    ...
    <SidebarContent className="gap-2">
      <div className="flex items-center justify-between">
        ...
        <ExternalLink
          variant="text"
          underline={false}
          href="https://docs.khulnasoft.com/sdks/framework/typescript/steps/inApp"
          className="text-xs"
        >
          <span>Help?</span>
        </ExternalLink>
