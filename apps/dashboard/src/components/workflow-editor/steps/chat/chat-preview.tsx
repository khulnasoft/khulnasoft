import { ChannelTypeEnum, ChatRenderOutput, GeneratePreviewResponseDto } from '@khulnasoft/shared';
        ...
        <div className="flex w-full items-start gap-2">
          ...
          <div className="flex w-full flex-col gap-1">
            <div className="flex items-center gap-1">
              <span className="text-foreground-950 text-xs font-bold">Khulnasoft</span>
