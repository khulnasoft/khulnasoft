...
import type { WorkflowResponseDto } from '@khulnasoft/shared';
  ...
  return (
    <>
      <div className="text-foreground-400 mb-3 text-xs">
        ...
        call the Khulnasoft API using workflow_id.
      </div>
      <div className="text-foreground-400 mb-3 text-xs">
...
export function TestWorkflowInstructions({ isOpen, onClose, workflow, to, payload }: TestWorkflowInstructionsProps) {
  ...
  const getApiKeyMaskPositions = (key: string) => {
    ...
    return {
      maskStart: 'KHULNASOFT_SECRET_KEY='.length,
      maskEnd: 'KHULNASOFT_SECRET_KEY='.length + lastFourStart,
    };
  };
      ...
      <SheetContent className="min-w-[500px]">
        <SheetHeader className="space-y-initial p-3 py-4">
          ...
          <SheetDescription className="text-paragraph-xs text-text-soft mt-1 block">
            ...
            <ExternalLink href="https://docs.khulnasoft.com/concepts/workflows">Learn more</ExternalLink>
          </SheetDescription>
        </SheetHeader>
        <Separator />
          ...
          <Tabs defaultValue="nodejs" className="w-full">
            ...
            <div className="mt-5 space-y-8 p-3">
              <TabsContent value="nodejs" className="space-y-8">
                <InstructionStep index={0} title="Install @khulnasoft/api" code="npm install @khulnasoft/api" codeTitle="Terminal">
                  The npm package to use with khulnasoft and node.js.
                </InstructionStep>

                <InstructionStep
                  index={1}
                  title="Copy API Keys to"
                  code={`KHULNASOFT_SECRET_KEY=${apiKey}`}
                  codeTitle=".env"
              ...
              <TabsContent value="php" className="space-y-8">
                <InstructionStep
                  index={0}
                  title="Install"
                  code='composer require "khulnasoft/khulnasoft"'
                  codeTitle="Terminal"
                />
...
KHULNASOFT_SECRET_KEY='${apiKey}'`}
              ...
              <TabsContent value="python" className="space-y-8">
                <InstructionStep index={0} title="Install" code="pip install khulnasoft" codeTitle="Terminal" />
              ...
              <TabsContent value="go" className="space-y-8">
                <InstructionStep
                  index={0}
                  title="Install"
                  code="go get github.com/khulnasoft/khulnasoft-go"
                  codeTitle="Terminal"
                />
