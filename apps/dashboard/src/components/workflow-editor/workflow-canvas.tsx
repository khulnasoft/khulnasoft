import { EnvironmentEnum, FeatureFlagsKeysEnum, WorkflowOriginEnum } from '@khulnasoft/shared';
import {
  Background,
  BackgroundVariant,
  BaseEdge,
...
const mapStepToNode = ({
  ...
  step,
  readOnly,
  workflowOrigin = WorkflowOriginEnum.KHULNASOFT_CLOUD,
}: {
  addStepIndex: number;
  ...
  return (
    <div ref={reactFlowWrapper} className="h-full w-full" id="workflow-canvas-container">
      ...
      {currentWorkflow &&
        ...
        currentWorkflow.origin === WorkflowOriginEnum.KHULNASOFT_CLOUD &&
