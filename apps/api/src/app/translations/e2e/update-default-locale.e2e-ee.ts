import { UserSession, getEERepository } from '@khulnasoft/testing';
import { expect } from 'chai';
import { OrganizationRepository } from '@khulnasoft/dal';

describe('Update default locale and add new translations - /translations/language (PATCH) #khulnasoft-v0', async () => {
