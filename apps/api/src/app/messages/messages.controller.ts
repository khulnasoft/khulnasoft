...
export class MessagesController {
  ...
  @ApiOperation({
    ...
    description: 'Deletes a message entity from the Khulnasoft platform',
  })
  ...
  @ApiOperation({
    ...
    description: 'Deletes messages entity from the Khulnasoft platform using TransactionId of message',
  })
