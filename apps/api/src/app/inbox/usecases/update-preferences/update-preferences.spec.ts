import { AnalyticsService, GetSubscriberTemplatePreference, UpsertPreferences } from '@khulnasoft/application-generic';
import { NotificationTemplateRepository, SubscriberRepository } from '@khulnasoft/dal';
