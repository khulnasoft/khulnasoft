import { EmailBlockTypeEnum, PreferenceLevelEnum, StepTypeEnum } from '@khulnasoft/shared';
import { UserSession } from '@khulnasoft/testing';
import { expect } from 'chai';

describe('Update global preferences - /inbox/preferences (PATCH) #khulnasoft-v2', function () {
