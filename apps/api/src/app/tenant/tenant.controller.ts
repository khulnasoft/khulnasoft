...
import { ApiRateLimitCategoryEnum, FeatureFlagsKeysEnum, UserSessionData } from '@khulnasoft/shared';
import {
  CreateTenant,
  CreateTenantCommand,
  GetTenant,
...
export class TenantController {
  ...
  @ApiOperation({
    ...
    description: `Deletes a tenant entity from the Khulnasoft platform.${v2TenantsApiDescription}`,
  })
  @ApiNoContentResponse({
