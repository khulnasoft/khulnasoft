...
import { NotificationTemplateRepository, EnvironmentRepository } from '@khulnasoft/dal';
import {
  EmailBlockTypeEnum,
...
describe('Get blueprints by id - /blueprints/:templateId (GET) #khulnasoft-v0', async () => {
