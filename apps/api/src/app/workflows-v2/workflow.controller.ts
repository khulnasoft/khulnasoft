...
import { DeleteWorkflowCommand, DeleteWorkflowUseCase, UserSession } from '@khulnasoft/application-generic';
import {
  CreateWorkflowDto,
  DirectionEnum,
  ...
  async create(
    ...
    return this.upsertWorkflowUseCase.execute(
      UpsertWorkflowCommand.create({
        workflowDto: { ...createWorkflowDto, origin: WorkflowOriginEnum.KHULNASOFT_CLOUD },
        user,
      })
    );
  }
