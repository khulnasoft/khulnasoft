import { WorkflowInternalResponseDto } from '@khulnasoft/application-generic';
import { NotificationStepEntity, NotificationTemplateEntity } from '@khulnasoft/dal';
import {
...
function computeOrigin(template: NotificationTemplateEntity): WorkflowOriginEnum {
  ...
  if (typeof template.type === 'undefined' && typeof template.origin === 'undefined') {
    return WorkflowOriginEnum.KHULNASOFT_CLOUD_V1;
  }

  return template?.type === WorkflowTypeEnum.REGULAR
    ? WorkflowOriginEnum.KHULNASOFT_CLOUD_V1
