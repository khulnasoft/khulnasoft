...
import { ChannelTypeEnum, UserSessionData } from '@khulnasoft/shared';
import {
...
export class IntegrationsController {
  constructor(
    ...
    private calculateLimitKhulnasoftIntegration: CalculateLimitKhulnasoftIntegration
  ) {}
    ...
    try {
      return await this.updateIntegrationUsecase.execute(
        UpdateIntegrationCommand.create({
          ...
          integrationId,
          credentials: body.credentials,
          removeKhulnasoftBranding: body.removeKhulnasoftBranding,
          active: body.active,
          check: body.check ?? false,
          conditions: body.conditions,
        })
  ...
  async getProviderLimit(
    ...
    const result = await this.calculateLimitKhulnasoftIntegration.execute(
