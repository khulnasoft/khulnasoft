...
describe('Get Decrypted Integrations - /integrations (GET) #khulnasoft-v2', function () {
  ...
  it('should get active decrypted integration', async function () {
    ...
    // We expect to find the test data 8 with khulnasoft provider integrations plus the one created
