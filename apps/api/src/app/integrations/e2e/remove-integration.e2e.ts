...
import { ChannelTypeEnum, EmailProviderIdEnum, ChatProviderIdEnum, PushProviderIdEnum } from '@khulnasoft/shared';
import { HttpStatus } from '@nestjs/common';

describe('Delete Integration - /integration/:integrationId (DELETE) #khulnasoft-v2', function () {
  ...
  it('should throw an error when trying to delete a demo integration', async function () {
    ...
    expect(res.body.message).to.equal('Khulnasoft demo integration or In-App integration cannot be deleted');
  });
