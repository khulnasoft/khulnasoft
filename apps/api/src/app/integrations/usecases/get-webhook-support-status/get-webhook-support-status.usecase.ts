...
import { IntegrationEntity, IntegrationQuery, IntegrationRepository } from '@khulnasoft/dal';
import { IEmailProvider, ISmsProvider } from '@khulnasoft/stateless';
import { IMailHandler, ISmsHandler, MailFactory, SmsFactory } from '@khulnasoft/application-generic';
import { ChannelTypeEnum, providers } from '@khulnasoft/shared';
