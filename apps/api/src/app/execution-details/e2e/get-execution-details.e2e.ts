import { ExecutionDetailsRepository, SubscriberEntity } from '@khulnasoft/dal';
import { ExecutionDetailsSourceEnum, ExecutionDetailsStatusEnum, StepTypeEnum } from '@khulnasoft/shared';
...
describe('Execution details - Get execution details by notification id - /v1/execution-details/notification/:notificationId (GET) #khulnasoft-v2', function () {
