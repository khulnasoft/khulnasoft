import { SubscriberCustomData, UserSessionData } from '@khulnasoft/shared';
import { CreateOrUpdateSubscriberCommand } from '@khulnasoft/application-generic';
import { IChannelCredentials, IChannelSettings, SubscriberEntity } from '@khulnasoft/dal';
