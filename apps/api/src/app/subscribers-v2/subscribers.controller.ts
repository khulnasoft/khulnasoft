...
import { ExternalApiAccessible, UserSession } from '@khulnasoft/application-generic';
import { ApiRateLimitCategoryEnum, UserSessionData } from '@khulnasoft/shared';
...
export class SubscribersController {
  ...
  @ApiOperation({
    ...
    description: 'Deletes a subscriber entity from the Khulnasoft platform',
  })
