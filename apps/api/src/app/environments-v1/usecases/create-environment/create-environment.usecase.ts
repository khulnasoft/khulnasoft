...
import { encryptApiKey } from '@khulnasoft/application-generic';
import { EnvironmentEntity, EnvironmentRepository, NotificationGroupRepository } from '@khulnasoft/dal';

import { EnvironmentEnum, PROTECTED_ENVIRONMENTS } from '@khulnasoft/shared';
...
export class CreateEnvironment {
  constructor(
    ...
    private createKhulnasoftIntegrationsUsecase: CreateKhulnasoftIntegrations
  ) {}
  ...
  async execute(command: CreateEnvironmentCommand): Promise<EnvironmentResponseDto> {
    ...
    await this.createKhulnasoftIntegrationsUsecase.execute(
