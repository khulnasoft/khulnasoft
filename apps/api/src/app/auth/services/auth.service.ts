...
import { MemberEntity, SubscriberEntity, UserEntity } from '@khulnasoft/dal';
import { AuthProviderEnum, AuthenticateContext, ISubscriberJwt, UserSessionData } from '@khulnasoft/shared';
import { IAuthService } from '@khulnasoft/application-generic';
