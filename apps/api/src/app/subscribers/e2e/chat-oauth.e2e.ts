...
describe('ChatOauth - /:subscriberId/credentials/:providerId/:environmentId (GET) #khulnasoft-v2', function () {
  ...
  it('should throw exception on missing credentials', async () => {
    ...
    const { error } = await expectSdkExceptionGeneric(() =>
      khulnasoftClient.subscribers.authentication.chatAccessOauth({
