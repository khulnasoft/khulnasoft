import { MemberEntity, EnvironmentRepository, CommunityMemberRepository } from '@khulnasoft/dal';
...
describe('Remove organization member - /organizations/members/:memberId (DELETE) #khulnasoft-v0-os', async () => {
