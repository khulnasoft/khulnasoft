...
import { IntegrationRepository, NotificationTemplateEntity, NotificationTemplateRepository } from '@khulnasoft/dal';
import {
  ...
  private async getProviderIdsForTemplate(
    ...
    for (const step of template?.steps) {
      ...
      if (channelType === ChannelTypeEnum.IN_APP) {
        providers[channelType] = InAppProviderIdEnum.Khulnasoft;
      } else {
