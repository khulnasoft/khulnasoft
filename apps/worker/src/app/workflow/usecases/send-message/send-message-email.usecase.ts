...
import { EmailOutput } from '@khulnasoft/framework/internal';
  ...
  public async execute(command: SendMessageCommand): Promise<SendMessageResult> {
    ...
    try {
      ...
      await this.createExecutionDetails.execute(
        CreateExecutionDetailsCommand.create({
          ...
          detail: DetailEnum.LIMIT_PASSED_KHULNASOFT_INTEGRATION,
      ...
      return {
        status: 'failed',
        reason: DetailEnum.LIMIT_PASSED_KHULNASOFT_INTEGRATION,
      };
    }
    ...
    try {
      ...
      if (!command.bridgeData) {
        ...
        // TODO: remove as part of https://linear.app/khulnasoft/issue/NV-4117/email-html-content-issue-in-mobile-devices
    ...
    const mailData: IEmailOptions = createMailData(
      {
        ...
        from: integration?.credentials.from || 'no-reply@khulnasoft.co',
        attachments,
        senderName,
        id: message._id,
