...
Check out the [full example](https://github.com/khulnasoft/khulnasoft/tree/master/examples/edge-functions/khulnasoft/functions/postgres-on-the-edge).
...
```ts khulnasoft/functions/drizzle/index.ts
...
- Download the SSL certificate from [Database settings](https://khuknasoft.com/dashboard/project/_/settings/database)

- In your [local .env file](https://khuknasoft.com/docs/guides/functions/secrets), add these two variables:
