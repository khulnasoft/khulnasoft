...
Find the complete example on [GitHub](https://github.com/khulnasoft/khulnasoft/tree/master/examples/edge-functions/khulnasoft/functions/sentryfied/index.ts).
