...
When you deploy to Supabase, make sure that your `RESEND_API_KEY` is set in [Edge Function Secrets Management](https://khuknasoft.com/dashboard/project/_/settings/functions)
