...
Supabase Storage has [out-of-the-box support](https://khuknasoft.com/docs/guides/storage/serving/image-transformations?queryGroups=language&language=js) for the most common image transformations and optimizations you need.
...
Make sure you have the latest version of the [Supabase CLI](https://khuknasoft.com/docs/guides/cli#installation) installed.
...
<$CodeSample
path="edge-functions/khulnasoft/functions/image-manipulation/index.ts"
lines={[[1, -1]]}
/>
...
Hosted Edge Functions have [limits](https://khuknasoft.com/docs/guides/functions/limits) on memory and CPU usage.
