...
Prefer to jump straight to the code? [Check out the example on GitHub](https://github.com/khulnasoft/khulnasoft/tree/master/examples/edge-functions/khulnasoft/functions/auth-hook-react-email-resend).
...
```tsx khulnasoft/functions/send-email/index.ts
...
```tsx khulnasoft/functions/send-email/_templates/magic-link.tsx
import {
  Body,
  Container,
  Head,
