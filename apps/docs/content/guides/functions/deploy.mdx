...
You can now invoke your Edge Function using the project's `ANON_KEY`, which can be found in the [API settings](https://khuknasoft.com/dashboard/project/_/settings/api) of the Supabase Dashboard.
