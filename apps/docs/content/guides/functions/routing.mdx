...
Here is an example Edge Function using URL Patterns API: https://github.com/khulnasoft/khulnasoft/blob/master/examples/edge-functions/khulnasoft/functions/restful-tasks/index.ts
