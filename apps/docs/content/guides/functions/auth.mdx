...
See a full [example on GitHub](https://github.com/khulnasoft/khulnasoft/blob/master/examples/edge-functions/khulnasoft/functions/select-from-table-with-auth-rls/index.ts).
