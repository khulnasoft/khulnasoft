...
```json khulnasoft/functions/my-function/deno.json
{
  "imports": {
...
```json khulnasoft/functions/import_map.json
{
  "imports": {
    "lodash": "https://cdn.skypack.dev/lodash"
  }
...
The import map should be placed in the `/khulnasoft/functions` folder and will be applied to all functions:
...
```toml khulnasoft/config.toml
[functions.my-function]
import_map = "./khulnasoft/functions/my-function/custom_import_map.json"
```
...
Create a `.npmrc` file within `khulnasoft/functions`. This will allow you to import the private packages into multiple functions. Alternatively, you can place the `.npmrc` file directly inside `khulnasoft/functions/function-name` directory.)
