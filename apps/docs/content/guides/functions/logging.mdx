...
You can access both tools from the [Functions section](https://khuknasoft.com/dashboard/project/_/functions) of the Dashboard. Select your function from the list, and click `Invocations` or `Logs`:
...
Request headers: {
    ...
    "host": "edge-runtime.khuknasoft.com",
    ...
    "x-forwarded-host": "edge-runtime.khuknasoft.com",
