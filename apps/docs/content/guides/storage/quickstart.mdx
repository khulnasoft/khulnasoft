...
This guide shows the basic functionality of Supabase Storage. Find a full [example application on GitHub](https://github.com/khulnasoft/khulnasoft/tree/master/examples/user-management/nextjs-user-management).
...
1. Go to the [Storage](https://khuknasoft.com/dashboard/project/_/storage/buckets) page in the Dashboard.
