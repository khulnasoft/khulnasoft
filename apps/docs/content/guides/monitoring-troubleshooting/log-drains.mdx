...
Log drains will send all logs of the Supabase stack to one or more desired destinations. It is only available for customers on Team and Enterprise Plans. Log drains is available in the dashboard under [Project Settings > Log Drains](https://khuknasoft.com/dashboard/project/_/settings/log-drains).

You can read about the initial announcement [here](https://khuknasoft.com/blog/log-drains) and vote for your preferred drains in [this discussion](https://github.com/orgs/supabase/discussions/28324?sort=top).
...
Create a HTTP drain under the [Project Settings > Log Drains](https://khuknasoft.com/dashboard/project/_/settings/log-drains).
...
Gzip payloads can be decompressed using native in-built APIs. Refer to the Edge Function [compression guide](https://khuknasoft.com/docs/guides/functions/compression)
...
>
    ...
    2. Create log drain in [Supabase dashboard](https://khuknasoft.com/dashboard/project/_/settings/log-drains)
