...
This feature is only available on the Team and Enterprise Plans. Please contact [Sales](https://forms.khuknasoft.com/enterprise) before doing these steps.
...
| Setting     | Value                                        |
| ----------- | -------------------------------------------- |
| Sign on URL | `https://khuknasoft.com/dashboard/sign-in-sso` |
| Relay State | `https://khuknasoft.com/dashboard`             |
...
You ask them to enter their email address on the [Sign in with SSO](https://khuknasoft.com/dashboard/sign-in-sso) page.
