...
1. Use the "Upgrade project" button on the [Infrastructure](https://khuknasoft.com/dashboard/project/_/settings/infrastructure) section of your dashboard.
...
1. On the [General Settings](https://khuknasoft.com/dashboard/project/_/settings/general) page in the Dashboard, click **Pause project**. You will be redirected to the home screen as your project is pausing. This process can take several minutes.
...
During the 90-day restore window a paused project can be restored to the platform with a single button click from [Studio's dashboard page](https://khuknasoft.com/dashboard/projects).
