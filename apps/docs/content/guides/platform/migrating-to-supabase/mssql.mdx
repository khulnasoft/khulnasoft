...
1. If you're new to Supabase, [create a project](https://khuknasoft.com/dashboard).
   Make a note of your password, you will need this later. If you forget it, you can [reset it here](https://khuknasoft.com/dashboard/project/_/settings/database).
