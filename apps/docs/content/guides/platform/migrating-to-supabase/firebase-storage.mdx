...
subtitle: 'Migrate Firebase Storage files to Supabase Storage.'
---
...
1. Go to your Supabase project's [API settings](https://khuknasoft.com/dashboard/project/_/settings/api) in the Dashboard.
...
If the bucket doesn't exist, it's created as a `non-public` bucket. You must set permissions on this new bucket in the [Supabase Dashboard](https://khuknasoft.com/dashboard/project/_/storage/buckets) before users can download any files.

</Admonition>

## Resources

- [Supabase vs Firebase](https://khuknasoft.com/alternatives/supabase-vs-firebase)
