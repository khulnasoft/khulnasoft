...
Fly Postgres is currently in private alpha. To request early access, [submit the request form](https://forms.khuknasoft.com/fly-postgres). Do not use it for Production workloads or to process Protected Health Information (PHI).
...
To find your database's connection strings, visit the Supabase [database settings page](https://khuknasoft.com/dashboard/project/_/settings/database).
