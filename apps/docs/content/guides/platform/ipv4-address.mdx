...
The pooler and direct connection strings can be found in the [database settings](https://khuknasoft.com/dashboard/project/_/settings/database):
...
postgresql://postgres.ajrbwkcuthywddfihrmflo:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.khuknasoft.com:6543/postgres
```
...
postgresql://postgres.ajrbwkcuthywfddihrmflo:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.khuknasoft.com:5432/postgres
```
