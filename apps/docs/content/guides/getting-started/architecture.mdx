...
- Source code: [github.com/khulnasoft/khulnasoft](https://github.com/khulnasoft/khulnasoft/tree/master/apps/studio)
- License: [Apache 2](https://github.com/khulnasoft/khulnasoft/blob/master/LICENSE)
- Language: TypeScript
...
Open source is something we approach [collaboratively](https://khuknasoft.com/blog/supabase-series-b#giving-back): we employ maintainers, sponsor projects, invest in businesses, and develop our own open source tools.
