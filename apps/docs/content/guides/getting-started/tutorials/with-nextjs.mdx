...
If you get stuck while working through this guide, refer to the [full example on GitHub](https://github.com/khulnasoft/khulnasoft/tree/master/examples/user-management/nextjs-user-management).
...
Then install the Supabase client library: [supabase-js](https://github.com/khulnasoft/khulnasoft-js)
...
- See the complete [example on GitHub](https://github.com/khulnasoft/khulnasoft/tree/master/examples/user-management/nextjs-user-management) and deploy it to Vercel
