...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={2}>
    ...
    The `refine-supabase` preset adds `@refinedev/supabase` supplementary package that supports Supabase in a refine app. `@refinedev/supabase` out-of-the-box includes the Supabase dependency: [supabase-js](https://github.com/khulnasoft/khulnasoft-js).
