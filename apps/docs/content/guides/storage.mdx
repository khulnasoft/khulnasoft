...
Check out all of the Storage [templates and examples](https://github.com/khulnasoft/khulnasoft/tree/master/examples/storage) in our GitHub repository.
...
export const examples = [
  {
    ...
    href: 'https://github.com/khulnasoft/khulnasoft/tree/master/examples/storage/resumable-upload-uppy',
  },
]
