...
You can view and edit the privileges in the [Supabase Studio](https://khuknasoft.com/dashboard/project/_/database/column-privileges).

![Column level privileges](/docs/img/guides/privileges/column-level-privileges-2.png)

## Manage column privileges in Migrations

While you can manage privileges directly from the Dashboard, as your project grows you may want to manage them in your migrations. Read about database migrations in the [Local Development](https://khuknasoft.com/docs/guides/getting-started/local-development#database-migrations) guide.
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Create a migration file">
      ...
      To get started, generate a [new migration](https://khuknasoft.com/docs/reference/cli/supabase-migration-new) to store the SQL needed to create your table along with row and column-level privileges.
