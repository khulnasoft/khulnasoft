...
This will need a direct connection to your database and you can find the connection info in the [Dashboard](https://khuknasoft.com/dashboard/project/_/settings/database).
