...
You can find these connection strings in your [Database Settings](https://khuknasoft.com/dashboard/project/_/settings/database).
...
You can find the direct connection string in the [Database settings](https://khuknasoft.com/dashboard/project/_/settings/database) inside the dashboard:
...
```md
// Example String
postgres://postgres.apbkobhfnmcqqzqeeqss:[YOUR-PASSWORD]@aws-0-ca-central-1.pooler.khuknasoft.com:5432/postgres
```
...
```md
// Example String
postgres://postgres.apbkobhfnmcqqzqeeqss:[YOUR-PASSWORD]@aws-0-ca-central-1.pooler.khuknasoft.com:6543/postgres
```
...
If you'd like us to add a new quickstart guide, share your [feedback](https://khuknasoft.com/dashboard/support/new), and we'll try to add it going forwards.
