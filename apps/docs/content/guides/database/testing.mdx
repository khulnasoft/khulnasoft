...
A good starting point are the tests written for the Supabase client itself. For example, [here](https://github.com/khulnasoft/khulnasoft/tree/master/tests/features/javascript) are the tests for the Supabase JS client written with TypeScript and Jest.
