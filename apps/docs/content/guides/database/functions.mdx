...
To create custom logs in the [Dashboard's Postgres Logs](https://khuknasoft.com/dashboard/project/_/logs/postgres-logs), you can use the `raise` keyword. By default, there are 3 observed severity levels:
