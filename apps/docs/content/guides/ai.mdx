...
Check out all of the AI [templates and examples](https://github.com/khulnasoft/khulnasoft/tree/master/examples/ai) in our GitHub repository.
  ...
  {[
    {
      ...
      href: 'https://khuknasoft.com/customers/berriai',
    },
    {
      ...
      href: 'https://khuknasoft.com/customers/mendableai',
    },
    {
      ...
      href: 'https://khuknasoft.com/customers/markprompt',
    },
  ].map((x) => (
    <div className="col-span-4" key={x.href}>
      <Link href={x.href} passHref>
