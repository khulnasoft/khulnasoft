...
Supabase allows you to specify wildcards when adding redirect URLs to the [allow list](https://khuknasoft.com/dashboard/project/_/auth/url-configuration). You can use wildcard match patterns to support preview URLs from providers like Netlify and Vercel.
