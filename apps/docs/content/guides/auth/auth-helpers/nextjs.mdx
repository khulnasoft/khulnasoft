...
Retrieve your project's URL and anon key from your [API settings](https://khuknasoft.com/dashboard/project/_/settings/api), and create a `.env.local` file with the following environment variables:
...
Check out the [Next.js auth example repo](https://github.com/khulnasoft/khulnasoft/tree/master/examples/auth/nextjs) for more examples, including [realtime subscriptions](https://github.com/khulnasoft/khulnasoft/tree/master/examples/auth/nextjs/app/realtime-posts.tsx).
...
Check out the [Next.js auth example repo](https://github.com/khulnasoft/khulnasoft/tree/master/examples/auth/nextjs) for more examples, including redirecting unauthenticated users - [protected pages](https://github.com/khulnasoft/khulnasoft/tree/master/examples/auth/nextjs/app/[id]/page.tsx).
...
- [Full App Router example](https://github.com/khulnasoft/khulnasoft/tree/master/examples/auth/nextjs)
- [Realtime Subscriptions](https://github.com/khulnasoft/khulnasoft/tree/master/examples/auth/nextjs/app/realtime-posts.tsx)
- [Protected Routes](https://github.com/khulnasoft/khulnasoft/tree/master/examples/auth/nextjs/app/[id]/page.tsx)
- [Conditional Rendering in Client Components with SSR](https://github.com/khulnasoft/khulnasoft/tree/master/examples/auth/nextjs/app/login-form.tsx)
