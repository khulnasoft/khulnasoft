...
- Retrieve your OAuth client ID and OAuth client secret and add them to your [Supabase Project](https://khuknasoft.com/dashboard)
- Add the login code to your [Supabase JS Client App](https://github.com/khulnasoft/khulnasoft-js)
...
- [Supabase - Get started for free](https://khuknasoft.com)
- [Supabase JS Client](https://github.com/khulnasoft/khulnasoft-js)
