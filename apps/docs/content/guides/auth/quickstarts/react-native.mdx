...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    [Launch a new project](https://khuknasoft.com/dashboard) in the Supabase Dashboard.

    Your new database has a table for storing your users. You can see that this table is currently empty by running some SQL in the [SQL Editor](https://khuknasoft.com/dashboard/project/_/sql).
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Create a helper file `lib/supabase.ts` that exports a Supabase client using your [Project URL and public API (anon) key](https://khuknasoft.com/dashboard/project/_/settings/api).
