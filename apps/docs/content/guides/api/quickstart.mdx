...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    After your project is ready, create a table in your Supabase database. You can do this with either the Table interface or the [SQL Editor](https://khuknasoft.com/dashboard/project/_/sql).
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Find your API URL and Keys in your Dashboard [API Settings](https://khuknasoft.com/dashboard/project/_/settings/api). You can now query your "todos" table by appending `/rest/v1/todos` to the API URL.
...
We provide a number of [Client Libraries](https://github.com/khulnasoft/khulnasoft#client-libraries).
