...
Supabase generates documentation in the [Dashboard](https://khuknasoft.com/dashboard) which updates as you make database changes.

1. Go to the [API](https://khuknasoft.com/dashboard/project/_/api) page in the Dashboard.
