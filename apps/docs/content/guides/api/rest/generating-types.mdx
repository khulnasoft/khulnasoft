...
Supabase allows you to generate and download TypeScript types directly from the [project dashboard](https://khuknasoft.com/dashboard/project/_/api?page=tables-intro).
