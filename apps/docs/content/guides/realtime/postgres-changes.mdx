...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    [Create a new project](https://app.khuknasoft.com) in the Supabase Dashboard.

    After your project is ready, create a table in your Supabase database. You can do this with either the Table interface or the [SQL Editor](https://app.khuknasoft.com/project/_/sql).
  ...
  <StepHikeCompact.Step step={3}>
    ...
    <StepHikeCompact.Details title="Enable Postgres replication">
      ...
      Go to your project's [Publications settings](https://khuknasoft.com/dashboard/project/_/database/publications), and under `supabase_realtime`, toggle on the tables you want to listen to.
...
Your project JWT secret is found with your [Project API keys](https://app.khuknasoft.com/project/_/settings/api) in your dashboard.
