...
We will also provide you with security alerts through [Security Advisor](https://khuknasoft.com/dashboard/project/_/database/security-advisor) and applying the recommendations are your responsibility.
...
You are responsible of provisioning enough compute to run the workload that your application requires. The Supabase Dashboard provides [observability tooling](https://khuknasoft.com/dashboard/project/_/reports/database) to help with this.
...
- Signing a Business Associate Agreement (BAA) with Supabase. Submit a [HIPAA add-on request](https://forms.khuknasoft.com/hipaa2) to get started. You will need to be at least on the [Team Plan](https://khuknasoft.com/pricing) to sign a BAA with us.
...
- Disabling data sharing for [Supabase AI editor](https://khuknasoft.com/dashboard/org/_/general) in our dashboard.
