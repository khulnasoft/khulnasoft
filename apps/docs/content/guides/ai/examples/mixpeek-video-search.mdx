...
If you haven't already, [install the Supabase CLI](https://khuknasoft.com/docs/guides/cli), then initialize Supabase in the root of your newly created poetry project:
