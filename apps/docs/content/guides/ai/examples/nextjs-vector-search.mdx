...
You can read our [Supabase Clippy](https://khuknasoft.com/blog/chatgpt-supabase-docs) blog post for a full example.
...
1. [Create a new project](https://khuknasoft.com/dashboard) in the Supabase Dashboard.
1. Enter your project details.
1. Wait for the new database to launch.

## Prepare the database

Let's prepare the database schema. We can use the "OpenAI Vector Search" quickstart in the [SQL Editor](https://khuknasoft.com/dashboard/project/_/sql), or you can copy/paste the SQL below and run it yourself.
...
1. Go to the [SQL Editor](https://khuknasoft.com/dashboard/project/_/sql) page in the Dashboard.
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={2}>
    ...
    To make changes to our local database, we need to create a new migration. This will create a new `.sql` file in our `khulnasoft/migrations` folder, where we can write SQL that will be applied to our local database when starting Supabase locally.
  ...
  <StepHikeCompact.Step step={4}>
    ...
    These are quite complex SQL operations, so let's wrap them in database functions that we can call from our frontend using [RPC](https://khuknasoft.com/docs/reference/javascript/rpc).
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Start Supabase locally. At this point all files in `khulnasoft/migrations` will be applied to your database and you're ready to go.
...
- Read about how we built [ChatGPT for the Supabase Docs](https://khuknasoft.com/blog/chatgpt-supabase-docs).
- Read the pgvector Docs for [Embeddings and vector similarity](https://khuknasoft.com/docs/guides/database/extensions/pgvector)
