...
We can combine Hugging Face with [Supabase Storage](https://khuknasoft.com/storage) and [Database Webhooks](https://khuknasoft.com/docs/guides/database/webhooks) to automatically caption for any image we upload to a storage bucket.
...
- Open your Supabase project dashboard or [create a new project](https://khuknasoft.com/dashboard/projects).
- [Create a new bucket](https://khuknasoft.com/dashboard/project/_/storage/buckets) called `images`.
...
- Create the Database Webhook in the [Supabase Dashboard](https://khuknasoft.com/dashboard/project/_/database/hooks) to trigger the `huggingface-image-captioning` function anytime a record is added to the `storage.objects` table.
...
Find the complete code on [GitHub](https://github.com/khulnasoft/khulnasoft/tree/master/examples/edge-functions/khulnasoft/functions/huggingface-image-captioning).
