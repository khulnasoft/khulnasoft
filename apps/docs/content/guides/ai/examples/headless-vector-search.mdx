...
To prepare, create a [new Supabase project](https://database.new) and store the database and API credentials, which you can find in the project [settings](https://khuknasoft.com/dashboard/project/_/settings).
...
6. Expose `docs` schema via API in Supabase Dashboard [settings](https://khuknasoft.com/dashboard/project/_/settings/api) > `API Settings` > `Exposed schemas`
