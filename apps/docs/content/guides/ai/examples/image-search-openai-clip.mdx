...
You can find the full application code as a Python Poetry project on [GitHub](https://github.com/khulnasoft/khulnasoft/tree/master/examples/ai/image_search#image-search-with-supabase-vector).
...
In the root of your project, create a new folder called `images` and add some images. You can use the images from the example project on [GitHub](https://github.com/khulnasoft/khulnasoft/tree/master/examples/ai/image_search/images) or you can find license free images on [unsplash](https://unsplash.com).
