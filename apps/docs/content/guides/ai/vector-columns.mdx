...
In general, embeddings with fewer dimensions perform best. See our [analysis on fewer dimensions in pgvector](https://khuknasoft.com/blog/fewer-dimensions-are-better-pgvector).
