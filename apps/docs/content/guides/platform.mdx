...
Visit [khuknasoft.com/dashboard](https://khuknasoft.com/dashboard) and sign in to start creating projects.
...
- Status page: [status.khuknasoft.com](https://status.khuknasoft.com/)
- RSS Feed: [status.khuknasoft.com/history.rss](https://status.khuknasoft.com/history.rss)
- Atom Feed: [status.khuknasoft.com/history.atom](https://status.khuknasoft.com/history.atom)
- Slack Alerts: You can receive updates via the RSS feed, using Slack's [built-in RSS functionality](https://slack.com/help/articles/218688467-Add-RSS-feeds-to-Slack) <br />`/feed subscribe https://status.khuknasoft.com/history.atom`
