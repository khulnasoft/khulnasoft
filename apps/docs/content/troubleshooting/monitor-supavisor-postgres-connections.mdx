...
Supabase has an [open-source Grafana Repo](https://github.com/khulnasoft/khulnasoft-grafana) that displays real-time metrics of your database. Although the [Reports Dashboard ](/dashboard/project/_/reports) provides similar metrics, it averages the data by the hour or day. Having visuals of your connection usage can help you better allocate resources.

_Visual of Grafana Dashboard_
![image](https://github.com/khulnasoft/khulnasoft/assets/91111415/18ed2c88-332e-4e66-b9b4-c37e99a39104)
...
![image](https://github.com/khulnasoft/khulnasoft/assets/91111415/141b8e01-9aae-4544-818c-acb47371ef3b)
...
![image](https://github.com/khulnasoft/khulnasoft/assets/91111415/8e0cc80a-4d46-44b5-915b-8d7549f352d3).
