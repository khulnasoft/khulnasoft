...
- A Supabase project (create one here: https://khuknasoft.com/dashboard)
...
Now go to the [Auth > Providers](https://khuknasoft.com/dashboard/project/_/auth/providers) page in the Supabase dashboard and select "Phone" from the Auth Providers list.
...
Go to [Auth > Templates](https://khuknasoft.com/dashboard/project/_/auth/templates) page in the Supabase dashboard.
