...
- **A Supabase project**: Necessary for SMS authentication integration. Create your project in the [Supabase Dashboard](https://khuknasoft.com/dashboard).
...
1. In your Supabase Dashboard, go to the [Auth Providers section](https://khuknasoft.com/dashboard/project/_/auth/providers).
