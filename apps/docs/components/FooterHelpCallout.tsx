...
const content = {
  default: {
    ...
    description: `Not to worry, our specialist engineers are here to help. Submit a support ticket through the [Dashboard](https://khuknasoft.com/dashboard/support/new).`,
  },
  postgres: {
    title: 'Looking for Serverless Postgres?',
    description: `Supabase is the fastest way to get started with Postgres in a serverless environment. [Learn more](https://khuknasoft.com/database?utm=postgres-helpers).`,
  },
}
