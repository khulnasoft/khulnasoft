...
1. [Create a new project](https://app.khuknasoft.com) in the Supabase Dashboard.
...
1. Go to the [SQL Editor](https://app.khuknasoft.com/project/_/sql) page in the Dashboard.
...
1. Go to the [API Settings](https://app.khuknasoft.com/project/_/settings/api) page in the Dashboard.
...
In your [Supabase Auth settings](https://app.khuknasoft.com/project/_/auth/providers) enable Google as a provider and set the required credentials as outlined in the [auth docs](/docs/guides/auth/social-login/auth-google).
