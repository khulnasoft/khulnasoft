      ...
      menuItems: [
        [
          ...
          },
          {
            ...
            icon: 'changelog',
            hasLightIcon: true,
            href: 'https://khuknasoft.com/changelog',
            level: 'changelog',
          },
          {
            label: 'Status',
...
export const reference_javascript_v1 = {
  ...
  pkg: {
    ...
    repo: 'https://github.com/khulnasoft/khulnasoft-js',
  },
}
...
export const reference_dart_v1 = {
  ...
  pkg: {
    ...
    repo: 'https://github.com/khulnasoft/khulnasoft-flutter',
  },
}
...
export const reference_python_v2 = {
  ...
  pkg: {
    name: 'supabase-py',
    repo: 'https://github.com/khulnasoft/khulnasoft-py',
  },
}
...
export const reference_swift_v1 = {
  ...
  pkg: {
    name: 'supabase-swift',
    repo: 'https://github.com/khulnasoft/khulnasoft-swift',
  },
}
