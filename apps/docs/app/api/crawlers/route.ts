...
function htmlShell(
  ...
  return (
    ...
    `<meta name="og:image" content="https://khuknasoft.com/docs/img/supabase-og-image.png">` +
    `<meta name="twitter:image" content="https://khuknasoft.com/docs/img/supabase-og-image.png">` +
    `<link rel="canonical" href="https://khuknasoft.com/docs/reference/${lib}` +
    (version ? '/' + version : '') +
    (slug ? '/' + slug : '') +
    `">` +
    '</head>' +
