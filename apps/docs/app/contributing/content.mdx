...
The code and content for our docs site are located in the main [Supabase GitHub repo](https://github.com/khulnasoft/khulnasoft), under the `apps/docs` directory.

In the repo, you'll also find:

- The [developers guide](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/DEVELOPERS.md), which will help you set up your local machine to develop the docs site
- The [contributing guide](https://github.com/khulnasoft/khulnasoft/blob/master/apps/docs/CONTRIBUTING.md), which goes over the content organization and some general guidelines for writing docs content
