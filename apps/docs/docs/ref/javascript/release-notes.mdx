...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
    ...
    See [PR](https://github.com/khulnasoft/khulnasoft-js/pull/458):
...
- `supabase-js`
  - `shouldThrowOnError` has been removed until all the client libraries support this option ([PR](https://github.com/khulnasoft/khulnasoft-js/pull/490)).
- `postgrest-js`
...
- `gotrue-js`
  - `supabase-js` client allows passing a `storageKey` param which will allow the user to set the key used in local storage for storing the session. By default, this will be namespace-d with the supabase project ref. ([PR](https://github.com/khulnasoft/khulnasoft-js/pull/460))
