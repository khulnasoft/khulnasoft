...
func TestPermsSyncerWorker_RepoSyncJobs(t *testing.T) {
	...
	require.NoError(t, err)
	repoStore := db.Repos()
	err = repoStore.Create(ctx, &types.Repo{Name: "github.com/soucegraph/khulnasoft"}, &types.Repo{Name: "github.com/soucegraph/about"}, &types.Repo{Name: "github.com/soucegraph/hello"})
	require.NoError(t, err)
...
func TestPermsSyncerWorker_UserSyncJobs(t *testing.T) {
	...
	require.NoError(t, err)
	repoStore := db.Repos()
	err = repoStore.Create(ctx, &types.Repo{Name: "github.com/soucegraph/khulnasoft"}, &types.Repo{Name: "github.com/soucegraph/about"})
	require.NoError(t, err)
