// The testproxy command runs a simple HTTP proxy that wraps a Khulnasoft server running with the
...
var (
	...
	urlStr         = flag.String("url", "http://localhost:3080", "proxy origin URL (Khulnasoft HTTP/HTTPS URL)") // CI:LOCALHOST_OK
	username       = flag.String("username", os.Getenv("USER"), "username to report to Khulnasoft")
