...
import (
	...
	"github.com/khulnasoft/khulnasoft/internal/github_apps/store"
...
func TestResolver_DeleteGitHubApp(t *testing.T) {
	...
	schema, err := graphqlbackend.NewSchema(db, gitserver.NewTestClient(t), nil, []graphqlbackend.OptionalResolver{{GitHubAppsResolver: NewResolver(logger, db)}})
