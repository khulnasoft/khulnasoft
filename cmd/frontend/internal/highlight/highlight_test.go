...
import (
	...
	"github.com/khulnasoft/khulnasoft/internal/gosyntect"
...
func TestSplitHighlightedLines(t *testing.T) {
...
</span></div></td></tr><tr><td class="line" data-line="4"></td><td class="code"><div><span style="color:#323232;">	</span><span style="color:#183691;">&#34;github.com/khulnasoft/khulnasoft/internal/api/legacyerr&#34;
	...
	want := []template.HTML{
		...
		`<div><span style="color:#323232;">	</span><span style="color:#183691;">&#34;github.com/khulnasoft/khulnasoft/internal/api/legacyerr&#34;
</span></div>`,
		`<div><span style="color:#323232;">)
</span></div>`,
		`<div><span style="color:#323232;">
			...
			want: [][]string{
				{
					...
					"<tr><td class=\"line\" data-line=\"4\"></td><td class=\"code\"><div><span style=\"color:#323232;\">	</span><span style=\"color:#183691;\">&#34;github.com/khulnasoft/khulnasoft/internal/api/legacyerr&#34;\n</span></div></td></tr>",
