...
func Test_serveRawWithHTTPRequestMethodHEAD(t *testing.T) {
	...
	t.Run("success response for HEAD request", func(t *testing.T) {
		...
		req := httptest.NewRequest("HEAD", "/github.com/khulnasoft/khulnasoft/-/raw", nil)
		...
		err := serveRaw(logger, db, gitserver.NewTestClient(t), nil)(w, req)
		if err != nil {
...
func Test_serveRawWithContentArchive(t *testing.T) {
	...
	t.Run("success response for format=zip", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/github.com/khulnasoft/khulnasoft/-/raw?format=zip", nil)
		w := httptest.NewRecorder()
		...
		err := serveRaw(logger, db, client, nil)(w, req)
		if err != nil {
			t.Fatalf("Failed to invoke serveRaw: %v", err)
		}
	...
	t.Run("success response for format=tar", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/github.com/khulnasoft/khulnasoft/-/raw?format=tar", nil)
		w := httptest.NewRecorder()
...
func Test_serveRawWithContentTypePlain(t *testing.T) {
	...
	t.Run("404 Not Found for non existent directory", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/github.com/khulnasoft/khulnasoft/-/raw", nil)
		w := httptest.NewRecorder()

		db := dbmocks.NewMockDB()
		err := serveRaw(logger, db, gsClient, nil)(w, req)
		if err != nil {
			t.Fatalf("Failed to invoke serveRaw: %v", err)
		}
...
c.go`
	...
	t.Run("success response for existing file", func(t *testing.T) {
		...
		err := serveRaw(logger, dbmocks.NewMockDB(), gitserverClient, nil)(w, req)
		if err != nil {
			t.Fatalf("Failed to invoke serveRaw: %v", err)
		}
	...
	t.Run("success response for existing file with format=exe", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/github.com/khulnasoft/khulnasoft/-/raw?format=exe", nil)
		w := httptest.NewRecorder()
