...
import (
	...
	"github.com/khulnasoft/khulnasoft/internal/modelconfig"
	...
	sgactor "github.com/khulnasoft/khulnasoft/internal/actor"
...
func resolveRequestedModel(
	...
	*modelconfigSDK.Provider, *modelconfigSDK.Model, error) {
	...
	// case, the configuration data is kinda useless. dotcom sets the "completions.provider" to "khulnasoft",
	...
	if dotcom.SourcegraphDotComMode() {
		...
		fauxProvider := modelconfigSDK.Provider{
			...
			// is "khulnasoft", and therefore the ServerSideConfig will be set correctly.
