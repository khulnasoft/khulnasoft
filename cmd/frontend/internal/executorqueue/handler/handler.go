...
import (
	...
	executorstore "github.com/khulnasoft/khulnasoft/internal/executor/store"
	...
	"github.com/khulnasoft/khulnasoft/lib/api"
...
func (h *handler[T]) dequeue(ctx context.Context, queueName string, metadata executorMetadata) (executortypes.Job, bool, error) {
	...
	if metadata.version != "" {
		var err error
		version2Supported, err = api.CheckKhulnasoftVersion(metadata.version, ">= 4.3.0-0", "2022-11-24")
		if err != nil {
