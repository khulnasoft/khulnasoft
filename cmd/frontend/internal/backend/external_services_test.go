...
import (
	...
	"github.com/khulnasoft/khulnasoft/internal/extsvc/awscodecommit"
	"github.com/khulnasoft/khulnasoft/internal/extsvc/azuredevops"
	...
	"github.com/khulnasoft/khulnasoft/internal/extsvc/gerrit"
	"github.com/khulnasoft/khulnasoft/internal/extsvc/github"
	"github.com/khulnasoft/khulnasoft/internal/extsvc/gitlab"
	"github.com/khulnasoft/khulnasoft/internal/extsvc/gitolite"
	internalrepos "github.com/khulnasoft/khulnasoft/internal/repos"
...
func TestAddRepoToExclude(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedConfig: `{"exclude":[{"name":"sg/khulnasoft"}],"url":"https://bitbucket.org"}`,
		},
		{
...
func makeBitbucketCloudRepo() *types.Repo {
	repo := typestest.MakeRepo("bitbucket.org/sg/khulnasoft", "https://bitbucket.org/", extsvc.TypeBitbucketCloud)
	mdStr := &bitbucketcloud.Repo{
		FullName: "sg/khulnasoft",
	}
	repo.Metadata = mdStr
	return repo
}
