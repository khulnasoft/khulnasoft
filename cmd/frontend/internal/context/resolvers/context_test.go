...
func TestCodyIgnore(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// TODO (taras-yemets): remove feature flag mocking after `CodyContextFilters` support is added to the IDE clients (see: https://github.com/khulnasoft/khulnasoft/pull/62231)
			t.Cleanup(func() {
