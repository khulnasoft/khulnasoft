...
func TestCalculateExecutorCompatibility(t *testing.T) {
	tests := []struct {
		...
		{
			name:                  "Executor is the same version as the Khulnasoft instance",
			executorVersion:       "3.43.0",
			sourcegraphVersion:    "3.43.0",
			isActive:              true,
			expectedCompatibility: ExecutorCompatibilityUpToDate,
		...
		{
			name:                  "Executor is the same version as the Khulnasoft instance (insiders)",
		...
		{
			name:                  "Executor is the same version as the Khulnasoft instance (insiders - old version)",
			executorVersion:       "executor-patch-notest-es-ignite-debug_168065_2022-08-25_e94e18c4ebcc_patch",
		...
		{
			name:                  "Khulnasoft instance is in dev mode",
		...
		{
			name:                  "Executor is in dev mode and Khulnasoft instance is on insiders version",
			executorVersion:       "0.0.0+dev",
			sourcegraphVersion:    "169135_2022-08-15_a2b623dce148",
			isActive:              true,
			expectedCompatibility: "",
		...
		{
			name:                  "Khulnasoft instance is in dev mode and executor is on insiders version",
			executorVersion:       "169135_2022-08-15_a2b623dce148",
			sourcegraphVersion:    "0.0.0+dev",
			isActive:              true,
			expectedCompatibility: "",
		...
		{
			name:                  "Khulnasoft version is an invalid semver",
		...
		{
			name:                  "Khulnasoft release branch build",
