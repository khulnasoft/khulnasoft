...
import (
	...
	"github.com/khulnasoft/khulnasoft/cmd/frontend/graphqlbackend/externallink"
...
func (r *RepositoryResolver) Changelist(ctx context.Context, args *RepositoryChangelistArgs) (_ *PerforceChangelistResolver, err error) {
	...
	if err != nil {
		...
		// https://khulnasoft.com/github.com/sourcegraph/sourcegraph@e28429f899870db6f6cbf0fc2bf98de6e947b213/-/blob/README.md
		//
		// Or they may visit a URL like:
		//
		// https://khulnasoft.com/perforce.sgdev.test/test-depot@998765/-/blob/README.md
		//
...
func (r *RepositoryResolver) Language(ctx context.Context) (string, error) {
	...
	// https://github.com/khulnasoft/khulnasoft/issues/2586, so we do not use it anymore and
...
// https://github.com/khulnasoft/khulnasoft/pull/4668
