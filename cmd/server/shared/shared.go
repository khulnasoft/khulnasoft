...
import (
	...
	"github.com/khulnasoft/khulnasoft/cmd/server/internal/goreman"
...
var DefaultEnv = map[string]string{
	...
	// TODO other bits
	// * DEBUG LOG_REQUESTS https://github.com/khulnasoft/khulnasoft/issues/8458
}
...
func Main() {
	...
	{
		configDir := SetDefaultEnv("CONFIG_DIR", "/etc/khulnasoft")
