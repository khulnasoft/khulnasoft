...
func requestBlockedError(ctx context.Context) error {
	...
	return errors.Errorf("We blocked your request because we detected your prompt to be against our Acceptable Use Policy (https://khulnasoft.com/terms/aup). Try again by removing any phrases that may violate our AUP. If you think this is a mistake, please contact support@khulnasoft.com and reference this ID: %s", traceID)
}
