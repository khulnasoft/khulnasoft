...
func (h *L1MainLanguageHost) Pack(ctx context.Context, req *khulnasoftrpc.PackRequest) (*khulnasoftrpc.PackResponse, error) {
...
func (h *L1MainLanguageHost) Run(ctx context.Context, req *khulnasoftrpc.RunRequest) (*khulnasoftrpc.RunResponse, error) {
	if req.Info.RootDirectory != filepath.Join(h.tempDir, "projects", "l1-main") {
	...
	resp, err := monitor.RegisterResource(ctx, &khulnasoftrpc.RegisterResourceRequest{
