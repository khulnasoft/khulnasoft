...
func (h *L1EmptyLanguageHost) Pack(ctx context.Context, req *khulnasoftrpc.PackRequest) (*khulnasoftrpc.PackResponse, error) {
...
func (h *L1EmptyLanguageHost) Run(ctx context.Context, req *khulnasoftrpc.RunRequest) (*khulnasoftrpc.RunResponse, error) {
	if req.Info.RootDirectory != filepath.Join(h.tempDir, "projects", "l1-empty") {
