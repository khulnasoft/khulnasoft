...
import (
	...
	"github.com/khulnasoft/khulnasoft/cmd/khulnasoft-test-language/providers"
		...
		runs: []testRun{
			{
				assert: func(l *L,
					...
					require.Equal(l, "khulnasoft:providers:khulnasoft", prov.Type.String(), "expected a default khulnasoft provider resource")
					ref := snap.Resources[2]
					require.Equal(l, "khulnasoft:khulnasoft:StackReference", ref.Type.String(), "expected a stack reference resource")
		...
		runs: []testRun{
			{
				assert: func(l *L,
					...
					assert.Equal(l, "khulnasoft:providers:simple", provider.Type.String(), "expected simple provider")
		...
		runs: []testRun{
			{
				assert: func(l *L,
					...
					provider := snap.Resources[1]
					assert.Equal(l, "khulnasoft:providers:primitive", provider.Type.String(), "expected primitive provider")
		...
		runs: []testRun{
			{
				assert: func(l *L,
					...
					provider := snap.Resources[1]
					assert.Equal(l, "khulnasoft:providers:alpha", provider.Type.String(), "expected alpha provider")
		...
		runs: []testRun{
			{
				...
				assert: func(l *L,
					...
					provider := snap.Resources[1]
					assert.Equal(l, "khulnasoft:providers:asset-archive", provider.Type.String(), "expected asset-archive provider")
		...
		runs: []testRun{
			{
				...
				assert: func(l *L,
					...
					require.Equal(l, "khulnasoft:providers:config", explicitProvider.Type.String(), "expected explicit provider resource")
					...
					require.Equal(l, "khulnasoft:providers:config", defaultProvider.Type.String(), "expected default provider resource")
		...
		runs: []testRun{
			{
				assert: func(l *L,
					...
					// TODO[khulnasoft/khulnasoft#16876]: CheckConfig request gets the secrets in the plain.
					...
					// TODO[khulnasoft/khulnasoft#17652] Languages do not agree on the object property
		...
		runs: []testRun{
			{
				assert: func(l *L,
					...
					provider := snap.Resources[1]
					assert.Equal(l, "khulnasoft:providers:primitive-ref", provider.Type.String(), "expected primitive-ref provider")
		...
		runs: []testRun{
			{
				assert: func(l *L,
					...
					provider := snap.Resources[1]
					assert.Equal(l, "khulnasoft:providers:ref-ref", provider.Type.String(), "expected ref-ref provider")
		...
		runs: []testRun{
			{
				assert: func(l *L,
					...
					provider := snap.Resources[1]
					assert.Equal(l, "khulnasoft:providers:plain", provider.Type.String(), "expected plain provider")
		...
		runs: []testRun{
			{
				assert: func(l *L,
					...
					requireSingleResource(l, snap.Resources, "khulnasoft:providers:primitive")
					primResource := requireSingleResource(l, snap.Resources, "primitive:index:Resource")
					requireSingleResource(l, snap.Resources, "khulnasoft:providers:primitive-ref")
					refResource := requireSingleResource(l, snap.Resources, "primitive-ref:index:Resource")
					requireSingleResource(l, snap.Resources, "khulnasoft:providers:ref-ref")
					rrefResource := requireSingleResource(l, snap.Resources, "ref-ref:index:Resource")
					requireSingleResource(l, snap.Resources, "khulnasoft:providers:plain")
