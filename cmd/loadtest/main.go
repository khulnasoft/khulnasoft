...
var (
	FrontendHost     = env.Get("LOAD_TEST_FRONTEND_URL", "http://khulnasoft-frontend-internal", "URL to the Khulnasoft frontend host to load test")
	FrontendPort     = env.Get("loadTestFrontendPort", "80", "Port that the Khulnasoft frontend is listening on")
