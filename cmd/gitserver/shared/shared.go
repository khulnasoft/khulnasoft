...
import (
	...
	internalgrpc "github.com/khulnasoft/khulnasoft/internal/grpc"
	...
	"github.com/khulnasoft/khulnasoft/cmd/gitserver/internal"
	...
	"github.com/khulnasoft/khulnasoft/cmd/gitserver/internal/cloneurl"
	...
	"github.com/khulnasoft/khulnasoft/cmd/gitserver/internal/vcssyncer"
	"github.com/khulnasoft/khulnasoft/internal/api"
	"github.com/khulnasoft/khulnasoft/internal/authz"
	"github.com/khulnasoft/khulnasoft/internal/authz/subrepoperms"
	...
	proto "github.com/khulnasoft/khulnasoft/internal/gitserver/v1"
	"github.com/khulnasoft/khulnasoft/internal/goroutine"
	"github.com/khulnasoft/khulnasoft/internal/goroutine/recorder"
	"github.com/khulnasoft/khulnasoft/internal/grpc/defaults"
	...
	return func(_ context.Context, cmd *exec.Cmd) bool {
		...
		if len(repos) == 1 && repos[0] == "*" {
			...
			for _, repo := range repos {
				...
				// different repo names. E.g. "khulnasoft/khulnasoft" and
