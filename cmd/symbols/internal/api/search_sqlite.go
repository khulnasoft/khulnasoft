...
import (
	...
	"github.com/khulnasoft/khulnasoft/cmd/symbols/internal/api/observability"
	"github.com/khulnasoft/khulnasoft/cmd/symbols/internal/database/store"
	"github.com/khulnasoft/khulnasoft/cmd/symbols/internal/database/writer"
	sharedobservability "github.com/khulnasoft/khulnasoft/cmd/symbols/internal/observability"
...
func MakeSqliteSearchFunc(observationCtx *observation.Context, cachedDatabaseWriter writer.CachedDatabaseWriter, db database.DB) types.SearchFunc {
	...
	return func(ctx context.Context, args search.SymbolsParameters) (results []result.Symbol, err error) {
		...
		defer func() {
			...
			if err2 != nil {
				err = errors.New("Processing symbols using the SQLite backend is taking a while. If this repository is ~1GB+, enable [Rockskip](https://khulnasoft.com/docs/code_navigation/explanations/rockskip).")
				return
			}
			...
			if size > 1_000_000_000 {
				help = "Enable [Rockskip](https://khulnasoft.com/docs/code_navigation/explanations/rockskip)."
			} else if size > 100_000_000 {
				help = "If this persists, enable [Rockskip](https://khulnasoft.com/docs/code_navigation/explanations/rockskip)."
			} else {
