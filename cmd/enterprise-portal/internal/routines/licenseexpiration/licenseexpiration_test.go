...
import (
	...
	subscriptions "github.com/khulnasoft/khulnasoft/cmd/enterprise-portal/internal/database/subscriptions"
	"github.com/khulnasoft/khulnasoft/cmd/enterprise-portal/internal/database/utctime"
...
func TestHandle(t *testing.T) {
	...
	autogold.Expect([]*slack.Payload{
		{
			Text: "The active license for subscription *es_e9450fb2-87c7-47ae-a713-a376c4618faa* (Salesforce subscription: `sf-sub-id`) <https://khulnasoft.com/site-admin/dotcom/product/subscriptions/es_e9450fb2-87c7-47ae-a713-a376c4618faa?env=dev|will expire *in the next 24 hours*> :rotating_light:",
		},
		{Text: "The active license for subscription *My Special Subscription* (Salesforce subscription: `unknown`) <https://khulnasoft.com/site-admin/dotcom/product/subscriptions/es_26136564-b319-4be4-98ff-7b8710abf4af?env=dev|will expire *in 7 days*>"},
	}).Equal(t, payloads)
}
