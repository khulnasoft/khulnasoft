...
describe('src/filters.js', function () {
  describe('filters.Href(filter)', function () {
    it('filters for exact matches of href', function () {
      var filter = new filters.Href('https://www.khulnasoft.com/about')
      var result = filter.apply([
        { payload: {} },
        { payload: { sessionId: 'session-a', href: new window.URL('https://www.khulnasoft.com/about') } },
        { payload: { sessionId: 'session-b', href: new window.URL('https://www.khulnasoft.com/about') } },
        { payload: { sessionId: 'session-B', href: new window.URL('https://www.khulnasoft.com') } },
        { payload: { sessionId: 'session-a', href: new window.URL('https://www.khulnasoft.com/about/imprint') } },
        { payload: { sessionId: 'session-a', href: new window.URL('https://www.khulnasoft.com/') } },
        { payload: { sessionId: 'session-B', href: new window.URL('https://www.khulnasoft.com/other') } }
      ])
