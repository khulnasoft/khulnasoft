...
func (panelOptionsLibrary) OpinionatedGraphPanelDefaults() ObservablePanelOption {
	return func(o Observable, p *sdk.Panel) {
		...
		//
		// 1. Using "{{instance}}" is often wrong, see: https://handbook.khulnasoft.com/engineering/observability/monitoring_pillars#graphs-should-have-less-than-5-cardinality
