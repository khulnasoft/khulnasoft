import { SmsProviderIdEnum } from '@khulnasoft/shared';
import { ChannelTypeEnum, ISendMessageSuccessResponse, ISmsOptions, ISmsProvider } from '@khulnasoft/stateless';
...
export class Sms77SmsProvider extends BaseProvider implements ISmsProvider {
  ...
  constructor(
    ...
    super();
    this.sms77Client = new Sms77Client(config.apiKey, 'Khulnasoft');
  }
