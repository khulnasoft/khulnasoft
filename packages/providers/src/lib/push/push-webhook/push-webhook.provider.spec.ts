  ...
  expect(fakePost).toHaveBeenCalledWith(
    ...
    }),
    {
      headers: {
        ...
        'X-Khulnasoft-Signature': 'ebb2ff6420df59a863a6ddfa64ca8721cbbce038d5432c441cde83dee43b70d9',
      },
    }
  );
});
...
test('should trigger push-webhook library correctly with _passthrough', async () => {
  ...
  expect(fakePost).toHaveBeenCalledWith(
    ...
    }),
    {
      headers: {
        'content-type': 'application/json',
        'X-Khulnasoft-Signature': '5147e1613526bad56a1c0e318ebbdd7d312c7760dcb8230f3f4c80c07d9ebdd0',
      },
    }
  );
});
