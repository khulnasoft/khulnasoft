import { PushProviderIdEnum } from '@khulnasoft/shared';
import { ChannelTypeEnum, ISendMessageSuccessResponse, IPushOptions, IPushProvider } from '@khulnasoft/stateless';
...
export class ExpoPushProvider extends BaseProvider implements IPushProvider {
  ...
  async sendMessage(
    ...
    /*
     * TODO: We now just send one device token from Khulnasoft.
