...
type KhulnasoftWelcomeEmailProps = ControlSchema & PayloadSchema;

export const KhulnasoftWelcomeEmail = ({
  components,
  userImage,
  teamImage,
  arrowImage,
  showHeader,
}: KhulnasoftWelcomeEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>Khulnasoft Welcome</Preview>
      <Tailwind
        config={{
          theme: {
            extend: {
        ...
        <Body className="bg-blurwhite text-base font-sans">
          ...
          <Container className="mt-20">
            <Text className="text-center text-gray-400 mb-45">
              Powered by Khulnasoft, the Code-First Notification Infrastructure
            </Text>
          </Container>
        </Body>
      </Tailwind>
...
export default KhulnasoftWelcomeEmail;

export function renderEmail(controls: ControlSchema, payload: PayloadSchema) {
  return render(<KhulnasoftWelcomeEmail {...controls} {...payload} />);
}
