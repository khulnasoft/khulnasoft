...
export const payloadSchema = z.object({
  inAppSubject: z
    ...
    .default("**Welcome to Khulnasoft!**"),
  inAppBody: z
    .string()
    .describe("The body of the notification")
    .default("This is an in-app notification powered by Khulnasoft."),
  inAppAvatar: z
    .string()
...
export const emailControlSchema = z.object({
  subject: z.string().default("A Successful Test on Khulnasoft!"),
  ...
  components: z
    ...
    .default([
      {
        type: "heading",
        text: "Welcome to Khulnasoft",
        align: "center",
      },
      {
        type: "text",
        text: "Congratulations on receiving your first notification email from Khulnasoft! Join the hundreds of thousands of developers worldwide who use Khulnasoft to build notification platforms for their products.",
        align: "left",
      },
      {
        type: "users",
