...
export default function Home() {
  const [isKhulnasoftConnected, setIsKhulnasoftConnected] = useState(false);
  ...
  useEffect(() => {
    const checkKhulnasoftConnection = async () => {
      try {
        const response = await fetch("/api/dev-studio-status");
        const data = await response.json();
        setIsKhulnasoftConnected(data.connected);

        if (!data.connected) {
          console.log("Khulnasoft connection failed:", data.error);
        }
      } catch (error) {
        console.error("Khulnasoft connection error:", error);
        setIsKhulnasoftConnected(false);
      }
    };

    checkKhulnasoftConnection();
    const interval = setInterval(checkKhulnasoftConnection, 3000);
      ...
      <main className={styles.main}>
        <div className={styles.card}>
          ...
          <div className={styles.header}>
            <div>
              <h1>Khulnasoft + Next.js Starter</h1>
          ...
          <div className={styles.content}>
            ...
            <div className={styles.infoSection}>
              ...
              <details className={styles.accordion}>
                ...
                <div className={styles.accordionContent}>
                  <p className={styles.description}>
                    In Khulnasoft, all notifications are sent via a workflow. Each
                  ...
                  <div className={styles.stepList}>
                    ...
                    <div className={styles.step}>
                      ...
                      <div className={styles.stepContent}>
                        ...
                        <p className={styles.stepDescription}>
                          ...
                          Khulnasoft API with a specified workflow trigger identifier.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className={styles.step}>
                      ...
                      <div className={styles.stepContent}>
                        ...
                        <p className={styles.stepDescription}>
                          Within the Khulnasoft framework, steps are categorized into
              ...
              <details className={styles.accordion}>
                ...
                <div className={styles.accordionContent}>
                  <p className={styles.description}>
                    Khulnasoft provides a way to store subscriber preferences. This
                ...
                <div className={styles.connectionMessage}>
                  ...
                  <div className={styles.connectionText}>
                    ...
                    <code className={styles.commandCode}>
                      npx khulnasoft@latest dev --port 4000
                    </code>
                  </div>
                </div>
              )}
      ...
      <footer className={styles.footer}>
        <div className={styles.footerContent}>
          <div className={styles.footerLogo}>
            <Image src="./khulnasoft.svg" alt="Khulnasoft Logo" width={120} height={60} />
          ...
          <div className={styles.footerSection}>
            ...
            <ul>
              ...
              <li>
                <a href="https://discord.khulnasoft.co" target="_blank">
                  Discord
                </a>
              </li>
              <li>
