...
use crate::native::utils::{path::get_child_files, KhulnasoftCondvar, KhulnasoftMutex, Normalize};
...
use crate::native::workspace::types::{
    FileMap, KhulnasoftWorkspaceFilesExternals, ProjectFiles, UpdatedWorkspaceFiles,
};
use crate::native::workspace::{config_files, types::KhulnasoftWorkspaceFiles, workspace_files};
...
struct FilesWorker(Option<Arc<(KhulnasoftMutex<Files>, KhulnasoftCondvar)>>);
impl FilesWorker {
    ...
    fn gather_files(workspace_root: &Path, cache_dir: String) -> Self {
        ...
        let files_lock = Arc::new((KhulnasoftMutex::new(Vec::new()), KhulnasoftCondvar::new()));
    ...
    fn gather_files(workspace_root: &Path, cache_dir: String) -> Self {
        ...
        let files_lock = Arc::new((KhulnasoftMutex::new(files), KhulnasoftCondvar::new()));
...
impl WorkspaceContext {
    ...
    ) -> anyhow::Result<KhulnasoftWorkspaceFiles> {
    ...
    pub fn update_project_files(
        ...
        UpdatedWorkspaceFiles {
            ...
            external_references: KhulnasoftWorkspaceFilesExternals {
