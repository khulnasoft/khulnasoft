...
import { ExternalNode, Project, Target, ProjectGraph as RustProjectGraph } from './index';

export function transformProjectGraphForRust(graph: ProjectGraph): RustProjectGraph {
