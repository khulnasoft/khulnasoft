...
export declare class HashPlanner {
  constructor(khulnasoftJson: KhulnasoftJson, projectGraph: ExternalObject<ProjectGraph>);
...
export declare class KhulnasoftCache {
  cacheDirectory: string;
  constructor(
    workspaceRoot: string,
    cachePath: string,
    dbConnection: ExternalObject<KhulnasoftDbConnection>,
    linkTaskDetails?: boolean | undefined | null,
...
export declare class KhulnasoftTaskHistory {
  constructor(db: ExternalObject<KhulnasoftDbConnection>);
...
export declare class RustPseudoTerminal {
  ...
  runCommand(
    command: string,
    commandDir?: string | undefined | null,
    jsEnv?: Record<string, string> | undefined | null,
    execArgv?: Array<string> | undefined | null,
...
export declare class TaskHasher {
  constructor(
    workspaceRoot: string,
    projectGraph: ExternalObject<ProjectGraph>,
    projectFileMap: ExternalObject<ProjectFiles>,
  ...
  hashPlans(
    hashPlans: ExternalObject<Record<string, Array<HashInstruction>>>,
...
export declare class WorkspaceContext {
  ...
  getWorkspaceFiles(projectRootMap: Record<string, string>): KhulnasoftWorkspaceFiles;
...
export declare function closeDbConnection(connection: ExternalObject<KhulnasoftDbConnection>): void;

export declare function connectToKhulnasoftDb(
  cacheDir: string,
  khulnasoftVersion: string,
  dbName?: string | undefined | null
): ExternalObject<KhulnasoftDbConnection>;
...
export interface KhulnasoftJson {
  namedInputs?: Record<string, Array<JsInputs>>;
}

export interface KhulnasoftWorkspaceFiles {
  projectFileMap: ProjectFiles;
  globalFiles: Array<FileData>;
  externalReferences?: KhulnasoftWorkspaceFilesExternals;
}

export interface KhulnasoftWorkspaceFilesExternals {
  projectFiles: ExternalObject<ProjectFiles>;
  globalFiles: ExternalObject<Array<FileData>>;
  allWorkspaceFiles: ExternalObject<Array<FileData>>;
}
...
export declare function testOnlyTransferFileMap(
  projectFiles: Record<string, Array<FileData>>,
  nonProjectFiles: Array<FileData>
