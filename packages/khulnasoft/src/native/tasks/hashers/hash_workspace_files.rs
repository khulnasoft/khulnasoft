    ...
    let globs: Vec<String> = workspace_file_sets
        ...
        .filter_map(|x| {
            ...
            if let Some(fileset) = fileset {
                ...
                warn!(
                    "{x} does not start with {}. This will throw an error in Khulnasoft 20.",
                    "{workspaceRoot}/"
                );
                None
            }
...
mod test {
    ...
    fn test_hash_workspace_files() {
        ...
        let khulnasoftignore_file = FileData {
            file: ".khulnasoftignore".into(),
            hash: "456".into(),
        };
