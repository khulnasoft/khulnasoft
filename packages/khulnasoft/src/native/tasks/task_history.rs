...
#[napi]
pub struct KhulnasoftTaskHistory {
    db: External<KhulnasoftDbConnection>,
}

#[napi]
impl KhulnasoftTaskHistory {
    #[napi(constructor)]
    pub fn new(db: External<KhulnasoftDbConnection>) -> anyhow::Result<Self> {
        let s = Self { db };
