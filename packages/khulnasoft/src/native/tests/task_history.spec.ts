import { TaskDetails, KhulnasoftTaskHistory } from '../index';
...
describe('KhulnasoftTaskHistory', () => {
  let taskHistory: KhulnasoftTaskHistory;
  let tempFs: TempFs;
  ...
  beforeEach(() => {
    ...
    taskHistory = new KhulnasoftTaskHistory(dbConnection);
