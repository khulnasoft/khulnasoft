...
import __wasmUrl from './khulnasoft.wasm32-wasi.wasm?url';
...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__KhulnasoftJson_struct_38']?.();
  ...
  __napiInstance.exports['__napi_register__KhulnasoftWorkspaceFiles_struct_53']?.();
  __napiInstance.exports['__napi_register__KhulnasoftWorkspaceFilesExternals_struct_54']?.();
