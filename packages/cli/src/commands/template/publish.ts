...
import { KHULNASOFTConfig, configName, getConfigPath, loadConfig } from 'src/config'
...
async function templateAction(
  ...
  try {
    ...
    const templates: (Pick<KHULNASOFTConfig, 'template_id'> & {
      configPath?: string
    })[] = []
