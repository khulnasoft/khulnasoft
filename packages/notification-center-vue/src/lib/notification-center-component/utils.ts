...
import { getStyleByPath, getDefaultTheme, getDefaultBellColors } from '@khulnasoft/notification-center';
import type { NotificationCenterContentComponentProps } from '@khulnasoft/notification-center';
