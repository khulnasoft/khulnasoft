...
import { ButtonTypeEnum, IMessage, IMessageAction, IOrganizationEntity, ISubscriberJwt } from '@khulnasoft/shared';
import type { ApiService, IStoreQuery, IUserPreferenceSettings } from '@khulnasoft/client';
...
export interface IKhulnasoftProviderContext {
  backendUrl?: string;
  subscriberId?: string;
