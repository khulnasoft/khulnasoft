...
import { useKhulnasoftTheme, useFetchUserPreferences, useKhulnasoftContext, useNotificationCenter } from '../../../../hooks';
...
export function SubscriberPreference() {
  const { setFetchingStrategy } = useKhulnasoftContext();
  const { theme, common } = useKhulnasoftTheme();
