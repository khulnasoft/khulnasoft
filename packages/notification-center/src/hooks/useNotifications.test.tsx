...
import { KhulnasoftProvider } from '../components';
import { useNotifications } from './useNotifications';
import { queryClient } from '../components/khulnasoft-provider/KhulnasoftProvider';
...
jest.mock('@khulnasoft/client', () => ({
  ...jest.requireActual<typeof import('@khulnasoft/client')>('@khulnasoft/client'),
