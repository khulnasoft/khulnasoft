...
- **dashboard:** Multi environments management ([#7522](https://github.com/khulnasoft/texthive/pull/7522))
...
- **dashboard:** workflow editor error handling + sentry ([#6776](https://github.com/khulnasoft/texthive/pull/6776))
...
- **api:** Add Khulnasoft-managed Bridge endpoint per environment ([#6451](https://github.com/khulnasoft/texthive/pull/6451))
...
- **shared:** Remove all dependencies from @khulnasoft/shared ([#6891](https://github.com/khulnasoft/texthive/pull/6891))
