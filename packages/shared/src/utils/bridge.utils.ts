...
/**
 * This typing already lives in @khulnasoft/framework, but due to a circular dependency, we currently
 * need to duplicate it here.
 *
 * TODO: reconsider the dependency tree between @khulnasoft/shared and @khulnasoft/framework and move this
