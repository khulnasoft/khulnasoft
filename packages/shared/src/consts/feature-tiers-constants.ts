...
export enum FeatureNameEnum {
  ...
  PLATFORM_REMOVE_KHULNASOFT_BRANDING_BOOLEAN = 'platformRemoveKhulnasoftBrandingBoolean',
...
const khulnasoftServiceTiers: Record<FeatureNameEnum, Record<ApiServiceLevelEnum, FeatureValue>> = {
  ...
  [FeatureNameEnum.PLATFORM_REMOVE_KHULNASOFT_BRANDING_BOOLEAN]: {
    [ApiServiceLevelEnum.FREE]: 0,
    [ApiServiceLevelEnum.PRO]: 1,
    [ApiServiceLevelEnum.BUSINESS]: 1,
    [ApiServiceLevelEnum.ENTERPRISE]: 1,
...
export function getFeatureForTier(featureName: FeatureNameEnum, tier: ApiServiceLevelEnum): FeatureValue {
  const feature = khulnasoftServiceTiers[featureName][tier];
...
export function getFeatureForTierAsBoolean(featureName: FeatureNameEnum, tier: ApiServiceLevelEnum): boolean {
  const feature: FeatureValue = khulnasoftServiceTiers[featureName][tier];
...
export function getFeatureForTierAsNumber(
  ...
  const featureValue: FeatureValue = khulnasoftServiceTiers[featureName][tier];
