...
import { OrderDirectionEnum, TemplateVariableTypeEnum } from '@khulnasoft/shared';
...
describe('Khulnasoft Node.js package - Layouts class', () => {
  ...
  test('should create layout', async () => {
    ...
    const result = await khulnasoft.layouts.create({
      name,
      identifier,
      description,
      content,
  ...
  test('should delete layout', async () => {
    ...
    const result = await khulnasoft.layouts.delete(layoutId);
  ...
  test('should get layout by the id', async () => {
    ...
    const result = await khulnasoft.layouts.get(layoutId);
  ...
  test('should list layouts', async () => {
    ...
    const result = await khulnasoft.layouts.list({ page: 0 });
  ...
  test('should list layouts with selected pageSize', async () => {
    ...
    const result = await khulnasoft.layouts.list({ page: 0, pageSize });
  ...
  test('should list layouts with selected query params', async () => {
    ...
    const result = await khulnasoft.layouts.list({
      page: 0,
      pageSize,
  ...
  test('should set layout as default', async () => {
    ...
    const result = await khulnasoft.layouts.setDefault(layoutId);
  ...
  test('should update layout', async () => {
    ...
    const result = await khulnasoft.layouts.update(layoutId, {
      name: newName,
      description: newDescription,
      isDefault: newIsDefault,
    });
