...
describe('Khulnasoft Node.js package - Organizations class', () => {
  ...
  it('should list organizations', async () => {
    ...
    const result = await khulnasoft.organizations.list();
  ...
  it('should create new organization', async () => {
    ...
    const result = await khulnasoft.organizations.create(payload);
  ...
  it('should rename current organization', async () => {
    ...
    const result = await khulnasoft.organizations.rename(payload);
  ...
  it('should fetch current organization', async () => {
    ...
    const result = await khulnasoft.organizations.getCurrent();
  ...
  it('should remove member from current organization', async () => {
    ...
    const result = await khulnasoft.organizations.removeMember(mockedMember.id);
  ...
  it('should update member role in current organization', async () => {
    ...
    const result = await khulnasoft.organizations.updateMemberRole(
      mockedMember.id,
      payload,
    );
  ...
  it('should fetch all members of current organization', async () => {
    ...
    const result = await khulnasoft.organizations.getMembers();
  ...
  it('should update branding details of current organization', async () => {
    ...
    const result = await khulnasoft.organizations.updateBranding(payload);
