...
describe('Khulnasoft Node.js package - Topics class', () => {
  ...
  test('should create topic', async () => {
    ...
    const result = await khulnasoft.topics.create({
      key,
      name,
    });
  ...
  test('should rename topic', async () => {
    ...
    const result = await khulnasoft.topics.rename(key, name);
  ...
  test('should delete topic by the key', async () => {
    ...
    const result = await khulnasoft.topics.delete(key);
  ...
  test('should get topic by the key', async () => {
    ...
    const result = await khulnasoft.topics.get(key);
  ...
  test('should get topic subscriber by the external subscriber ID', async () => {
    ...
    const result = await khulnasoft.topics.getSubscriber(
      topicKey,
      externalSubscriberId,
    );
  ...
  test('should list topics', async () => {
    ...
    const result = await khulnasoft.topics.list({ page: 0 });
  ...
  test('should list topics with selected pageSize', async () => {
    ...
    const result = await khulnasoft.topics.list({ page: 0, pageSize });
  ...
  test('should add subscribers', async () => {
    ...
    const result = await khulnasoft.topics.addSubscribers(topicId, { subscribers });
  ...
  test('should remove subscribers', async () => {
    ...
    const result = await khulnasoft.topics.removeSubscribers(topicId, {
      subscribers,
    });
