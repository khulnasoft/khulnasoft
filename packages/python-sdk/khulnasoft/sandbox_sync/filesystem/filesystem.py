...
import khulnasoft_connect
import httpcore
import httpx
from packaging.version import Version

from khulnasoft.envd.versions import ENVD_VERSION_RECURSIVE_WATCH
from khulnasoft.exceptions import TemplateException
...
from khulnasoft.envd.api import ENVD_API_FILES_ROUTE, handle_envd_api_exception
...
from khulnasoft.sandbox_sync.filesystem.watch_handle import WatchHandle
...
class Filesystem:
    ...
    def exists(
        ...
        try:
            ...
            if isinstance(e, khulnasoft_connect.ConnectException):
                if e.status == khulnasoft_connect.Code.not_found:
                    return False
            raise handle_rpc_exception(e)
    ...
    def make_dir(
        ...
        try:
            ...
            if isinstance(e, khulnasoft_connect.ConnectException):
                if e.status == khulnasoft_connect.Code.already_exists:
                    return False
            raise handle_rpc_exception(e)
