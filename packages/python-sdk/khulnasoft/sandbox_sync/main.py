...
from khulnasoft.envd.api import ENVD_API_HEALTH_ROUTE, handle_envd_api_exception
from khulnasoft.exceptions import SandboxException, format_request_timeout_error
from khulnasoft.sandbox.main import SandboxSetup
from khulnasoft.sandbox.utils import class_method_variant
from khulnasoft.sandbox_sync.filesystem.filesystem import Filesystem
from khulnasoft.sandbox_sync.commands.command import Commands
from khulnasoft.sandbox_sync.commands.pty import Pty
from khulnasoft.sandbox_sync.sandbox_api import SandboxApi
...
class Sandbox(SandboxSetup, SandboxApi):
    ...
    Check docs [here](https://khulnasoft.com/docs).
    ...
    def __init__(
        ...
        :param api_key: KHULNASOFT API Key to use for authentication, defaults to `KHULNASOFT_API_KEY` environment variable
