...
class ConnectionConfig:
    ...
    @staticmethod
    def _domain():
        return os.getenv("KHULNASOFT_DOMAIN", "khulnasoft.com")

    @staticmethod
    def _debug():
        return os.getenv("KHULNASOFT_DEBUG", "false").lower() == "true"

    @staticmethod
    def _api_key():
        return os.getenv("KHULNASOFT_API_KEY")

    @staticmethod
    def _access_token():
        return os.getenv("KHULNASOFT_ACCESS_TOKEN")
