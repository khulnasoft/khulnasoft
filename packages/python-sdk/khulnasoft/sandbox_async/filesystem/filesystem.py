...
import khulnasoft_connect as connect
from khulnasoft.connection_config import (
    ConnectionConfig,
    Username,
    KEEPALIVE_PING_HEADER,
    KEEPALIVE_PING_INTERVAL_SEC,
)
from khulnasoft.envd.api import ENVD_API_FILES_ROUTE, ahandle_envd_api_exception
from khulnasoft.envd.filesystem import filesystem_connect, filesystem_pb2
from khulnasoft.envd.rpc import authentication_header, handle_rpc_exception
from khulnasoft.envd.versions import ENVD_VERSION_RECURSIVE_WATCH
from khulnasoft.exceptions import SandboxException, TemplateException
from khulnasoft.sandbox.filesystem.filesystem import EntryInfo, map_file_type
from khulnasoft.sandbox.filesystem.watch_handle import FilesystemEvent
from khulnasoft.sandbox_async.filesystem.watch_handle import AsyncWatchHandle
from khulnasoft.sandbox_async.utils import OutputHandler
...
class Filesystem:
    ...
    def __init__(
        ...
        self._rpc = filesystem_connect.FilesystemClient(
            ...
            # compressor=khulnasoft_connect.GzipCompressor,
            async_pool=pool,
            json=True,
        )
    ...
    async def watch_dir(
        ...
        if (
            ...
            raise TemplateException(
                ...
                "You can do this by running `khulnasoft template build` in the directory with the template."
            )
