...
describe('workflow function', () => {
  ...
  describe('trigger', () => {
    ...
    afterEach(() => {
      delete process.env.KHULNASOFT_SECRET_KEY;
    });
    ...
    it('should throw an error when the KHULNASOFT_SECRET_KEY is not set', async () => {
      const originalEnv = process.env.KHULNASOFT_SECRET_KEY;
      delete process.env.KHULNASOFT_SECRET_KEY;
      ...
      process.env.KHULNASOFT_SECRET_KEY = originalEnv;
    });
      ...
      expect(fetchMock).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          ...
          headers: {
            ...
            Authorization: `ApiKey ${process.env.KHULNASOFT_SECRET_KEY}`,
          },
          method: 'POST',
        })
      );
