 ...
 * Example:
 *
 * import { serve, Client, type Workflow } from '@khulnasoft/framework/next';
 *
 * instead of
 *
...
/**
 * In Next.js, serve and register any declared workflows with Khulnasoft, making
...
export const serve = (
   ...
   */
  const baseHandler = khulnasoftHandler.createHandler();
