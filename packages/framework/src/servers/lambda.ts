 ...
 * Example:
 *
 * import { serve, Client, type Workflow } from '@khulnasoft/framework/lambda';
 *
 * instead of
 *
 * import { serve } from '@khulnasoft/framework/lambda';
...
/**
 * With AWS Lambda, serve and register any declared workflows with Khulnasoft,
