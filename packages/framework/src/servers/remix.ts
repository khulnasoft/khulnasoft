 ...
 * Example:
 *
 * import { serve, Client, type Workflow } from '@khulnasoft/framework/remix';
 *
 * instead of
 *
 * import { serve } from '@khulnasoft/framework/remix';
...
/**
 * In Remix, serve and register any declared workflows with Khulnasoft, making them
