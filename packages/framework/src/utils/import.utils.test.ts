  ...
  describe('checkDependencies', () => {
    ...
    it('should throw an error if a single dependency is not installed', async () => {
      await expect(
        ...
        'Tried to use a test schema in @khulnasoft/framework without missing-random-dependency installed. Please install it by running `npm install missing-random-dependency`.'
      );
    });
    ...
    it('should throw an error if multiple dependencies are not installed', async () => {
      await expect(
        ...
        'Tried to use a test schema in @khulnasoft/framework without missing-random-dependency-1, missing-random-dependency-2 installed. Please install them by running `npm install missing-random-dependency-1 missing-random-dependency-2`.'
      );
    });
