...
export class SignatureMismatchError extends UnauthorizedError {
  ...
  constructor() {
    super(
      `Signature does not match the expected signature. Please ensure the signature provided in the \`${HttpHeaderKeysEnum.KHULNASOFT_SIGNATURE}\` header is correct and try again.`
    );
  }
}
...
export class SignatureNotFoundError extends UnauthorizedError {
  ...
  constructor() {
    super(
      `Signature not found. Please provide a signature in the \`${HttpHeaderKeysEnum.KHULNASOFT_SIGNATURE}\` header`
    );
  }
}
...
export class SignatureInvalidError extends UnauthorizedError {
  ...
  constructor() {
    super(
      `Signature is invalid. Please provide a valid signature in the \`${HttpHeaderKeysEnum.KHULNASOFT_SIGNATURE}\` header`
    );
  }
}
...
export class SignatureExpiredError extends UnauthorizedError {
  ...
  constructor() {
    super(
      `Signature expired. Please provide a signature with a timestamp no older than ${SIGNATURE_TIMESTAMP_TOLERANCE_MINUTES} minutes in the \`${HttpHeaderKeysEnum.KHULNASOFT_SIGNATURE}\` header`
    );
  }
}
...
export class SignatureVersionInvalidError extends UnauthorizedError {
  ...
  constructor() {
    super(
      `Signature version is invalid. Please provide a signature version with version \`v1\` in the \`${HttpHeaderKeysEnum.KHULNASOFT_SIGNATURE}\` header`
    );
  }
}
