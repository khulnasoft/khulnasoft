...
export function Sidebar({ onGenerate }: SidebarProps) {
  ...
  return (
    <aside className="w-80 overflow-auto bg-gray-100 p-6 dark:bg-gray-800">
      <h2 className="mb-4 text-xl font-semibold dark:text-gray-200">Settings</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <Label className="dark:text-gray-300">Date Range</Label>
          <div className="pr-[10px]">
            {' '}
            {/* Add 1px padding to prevent touching right margin */}
        ...
        <div className="flex items-center space-x-2">
          ...
          <Label htmlFor="fetch-diffs" className="dark:text-gray-300">
            Fetch Diffs
          </Label>
        </div>
