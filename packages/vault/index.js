...
window.__khulnasoft__cache__ = window.__khulnasoft__cache__ || {}
...
function createVault (host) {
  if (window.__khulnasoft__cache__[host]) {
    return window.__khulnasoft__cache__[host]
  }
...
function createElementId () {
  return 'khulnasoft-vault-' + Math.random().toString(36).slice(2)
}
