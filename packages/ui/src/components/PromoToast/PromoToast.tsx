...
const LW11BGDark =
  'https://obuldanrptloktxcffvn.khulnasoft.co/storage/v1/object/public/images/lw11/assets/backgrounds/regular/001.png'
const LW11BGLight =
  'https://obuldanrptloktxcffvn.khulnasoft.co/storage/v1/object/public/images/lw11/assets/backgrounds/platinum/001.png'
    ...
    >
      ...
      <div className="relative z-10 flex items-center space-x-2">
        <Button asChild type="secondary">
          <Link target="_blank" rel="noreferrer" href="https://khulnasoft.com/ga-week#day-4">
            Learn more
          </Link>
        </Button>
