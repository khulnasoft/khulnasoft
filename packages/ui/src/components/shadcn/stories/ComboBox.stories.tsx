...
export const ComboOrgPicker = {
  ...
  render: ({}) => {
    ...
    const orgs: Status[] = [
      ...
      {
        value: 'khulnasoftlabz',
        label: 'Khulnasoft Labs',
        icon: ArrowUpCircle,
      },
      {
        value: 'khulnasoftdemos',
        label: 'Khulnasoft Demos',
        icon: CheckCircle2,
      },
    ]
...
export const MultipleComboPickers = {
  ...
  render: ({}) => {
    ...
    const projects: Status[] = [
      ...
      {
        value: 'khulnasoft-studio-staging',
        icon: CheckCircle2,
        label: 'khulnasoft-studio-staging',
      },
      {
        value: 'app.khulnasoft.green',
        icon: CheckCircle2,
        label: 'app.khulnasoft.green',
      },
      {
      ...
      {
        value: 'khulnasoft.green',
        icon: CheckCircle2,
        label: 'khulnasoft.green',
      },
      {
        value: 'app.khulnasoft.com',
        icon: CheckCircle2,
        label: 'app.khulnasoft.com',
      },
      {
        value: 'khulnasoft-studio.vercel.app',
        icon: CheckCircle2,
        label: 'khulnasoft-studio.vercel.app',
      },
    ]
