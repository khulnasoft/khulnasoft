...
Khulnasoft is migrating to use tailwind classes that use CSS properties.
...
We (the Khulnasoft Design team ✨) define primitive color values using Figma Variables.
