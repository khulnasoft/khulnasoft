...
import type { KhulnasoftEventEmitter } from '../event-emitter';
...
export const read = async ({
  ...
  try {
    ...
    return { error: new KhulnasoftError('Failed to read notification', error) };
  }
};
...
export const unread = async ({
  ...
  try {
    ...
    return { error: new KhulnasoftError('Failed to unread notification', error) };
  }
};
...
export const archive = async ({
  ...
  try {
    ...
    return { error: new KhulnasoftError('Failed to archive notification', error) };
  }
};
...
export const unarchive = async ({
  ...
  try {
    ...
    return { error: new KhulnasoftError('Failed to unarchive notification', error) };
  }
};
...
export const completeAction = async ({
  ...
  try {
    ...
    return { error: new KhulnasoftError(`Failed to complete ${actionType} action on the notification`, error) };
  }
};
...
export const revertAction = async ({
  ...
  try {
    ...
    return { error: new KhulnasoftError('Failed to fetch notifications', error) };
  }
};
...
export const readAll = async ({
  ...
  try {
    ...
    return { error: new KhulnasoftError('Failed to read all notifications', error) };
  }
};
...
export const archiveAll = async ({
  ...
  try {
    ...
    return { error: new KhulnasoftError('Failed to archive all notifications', error) };
  }
};
...
export const archiveAllRead = async ({
  ...
  try {
    ...
    return { error: new KhulnasoftError('Failed to archive all read notifications', error) };
  }
};
