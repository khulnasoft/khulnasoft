...
import { EventHandler, EventNames, Events, KhulnasoftEventEmitter } from '../event-emitter';
...
export class Notification implements Pick<KhulnasoftEventEmitter, 'on'>, InboxNotification {
  ...
  constructor(notification: InboxNotification, emitter: KhulnasoftEventEmitter, inboxService: InboxService) {
