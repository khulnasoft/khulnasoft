...
export interface components {
  schemas: {
    ...
    ResourceProvisioningConfigResponse: {
       ...
       * @example postgres://postgres.abcdefghijklmnop:dbpass@aws-0-us-east-1.pooler.khuknasoft.com:6543/postgres
       */
    ...
    V1CreateProjectBody: {
       ...
       * @example https://github.com/khulnasoft/khulnasoft/tree/master/examples/slack-clone/nextjs-slack-clone
       */
      template_url?: string
    }
    V1DatabaseResponse: {
