...
const CommandMenu = () => {
  ...
  // This function has been added to prevent the use of double quotes in the search docs input due to an issue with the cmdk-khulnasoft module. This function can be removed when we transition to using cmdk.
                ...
                <CommandGroup heading="Projects">
                  {sharedItems.projectTools.map((item) => (
                    <CommandItem
                      ...
                      type="link"
                      onSelect={() =>
                        window.open(`https://khulnasoft.com/dashboard${item.url}`, '_blank')
                      }
                    >
                      <IconArrowRight className="text-foreground-muted" />
                      <CommandLabel>
              ...
              {site === 'studio' && (
                <CommandGroup heading="Experimental">
                  ...
                  >
                    ...
                    <CommandLabel>Generate SQL with Khulnasoft AI</CommandLabel>
                  </CommandItem>
                </CommandGroup>
              )}
