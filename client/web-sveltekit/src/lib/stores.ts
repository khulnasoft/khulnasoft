...
export interface KhulnasoftContext {
...
export function setAppContext(context: KhulnasoftContext): void {
    setContext<KhulnasoftContext>(KEY, context)
}

export function getStores(): KhulnasoftContext {
    return getContext<KhulnasoftContext>(KEY)
}
