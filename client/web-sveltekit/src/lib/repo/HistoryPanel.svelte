...
<script lang="ts">
    ...
    import { KhulnasoftURL } from '$lib/common'
    ...
    $: closeURL = KhulnasoftURL.from($page.url).deleteSearchParameter('rev', 'diff').toString()
</script>
                            ...
                            <Tooltip tooltip="Browse files at commit">
                                <a
                                    href={replaceRevisionInURL(
                                        KhulnasoftURL.from($page.url).deleteSearchParameter('rev', 'diff').toString(),
                                        commit.oid
