...
// This needs to be set to the path where the Khulnasoft backend
...
if (process.env.BAZEL || process.env.DEPLOY_TYPE === 'dev') {
  // Setup to use when seving the app from the Khulnasoft backend
  ...
  // This template includes Go template syntax and is used by the Khulnasoft
 ...
 * to work properly with the Khulnasoft backend.
 *
 * Longer explanation:
 *
 ...
 * Khulnasoft backend, which is /.assets/_sk/_app.
