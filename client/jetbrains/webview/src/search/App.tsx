...
import { initializeKhulnasoftSettings } from '../sourcegraphSettings'
...
export const App: React.FunctionComponent<React.PropsWithChildren<Props>> = ({
        ...
        args =>
            requestGraphQLCommon({
                ...
                headers: {
                    ...
                    'X-Khulnasoft-Should-Trace': new URLSearchParams(window.location.search).get('trace') || 'false',
    ...
    const settingsCascade: SettingsCascadeOrError =
        useObservable(useMemo(() => initializeKhulnasoftSettings(requestGraphQL).settings, [requestGraphQL])) ||
