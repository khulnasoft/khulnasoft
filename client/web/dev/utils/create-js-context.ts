...
import type { KhulnasoftContext } from '../../src/jscontext'
...
export const createJsContext = ({ sourcegraphBaseUrl }: { sourcegraphBaseUrl: string }): KhulnasoftContext => {
    ...
    const jsContext: KhulnasoftContext = {
        currentUser: null,
