...
export interface CreateGitHubAppPageProps extends TelemetryV2Props {
    ...
    /** The domain the new GitHub App is meant to be used for in Khulnasoft. */
    ...
    /** The name to use for the new GitHub App. Defaults to "Khulnasoft". */
        ...
        <>
            ...
            <Container className="mb-3">
                ...
                <Text>
                    ...
                    be redirected back here to finish connecting it to Khulnasoft.
                </Text>
