            ...
            <HeroPage
                ...
                subtitle={
                    <div className="container">
                        <Text>A new version of Khulnasoft is available.</Text>
    ...
    return (
        <HeroPage
            ...
            subtitle={
                <div className="container">
                    <Text>
                        Khulnasoft encountered an unexpected error. If reloading the page doesn't fix it, contact your
                        site admin or Khulnasoft support.
                    </Text>
                    <Text>
