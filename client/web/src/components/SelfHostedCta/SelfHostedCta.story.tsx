...
export const Basic: React.FunctionComponent<React.PropsWithChildren<Partial<SelfHostedCtaProps>>> = (
    ...
    >
        <Text className="mb-2">
            <strong>Run Khulnasoft self-hosted for more enterprise features</strong>
        </Text>
        <Text className="mb-2">
            For team oriented functionality, additional code hosts and enterprise only features, install Khulnasoft
            self-hosted.
        </Text>
    </SelfHostedCta>
)
