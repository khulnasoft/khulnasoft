...
const ExternalServicesPrivacyAlert: FC<ExternalServicesPrivacyAlertProps> = ({ dismissPrivacyWarning }) => (
    <Alert variant="info">
        <Text>
            This Khulnasoft installation will never send your code, repository names, file names, or any other specific
            code data to Khulnasoft.com or any other destination. Your code is kept private on this installation.
        </Text>
        <Text>
