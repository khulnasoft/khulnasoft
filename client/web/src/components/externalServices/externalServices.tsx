...
const editorActionComments = {
    enablePermissions:
        '// Prerequisite: you must configure GitHub as an OAuth auth provider in the site config (https://khulnasoft.com/docs/admin/auth#github). Otherwise, access to all repositories will be disallowed.',
    enforcePermissionsOAuth: `// Prerequisite: you must first update the site configuration to
      ...
      // See https://khulnasoft.com/docs/admin/auth#gitlab for instructions.`,
    enforcePermissionsSSO: `// Prerequisite: You need a sudo-level access token. If you can configure
    // GitLab as an OAuth identity provider for Khulnasoft, we recommend that
    // option instead.
    //
    ...
    //    (https://khulnasoft.com/docs/admin/auth).
    // 3. Update the fields below to match the properties of this auth provider
    //    (https://khulnasoft.com/docs/admin/permissions).`,
}
...
const GitHubInstructions: React.FunctionComponent<{ isEnterprise: boolean }> = ({ isEnterprise }) => (
    <div>
        <ol>
            ...
            <li>
                Specify which repositories Khulnasoft should index using one of the following fields:
                <ul>
                    <li>
    ...
    Instructions: () => (
        <div>
            <ol>
                ...
                <li>
                    Set the <Field>teams</Field> field to be the list of teams whose repositories Khulnasoft should
                    index.
                </li>
            </ol>
            <Text>
    ...
    Instructions: () => (
        <div>
            <ol>
                ...
                <li>
                    Specify which repositories Khulnasoft should clone using the following fields.
                    <ul>
                        <li>
...
const SRC_SERVE_GIT: AddExternalServiceOptions = {
    ...
    title: 'Khulnasoft CLI Serve-Git',
    icon: GitIcon,
  ...
  // Do not change this. Khulnasoft uses this as a signal that url is 'src serve'.
  "repos": ["src-serve"]
}`,
    Instructions: () => (
        <div>
    ...
    editorActions: [
        {
            id: 'setURL',
            label: 'Khulnasoft in Docker and src serve-git running on host',
            run: (config: string) => {
    ...
    Instructions: () => (
        <div>
            <ol>
                ...
                <li>
                    Set the <Field>prefix</Field> field to the prefix you desire for the repository names on Khulnasoft.
...
const PHABRICATOR_SERVICE: AddExternalServiceOptions = {
    ...
    shortDescription:
        'Associate Phabricator repositories with existing repositories on Khulnasoft. Mirroring is not supported.',
  ...
  // https://khulnasoft.com/docs/admin/code_hosts/phabricator#configuration
        ...
        },
        {
            ...
            run: (config: string) => {
                const value = {
                    ...
                    path: '<Khulnasoft repository full name>',
                }
                const edits = modify(config, ['repos', -1], value, defaultModificationOptions)
  ...
  "maven": {
    ...
    Instructions: () => (
        <div>
            ...
            <Text>⚠️ JVM dependency repositories are visible by all users of the Khulnasoft instance.</Text>
            <Text>⚠️ It is only possible to register one JVM dependency code host per Khulnasoft instance.</Text>
        </div>
    ),
    editorActions: [],
}
  ...
  "dependencies": []
    ...
    Instructions: () => (
        <div>
            ...
            <Text>⚠️ npm package repositories are visible by all users of the Khulnasoft instance.</Text>
            <Text>⚠️ It is only possible to register one npm package code host per Khulnasoft instance.</Text>
        </div>
    ),
    editorActions: [],
}
  ...
  "dependencies": []
    ...
    Instructions: () => (
        <div>
            ...
            <Text>⚠️ go module repositories are visible by all users of the Khulnasoft instance.</Text>
            <Text>⚠️ It is only possible to register one go modules code host per Khulnasoft instance.</Text>
        </div>
    ),
    editorActions: [],
}
  ...
  "dependencies": []
    ...
    Instructions: () => (
        <div>
            ...
            <Text>⚠️ Python package repositories are visible by all users of the Khulnasoft instance.</Text>
            <Text>⚠️ It is only possible to register one Python packages code host per Khulnasoft instance.</Text>
        </div>
    ),
    editorActions: [],
}
  ...
  "dependencies": []
    ...
    Instructions: () => (
        <div>
            ...
            <Text>⚠️ Rust package repositories are visible by all users of the Khulnasoft instance.</Text>
            <Text>⚠️ It is only possible to register one Rust packages code host per Khulnasoft instance.</Text>
        </div>
    ),
    editorActions: [],
}
  ...
  "dependencies": ["shopify_api@12.0.0"]
    ...
    Instructions: () => (
        <div>
            ...
            <Text>⚠️ Ruby package repositories are visible by all users of the Khulnasoft instance.</Text>
            <Text>⚠️ It is only possible to register one Ruby packages code host per Khulnasoft instance.</Text>
        </div>
    ),
    editorActions: [],
}
