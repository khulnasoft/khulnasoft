...
export const SURVEY_QUESTIONS: Record<'otherUseCase' | 'better' | 'reason', string> = {
    otherUseCase: 'What do you use Khulnasoft for?',
    better: 'How can we make Khulnasoft better?',
    reason: 'What is the most important reason for the score you gave Khulnasoft?',
}
