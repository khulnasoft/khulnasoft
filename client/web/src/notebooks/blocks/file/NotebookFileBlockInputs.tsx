...
> = ({ id, lineRange, onFileSelected, onLineRangeChange, isKhulnasoftDotCom, patternType, ...inputProps }) => {
        ...
        <div className={styles.fileBlockInputs}>
            <div className="text-muted mb-2">
                <small>
                    ...
                    Khulnasoft file URL, select the block, and paste the URL ({isMacPlatform ? '⌘' : 'Ctrl'} + v).
                </small>
            </div>
            <SearchTypeSuggestionsInput<PathMatch>
                id={id}
                label="Find a file using a Khulnasoft search query"
