...
function getSelectedShareOptionDescription(shareOption: ShareOption, isKhulnasoftDotCom: boolean): string {
    if (shareOption.namespaceType === 'User') {
        const withAccess = isKhulnasoftDotCom ? 'on Khulnasoft.com' : 'with access to the Khulnasoft instance'
...
export const ShareNotebookModal: React.FunctionComponent<React.PropsWithChildren<ShareNotebookModalProps>> = ({
    ...
    const description = useMemo(
        () => getSelectedShareOptionDescription(selectedShareOption, isKhulnasoftDotCom),
        [selectedShareOption, isKhulnasoftDotCom]
    )
            ...
            <div className={classNames('mb-2', styles.body)}>
                ...
                {selectedShareOption.namespaceType === 'Org' && (
                    <Checkbox
                        ...
                        label={`Everyone ${
                            isKhulnasoftDotCom ? 'on Khulnasoft.com' : 'with access to the Khulnasoft instance'
