                                ...
                                parents: [
                                    {
                                        ...
                                        perforceChangelist: null,
                                        url: '/github.com/khulnasoft/khulnasoft/-/commit/59ce236cca392975a383cdab14d73244f05d21b6',
                                        __typename: 'GitCommit',
                                    },
                                ],
                                url: '/github.com/khulnasoft/khulnasoft/-/commit/b1e1ec16e2c2d932cf230c71c760516fb9658cdb',
                                canonicalURL:
                                    '/github.com/khulnasoft/khulnasoft/-/commit/b1e1ec16e2c2d932cf230c71c760516fb9658cdb',
                                externalURLs: [
                                    {
                                        url: 'https://github.com/khulnasoft/khulnasoft/commit/b1e1ec16e2c2d932cf230c71c760516fb9658cdb',
                                        serviceKind: ExternalServiceKind.GITHUB,
                                        __typename: 'ExternalLink',
                                    },
                                ],
...
export const GitCommitsStory: StoryFn<RepositoryCommitsPageProps> = () => (
    <MockedTestProvider>
        <WebStory
            initialEntries={['/github.com/khulnasoft/khulnasoft/-/commits']}
...
export const GitCommitsInPathStory: StoryFn<RepositoryCommitsPageProps> = () => (
    <MockedTestProvider>
        <WebStory
            initialEntries={['/github.com/khulnasoft/khulnasoft/-/commits/somePath']}
            mocks={[mockRepositoryGitCommitsQuery]}
        >
            {props => <RepositoryCommitsPage revision="" repo={gitRepo} {...props} />}
        </WebStory>
