        ...
        <HeroPage
            ...
            subtitle={
                <div className={styles.repositoryNotFoundPage}>
                    {viewerCanAdminister && (
                        <Text>
                            As a site admin, you can add <Code>{repo}</Code> to Khulnasoft to allow users to search and
                            view it by <Link to="/site-admin/external-services">connecting an external service</Link>{' '}
                            referencing it.
                        </Text>
                    )}
                    {!viewerCanAdminister && <Text>To access this repository, contact the Khulnasoft admin.</Text>}
                </div>
            }
        />
    )
