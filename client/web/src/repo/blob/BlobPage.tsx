...
import { asError, basename, isErrorLike, KhulnasoftURL, type ErrorLike } from '@sourcegraph/common'
import {
    createActiveSpan,
    reactManualTracer,
    TraceSpanProvider,
...
interface BlobPageProps
    ...
    className?: string
    context: Pick<KhulnasoftContext, 'externalURL'>
}
...
export const BlobPage: React.FunctionComponent<BlobPageProps> = ({ className, context, ...props }) => {
    ...
    const { lineRange: lineOrRange, viewState } = useMemo(() => KhulnasoftURL.from(location), [location])
    ...
    // Prevents https://github.com/khulnasoft/khulnasoft/issues/14965 by not allowing
                    ...
                    subtitle={
                        <div>
                            <Text className={styles.lfsText}>
                                This file is stored in Git Large File Storage and cannot be viewed inside Khulnasoft.
                            </Text>
