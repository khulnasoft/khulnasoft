export const content = [
    ...
    },
    {
        ...
        description: 'Must be set in order for Khulnasoft to work correctly.',
    ...
    },
    {
        ...
        description: 'You must connect a code host to set up user authentication and use Khulnasoft.',
