...
describe('Repository', () => {
    ...
    describe('index page', () => {
        it('loads when accessed with a repo url', async () => {
            ...
            const repositoryKhulnasoftUrl = `/${repositoryName}`
            const commitUrl = `${repositoryKhulnasoftUrl}/-/commit/15c2290dcb37731cc4ee5a2a1c1e5a25b4c28f81?first=1`
            ...
            testContext.overrideGraphQL({
                ...commonWebGraphQlResults,
                ...getCommonRepositoryGraphQlResults(repositoryName, repositoryKhulnasoftUrl, fileEntries),
                FileCommits: () => ({
                    repository: {
            ...
            await driver.assertWindowLocation(repositoryKhulnasoftUrl)
        ...
        it('works with files with spaces in the name', async () => {
            ...
            testContext.overrideGraphQL({
                ...commonWebGraphQlResults,
                ...getCommonRepositoryGraphQlResults(repositoryName, repositoryKhulnasoftUrl),
        ...
        it('works with a plus sign in the repository name', async () => {
            ...
            const repositoryName = `github.com/${shortRepositoryName}`
            const repositoryKhulnasoftUrl = `/${shortRepositoryName}`

            testContext.overrideGraphQL({
                ...commonWebGraphQlResults,
                ...getCommonRepositoryGraphQlResults(repositoryName, repositoryKhulnasoftUrl, ['readme.md']),
            })

            await driver.page.goto(driver.sourcegraphBaseUrl + repositoryKhulnasoftUrl)
        ...
        it('works with spaces in the repository name', async () => {
            ...
            const repositoryName = `github.com/${shortRepositoryName}`
            const repositoryKhulnasoftUrl = '/github.com/my%20org/repo%20with%20spaces'
    ...
    describe('commits page', () => {
        it('loads commits of a repository', async () => {
                                        ...
                                        parents: [
                                            {
                                                ...
                                                perforceChangelist: null,
                                                url: '/github.com/khulnasoft/khulnasoft/-/commit/a2d1fd474d79dc29af6c7b4c33f02fe22287bd11',
                                            },
                                        ],
                                        url: '/github.com/khulnasoft/khulnasoft/-/commit/284aba024b1b558590e8e2f97dbc3553a5e0c76b',
                                        canonicalURL:
                                            '/github.com/khulnasoft/khulnasoft/-/commit/284aba024b1b558590e8e2f97dbc3553a5e0c76b',
                                        externalURLs: [
                                            {
                                                url: 'https://github.com/khulnasoft/khulnasoft/commit/284aba024b1b558590e8e2f97dbc3553a5e0c76b',
                                                serviceKind: ExternalServiceKind.GITHUB,
                                            },
                                        ],
                                        tree: {
                                        ...
                                        parents: [
                                            {
                                                ...
                                                perforceChangelist: null,
                                                url: '/github.com/khulnasoft/khulnasoft/-/commit/3a163b92b5c45921fbc730ff2047ff7e60d8689b',
                                            },
                                        ],
                                        url: '/github.com/khulnasoft/khulnasoft/-/commit/a2d1fd474d79dc29af6c7b4c33f02fe22287bd11',
                                        canonicalURL:
                                            '/github.com/khulnasoft/khulnasoft/-/commit/a2d1fd474d79dc29af6c7b4c33f02fe22287bd11',
                                        externalURLs: [
                                            {
                                                url: 'https://github.com/khulnasoft/khulnasoft/commit/a2d1fd474d79dc29af6c7b4c33f02fe22287bd11',
                                                serviceKind: ExternalServiceKind.GITHUB,
                                            },
                                        ],
                                        tree: {
                                        ...
                                        parents: [
                                            {
                                                ...
                                                perforceChangelist: null,
                                                url: '/github.com/khulnasoft/khulnasoft/-/commit/e2e91f0dcdc90811c4f2f4df638bc459b2358e7d',
                                            },
                                        ],
                                        url: '/github.com/khulnasoft/khulnasoft/-/commit/3a163b92b5c45921fbc730ff2047ff7e60d8689b',
                                        canonicalURL:
                                            '/github.com/khulnasoft/khulnasoft/-/commit/3a163b92b5c45921fbc730ff2047ff7e60d8689b',
                                        externalURLs: [
                                            {
                                                url: 'https://github.com/khulnasoft/khulnasoft/commit/3a163b92b5c45921fbc730ff2047ff7e60d8689b',
                                                serviceKind: ExternalServiceKind.GITHUB,
                                            },
                                        ],
                                        tree: {
            ...
            await driver.page.goto(driver.sourcegraphBaseUrl + '/github.com/khulnasoft/khulnasoft/-/commits')
    ...
    describe('Accessibility', () => {
        ...
        describe('Contributors page', () => {
            const repositoryKhulnasoftUrl = `/${repositoryName}/-/stats/contributors`
        ...
        describe('Branches page', () => {
            it('should render correctly branches', async () => {
                const repositoryKhulnasoftUrl = `/${repositoryName}/-/branches`
                testContext.overrideGraphQL({
                    ...commonWebGraphQlResults,
                    ...getCommonRepositoryGraphQlResults(repositoryName, repositoryKhulnasoftUrl, []),
        ...
        describe('Tags page', () => {
            const repositoryKhulnasoftUrl = `/${repositoryName}/-/tags`
        ...
        describe('Compare page', () => {
            const repositoryKhulnasoftUrl = `/${repositoryName}/-/compare/main...bl/readme`
