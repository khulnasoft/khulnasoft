...
/**
 * Does a GraphQL request to the Khulnasoft GraphQL API running under `/.api/graphql`
...
/**
 * Does a GraphQL query to the Khulnasoft GraphQL API running under `/.api/graphql`
...
/**
 * Does a GraphQL mutation to the Khulnasoft GraphQL API running under `/.api/graphql`
