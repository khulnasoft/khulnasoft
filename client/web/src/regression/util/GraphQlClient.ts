...
export interface GraphQLClient {
    /**
     * mimics the `mutateGraphQL` function used by the Khulnasoft backend, but substitutes
    ...
    /**
     * mimics the `queryGraphQL` function used by the Khulnasoft backend, but substitutes
     * in CLI-read HTTP headers rather than use the ones in the browser context (which doesn't
     * exist).
     */
