            ...
            <Form className="mt-4" onSubmit={onSubmit}>
                ...
                <div className="form-group row">
                    <Label htmlFor="repoMetadata" className="col-4 col-form-label">
                        Repository metadata
                        <Tooltip content="Match repositories that have a metadata key / value pair {key:value}. Metadata is a Khulnasoft entity that provides key:value mappings to repositories.">
                            <Icon
                                aria-label="hover icon for help tooltip"
                                className="ml-2"
                                svgPath={mdiHelpCircleOutline}
                ...
                <div className="form-group row">
                    <Label htmlFor="searchContext" className="col-4 col-form-label">
                        Search context
                        <Tooltip content="Only match files inside a search context. A search context is a Khulnasoft entity to provide shareable and repeatable filters, such as common sets of repositories. The global context  will search over all code on Khulnasoft.">
                            <Icon
                                aria-label="hover icon for help tooltip"
                                className="ml-2"
                                svgPath={mdiHelpCircleOutline}
