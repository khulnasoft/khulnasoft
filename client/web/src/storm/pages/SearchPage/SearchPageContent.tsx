...
export const SearchPageContent: FC<SearchPageContentProps> = props => {
    ...
    const { telemetryService, selectedSearchContextSpec, isKhulnasoftDotCom, authenticatedUser, platformContext } =
    ...
    const showOnboardingTour = useShowOnboardingTour({ authenticatedUser, isKhulnasoftDotCom })
        ...
        <div className={classNames('d-flex flex-column align-items-center px-3', styles.searchPage)}>
            ...
            <div className={styles.searchContainer}>
                ...
                {shouldShowAddCodeHostWidget ? (
                    <>
                        <Tooltip
                            content="Khulnasoft is not fully functional until a code host is set up"
                            placement="top"
                        >
            ...
            {(!simpleSearchEnabled || !simpleSearch) && (
                <div className={classNames(styles.panelsContainer)}>
                    {(!!authenticatedUser || isKhulnasoftDotCom) && (
                        <QueryExamples
