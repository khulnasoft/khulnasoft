...
import type { DynamicKhulnasoftWebAppContext, StaticKhulnasoftWebAppContext } from './KhulnasoftWebApp'
 ...
 * 2. StaticKhulnasoftWebAppContext — injected by the `KhulnasoftWebApp` component.
 * 3. DynamicKhulnasoftWebAppContext — injected by the `KhulnasoftWebApp` component.
 * 4. StaticLegacyRouteContext — injected by the `StaticLegacyRouteContext` component
 *
 * All these fields are static except for `DynamicKhulnasoftWebAppContext`.
 */
export interface LegacyLayoutRouteContext
    extends StaticAppConfig,
        StaticKhulnasoftWebAppContext,
        DynamicKhulnasoftWebAppContext,
...
export interface LegacyRouteContextProviderProps {
    context: StaticAppConfig & StaticKhulnasoftWebAppContext & DynamicKhulnasoftWebAppContext
}
