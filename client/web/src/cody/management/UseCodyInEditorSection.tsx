...
import { Badge, ButtonLink, H3, Icon, Link, LinkOrSpan, KhulnasoftIcon, Text } from '@sourcegraph/wildcard'
...
const EDITOR_INSTRUCTIONS: EditorInstructionsTile[] = [
    ...
    {
        icon: ({ className }) => (
            <KhulnasoftIcon className={className} width={EDITOR_ICON_HEIGHT} height={EDITOR_ICON_HEIGHT} />
        ),
        name: 'Web',
        instructions: ({ telemetryRecorder }) => (
            <div className="d-flex flex-column flex-gap-2 align-items-start">
