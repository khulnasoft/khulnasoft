...
/**
 * CodyIgnoreProvider provides {@link CodyIgnoreFns} based on the {@link isKhulnasoftDotCom} prop.
 *
 ...
 */
export const CodyIgnoreProvider: React.FC<React.PropsWithChildren<{ isKhulnasoftDotCom: boolean }>> = ({
    isKhulnasoftDotCom,
    children,
}) => {
