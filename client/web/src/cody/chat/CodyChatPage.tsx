...
const AuthenticatedCodyChatPage: FC<CodyChatPageProps> = props => {
    const { isKhulnasoftDotCom, authenticatedUser } = props
    ...
    return (
        <Page className={styles.root}>
            ...
            <CodyPageHeader isKhulnasoftDotCom={isKhulnasoftDotCom} className={styles.pageHeader} />
...
const CodyPageHeader: FC<CodyPageHeaderProps> = props => {
    const { isKhulnasoftDotCom, className } = props

    const codyDashboardLink = isKhulnasoftDotCom ? CodyProRoutes.Manage : PageRoutes.CodyDashboard
