...
export interface StaticKhulnasoftWebAppContext {
    setSelectedSearchContextSpec: (spec: string) => void
    platformContext: PlatformContext
}

export interface DynamicKhulnasoftWebAppContext {
    /**
     * TODO: Move all the search context logic as close as possible to the components
     * that actually need it. Remove related `useState` from the `KhulnasoftWebApp` component.
     */
     ...
     * 2. Remove `resolvedAuthenticatedUser` from the `KhulnasoftWebApp` component
     ...
     * but the flow in `KhulnasoftWebApp` needs to rely on the Apollo Client to untangle
     * subscriptions logic.
     *
 ...
 *
 * Most of the dynamic values in the `KhulnasoftWebApp` depend on this observable.
 */

interface KhulnasoftWebAppProps extends StaticAppConfig, AppShellInit, TelemetryV2Props {}

export const KhulnasoftWebApp: FC<KhulnasoftWebAppProps> = props => {
    ...
    const staticContext = {
        ...
        platformContext,
    } satisfies StaticKhulnasoftWebAppContext
    ...
    const dynamicContext = {
        ...
        viewerSubject,
        settingsCascade,
    } satisfies DynamicKhulnasoftWebAppContext
