    ...
    return (
        ...
        >
            <div>
                ...
                />
                <Text className="pt-3">
                    <strong>You are going to delete {org.name} from Khulnasoft.</strong>
                    This cannot be undone. Deleting an organization will remove all of its synced repositories from
                    Khulnasoft, along with the organization’s code insights, batch changes, code monitors and other
                    resources.
                </Text>
                <Input
