...
interface LegacyKhulnasoftWebAppState extends SettingsCascadeProps {
    error?: Error
 ...
 * The root component.
 */
export class LegacyKhulnasoftWebApp extends React.Component<StaticAppConfig, LegacyKhulnasoftWebAppState> {
                ...
                <Route
                    ...
                    element={
                        <LegacyLayout
                            ...
                            isKhulnasoftDotCom={window.context.sourcegraphDotComMode}
