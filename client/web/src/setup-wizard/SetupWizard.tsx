...
const CORE_STEPS: StepConfiguration[] = [
    {
        ...
        // to app UI. See https://github.com/khulnasoft/khulnasoft/issues/50122
        onNext: (client: ApolloClient<{}>) => {
            ...
            // TODO Remove this as soon as we have a proper Khulnasoft context store
                ...
                <div className={styles.content}>
                    <header className={styles.header}>
                        ...
                        <H2 as={H1} className="font-weight-normal text-white mt-3 mb-4">
                            Welcome to Khulnasoft! Let's get started.
                        </H2>
                    </header>
