 ...
 */
export type KhulnasoftContextCurrentUser = Pick<
    AuthenticatedUser,
    | '__typename'
    | 'id'
    | 'databaseID'
 ...
 * if client side query changes.
 */
export type KhulnasoftContextTemporarySettings = Pick<
    TemporarySettingsResult['temporarySettings'],
    '__typename' | 'contents'
>

export interface KhulnasoftContext extends Pick<Required<SiteConfiguration>, 'experimentalFeatures'> {
     ...
     */
    readonly currentUser: KhulnasoftContextCurrentUser | null
    readonly temporarySettings: KhulnasoftContextTemporarySettings | null
    ...
    /**
     * siteID is the identifier of the Khulnasoft site.
     */
    siteID: string

    /** The GraphQL ID of the Khulnasoft site. */
    siteGQLID: string
     ...
     * {@link KhulnasoftContext.codyEnabledForCurrentUser} to see whether Cody is enabled for the
     * current user.
     */
    ...
    /** Whether code intelliense is enabled on the Khulnasoft instance. */
    codeIntelligenceEnabled: boolean

    /** Whether search contexts are enabled on the Khulnasoft instance */
    searchContextsEnabled: boolean

    /** Whether notebooks is enabled on the Khulnasoft instance */
    notebooksEnabled: boolean

    /** Whether code monitoring is enabled on the Khulnasoft instance */
    codeMonitoringEnabled: boolean

    /** Whether search aggregation is enabled on the Khulnasoft instance */
    searchAggregationEnabled: boolean

    /** Whether the own API is enabled on the Khulnasoft instance */
    ownEnabled: boolean

    /** Whether the search jobs feature is enabled on the Khulnasoft instance */
