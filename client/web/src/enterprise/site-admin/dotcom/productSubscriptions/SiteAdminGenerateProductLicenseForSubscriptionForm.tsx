    ...
    const infoAlerts = (
        <>
            <Alert variant="warning" className="flex-shrink-0">
                <Text>
                    Each subscription must map to exactly ONE Khulnasoft instance.{' '}
                    <strong>
                        DO NOT create licenses used by multiple Khulnasoft instances within a single subscription
                    </strong>{' '}
    ...
    return (
        ...
        >
            <H3 className="flex-shrink-0" id={labelId}>
                Generate new Khulnasoft license
            </H3>
                        ...
                        <Form onSubmit={onSubmit}>
                            ...
                            {selectedPlan && (
                                <>
                                    ...
                                    <Input
                                        type="date"
                                        description="When this license expires. Khulnasoft will disable beyond this date. Usually the end date of the contract."
                                        label="Expires At"
