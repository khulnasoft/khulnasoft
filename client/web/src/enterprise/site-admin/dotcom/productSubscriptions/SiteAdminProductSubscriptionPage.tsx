...
const Page: React.FunctionComponent<React.PropsWithChildren<Props>> = ({ telemetryRecorder }) => {
    ...
    const onArchive = useCallback(async () => {
        ...
        const reason = window.prompt(
            'Do you really want to PERMANENTLY archive this subscription? All licenses associated with this subscription will be PERMANENTLY revoked, it will no longer be available for various Khulnasoft services, and changes can no longer be made to this subscription.\n\nHowever, it does NOT refund payment or cancel billing for you.\n\nEnter a revocation reason to continue.'
        )
    ...
    return (
        <div className="site-admin-product-subscription-page">
            ...
            <PageHeader
                ...
                description="This subscription tracks a single Enterprise Khulnasoft instance."
                byline={
                    subscription &&
                            ...
                            <tbody>
                                <tr>
                                    <th className="text-nowrap">
                                        Subscription ID{' '}
                                        <Tooltip content="This immutable identifier represents a subscription for a single Enterprise Khulnasoft instance tracked by the Enterprise Portal service.">
                                ...
                                <tr>
                                    <th className="text-nowrap">
                                        Instance domain{' '}
                                        <Tooltip content="The known 'external URL' of this Khulnasoft instance. This must be set manually, and is required for Cody Analytics.">
                                            <Icon aria-label="Show help text" svgPath={mdiInformationOutline} />
                                        </Tooltip>
                                    </th>
                                    <td className="w-100">
