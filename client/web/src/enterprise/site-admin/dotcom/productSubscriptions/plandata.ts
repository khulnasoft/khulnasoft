...
export const TAG_AIR_GAPPED: Tag = {
    ...
    description: 'Allows offline usage of Khulnasoft with no remote license key validation and telemetry off',
}
...
export const DEPRECATED_TAGS: Tag[] = [
    ...
    },
    {
        ...
        description:
            'Whether publishing extensions to this Khulnasoft instance has been purchased. If not, then extensions must be published to Khulnasoft.com. All instances may use extensions published to Khulnasoft.com',
    },
    {
    ...
    },
    {
        name: 'Branding',
        tagValue: 'branding',
        description: 'Whether custom branding of this Khulnasoft instance has been purchased',
    },
    {
        name: 'Campaigns',
        tagValue: 'campaigns',
        description: 'Whether campaigns (now: batch changes) on this Khulnasoft instance has been purchased',
    },
    {
        name: 'Monitoring',
        tagValue: 'monitoring',
        description: 'Whether monitoring on this Khulnasoft instance has been purchased',
    },
    {
        name: 'BackupAndRestore',
        tagValue: 'backup-and-restore',
        description: 'Whether builtin backup and restore on this Khulnasoft instance has been purchased',
    },
    {
        name: 'Starter',
        tagValue: 'starter',
