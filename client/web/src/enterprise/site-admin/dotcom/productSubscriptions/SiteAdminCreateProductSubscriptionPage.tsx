 ...
 *
 * For use on Khulnasoft.com by Khulnasoft teammates only.
 */
    ...
    return (
        <div className="site-admin-create-product-subscription-page">
            ...
            <Container className="mb-3">
                ...
                <Alert variant="info">
                    <Text>
                        <strong>You are creating an Enterprise subscription for a SINGLE Khulnasoft instance</strong>.
                        Customers with multiple Khulnasoft instances should have a separate subscription for each.{' '}
                        <strong>Each subscription should only have licenses for a SINGLE Khulnasoft instance.</strong>
                    </Text>
                    <Text className="mb-0">
                ...
                <Form ref={formRef} onSubmit={handleSubmit}>
                    ...
                    <Select
                        id="instance-type"
                        label="Instance type"
                        message="Select the type of instance this subscription is used for. A production instance might be a PRIMARY instance, while a testing or staging instance would be a SECONDARY instance. INTERNAL instances are used internally at Khulnasoft."
                    ...
                    <Label className="w-100 mt-2">
                        Instance domain
                        <Input
                            message="External domain of the Khulnasoft instance that will be used by this subscription. Required for Cody Analytics. Must be set manually."
