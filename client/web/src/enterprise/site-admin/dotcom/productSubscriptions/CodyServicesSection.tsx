...
const ToggleCodyServicesConfirmationModal: React.FunctionComponent<ToggleCodyServicesConfirmationModalProps> = ({
    ...
    return (
        <Modal onDismiss={onCancel} aria-labelledby={labelId}>
            ...
            <Text>
                Cody Gateway is a Khulnasoft managed service that allows customer instances to talk to upstream LLMs and
                generate embeddings under our negotiated terms with third party providers in a safe manner.
            </Text>
