...
export const InstanceTypeBadge: React.FunctionComponent<InstanceTypeBadgeProps> = ({ instanceType, className }) => {
    ...
    switch (instanceType) {
        case EnterpriseSubscriptionInstanceType.INTERNAL: {
            tooltip = 'This subscription is for Khulnasoft-internal instances.'
            break
        }
        case EnterpriseSubscriptionInstanceType.PRIMARY: {
            variant = 'primary'
            tooltip = "This subscription is for a customer's primary, production Khulnasoft instance."
            break
        }
        case EnterpriseSubscriptionInstanceType.SECONDARY: {
            variant = 'info'
            tooltip =
                "This subscription is for a customer's secondary Khulnasoft instance, such as one for staging new releases."
            break
        }
    }
    return (
