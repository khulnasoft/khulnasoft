...
export const ProductSubscriptionStatus: React.FunctionComponent<React.PropsWithChildren<Props>> = ({
    ...
    // No license means Khulnasoft Free. For that, show the user that they can use this for free
                ...
                footer={
                    <CardFooter className="d-flex align-items-center justify-content-between">
                        {!license.isFreePlan ? (
                            ...
                            <>
                                <div className="mr-2">
                                    Add a license key to activate Khulnasoft Enterprise features{' '}
...
const LicenseDetails: FC<LicenseDetailsProps> = ({ license }) => {
    ...
    return (
        <Alert variant="danger">
            <Text className="mb-0">
                The Khulnasoft license key is invalid. Reason: {license.licenseInvalidityReason}
            </Text>
        </Alert>
    )
}
