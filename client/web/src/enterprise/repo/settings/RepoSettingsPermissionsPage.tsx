            ...
            <Container className="repo-settings-permissions-page">
                {!repo.isPrivate ? (
                    <Alert className="mb-0" variant="info">
                        Access to this repository is <strong>not restricted</strong>, all Khulnasoft users have access.
                    </Alert>
                ) : !permissionsInfo ? (
                    <Alert className="mb-0" variant="info">
                    ...
                    <Alert className="mb-0" variant="info">
                        This repository has been explicitly flagged as unrestricted, all Khulnasoft users have access.
                    </Alert>
                ) : (
                    <div>
                        <table className="table">
                            <tbody>
                                <tr>
                                    <th>
                                        Last complete sync{' '}
                                        <Tooltip content="Syncs repository permissions from the code host. All users that have access to the repository on the code host will have access on Khulnasoft as well.">
