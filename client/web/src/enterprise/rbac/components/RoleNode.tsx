                    ...
                    >
                        ...
                        <header className="d-flex flex-column justify-content-center mr-2">
                            <div className="d-flex align-items-center">
                                <H4 className="m-0">{roleName}</H4>
                                <SystemLabel />
                                <Tooltip content="This role is locked. Its permissions are managed by Khulnasoft and cannot be modified.">
                                    <Icon
...
const SystemLabel: React.FunctionComponent = () => (
    <Tooltip content="System roles are predefined by Khulnasoft. They cannot be deleted.">
