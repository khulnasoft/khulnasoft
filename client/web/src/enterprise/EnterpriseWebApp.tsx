...
import '../KhulnasoftWebApp.scss'

import { logger } from '@sourcegraph/common'

import { KhulnasoftWebApp } from '../KhulnasoftWebApp'
import { LegacyKhulnasoftWebApp } from '../LegacyKhulnasoftWebApp'
...
export const EnterpriseWebApp: FC<AppShellInit> = props => {
    ...
    return <LegacyKhulnasoftWebApp {...staticAppConfig} />
}
