    ...
    const [heading, description]: [React.ReactNode, React.ReactNode] =
        type === 'create'
            ? [
                  ...
                  <>
                      Let Khulnasoft help you with <strong>{insightTitle}</strong> by preparing a relevant{' '}
                      <strong>batch change</strong>.
                  </>,
              ]
            : [
                  `Start from template for the ${insightTitle}`,
                  `Khulnasoft pre-selected a batch spec for the batch change started from ${insightTitle}.`,
              ]
