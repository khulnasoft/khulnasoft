...
/**
 * A list of all batch changes on the Khulnasoft instance.
 */
export const BatchChangeListPage: React.FunctionComponent<React.PropsWithChildren<BatchChangeListPageProps>> = ({
    ...
    const [selectedTab, setSelectedTab] = useState<SelectedTab>(
        openTab ?? (isKhulnasoftDotCom || !canUseBatchChanges ? 'gettingStarted' : 'batchChanges')
    )
    ...
    return (
        <Page>
            ...
            {!isKhulnasoftDotCom && canUseBatchChanges && (
