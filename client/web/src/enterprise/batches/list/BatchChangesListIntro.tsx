...
import { KhulnasoftIcon } from '../../../auth/icons'
    ...
    <div className={classNames(styles.batchChangesListIntroAlert, 'h-100')}>
        <Card className={classNames(styles.batchChangesListIntroCard, 'h-100')}>
            <CardBody className="d-flex align-items-start">
                ...
                <KhulnasoftIcon className="mr-3 col-2 mt-2 d-none d-sm-block" />
                <div>
                    <H4>Batch changes trial</H4>
                    <Text>
                        Batch changes is a paid feature of Khulnasoft. All users can create sample batch changes with up
                        to ten changesets without a license.
                    </Text>
                    <Text className="mb-0">
                        <Link to="https://khulnasoft.com/contact/sales/">Contact sales</Link> to obtain a trial license.
                    </Text>
                </div>
            </CardBody>
        </Card>
