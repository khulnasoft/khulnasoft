                    ...
                    <div className="d-flex align-items-center">
                        ...
                        {node.namespace === null && (
                            <span>
                                <Badge
                                    variant="secondary"
                                    tooltip="This secret is available to users of the Khulnasoft instance."
                                    aria-label="This secret is available to users of the Khulnasoft instance."
                                    className="mr-2"
                                >
                                    Global secret
                                </Badge>
                        ...
                        {node.overwritesGlobalSecret && (
                            <span>
                                <Badge
                                    variant="secondary"
                                    tooltip="This secret overwrites an existing secret set globally in this Khulnasoft instance."
                                    aria-label="This secret overwrites an existing secret set globally in this Khulnasoft instance."
                                    className="mr-2"
                                >
