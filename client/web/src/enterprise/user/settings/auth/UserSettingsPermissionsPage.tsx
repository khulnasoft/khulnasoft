    ...
    return (
        <div className="w-100">
            ...
            <Container className="mb-3">
                <>
                    ...
                    <Text className="text-muted mt-2 mb-4">
                        ...
                        user. However, please note that the user may have had permissions stored in Khulnasoft in the
                        past.
                    </Text>
            ...
            <PageHeader
                ...
                description={
                    <>
                        List of <i>all</i> repositories the user can access on Khulnasoft.
                    </>
                }
                className="my-3 pt-3"
            />
