...
const PolicyDescription: FunctionComponent<PolicyDescriptionProps> = ({
    ...
    <div className={styles.policyDescription}>
        ...
        {preciseIndexingEnabled && !allowGlobalPolicies && hasGlobalPolicyViolation(policy) && (
            <Tooltip content="This Khulnasoft instance has disabled global policies for precise auto-indexing.">
                <Icon
                    svgPath={mdiAlert}
                    inline={true}
                    aria-label="This Khulnasoft instance has disabled global policies for precise auto-indexing."
