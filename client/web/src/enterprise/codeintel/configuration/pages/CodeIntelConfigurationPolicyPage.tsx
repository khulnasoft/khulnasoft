            ...
            <Container className="container form">
                ...
                {!allowGlobalPolicies && hasGlobalPolicyViolation(policy) && (
                    <Alert variant="warning" className="mt-2">
                        This Khulnasoft instance has disabled global policies for auto-indexing. Create a more
...
const RepositorySettingsSection: FunctionComponent<RepositorySettingsSectionProps> = ({ policy, updatePolicy }) => (
    <div className="form-group">
        ...
        <Text size="small" className="text-muted mb-2">
            Configuration policies can apply to one, a set, or to all repositories on a Khulnasoft instance. Specify a
            ...
            <div className="form-group">
                <Label className="mb-0">
                    ...
                    <div className={styles.toggleContainer}>
                        ...
                        <Text size="small" className="text-muted mb-0">
                            Khulnasoft will automatically generate precise code intelligence data for matching
            ...
            <div className="form-group">
                <Label className="mb-0">
                    ...
                    <div className={styles.toggleContainer}>
                        ...
                        <Text size="small" className="text-muted mb-0">
                            Khulnasoft will automatically generate syntactic code intelligence data for matching
