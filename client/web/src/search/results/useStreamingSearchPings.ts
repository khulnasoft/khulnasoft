...
export function useStreamingSearchPings(props: useStreamingSearchPingsProps): StreamingSearchPingsAPI {
    const { isAuauthenticated, isKhulnasoftDotCom, results, telemetryService, telemetryRecorder } = props
            ...
            },
            {
                code_search: {
                    query_data: {
                        ...
                        // on Khulnasoft.com, and only after sanitizing to remove certain filters.
                        combined:
                            !isAuauthenticated && isKhulnasoftDotCom
