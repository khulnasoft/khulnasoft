...
describe('searchResultsToFileContent', () => {
    ...
    const data: [SearchType | 'owner' | null, SearchMatch[], string][] = [
        ...
        [
            ...
            [
                {
                    ...
                    symbols: [
                        {
                            url: '/github.com/khulnasoft/khulnasoft/-/blob/enterprise/internal/batches/types/code_host.go?L6:6-6:14',
                            name: 'CodeHost',
                            containerName: 'types',
                            kind: 'STRUCT',
                            line: 6,
                ...
                },
                {
                    ...
                    symbols: [
                        {
                            url: '/github.com/khulnasoft/khulnasoft/-/blob/internal/database/external_services.go?L225:2-225:10',
                            name: 'CodeHost',
                ...
                },
                {
                    ...
                    symbols: [
                        {
                            url: '/github.com/khulnasoft/khulnasoft/-/blob/internal/extsvc/codehost.go?L10:6-10:14',
                            name: 'CodeHost',
                        ...
                        {
                            url: '/github.com/khulnasoft/khulnasoft/-/blob/internal/extsvc/codehost.go?L64:9-64:20',
                            name: 'NewCodeHost',
                            containerName: 'extsvc',
                            kind: 'FUNCTION',
                            line: 64,
            ...
            'Match type,Repository,Repository external URL,File path,File URL,Symbols [kind name url]\nsymbol,github.com/sourcegraph/sourcegraph,http://localhost:3443/github.com/sourcegraph/sourcegraph,enterprise/internal/batches/types/code_host.go,http://localhost:3443/github.com/khulnasoft/khulnasoft/-/blob/enterprise/internal/batches/types/code_host.go,"[STRUCT, CodeHost, http://localhost:3443/github.com/khulnasoft/khulnasoft/-/blob/enterprise/internal/batches/types/code_host.go?L6:6-6:14]"\nsymbol,github.com/sourcegraph/sourcegraph,http://localhost:3443/github.com/sourcegraph/sourcegraph,internal/database/external_services.go,http://localhost:3443/github.com/khulnasoft/khulnasoft/-/blob/internal/database/external_services.go,"[FIELD, CodeHost, http://localhost:3443/github.com/khulnasoft/khulnasoft/-/blob/internal/database/external_services.go?L225:2-225:10]"\nsymbol,github.com/koderover/zadig,http://localhost:3443/github.com/koderover/zadig,pkg/cli/upgradeassistant/internal/repository/models/codehost.go,http://localhost:3443/github.com/koderover/zadig/-/blob/pkg/cli/upgradeassistant/internal/repository/models/codehost.go,"[STRUCT, CodeHost, http://localhost:3443/github.com/koderover/zadig/-/blob/pkg/cli/upgradeassistant/internal/repository/models/codehost.go?L19:6-19:14]"\nsymbol,github.com/sourcegraph/sourcegraph,http://localhost:3443/github.com/sourcegraph/sourcegraph,internal/extsvc/codehost.go,http://localhost:3443/github.com/khulnasoft/khulnasoft/-/blob/internal/extsvc/codehost.go,"[STRUCT, CodeHost, http://localhost:3443/github.com/khulnasoft/khulnasoft/-/blob/internal/extsvc/codehost.go?L10:6-10:14]; [FUNCTION, NewCodeHost, http://localhost:3443/github.com/khulnasoft/khulnasoft/-/blob/internal/extsvc/codehost.go?L64:9-64:20]"',
        ],
        [
            'diff',
            [
            ...
            'Match type,Repository,Repository external URL,Date,Author,Message,oid,Commit URL\ncommit,github.com/EbookFoundation/free-programming-books,http://localhost:3443/github.com/EbookFoundation/free-programming-books,2022-11-15T23:25:02Z,Oscar Skille,"Create Norwegian How to (#8632)\n\n* Create HOWTO-no.md\r\n\r\n* Update HOWTO-no.md\r\n\r\n* fix? syntax\r\n\r\n* add -no link\r\n\r\nCo-authored-by: Eric Hellman <eric@hellman.net>",76f7742b20f4875d3ca21774eac3d04322112821,http://localhost:3443/github.com/EbookFoundation/free-programming-books/-/commit/76f7742b20f4875d3ca21774eac3d04322112821\ncommit,github.com/freeCodeCamp/freeCodeCamp,http://localhost:3443/github.com/freeCodeCamp/freeCodeCamp,2022-12-12T17:07:03Z,Sem Bauke,feat(Cypress): give basic structure to cypress typescript files (#48734),ff95595fa50d9085166dc07035d84364125099e0,http://localhost:3443/github.com/freeCodeCamp/freeCodeCamp/-/commit/ff95595fa50d9085166dc07035d84364125099e0',
        ],
        [
            'commit',
            [
            ...
            'Match type,Repository,Repository external URL,Date,Author,Message,oid,Commit URL\ncommit,github.com/EbookFoundation/free-programming-books,http://localhost:3443/github.com/EbookFoundation/free-programming-books,2022-10-30T03:07:11Z,Karen Ketlyn Ferreira Barcelos,"Added two courses R PT_BR (#7415)\n\n* Added two courses R PT_BR\r\n\r\nHello! I\'m trying to help by adding courses that helped me!\r\n\r\n* fix: URL fragments goes in lowercase\r\n\r\n* lint: leave 2 blank lines between listings and next heading\r\n\r\n* Update courses/free-courses-pt_BR.md\r\n\r\nCo-authored-by: David Ordás <3125580+davorpa@users.noreply.github.com>\r\n\r\n* Update courses/free-courses-pt_BR.md\r\n\r\nCo-authored-by: David Ordás <3125580+davorpa@users.noreply.github.com>\r\n\r\nCo-authored-by: David Ordás <3125580+davorpa@users.noreply.github.com>\r\nCo-authored-by: Eric Hellman <eric@hellman.net>",91cdcd907bbf070b1310f9120b06bb03f481edb6,http://localhost:3443/github.com/EbookFoundation/free-programming-books/-/commit/91cdcd907bbf070b1310f9120b06bb03f481edb6\ncommit,github.com/freeCodeCamp/freeCodeCamp,http://localhost:3443/github.com/freeCodeCamp/freeCodeCamp,2022-07-12T07:13:40Z,Harsh Kashyap,"fix(curriculum): corrected grammar in line 12 of the description section of learn HTML forms.md (#46859)\n\n* Update 60fad1cafcde010995e15306.md\r\n\r\nHello, \r\nI have changed the sentence, please have a look.\r\n\r\n* Update curriculum/challenges/english/14-responsive-web-design-22/learn-html-forms-by-building-a-registration-form/60fad1cafcde010995e15306.md\r\n\r\nThank you, I have committed the changes suggested by you.\r\n\r\nCo-authored-by: Jeremy L Thompson <jeremy@jeremylt.org>\r\n\r\nCo-authored-by: Jeremy L Thompson <jeremy@jeremylt.org>",3ecc381f95383dfa8314846a5a7d815b359d95d1,http://localhost:3443/github.com/freeCodeCamp/freeCodeCamp/-/commit/3ecc381f95383dfa8314846a5a7d815b359d95d1\ncommit,github.com/EbookFoundation/free-programming-books,http://localhost:3443/github.com/EbookFoundation/free-programming-books,2022-10-07T14:42:09Z,yakirk,"Change link of repojacking vulnerable link (#7723)\n\nHello from Hacktoberfest :)\r\nThe link to https://raw.githubusercontent.com/teten777/free-ebook-springboot-basic/master/Memulai%20Java%20Enterprise%20dengan%20Spring%20Boot.pdf is vulnerable to repojacking (it redirects to the orignial project that changed name), you should change the link to the current name of the project. if you won\'t change the link, an attacker can open the linked repository and attacks users that trust your links.\r\nThe new repository name is:\r\nhttps://raw.githubusercontent.com/teten-nugraha/free-ebook-springboot-basic/master/Memulai%20Java%20Enterprise%20dengan%20Spring%20Boot.pdf",c019ebd5db296ff9fba99a2ebb73ba5d3aa5f854,http://localhost:3443/github.com/EbookFoundation/free-programming-books/-/commit/c019ebd5db296ff9fba99a2ebb73ba5d3aa5f854\ncommit,github.com/EbookFoundation/free-programming-books,http://localhost:3443/github.com/EbookFoundation/free-programming-books,2022-07-21T05:52:57Z,Muhammad Anas,"New Django Course! (#6945)\n\nI have added a new course under the Django section. It was undoubtedly a must. It teaches everything from head to toe! From creating a simple **Hello World** site to a fully functional website to deployment! All is here!",a55f727e669f2a6ce694ac5821ff06a15a889328,http://localhost:3443/github.com/EbookFoundation/free-programming-books/-/commit/a55f727e669f2a6ce694ac5821ff06a15a889328\ncommit,github.com/EbookFoundation/free-programming-books,http://localhost:3443/github.com/EbookFoundation/free-programming-books,2020-10-31T20:49:54Z,Diego Mateos,"Added Hello SDL by LazyFoo (#4956)\n\n* Addded Hello SDL by LazyFoo\r\n\r\n* removed the redundant part of the URL",e364fc5254fedbbdbf179912aa59dfd773519d14,http://localhost:3443/github.com/EbookFoundation/free-programming-books/-/commit/e364fc5254fedbbdbf179912aa59dfd773519d14',
        ],
        [
            'owner',
            [
