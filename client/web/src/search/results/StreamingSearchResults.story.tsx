...
export const ServerSideAlertUnownedResults: StoryFn = () => {
    const result: AggregateStreamingSearchResults = {
        ...
        alert: {
            ...
            description:
                'For some results, no ownership data was found, or no rule applied to the result. [Learn more about configuring code ownership](https://khulnasoft.com/docs/own).',
        },
    }
