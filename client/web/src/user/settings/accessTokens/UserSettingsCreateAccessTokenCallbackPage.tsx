...
export const UserSettingsCreateAccessTokenCallbackPage: React.FC<Props> = ({
    ...
    useEffect((): void => {
        ...
        if (REQUESTERS[requestFrom].onlyDotCom && !isKhulnasoftDotCom) {
            navigate('../..', { relative: 'path' })
            return
        }
    ...
    }, [isKhulnasoftDotCom, location.search, navigate, requestFrom, requester, port, destination])
    ...
    return (
        <div className={styles.wrapper}>
            ...
            <Card className={styles.card}>
                ...
                <ul>
                    <li>Your Khulnasoft.com account</li>
