...
/**
 * ExternalsAuth is ONLY intended for use in Khulnasoft.com components.
 */
export const ExternalsAuth: React.FunctionComponent<React.PropsWithChildren<ExternalsAuthProps>> = ({
    ...
    // Since this component is only intended for use on Khulnasoft.com, it's OK to hardcode
    // our providers.
