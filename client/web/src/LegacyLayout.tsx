...
import { isKhulnasoftDev, useDeveloperSettings } from './stores'
 ...
 * https://github.com/khulnasoft/khulnasoft/issues/36251
 */
...
export const LegacyLayout: FC<LegacyLayoutProps> = props => {
    ...
    const showDeveloperDialog =
        ...
        (process.env.NODE_ENV === 'development' || isKhulnasoftDev(props.authenticatedUser))
    ...
    // Note: this was a poor UX and is disabled for now, see https://github.com/khulnasoft/khulnasoft/issues/30192
    ...
    return (
        ...
        >
            ...
            <GlobalAlerts
                ...
                telemetryRecorder={props.platformContext.telemetryRecorder}
            />
            {!isSiteInit && !isSignInOrUp && !props.isKhulnasoftDotCom && !disableFeedbackSurvey && (
                <SurveyToast
                    authenticatedUser={props.authenticatedUser}
                    telemetryRecorder={props.platformContext.telemetryRecorder}
                />
                ...
                <>
                    {newSearchNavigation ? (
                        <NewGlobalNavigationBar
                            ...
                            authenticatedUser={props.authenticatedUser}
                            isKhulnasoftDotCom={props.isKhulnasoftDotCom}
