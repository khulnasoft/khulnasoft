...
export const routes: RouteObject[] = [
    ...
    },
    {
        ...
        element: (
            <LegacyRoute
                ...
                condition={({ isKhulnasoftDotCom, codeMonitoringEnabled }) =>
                    !isKhulnasoftDotCom && codeMonitoringEnabled
                }
            />
        ),
    },
    ...
    },
    {
        ...
        element: (
            <LegacyRoute
                ...
                condition={({ isKhulnasoftDotCom, ownEnabled }) => !isKhulnasoftDotCom && ownEnabled}
            />
        ),
    },
    {
    ...
    // when the instance has the code search feature.
    {
        ...
        element: (
            <LegacyRoute
                render={props => (
                    <CodyIgnoreProvider isKhulnasoftDotCom={props.isKhulnasoftDotCom}>
