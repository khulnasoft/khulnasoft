            ...
            {isErrorLike(migrationsOrError) ? (
                ...
                <>
                    ...
                    <PageHeader
                        ...
                        description={
                            <>
                                Out-of-band migrations run in the background of the Khulnasoft instance convert data
                                from an old format into a new format. Consult this page prior to upgrading your
                                Khulnasoft instance to ensure that all expected migrations have completed.
                            </>
                        }
                        className="mb-3"
                    />
...
> = ({ migrations }) => (
    <Alert variant="warning">
        <Text>
            The next version of Khulnasoft removes support for reading an old data format. Your Khulnasoft instance must
            complete the following migrations to ensure your data remains readable.{' '}
            <strong>If you upgrade your Khulnasoft instance now, you may corrupt or lose data.</strong>
        </Text>
        <ul>
            {migrations.map(migration => (
                <li key={migration.id}>{migration.description}</li>
...
> = ({ migrations }) => (
    <Alert variant="warning">
        <Text>
            ...
            <span>
                The previous version of Khulnasoft does not support reading data that has been migrated into a new
                format. Your Khulnasoft instance must undo the following migrations to ensure your data can be read by
                the previous version.{' '}
                <strong>If you downgrade your Khulnasoft instance now, you may corrupt or lose data.</strong>
            </span>
        </Text>
