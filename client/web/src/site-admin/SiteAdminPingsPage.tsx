    ...
    return (
        <div className="site-admin-pings-page">
            ...
            <PageHeader
                ...
                description={
                    <>
                        Khulnasoft periodically sends a ping to Khulnasoft.com to help our product and customer teams.
            ...
            <Container>
                ...
                <ul>
                    ...
                    <li>Khulnasoft version string (e.g. "vX.X.X")</li>
                    ...
                    <li>License key associated with your Khulnasoft subscription</li>
                ...
                <Text>
                    By default, Khulnasoft also aggregates usage and performance metrics for some product features. No
                ...
                <ul>
                    ...
                    <li>
                        Khulnasoft extension activation statistics
                        <ul>
                            <li>Total number of users that use a given non-default Khulnasoft extension</li>
                            <li>
                                Average number of activations for users that use a given non-default Khulnasoft
                                extension
                            </li>
                            <li>Total number of users that use non-default Khulnasoft extensions</li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                visited Khulnasoft instance from browser extension
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            ...
                            <li>Aggregate count of daily redirects from extension to Khulnasoft instance</li>
                        </ul>
                    </li>
                    <li>
