 ...
 * Will only work if this Khulnasoft instance has the Khulnasoft repository - if not,
...
> = ({ fetchFeatureFlags = defaultFetchFeatureFlags, productVersion = window.context.version, telemetryRecorder }) => {
    ...
    const [isKhulnasoftCloudManagedFeatureFlagsWarningShown] = useFeatureFlag(
    ...
    return (
        <>
            ...
            {isKhulnasoftCloudManagedFeatureFlagsWarningShown && (
                <Alert variant="info">
                    Feature flag settings are managed by Khulnasoft and will be overridden by updates. Contact support
                    for help.
                </Alert>
            )}
