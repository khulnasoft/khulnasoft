...
const initSite = async (args: SignUpArguments): Promise<void> => {
    const pingUrl = new URL('https://khulnasoft.com/ping-from-self-hosted')
...
interface Props extends TelemetryV2Props {
    ...
    context: Pick<KhulnasoftContext, 'authPasswordPolicy' | 'authMinPasswordLength'>
}

/**
 * A page that is shown when the Khulnasoft instance has not yet been initialized.
                ...
                {authenticatedUser ? (
                    ...
                    <Container>
                        <Text className="mb-0">
                            ...
                            initialize Khulnasoft before you can continue.
                        </Text>
                    </Container>
                ) : (
                    <Container>
