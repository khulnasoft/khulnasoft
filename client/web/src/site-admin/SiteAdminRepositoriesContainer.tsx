        ...
        const items: ValueLegendListProps['items'] = [
            {
                ...
                color: 'var(--purple)',
                tooltip:
                    'Total number of repositories in the Khulnasoft instance. This number might be higher than the total number of repositories in the list below in case repository permissions do not allow you to view some repositories.',
            },
            {
