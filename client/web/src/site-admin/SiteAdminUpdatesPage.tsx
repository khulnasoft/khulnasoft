                                                ...
                                                <div>
                                                    {summary.urlHint ? (
                                                        <Link to={summary.urlHint}>
                                                            See Khulnasoft query for potential fix
                                                        </Link>
                                                    ) : (
                                                        'Not Applicable'
                                                    )}
...
/**
 * A page displaying information about available updates for the Khulnasoft instance. As well as the readiness status of the instance for upgrade.
 */
