...
> = () => (
    <thead>
        <tr>
            <th>User</th>
            <th>Last active on Khulnasoft</th>
...
export const SiteAdminSurveyResponsesPage: React.FunctionComponent<React.PropsWithChildren<Props>> = ({
    ...
    return (
        <div className="site-admin-survey-responses-page">
            ...
            <Text>
                After using Khulnasoft for a few days, users are presented with a request to answer "How likely is it
                that you would recommend Khulnasoft to a friend?" on a scale from 0–10 and to provide some feedback.
                Responses are visible below (and are also sent to Khulnasoft).
            </Text>
