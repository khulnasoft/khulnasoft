            ...
            items: [
                {
                    ...
                    minPerItem: 120,
                    description:
                        'Without Khulnasoft, these searches would require complex scripting. They often answer specific and valuable questions such as finding occurrences of Log4j at a specific version globally.',
                    percentage: 3,
                    value: totalCount,
                },
                {
                    ...
                    minPerItem: 5,
                    description:
                        "Searches that leverage Khulnasoft's ability to quickly and confidently query all of your company's code across code hosts, without locally cloning repositories or complex scripting.",
                    percentage: 22,
                    value: totalCount,
                },
                {
                    ...
                    minPerItem: 0.5,
                    description:
                        'Common code search use cases are made more efficient through Khulnasoft’s advanced query language, syntax aware search patterns, and the ability to search code, diffs, and commit messages at any revision.',
                    percentage: 75,
                    value: totalCount,
                },
            ],
