    ...
    const [stats, legends, calculatorProps] = useMemo(() => {
        ...
        const legends: ValueLegendListProps['items'] = [
            ...
            },
            {
                ...
                tooltip:
                    'Cross repository code navigation identifies symbols in code throughout your Khulnasoft instance, in a single click, without locating and downloading a repository.',
            },
        ]
