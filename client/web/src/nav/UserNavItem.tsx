...
import { enableDevSettings, isKhulnasoftDev, useDeveloperSettings } from '../stores'
                    ...
                    <>
                        ...
                        >
                            ...
                            {window.context.codyEnabledForCurrentUser && (
                                <MenuLink
                                    as={Link}
                                    to={isKhulnasoftDotCom ? CodyProRoutes.Manage : PageRoutes.CodyDashboard}
                                >
                                    Cody dashboard
                                </MenuLink>
                            )}
                            ...
                            {!isKhulnasoftDotCom && window.context.ownEnabled && (
                            ...
                            {process.env.NODE_ENV !== 'development' && isKhulnasoftDev(authenticatedUser) && (
                                <div className="px-2 py-1">
                                    <div className="d-flex align-items-center justify-content-between">
