 ...
 */
export const EditPage: FunctionComponent<{ isKhulnasoftDotCom: boolean } & TelemetryV2Props> = ({
    isKhulnasoftDotCom,
    telemetryRecorder,
}) => {
...
const EditForm: FunctionComponent<
    TelemetryV2Props & { savedSearch: SavedSearchFields; isKhulnasoftDotCom: boolean }
> = ({ savedSearch, telemetryRecorder, isKhulnasoftDotCom }) => {
    useEffect(() => {
