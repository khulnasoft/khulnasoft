...
describe('Repository component', () => {
    ...
    describe.skip('symbol sidebar', () => {
        ...
        const navigateToSymbolTests = [
            // Flake, see https://github.com/khulnasoft/khulnasoft/issues/44791
            // {
        ...
        // https://github.com/khulnasoft/khulnasoft/issues/60824
        /*
    ...
    describe('hovers', () => {
        describe('Blob', () => {
            ...
            describe('jump to definition', () => {
                // https://github.com/khulnasoft/khulnasoft/issues/41555
                ...
                test.skip('does navigation (same repo, same file)', async () => {
                    // See https://github.com/khulnasoft/khulnasoft/pull/39747
                    await driver.page.goto(
                        sourcegraphBaseUrl +
            ...
            describe('find references', () => {
                ...
                // https://github.com/khulnasoft/khulnasoft/issues/33640
