...
/**
 * Gets the Khulnasoft instance version number via the GrapQL API.
 *
 * @returns An Observable that emits flattened Khulnasoft instance version number or undefined in case of an error:
...
/**
 * Parses the Khulnasoft instance version number.
 *
...
/**
 * Checks if the Khulnasoft instance version is older than the given version.
 * */
