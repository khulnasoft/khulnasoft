...
export function createPlatformContext(extensionCoreAPI: Comlink.Remote<ExtensionCoreAPI>): VSCodePlatformContext {
    const context: VSCodePlatformContext = {
        requestGraphQL({ request, variables, overrideAccessToken, overrideKhulnasoftURL }) {
            return from(extensionCoreAPI.requestGraphQL(request, variables, overrideAccessToken, overrideKhulnasoftURL))
        },
        ...
        settings: wrapRemoteObservable(extensionCoreAPI.observeKhulnasoftSettings()),
