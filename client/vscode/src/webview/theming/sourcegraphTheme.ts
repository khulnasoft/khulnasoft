 ...
 */
export function adaptKhulnasoftThemeToEditorTheme(): Observable<'theme-dark' | 'theme-light' | undefined> {
    const body = document.querySelector<HTMLBodyElement>('body')

    const themes = new BehaviorSubject<'theme-dark' | 'theme-light' | undefined>(undefined)

    function applyVSCodeThemeToKhulnasoft(): void {
