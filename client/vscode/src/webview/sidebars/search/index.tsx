...
import { adaptKhulnasoftThemeToEditorTheme } from '../../theming/sourcegraphTheme'
...
const themes = adaptKhulnasoftThemeToEditorTheme()
...
const Main: React.FC<React.PropsWithChildren<unknown>> = () => {
    ...
    const settingsCascade = useObservable(
        useMemo(() => wrapRemoteObservable(extensionCoreAPI.observeKhulnasoftSettings()), [])
    )
