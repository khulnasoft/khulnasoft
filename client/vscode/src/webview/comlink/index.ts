...
// Khulnasoft VS Code extension Comlink "communication layer" documentation
// -----
...
// our Khulnasoft extension host. Given the need to sync state between {search panel <- extension "Core" -> search webview},
...
// - web <-> web (webview context, used for Khulnasoft extension host Web Worker)
