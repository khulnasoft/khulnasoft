...
export interface ExtensionCoreAPI {
    ...
    requestGraphQL: (
        ...
        overrideKhulnasoftURL?: string
    ) => Promise<GraphQLResult<any>>
    observeKhulnasoftSettings: () => ProxySubscribable<SettingsCascadeOrError>
    ...
    /** Opens a remote file given a serialized KhulnasoftUri */
    openKhulnasoftFile: (uri: string) => Promise<void>
