...
import type { KhulnasoftUri } from './KhulnasoftUri'
 ...
 **/
export async function openKhulnasoftUriCommand(fs: KhulnasoftFileSystemProvider, uri: KhulnasoftUri): Promise<void> {
    if (uri.compareRange) {
...
function getSelection(uri: KhulnasoftUri, textDocument: vscode.TextDocument): vscode.Range | undefined {
