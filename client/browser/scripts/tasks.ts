...
function buildSafariExtensionApp(): void {
    const safariWebExtensionConverterOptions = [
        ...
        'build/',
        '--app-name',
        '"Khulnasoft for Safari"',
        '--bundle-identifier',
        '"com.sourcegraph.Khulnasoft-for-Safari"',
        '--copy-resources',
        '--swift',
        '--force',
        '--no-open',
    ...
    const xcodebuildOptions = [
        '-quiet',
        '-project',
        '"./build/Khulnasoft for Safari/Khulnasoft for Safari.xcodeproj"',
        'build',
    ]
    ...
    shelljs.mv('./build/Khulnasoft for Safari/build/Release/Khulnasoft for Safari.app', './build/bundles')
}
...
/**
 * When building with inline (bundled) Khulnasoft extensions, copy the built Khulnasoft extensions into the output.
