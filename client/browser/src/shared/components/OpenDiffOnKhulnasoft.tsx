...
import type { OpenDiffInKhulnasoftProps } from '../repo'
import { getPlatformName } from '../util/context'

import { KhulnasoftIconButton, type KhulnasoftIconButtonProps } from './KhulnasoftIconButton'

interface Props extends KhulnasoftIconButtonProps, PlatformContextProps<'requestGraphQL'> {
    openProps: OpenDiffInKhulnasoftProps
}
...
export class OpenDiffOnKhulnasoft extends React.Component<Props, State> {
    ...
    public render(): JSX.Element {
        const url = this.getOpenInKhulnasoftUrl(this.props.openProps)
        return (
    ...
    private getOpenInKhulnasoftUrl(props: OpenDiffInKhulnasoftProps): string {
