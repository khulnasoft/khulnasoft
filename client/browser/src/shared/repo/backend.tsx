 ...
 * Emits the repo name on the Khulnasoft instance as affected by `repositoryPathPattern`.
...
/**
 * Fetches the lines of a given file at a given commit from the Khulnasoft API.
