...
export class EventLogger implements TelemetryService {
    ...
    /**
     * Buffered Observable for the latest Khulnasoft URL
     */
    ...
    /**
     * Get the anonymous identifier for this user (allows site admins on a private Khulnasoft
     * instance to see a count of unique users on a daily, weekly, and monthly basis).
     *
     * Not used at all for public/Khulnasoft.com usage.
     */
    ...
    /**
     * Log a user action on the associated Khulnasoft instance
     */
