...
/**
 * Get the manifest URL and script URL for a Khulnasoft extension which is inline (bundled with the browser add-on).
 */
function getURLsForInlineExtension(extensionID: string, assetsURL: string): { manifestURL: string; scriptURL: string } {
     ...
     * We assume extension bundles exist (e.g. were built using [build-inline-extensions](https://khulnasoft.com/github.com/sourcegraph/sourcegraph@a2190db3ee4b7e61f02f821cd2e5b58fa9814540/-/blob/client/browser/scripts/build-inline-extensions.js) script).
     */
