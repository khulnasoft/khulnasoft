...
describe('GitHub DOM functions', () => {
    describe('diffDomFunctions', () => {
        ...
        const diffFixtures: Record<GitHubVersion, Record<GitHubDiffPage, GitHubCodeViewFixture>> = {
            ...
            'github.com': {
                commit: {
                    url: 'https://github.com/khulnasoft/khulnasoft/commit/d3d0fe7fad2c909e3a2e4de2259dc6604983a092',
                    lineCases: [
                ...
                'pull-request': {
                    url: 'https://github.com/khulnasoft/khulnasoft/pull/3272/files',
                    lineCases: [
                ...
                'pull-request-discussion': {
                    url: 'https://github.com/khulnasoft/khulnasoft/pull/3221',
                    lineCases: [
        ...
        for (const version of ['github.com', 'ghe-2.14.11']) {
            describe(`Version ${version}`, () => {
                const views = [
                    {
                        view: 'pull-request',
                        url: 'https://github.com/khulnasoft/khulnasoft/pull/2672/files',
                    },
                    {
                        view: 'commit',
                        url: 'https://github.com/khulnasoft/khulnasoft/commit/2c74f329fd03008fa0b446cd5e53234715dae3dc',
                    },
                    {
                        view: 'pull-request-discussion',
                        url: 'https://github.com/khulnasoft/khulnasoft/pull/2672/',
                    },
                ]
