 ...
 * ambiguous. For example: https://github.com/khulnasoft/khulnasoft/blob/bext/release/cmd/frontend/internal/session/session.go
 *
 ...
 * E.g., in URL "https://github.com/khulnasoft/khulnasoft/blob/bext/release/package.json" branch name is "bext/release".
 */
