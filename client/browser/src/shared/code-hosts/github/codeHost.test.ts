        ...
        describe('on blob page', () => {
            beforeAll(() => {
                windowLocation__testingOnly.value = new URL(
                    'https://github.com/khulnasoft/khulnasoft/blob/main/browser/src/shared/code-hosts/code_intelligence.tsx'
                )
            })
            ...
            it('returns an URL to a blob on the same code host if possible', () => {
                expect(
                    ...
                    'https://github.com/khulnasoft/khulnasoft/blob/main/browser/src/shared/code-hosts/code_intelligence.tsx#L5:12'
                )
            })
        })
        describe('on pull request page', () => {
            beforeAll(async () => {
                windowLocation__testingOnly.value = new URL('https://github.com/khulnasoft/khulnasoft/pull/3257/files')
            ...
            it('returns a URL to the same PR if possible', () => {
                expect(
                    ...
                    'https://github.com/khulnasoft/khulnasoft/pull/3257/files#diff-93ceb95cf0be7b7b17815c5638fc4c5cR1335'
                )
            })
        })
    })
