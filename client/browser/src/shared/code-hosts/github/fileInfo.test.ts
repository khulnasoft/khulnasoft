...
describe('github/fileInfo', () => {
    ...
    describe('getFilePathFromURL()', () => {
        const toReturn = [
            {
                url: 'https://github.com/khulnasoft/khulnasoft/blob/4.4/client/browser/src/browser-extension/browser-action-icon.ts',
                rev: '4.4',
                filePath: 'client/browser/src/browser-extension/browser-action-icon.ts',
            },
            {
                url: 'https://github.com/khulnasoft/khulnasoft/blob/bext/release/client/browser/src/browser-extension/browser-action-icon.ts',
                rev: 'bext/release',
                filePath: 'client/browser/src/browser-extension/browser-action-icon.ts',
            },
            {
        ...
        const toThrow = [
            {
                url: 'https://github.com/khulnasoft/khulnasoft/blob/4.4',
                rev: '4.4',
                reason: 'no file in blob page URL',
            },
            {
                url: 'https://github.com/khulnasoft/khulnasoft/blob/main/client/browser/src/browser-extension/browser-action-icon.ts',
                rev: 'bext/release',
