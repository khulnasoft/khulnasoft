...
/**
 * Dispatches a custom event to signal to Khulnasoft web app
 * that the browser extension is installed.
 */
export function signalBrowserExtensionInstalled(): void {
    if (document.readyState === 'complete' || document.readyState === 'interactive') {
        dispatchKhulnasoftEvents()
    } else {
        window.addEventListener('load', dispatchKhulnasoftEvents, { once: true })
    }
}

function dispatchKhulnasoftEvents(): void {
...
export const checkIsKhulnasoft = (
