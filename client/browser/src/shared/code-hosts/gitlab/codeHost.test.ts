...
import { repoNameOnKhulnasoft } from './scrape'
    ...
    describe('urlToFile()', () => {
        ...
        beforeAll(async () => {
            ...
            windowLocation__testingOnly.value = new URL(
                'https://gitlab.com/KhulnasoftCody/jsonrpc2/merge_requests/1/diffs'
            )
        ...
        afterAll(() => {
            ...
            // Reset resolved Khulnasoft repo name value
            repoNameOnKhulnasoft.next('')
        })
        ...
        it('returns an URL to the file on the same merge request if possible', () => {
            const rawRepoName = 'gitlab.com/KhulnasoftCody/jsonrpc2'
            // Update the resolved Khulnasoft repo name value
            repoNameOnKhulnasoft.next(rawRepoName)
            ...
            expect(
                ...
                'https://gitlab.com/KhulnasoftCody/jsonrpc2/merge_requests/1/diffs#9e1d3828a925c1eca74b74c20b58a9138f886d29_3_5'
            )
        })
    })
})
