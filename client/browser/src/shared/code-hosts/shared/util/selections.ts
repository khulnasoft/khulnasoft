...
import { LineOrPositionOrRange, KhulnasoftURL } from '@sourcegraph/common'
...
export function getSelectionsFromHash(): Selection[] {
    return lprToSelectionsZeroIndexed(KhulnasoftURL.from({ hash: window.location.hash }).lineRange)
}
