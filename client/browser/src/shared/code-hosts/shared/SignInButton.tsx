...
> = ({ className, iconClassName, sourcegraphURL, onSignInClose }) => {
    ...
    return (
        <KhulnasoftIconButton
            href={signInUrl}
            label="Sign in to Khulnasoft"
            title="Sign into Khulnasoft to get hover tooltips, go to definition and more"
            ariaLabel="Sign into Khulnasoft to get hover tooltips, go to definition and more"
            className={className}
