...
describe('GitLab', () => {
    ...
    beforeEach(async function () {
        ...
        testContext.overrideGraphQL({
            ...
            ResolveRepoName: () => ({
                repository: {
                    name: 'gitlab.com/KhulnasoftCody/jsonrpc2',
                },
            }),
            ResolveRev: () => ({
                repository: {
    ...
    it('adds "view on Khulnasoft" buttons to files', async () => {
        if (readEnvironmentString({ variable: 'POLLYJS_MODE', defaultValue: 'replay' }) === 'replay') {
            // mock Khulnasoft icon and bootstrap.js loaded by the extension
        ...
        const repoName = 'gitlab.com/KhulnasoftCody/jsonrpc2'

        const url =
            'https://gitlab.com/KhulnasoftCody/jsonrpc2/blob/4fb7cd90793ee6ab445f466b900e6bffb9b63d78/call_opt.go'
