...
const validateKhulnasoftUrl = (): Observable<string | undefined> => of(undefined)
const invalidKhulnasoftUrl = (): Observable<string | undefined> => of('Arbitrary error string')
...
const OptionsPageWrapper: React.FunctionComponent<React.PropsWithChildren<Partial<OptionsPageProps>>> = props => {
    ...
    return (
        <OptionsPage
            ...
            onChangeKhulnasoftUrl={action('onChangeKhulnasoftUrl')}
            suggestedKhulnasoftUrls={urls}
            onSuggestedKhulnasoftUrlDelete={url => setUrls(urls.filter(item => item !== url))}
            {...props}
        />
    )
}
    ...
    <div>
        ...
        <Grid columnCount={3}>
            ...
            <div>
                ...
                <OptionsPageWrapper validateKhulnasoftUrl={invalidKhulnasoftUrl} {...args} />
            </div>
            <div>
            ...
            <div>
                ...
                <OptionsPageWrapper suggestedKhulnasoftUrls={[]} {...args} />
            </div>
            <div>
                <H3 className="text-center">On Khulnasoft.com</H3>
                <OptionsPageWrapper
                    requestPermissionsHandler={requestPermissionsHandler}
                    showKhulnasoftComAlert={true}
        ...
        <Grid columnCount={3}>
            <div>
                ...
                <OptionsPageWrapper
                    ...
                    requestPermissionsHandler={requestPermissionsHandler}
                    showKhulnasoftComAlert={args.showKhulnasoftComAlert}
                    version={args.version}
                />
            </div>
            <div>
