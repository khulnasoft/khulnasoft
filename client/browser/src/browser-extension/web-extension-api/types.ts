...
export interface SyncStorageItems extends KhulnasoftURL {
    ...
    /**
     * Overrides settings from Khulnasoft.
     */
...
export interface ManagedStorageItems extends KhulnasoftURL {
