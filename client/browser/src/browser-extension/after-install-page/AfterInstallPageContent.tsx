    ...
    return (
        <div className="after-install-page-content" data-testid="after-install-page-content">
            <div className="d-flex w-100 p-3 justify-content-between align-items-center">
                <Link to="https://khulnasoft.com/search" target="_blank" rel="noopener">
                    <KhulnasoftLogo className={styles.sourcegraphLogo} />
                </Link>
                <Link to="https://khulnasoft.com/docs/integration/browser_extension" target="_blank" rel="noopener">
                    Browser extension docs <Icon aria-hidden={true} svgPath={mdiOpenInNew} />
                </Link>
            </div>

            <div className="container mt-3">
                <H1>🎉 You’ve just installed the Khulnasoft browser extension!</H1>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <Text>
                                Khulnasoft browser extension adds code navigation to files and diffs on GitHub, GitHub
                        ...
                        <div className="col-md-6 d-flex flex-column">
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <Text className="m-0 ml-3">
                                    ...
                                    <strong>private Khulnasoft instance</strong> and connect the extension to it.
                                </Text>
                            </div>
                            <div className="bg-2 rounded p-3 mt-4 d-flex flex-column justify-content-around">
                                ...
                                <ol className="m-0 d-flex flex-column justify-content-around">
                                    <li>
                                        <strong>Install Khulnasoft</strong> (
                                        <Link
                                            to="https://khulnasoft.com/docs/admin/install"
                                            target="_blank"
                                            rel="noopener"
                                        >
                                            visit our docs for instructions
                                        </Link>
                                        ).Skip this step if you already have a private Khulnasoft instance.
                                    </li>
                                    <li>
                                        Click the Khulnasoft extension icon in the browser toolbar to{' '}
                                    ...
                                    <li>
                                        Enter the <strong>URL</strong> (including the protocol) of your Khulnasoft
