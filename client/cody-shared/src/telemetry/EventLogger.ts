...
export class EventLogger {
    private gqlAPIClient: KhulnasoftGraphQLAPIClient
    ...
    constructor(
        ...
        this.gqlAPIClient = new KhulnasoftGraphQLAPIClient(this.config)
    ...
    private async setSiteIdentification(): Promise<void> {
        ...
        if (isError(siteIdentification)) {
            /**
             * Swallow errors. Any instance with a version before https://github.com/khulnasoft/khulnasoft/commit/05184f310f631bb36c6d726792e49ff9d122e4af
