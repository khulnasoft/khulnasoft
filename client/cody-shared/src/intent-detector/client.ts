...
import type { KhulnasoftCompletionsClient } from '../sourcegraph-api/completions/client'
import type { KhulnasoftGraphQLAPIClient } from '../sourcegraph-api/graphql'
...
export class KhulnasoftIntentDetectorClient implements IntentDetector {
    constructor(private client: KhulnasoftGraphQLAPIClient, private completionsClient?: KhulnasoftCompletionsClient) {}
