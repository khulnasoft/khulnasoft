...
/**
 * Access the chat based LLM APIs via a Khulnasoft server instance.
 */
export abstract class KhulnasoftCompletionsClient {
    ...
    protected get completionsEndpoint(): string {
        ...
        // Khulnasoft >=5.4 instances require client name and version params on the completions endpoint to ensure client supports Cody Ignore functionality.
        ...
        // See https://github.com/khulnasoft/khulnasoft/pull/62048.
...
export function bufferStream(
    client: Pick<KhulnasoftCompletionsClient, 'stream'>,
