...
const STATUS_LINK_MAPPING: Record<ProductStatusLinked, string> = {
    experimental: 'https://khulnasoft.com/docs/admin/beta_and_experimental_features#experimental-features',
    beta: 'https://khulnasoft.com/docs/admin/beta_and_experimental_features#beta-features',
    'private-beta': 'https://khulnasoft.com/docs/admin/beta_and_experimental_features#beta-features',
} as const
