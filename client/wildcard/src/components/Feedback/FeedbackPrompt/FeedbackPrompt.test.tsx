...
describe('FeedbackPrompt', () => {
    ...
    const submitFeedback = () => {
        fireEvent.change(screen.getByLabelText('Send feedback to Khulnasoft'), {
    ...
    test('should enable/disable submit button correctly', () => {
        ...
        userEvent.type(screen.getByLabelText('Send feedback to Khulnasoft'), sampleFeedback.feedback)
