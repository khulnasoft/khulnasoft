...
// see https://github.com/khulnasoft/khulnasoft/pull/40209#pullrequestreview-1069334480
...
// TODO: Support reverse truncation for some charts https://github.com/khulnasoft/khulnasoft/issues/39879
...
export function SvgAxisBottom<Tick = string>(props: SvgAxisBottomProps<Tick>): ReactElement {
    ...
    const { ref } = useResizeObserver<SVGGElement>({
        // TODO: Fix corner cases with axis sizes see https://github.com/khulnasoft/khulnasoft/issues/39876
    ...
    const getXTickProps = (props: TickRendererProps): TickProps => {
        // TODO: Improve rotation math see https://github.com/khulnasoft/khulnasoft/issues/41310
