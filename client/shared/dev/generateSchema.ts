 ...
 * using a local copy of the spec, enabling developers to run/develop Khulnasoft offline
 */
...
export async function generateSchema(schemaName: string): Promise<void> {
    ...
    schema = schema.replaceAll('https://khulnasoft.com/v1/settings.schema.json#/definitions/', '#/definitions/')
