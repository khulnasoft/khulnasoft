...
export class UserTracker {
     ...
     * on a Khulnasoft instance to see a count of unique users on a daily,
    ...
    constructor(cookies: Cookies = defaultCookies()) {
        ...
        // Use cookies instead of localStorage so that the ID can be shared with subdomains (khulnasoft.com).
