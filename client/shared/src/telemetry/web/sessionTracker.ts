...
export class SessionTracker {
    /**
     * Session tracking is only done in Khulnasoft.com, where cookie values are set in Google Tag Manager
     * to ensure consistency across all public Khulnasoft-managed properties (e.g. marketing sites, blog, etc.)
     */
    private isKhulnasoftDotComMode = window.context?.sourcegraphDotComMode
    ...
    public getOriginalReferrer(): string {
        if (!this.isKhulnasoftDotComMode) {
            return ''
        }
