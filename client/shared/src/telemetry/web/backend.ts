...
/**
 * Log a raw user action (used to allow site admins on a Khulnasoft instance
 * to see a count of unique users on a daily, weekly, and monthly basis).
 *
 * When invoked on a non-Khulnasoft.com instance, this data is stored in the
 * instance's database, and not sent to Khulnasoft.com.
 *
