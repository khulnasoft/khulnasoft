...
/**
 * TelemetryRecorderProvider type used in Khulnasoft clients.
 */
export type TelemetryRecorderProvider = typeof noOptelemetryRecorderProvider

/**
 * TelemetryRecorder type used in Khulnasoft clients.
 */
 ...
 * new telemetry framework: https://docs-legacy.khulnasoft.com/dev/background-information/telemetry
