...
export class Driver {
    ...
    /**
     * Navigates to the Khulnasoft browser extension page.
     */
    ...
    /**
     * Navigates to the Khulnasoft browser extension options page and sets the sourcegraph URL.
     */
    public async setExtensionKhulnasoftUrl(): Promise<void> {
    ...
    public async ensureHasExternalService({
        ...
        if (ensureRepos) {
            ...
            for (const slug of ensureRepos) {
                ...
                // Workaround for https://github.com/khulnasoft/khulnasoft/issues/5286
...
interface DriverOptions extends LaunchOptions, BrowserConnectOptions, BrowserLaunchArgumentOptions {
    ...
    /** If true, load the Khulnasoft browser extension. */
