...
const configFields: ConfigFields = {
    ...
    gitHubClientID: {
        ...
        description:
            'Client ID of the GitHub app to use to authenticate to Khulnasoft. Follow these instructions to obtain: https://developer.github.com/apps/building-oauth-apps/creating-an-oauth-app/',
    ...
    gitHubClientSecret: {
        ...
        description:
            'Cilent secret of the GitHub app to use to authenticate to Khulnasoft. Follow these instructions to obtain: https://developer.github.com/apps/building-oauth-apps/creating-an-oauth-app/',
    },
    gitHubDotComToken: {
        envVar: 'GH_TOKEN',
    ...
    gitHubUserAmyPassword: {
        ...
        description: 'Password of the GitHub user sg-e2e-regression-test-amy, used to log in to Khulnasoft.',
    },
    gitHubUserBobPassword: {
        envVar: 'GITHUB_USER_BOB_PASSWORD',
        description: 'Password of the GitHub user sg-e2e-regression-test-bob, used to log in to Khulnasoft.',
    },
    gitHubUserBobToken: {
        envVar: 'GITHUB_USER_BOB_TOKEN',
        description:
            "GitHub personal access token with repo scope for user sg-e2e-regression-test-bob. Used to clone Bob's repositories to Khulnasoft.",
    },
    gitLabToken: {
        envVar: 'GITLAB_TOKEN',
        description:
    ...
    gitLabClientID: {
        ...
        description:
            'Application ID of the GitLab OAuth app used to authenticate Khulnasoft. Follow these instructions to obtain: https://docs.gitlab.com/ee/integration/oauth_provider.html',
    },
    gitLabClientSecret: {
        envVar: 'GITLAB_CLIENT_SECRET',
        description:
            'Secret of the GitLab OAuth app used to authenticate Khulnasoft. Follow these instructions to obtain: https://docs.gitlab.com/ee/integration/oauth_provider.html',
    },
    gitLabUserAmyPassword: {
        envVar: 'GITLAB_USER_AMY_PASSWORD',
        description: 'Password of the GitLab user sg-e2e-regression-test-amy, used to log in to Khulnasoft.',
    },
    oktaMetadataUrl: {
    ...
    init: {
        ...
        parser: parseBool,
        defaultValue: false,
        description: 'If true, run the test for initializing a brand new instance of Khulnasoft',
    },
    testUserPassword: {
        envVar: 'TEST_USER_PASSWORD',
        description:
            'The password to use for any test users that are created. This password should be secure and unguessable when running against production Khulnasoft instances.',
    },
    noCleanup: {
        envVar: 'NO_CLEANUP',
        parser: parseBool,
