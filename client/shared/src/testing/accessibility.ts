...
How to manually audit: https://docs-legacy.khulnasoft.com/dev/background-information/web/accessibility/how-to-audit#auditing-a-user-journey
 ...
 *
 * See further documentation: https://docs-legacy.khulnasoft.com/dev/how-to/testing#accessibility-tests
 */
export async function accessibilityAudit(page: Page, config: AccessibilityAuditConfiguration = {}): Promise<void> {
    ...
    const axe = new AxePuppeteer(page)
         ...
         * https://github.com/khulnasoft/khulnasoft/issues/36534
