...
export interface KhulnasoftProviders {
...
export const emptyKhulnasoftProviders: KhulnasoftProviders = {
    definition: {
        provideDefinition() {
            return of(null)
        },
...
/**
 * Creates a KhulnasoftProviders with LSIF and search-based behaviors.
 *
 ...
 * @param logger The logger instance.
 * @param languageID The language the extension recognizes.
 * @param api The Khulnasoft API instance.
