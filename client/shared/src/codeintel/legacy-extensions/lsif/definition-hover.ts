...
/**
 * Convert a GraphQL definition and hover response into an object consisting of a list of Khulnasoft
...
/**
 * Convert a GraphQL Markdown payload into a Khulnasoft hover.
 *
