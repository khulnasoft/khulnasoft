...
export class API {
     ...
     * throws an error if the repository is not known to the Khulnasoft instance.
     ...
     * the Khulnasoft instance. Returns undefined if the input rev or the file is
     * not known to the Khulnasoft instance.
     ...
     * @param fileLocal Set to false to not request this field, which is absent in older versions of Khulnasoft.
     */
