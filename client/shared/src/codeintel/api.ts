...
import { createProviders, emptyKhulnasoftProviders, type KhulnasoftProviders } from './legacy-extensions/providers'
...
function requestFor(textParameters: TextDocumentPositionParameters): LanguageRequest {
    ...
    return {
        ...
        providers: findLanguageMatchingDocument(document)?.providers || emptyKhulnasoftProviders,
    }
}
