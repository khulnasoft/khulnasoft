...
/*
    ...
    GitHub issue: https://github.com/khulnasoft/khulnasoft/issues/33343
*/
        ...
        data: [
            {
                ...
                message: 'add more tests, use the Khulnasoft stubs api and improve repo matching. (#13)',
                authorName: 'Vanesa',
                authorDate: '2019-10-29T20:59:15Z',
...
export const symbolSearchStreamEvents: SearchEvent[] = [
    {
        ...
        data: [
            ...
            {
                type: 'symbol',
                path: 'src/typings/KhulnasoftGQL.d.ts',
                repository: 'gitlab.sgdev.org/sourcegraph/sourcegraph-code-discussions',
                branches: [''],
                commit: 'f8c71486372087822b7995f0d572c6422b7ae0e5',
                symbols: [
                    {
                        url: '/gitlab.sgdev.org/sourcegraph/sourcegraph-code-discussions/-/blob/src/typings/KhulnasoftGQL.d.ts#L493:9-493:31',
                        name: 'lastIndexedRevOrLatest',
                        containerName: 'KhulnasoftGQL.IRepository',
                        kind: 'CLASS' as SymbolKind,
                        line: 493,
                    },
                    {
                        url: '/gitlab.sgdev.org/sourcegraph/sourcegraph-code-discussions/-/blob/src/typings/KhulnasoftGQL.d.ts#L1046:9-1046:23',
                        name: 'latestSettings',
                        containerName: 'KhulnasoftGQL.IUser',
                        kind: 'FUNCTION' as SymbolKind,
                        line: 1046,
                    },
                    {
                        url: '/gitlab.sgdev.org/sourcegraph/sourcegraph-code-discussions/-/blob/src/typings/KhulnasoftGQL.d.ts#L1170:9-1170:23',
                        name: 'latestSettings',
                        containerName: 'KhulnasoftGQL.IConfigurationSubject',
                        kind: 'ENUM' as SymbolKind,
                        line: 1170,
                    },
                    {
                        url: '/gitlab.sgdev.org/sourcegraph/sourcegraph-code-discussions/-/blob/src/typings/KhulnasoftGQL.d.ts#L1317:9-1317:23',
                        name: 'latestSettings',
                        containerName: 'KhulnasoftGQL.IOrg',
                        kind: 'PROPERTY' as SymbolKind,
                        line: 1317,
                    },
                    {
                        url: '/gitlab.sgdev.org/sourcegraph/sourcegraph-code-discussions/-/blob/src/typings/KhulnasoftGQL.d.ts#L4633:9-4633:23',
                        name: 'latestSettings',
                        containerName: 'KhulnasoftGQL.ISite',
                        kind: 'PROPERTY' as SymbolKind,
                        line: 4633,
                    },
                ],
