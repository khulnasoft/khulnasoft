...
const toStructuralHover = (token: MetaStructural): string => {
    switch (token.kind) {
        case MetaStructuralKind.Hole: {
            return '**Structural hole**. Matches code structures contextually. See the [syntax reference](https://khulnasoft.com/docs/code-search/queries#structural-search) for a complete description.'
        }
...
const toRevisionHover = (token: MetaRevision): string => {
    switch (token.kind) {
        ...
        case MetaKhulnasoftRevision.IncludeGlobMarker: {
        ...
        case MetaKhulnasoftRevision.ExcludeGlobMarker: {
        ...
        case MetaKhulnasoftRevision.Separator: {
