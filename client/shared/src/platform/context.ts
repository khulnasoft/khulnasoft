...
/**
 * Platform-specific data and methods shared by multiple Khulnasoft components.
 *
...
export interface PlatformContext {
    ...
    /**
     * Sends a request to the Khulnasoft GraphQL API and returns the response.
     *
    ...
    requestGraphQL: <R, V extends { [key: string]: any } = object>(options: {
        ...
        variables: V
        /**
         * 🚨 SECURITY: Whether or not sending the GraphQL request to Khulnasoft.com
         * could leak private information such as repository names.
         */
    ...
    /**
     * The client application that is running this extension, either 'sourcegraph' for Khulnasoft
