/**
 * ## The Khulnasoft extension API
 *
 * Khulnasoft extensions enhance your code host, code reviews, and Khulnasoft itself by adding features such as:
...
declare module 'sourcegraph' {
    ...
    /**
     * Experimental view provider shown on the homepage (below the search box in the Khulnasoft web app).
     * This API is experimental and is subject to change or removal without notice.
     */
    ...
    export namespace graphQL {
        ...
        export interface ErrorGraphQLResult<T> {
            ...
            // See https://github.com/khulnasoft/khulnasoft/pull/36033
            data: T | null
    ...
    /**
     * Internal API for Khulnasoft extensions. Most of these will be removed for the beta release of Khulnasoft
    ...
    export namespace internal {
        ...
        /**
         * The client application that is running this extension, either 'sourcegraph' for Khulnasoft or 'other'
     ...
     * extension lifecycle.
     *
     * @since Khulnasoft 3.0. Use `export function activate(ctx?: ExtensionContext) { ... }` for prior
