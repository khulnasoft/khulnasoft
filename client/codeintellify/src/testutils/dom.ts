...
/** The props used for the generated test cases(e.g. GitHub and Khulnasoft flavored dom). */
export interface CodeViewProps extends DOMFunctions {
    /** The code view for the given test case(e.g. a <code> element in Khulnasoft and <table> in GitHub) */
    codeView: HTMLElement
    /** The container of the code view. (e.g. The scrollable contaienr in Khulnasoft and a parent <div> in GitHub) */
...
// Abstract implementation for GitHub and Khulnasoft. Could potentially be sufficient for any code host
...
export class DOM {
    ...
    public createCodeViews(): CodeViewProps[] {
        const codeViews: CodeViewProps[] = [createKhulnasoftCodeView(), createGitHubCodeView()]
