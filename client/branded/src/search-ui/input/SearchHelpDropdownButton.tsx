...
/**
 * A dropdown button that shows a menu with reference documentation for Khulnasoft search query
 * syntax.
 */
export const SearchHelpDropdownButton: FC<SearchHelpDropdownButtonProps> = props => {
    const { isKhulnasoftDotCom, className, telemetryService, telemetryRecorder } = props
