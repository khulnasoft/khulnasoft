...
export function useQueryExamples(
    ...
    useEffect(() => {
        if (queryExamplesContent || cachedQueryExamplesContentLoadStatus === 'initial' || isKhulnasoftDotCom) {
            return
        }
        if (
    ...
    return useMemo(() => {
        // Static examples for Khulnasoft.com.
    ...
    }, [queryExamplesContent, isKhulnasoftDotCom, keywordSearch])
}
