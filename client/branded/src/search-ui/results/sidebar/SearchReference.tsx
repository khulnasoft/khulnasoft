...
To use this filter, the search query must contain \`type:diff\` or \`type:commit\`.`,
    ...
    },
    {
        ...
        description:
            'Retrieve *N* results. By default, Khulnasoft stops searching early and returns if it finds a full page of results. This is desirable for most interactive searches. To wait for all results, use **count:all**.',
        commonRank: 60,
