...
2. Open an issue to investigate the flaky test (use the [flaky test issue template](https://github.com/khulnasoft/khulnasoft/issues/new/choose)), and assign it to the most likely owner.
...
+               bk.Skip("2021-09-29 example message https://github.com/khulnasoft/khulnasoft/issues/123"),
        )
 }
```
...
[![buildchecker](https://github.com/khulnasoft/khulnasoft/actions/workflows/buildchecker.yml/badge.svg)](https://github.com/khulnasoft/khulnasoft/actions/workflows/buildchecker.yml) [![buildchecker-history](https://github.com/khulnasoft/khulnasoft/actions/workflows/buildchecker-history.yml/badge.svg)](https://github.com/khulnasoft/khulnasoft/actions/workflows/buildchecker-history.yml)

[`buildchecker`](https://github.com/khulnasoft/khulnasoft/actions/workflows/buildchecker.yml), our [branch lock management tool](#branch-locks), runs in GitHub actions—see the [workflow specification](https://github.com/khulnasoft/khulnasoft/blob/main/.github/workflows/buildchecker.yml).

To learn more about `buildchecker`, refer to the [`buildchecker` source code and documentation](https://github.com/khulnasoft/khulnasoft/tree/main/dev/buildchecker).

### `pr-auditor`

[![pr-auditor](https://github.com/khulnasoft/khulnasoft/actions/workflows/pr-auditor.yml/badge.svg)](https://github.com/khulnasoft/khulnasoft/actions/workflows/pr-auditor.yml)

[`pr-auditor`](https://github.com/khulnasoft/khulnasoft/actions/workflows/pr-auditor.yml), our [PR audit tool](../testing_principles.md#policy), runs in GitHub actions—see the [workflow specification](https://github.com/khulnasoft/khulnasoft/blob/main/.github/workflows/pr-auditor.yml).

To learn more about `pr-auditor`, refer to the [`pr-auditor` source code and documentation](https://github.com/khulnasoft/khulnasoft/tree/main/dev/pr-auditor).

### Third-party licenses

[![Licenses Update](https://github.com/khulnasoft/khulnasoft/actions/workflows/licenses-update.yml/badge.svg)](https://github.com/khulnasoft/khulnasoft/actions/workflows/licenses-update.yml) [![Licenses Check](https://github.com/khulnasoft/khulnasoft/actions/workflows/licenses-check.yml/badge.svg)](https://github.com/khulnasoft/khulnasoft/actions/workflows/licenses-check.yml)

We use the [`license_finder`](https://github.com/pivotal/LicenseFinder) tool to check third-party dependencies for their licenses. It runs as a [GitHub Action on pull requests](https://github.com/khulnasoft/khulnasoft/actions?query=workflow%3A%22Licenses+Check%22), which will fail if one of the following occur:
