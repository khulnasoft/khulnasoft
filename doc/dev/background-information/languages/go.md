...
This file documents the style used in Khulnasoft's code. For non-code text, see the overall [content guidelines](https://handbook.sourcegraph.com/communication/content_guidelines).
