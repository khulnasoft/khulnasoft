...
Comments starting with `#!` in [schema.graphql](https://github.com/khulnasoft/khulnasoft/blob/main/cmd/frontend/graphqlbackend/schema.graphql) will be stripped out before the GraphQL documentation is generated. `#!` is useful for implementation details and security notes that shouldn't be displayed to API users.
