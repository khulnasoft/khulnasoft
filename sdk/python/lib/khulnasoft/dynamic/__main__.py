...
from khulnasoft.metadata import get_project
from khulnasoft.runtime._serialization import _deserialize
from khulnasoft.runtime import configure, proto, rpc, Settings
from khulnasoft.runtime.proto import provider_pb2_grpc, ResourceProviderServicer
from khulnasoft.dynamic import ResourceProvider, ConfigureRequest, Config
...
def get_provider(props: Dict[str, Any], config: Dict[str, Any]) -> ResourceProvider:
    ...
    if provider is None:
        ...
        # like https://github.com/khulnasoft/khulnasoft/issues/14159 there may be resource contention in dill.loads,
