...
class Output(Generic[T_co]):
    ...
    def get(self) -> T_co:
        ...
        values will be known and can be safely retrieved. During khulnasoft deployment or preview
    ...
    def apply(
        ...
        This function will be called during execution of a `khulnasoft up` or `khulnasoft preview` request.
