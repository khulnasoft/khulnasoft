...
def _requires_legacy_none_return_for_empty_struct(
    ...
    See https://github.com/khulnasoft/khulnasoft/issues/14508.
    """
    ...
    # If we have a version and it's less than or equal to khulnasoft-kubernetes 4.5.4, we need the legacy behavior;
