...
Because the Pulumi top-level module depends on the `khulnasoft.runtime` submodule,
it is not allowed for `khulnasoft.runtime` to reach back to the `khulnasoft` top-level
