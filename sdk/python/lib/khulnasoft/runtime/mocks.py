...
from ..runtime.stack import Stack, run_khulnasoft_func
...
class MockMonitor:
    ...
    def make_urn(self, parent: str, type_: str, name: str) -> str:
        ...
        return "urn:khulnasoft:" + "::".join([get_stack(), get_project(), type_, name])
    ...
    def Invoke(self, request):
        ...
        if request.tok == "khulnasoft:khulnasoft:getResource":
    ...
    def RegisterResource(self, request):
        ...
        if request.type == "khulnasoft:khulnasoft:Stack":
