...
2. Programs defined as a function alongside your Automation API code (inline source)::
    ...
    def khulnasoft_program():
        ...
        khulnasoft.export("bucket_name", bucket.Bucket)

    stack = create_stack("myOrg/myProj/myStack", program=khulnasoft_program)
    ```
...
Workspaces can be explicitly created and customized beyond the three Stack creation helpers noted above::
    ...
    ws = LocalWorkspace(work_dir=os.path.join(".", "project", "path"), khulnasoft_home="~/.khulnasoft")
...
from khulnasoft.automation._remote_workspace import (
...
from khulnasoft.automation._remote_stack import RemoteStack
