...
func (log *logState) Debug(msg string, args *LogArgs) error {
	return log._log(khulnasoftrpc.LogSeverity_DEBUG, msg, args)
}
...
func (log *logState) Info(msg string, args *LogArgs) error {
	return log._log(khulnasoftrpc.LogSeverity_INFO, msg, args)
}

// Warn logs a warning to indicate that something went wrong, but not catastrophically so.
func (log *logState) Warn(msg string, args *LogArgs) error {
	return log._log(khulnasoftrpc.LogSeverity_WARNING, msg, args)
}
...
func (log *logState) Error(msg string, args *LogArgs) error {
	return log._log(khulnasoftrpc.LogSeverity_ERROR, msg, args)
}

func (log *logState) _log(severity khulnasoftrpc.LogSeverity, message string, args *LogArgs) error {
	if log.join != nil {
		log.join.Add(1)
		defer log.join.Done()
	}
	...
	logRequest := &khulnasoftrpc.LogRequest{
		Severity:  severity,
