...
// will cause "khulnasoft up" to fail if called and used during a non-dryrun deployment.
...
//
//	type Nested struct {
//	    Foo int `khulnasoft:"foo"`
//	    Bar string `khulnasoft:"bar"`
//	}
//
//	type NestedInputValue struct {
//	    Foo khulnasoft.IntInput `khulnasoft:"foo"`
//	    Bar khulnasoft.StringInput `khulnasoft:"bar"`
//	}
//
...
//	    return khulnasoft.ToOutput(v).(NestedOutput)
//	}
//
//	func (v NestedInputValue) ToNestedOutputWithContext(ctx context.Context) NestedOutput {
//	    return khulnasoft.ToOutputWithContext(ctx, v).(NestedOutput)
//	}
//
//	type NestedOutput struct { *khulnasoft.OutputState }
//
...
var _ khulnasoftx.Input[any] = AnyOutput{}
...
func (o AnyOutput) ToOutput(context.Context) khulnasoftx.Output[any] {
	return khulnasoftx.Output[any]{
...
var _ khulnasoftx.Input[Resource] = ResourceOutput{}
...
func (o ResourceOutput) ToOutput(context.Context) khulnasoftx.Output[Resource] {
...
var _ khulnasoftx.Input[[]Resource] = ResourceArray{}
...
func (in ResourceArray) ToOutput(ctx context.Context) khulnasoftx.Output[[]Resource] {
	return khulnasoftx.Output[[]Resource]{
...
var _ khulnasoftx.Input[[]Resource] = ResourceArrayOutput{}
...
func (o ResourceArrayOutput) ToOutput(context.Context) khulnasoftx.Output[[]Resource] {
	return khulnasoftx.Output[[]Resource]{
		OutputState: o.OutputState,
	}
}
