...
func WrapResourceMonitorClient(
	wrap func(khulnasoftrpc.ResourceMonitorClient) khulnasoftrpc.ResourceMonitorClient,
) RunOption {
...
type testResource2 struct {
	...
	Foo StringOutput `khulnasoft:"foo"`
}
...
type testMyCustomResource struct {
	...
	Instance testInstanceResourceOutput `khulnasoft:"instance"`
}

type testMyCustomResourceArgs struct {
	Instance testInstanceResource `khulnasoft:"instance"`
}
...
type testMyRemoteComponentArgs struct {
	Inprop string `khulnasoft:"inprop"`
}
...
type testMyRemoteComponent struct {
	...
	Outprop StringOutput `khulnasoft:"outprop"`
}
...
type testResource4Args struct {
	Inprop *testResource2 `khulnasoft:"inprop"`
}
