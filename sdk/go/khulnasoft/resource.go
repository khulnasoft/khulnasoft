...
// into khulnasoft.ResourceState without exporting the field to the public API.
//
//nolint:unused
...
//
// See https://www.khulnasoft.com/docs/intro/concepts/resources/options/
