...
type BoolEnumInputArgs struct {
	Value BoolEnumInput `khulnasoft:"value"`
}
...
type IntEnumInputArgs struct {
	Value IntEnumInput `khulnasoft:"value"`
}
...
type FloatEnumInputArgs struct {
	Value FloatEnumInput `khulnasoft:"value"`
}
...
type StringEnumInputArgs struct {
	Value StringEnumInput `khulnasoft:"value"`
}

type StringInputArgs struct {
	Value StringInput `khulnasoft:"value"`
}

type StringPtrInputArgs struct {
	Value StringPtrInput `khulnasoft:"value"`
}

type StringArrayInputArgs struct {
	Value StringArrayInput `khulnasoft:"value"`
}

type StringMapInputArgs struct {
	Value StringMapInput `khulnasoft:"value"`
}

type BoolInputArgs struct {
	Value BoolInput `khulnasoft:"value"`
}

type BoolPtrInputArgs struct {
	Value BoolPtrInput `khulnasoft:"value"`
}

type NestedOutputArgs struct {
	Value NestedOutput `khulnasoft:"value"`
}

type NestedPtrOutputArgs struct {
	Value NestedPtrOutput `khulnasoft:"value"`
}

type NestedArrayOutputArgs struct {
	Value NestedArrayOutput `khulnasoft:"value"`
}

type NestedMapOutputArgs struct {
	Value NestedMapOutput `khulnasoft:"value"`
}

type Nested struct {
	Foo string `khulnasoft:"foo"`
	Bar int    `khulnasoft:"bar,optional"`
}
...
type StringMapArgs struct {
	Value map[string]string `khulnasoft:"value"`
}

type IntArgs struct {
	Value int `khulnasoft:"value"`
}

type NestedArgs struct {
	Value Nested `khulnasoft:"value"`
}
...
type NestedMapArgs struct {
	Value map[string]Nested `khulnasoft:"value"`
}
...
type PlainMapArgs struct {
	Value map[string]StringInput `khulnasoft:"value"`
}

type AssetArgs struct {
	Value Asset `khulnasoft:"value"`
}

type AssetInputArgs struct {
	Value AssetInput `khulnasoft:"value"`
}

type ArchiveArgs struct {
	Value Archive `khulnasoft:"value"`
}

type ArchiveInputArgs struct {
	Value ArchiveInput `khulnasoft:"value"`
}

type AssetOrArchiveArgs struct {
	Value AssetOrArchive `khulnasoft:"value"`
}

type AssetOrArchiveInputArgs struct {
	Value AssetOrArchiveInput `khulnasoft:"value"`
}
...
type NestedInputtyInputArgs struct {
	Something StringPtrInput `khulnasoft:"something"`
}
...
type PlainOptionalNestedInputtyInputArgs struct {
	Value *NestedInputtyInputArgs `khulnasoft:"value"`
}
...
type PlainOptionalNestedInputtyArgs struct {
	Value *NestedInputtyArgs `khulnasoft:"value"`
}

type LaunchTemplateOptions struct {
	TagSpecifications []LaunchTemplateTagSpecification `khulnasoft:"tagSpecifications"`
}
...
type LaunchTemplateOptionsArgs struct {
	TagSpecifications LaunchTemplateTagSpecificationArrayInput `khulnasoft:"tagSpecifications"`
}
...
type LaunchTemplateArgs struct {
	Value LaunchTemplateOptionsPtrInput `khulnasoft:"value"`
}
...
func TestConstructInputsCopyTo(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args:          &StringArgs{},
			expectedError: "expected destination type to implement khulnasoft.Input or khulnasoft.Output, got string",
		},
		{
		...
		},
		{
			...
			args:  &StringArgs{},
			expectedError: "khulnasoft.StringArgs.Value is typed as string but must be a type that implements " +
				"khulnasoft.Input or khulnasoft.Output for input with dependencies",
		},
		...
		},
		{
			...
			args:          &NestedArgs{},
			expectedError: "expected destination type to implement khulnasoft.Input or khulnasoft.Output, got khulnasoft.Nested",
		},
		{
			...
			deps: urnSet{"fakeURN": struct{}{}},
			args: &NestedArgs{},
			expectedError: "khulnasoft.NestedArgs.Value is typed as khulnasoft.Nested but must be a type that implements " +
				"khulnasoft.Input or khulnasoft.Output for input with dependencies",
		},
...
type MyComponent struct {
	...
	Foo        string       `khulnasoft:"foo"`
	SomeValue  StringOutput `khulnasoft:"someValue"`
	Nope       StringOutput
	unexported StringOutput `khulnasoft:"unexported"`
}
...
type MyComponentWithResource struct {
	...
	Component Resource `khulnasoft:"component"`
}
...
func TestConstruct_resourceOptionsSnapshot(t *testing.T) {
	...
	snapshotFromRequest := func(t *testing.T, req *khulnasoftrpc.ConstructRequest) *ResourceOptions {
	...
	t.Run("Aliases", func(t *testing.T) {
		...
		snap := snapshotFromRequest(t, &khulnasoftrpc.ConstructRequest{
			Aliases: []string{"test"},
		})
	...
	t.Run("Providers", func(t *testing.T) {
		...
		urn := resource.NewURN("mystack", "myproject", "", "khulnasoft:providers:foo", "bar")
		snap := snapshotFromRequest(t, &khulnasoftrpc.ConstructRequest{
	...
	t.Run("CustomTimeouts", func(t *testing.T) {
		...
		tests := []struct {
			name string
			give *khulnasoftrpc.ConstructRequest_CustomTimeouts
			want *CustomTimeouts
		}{
			{
				name: "Create",
				give: &khulnasoftrpc.ConstructRequest_CustomTimeouts{Create: "1m"},
				want: &CustomTimeouts{Create: "1m"},
			},
			{
				name: "Update",
				give: &khulnasoftrpc.ConstructRequest_CustomTimeouts{Update: "2m"},
				want: &CustomTimeouts{Update: "2m"},
			},
			{
				name: "Delete",
				give: &khulnasoftrpc.ConstructRequest_CustomTimeouts{Delete: "3m"},
...
func TestConstruct_await(t *testing.T) {
	...
	constructWithState := func(t *testing.T, req *khulnasoftrpc.ConstructRequest, stateF func(ctx *Context, state Map)) error {
		// Keep test cases simple:
		req.Stack = "mystack"
		req.Project = "myproject"
	...
	t.Run("outstanding rpc", func(t *testing.T) {
		...
		err := constructWithState(t, &khulnasoftrpc.ConstructRequest{}, func(ctx *Context, state Map) {
...
func TestCall_await(t *testing.T) {
	...
	// meaning that it may or may not be tracked by the context's waitgroup.
	callWithResult := func(t *testing.T, req *khulnasoftrpc.CallRequest, resultF func(ctx *Context, state Map)) error {
		// Keep test cases simple:
		req.Stack = "mystack"
		req.Project = "myproject"
	...
	t.Run("outstanding rpc", func(t *testing.T) {
		...
		err := callWithResult(t, &khulnasoftrpc.CallRequest{}, func(ctx *Context, result Map) {
