...
func New(ctx *khulnasoft.Context, namespace string) *Config {
	if namespace == "" {
...
func (c *Config) GetSecret(key string) khulnasoft.StringOutput {
...
func (c *Config) GetSecretObject(key string, output interface{}) (khulnasoft.Output, error) {
...
func (c *Config) GetSecretBool(key string) khulnasoft.BoolOutput {
...
func (c *Config) GetSecretFloat64(key string) khulnasoft.Float64Output {
	return GetSecretFloat64(c.ctx, c.fullKey(key))
}

// GetSecretInt loads an optional int configuration value by its key
// or 0 if it doesn't exist, and returns it wrapped in a secret Output.
func (c *Config) GetSecretInt(key string) khulnasoft.IntOutput {
...
func (c *Config) RequireSecret(key string) khulnasoft.StringOutput {
...
func (c *Config) RequireSecretObject(key string, output interface{}) khulnasoft.Output {
...
func (c *Config) TrySecret(key string) (khulnasoft.StringOutput, error) {
...
func (c *Config) TrySecretObject(key string, output interface{}) (khulnasoft.Output, error) {
...
func (c *Config) TrySecretBool(key string) (khulnasoft.BoolOutput, error) {
...
// or returns an error if it doesn't exist.
func (c *Config) TrySecretFloat64(key string) (khulnasoft.Float64Output, error) {
...
// or returns an error if it doesn't exist.
func (c *Config) TrySecretInt(key string) (khulnasoft.IntOutput, error) {
