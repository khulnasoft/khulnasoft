...
func getBool(ctx *khulnasoft.Context, key, use, insteadOf string) bool {
	if v, ok := get(ctx, key, use, insteadOf); ok {
...
func GetBool(ctx *khulnasoft.Context, key string) bool {
	return getBool(ctx, key, "GetSecretBool", "GetBool")
}

func getFloat64(ctx *khulnasoft.Context, key, use, insteadOf string) float64 {
	if v, ok := get(ctx, key, use, insteadOf); ok {
...
func GetFloat64(ctx *khulnasoft.Context, key string) float64 {
	return getFloat64(ctx, key, "GetSecretFloat64", "GetFloat64")
}

func getInt(ctx *khulnasoft.Context, key, use, insteadOf string) int {
	if v, ok := get(ctx, key, use, insteadOf); ok {
		return cast.ToInt(v)
	}
	return 0
...
func GetInt(ctx *khulnasoft.Context, key string) int {
...
func GetSecretBool(ctx *khulnasoft.Context, key string) khulnasoft.BoolOutput {
	return khulnasoft.ToSecret(getBool(ctx, key, "", "")).(khulnasoft.BoolOutput)
}

// GetSecretFloat64 loads an optional float64 configuration value by its key,
// or false if it does not exist, into a secret Output.
func GetSecretFloat64(ctx *khulnasoft.Context, key string) khulnasoft.Float64Output {
	return khulnasoft.ToSecret(getFloat64(ctx, key, "", "")).(khulnasoft.Float64Output)
}

// GetSecretInt loads an optional int configuration value by its key,
// or false if it does not exist, into a secret Output.
func GetSecretInt(ctx *khulnasoft.Context, key string) khulnasoft.IntOutput {
	return khulnasoft.ToSecret(getInt(ctx, key, "", "")).(khulnasoft.IntOutput)
}
