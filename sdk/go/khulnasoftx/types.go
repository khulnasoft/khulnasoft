...
// All such types MUST embed *khulnasoft.OutputState.
//
// For example, OutputOf[int] is satisfied by khulnasoftx.Output[int]
// as well as khulnasoft.IntOutput.
...
//
// Output[T] implements khulnasoftx.Input[T], as well as khulnasoft.Input.
...
// Untyped converts an Output[T] to a khulnasoft.Output.
//
// The concrete type of the returned value will be the most specific known
// implementation of khulnasoft.Output that matches the element type of the input,
// assuming it was registered with khulnasoft.RegisterOutputType.
//
// Use this to call legacy APIs that expect a concrete khulnasoft.Output.
// For example,
//
//	var o khulnasoftx.Output[string] = // ...
//	legacyAPI(o.Untyped().(khulnasoft.StringOutput))
...
// ConvertTyped builds an [Output] with the given untyped khulnasoft.Output,
...
//
//	var o khulnasoftx.Output[[]string] = // ...
//	ao := khulnasoftx.Cast[khulnasoftx.ArrayOutput[string]](o)
//	sao := khulnasoftx.Cast[khulnasoft.StringArrayOutput](o)
