...
// Untyped converts a GPtrOutput[T] to a khulnasoft.Output.
//
...
// For example,
//
//	var s khulnasoft.StringOutput = ... // implements Input[string]
...
// Untyped converts a PtrOutput[T] to a khulnasoft.Output.
//
// See [Output.Untyped] for more details.
