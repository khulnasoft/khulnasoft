...
func NewResource(ctx *khulnasoft.Context,
	...
	err := ctx.RegisterResource("fail_on_create:index:Resource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResource(ctx *khulnasoft.Context,
	...
	var resource Resource
	err := ctx.ReadResource("fail_on_create:index:Resource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
