...
export class Resource extends khulnasoft.CustomResource {
    ...
    /** @internal */
    public static readonly __khulnasoftType = 'plain:index:Resource';
     ...
     */
    public readonly nonPlainData!: khulnasoft.Output<outputs.Data | undefined>;
...
export interface ResourceArgs {
     ...
     * A non plain input to compare against the plain inputs, as well as testing plain/non-plain nesting.
     */
    nonPlainData?: khulnasoft.Input<inputs.DataArgs>;
}
