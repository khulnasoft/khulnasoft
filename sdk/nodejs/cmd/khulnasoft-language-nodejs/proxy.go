...
func createAndServePipes(ctx context.Context, target khulnasoftrpc.ResourceMonitorClient) (pipes, chan error, error) {
...
func servePipes(ctx context.Context, pipes pipes, target khulnasoftrpc.ResourceMonitorClient) chan error {
	...
	go func() {
		...
		err := func() error {
			...
			for {
				...
				var req khulnasoftrpc.ResourceInvokeRequest
				...
				if err != nil {
					...
					if res == nil {
						res = &khulnasoftrpc.InvokeResponse{}
					}

					res.Failures = append(res.Failures, &khulnasoftrpc.CheckFailure{
						Property: "",
						Reason:   err.Error(),
					})
				}
...
type monitorProxy struct {
	...
	target khulnasoftrpc.ResourceMonitorClient
}
...
func (p *monitorProxy) StreamInvoke(
	req *khulnasoftrpc.ResourceInvokeRequest, server khulnasoftrpc.ResourceMonitor_StreamInvokeServer,
) error {
...
func (p *monitorProxy) Call(
	ctx context.Context, req *khulnasoftrpc.ResourceCallRequest,
) (*khulnasoftrpc.CallResponse, error) {
	return p.target.Call(ctx, req)
}

func (p *monitorProxy) ReadResource(
	ctx context.Context, req *khulnasoftrpc.ReadResourceRequest,
) (*khulnasoftrpc.ReadResourceResponse, error) {
	return p.target.ReadResource(ctx, req)
}

func (p *monitorProxy) RegisterResource(
	ctx context.Context, req *khulnasoftrpc.RegisterResourceRequest,
) (*khulnasoftrpc.RegisterResourceResponse, error) {
	// Add the "khulnasoft-runtime" header to the context so the engine can detect this request
	...
	ctx = metadata.AppendToOutgoingContext(ctx, "khulnasoft-runtime", "nodejs")
	return p.target.RegisterResource(ctx, req)
}

func (p *monitorProxy) RegisterResourceOutputs(
	ctx context.Context, req *khulnasoftrpc.RegisterResourceOutputsRequest,
) (*emptypb.Empty, error) {
	return p.target.RegisterResourceOutputs(ctx, req)
}

func (p *monitorProxy) SupportsFeature(
	ctx context.Context, req *khulnasoftrpc.SupportsFeatureRequest,
...
func (p *monitorProxy) RegisterStackTransform(
	ctx context.Context, req *khulnasoftrpc.Callback,
) (*emptypb.Empty, error) {
...
func (p *monitorProxy) RegisterPackage(
	ctx context.Context, req *khulnasoftrpc.RegisterPackageRequest,
