...
export function invalidateSubscribersNotificationsFeed(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ["@khulnasoft/api", "Notifications", "feed", ...queryKeyBase],
  });
}
...
export function invalidateAllSubscribersNotificationsFeed(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ["@khulnasoft/api", "Notifications", "feed"],
  });
}
...
export function queryKeySubscribersNotificationsFeed(
  ...
  return ["@khulnasoft/api", "Notifications", "feed", subscriberId, parameters];
}
