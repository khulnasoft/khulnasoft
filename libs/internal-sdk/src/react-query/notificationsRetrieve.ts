...
export function invalidateNotificationsRetrieve(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ["@khulnasoft/api", "Notifications", "retrieve", ...queryKeyBase],
  });
}
...
export function invalidateAllNotificationsRetrieve(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ["@khulnasoft/api", "Notifications", "retrieve"],
  });
}
...
export function queryKeyNotificationsRetrieve(
  ...
  return ["@khulnasoft/api", "Notifications", "retrieve", notificationId, parameters];
}
