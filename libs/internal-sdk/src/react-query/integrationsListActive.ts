...
export function invalidateIntegrationsListActive(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ["@khulnasoft/api", "Integrations", "listActive", ...queryKeyBase],
  });
}
...
export function invalidateAllIntegrationsListActive(
  ...
  return client.invalidateQueries({
    ...filters,
    queryKey: ["@khulnasoft/api", "Integrations", "listActive"],
  });
}
...
export function queryKeyIntegrationsListActive(
  ...
  return ["@khulnasoft/api", "Integrations", "listActive", parameters];
}
