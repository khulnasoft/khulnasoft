...
import { KhulnasoftSubscribers } from "./khulnasoftsubscribers.js";

export class Topics extends ClientSDK {
  private _subscribers?: KhulnasoftSubscribers;
  get subscribers(): KhulnasoftSubscribers {
    return (this._subscribers ??= new KhulnasoftSubscribers(this._options));
  }
