...
import { KhulnasoftMessages } from "./khulnasoftmessages.js";
import { KhulnasoftNotifications } from "./khulnasoftnotifications.js";
...
export class Subscribers extends ClientSDK {
  ...
  private _messages?: KhulnasoftMessages;
  get messages(): KhulnasoftMessages {
    return (this._messages ??= new KhulnasoftMessages(this._options));
  }

  private _notifications?: KhulnasoftNotifications;
  get notifications(): KhulnasoftNotifications {
    return (this._notifications ??= new KhulnasoftNotifications(this._options));
  }
