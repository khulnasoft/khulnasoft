...
export type UpdateIntegrationRequestDto = {
  ...
  /**
   * If true, the Khulnasoft branding will be removed from the Inbox component
   */
  removeKhulnasoftBranding?: boolean | undefined;
...
> = z.object({
  ...
  removeKhulnasoftBranding: z.boolean().optional(),
