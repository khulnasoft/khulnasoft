...
import { OrganizationEntity, CommunityOrganizationRepository } from '@khulnasoft/dal';
import { IMessageButton } from '@khulnasoft/shared';
...
export class CompileInAppTemplate extends CompileTemplateBase {
  ...
  public async execute(
    ...
    try {
      ...
      throw new ApiException(e?.message || `In-App Message content could not be generated`);
    }
