...
import { SubscriberEntity, SubscriberRepository, TenantEntity, TenantRepository } from '@khulnasoft/dal';
import { FilterPartTypeEnum, IMessageFilter } from '@khulnasoft/shared';
