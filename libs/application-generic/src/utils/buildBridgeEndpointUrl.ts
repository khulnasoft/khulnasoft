...
/*
 * Creates a bridge endpoint url to be used for request from khulnasoft cloud to the local
 * workflow definition
 */
 ...
 * places, including packages/khulnasoft/src/commands/init/templates/index.ts when generating the
