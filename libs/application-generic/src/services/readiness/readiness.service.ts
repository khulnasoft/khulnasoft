...
export interface IKhulnasoftWorker extends IDestroy {
...
export class ReadinessService {
  ...
  async pauseWorkers(workers: IKhulnasoftWorker[]): Promise<void> {
  ...
  async enableWorkers(workers: IKhulnasoftWorker[]): Promise<void> {
