...
import { IEventJobData, IJobData, JobTopicNameEnum } from '@khulnasoft/shared';
...
export class BullMqService {
  ...
  public static readonly pro: boolean = process.env.KHULNASOFT_MANAGED_SERVICE !== undefined;
