  ...
  describe('Non cluster mode', () => {
    ...
    describe('Set up', () => {
      ...
      it('should we able to operate in the in-memory database', async () => {
        ...
        await inMemoryProviderService.inMemoryProviderClient.set('khulnasoft', valueToStore);
        const value = await inMemoryProviderService.inMemoryProviderClient.get('khulnasoft');
