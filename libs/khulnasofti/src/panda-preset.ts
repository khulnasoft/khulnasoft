...
/**
 * This defines all Khulnasoft tokens into a single preset to be used in our various apps (and design-system).
 ...
 */
export const khulnasoftPandaPreset = definePreset({
  theme: {
    tokens: {
      sizes: SIZES_TOKENS,
