  ...
  rules: {
    ...
    'no-restricted-syntax': [
      ...
      },
      {
        ...
        message:
          'Use `react-router-dom-v5-compat` instead. We are in the process of migrating from react-router v5 to v6. More info https://github.com/khulnasoft/khulnasoft/issues/33834',
      },
    ],
